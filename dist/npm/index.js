...
r[e]=t;var a=(r,e)=>Ce(r,"name",{value:e,configurable:!0});var $=(r,e)=>()=>(r&&(e=r(r=0)),e);var I=(r,e)=>()=>(e||r((e={exports:{}}).exports,e),e.exports),X=(r,e)=>{for(var t in e)
...
eo(e,i))||n.enumerable});return r};var Qe=(r,e,t)=>(t=r!=null?Xs(ro(r)):{},An(e||!r||!r.__esModule?Ce(t,"default",{
value:r,enumerable:!0}):t,r)),O=r=>An(Ce({},"__esModule",{value:!0}),r);var T=(r,e,t)=>(io(r,typeof e!="symbol"?e+"":e,t),t);var Tn=I(nt=>{"use strict";p();nt.byteLength=oo;nt.toByteArray=uo;nt.fromByteArray=
lo;var ue=[],re=[],so=typeof Uint8Array<"u"?Uint8Array:Array,It="ABCDEFGHIJKLMNO\
PQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";for(_e=0,Cn=It.length;_e<Cn;++_e)
ue[_e]=It[_e],re[It.charCodeAt(_e)]=_e;var _e,Cn;re[45]=62;re[95]=63;function In(r){
...
"getLens");function oo(r){var e=In(r),t=e[0],n=e[1];return(t+n)*3/4-n}a(oo,"byte\
Length");function ao(r,e,t){return(e+t)*3/4-t}a(ao,"_byteLength");function uo(r){
var e,t=In(r),n=t[0],i=t[1],s=new so(ao(r,n,i)),o=0,u=i>0?n-4:n,c;for(c=0;c<u;c+=
...
e&255),s}a(uo,"toByteArray");function co(r){return ue[r>>18&63]+ue[r>>12&63]+ue[r>>
6&63]+ue[r&63]}a(co,"tripletToBase64");function ho(r,e,t){for(var n,i=[],s=e;s<t;s+=
...
u=t-n;o<u;o+=s)i.push(ho(r,o,o+s>u?u:o+s));return n===1?(e=r[t-1],i.push(ue[e>>2]+
ue[e<<4&63]+"==")):n===2&&(e=(r[t-2]<<8)+r[t-1],i.push(ue[e>>10]+ue[e>>4&63]+ue[e<<
2&63]+"=")),i.join("")}a(lo,"fromByteArray")});var Pn=I(Tt=>{p();Tt.read=function(r,e,t,n,i){var s,o,u=i*8-n-1,c=(1<<u)-1,h=c>>
...
i-=8);for(o=o<<i|u,h+=i;h>0;r[t+_]=o&255,_+=P,o/=256,h-=8);r[t+_-P]|=N*128}});var $n=I(Be=>{"use strict";p();var Pt=Tn(),Te=Pn(),Bn=typeof Symbol=="function"&&
...
this))return this.byteOffset}});function pe(r){if(r>it)throw new RangeError('The\
...
fer");f.poolSize=8192;function Mn(r,e,t){if(typeof r=="string")return yo(r,e);if(ArrayBuffer.
...
"u"&&(ce(r,SharedArrayBuffer)||r&&ce(r.buffer,SharedArrayBuffer)))return Lt(r,e,
...
'The value "'+r+'" is invalid for option "size"')}a(Dn,"assertSize");function po(r,e,t){
return Dn(r),r<=0?pe(r):e!==void 0?typeof t=="string"?pe(r).fill(e,t):pe(r).fill(
e):pe(r)}a(po,"alloc");f.alloc=function(r,e,t){return po(r,e,t)};function Ft(r){
return Dn(r),pe(r<0?0:Mt(r)|0)}a(Ft,"allocUnsafe");f.allocUnsafe=function(r){return Ft(
...
n}a(yo,"fromString");function Bt(r){let e=r.length<0?0:Mt(r.length)|0,t=pe(e);for(let n=0;n<
e;n+=1)t[n]=r[n]&255;return t}a(Bt,"fromArrayLike");function mo(r){if(ce(r,Uint8Array)){
...
return typeof r.length!="number"||Ot(r.length)?pe(0):Bt(r);if(r.type==="Buffer"&&
...
it.toString(16)+" bytes");return r|0}a(Mt,"checked");function wo(r){return+r!=r&&
...
i=!0}}a(On,"byteLength");f.byteLength=On;function bo(r,e,t){let n=!1;if((e===void 0||
...
this,e,t);case"utf8":case"utf-8":return Un(this,e,t);case"ascii":return Io(this,
...
a(function(e,t,n){return kn(this,e,t,n,!1)},"lastIndexOf");function So(r,e,t,n){
...
return o;r[t+o]=u}return o}a(So,"hexWrite");function xo(r,e,t,n){return st(Rt(e,
r.length-t),r,t,n)}a(xo,"utf8Write");function Eo(r,e,t,n){return st(Mo(e),r,t,n)}
a(Eo,"asciiWrite");function vo(r,e,t,n){return st(Gn(e),r,t,n)}a(vo,"base64Write");
...
length?Pt.fromByteArray(r):Pt.fromByteArray(r.slice(e,t))}a(Ao,"base64Slice");function Un(r,e,t){
...
o&1023),n.push(o),i+=u}return Co(n)}a(Un,"utf8Slice");var Rn=4096;function Co(r){
let e=r.length;if(e<=Rn)return String.fromCharCode.apply(String,r);let t="",n=0;
for(;n<e;)t+=String.fromCharCode.apply(String,r.slice(n,n+=Rn));return t}a(Co,"d\
...
readUInt32BE");f.prototype.readBigUInt64LE=we(a(function(e){e=e>>>0,Pe(e,"offset");
...
igInt64LE"));f.prototype.readBigInt64BE=we(a(function(e){e=e>>>0,Pe(e,"offset");
let t=this[e],n=this[e+7];(t===void 0||n===void 0)&&We(e,this.length-8);let i=(t<<
...
writeBigInt64BE=we(a(function(e,t=0){return Nn(this,e,t,-BigInt("0x8000000000000\
...
t)}${e}`}a(Fn,"addNumericalSeparator");function Lo(r,e,t){Pe(e,"offset"),(r[e]===
void 0||r[e+t]===void 0)&&We(e,r.length-(t+1))}a(Lo,"checkBounds");function Hn(r,e,t,n,i,s){
...
"value",u,r)}Lo(n,i,s)}a(Hn,"checkIntBI");function Pe(r,e){if(typeof r!="number")
...
a(Do,"utf16leToBytes");function Gn(r){return Pt.toByteArray(Fo(r))}a(Gn,"base64T\
...
a(ce,"isInstance");function Ot(r){return r!==r}a(Ot,"numberIsNaN");var Oo=function(){
...
e.then.bind(e)}});var be=I((eh,kt)=>{"use strict";p();var Le=typeof Reflect=="object"?Reflect:null,
Vn=Le&&typeof Le.apply=="function"?Le.apply:a(function(e,t,n){return Function.prototype.
...
0;B.prototype._maxListeners=void 0;var Kn=10;function at(r){if(typeof r!="functi\
...
_onceWrap");B.prototype.once=a(function(e,t){return at(t),this.on(e,Jn(this,e,t)),
...
on"?t?[i.listener||i]:[i]:t?Qo(i):ti(i,i.length)}a(Xn,"_listeners");B.prototype.
...
return t}a(ti,"arrayClone");function No(r,e){for(;e+1<r.length;e++)r[e]=r[e+1];r.
...
arguments))}a(s,"resolver"),ri(r,e,s,{once:!0}),e!=="error"&&jo(r,i,{once:!0})})}
a(Wo,"once");function jo(r,e,t){typeof r.on=="function"&&ri(r,"error",e,t)}a(jo,
...
ed type '+typeof r)}a(ri,"eventTargetAgnosticAddListener")});var je={};X(je,{default:()=>Ho});var Ho,He=$(()=>{"use strict";p();Ho={}});function Ge(r){let e=1779033703,t=3144134277,n=1013904242,i=2773480762,s=1359893119,
...
15],7)^x(_[L-15],18)^_[L-15]>>>3,le=x(_[L-2],17)^x(_[L-2],19)^_[L-2]>>>10;_[L]=_[L-
16]+G+_[L-7]+le|0}let A=e,g=t,D=n,H=i,Q=s,W=o,he=u,oe=c;for(let L=0;L<64;L++){let G=x(
Q,6)^x(Q,11)^x(Q,25),le=Q&W^~Q&he,me=oe+G+le+y[L]+_[L]|0,ge=x(A,2)^x(A,13)^x(A,22),
ae=A&g^A&D^g&D,ee=ge+ae|0;oe=he,he=W,W=Q,Q=H+me|0,H=D,D=g,g=A,A=me+ee|0}e=e+A|0,
t=t+g|0,n=n+D|0,i=i+H|0,s=s+Q|0,o=o+W|0,u=u+he|0,c=c+oe|0,l=0},"process"),J=a(A=>{
typeof A=="string"&&(A=new TextEncoder().encode(A));for(let g=0;g<A.length;g++)P[l++]=
A[g],l===64&&N();h+=A.length},"add"),ye=a(()=>{if(P[l++]=128,l==64&&N(),l+8>64){
...
g[31]=c&255,g},"digest");return r===void 0?{add:J,digest:ye}:(J(r),ye())}var ni=$(
()=>{"use strict";p();a(Ge,"sha256")});var k,$e,ii=$(()=>{"use strict";p();k=class k{constructor(){T(this,"_dataLength",
...
ut",[]),T(k,"onePassHasher",new k);$e=k});var Ut={};X(Ut,{createHash:()=>$o,createHmac:()=>Vo,randomBytes:()=>Go});function Go(r){
...
set(Ge(o),64),d.from(Ge(u))}}}}}var qt=$(()=>{"use strict";p();ni();ii();a(Go,"r\
andomBytes");a($o,"createHash");a(Vo,"createHmac")});var Qt=I(si=>{"use strict";p();si.parse=function(r,e){return new Nt(r,e).parse()};
...
entries}};a(ut,"ArrayParser");var Nt=ut;function Ko(r){return r}a(Ko,"identity")});var Wt=I((gh,oi)=>{p();var zo=Qt();oi.exports={create:function(r,e){return{parse:function(){
return zo.parse(r,e)}}}}});var ci=I((bh,ui)=>{"use strict";p();var Yo=/(\d{1,})-(\d{2})-(\d{2}) (\d{2}):(\d{2}):(\d{2})(\.\d{1,})?.*?( BC)?$/,
Zo=/^(\d{1,})-(\d{2})-(\d{2})( BC)?$/,Jo=/([Z+-])(\d{2})?:?(\d{2})?:?(\d{2})?/,Xo=/^-?infinity$/;
ui.exports=a(function(e){if(Xo.test(e))return Number(e.replace("i","I"));var t=Yo.
exec(e);if(!t)return ea(e)||null;var n=!!t[8],i=parseInt(t[1],10);n&&(i=ai(i));var s=parseInt(
...
e[3]||0,10)*60+parseInt(e[4]||0,10);return i*n*1e3}}a(ta,"timeZoneOffset");function ai(r){
return-(r-1)}a(ai,"bcYearToNegativeYear");function jt(r){return r>=0&&r<100}a(jt,
"is0To99")});var li=I((Eh,hi)=>{p();hi.exports=na;var ra=Object.prototype.hasOwnProperty;function na(r){
for(var e=1;e<arguments.length;e++){var t=arguments[e];for(var n in t)ra.call(t,
n)&&(r[n]=t[n])}return r}a(na,"extend")});var di=I((Ah,pi)=>{"use strict";p();var ia=li();pi.exports=Re;function Re(r){if(!(this instanceof
...
ca,ha,la,fa].map(function(r){return"("+r+")?"}).join("\\s*")),fi={years:2,months:4,
...
o),n},{})}a(ma,"parse")});var mi=I((Th,yi)=>{"use strict";p();yi.exports=a(function(e){if(/^\\x/.test(e))return new d(
...
"\\";n+=Math.floor(i/2)*2}return new d(t,"binary")},"parseBytea")});var vi=I((Lh,Ei)=>{p();var Ve=Qt(),Ke=Wt(),ct=ci(),wi=di(),bi=mi();function ht(r){
...
r==="1"}a(Si,"parseBool");function ga(r){return r?Ve.parse(r,Si):null}a(ga,"pars\
eBoolArray");function wa(r){return parseInt(r,10)}a(wa,"parseBaseTenInt");function Gt(r){
return r?Ve.parse(r,ht(wa)):null}a(Gt,"parseIntegerArray");function ba(r){return r?
Ve.parse(r,ht(function(e){return xi(e).trim()})):null}a(ba,"parseBigIntegerArray");
...
ct),r(1114,ct),r(1184,ct),r(600,zt),r(651,ne),r(718,va),r(1e3,ga),r(1001,Ea),r(1005,
Gt),r(1007,Gt),r(1028,Gt),r(1016,ba),r(1017,Sa),r(1021,$t),r(1022,$t),r(1231,$t),
r(1014,ne),r(1015,ne),r(1008,ne),r(1009,ne),r(1040,ne),r(1041,ne),r(1115,Vt),r(1182,
Vt),r(1185,Vt),r(1186,wi),r(1187,xa),r(17,bi),r(114,JSON.parse.bind(JSON)),r(3802,
JSON.parse.bind(JSON)),r(199,gi),r(3807,gi),r(3907,ne),r(2951,ne),r(791,ne),r(1183,
ne),r(1270,ne)},"init");Ei.exports={init:_a}});var Ai=I((Mh,_i)=>{"use strict";p();var z=1e6;function Aa(r){var e=r.readInt32BE(
...
e%z,o=4294967296*s+t,u=""+o%z,n+u+i}a(Aa,"readInt8");_i.exports=Aa});var Bi=I((kh,Pi)=>{p();var Ca=Ai(),R=a(function(r,e,t,n,i){t=t||0,n=n||!1,i=i||function(_,P,N){
...
r,31,1,!0)+1):R(r,31,1)},"parseInt32"),Ta=a(function(r){return Ti(r,23,8)},"pars\
eFloat32"),Pa=a(function(r){return Ti(r,52,11)},"parseFloat64"),Ba=a(function(r){
...
null?null:R(r,8)>0},"parseBool"),Fa=a(function(r){r(20,Ca),r(21,Ia),r(23,Ci),r(26,
Ci),r(1700,Ba),r(700,Ta),r(701,Pa),r(16,Ra),r(1114,Ii.bind(null,!1)),r(1184,Ii.bind(
null,!0)),r(1e3,ze),r(1007,ze),r(1016,ze),r(1008,ze),r(1009,ze),r(25,La)},"init");
Pi.exports={init:Fa}});var Ri=I((Nh,Li)=>{p();Li.exports={BOOL:16,BYTEA:17,CHAR:18,INT8:20,INT2:21,INT4:23,
...
REGCONFIG:3734,REGDICTIONARY:3769,JSONB:3802,REGNAMESPACE:4089,REGROLE:4096}});var Je=I(Ze=>{p();var Ma=vi(),Da=Bi(),Oa=Wt(),ka=Ri();Ze.getTypeParser=Ua;Ze.setTypeParser=
qa;Ze.arrayParser=Oa;Ze.builtins=ka;var Ye={text:{},binary:{}};function Fi(r){return String(
r)}a(Fi,"noParse");function Ua(r,e){return e=e||"text",Ye[e]&&Ye[e][r]||Fi}a(Ua,
...
Ye.binary[r]=e})});var Xe=I((Gh,Yt)=>{"use strict";p();Yt.exports={host:"localhost",user:m.platform===
...
setTypeParser(1016,"text",r?Fe.getTypeParser(1007,"text"):Qa)})});var et=I((Vh,Di)=>{"use strict";p();var Wa=(qt(),O(Ut)),ja=Xe();function Ha(r){var e=r.
...
toString("hex"):e+=Ha(lt(r[t]));return e=e+"}",e}a(Mi,"arrayString");var lt=a(function(r,e){
...
Va(r):$a(r):Array.isArray(r)?Mi(r):typeof r=="object"?Ga(r,e):r.toString()},"pre\
...
e)},"prepareValueWrapper"),normalizeQueryConfig:Ka,postgresMd5PasswordHash:za,md5:Zt}});var Ni=I((Yh,qi)=>{"use strict";p();var Jt=(qt(),O(Ut));function Ya(r){if(r.indexOf(
...
",s="+n.salt+",i="+n.iteration,l="c=biws,r="+n.nonce,y=c+","+h+","+l,x=Me(u,y),_=Ui(
o,x),P=_.toString("base64"),N=Me(s,"Server Key"),J=Me(N,y);r.message="SASLRespon\
...
n=e.substring(2);return[t,n]}))}a(ki,"parseAttributePairs");function eu(r){let e=ki(
...
ssage");function tu(r){let t=ki(r).get("v");if(t){if(!Oi(t))throw new Error("SAS\
...
a(tu,"parseServerFinalMessage");function Ui(r,e){if(!d.isBuffer(r))throw new TypeError(
...
from(r.map((t,n)=>r[n]^e[n]))}a(Ui,"xorBuffers");function ru(r){return Jt.createHash(
"sha256").update(r).digest()}a(ru,"sha256");function Me(r,e){return Jt.createHmac(
"sha256",r).update(e).digest()}a(Me,"hmacSha256");function nu(r,e,t){for(var n=Me(
r,d.concat([e,d.from([0,0,0,1])])),i=n,s=0;s<t-1;s++)n=Me(r,n),i=Ui(i,n);return i}
a(nu,"Hi");qi.exports={startSession:Ya,continueSession:Za,finalizeSession:Ja}});var Xt={};X(Xt,{join:()=>iu});function iu(...r){return r.join("/")}var er=$(()=>{
"use strict";p();a(iu,"join")});var tr={};X(tr,{stat:()=>su});function su(r,e){e(new Error("No filesystem"))}var rr=$(
()=>{"use strict";p();a(su,"stat")});var nr={};X(nr,{default:()=>ou});var ou,ir=$(()=>{"use strict";p();ou={}});var Qi={};X(Qi,{StringDecoder:()=>sr});var or,sr,Wi=$(()=>{"use strict";p();or=class or{constructor(e){
T(this,"td");this.td=new TextDecoder(e)}write(e){return this.td.decode(e,{stream:!0})}end(e){
return this.td.decode(e)}};a(or,"StringDecoder");sr=or});var $i=I((ol,Gi)=>{"use strict";p();var{Transform:au}=(ir(),O(nr)),{StringDecoder:uu}=(Wi(),O(Qi)),
Se=Symbol("last"),ft=Symbol("decoder");function cu(r,e,t){let n;if(this.overflow){
...
if(this[Se]+=this[ft].end(),this[Se])try{Hi(this,this.mapper(this[Se]))}catch(e){
return r(e)}r()}a(hu,"flush");function Hi(r,e){e!==void 0&&r.push(e)}a(Hi,"push");
function ji(r){return r}a(ji,"noop");function lu(r,e,t){switch(r=r||/\r?\n/,e=e||
...
let n=new au(t);return n[Se]="",n[ft]=new uu("utf8"),n.matcher=r,n.mapper=e,n.maxLength=
t.maxLength,n.skipOverflow=t.skipOverflow||!1,n.overflow=!1,n._destroy=function(i,s){
this._writableState.errorEmitted=!1,s(i)},n}a(lu,"split");Gi.exports=lu});var zi=I((cl,de)=>{"use strict";p();var Vi=(er(),O(Xt)),fu=(ir(),O(nr)).Stream,pu=$i(),
Ki=(He(),O(je)),du=5432,pt=m.platform==="win32",tt=m.stderr,yu=56,mu=7,gu=61440,
wu=32768;function bu(r){return(r&gu)==wu}a(bu,"isRegFile");var De=["host","port",
"database","user","password"],ar=De.length,Su=De[ar-1];function ur(){var r=tt instanceof
fu&&tt.writable===!0;if(r){var e=Array.prototype.slice.call(arguments).concat(`
`);tt.write(Ki.format.apply(Ki,e))}}a(ur,"warn");Object.defineProperty(de.exports,
"isWin",{get:function(){return pt},set:function(r){pt=r}});de.exports.warnTo=function(r){
var e=tt;return tt=r,e};de.exports.getFileName=function(r){var e=r||m.env,t=e.PGPASSFILE||
(pt?Vi.join(e.APPDATA||"./","postgresql","pgpass.conf"):Vi.join(e.HOME||"./",".p\
gpass"));return t};de.exports.usePgPass=function(r,e){return Object.prototype.hasOwnProperty.
call(m.env,"PGPASSWORD")?!1:pt?!0:(e=e||"<unkn>",bu(r.mode)?r.mode&(yu|mu)?(ur('\
...
e),!1))};var xu=de.exports.match=function(r,e){return De.slice(0,-1).reduce(function(t,n,i){
return i==1&&Number(r[n]||du)===Number(e[n])?t&&!0:t&&(e[n]==="*"||e[n]===r[n])},
!0)};de.exports.getPassword=function(r,e,t){var n,i=e.pipe(pu());function s(c){var h=Eu(
...
u)};var Eu=de.exports.parseLine=function(r){if(r.length<11||r.match(/^\s+#/))return null;
...
Object.keys(o).length===ar?o:null,o},vu=de.exports.isValidEntry=function(r){for(var e={
...
1){var n=e[t],i=r[De[t]]||"",s=n(i);if(!s)return!1}return!0}});var Zi=I((pl,cr)=>{"use strict";p();var fl=(er(),O(Xt)),Yi=(rr(),O(tr)),dt=zi();
...
e)})};cr.exports.warnTo=dt.warnTo});var hr=I((yl,Ji)=>{"use strict";p();var _u=Je();function yt(r){this._types=r||_u,
...
"text",this.getOverrides(e)[r]||this._types.getTypeParser(r,e)};Ji.exports=yt});var Xi={};X(Xi,{default:()=>Au});var Au,es=$(()=>{"use strict";p();Au={}});var ts={};X(ts,{parse:()=>lr});function lr(r,e=!1){let{protocol:t}=new URL(r),n="\
...
password:s,host:o,hostname:u,port:c,pathname:h,search:l,query:P,hash:x}}var fr=$(
()=>{"use strict";p();a(lr,"parse")});var ns=I((xl,rs)=>{"use strict";p();var Cu=(fr(),O(ts)),pr=(rr(),O(tr));function dr(r){
...
return t}a(dr,"parse");rs.exports=dr;dr.parse=dr});var mt=I((_l,os)=>{"use strict";p();var Iu=(es(),O(Xi)),ss=Xe(),is=ns().parse,V=a(
function(r,e,t){return t===void 0?t=m.env["PG"+r.toUpperCase()]:t===!1||(t=m.env[t]),
e[r]||t||ss[r]},"val"),Tu=a(function(){switch(m.env.PGSSLMODE){case"disable":return!1;case"\
prefer":case"require":case"verify-ca":case"verify-full":return!0;case"no-verify":
return{rejectUnauthorized:!1}}return ss.ssl},"readSSLConfigFromEnvironment"),Oe=a(
...
(e=Object.assign({},e,is(e.connectionString))),this.user=V("user",e),this.database=
...
e(i,null):(t.push("hostaddr="+Oe(s)),e(null,t.join(" ")))})}};a(mr,"ConnectionPa\
rameters");var yr=mr;os.exports=yr});var cs=I((Il,us)=>{"use strict";p();var Pu=Je(),as=/^([A-Za-z]+)(?: (\d+))?(?: (\d+))?/,
...
Result");var gr=wr;us.exports=gr});var ps=I((Bl,fs)=>{"use strict";p();var{EventEmitter:Bu}=be(),hs=cs(),ls=et(),Sr=class Sr extends Bu{constructor(e,t,n){
...
var br=Sr;fs.exports=br});var ys={};X(ys,{Socket:()=>xe,isIP:()=>Lu});function Lu(r){return 0}var ds,Ru,v,
xe,gt=$(()=>{"use strict";p();ds=Qe(be(),1);a(Lu,"isIP");Ru=a(r=>r.replace(/^[^.]+\./,
"api."),"transformHost"),v=class v extends ds.EventEmitter{constructor(){super(...arguments);
...
T(v,"opts",{});xe=v});var zr=I(C=>{"use strict";p();Object.defineProperty(C,"__esModule",{value:!0});C.
...
sage");var Rr=$r;C.CommandCompleteMessage=Rr;var Vr=class Vr{constructor(e,t){this.
length=e,this.fields=t,this.name="dataRow",this.fieldCount=t.length}};a(Vr,"Data\
RowMessage");var Fr=Vr;C.DataRowMessage=Fr;var Kr=class Kr{constructor(e,t){this.
length=e,this.message=t,this.name="notice"}};a(Kr,"NoticeMessage");var Mr=Kr;C.NoticeMessage=
...
St.serialize=void 0;var Jr=ms(),F=new Jr.Writer,Fu=a(r=>{F.addInt16(3).addInt16(
...
r=>F.addCString(r).flush(81),"query"),gs=[],qu=a(r=>{let e=r.name||"";e.length>63&&
...
flush(80)},"parse"),ke=new Jr.Writer,Nu=a(function(r,e){for(let t=0;t<r.length;t++){
...
Vu=a(r=>r.name?Xr(68,`${r.type}${r.name||""}`):r.type==="P"?Gu:$u,"describe"),Ku=a(
r=>{let e=`${r.type}${r.name||""}`;return Xr(67,e)},"close"),zu=a(r=>F.add(r).flush(
100),"copyData"),Yu=a(r=>Xr(102,r),"copyFail"),bt=a(r=>d.from([r,0,0,0,4]),"code\
...
copyData:zu,copyDone:()=>ec,copyFail:Yu,cancel:Hu};St.serialize=tc});var bs=I(xt=>{"use strict";p();Object.defineProperty(xt,"__esModule",{value:!0});
xt.BufferReader=void 0;var rc=d.allocUnsafe(0),tn=class tn{constructor(e=0){this.
...
en});var Ss={};X(Ss,{default:()=>nc});var nc,xs=$(()=>{"use strict";p();nc={}});var _s=I(Ue=>{"use strict";p();var ic=Ue&&Ue.__importDefault||function(r){return r&&
r.__esModule?r:{default:r}};Object.defineProperty(Ue,"__esModule",{value:!0});Ue.
Parser=void 0;var M=zr(),sc=bs(),oc=ic((xs(),O(Ss))),rn=1,ac=4,Es=rn+ac,vs=d.allocUnsafe(
...
o=this.buffer.readUInt32BE(i+rn),u=rn+o;if(u+i<=n){let c=this.handlePacket(i+Es,
...
line=s.L,c.routine=s.R,c}};a(sn,"Parser");var nn=sn;Ue.Parser=nn});var on=I(Ee=>{"use strict";p();Object.defineProperty(Ee,"__esModule",{value:!0});
Ee.DatabaseError=Ee.serialize=Ee.parse=void 0;var uc=zr();Object.defineProperty(
Ee,"DatabaseError",{enumerable:!0,get:function(){return uc.DatabaseError}});var cc=ws();
Object.defineProperty(Ee,"serialize",{enumerable:!0,get:function(){return cc.serialize}});
var hc=_s();function lc(r,e){let t=new hc.Parser;return r.on("data",n=>t.parse(n,
e)),new Promise(n=>r.on("end",()=>n()))}a(lc,"parse");Ee.parse=lc});var As={};X(As,{connect:()=>fc});function fc({socket:r,servername:e}){return r.startTls(
e),r}var Cs=$(()=>{"use strict";p();a(fc,"connect")});var cn=I((rf,Ps)=>{"use strict";p();var Is=(gt(),O(ys)),pc=be().EventEmitter,{parse:dc,
serialize:q}=on(),Ts=q.flush(),yc=q.sync(),mc=q.end(),un=class un extends pc{constructor(e){
...
nnection"))}var u=(Cs(),O(As));let c={socket:n.stream};n.ssl!==!0&&(Object.assign(
...
_ending=!0,this._send(Ts),this._send(yc)}ref(){this.stream.ref()}unref(){this.stream.
...
this._send(q.copyFail(e))}};a(un,"Connection");var an=un;Ps.exports=an});var Rs=I((af,Ls)=>{"use strict";p();var gc=be().EventEmitter,of=(He(),O(je)),wc=et(),
hn=Ni(),bc=Zi(),Sc=hr(),xc=mt(),Bs=ps(),Ec=Xe(),vc=cn(),ln=class ln extends gc{constructor(e){
...
Bs;Ls.exports=Et});var Os=I((hf,Ds)=>{"use strict";p();var _c=be().EventEmitter,Fs=a(function(){},"\
...
e}};a(yn,"PendingItem");var qe=yn;function Ac(){throw new Error("Release called \
...
"idleListener")}a(Cc,"makeIdleListener");var mn=class mn extends _c{constructor(e,t){
...
length}};a(mn,"Pool");var pn=mn;Ds.exports=pn});var ks={};X(ks,{default:()=>Ic});var Ic,Us=$(()=>{"use strict";p();Ic={}});var qs=I((df,Tc)=>{Tc.exports={name:"pg",version:"8.8.0",description:"PostgreSQL\
...
7b9a5491a178655"}});var Ws=I((yf,Qs)=>{"use strict";p();var Ns=be().EventEmitter,Pc=(He(),O(je)),gn=et(),
...
Ne,Ns);var Bc={sqlState:"code",statementPosition:"position",messagePrimary:"mess\
...
text,t)}});var $s=I((bf,Gs)=>{"use strict";p();var Lc=(Us(),O(ks)),Rc=hr(),wf=qs(),js=be().
EventEmitter,Fc=(He(),O(je)),Mc=mt(),Hs=Ws(),Y=Gs.exports=function(r){js.call(this),
...
e.port,this.namedQueries={}};Y.Query=Hs;Fc.inherits(Y,js);Y.prototype._errorAllQueries=
...
_types.getTypeParser(r,e)}});var wn=I((Ef,Vs)=>{"use strict";p();Vs.exports=$s()});var _t=I((_f,rt)=>{"use strict";p();var Dc=Rs(),Oc=Xe(),kc=cn(),Uc=Os(),{DatabaseError:qc}=on(),
Nc=a(r=>{var e;return e=class extends Uc{constructor(n){super(n,r)}},a(e,"BoundP\
ool"),e},"poolFactory"),bn=a(function(r){this.defaults=Oc,this.Client=r,this.Query=
...
exports=new bn(wn()):(rt.exports=new bn(Dc),Object.defineProperty(rt.exports,"na\
...
native",{value:r}),r}}))});var jc={};X(jc,{Client:()=>At,ClientBase:()=>Z.ClientBase,Connection:()=>Z.Connection,
DatabaseError:()=>Z.DatabaseError,NeonDbError:()=>ve,Pool:()=>En,Query:()=>Z.Query,
defaults:()=>Z.defaults,neon:()=>Sn,neonConfig:()=>xe,types:()=>Z.types});module.
exports=O(jc);p();var Ct=Qe(_t());gt();p();fr();gt();var Ys=Qe(et());var xn=class xn extends Error{constructor(){super(...arguments);T(this,"name","N\
...
of queries";function Sn(r,{arrayMode:e,fullResults:t,fetchOptions:n,isolationLevel:i,
...
g=g.map(W=>(0,Ys.prepareValue)(W));let Q={query:D,params:g};return u&&u(Q),Qc(ye,
...
"NeonQueryPromise")throw new Error(Ks);return H.parameterizedQuery});return ye(D,
g)};async function ye(A,g){let D=n??{},{fetchEndpoint:H,fetchFunction:Q}=xe,W=typeof H==
"function"?H(_,P):H,he=Array.isArray(A)?{queries:A}:A,oe=e??!1,L=t??!1,G=i,le=s,
me=o;g!==void 0&&(g.arrayMode!==void 0&&(oe=g.arrayMode),g.fullResults!==void 0&&
(L=g.fullResults),g.fetchOptions!==void 0&&(D={...D,...g.fetchOptions}),g.isolationLevel!==
void 0&&(G=g.isolationLevel),g.readOnly!==void 0&&(le=g.readOnly),g.deferrable!==
void 0&&(me=g.deferrable));let ge={"Neon-Connection-String":r,"Neon-Raw-Text-Out\
put":"true","Neon-Array-Mode":"true"};Array.isArray(A)&&(G!==void 0&&(ge["Neon-B\
atch-Isolation-Level"]=G),le!==void 0&&(ge["Neon-Batch-Read-Only"]=String(le)),me!==
void 0&&(ge["Neon-Batch-Deferrable"]=String(me)));let ae;try{ae=await(Q??fetch)(
W,{method:"POST",body:JSON.stringify(he),headers:ge,...D})}catch(ee){let se=new ve(
`Error connecting to database: ${ee.message}`);throw se.sourceError=ee,se}if(ae.
ok){let ee=await ae.json();if(Array.isArray(A)){let se=ee.results;if(!Array.isArray(
se))throw new ve("Neon internal error: unexpected result format");return se.map(
(fe,te)=>zs(fe,{arrayMode:oe,fullResults:L,parameterizedQuery:A[te],resultCallback:c}))}else
return zs(ee,{arrayMode:oe,fullResults:L,parameterizedQuery:A,resultCallback:c})}else{
let{status:ee}=ae;if(ee===400){let{message:se,code:fe}=await ae.json(),te=new ve(
se);throw te.code=fe,te}else{let se=await ae.text();throw new ve(`Server error (\
HTTP status ${ee}): ${se}`)}}}return a(ye,"execute"),J}a(Sn,"neon");function Qc(r,e,t){
return{[Symbol.toStringTag]:"NeonQueryPromise",parameterizedQuery:e,opts:t,then:(n,i)=>r(
e,t).then(n,i),catch:n=>r(e,t).catch(n),finally:n=>r(e,t).finally(n)}}a(Qc,"crea\
teNeonQueryPromise");function zs(r,{arrayMode:e,fullResults:t,parameterizedQuery:n,
resultCallback:i}){let s=r.fields.map(c=>c.name),o=r.fields.map(c=>Z.types.getTypeParser(
...
u,r):u}a(zs,"processQueryResult");var Zs=Qe(mt()),Z=Qe(_t());var vn=class vn extends Ct.Client{constructor(t){super(t);this.config=t}get neonConfig(){
...
fromEntries(s.split(",").map(fe=>{if(!/^.=/.test(fe))throw new Error("SASL: Inva\
lid attribute pair entry");let te=fe[0],Js=fe.substring(2);return[te,Js]})),u=o.
...
[0,0,0,1])]))),J=N;for(var ye=0;ye<l-1;ye++)N=new Uint8Array(await w.subtle.sign(
"HMAC",P,N)),J=d.from(J.map((fe,te)=>J[te]^N[te]));let A=J,g=await w.subtle.importKey(
...
D),Q="n=*,r="+n.clientNonce,W="r="+u+",s="+c+",i="+l,he="c=biws,r="+u,oe=Q+","+W+
","+he,L=await w.subtle.importKey("raw",H,{name:"HMAC",hash:{name:"SHA-256"}},!1,
["sign"]);var G=new Uint8Array(await w.subtle.sign("HMAC",L,x.encode(oe))),le=d.
from(D.map((fe,te)=>D[te]^G[te])),me=le.toString("base64");let ge=await w.subtle.
importKey("raw",A,{name:"HMAC",hash:{name:"SHA-256"}},!1,["sign"]),ae=await w.subtle.
sign("HMAC",ge,x.encode("Server Key")),ee=await w.subtle.importKey("raw",ae,{name:"\
HMAC",hash:{name:"SHA-256"}},!1,["sign"]);var se=d.from(await w.subtle.sign("HMA\
C",ee,x.encode(oe)));n.message="SASLResponse",n.serverSignature=se.toString("bas\
e64"),n.response=he+",p="+me,this.connection.sendSCRAMClientFinalMessage(this.saslSession.
response)}};a(vn,"NeonClient");var At=vn;function Wc(r,e){if(e)return{callback:e,
result:void 0};let t,n,i=a(function(o,u){o?t(o):n(u)},"cb"),s=new r(function(o,u){
n=o,t=u});return{callback:i,result:s}}a(Wc,"promisify");var _n=class _n extends Ct.Pool{constructor(){
...
"string"?t:t.text,y=n??t.values??[];Sn(h,{fullResults:!0,arrayMode:t.rowMode==="\
