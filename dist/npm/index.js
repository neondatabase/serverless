...
r[e]=t;var a=(r,e)=>Te(r,"name",{value:e,configurable:!0});var te=(r,e)=>()=>(r&&(e=r(r=0)),e);var I=(r,e)=>()=>(e||r((e={exports:{}}).exports,e),e.exports),re=(r,e)=>{for(var t in e)
...
no(e,i))||n.enumerable});return r};var Ie=(r,e,t)=>(t=r!=null?ro(so(r)):{},Pn(e||!r||!r.__esModule?Te(t,"default",{
value:r,enumerable:!0}):t,r)),O=r=>Pn(Te({},"__esModule",{value:!0}),r);var _=(r,e,t)=>ao(r,typeof e!="symbol"?e+"":e,t);var Rn=I(st=>{"use strict";p();st.byteLength=co;st.toByteArray=lo;st.fromByteArray=
yo;var ue=[],ne=[],uo=typeof Uint8Array<"u"?Uint8Array:Array,Ft="ABCDEFGHIJKLMNO\
PQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";for(_e=0,Ln=Ft.length;_e<Ln;++_e)
ue[_e]=Ft[_e],ne[Ft.charCodeAt(_e)]=_e;var _e,Ln;ne[45]=62;ne[95]=63;function Bn(r){
...
"getLens");function co(r){var e=Bn(r),t=e[0],n=e[1];return(t+n)*3/4-n}a(co,"byte\
Length");function ho(r,e,t){return(e+t)*3/4-t}a(ho,"_byteLength");function lo(r){
var e,t=Bn(r),n=t[0],i=t[1],s=new uo(ho(r,n,i)),o=0,u=i>0?n-4:n,c;for(c=0;c<u;c+=
...
2&63]+"=")),i.join("")}a(yo,"fromByteArray")});var Fn=I(Mt=>{p();Mt.read=function(r,e,t,n,i){var s,o,u=i*8-n-1,c=(1<<u)-1,h=c>>
...
i-=8);for(o=o<<i|u,h+=i;h>0;r[t+C]=o&255,C+=L,o/=256,h-=8);r[t+C-L]|=Q*128}});var Yn=I(Re=>{"use strict";p();var kt=Rn(),Le=Fn(),Mn=typeof Symbol=="function"&&
...
ument must be of type number');if(r<0)throw new RangeError('The value "'+r+'" is\
 invalid for option "size"')}a(Nn,"assertSize");function go(r,e,t){return Nn(r),
r<=0?pe(r):e!==void 0?typeof t=="string"?pe(r).fill(e,t):pe(r).fill(e):pe(r)}a(go,
"alloc");f.alloc=function(r,e,t){return go(r,e,t)};function Nt(r){return Nn(r),pe(
r<0?0:qt(r)|0)}a(Nt,"allocUnsafe");f.allocUnsafe=function(r){return Nt(r)};f.allocUnsafeSlow=
function(r){return Nt(r)};function wo(r,e){if((typeof e!="string"||e==="")&&(e="\
utf8"),!f.isEncoding(e))throw new TypeError("Unknown encoding: "+e);let t=qn(r,e)|
0,n=pe(t),i=n.write(r,e);return i!==t&&(n=n.slice(0,i)),n}a(wo,"fromString");function Dt(r){
let e=r.length<0?0:qt(r.length)|0,t=pe(e);for(let n=0;n<e;n+=1)t[n]=r[n]&255;return t}
a(Dt,"fromArrayLike");function bo(r){if(ce(r,Uint8Array)){let e=new Uint8Array(r);
return Ut(e.buffer,e.byteOffset,e.byteLength)}return Dt(r)}a(bo,"fromArrayView");
...
n,f.prototype),n}a(Ut,"fromArrayBuffer");function So(r){if(f.isBuffer(r)){let e=qt(
...
Array.isArray(r.data))return Dt(r.data)}a(So,"fromObject");function qt(r){if(r>=
...
i=!0}}a(qn,"byteLength");f.byteLength=qn;function vo(r,e,t){let n=!1;if((e===void 0||
...
this,e,t);case"utf8":case"utf-8":return Wn(this,e,t);case"ascii":return Lo(this,
...
vo,"slowToString");f.prototype._isBuffer=!0;function Ae(r,e,t){let n=r[e];r[e]=r[t],
...
return o;r[t+o]=u}return o}a(Eo,"hexWrite");function _o(r,e,t,n){return at(Ot(e,
r.length-t),r,t,n)}a(_o,"utf8Write");function Ao(r,e,t,n){return at(Uo(e),r,t,n)}
a(Ao,"asciiWrite");function Co(r,e,t,n){return at(zn(e),r,t,n)}a(Co,"base64Write");
...
length?kt.fromByteArray(r):kt.fromByteArray(r.slice(e,t))}a(Io,"base64Slice");function Wn(r,e,t){
...
o&1023),n.push(o),i+=u}return Po(n)}a(Wn,"utf8Slice");var Dn=4096;function Po(r){
let e=r.length;if(e<=Dn)return String.fromCharCode.apply(String,r);let t="",n=0;
for(;n<e;)t+=String.fromCharCode.apply(String,r.slice(n,n+=Dn));return t}a(Po,"d\
...
length),Le.read(this,e,!1,52,8)},"readDoubleBE");function z(r,e,t,n,i,s){if(!f.isBuffer(
...
t)}${e}`}a(Un,"addNumericalSeparator");function Mo(r,e,t){Be(e,"offset"),(r[e]===
void 0||r[e+t]===void 0)&&je(e,r.length-(t+1))}a(Mo,"checkBounds");function Kn(r,e,t,n,i,s){
...
"value",u,r)}Mo(n,i,s)}a(Kn,"checkIntBI");function Be(r,e){if(typeof r!="number")
...
4!==0;)r=r+"=";return r}a(Do,"base64clean");function Ot(r,e){e=e||1/0;let t,n=r.
...
a(Oo,"utf16leToBytes");function zn(r){return kt.toByteArray(Do(r))}a(zn,"base64T\
...
a(ce,"isInstance");function Wt(r){return r!==r}a(Wt,"numberIsNaN");var No=function(){
...
e.then.bind(e)}});var we=I((rh,jt)=>{"use strict";p();var Fe=typeof Reflect=="object"?Reflect:null,
...
console.warn(r)}a(Qo,"ProcessEmitWarning");var Xn=Number.isNaN||a(function(e){return e!==
e},"NumberIsNaN");function B(){B.init.call(this)}a(B,"EventEmitter");jt.exports=
B;jt.exports.once=Go;B.EventEmitter=B;B.prototype._events=void 0;B.prototype._eventsCount=
...
ededWarning",u.emitter=r,u.type=e,u.count=o.length,Qo(u)}return r}a(ti,"_addList\
...
return ti(this,e,t,!0)},"prependListener");function Wo(){if(!this.fired)return this.
...
listener:t},i=Wo.bind(n);return i.listener=t,n.wrapFn=i,i}a(ri,"_onceWrap");B.prototype.
...
"function"?t?[i.listener||i]:[i]:t?Ho(i):si(i,i.length)}a(ni,"_listeners");B.prototype.
...
return t}a(si,"arrayClone");function jo(r,e){for(;e+1<r.length;e++)r[e]=r[e+1];r.
...
arguments))}a(s,"resolver"),oi(r,e,s,{once:!0}),e!=="error"&&$o(r,i,{once:!0})})}
a(Go,"once");function $o(r,e,t){typeof r.on=="function"&&oi(r,"error",e,t)}a($o,
...
ed type '+typeof r)}a(oi,"eventTargetAgnosticAddListener")});var He={};re(He,{default:()=>Vo});var Vo,Ge=te(()=>{"use strict";p();Vo={}});var Ht={};re(Ht,{Md5:()=>Ve,createHash:()=>zo,createHmac:()=>Yo,randomBytes:()=>Ko,
...
3];for(let R=16;R<64;R++){let $=b(C[R-15],7)^b(C[R-15],18)^C[R-15]>>>3,le=b(C[R-
2],17)^b(C[R-2],19)^C[R-2]>>>10;C[R]=C[R-16]+$+C[R-7]+le|0}let A=e,g=t,P=n,K=i,D=s,
W=o,X=u,ae=c;for(let R=0;R<64;R++){let $=b(D,6)^b(D,11)^b(D,25),le=D&W^~D&X,me=ae+
$+le+d[R]+C[R]|0,ve=b(A,2)^b(A,13)^b(A,22),We=A&g^A&P^g&P,fe=ve+We|0;ae=X,X=W,W=
D,D=K+me|0,K=P,P=g,g=A,A=me+fe|0}e=e+A|0,t=t+g|0,n=n+P|0,i=i+K|0,s=s+D|0,o=o+W|0,
u=u+X|0,c=c+ae|0,l=0},"process"),J=a(A=>{typeof A=="string"&&(A=new TextEncoder().
encode(A));for(let g=0;g<A.length;g++)L[l++]=A[g],l===64&&Q();h+=A.length},"add"),
ye=a(()=>{if(L[l++]=128,l==64&&Q(),l+8>64){for(;l<64;)L[l++]=0;Q()}for(;l<58;)L[l++]=
...
c>>>16&255,g[30]=c>>>8&255,g[31]=c&255,g},"digest");return r===void 0?{add:J,digest:ye}:
(J(r),ye())}var U,Ve,Gt=te(()=>{"use strict";p();a(Ko,"randomBytes");a(zo,"creat\
...
ut",[]),_(U,"onePassHasher",new U);Ve=U;a($e,"sha256")});var Vt=I(ai=>{"use strict";p();ai.parse=function(r,e){return new $t(r,e).parse()};
...
entries}};a(ht,"ArrayParser");var $t=ht;function Zo(r){return r}a(Zo,"identity")});var Kt=I((lh,ui)=>{p();var Jo=Vt();ui.exports={create:a(function(r,e){return{parse:a(
function(){return Jo.parse(r,e)},"parse")}},"create")}});var li=I((dh,hi)=>{"use strict";p();var Xo=/(\d{1,})-(\d{2})-(\d{2}) (\d{2}):(\d{2}):(\d{2})(\.\d{1,})?.*?( BC)?$/,
...
i,s,o,u,c,h,l),zt(i)&&d.setFullYear(i)),d},"parseDate");function na(r){var e=ea.
exec(r);if(e){var t=parseInt(e[1],10),n=!!e[4];n&&(t=ci(t));var i=parseInt(e[2],
10)-1,s=e[3],o=new Date(t,i,s);return zt(t)&&o.setFullYear(t),o}}a(na,"getDate");
...
return-(r-1)}a(ci,"bcYearToNegativeYear");function zt(r){return r>=0&&r<100}a(zt,
"is0To99")});var pi=I((gh,fi)=>{p();fi.exports=oa;var sa=Object.prototype.hasOwnProperty;function oa(r){
for(var e=1;e<arguments.length;e++){var t=arguments[e];for(var n in t)sa.call(t,
n)&&(r[n]=t[n])}return r}a(oa,"extend")});var mi=I((Sh,yi)=>{"use strict";p();var aa=pi();yi.exports=Me;function Me(r){if(!(this instanceof
...
"")),i+ca[n]}};var Yt="([+-]?\\d+)",fa=Yt+"\\s+years?",pa=Yt+"\\s+mons?",da=Yt+"\
...
o),n},{})}a(ba,"parse")});var wi=I((Eh,gi)=>{"use strict";p();gi.exports=a(function(e){if(/^\\x/.test(e))return new y(
...
"\\";n+=Math.floor(i/2)*2}return new y(t,"binary")},"parseBytea")});var Ai=I((Ch,_i)=>{p();var Ke=Vt(),ze=Kt(),lt=li(),Si=mi(),xi=wi();function ft(r){
...
return r?Ke.parse(r,ft(xa)):null}a(Zt,"parseIntegerArray");function va(r){return r?
Ke.parse(r,ft(function(e){return Ei(e).trim()})):null}a(va,"parseBigIntegerArray");
...
var s=tr(e);return s.radius=parseFloat(t),s},"parseCircle"),Ta=a(function(r){r(20,
Ei),r(21,er),r(23,er),r(26,er),r(700,parseFloat),r(701,parseFloat),r(16,vi),r(1082,
lt),r(1114,lt),r(1184,lt),r(600,tr),r(651,ie),r(718,Ca),r(1e3,Sa),r(1001,Aa),r(1005,
Zt),r(1007,Zt),r(1028,Zt),r(1016,va),r(1017,Ea),r(1021,Jt),r(1022,Jt),r(1231,Jt),
r(1014,ie),r(1015,ie),r(1008,ie),r(1009,ie),r(1040,ie),r(1041,ie),r(1115,Xt),r(1182,
Xt),r(1185,Xt),r(1186,Si),r(1187,_a),r(17,xi),r(114,JSON.parse.bind(JSON)),r(3802,
JSON.parse.bind(JSON)),r(199,bi),r(3807,bi),r(3907,ie),r(2951,ie),r(791,ie),r(1183,
ie),r(1270,ie)},"init");_i.exports={init:Ta}});var Ti=I((Ph,Ci)=>{"use strict";p();var Y=1e6;function Ia(r){var e=r.readInt32BE(
...
e%Y,o=4294967296*s+t,u=""+o%Y,n+u+i}a(Ia,"readInt8");Ci.exports=Ia});var Ri=I((Rh,Bi)=>{p();var Pa=Ti(),F=a(function(r,e,t,n,i){t=t||0,n=n||!1,i=i||function(C,L,Q){
...
r,31,1,!0)+1):F(r,31,1)},"parseInt32"),Ba=a(function(r){return Li(r,23,8)},"pars\
eFloat32"),Ra=a(function(r){return Li(r,52,11)},"parseFloat64"),Fa=a(function(r){
...
null?null:F(r,8)>0},"parseBool"),Da=a(function(r){r(20,Pa),r(21,La),r(23,Ii),r(26,
Ii),r(1700,Fa),r(700,Ba),r(701,Ra),r(16,ka),r(1114,Pi.bind(null,!1)),r(1184,Pi.bind(
null,!0)),r(1e3,Ye),r(1007,Ye),r(1016,Ye),r(1008,Ye),r(1009,Ye),r(25,Ma)},"init");
Bi.exports={init:Da}});var Mi=I((kh,Fi)=>{p();Fi.exports={BOOL:16,BYTEA:17,CHAR:18,INT8:20,INT2:21,INT4:23,
...
REGCONFIG:3734,REGDICTIONARY:3769,JSONB:3802,REGNAMESPACE:4089,REGROLE:4096}});var Xe=I(Je=>{p();var Ua=Ai(),Oa=Ri(),Na=Kt(),qa=Mi();Je.getTypeParser=Qa;Je.setTypeParser=
Wa;Je.arrayParser=Na;Je.builtins=qa;var Ze={text:{},binary:{}};function ki(r){return String(
r)}a(ki,"noParse");function Qa(r,e){return e=e||"text",Ze[e]&&Ze[e][r]||ki}a(Qa,
...
Ze.binary[r]=e})});var et=I((qh,rr)=>{"use strict";p();rr.exports={host:"localhost",user:m.platform===
...
connect_timeout:0,keepalives:1,keepalives_idle:0};var ke=Xe(),ja=ke.getTypeParser(
20,"text"),Ha=ke.getTypeParser(1016,"text");rr.exports.__defineSetter__("parseIn\
t8",function(r){ke.setTypeParser(20,"text",r?ke.getTypeParser(23,"text"):ja),ke.
setTypeParser(1016,"text",r?ke.getTypeParser(1007,"text"):Ha)})});var tt=I((Wh,Ui)=>{"use strict";p();var Ga=(Gt(),O(Ht)),$a=et();function Va(r){var e=r.
...
toString("hex"):e+=Va(pt(r[t]));return e=e+"}",e}a(Di,"arrayString");var pt=a(function(r,e){
...
Ya(r):za(r):Array.isArray(r)?Di(r):typeof r=="object"?Ka(r,e):r.toString()},"pre\
...
g");var nr=a(function(r){return Ga.createHash("md5").update(r,"utf-8").digest("h\
ex")},"md5"),Ja=a(function(r,e,t){var n=nr(e+r),i=nr(y.concat([y.from(n),t]));return"\
md5"+i},"postgresMd5PasswordHash");Ui.exports={prepareValue:a(function(e){return pt(
e)},"prepareValueWrapper"),normalizeQueryConfig:Za,postgresMd5PasswordHash:Ja,md5:nr}});var Wi=I((Gh,Qi)=>{"use strict";p();var ir=(Gt(),O(Ht));function Xa(r){if(r.indexOf(
...
o,b),L=C.toString("base64"),Q=De(s,"Server Key"),J=De(Q,d);r.message="SASLRespon\
...
ssage");function iu(r){let t=Ni(r).get("v");if(t){if(!Oi(t))throw new Error("SAS\
...
from(r.map((t,n)=>r[n]^e[n]))}a(qi,"xorBuffers");function su(r){return ir.createHash(
"sha256").update(r).digest()}a(su,"sha256");function De(r,e){return ir.createHmac(
...
a(ou,"Hi");Qi.exports={startSession:Xa,continueSession:eu,finalizeSession:tu}});var sr={};re(sr,{join:()=>au});function au(...r){return r.join("/")}var or=te(()=>{
"use strict";p();a(au,"join")});var ar={};re(ar,{stat:()=>uu});function uu(r,e){e(new Error("No filesystem"))}var ur=te(
()=>{"use strict";p();a(uu,"stat")});var cr={};re(cr,{default:()=>cu});var cu,hr=te(()=>{"use strict";p();cu={}});var ji={};re(ji,{StringDecoder:()=>lr});var fr,lr,Hi=te(()=>{"use strict";p();fr=
...
lr=fr});var Ki=I((tl,Vi)=>{"use strict";p();var{Transform:hu}=(hr(),O(cr)),{StringDecoder:lu}=(Hi(),O(ji)),
be=Symbol("last"),dt=Symbol("decoder");function fu(r,e,t){let n;if(this.overflow){
...
let n=new hu(t);return n[be]="",n[dt]=new lu("utf8"),n.matcher=r,n.mapper=e,n.maxLength=
t.maxLength,n.skipOverflow=t.skipOverflow||!1,n.overflow=!1,n._destroy=function(i,s){
this._writableState.errorEmitted=!1,s(i)},n}a(du,"split");Vi.exports=du});var Zi=I((il,de)=>{"use strict";p();var zi=(or(),O(sr)),yu=(hr(),O(cr)).Stream,mu=Ki(),
Yi=(Ge(),O(He)),gu=5432,yt=m.platform==="win32",rt=m.stderr,wu=56,bu=7,Su=61440,
xu=32768;function vu(r){return(r&Su)==xu}a(vu,"isRegFile");var Ue=["host","port",
"database","user","password"],pr=Ue.length,Eu=Ue[pr-1];function dr(){var r=rt instanceof
yu&&rt.writable===!0;if(r){var e=Array.prototype.slice.call(arguments).concat(`
`);rt.write(Yi.format.apply(Yi,e))}}a(dr,"warn");Object.defineProperty(de.exports,
...
<unkn>",vu(r.mode)?r.mode&(wu|bu)?(dr('WARNING: password file "%s" has group or \
...
pr?o:null,o},Cu=de.exports.isValidEntry=function(r){for(var e={0:function(o){return o.
...
"",s=n(i);if(!s)return!1}return!0}});var Xi=I((ul,yr)=>{"use strict";p();var al=(or(),O(sr)),Ji=(ur(),O(ar)),mt=Zi();
yr.exports=function(r,e){var t=mt.getFileName();Ji.stat(t,function(n,i){if(n||!mt.
usePgPass(i,t))return e(void 0);var s=Ji.createReadStream(t);mt.getPassword(r,s,
e)})};yr.exports.warnTo=mt.warnTo});var wt=I((hl,es)=>{"use strict";p();var Tu=Xe();function gt(r){this._types=r||Tu,
...
"text",this.getOverrides(e)[r]||this._types.getTypeParser(r,e)};es.exports=gt});var ts={};re(ts,{default:()=>Iu});var Iu,rs=te(()=>{"use strict";p();Iu={}});var ns={};re(ns,{parse:()=>mr});function mr(r,e=!1){let{protocol:t}=new URL(r),n="\
...
search:l,query:L,hash:b}}var gr=te(()=>{"use strict";p();a(mr,"parse")});var ss=I((ml,is)=>{"use strict";p();var Pu=(gr(),O(ns)),wr=(ur(),O(ar));function br(r){
...
return t}a(br,"parse");is.exports=br;br.parse=br});var bt=I((bl,us)=>{"use strict";p();var Lu=(rs(),O(ts)),as=et(),os=ss().parse,V=a(
...
d"),xr=class xr{constructor(e){e=typeof e=="string"?os(e):e||{},e.connectionString&&
...
ent_encoding="+Oe(this.client_encoding)),Lu.lookup(this.host,function(i,s){return i?
e(i,null):(t.push("hostaddr="+Oe(s)),e(null,t.join(" ")))})}};a(xr,"ConnectionPa\
rameters");var Sr=xr;us.exports=Sr});var ls=I((vl,hs)=>{"use strict";p();var Ru=Xe(),cs=/^([A-Za-z]+)(?: (\d+))?(?: (\d+))?/,
...
ext"):this._parsers[t]=Ru.getTypeParser(n.dataTypeID,n.format||"text")}}};a(Er,"\
Result");var vr=Er;hs.exports=vr});var ys=I((Al,ds)=>{"use strict";p();var{EventEmitter:Fu}=we(),fs=ls(),ps=tt(),Ar=class Ar extends Fu{constructor(e,t,n){
...
var _r=Ar;ds.exports=_r});var ws={};re(ws,{Socket:()=>Se,isIP:()=>Mu});function Mu(r){return 0}var gs,ms,v,
Se,St=te(()=>{"use strict";p();gs=Ie(we(),1);a(Mu,"isIP");ms=/^[^.]+\./,v=class v extends gs.EventEmitter{constructor(){
...
rootCerts:"",pipelineTLS:!1,disableSNI:!1}),_(v,"opts",{});Se=v});var en=I(T=>{"use strict";p();Object.defineProperty(T,"__esModule",{value:!0});T.
...
Nr});var bs=I(xt=>{"use strict";p();Object.defineProperty(xt,"__esModule",{value:!0});
...
iter");var tn=rn;xt.Writer=tn});var xs=I(Et=>{"use strict";p();Object.defineProperty(Et,"__esModule",{value:!0});
Et.serialize=void 0;var nn=bs(),M=new nn.Writer,ku=a(r=>{M.addInt16(3).addInt16(
...
flush(80)},"parse"),Ne=new nn.Writer,Wu=a(function(r,e){for(let t=0;t<r.length;t++){
...
zu=a(r=>r.name?sn(68,`${r.type}${r.name||""}`):r.type==="P"?Vu:Ku,"describe"),Yu=a(
r=>{let e=`${r.type}${r.name||""}`;return sn(67,e)},"close"),Zu=a(r=>M.add(r).flush(
100),"copyData"),Ju=a(r=>sn(102,r),"copyFail"),vt=a(r=>y.from([r,0,0,0,4]),"code\
...
cancel:$u};Et.serialize=nc});var vs=I(_t=>{"use strict";p();Object.defineProperty(_t,"__esModule",{value:!0});
_t.BufferReader=void 0;var ic=y.allocUnsafe(0),an=class an{constructor(e=0){this.
...
on});var As=I(At=>{"use strict";p();Object.defineProperty(At,"__esModule",{value:!0});
At.Parser=void 0;var k=en(),sc=vs(),un=1,oc=4,Es=un+oc,_s=y.allocUnsafe(0),hn=class hn{constructor(e){
...
i+un),u=un+o;if(u+i<=n){let c=this.handlePacket(i+Es,s,o,this.buffer);t(c),i+=u}else
...
xe.DatabaseError=xe.serialize=xe.parse=void 0;var ac=en();Object.defineProperty(
xe,"DatabaseError",{enumerable:!0,get:a(function(){return ac.DatabaseError},"get")});
var uc=xs();Object.defineProperty(xe,"serialize",{enumerable:!0,get:a(function(){
return uc.serialize},"get")});var cc=As();function hc(r,e){let t=new cc.Parser;return r.
on("data",n=>t.parse(n,e)),new Promise(n=>r.on("end",()=>n()))}a(hc,"parse");xe.
parse=hc});var Cs={};re(Cs,{connect:()=>lc});function lc({socket:r,servername:e}){return r.
startTls(e),r}var Ts=te(()=>{"use strict";p();a(lc,"connect")});var dn=I((Yl,Ls)=>{"use strict";p();var Is=(St(),O(ws)),fc=we().EventEmitter,{parse:pc,
serialize:q}=ln(),Ps=q.flush(),dc=q.sync(),yc=q.end(),pn=class pn extends fc{constructor(e){
...
this._send(q.copyFail(e))}};a(pn,"Connection");var fn=pn;Ls.exports=fn});var Fs=I((ef,Rs)=>{"use strict";p();var mc=we().EventEmitter,Xl=(Ge(),O(He)),gc=tt(),
yn=Wi(),wc=Xi(),bc=wt(),Sc=bt(),Bs=ys(),xc=et(),vc=dn(),mn=class mn extends mc{constructor(e){
...
Bs;Rs.exports=Ct});var Us=I((nf,Ds)=>{"use strict";p();var Ec=we().EventEmitter,Ms=a(function(){},"\
...
e}};a(Sn,"PendingItem");var qe=Sn;function _c(){throw new Error("Release called \
...
"idleListener")}a(Ac,"makeIdleListener");var xn=class xn extends Ec{constructor(e,t){
...
length}};a(xn,"Pool");var wn=xn;Ds.exports=wn});var Os={};re(Os,{default:()=>Cc});var Cc,Ns=te(()=>{"use strict";p();Cc={}});var qs=I((uf,Tc)=>{Tc.exports={name:"pg",version:"8.8.0",description:"PostgreSQL\
...
7b9a5491a178655"}});var js=I((cf,Ws)=>{"use strict";p();var Qs=we().EventEmitter,Ic=(Ge(),O(He)),vn=tt(),
Qe=Ws.exports=function(r,e,t){Qs.call(this),r=vn.normalizeQueryConfig(r,e,t),this.
...
text,t)}});var Vs=I((pf,$s)=>{"use strict";p();var Lc=(Ns(),O(Os)),Bc=wt(),ff=qs(),Hs=we().
EventEmitter,Rc=(Ge(),O(He)),Fc=bt(),Gs=js(),Z=$s.exports=function(r){Hs.call(this),
...
_types.getTypeParser(r,e)}});var En=I((mf,Ks)=>{"use strict";p();Ks.exports=Vs()});var It=I((wf,nt)=>{"use strict";p();var Mc=Fs(),kc=et(),Dc=dn(),Uc=Us(),{DatabaseError:Oc}=ln(),
Nc=a(r=>{var e;return e=class extends Uc{constructor(n){super(n,r)}},a(e,"BoundP\
ool"),e},"poolFactory"),_n=a(function(r){this.defaults=kc,this.Client=r,this.Query=
...
exports=new _n(En()):(nt.exports=new _n(Mc),Object.defineProperty(nt.exports,"na\
...
native",{value:r}),r}}))});var Gc={};re(Gc,{Client:()=>Lt,ClientBase:()=>oe.ClientBase,Connection:()=>oe.Connection,
...
exports=O(Gc);p();var Bt=Ie(It());St();p();St();gr();var Zs=Ie(tt()),Js=Ie(wt());function qc(r){return r instanceof y?"\\x"+r.toString("hex"):r}a(qc,"encodeBuffe\
...
query:P,params:g};return u&&u(D),Wc(ye,D,K)}a(J,"resolve"),J.transaction=async(A,g)=>{
if(typeof A=="function"&&(A=A(J)),!Array.isArray(A))throw new Error(zs);A.forEach(
D=>{if(D[Symbol.toStringTag]!=="NeonQueryPromise")throw new Error(zs)});let P=A.
map(D=>D.parameterizedQuery),K=A.map(D=>D.opts??{});return ye(P,K,g)};async function ye(A,g,P){
let{fetchEndpoint:K,fetchFunction:D}=Se,W=Array.isArray(A)?{queries:A}:A,X=n??{},
ae=e??!1,R=t??!1,$=i,le=s,me=o;P!==void 0&&(P.fetchOptions!==void 0&&(X={...X,...P.
fetchOptions}),P.arrayMode!==void 0&&(ae=P.arrayMode),P.fullResults!==void 0&&(R=
...
g)&&g.fetchOptions!==void 0&&(X={...X,...g.fetchOptions});let ve=h;!Array.isArray(
g)&&g?.authToken!==void 0&&(ve=g.authToken);let We=typeof K=="function"?K(C,L,{jwtAuth:ve!==
void 0}):K,fe={"Neon-Connection-String":r,"Neon-Raw-Text-Output":"true","Neon-Ar\
ray-Mode":"true"},it=await jc(ve);it&&(fe.Authorization=`Bearer ${it}`),Array.isArray(
...
let ee;try{ee=await(D??fetch)(We,{method:"POST",body:JSON.stringify(W),headers:fe,
...X})}catch(j){let H=new he(`Error connecting to database: ${j}`);throw H.sourceError=
j,H}if(ee.ok){let j=await ee.json();if(Array.isArray(A)){let H=j.results;if(!Array.
isArray(H))throw new he("Neon internal error: unexpected result format");return H.
map((Ce,Ee)=>{let Rt=g[Ee]??{},eo=Rt.arrayMode??ae,to=Rt.fullResults??R;return Ys(
Ce,{arrayMode:eo,fullResults:to,parameterizedQuery:A[Ee],resultCallback:c,types:Rt.
types})})}else{let H=g??{},Ce=H.arrayMode??ae,Ee=H.fullResults??R;return Ys(j,{arrayMode:Ce,
fullResults:Ee,parameterizedQuery:A,resultCallback:c,types:H.types})}}else{let{status:j}=ee;
if(j===400){let H=await ee.json(),Ce=new he(H.message);for(let Ee of Qc)Ce[Ee]=H[Ee]??
void 0;throw Ce}else{let H=await ee.text();throw new he(`Server error (HTTP stat\
us ${j}): ${H}`)}}}return a(ye,"execute"),J}a(An,"neon");function Wc(r,e,t){return{
...
n),"finally")}}a(Wc,"createNeonQueryPromise");function Ys(r,{arrayMode:e,fullResults:t,
...
n: ${e.message}`)),t}}a(jc,"getAuthToken");var Xs=Ie(bt()),oe=Ie(It());var Tn=class Tn extends Bt.Client{constructor(t){super(t);this.config=t}get neonConfig(){
...
[0,0,0,1])]))),J=Q;for(var ye=0;ye<l-1;ye++)Q=new Uint8Array(await w.subtle.sign(
...
P),D="n=*,r="+n.clientNonce,W="r="+u+",s="+c+",i="+l,X="c=biws,r="+u,ae=D+","+W+
...
from(P.map((ee,j)=>P[j]^$[j])),me=le.toString("base64");let ve=await w.subtle.importKey(
"raw",A,{name:"HMAC",hash:{name:"SHA-256"}},!1,["sign"]),We=await w.subtle.sign(
"HMAC",ve,b.encode("Server Key")),fe=await w.subtle.importKey("raw",We,{name:"HM\
...
n.response=X+",p="+me,this.connection.sendSCRAMClientFinalMessage(this.saslSession.
response)}};a(Tn,"NeonClient");var Lt=Tn;function Hc(r,e){if(e)return{callback:e,
result:void 0};let t,n,i=a(function(o,u){o?t(o):n(u)},"cb"),s=new r(function(o,u){
n=o,t=u});return{callback:i,result:s}}a(Hc,"promisify");var In=class In extends Bt.Pool{constructor(){
super(...arguments);_(this,"Client",Lt);_(this,"hasFetchUnsupportedListeners",!1)}on(t,n){
