"use strict";var so=Object.create;var Ie=Object.defineProperty;var oo=Object.getOwnPropertyDescriptor;var ao=Object.getOwnPropertyNames;var uo=Object.getPrototypeOf,co=Object.prototype.hasOwnProperty;var lo=(r,e,t)=>e in r?Ie(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):
...
"function")for(let i of ao(e))!co.call(r,i)&&i!==t&&Ie(r,i,{get:()=>e[i],enumerable:!(n=
oo(e,i))||n.enumerable});return r},te=(r,e,t)=>(ot(r,e,"default"),t&&ot(t,e,"def\
ault")),Re=(r,e,t)=>(t=r!=null?so(uo(r)):{},ot(e||!r||!r.__esModule?Ie(t,"defaul\
...
wo;var ce=[],ie=[],ho=typeof Uint8Array<"u"?Uint8Array:Array,kt="ABCDEFGHIJKLMNO\
PQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";for(Ce=0,Fn=kt.length;Ce<Fn;++Ce)
ce[Ce]=kt[Ce],ie[kt.charCodeAt(Ce)]=Ce;var Ce,Fn;ie[45]=62;ie[95]=63;function Ln(r){
...
var e,t=Ln(r),n=t[0],i=t[1],s=new ho(po(r,n,i)),o=0,u=i>0?n-4:n,c;for(c=0;c<u;c+=
...
e&255),s}a(yo,"toByteArray");function mo(r){return ce[r>>18&63]+ce[r>>12&63]+ce[r>>
6&63]+ce[r&63]}a(mo,"tripletToBase64");function go(r,e,t){for(var n,i=[],s=e;s<t;s+=
...
u=t-n;o<u;o+=s)i.push(go(r,o,o+s>u?u:o+s));return n===1?(e=r[t-1],i.push(ce[e>>2]+
ce[e<<4&63]+"==")):n===2&&(e=(r[t-2]<<8)+r[t-1],i.push(ce[e>>10]+ce[e>>4&63]+ce[e<<
2&63]+"=")),i.join("")}a(wo,"fromByteArray")});var Mn=I(Ot=>{d();Ot.read=function(r,e,t,n,i){var s,o,u=i*8-n-1,c=(1<<u)-1,l=c>>
...
i-=8);for(o=o<<i|u,l+=i;l>0;r[t+_]=o&255,_+=P,o/=256,l-=8);r[t+_-P]|=G*128}});var Zn=I(Be=>{"use strict";d();var Dt=Bn(),Fe=Mn(),kn=typeof Symbol=="function"&&
...
0,n=pe(t),i=n.write(r,e);return i!==t&&(n=n.slice(0,i)),n}a(xo,"fromString");function Qt(r){
...
base64":return Yn(r).length;default:if(i)return n?-1:qt(r).length;e=(""+e).toLowerCase(),
i=!0}}a(Nn,"byteLength");f.byteLength=Nn;function _o(r,e,t){let n=!1;if((e===void 0||
...
if(l[p]!==h[p]){o=l[p],u=h[p];break}return o<u?-1:u<o?1:0},"compare");function Wn(r,e,t,n,i){
...
"string"&&(e=f.from(e,n)),f.isBuffer(e))return e.length===0?-1:On(r,e,t,n,i);if(typeof e==
...
[e],t,n,i);throw new TypeError("val must be string, number or Buffer")}a(Wn,"bid\
irectionalIndexOf");function On(r,e,t,n,i){let s=1,o=r.length,u=e.length;if(n!==
...
o&1023),n.push(o),i+=u}return Lo(n)}a(jn,"utf8Slice");var Dn=4096;function Lo(r){
...
this[t+2]=e>>>8,this[t+3]=e&255,t+4},"writeUInt32BE");function Hn(r,e,t,n,i){zn(
...
o,o=o>>8,r[t++]=o,o=o>>8,r[t++]=o,o=o>>8,r[t++]=o,t}a(Hn,"wrtBigUInt64LE");function Gn(r,e,t,n,i){
zn(e,n,i,r,t,7);let s=Number(e&BigInt(4294967295));r[t+7]=s,s=s>>8,r[t+6]=s,s=s>>
...
000"),BigInt("0x7fffffffffffffff"))},"writeBigInt64BE"));function $n(r,e,t,n,i,s){
if(t+n>r.length)throw new RangeError("Index out of range");if(t<0)throw new RangeError(
"Index out of range")}a($n,"checkIEEE754");function Vn(r,e,t,n,i){return e=+e,t=
t>>>0,i||$n(r,e,t,4,34028234663852886e22,-34028234663852886e22),Fe.write(r,e,t,n,
...
this,e,t,!1,n)},"writeFloatBE");function Kn(r,e,t,n,i){return e=+e,t=t>>>0,i||$n(
...
isInteger(t)&&Math.abs(t)>2**32?i=Qn(String(t)):typeof t=="bigint"&&(i=String(t),
(t>BigInt(2)**BigInt(32)||t<-(BigInt(2)**BigInt(32)))&&(i=Qn(i)),i+="n"),n+=` It\
 must be ${e}. Received ${i}`,n},RangeError);function Qn(r){let e="",t=r.length,
...
void 0||r[e+t]===void 0)&&He(e,r.length-(t+1))}a(Do,"checkBounds");function zn(r,e,t,n,i,s){
...
"value",u,r)}Do(n,i,s)}a(zn,"checkIntBI");function Le(r,e){if(typeof r!="number")
...
16;++i)e[n+i]=r[t]+r[i]}return e}();function be(r){return typeof BigInt>"u"?jo:r}
...
e.then.bind(e)}});var Se=I((sl,Gt)=>{"use strict";d();var Me=typeof Reflect=="object"?Reflect:null,
...
console.warn(r)}a(Ho,"ProcessEmitWarning");var ei=Number.isNaN||a(function(e){return e!==
...
"number"||r<0||ei(r))throw new RangeError('The value of "defaultMaxListeners" is\
...
"number"||e<0||ei(e))throw new RangeError('The value of "n" is out of range. It \
must be a non-negative number. Received '+e+".");return this._maxListeners=e,this},
"setMaxListeners");function ti(r){return r._maxListeners===void 0?F.defaultMaxListeners:
r._maxListeners}a(ti,"_getMaxListeners");F.prototype.getMaxListeners=a(function(){
return ti(this)},"getMaxListeners");F.prototype.emit=a(function(e){for(var t=[],
...
"function")Jn(c,this,t);else for(var l=c.length,h=oi(c,l),n=0;n<l;++n)Jn(h[n],this,
t);return!0},"emit");function ri(r,e,t,n){var i,s,o;if(ht(t),s=r._events,s===void 0?
...
t):o.push(t),i=ti(r),i>0&&o.length>i&&!o.warned){o.warned=!0;var u=new Error("Po\
...
ededWarning",u.emitter=r,u.type=e,u.count=o.length,Ho(u)}return r}a(ri,"_addList\
ener");F.prototype.addListener=a(function(e,t){return ri(this,e,t,!1)},"addListe\
ner");F.prototype.on=F.prototype.addListener;F.prototype.prependListener=a(function(e,t){
return ri(this,e,t,!0)},"prependListener");function Go(){if(!this.fired)return this.
...
"onceWrapper");function ni(r,e,t){var n={fired:!1,wrapFn:void 0,target:r,type:e,
listener:t},i=Go.bind(n);return i.listener=t,n.wrapFn=i,i}a(ni,"_onceWrap");F.prototype.
once=a(function(e,t){return ht(t),this.on(e,ni(this,e,t)),this},"once");F.prototype.
prependOnceListener=a(function(e,t){return ht(t),this.prependListener(e,ni(this,
...
1;i>=0;i--)this.removeListener(e,t[i]);return this},"removeAllListeners");function ii(r,e,t){
var n=r._events;if(n===void 0)return[];var i=n[e];return i===void 0?[]:typeof i==
"function"?t?[i.listener||i]:[i]:t?Vo(i):oi(i,i.length)}a(ii,"_listeners");F.prototype.
listeners=a(function(e){return ii(this,e,!0)},"listeners");F.prototype.rawListeners=
a(function(e){return ii(this,e,!1)},"rawListeners");F.listenerCount=function(r,e){
return typeof r.listenerCount=="function"?r.listenerCount(e):si.call(r,e)};F.prototype.
listenerCount=si;function si(r){var e=this._events;if(e!==void 0){var t=e[r];if(typeof t==
"function")return 1;if(t!==void 0)return t.length}return 0}a(si,"listenerCount");
...
return t}a(oi,"arrayClone");function $o(r,e){for(;e+1<r.length;e++)r[e]=r[e+1];r.
...
arguments))}a(s,"resolver"),ai(r,e,s,{once:!0}),e!=="error"&&zo(r,i,{once:!0})})}
a(Ko,"once");function zo(r,e,t){typeof r.on=="function"&&ai(r,"error",e,t)}a(zo,
"addErrorHandlerIfEventEmitter");function ai(r,e,t,n){if(typeof r.on=="function")
...
ed type '+typeof r)}a(ai,"eventTargetAgnosticAddListener")});var Ge={};ne(Ge,{default:()=>Yo});var Yo,$e=z(()=>{"use strict";d();Yo={}});function Ve(r){let e=1779033703,t=3144134277,n=1013904242,i=2773480762,s=1359893119,
...
g[31]=c&255,g},"digest");return r===void 0?{add:ee,digest:ae}:(ee(r),ae())}var ui=z(
()=>{"use strict";d();a(Ve,"sha256")});var Q,Ke,ci=z(()=>{"use strict";d();Q=class Q{constructor(){A(this,"_dataLength",
...
64),y.from(Ve(u))},"digest")}},"update")}}var Zo,Vt=z(()=>{"use strict";d();ui();
ci();Zo="node:crypto";a(Jo,"randomBytes");a(Xo,"createHash");a(ea,"createHmac")});var zt=I(li=>{"use strict";d();li.parse=function(r,e){return new Kt(r,e).parse()};
...
entries}};a(ft,"ArrayParser");var Kt=ft;function ta(r){return r}a(ta,"identity")});var Yt=I((vl,hi)=>{d();var ra=zt();hi.exports={create:a(function(r,e){return{parse:a(
function(){return ra.parse(r,e)},"parse")}},"create")}});var pi=I((_l,di)=>{"use strict";d();var na=/(\d{1,})-(\d{2})-(\d{2}) (\d{2}):(\d{2}):(\d{2})(\.\d{1,})?.*?( BC)?$/,
ia=/^(\d{1,})-(\d{2})-(\d{2})( BC)?$/,sa=/([Z+-])(\d{2})?:?(\d{2})?:?(\d{2})?/,oa=/^-?infinity$/;
di.exports=a(function(e){if(oa.test(e))return Number(e.replace("i","I"));var t=na.
exec(e);if(!t)return aa(e)||null;var n=!!t[8],i=parseInt(t[1],10);n&&(i=fi(i));var s=parseInt(
...
i,s,o,u,c,l,h),Zt(i)&&p.setFullYear(i)),p},"parseDate");function aa(r){var e=ia.
exec(r);if(e){var t=parseInt(e[1],10),n=!!e[4];n&&(t=fi(t));var i=parseInt(e[2],
10)-1,s=e[3],o=new Date(t,i,s);return Zt(t)&&o.setFullYear(t),o}}a(aa,"getDate");
...
e[3]||0,10)*60+parseInt(e[4]||0,10);return i*n*1e3}}a(ua,"timeZoneOffset");function fi(r){
return-(r-1)}a(fi,"bcYearToNegativeYear");function Zt(r){return r>=0&&r<100}a(Zt,
"is0To99")});var mi=I((Il,yi)=>{d();yi.exports=la;var ca=Object.prototype.hasOwnProperty;function la(r){
for(var e=1;e<arguments.length;e++){var t=arguments[e];for(var n in t)ca.call(t,
n)&&(r[n]=t[n])}return r}a(la,"extend")});var bi=I((Fl,wi)=>{"use strict";d();var ha=mi();wi.exports=ke;function ke(r){if(!(this instanceof
...
"")),i+da[n]}};var Jt="([+-]?\\d+)",ma=Jt+"\\s+years?",ga=Jt+"\\s+mons?",wa=Jt+"\
\\s+days?",ba="([+-])?([\\d]*):(\\d\\d):(\\d\\d)\\.?(\\d{1,6})?",Sa=new RegExp([
ma,ga,wa,ba].map(function(r){return"("+r+")?"}).join("\\s*")),gi={years:2,months:4,
...
r),t=e[8]==="-";return Object.keys(gi).reduce(function(n,i){var s=gi[i],o=e[s];return!o||
(o=i==="milliseconds"?va(o):parseInt(o,10),!o)||(t&&~xa.indexOf(i)&&(o*=-1),n[i]=
o),n},{})}a(Ea,"parse")});var xi=I((Ml,Si)=>{"use strict";d();Si.exports=a(function(e){if(/^\\x/.test(e))return new y(
...
"\\";n+=Math.floor(i/2)*2}return new y(t,"binary")},"parseBytea")});var Ii=I((Dl,Ti)=>{d();var ze=zt(),Ye=Yt(),dt=pi(),Ei=bi(),Ai=xi();function pt(r){
return a(function(t){return t===null?t:r(t)},"nullAllowed")}a(pt,"allowNull");function _i(r){
return r===null?r:r==="TRUE"||r==="t"||r==="true"||r==="y"||r==="yes"||r==="on"||
r==="1"}a(_i,"parseBool");function Aa(r){return r?ze.parse(r,_i):null}a(Aa,"pars\
...
ze.parse(r,pt(function(e){return Ci(e).trim()})):null}a(Ca,"parseBigIntegerArray");
...
return t!==null&&(t=Ei(t)),t});return e.parse()},"parseIntervalArray"),Ra=a(function(r){
return r?ze.parse(r,pt(Ai)):null},"parseByteAArray"),rr=a(function(r){return parseInt(
r,10)},"parseInteger"),Ci=a(function(r){var e=String(r);return/^\d+$/.test(e)?e:
r},"parseBigInteger"),vi=a(function(r){return r?ze.parse(r,pt(JSON.parse)):null},
...
var s=nr(e);return s.radius=parseFloat(t),s},"parseCircle"),Fa=a(function(r){r(20,
Ci),r(21,rr),r(23,rr),r(26,rr),r(700,parseFloat),r(701,parseFloat),r(16,_i),r(1082,
dt),r(1114,dt),r(1184,dt),r(600,nr),r(651,se),r(718,Pa),r(1e3,Aa),r(1001,Ra),r(1005,
...
tr),r(1185,tr),r(1186,Ei),r(1187,Ia),r(17,Ai),r(114,JSON.parse.bind(JSON)),r(3802,
JSON.parse.bind(JSON)),r(199,vi),r(3807,vi),r(3907,se),r(2951,se),r(791,se),r(1183,
se),r(1270,se)},"init");Ti.exports={init:Fa}});var Pi=I((ql,Ri)=>{"use strict";d();var Z=1e6;function La(r){var e=r.readInt32BE(
...
e%Z,o=4294967296*s+t,u=""+o%Z,n+u+i}a(La,"readInt8");Ri.exports=La});var ki=I((jl,Mi)=>{d();var Ba=Pi(),B=a(function(r,e,t,n,i){t=t||0,n=n||!1,i=i||function(_,P,G){
...
(B(r,15,1,!0)+1):B(r,15,1)},"parseInt16"),Fi=a(function(r){return B(r,1)==1?-1*(B(
r,31,1,!0)+1):B(r,31,1)},"parseInt32"),ka=a(function(r){return Bi(r,23,8)},"pars\
eFloat32"),Oa=a(function(r){return Bi(r,52,11)},"parseFloat64"),Da=a(function(r){
...
return(e===0?1:-1)*Math.round(n*u)/u},"parseNumeric"),Li=a(function(r,e){var t=B(
...
null?null:B(r,8)>0},"parseBool"),qa=a(function(r){r(20,Ba),r(21,Ma),r(23,Fi),r(26,
Fi),r(1700,Da),r(700,ka),r(701,Oa),r(16,Ua),r(1114,Li.bind(null,!1)),r(1184,Li.bind(
null,!0)),r(1e3,Ze),r(1007,Ze),r(1016,Ze),r(1008,Ze),r(1009,Ze),r(25,Qa)},"init");
Mi.exports={init:qa}});var Di=I(($l,Oi)=>{d();Oi.exports={BOOL:16,BYTEA:17,CHAR:18,INT8:20,INT2:21,INT4:23,
...
REGCONFIG:3734,REGDICTIONARY:3769,JSONB:3802,REGNAMESPACE:4089,REGROLE:4096}});var et=I(Xe=>{d();var Na=Ii(),Wa=ki(),ja=Yt(),Ha=Di();Xe.getTypeParser=Ga;Xe.setTypeParser=
$a;Xe.arrayParser=ja;Xe.builtins=Ha;var Je={text:{},binary:{}};function Qi(r){return String(
r)}a(Qi,"noParse");function Ga(r,e){return e=e||"text",Je[e]&&Je[e][r]||Qi}a(Ga,
...
Je.binary[r]=e})});var tt=I((Zl,ir)=>{"use strict";d();ir.exports={host:"localhost",user:m.platform===
...
20,"text"),Ka=Oe.getTypeParser(1016,"text");ir.exports.__defineSetter__("parseIn\
t8",function(r){Oe.setTypeParser(20,"text",r?Oe.getTypeParser(23,"text"):Va),Oe.
setTypeParser(1016,"text",r?Oe.getTypeParser(1007,"text"):Ka)})});var rt=I((Xl,qi)=>{"use strict";d();var za=(Vt(),U($t)),Ya=tt();function Za(r){var e=r.
...
toString("hex"):e+=Za(yt(r[t]));return e=e+"}",e}a(Ui,"arrayString");var yt=a(function(r,e){
...
g");var sr=a(function(r){return za.createHash("md5").update(r,"utf-8").digest("h\
ex")},"md5"),ru=a(function(r,e,t){var n=sr(e+r),i=sr(y.concat([y.from(n),t]));return"\
md5"+i},"postgresMd5PasswordHash");qi.exports={prepareValue:a(function(e){return yt(
e)},"prepareValueWrapper"),normalizeQueryConfig:tu,postgresMd5PasswordHash:ru,md5:sr}});var Gi=I((rh,Hi)=>{"use strict";d();var or=(Vt(),U($t));function nu(r){if(r.indexOf(
...
i,n.iteration),o=De(s,"Client Key"),u=cu(o),c="n=*,r="+r.clientNonce,l="r="+n.nonce+
",s="+n.salt+",i="+n.iteration,h="c=biws,r="+n.nonce,p=c+","+l+","+h,S=De(u,p),_=ji(
...
Session");function su(r,e){if(r.message!=="SASLResponse")throw new Error("SASL: \
...
test(r)}a(Ni,"isBase64");function Wi(r){if(typeof r!="string")throw new TypeError(
...
n=e.substring(2);return[t,n]}))}a(Wi,"parseAttributePairs");function au(r){let e=Wi(
...
ssage");function uu(r){let t=Wi(r).get("v");if(t){if(!Ni(t))throw new Error("SAS\
...
a(uu,"parseServerFinalMessage");function ji(r,e){if(!y.isBuffer(r))throw new TypeError(
...
from(r.map((t,n)=>r[n]^e[n]))}a(ji,"xorBuffers");function cu(r){return or.createHash(
...
r,y.concat([e,y.from([0,0,0,1])])),i=n,s=0;s<t-1;s++)n=De(r,n),i=ji(i,n);return i}
a(lu,"Hi");Hi.exports={startSession:nu,continueSession:iu,finalizeSession:su}});var ar={};ne(ar,{join:()=>hu});function hu(...r){return r.join("/")}var ur=z(()=>{
"use strict";d();a(hu,"join")});var cr={};ne(cr,{stat:()=>fu});function fu(r,e){e(new Error("No filesystem"))}var lr=z(
()=>{"use strict";d();a(fu,"stat")});var hr={};ne(hr,{default:()=>du});var du,fr=z(()=>{"use strict";d();du={}});var $i={};ne($i,{StringDecoder:()=>dr});var pr,dr,Vi=z(()=>{"use strict";d();pr=
...
dr=pr});var Zi=I((fh,Yi)=>{"use strict";d();var{Transform:pu}=(fr(),U(hr)),{StringDecoder:yu}=(Vi(),U($i)),
...
n.pop();for(let i=0;i<n.length;i++)try{zi(this,this.mapper(n[i]))}catch(s){return t(
...
if(this[xe]+=this[mt].end(),this[xe])try{zi(this,this.mapper(this[xe]))}catch(e){
return r(e)}r()}a(gu,"flush");function zi(r,e){e!==void 0&&r.push(e)}a(zi,"push");
function Ki(r){return r}a(Ki,"noop");function wu(r,e,t){switch(r=r||/\r?\n/,e=e||
...
this._writableState.errorEmitted=!1,s(i)},n}a(wu,"split");Yi.exports=wu});var es=I((yh,ye)=>{"use strict";d();var Ji=(ur(),U(ar)),bu=(fr(),U(hr)).Stream,Su=Zi(),
Xi=($e(),U(Ge)),xu=5432,gt=m.platform==="win32",nt=m.stderr,vu=56,Eu=7,Au=61440,
...
`);nt.write(Xi.format.apply(Xi,e))}}a(mr,"warn");Object.defineProperty(ye.exports,
...
var e=r||m.env,t=e.PGPASSFILE||(gt?Ji.join(e.APPDATA||"./","postgresql","pgpass.\
conf"):Ji.join(e.HOME||"./",".pgpass"));return t};ye.exports.usePgPass=function(r,e){
...
return Qe.slice(0,-1).reduce(function(t,n,i){return i==1&&Number(r[n]||xu)===Number(
...
on("data",s).on("end",o).on("error",u)};var Ru=ye.exports.parseLine=function(r){
...
"",s=n(i);if(!s)return!1}return!0}});var rs=I((bh,gr)=>{"use strict";d();var wh=(ur(),U(ar)),ts=(lr(),U(cr)),wt=es();
gr.exports=function(r,e){var t=wt.getFileName();ts.stat(t,function(n,i){if(n||!wt.
usePgPass(i,t))return e(void 0);var s=ts.createReadStream(t);wt.getPassword(r,s,
e)})};gr.exports.warnTo=wt.warnTo});var St=I((xh,ns)=>{"use strict";d();var Fu=et();function bt(r){this._types=r||Fu,
...
"text",this.getOverrides(e)[r]||this._types.getTypeParser(r,e)};ns.exports=bt});var is={};ne(is,{default:()=>Lu});var Lu,ss=z(()=>{"use strict";d();Lu={}});var os={};ne(os,{parse:()=>wr});function wr(r,e=!1){let{protocol:t}=new URL(r),n="\
...
search:h,query:P,hash:S}}var br=z(()=>{"use strict";d();a(wr,"parse")});var us=I((Th,as)=>{"use strict";d();var Bu=(br(),U(os)),Sr=(lr(),U(cr));function xr(r){
...
return t}a(xr,"parse");as.exports=xr;xr.parse=xr});var xt=I((Ph,hs)=>{"use strict";d();var Mu=(ss(),U(is)),ls=tt(),cs=us().parse,V=a(
function(r,e,t){return t===void 0?t=m.env["PG"+r.toUpperCase()]:t===!1||(t=m.env[t]),
e[r]||t||ls[r]},"val"),ku=a(function(){switch(m.env.PGSSLMODE){case"disable":return!1;case"\
prefer":case"require":case"verify-ca":case"verify-full":return!0;case"no-verify":
return{rejectUnauthorized:!1}}return ls.ssl},"readSSLConfigFromEnvironment"),Ue=a(
function(r){return"'"+(""+r).replace(/\\/g,"\\\\").replace(/'/g,"\\'")+"'"},"quo\
teParamValue"),oe=a(function(r,e,t){var n=e[t];n!=null&&r.push(t+"="+Ue(n))},"ad\
d"),Er=class Er{constructor(e){e=typeof e=="string"?cs(e):e||{},e.connectionString&&
(e=Object.assign({},e,cs(e.connectionString))),this.user=V("user",e),this.database=
...
rameters");var vr=Er;hs.exports=vr});var ps=I((Bh,ds)=>{"use strict";d();var Ou=et(),fs=/^([A-Za-z]+)(?: (\d+))?(?: (\d+))?/,
...
var t;e.text?t=fs.exec(e.text):t=fs.exec(e.command),t&&(this.command=t[1],t[3]?(this.
...
Result");var Ar=_r;ds.exports=Ar});var ws=I((Oh,gs)=>{"use strict";d();var{EventEmitter:Du}=Se(),ys=ps(),ms=rt(),Tr=class Tr extends Du{constructor(e,t,n){
super(),e=ms.normalizeQueryConfig(e,t,n),this.text=e.text,this.values=e.values,this.
...
(this.callback=m.domain.bind(e.callback)),this._result=new ys(this._rowMode,this.
...
(Array.isArray(this._results)||(this._results=[this._result]),this._result=new ys(
...
var Cr=Tr;gs.exports=Cr});var xs={};ne(xs,{Socket:()=>ve,isIP:()=>Qu});function Qu(r){return 0}var Ss,bs,E,
ve,vt=z(()=>{"use strict";d();Ss=Re(Se(),1);a(Qu,"isIP");bs=/^[^.]+\./,E=class E extends Ss.EventEmitter{constructor(){
...
(t,n,i)=>{let s;return i?.jwtAuth?s=t.replace(bs,"apiauth."):s=t.replace(bs,"api\
...
Nr});var vs=I(Et=>{"use strict";d();Object.defineProperty(Et,"__esModule",{value:!0});
...
iter");var nn=sn;Et.Writer=nn});var As=I(_t=>{"use strict";d();Object.defineProperty(_t,"__esModule",{value:!0});
_t.serialize=void 0;var on=vs(),M=new on.Writer,Uu=a(r=>{M.addInt16(3).addInt16(
...
r=>M.addCString(r).flush(81),"query"),Es=[],Gu=a(r=>{let e=r.name||"";e.length>63&&
...
OnlyBuffer"),nc=At(72),ic=At(83),sc=At(88),oc=At(99),ac={startup:Uu,password:Nu,
...
cancel:Yu};_t.serialize=ac});var _s=I(Ct=>{"use strict";d();Object.defineProperty(Ct,"__esModule",{value:!0});
...
un});var Is=I(Tt=>{"use strict";d();Object.defineProperty(Tt,"__esModule",{value:!0});
Tt.Parser=void 0;var k=rn(),cc=_s(),ln=1,lc=4,Cs=ln+lc,Ts=y.allocUnsafe(0),fn=class fn{constructor(e){
if(this.buffer=Ts,this.bufferLength=0,this.bufferOffset=0,this.reader=new cc.BufferReader,
...
i=this.bufferOffset;for(;i+Cs<=n;){let s=this.buffer[i],o=this.buffer.readUInt32BE(
i+ln),u=ln+o;if(u+i<=n){let c=this.handlePacket(i+Cs,s,o,this.buffer);t(c),i+=u}else
break}i===n?(this.buffer=Ts,this.bufferLength=0,this.bufferOffset=0):(this.bufferLength=
...
var fc=As();Object.defineProperty(Ee,"serialize",{enumerable:!0,get:a(function(){
return fc.serialize},"get")});var dc=Is();function pc(r,e){let t=new dc.Parser;return r.
on("data",n=>t.parse(n,e)),new Promise(n=>r.on("end",()=>n()))}a(pc,"parse");Ee.
parse=pc});var Rs={};ne(Rs,{connect:()=>yc});function yc({socket:r,servername:e}){return r.
startTls(e),r}var Ps=z(()=>{"use strict";d();a(yc,"connect")});var mn=I((uf,Bs)=>{"use strict";d();var Fs=(vt(),U(xs)),mc=Se().EventEmitter,{parse:gc,
serialize:N}=dn(),Ls=N.flush(),wc=N.sync(),bc=N.end(),yn=class yn extends mc{constructor(e){
super(),e=e||{},this.stream=e.stream||new Fs.Socket,this._keepAlive=e.keepAlive,
...
nnection"))}var u=(Ps(),U(Rs));let c={socket:n.stream};n.ssl!==!0&&(Object.assign(
c,n.ssl),"key"in n.ssl&&(c.key=n.ssl.key)),Fs.isIP(t)===0&&(c.servername=t);try{
...
_send(N.execute(e))}flush(){this.stream.writable&&this.stream.write(Ls)}sync(){this.
...
this._send(N.copyFail(e))}};a(yn,"Connection");var pn=yn;Bs.exports=pn});var Os=I((ff,ks)=>{"use strict";d();var Sc=Se().EventEmitter,hf=($e(),U(Ge)),xc=rt(),
gn=Gi(),vc=rs(),Ec=St(),Ac=xt(),Ms=ws(),_c=tt(),Cc=mn(),wn=class wn extends Sc{constructor(e){
...
(i.callback=i.callback||t)):(o=this.connectionParameters.query_timeout,i=new Ms(
...
Ms;ks.exports=It});var qs=I((yf,Us)=>{"use strict";d();var Tc=Se().EventEmitter,Ds=a(function(){},"\
NOOP"),Qs=a((r,e)=>{let t=r.findIndex(e);return t===-1?void 0:r.splice(t,1)[0]},
...
o),o});return{callback:i,result:s}}a(Rt,"promisify");function Rc(r,e){return a(function t(n){
...
throw new Error("unexpected condition")}_remove(e){let t=Qs(this._idle,n=>n.client===
...
return this._pendingQueue.push(new Ne(t.callback)),n;let i=a((u,c,l)=>{clearTimeout(
o),t.callback(u,c,l)},"queueCallback"),s=new Ne(i),o=setTimeout(()=>{Qs(this._pendingQueue,
...
length}};a(En,"Pool");var Sn=En;Us.exports=Sn});var Ns={};ne(Ns,{default:()=>Pc});var Pc,Ws=z(()=>{"use strict";d();Pc={}});var js=I((bf,Fc)=>{Fc.exports={name:"pg",version:"8.8.0",description:"PostgreSQL\
...
7b9a5491a178655"}});var $s=I((Sf,Gs)=>{"use strict";d();var Hs=Se().EventEmitter,Lc=($e(),U(Ge)),An=rt(),
We=Gs.exports=function(r,e,t){Hs.call(this),r=An.normalizeQueryConfig(r,e,t),this.
...
We,Hs);var Bc={sqlState:"code",statementPosition:"position",messagePrimary:"mess\
...
text,t)}});var Ys=I((Af,zs)=>{"use strict";d();var Mc=(Ws(),U(Ns)),kc=St(),Ef=js(),Vs=Se().
EventEmitter,Oc=($e(),U(Ge)),Dc=xt(),Ks=$s(),J=zs.exports=function(r){Vs.call(this),
...
e.port,this.namedQueries={}};J.Query=Ks;Oc.inherits(J,Vs);J.prototype._errorAllQueries=
...
query_timeout,n=new Ks(r,e,t),!n.callback){let c,l;i=new this._Promise((h,p)=>{c=
...
_types.getTypeParser(r,e)}});var _n=I((Tf,Zs)=>{"use strict";d();Zs.exports=Ys()});var Pt=I((Rf,it)=>{"use strict";d();var Qc=Os(),Uc=tt(),qc=mn(),Nc=qs(),{DatabaseError:Wc}=dn(),
...
types=et(),this.DatabaseError=Wc},"PG");typeof m.env.NODE_PG_FORCE_NATIVE<"u"?it.
exports=new Cn(_n()):(it.exports=new Cn(Qc),Object.defineProperty(it.exports,"na\
...
captureStackTrace(this,Ft)}};a(Ft,"NeonDbError");var he=Ft,Js="transaction() exp\
...
if(typeof C=="function"&&(C=C(ee)),!Array.isArray(C))throw new Error(Js);C.forEach(
D=>{if(D[Symbol.toStringTag]!=="NeonQueryPromise")throw new Error(Js)});let R=C.
...
ray-Mode":"true"},st=await Vc(Ae);st&&(de.Authorization=`Bearer ${st}`),Array.isArray(
...
map((we,_e)=>{let Mt=g[_e]??{},no=Mt.arrayMode??ue,io=Mt.fullResults??L;return Xs(
we,{arrayMode:no,fullResults:io,parameterizedQuery:C[_e],resultCallback:c,types:Mt.
types})})}else{let O=g??{},we=O.arrayMode??ue,_e=O.fullResults??L;return Xs(K,{arrayMode:we,
...
n),"finally")}}a($c,"createNeonQueryPromise");function Xs(r,{arrayMode:e,fullResults:t,
parameterizedQuery:n,resultCallback:i,types:s}){let o=new to.default(s),u=r.fields.
...
t?(r.viaNeonFetch=!0,r.rowAsArray=e,r.rows=l,r._parsers=c,r._types=o,r):l}a(Xs,"\
...
n=o,t=u});return{callback:i,result:s}}a(Kc,"promisify");var Pn=class Pn extends Bt.Pool{constructor(){
...
catch(_=>i(_))}catch(o){i(o)}return s.result}};a(Pn,"NeonPool");var In=Pn;
