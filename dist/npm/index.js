...
no(e,i))||n.enumerable});return r};var je=(r,e,t)=>(t=r!=null?ro(so(r)):{},In(e||!r||!r.__esModule?Ie(t,"default",{
value:r,enumerable:!0}):t,r)),O=r=>In(Ie({},"__esModule",{value:!0}),r);var P=(r,e,t)=>(ao(r,typeof e!="symbol"?e+"":e,t),t);var Bn=I(it=>{"use strict";p();it.byteLength=co;it.toByteArray=lo;it.fromByteArray=
yo;var ae=[],te=[],uo=typeof Uint8Array<"u"?Uint8Array:Array,Pt="ABCDEFGHIJKLMNO\
...
e&255),s}a(lo,"toByteArray");function fo(r){return ae[r>>18&63]+ae[r>>12&63]+ae[r>>
6&63]+ae[r&63]}a(fo,"tripletToBase64");function po(r,e,t){for(var n,i=[],s=e;s<t;s+=
...
u=t-n;o<u;o+=s)i.push(po(r,o,o+s>u?u:o+s));return n===1?(e=r[t-1],i.push(ae[e>>2]+
ae[e<<4&63]+"==")):n===2&&(e=(r[t-2]<<8)+r[t-1],i.push(ae[e>>10]+ae[e>>4&63]+ae[e<<
2&63]+"=")),i.join("")}a(yo,"fromByteArray")});var Ln=I(Tt=>{p();Tt.read=function(r,e,t,n,i){var s,o,u=i*8-n-1,c=(1<<u)-1,h=c>>
...
fer");f.poolSize=8192;function On(r,e,t){if(typeof r=="string")return wo(r,e);if(ArrayBuffer.
...
'The value "'+r+'" is invalid for option "size"')}a(kn,"assertSize");function go(r,e,t){
return kn(r),r<=0?fe(r):e!==void 0?typeof t=="string"?fe(r).fill(e,t):fe(r).fill(
e):fe(r)}a(go,"alloc");f.alloc=function(r,e,t){return go(r,e,t)};function Mt(r){
...
n}a(wo,"fromString");function Lt(r){let e=r.length<0?0:Dt(r.length)|0,t=fe(e);for(let n=0;n<
e;n+=1)t[n]=r[n]&255;return t}a(Lt,"fromArrayLike");function bo(r){if(ue(r,Uint8Array)){
...
i=!0}}a(Un,"byteLength");f.byteLength=Un;function Eo(r,e,t){let n=!1;if((e===void 0||
...
Eo,"slowToString");f.prototype._isBuffer=!0;function Ae(r,e,t){let n=r[e];r[e]=r[t],
...
a(function(e,t,n){return qn(this,e,t,n,!1)},"lastIndexOf");function vo(r,e,t,n){
...
return o;r[t+o]=u}return o}a(vo,"hexWrite");function _o(r,e,t,n){return ot(Ft(e,
...
length?Bt.fromByteArray(r):Bt.fromByteArray(r.slice(e,t))}a(Po,"base64Slice");function Nn(r,e,t){
...
o&1023),n.push(o),i+=u}return To(n)}a(Nn,"utf8Slice");var Mn=4096;function To(r){
let e=r.length;if(e<=Mn)return String.fromCharCode.apply(String,r);let t="",n=0;
for(;n<e;)t+=String.fromCharCode.apply(String,r.slice(n,n+=Mn));return t}a(To,"d\
...
void 0||r[e+t]===void 0)&&We(e,r.length-(t+1))}a(Mo,"checkBounds");function $n(r,e,t,n,i,s){
...
4!==0;)r=r+"=";return r}a(Oo,"base64clean");function Ft(r,e){e=e||1/0;let t,n=r.
...
Ft,"utf8ToBytes");function ko(r){let e=[];for(let t=0;t<r.length;++t)e.push(r.charCodeAt(
...
a(Uo,"utf16leToBytes");function Vn(r){return Bt.toByteArray(Oo(r))}a(Vn,"base64T\
...
a(ue,"isInstance");function kt(r){return r!==r}a(kt,"numberIsNaN");var qo=function(){
...
B;Ut.exports.once=Go;B.EventEmitter=B;B.prototype._events=void 0;B.prototype._eventsCount=
...
prependListener=a(function(e,t){return Xn(this,e,t,!0)},"prependListener");function jo(){
...
target,arguments)}a(jo,"onceWrapper");function ei(r,e,t){var n={fired:!1,wrapFn:void 0,
target:r,type:e,listener:t},i=jo.bind(n);return i.listener=t,n.wrapFn=i,i}a(ei,"\
...
on"?t?[i.listener||i]:[i]:t?Ho(i):ni(i,i.length)}a(ti,"_listeners");B.prototype.
...
ed type '+typeof r)}a(ii,"eventTargetAgnosticAddListener")});var He={};ee(He,{default:()=>Vo});var Vo,Ge=V(()=>{"use strict";p();Vo={}});function $e(r){let e=1779033703,t=3144134277,n=1013904242,i=2773480762,s=1359893119,
...
ut",[]),P(k,"onePassHasher",new k);Ve=k});var qt={};ee(qt,{createHash:()=>zo,createHmac:()=>Yo,randomBytes:()=>Ko});function Ko(r){
...
set($e(o),64),d.from($e(u))}}}}}var Nt=V(()=>{"use strict";p();si();oi();a(Ko,"r\
andomBytes");a(zo,"createHash");a(Yo,"createHmac")});var jt=I(ai=>{"use strict";p();ai.parse=function(r,e){return new Qt(r,e).parse()};
...
entries}};a(ct,"ArrayParser");var Qt=ct;function Zo(r){return r}a(Zo,"identity")});var Wt=I((Sh,ui)=>{p();var Jo=jt();ui.exports={create:function(r,e){return{parse:function(){
return Jo.parse(r,e)}}}}});var li=I((Eh,hi)=>{"use strict";p();var Xo=/(\d{1,})-(\d{2})-(\d{2}) (\d{2}):(\d{2}):(\d{2})(\.\d{1,})?.*?( BC)?$/,
...
n)&&(r[n]=t[n])}return r}a(oa,"extend")});var mi=I((Ph,yi)=>{"use strict";p();var aa=pi();yi.exports=Fe;function Fe(r){if(!(this instanceof
...
"\\";n+=Math.floor(i/2)*2}return new d(t,"binary")},"parseBytea")});var Ai=I((Mh,_i)=>{p();var Ke=jt(),ze=Wt(),ht=li(),Si=mi(),xi=wi();function lt(r){
...
r==="1"}a(Ei,"parseBool");function Sa(r){return r?Ke.parse(r,Ei):null}a(Sa,"pars\
eBoolArray");function xa(r){return parseInt(r,10)}a(xa,"parseBaseTenInt");function $t(r){
return r?Ke.parse(r,lt(xa)):null}a($t,"parseIntegerArray");function Ea(r){return r?
Ke.parse(r,lt(function(e){return vi(e).trim()})):null}a(Ea,"parseBigIntegerArray");
...
ht),r(1114,ht),r(1184,ht),r(600,Yt),r(651,re),r(718,Ca),r(1e3,Sa),r(1001,Aa),r(1005,
$t),r(1007,$t),r(1028,$t),r(1016,Ea),r(1017,va),r(1021,Vt),r(1022,Vt),r(1231,Vt),
...
re),r(1270,re)},"init");_i.exports={init:Ia}});var Ii=I((kh,Ci)=>{"use strict";p();var Y=1e6;function Pa(r){var e=r.readInt32BE(
...
e%Y,o=4294967296*s+t,u=""+o%Y,n+u+i}a(Pa,"readInt8");Ci.exports=Pa});var Ri=I((Nh,Li)=>{p();var Ta=Ii(),R=a(function(r,e,t,n,i){t=t||0,n=n||!1,i=i||function(_,T,N){
...
r,31,1,!0)+1):R(r,31,1)},"parseInt32"),La=a(function(r){return Bi(r,23,8)},"pars\
...
null?null:R(r,8)>0},"parseBool"),Oa=a(function(r){r(20,Ta),r(21,Ba),r(23,Pi),r(26,
Pi),r(1700,Fa),r(700,La),r(701,Ra),r(16,Da),r(1114,Ti.bind(null,!1)),r(1184,Ti.bind(
...
REGCONFIG:3734,REGDICTIONARY:3769,JSONB:3802,REGNAMESPACE:4089,REGROLE:4096}});var Xe=I(Je=>{p();var ka=Ai(),Ua=Ri(),qa=Wt(),Na=Mi();Je.getTypeParser=Qa;Je.setTypeParser=
ja;Je.arrayParser=qa;Je.builtins=Na;var Ze={text:{},binary:{}};function Di(r){return String(
...
setTypeParser(1016,"text",r?Me.getTypeParser(1007,"text"):Ha)})});var tt=I((Yh,ki)=>{"use strict";p();var Ga=(Nt(),O(qt)),$a=et();function Va(r){var e=r.
...
toString("hex"):e+=Va(ft(r[t]));return e=e+"}",e}a(Oi,"arrayString");var ft=a(function(r,e){
...
e)},"prepareValueWrapper"),normalizeQueryConfig:Za,postgresMd5PasswordHash:Ja,md5:Jt}});var ji=I((Xh,Qi)=>{"use strict";p();var Xt=(Nt(),O(qt));function Xa(r){if(r.indexOf(
...
se",r.serverSignature=X.toString("base64"),r.response=l+",p="+T}a(eu,"continueSe\
...
ssage");function iu(r){let t=qi(r).get("v");if(t){if(!Ui(t))throw new Error("SAS\
...
a(ou,"Hi");Qi.exports={startSession:Xa,continueSession:eu,finalizeSession:tu}});var er={};ee(er,{join:()=>au});function au(...r){return r.join("/")}var tr=V(()=>{
"use strict";p();a(au,"join")});var rr={};ee(rr,{stat:()=>uu});function uu(r,e){e(new Error("No filesystem"))}var nr=V(
()=>{"use strict";p();a(uu,"stat")});var ir={};ee(ir,{default:()=>cu});var cu,sr=V(()=>{"use strict";p();cu={}});var Wi={};ee(Wi,{StringDecoder:()=>or});var ar,or,Hi=V(()=>{"use strict";p();ar=
...
or=ar});var Ki=I((cl,Vi)=>{"use strict";p();var{Transform:hu}=(sr(),O(ir)),{StringDecoder:lu}=(Hi(),O(Wi)),
be=Symbol("last"),pt=Symbol("decoder");function fu(r,e,t){let n;if(this.overflow){
...
let n=new hu(t);return n[be]="",n[pt]=new lu("utf8"),n.matcher=r,n.mapper=e,n.maxLength=
t.maxLength,n.skipOverflow=t.skipOverflow||!1,n.overflow=!1,n._destroy=function(i,s){
this._writableState.errorEmitted=!1,s(i)},n}a(du,"split");Vi.exports=du});var Zi=I((fl,pe)=>{"use strict";p();var zi=(tr(),O(er)),yu=(sr(),O(ir)).Stream,mu=Ki(),
Yi=(Ge(),O(He)),gu=5432,dt=m.platform==="win32",rt=m.stderr,wu=56,bu=7,Su=61440,
xu=32768;function Eu(r){return(r&Su)==xu}a(Eu,"isRegFile");var Oe=["host","port",
"database","user","password"],ur=Oe.length,vu=Oe[ur-1];function cr(){var r=rt instanceof
...
call(m.env,"PGPASSWORD")?!1:dt?!0:(e=e||"<unkn>",Eu(r.mode)?r.mode&(wu|bu)?(cr('\
...
e),!1))};var _u=pe.exports.match=function(r,e){return Oe.slice(0,-1).reduce(function(t,n,i){
return i==1&&Number(r[n]||gu)===Number(e[n])?t&&!0:t&&(e[n]==="*"||e[n]===r[n])},
!0)};pe.exports.getPassword=function(r,e,t){var n,i=e.pipe(mu());function s(c){var h=Au(
...
u)};var Au=pe.exports.parseLine=function(r){if(r.length<11||r.match(/^\s+#/))return null;
...
Object.keys(o).length===ur?o:null,o},Cu=pe.exports.isValidEntry=function(r){for(var e={
...
"text",this.getOverrides(e)[r]||this._types.getTypeParser(r,e)};es.exports=mt});var ts={};ee(ts,{default:()=>Pu});var Pu,rs=V(()=>{"use strict";p();Pu={}});var ns={};ee(ns,{parse:()=>fr});function fr(r,e=!1){let{protocol:t}=new URL(r),n="\
...
()=>{"use strict";p();a(fr,"parse")});var ss=I((_l,is)=>{"use strict";p();var Tu=(pr(),O(ns)),dr=(nr(),O(rr));function yr(r){
...
return t}a(yr,"parse");is.exports=yr;yr.parse=yr});var gt=I((Il,us)=>{"use strict";p();var Bu=(rs(),O(ts)),as=et(),os=ss().parse,K=a(
...
teParamValue"),Ru=a(function(r){return r.split(".")[0]},"extractProjectValue"),ne=a(
...
" ")))})}};a(gr,"ConnectionParameters");var mr=gr;us.exports=mr});var ls=I((Bl,hs)=>{"use strict";p();var Fu=Xe(),cs=/^([A-Za-z]+)(?: (\d+))?(?: (\d+))?/,
...
ext"):this._parsers[t]=Fu.getTypeParser(n.dataTypeID,n.format||"text")}}};a(br,"\
Result");var wr=br;hs.exports=wr});var ys=I((Fl,ds)=>{"use strict";p();var{EventEmitter:Mu}=we(),fs=ls(),ps=tt(),xr=class xr extends Mu{constructor(e,t,n){
...
var Sr=xr;ds.exports=Sr});var bs={};ee(bs,{Socket:()=>Se,isIP:()=>Du,isNeonHost:()=>Er});function Du(r){return 0}
var gs,ws,Er,ms,x,Se,wt=V(()=>{"use strict";p();gs=je(we(),1);a(Du,"isIP");ws=/^(?:ep-)?([a-z]+)-([a-z]+)-(\w+)/,
Er=a(r=>ws.test(r),"isNeonHost"),ms=a(r=>r.replace(ws,"api"),"transformHost"),x=
...
Or});var Ss=I(bt=>{"use strict";p();Object.defineProperty(bt,"__esModule",{value:!0});
...
iter");var Jr=Xr;bt.Writer=Jr});var Es=I(xt=>{"use strict";p();Object.defineProperty(xt,"__esModule",{value:!0});
xt.serialize=void 0;var en=Ss(),F=new en.Writer,Ou=a(r=>{F.addInt16(3).addInt16(
...
r=>F.addCString(r).flush(81),"query"),xs=[],ju=a(r=>{let e=r.name||"";e.length>63&&
...
flush(80)},"parse"),Ue=new en.Writer,Wu=a(function(r,e){for(let t=0;t<r.length;t++){
...
"",n=r.binary||!1,i=r.values||xs,s=i.length;return F.addCString(e).addCString(t),
...
Yu=a(r=>r.name?tn(68,`${r.type}${r.name||""}`):r.type==="P"?Ku:zu,"describe"),Zu=a(
...
copyData:Ju,copyDone:()=>nc,copyFail:Xu,cancel:Vu};xt.serialize=ic});var vs=I(Et=>{"use strict";p();Object.defineProperty(Et,"__esModule",{value:!0});
...
rn});var _s={};ee(_s,{default:()=>oc});var oc,As=V(()=>{"use strict";p();oc={}});var Ps=I(qe=>{"use strict";p();var ac=qe&&qe.__importDefault||function(r){return r&&
r.__esModule?r:{default:r}};Object.defineProperty(qe,"__esModule",{value:!0});qe.
Parser=void 0;var M=Zr(),uc=vs(),cc=ac((As(),O(_s))),sn=1,hc=4,Cs=sn+hc,Is=d.allocUnsafe(
0),an=class an{constructor(e){if(this.buffer=Is,this.bufferLength=0,this.bufferOffset=
...
bufferOffset+this.bufferLength,i=this.bufferOffset;for(;i+Cs<=n;){let s=this.buffer[i],
o=this.buffer.readUInt32BE(i+sn),u=sn+o;if(u+i<=n){let c=this.handlePacket(i+Cs,
s,o,this.buffer);t(c),i+=u}else break}i===n?(this.buffer=Is,this.bufferLength=0,
...
xe,"DatabaseError",{enumerable:!0,get:function(){return lc.DatabaseError}});var fc=Es();
Object.defineProperty(xe,"serialize",{enumerable:!0,get:function(){return fc.serialize}});
var pc=Ps();function dc(r,e){let t=new pc.Parser;return r.on("data",n=>t.parse(n,
e)),new Promise(n=>r.on("end",()=>n()))}a(dc,"parse");xe.parse=dc});var Ts={};ee(Ts,{connect:()=>yc});function yc({socket:r,servername:e}){return r.
startTls(e),r}var Bs=V(()=>{"use strict";p();a(yc,"connect")});var ln=I((of,Fs)=>{"use strict";p();var Ls=(wt(),O(bs)),mc=we().EventEmitter,{parse:gc,
serialize:q}=un(),Rs=q.flush(),wc=q.sync(),bc=q.end(),hn=class hn extends mc{constructor(e){
...
nnection"))}var u=(Bs(),O(Ts));let c={socket:n.stream};n.ssl!==!0&&(Object.assign(
...
_send(q.execute(e))}flush(){this.stream.writable&&this.stream.write(Rs)}sync(){this.
...
this._send(q.copyFail(e))}};a(hn,"Connection");var cn=hn;Fs.exports=cn});var Os=I((hf,Ds)=>{"use strict";p();var Sc=we().EventEmitter,cf=(Ge(),O(He)),xc=tt(),
fn=ji(),Ec=Xi(),vc=lr(),_c=gt(),Ms=ys(),Ac=et(),Cc=ln(),pn=class pn extends Sc{constructor(e){
...
Ms;Ds.exports=vt});var Ns=I((pf,qs)=>{"use strict";p();var Ic=we().EventEmitter,ks=a(function(){},"\
...
o),t.callback(u,c,h)},"queueCallback"),s=new Ne(i),o=setTimeout(()=>{Us(this._pendingQueue,
...
length}};a(wn,"Pool");var yn=wn;qs.exports=yn});var Qs={};ee(Qs,{default:()=>Bc});var Bc,js=V(()=>{"use strict";p();Bc={}});var Ws=I((gf,Lc)=>{Lc.exports={name:"pg",version:"8.8.0",description:"PostgreSQL\
...
7b9a5491a178655"}});var $s=I((wf,Gs)=>{"use strict";p();var Hs=we().EventEmitter,Rc=(Ge(),O(He)),bn=tt(),
Qe=Gs.exports=function(r,e,t){Hs.call(this),r=bn.normalizeQueryConfig(r,e,t),this.
...
Qe,Hs);var Fc={sqlState:"code",statementPosition:"position",messagePrimary:"mess\
...
text,t)}});var Ys=I((Ef,zs)=>{"use strict";p();var Mc=(js(),O(Qs)),Dc=lr(),xf=Ws(),Vs=we().
EventEmitter,Oc=(Ge(),O(He)),kc=gt(),Ks=$s(),Z=zs.exports=function(r){Vs.call(this),
...
e.port,this.namedQueries={}};Z.Query=Ks;Oc.inherits(Z,Vs);Z.prototype._errorAllQueries=
...
_types.getTypeParser(r,e)}});var Sn=I((Af,Zs)=>{"use strict";p();Zs.exports=Ys()});var At=I((If,nt)=>{"use strict";p();var Uc=Os(),qc=et(),Nc=ln(),Qc=Ns(),{DatabaseError:jc}=un(),
...
exports=O($c);p();var It=je(At());wt();p();pr();wt();var eo=je(tt());var vn=class vn extends Error{constructor(){super(...arguments);P(this,"name","N\
eonDbError");P(this,"code",null);P(this,"sourceError")}};a(vn,"NeonDbError");var Ee=vn,
Js="transaction() expects an array of queries, or a function returning an array \
...
g=g.map(j=>(0,eo.prepareValue)(j));let Q={query:D,params:g};return u&&u(Q),Hc(de,
Q,H)}a(X,"resolve"),X.transaction=async(A,g)=>{if(typeof A=="function"&&(A=A(X)),
!Array.isArray(A))throw new Error(Js);let D=A.map(H=>{if(H[Symbol.toStringTag]!==
"NeonQueryPromise")throw new Error(Js);return H.parameterizedQuery});return de(D,
...
ternal error: unexpected result format");return $.map((ie,Ce)=>Xs(ie,{arrayMode:L,
fullResults:G,parameterizedQuery:A[Ce],resultCallback:c}))}else return Xs(oe,{arrayMode:L,
...
e,t).catch(n),finally:n=>r(e,t).finally(n)}}a(Hc,"createNeonQueryPromise");function Xs(r,{
...
t?(r.viaNeonFetch=!0,r.rowAsArray=e,r.rows=u,r):u}a(Xs,"processQueryResult");var to=je(gt()),J=je(At());var An=class An extends It.Client{constructor(t){super(t);this.config=t}get neonConfig(){
