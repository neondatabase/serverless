...
"getLens");function co(r){var e=Ln(r),t=e[0],n=e[1];return(t+n)*3/4-n}a(co,"byte\
Length");function ho(r,e,t){return(e+t)*3/4-t}a(ho,"_byteLength");function lo(r){
var e,t=Ln(r),n=t[0],i=t[1],s=new uo(ho(r,n,i)),o=0,u=i>0?n-4:n,c;for(c=0;c<u;c+=
...
i-=8);for(o=o<<i|u,h+=i;h>0;r[t+C]=o&255,C+=B,o/=256,h-=8);r[t+C-B]|=Q*128}});var Yn=I(Re=>{"use strict";p();var kt=Rn(),Be=Fn(),Mn=typeof Symbol=="function"&&
...
i=!0}}a(qn,"byteLength");f.byteLength=qn;function Eo(r,e,t){let n=!1;if((e===void 0||
...
return o;r[t+o]=u}return o}a(vo,"hexWrite");function _o(r,e,t,n){return at(Ot(e,
...
length),Be.read(this,e,!1,52,8)},"readDoubleBE");function z(r,e,t,n,i,s){if(!f.isBuffer(
...
t)}${e}`}a(Un,"addNumericalSeparator");function Mo(r,e,t){Le(e,"offset"),(r[e]===
...
"value",u,r)}Mo(n,i,s)}a(Kn,"checkIntBI");function Le(r,e){if(typeof r!="number")
...
L;jt.exports.once=Go;L.EventEmitter=L;L.prototype._events=void 0;L.prototype._eventsCount=
...
listener:t},i=Wo.bind(n);return i.listener=t,n.wrapFn=i,i}a(ri,"_onceWrap");L.prototype.
...
"function"?t?[i.listener||i]:[i]:t?Ho(i):si(i,i.length)}a(ni,"_listeners");L.prototype.
...
$+le+d[R]+C[R]|0,Ee=b(A,2)^b(A,13)^b(A,22),We=A&g^A&P^g&P,fe=Ee+We|0;ae=X,X=W,W=
...
ye=a(()=>{if(B[l++]=128,l==64&&Q(),l+8>64){for(;l<64;)B[l++]=0;Q()}for(;l<58;)B[l++]=
...
o),n},{})}a(ba,"parse")});var wi=I((vh,gi)=>{"use strict";p();gi.exports=a(function(e){if(/^\\x/.test(e))return new y(
...
return r?Ke.parse(r,ft(xa)):null}a(Zt,"parseIntegerArray");function Ea(r){return r?
Ke.parse(r,ft(function(e){return vi(e).trim()})):null}a(Ea,"parseBigIntegerArray");
...
vi),r(21,er),r(23,er),r(26,er),r(700,parseFloat),r(701,parseFloat),r(16,Ei),r(1082,
lt),r(1114,lt),r(1184,lt),r(600,tr),r(651,ie),r(718,Ca),r(1e3,Sa),r(1001,Aa),r(1005,
Zt),r(1007,Zt),r(1028,Zt),r(1016,Ea),r(1017,va),r(1021,Jt),r(1022,Jt),r(1231,Jt),
...
e%Y,o=4294967296*s+t,u=""+o%Y,n+u+i}a(Ia,"readInt8");Ci.exports=Ia});var Ri=I((Rh,Li)=>{p();var Pa=Ti(),F=a(function(r,e,t,n,i){t=t||0,n=n||!1,i=i||function(C,B,Q){
...
null?null:F(r,8)>0},"parseBool"),Da=a(function(r){r(20,Pa),r(21,Ba),r(23,Ii),r(26,
Ii),r(1700,Fa),r(700,La),r(701,Ra),r(16,ka),r(1114,Pi.bind(null,!1)),r(1184,Pi.bind(
null,!0)),r(1e3,Ye),r(1007,Ye),r(1016,Ye),r(1008,Ye),r(1009,Ye),r(25,Ma)},"init");
Li.exports={init:Da}});var Mi=I((kh,Fi)=>{p();Fi.exports={BOOL:16,BYTEA:17,CHAR:18,INT8:20,INT2:21,INT4:23,
...
o,b),B=C.toString("base64"),Q=De(s,"Server Key"),J=De(Q,d);r.message="SASLRespon\
...
xu=32768;function Eu(r){return(r&Su)==xu}a(Eu,"isRegFile");var Ue=["host","port",
"database","user","password"],pr=Ue.length,vu=Ue[pr-1];function dr(){var r=rt instanceof
...
<unkn>",Eu(r.mode)?r.mode&(wu|bu)?(dr('WARNING: password file "%s" has group or \
...
search:l,query:B,hash:b}}var gr=te(()=>{"use strict";p();a(mr,"parse")});var ss=I((ml,is)=>{"use strict";p();var Pu=(gr(),O(ns)),wr=(ur(),O(ar));function br(r){
...
return t}a(br,"parse");is.exports=br;br.parse=br});var bt=I((bl,us)=>{"use strict";p();var Bu=(rs(),O(ts)),as=et(),os=ss().parse,V=a(
...
ent_encoding="+Oe(this.client_encoding)),Bu.lookup(this.host,function(i,s){return i?
e(i,null):(t.push("hostaddr="+Oe(s)),e(null,t.join(" ")))})}};a(xr,"ConnectionPa\
rameters");var Sr=xr;us.exports=Sr});var ls=I((El,hs)=>{"use strict";p();var Ru=Xe(),cs=/^([A-Za-z]+)(?: (\d+))?(?: (\d+))?/,
...
Result");var Er=vr;hs.exports=Er});var ys=I((Al,ds)=>{"use strict";p();var{EventEmitter:Fu}=we(),fs=ls(),ps=tt(),Ar=class Ar extends Fu{constructor(e,t,n){
...
var _r=Ar;ds.exports=_r});var ws={};re(ws,{Socket:()=>Se,isIP:()=>Mu});function Mu(r){return 0}var gs,ms,E,
Se,St=te(()=>{"use strict";p();gs=Ie(we(),1);a(Mu,"isIP");ms=/^[^.]+\./,E=class E extends gs.EventEmitter{constructor(){
...
rootCerts:"",pipelineTLS:!1,disableSNI:!1}),_(E,"opts",{});Se=E});var en=I(T=>{"use strict";p();Object.defineProperty(T,"__esModule",{value:!0});T.
...
iter");var tn=rn;xt.Writer=tn});var xs=I(vt=>{"use strict";p();Object.defineProperty(vt,"__esModule",{value:!0});
vt.serialize=void 0;var nn=bs(),M=new nn.Writer,ku=a(r=>{M.addInt16(3).addInt16(
...
100),"copyData"),Ju=a(r=>sn(102,r),"copyFail"),Et=a(r=>y.from([r,0,0,0,4]),"code\
...
cancel:$u};vt.serialize=nc});var Es=I(_t=>{"use strict";p();Object.defineProperty(_t,"__esModule",{value:!0});
...
At.Parser=void 0;var k=en(),sc=Es(),un=1,oc=4,vs=un+oc,_s=y.allocUnsafe(0),hn=class hn{constructor(e){
...
i+un),u=un+o;if(u+i<=n){let c=this.handlePacket(i+vs,s,o,this.buffer);t(c),i+=u}else
...
startTls(e),r}var Ts=te(()=>{"use strict";p();a(lc,"connect")});var dn=I((Yl,Bs)=>{"use strict";p();var Is=(St(),O(ws)),fc=we().EventEmitter,{parse:pc,
...
this._send(q.copyFail(e))}};a(pn,"Connection");var fn=pn;Bs.exports=fn});var Fs=I((ef,Rs)=>{"use strict";p();var mc=we().EventEmitter,Xl=(Ge(),O(He)),gc=tt(),
yn=Wi(),wc=Xi(),bc=wt(),Sc=bt(),Ls=ys(),xc=et(),Ec=dn(),mn=class mn extends mc{constructor(e){
...
Ls;Rs.exports=Ct});var Us=I((nf,Ds)=>{"use strict";p();var vc=we().EventEmitter,Ms=a(function(){},"\
...
"idleListener")}a(Ac,"makeIdleListener");var xn=class xn extends vc{constructor(e,t){
...
7b9a5491a178655"}});var js=I((cf,Ws)=>{"use strict";p();var Qs=we().EventEmitter,Ic=(Ge(),O(He)),En=tt(),
Qe=Ws.exports=function(r,e,t){Qs.call(this),r=En.normalizeQueryConfig(r,e,t),this.
...
text,t)}});var Vs=I((pf,$s)=>{"use strict";p();var Bc=(Ns(),O(Os)),Lc=wt(),ff=qs(),Hs=we().
...
_types.getTypeParser(r,e)}});var vn=I((mf,Ks)=>{"use strict";p();Ks.exports=Vs()});var It=I((wf,nt)=>{"use strict";p();var Mc=Fs(),kc=et(),Dc=dn(),Uc=Us(),{DatabaseError:Oc}=ln(),
...
exports=new _n(vn()):(nt.exports=new _n(Mc),Object.defineProperty(nt.exports,"na\
...
native",{value:r}),r}}))});var Gc={};re(Gc,{Client:()=>Bt,ClientBase:()=>oe.ClientBase,Connection:()=>oe.Connection,
...
exports=O(Gc);p();var Lt=Ie(It());St();p();St();gr();var Zs=Ie(tt()),Js=Ie(wt());function qc(r){return r instanceof y?"\\x"+r.toString("hex"):r}a(qc,"encodeBuffe\
...
g)&&g.fetchOptions!==void 0&&(X={...X,...g.fetchOptions});let Ee=h;!Array.isArray(
g)&&g?.authToken!==void 0&&(Ee=g.authToken);let We=typeof K=="function"?K(C,B,{jwtAuth:Ee!==
void 0}):K,fe={"Neon-Connection-String":r,"Neon-Raw-Text-Output":"true","Neon-Ar\
ray-Mode":"true"},it=await jc(Ee);it&&(fe.Authorization=`Bearer ${it}`),Array.isArray(
...
map((Ce,ve)=>{let Rt=g[ve]??{},eo=Rt.arrayMode??ae,to=Rt.fullResults??R;return Ys(
Ce,{arrayMode:eo,fullResults:to,parameterizedQuery:A[ve],resultCallback:c,types:Rt.
types})})}else{let H=g??{},Ce=H.arrayMode??ae,ve=H.fullResults??R;return Ys(j,{arrayMode:Ce,
fullResults:ve,parameterizedQuery:A,resultCallback:c,types:H.types})}}else{let{status:j}=ee;
if(j===400){let H=await ee.json(),Ce=new he(H.message);for(let ve of Qc)Ce[ve]=H[ve]??
...
n: ${e.message}`)),t}}a(jc,"getAuthToken");var Xs=Ie(bt()),oe=Ie(It());var Tn=class Tn extends Lt.Client{constructor(t){super(t);this.config=t}get neonConfig(){
...
from(P.map((ee,j)=>P[j]^$[j])),me=le.toString("base64");let Ee=await w.subtle.importKey(
"raw",A,{name:"HMAC",hash:{name:"SHA-256"}},!1,["sign"]),We=await w.subtle.sign(
"HMAC",Ee,b.encode("Server Key")),fe=await w.subtle.importKey("raw",We,{name:"HM\
...
response)}};a(Tn,"NeonClient");var Bt=Tn;function Hc(r,e){if(e)return{callback:e,
result:void 0};let t,n,i=a(function(o,u){o?t(o):n(u)},"cb"),s=new r(function(o,u){
n=o,t=u});return{callback:i,result:s}}a(Hc,"promisify");var In=class In extends Lt.Pool{constructor(){
