...
value:r,enumerable:!0}):t,r)),N=r=>Pn(Te({},"__esModule",{value:!0}),r);var A=(r,e,t)=>co(r,typeof e!="symbol"?e+"":e,t);var Rn=I(st=>{"use strict";p();st.byteLength=lo;st.toByteArray=po;st.fromByteArray=
go;var ue=[],re=[],ho=typeof Uint8Array<"u"?Uint8Array:Array,Ft="ABCDEFGHIJKLMNO\
PQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";for(Ae=0,Ln=Ft.length;Ae<Ln;++Ae)
ue[Ae]=Ft[Ae],re[Ft.charCodeAt(Ae)]=Ae;var Ae,Ln;re[45]=62;re[95]=63;function Bn(r){
...
"getLens");function lo(r){var e=Bn(r),t=e[0],n=e[1];return(t+n)*3/4-n}a(lo,"byte\
Length");function fo(r,e,t){return(e+t)*3/4-t}a(fo,"_byteLength");function po(r){
var e,t=Bn(r),n=t[0],i=t[1],s=new ho(fo(r,n,i)),o=0,u=i>0?n-4:n,c;for(c=0;c<u;c+=
...
i-=8);for(o=o<<i|u,h+=i;h>0;r[t+_]=o&255,_+=L,o/=256,h-=8);r[t+_-L]|=G*128}});var Yn=I(Re=>{"use strict";p();var kt=Rn(),Le=Fn(),Mn=typeof Symbol=="function"&&
typeof Symbol.for=="function"?Symbol.for("nodejs.util.inspect.custom"):null;Re.Buffer=
f;Re.SlowBuffer=Eo;Re.INSPECT_MAX_BYTES=50;var ot=2147483647;Re.kMaxLength=ot;f.
...
0,n=pe(t),i=n.write(r,e);return i!==t&&(n=n.slice(0,i)),n}a(So,"fromString");function Dt(r){
let e=r.length<0?0:qt(r.length)|0,t=pe(e);for(let n=0;n<e;n+=1)t[n]=r[n]&255;return t}
a(Dt,"fromArrayLike");function xo(r){if(ce(r,Uint8Array)){let e=new Uint8Array(r);
return Ut(e.buffer,e.byteOffset,e.byteLength)}return Dt(r)}a(xo,"fromArrayView");
...
return typeof r.length!="number"||Wt(r.length)?pe(0):Dt(r);if(r.type==="Buffer"&&
Array.isArray(r.data))return Dt(r.data)}a(vo,"fromObject");function qt(r){if(r>=
ot)throw new RangeError("Attempt to allocate Buffer larger than maximum size: 0x"+
ot.toString(16)+" bytes");return r|0}a(qt,"checked");function Eo(r){return+r!=r&&
...
this,e,t);case"utf8":case"utf-8":return Wn(this,e,t);case"ascii":return Ro(this,
e,t);case"latin1":case"binary":return Fo(this,e,t);case"base64":return Lo(this,e,
...
_o,"slowToString");f.prototype._isBuffer=!0;function Ce(r,e,t){let n=r[e];r[e]=r[t],
...
if(c(r,h+d)!==c(e,d)){l=!1;break}if(l)return h}return-1}a(kn,"arrayIndexOf");f.prototype.
...
length?kt.fromByteArray(r):kt.fromByteArray(r.slice(e,t))}a(Lo,"base64Slice");function Wn(r,e,t){
...
o&1023),n.push(o),i+=u}return Bo(n)}a(Wn,"utf8Slice");var Dn=4096;function Bo(r){
...
writeBigInt64BE=we(a(function(e,t=0){return Hn(this,e,t,-BigInt("0x8000000000000\
...
this,e,t,!1,n)},"writeFloatBE");function Kn(r,e,t,n,i){return e=+e,t=t>>>0,i||Gn(
...
t)}${e}`}a(Un,"addNumericalSeparator");function Do(r,e,t){Be(e,"offset"),(r[e]===
void 0||r[e+t]===void 0)&&je(e,r.length-(t+1))}a(Do,"checkBounds");function Vn(r,e,t,n,i,s){
...
"value",u,r)}Do(n,i,s)}a(Vn,"checkIntBI");function Be(r,e){if(typeof r!="number")
...
1:0} and <= ${e}`,r)}a(je,"boundsError");var Uo=/[^+/0-9A-Za-z-_]/g;function Oo(r){
...
a(qo,"utf16leToBytes");function zn(r){return kt.toByteArray(Oo(r))}a(zn,"base64T\
...
a(ce,"isInstance");function Wt(r){return r!==r}a(Wt,"numberIsNaN");var Qo=function(){
let r="0123456789abcdef",e=new Array(256);for(let t=0;t<16;++t){let n=t*16;for(let i=0;i<
16;++i)e[n+i]=r[t]+r[i]}return e}();function we(r){return typeof BigInt>"u"?Wo:r}
a(we,"defineBigIntMethod");function Wo(){throw new Error("BigInt not supported")}
a(Wo,"BufferBigIntNotDefined")});var b,x,v,w,y,m,p=z(()=>{"use strict";b=globalThis,x=globalThis.setImmediate??(r=>setTimeout(
...
e.then.bind(e)}});var be=I((oh,jt)=>{"use strict";p();var Fe=typeof Reflect=="object"?Reflect:null,
...
e},"NumberIsNaN");function B(){B.init.call(this)}a(B,"EventEmitter");jt.exports=
B;jt.exports.once=Ko;B.EventEmitter=B;B.prototype._events=void 0;B.prototype._eventsCount=
0;B.prototype._maxListeners=void 0;var Jn=10;function ct(r){if(typeof r!="functi\
...
"setMaxListeners");function ei(r){return r._maxListeners===void 0?B.defaultMaxListeners:
r._maxListeners}a(ei,"_getMaxListeners");B.prototype.getMaxListeners=a(function(){
return ei(this)},"getMaxListeners");B.prototype.emit=a(function(e){for(var t=[],
...
ener");B.prototype.addListener=a(function(e,t){return ti(this,e,t,!1)},"addListe\
...
listener:t},i=Ho.bind(n);return i.listener=t,n.wrapFn=i,i}a(ri,"_onceWrap");B.prototype.
once=a(function(e,t){return ct(t),this.on(e,ri(this,e,t)),this},"once");B.prototype.
...
"function"?t?[i.listener||i]:[i]:t?$o(i):si(i,i.length)}a(ni,"_listeners");B.prototype.
listeners=a(function(e){return ni(this,e,!0)},"listeners");B.prototype.rawListeners=
a(function(e){return ni(this,e,!1)},"rawListeners");B.listenerCount=function(r,e){
return typeof r.listenerCount=="function"?r.listenerCount(e):ii.call(r,e)};B.prototype.
...
e[t]=r[t].listener||r[t];return e}a($o,"unwrapListeners");function Ko(r,e){return new Promise(
function(t,n){function i(o){r.removeListener(e,s),n(o)}a(i,"errorListener");function s(){
typeof r.removeListener=="function"&&r.removeListener("error",i),t([].slice.call(
arguments))}a(s,"resolver"),oi(r,e,s,{once:!0}),e!=="error"&&Vo(r,i,{once:!0})})}
a(Ko,"once");function Vo(r,e,t){typeof r.on=="function"&&oi(r,"error",e,t)}a(Vo,
...
ed type '+typeof r)}a(oi,"eventTargetAgnosticAddListener")});var He={};te(He,{default:()=>zo});var zo,Ge=z(()=>{"use strict";p();zo={}});function $e(r){let e=1779033703,t=3144134277,n=1013904242,i=2773480762,s=1359893119,
...
15],7)^S(_[R-15],18)^_[R-15]>>>3,le=S(_[R-2],17)^S(_[R-2],19)^_[R-2]>>>10;_[R]=_[R-
16]+$+_[R-7]+le|0}let C=e,g=t,P=n,W=i,U=s,j=o,ee=u,ae=c;for(let R=0;R<64;R++){let $=S(
U,6)^S(U,11)^S(U,25),le=U&j^~U&ee,ye=ae+$+le+d[R]+_[R]|0,Ee=S(C,2)^S(C,13)^S(C,22),
We=C&g^C&P^g&P,fe=Ee+We|0;ae=ee,ee=j,j=U,U=W+ye|0,W=P,P=g,g=C,C=ye+fe|0}e=e+C|0,
t=t+g|0,n=n+P|0,i=i+W|0,s=s+U|0,o=o+j|0,u=u+ee|0,c=c+ae|0,l=0},"process"),X=a(C=>{
typeof C=="string"&&(C=new TextEncoder().encode(C));for(let g=0;g<C.length;g++)L[l++]=
C[g],l===64&&G();h+=C.length},"add"),oe=a(()=>{if(L[l++]=128,l==64&&G(),l+8>64){
...
g[31]=c&255,g},"digest");return r===void 0?{add:X,digest:oe}:(X(r),oe())}var ai=z(
()=>{"use strict";p();a($e,"sha256")});var O,Ke,ui=z(()=>{"use strict";p();O=class O{constructor(){A(this,"_dataLength",
...
ut",[]),A(O,"onePassHasher",new O);Ke=O});var Ht={};te(Ht,{createHash:()=>Jo,createHmac:()=>Xo,randomBytes:()=>Zo});function Zo(r){
...
64),y.from($e(u))},"digest")}},"update")}}var Yo,Gt=z(()=>{"use strict";p();ai();
ui();Yo="node:crypto";a(Zo,"randomBytes");a(Jo,"createHash");a(Xo,"createHmac")});var Kt=I(ci=>{"use strict";p();ci.parse=function(r,e){return new $t(r,e).parse()};
var ht=class ht{constructor(e,t){this.source=e,this.transform=t||ea,this.position=
...
entries}};a(ht,"ArrayParser");var $t=ht;function ea(r){return r}a(ea,"identity")});var Vt=I((Eh,hi)=>{p();var ta=Kt();hi.exports={create:a(function(r,e){return{parse:a(
function(){return ta.parse(r,e)},"parse")}},"create")}});var pi=I((Ch,fi)=>{"use strict";p();var ra=/(\d{1,})-(\d{2})-(\d{2}) (\d{2}):(\d{2}):(\d{2})(\.\d{1,})?.*?( BC)?$/,
na=/^(\d{1,})-(\d{2})-(\d{2})( BC)?$/,ia=/([Z+-])(\d{2})?:?(\d{2})?:?(\d{2})?/,sa=/^-?infinity$/;
fi.exports=a(function(e){if(sa.test(e))return Number(e.replace("i","I"));var t=ra.
exec(e);if(!t)return oa(e)||null;var n=!!t[8],i=parseInt(t[1],10);n&&(i=li(i));var s=parseInt(
t[2],10)-1,o=t[3],u=parseInt(t[4],10),c=parseInt(t[5],10),h=parseInt(t[6],10),l=t[7];
l=l?1e3*parseFloat(l):0;var d,S=aa(e);return S!=null?(d=new Date(Date.UTC(i,s,o,
u,c,h,l)),zt(i)&&d.setUTCFullYear(i),S!==0&&d.setTime(d.getTime()-S)):(d=new Date(
i,s,o,u,c,h,l),zt(i)&&d.setFullYear(i)),d},"parseDate");function oa(r){var e=na.
...
e[3]||0,10)*60+parseInt(e[4]||0,10);return i*n*1e3}}a(aa,"timeZoneOffset");function li(r){
return-(r-1)}a(li,"bcYearToNegativeYear");function zt(r){return r>=0&&r<100}a(zt,
"is0To99")});var yi=I((Ph,di)=>{p();di.exports=ca;var ua=Object.prototype.hasOwnProperty;function ca(r){
for(var e=1;e<arguments.length;e++){var t=arguments[e];for(var n in t)ua.call(t,
n)&&(r[n]=t[n])}return r}a(ca,"extend")});var wi=I((Rh,gi)=>{"use strict";p();var ha=yi();gi.exports=Me;function Me(r){if(!(this instanceof
Me))return new Me(r);ha(this,va(r))}a(Me,"PostgresInterval");var la=["seconds","\
minutes","hours","days","months","years"];Me.prototype.toPostgres=function(){var r=la.
...
M",seconds:"S"},pa=["years","months","days"],da=["hours","minutes","seconds"];Me.
prototype.toISOString=Me.prototype.toISO=function(){var r=pa.map(t,this).join(""),
e=da.map(t,this).join("");return"P"+r+"T"+e;function t(n){var i=this[n]||0;return n===
...
o),n},{})}a(va,"parse")});var Si=I((kh,bi)=>{"use strict";p();bi.exports=a(function(e){if(/^\\x/.test(e))return new y(
...
"\\";n+=Math.floor(i/2)*2}return new y(t,"binary")},"parseBytea")});var Ti=I((Oh,Ci)=>{p();var Ve=Kt(),ze=Vt(),lt=pi(),vi=wi(),Ei=Si();function ft(r){
...
r==="1"}a(_i,"parseBool");function Ea(r){return r?Ve.parse(r,_i):null}a(Ea,"pars\
eBoolArray");function _a(r){return parseInt(r,10)}a(_a,"parseBaseTenInt");function Zt(r){
return r?Ve.parse(r,ft(_a)):null}a(Zt,"parseIntegerArray");function Aa(r){return r?
Ve.parse(r,ft(function(e){return Ai(e).trim()})):null}a(Aa,"parseBigIntegerArray");
...
return r?Ve.parse(r,ft(Ei)):null},"parseByteAArray"),er=a(function(r){return parseInt(
r,10)},"parseInteger"),Ai=a(function(r){var e=String(r);return/^\d+$/.test(e)?e:
r},"parseBigInteger"),xi=a(function(r){return r?Ve.parse(r,ft(JSON.parse)):null},
...
var s=tr(e);return s.radius=parseFloat(t),s},"parseCircle"),La=a(function(r){r(20,
Ai),r(21,er),r(23,er),r(26,er),r(700,parseFloat),r(701,parseFloat),r(16,_i),r(1082,
lt),r(1114,lt),r(1184,lt),r(600,tr),r(651,ne),r(718,Pa),r(1e3,Ea),r(1001,Ia),r(1005,
Zt),r(1007,Zt),r(1028,Zt),r(1016,Aa),r(1017,Ca),r(1021,Jt),r(1022,Jt),r(1231,Jt),
...
ne),r(1270,ne)},"init");Ci.exports={init:La}});var Pi=I((Qh,Ii)=>{"use strict";p();var Z=1e6;function Ba(r){var e=r.readInt32BE(
...
e%Z,o=4294967296*s+t,u=""+o%Z,n+u+i}a(Ba,"readInt8");Ii.exports=Ba});var Mi=I((Hh,Fi)=>{p();var Ra=Pi(),F=a(function(r,e,t,n,i){t=t||0,n=n||!1,i=i||function(_,L,G){
...
(h=i(h,o(r[l])>>8-S,S)),h},"parseBits"),Ri=a(function(r,e,t){var n=Math.pow(2,t-
...
-1)*Math.pow(2,s-n)*c},"parseFloatFromBits"),Fa=a(function(r){return F(r,1)==1?-1*
(F(r,15,1,!0)+1):F(r,15,1)},"parseInt16"),Li=a(function(r){return F(r,1)==1?-1*(F(
r,31,1,!0)+1):F(r,31,1)},"parseInt32"),Ma=a(function(r){return Ri(r,23,8)},"pars\
eFloat32"),ka=a(function(r){return Ri(r,52,11)},"parseFloat64"),Da=a(function(r){
...
ay"),Ua=a(function(r){return r.toString("utf8")},"parseText"),Oa=a(function(r){return r===
null?null:F(r,8)>0},"parseBool"),Na=a(function(r){r(20,Ra),r(21,Fa),r(23,Li),r(26,
Li),r(1700,Da),r(700,Ma),r(701,ka),r(16,Oa),r(1114,Bi.bind(null,!1)),r(1184,Bi.bind(
null,!0)),r(1e3,Ye),r(1007,Ye),r(1016,Ye),r(1008,Ye),r(1009,Ye),r(25,Ua)},"init");
Fi.exports={init:Na}});var Di=I((Kh,ki)=>{p();ki.exports={BOOL:16,BYTEA:17,CHAR:18,INT8:20,INT2:21,INT4:23,
...
REGCONFIG:3734,REGDICTIONARY:3769,JSONB:3802,REGNAMESPACE:4089,REGROLE:4096}});var Xe=I(Je=>{p();var qa=Ti(),Qa=Mi(),Wa=Vt(),ja=Di();Je.getTypeParser=Ha;Je.setTypeParser=
Ga;Je.arrayParser=Wa;Je.builtins=ja;var Ze={text:{},binary:{}};function Ui(r){return String(
r)}a(Ui,"noParse");function Ha(r,e){return e=e||"text",Ze[e]&&Ze[e][r]||Ui}a(Ha,
"getTypeParser");function Ga(r,e,t){typeof e=="function"&&(t=e,e="text"),Ze[e][r]=
t}a(Ga,"setTypeParser");qa.init(function(r,e){Ze.text[r]=e});Qa.init(function(r,e){
Ze.binary[r]=e})});var et=I((Jh,rr)=>{"use strict";p();rr.exports={host:"localhost",user:m.platform===
...
connect_timeout:0,keepalives:1,keepalives_idle:0};var ke=Xe(),$a=ke.getTypeParser(
20,"text"),Ka=ke.getTypeParser(1016,"text");rr.exports.__defineSetter__("parseIn\
t8",function(r){ke.setTypeParser(20,"text",r?ke.getTypeParser(23,"text"):$a),ke.
setTypeParser(1016,"text",r?ke.getTypeParser(1007,"text"):Ka)})});var tt=I((el,Ni)=>{"use strict";p();var Va=(Gt(),N(Ht)),za=et();function Ya(r){var e=r.
...
toString("hex"):e+=Ya(pt(r[t]));return e=e+"}",e}a(Oi,"arrayString");var pt=a(function(r,e){
...
Xa(r):Ja(r):Array.isArray(r)?Oi(r):typeof r=="object"?Za(r,e):r.toString()},"pre\
...
e)},"prepareValueWrapper"),normalizeQueryConfig:eu,postgresMd5PasswordHash:tu,md5:nr}});var Hi=I((nl,ji)=>{"use strict";p();var ir=(Gt(),N(Ht));function ru(r){if(r.indexOf(
...
i,n.iteration),o=De(s,"Client Key"),u=uu(o),c="n=*,r="+r.clientNonce,h="r="+n.nonce+
",s="+n.salt+",i="+n.iteration,l="c=biws,r="+n.nonce,d=c+","+h+","+l,S=De(u,d),_=Wi(
o,S),L=_.toString("base64"),G=De(s,"Server Key"),X=De(G,d);r.message="SASLRespon\
se",r.serverSignature=X.toString("base64"),r.response=l+",p="+L}a(nu,"continueSe\
...
ssage");function au(r){let t=Qi(r).get("v");if(t){if(!qi(t))throw new Error("SAS\
...
"sha256").update(r).digest()}a(uu,"sha256");function De(r,e){return ir.createHmac(
"sha256",r).update(e).digest()}a(De,"hmacSha256");function cu(r,e,t){for(var n=De(
r,y.concat([e,y.from([0,0,0,1])])),i=n,s=0;s<t-1;s++)n=De(r,n),i=Wi(i,n);return i}
a(cu,"Hi");ji.exports={startSession:ru,continueSession:nu,finalizeSession:iu}});var sr={};te(sr,{join:()=>hu});function hu(...r){return r.join("/")}var or=z(()=>{
"use strict";p();a(hu,"join")});var ar={};te(ar,{stat:()=>lu});function lu(r,e){e(new Error("No filesystem"))}var ur=z(
()=>{"use strict";p();a(lu,"stat")});var cr={};te(cr,{default:()=>fu});var fu,hr=z(()=>{"use strict";p();fu={}});var Gi={};te(Gi,{StringDecoder:()=>lr});var fr,lr,$i=z(()=>{"use strict";p();fr=
...
lr=fr});var Yi=I((pl,zi)=>{"use strict";p();var{Transform:pu}=(hr(),N(cr)),{StringDecoder:du}=($i(),N(Gi)),
Se=Symbol("last"),dt=Symbol("decoder");function yu(r,e,t){let n;if(this.overflow){
...
if(this[Se]+=this[dt].end(),this[Se])try{Vi(this,this.mapper(this[Se]))}catch(e){
return r(e)}r()}a(mu,"flush");function Vi(r,e){e!==void 0&&r.push(e)}a(Vi,"push");
function Ki(r){return r}a(Ki,"noop");function gu(r,e,t){switch(r=r||/\r?\n/,e=e||
...
let n=new pu(t);return n[Se]="",n[dt]=new du("utf8"),n.matcher=r,n.mapper=e,n.maxLength=
t.maxLength,n.skipOverflow=t.skipOverflow||!1,n.overflow=!1,n._destroy=function(i,s){
this._writableState.errorEmitted=!1,s(i)},n}a(gu,"split");zi.exports=gu});var Xi=I((ml,de)=>{"use strict";p();var Zi=(or(),N(sr)),wu=(hr(),N(cr)).Stream,bu=Yi(),
Ji=(Ge(),N(He)),Su=5432,yt=m.platform==="win32",rt=m.stderr,xu=56,vu=7,Eu=61440,
_u=32768;function Au(r){return(r&Eu)==_u}a(Au,"isRegFile");var Ue=["host","port",
"database","user","password"],pr=Ue.length,Cu=Ue[pr-1];function dr(){var r=rt instanceof
...
<unkn>",Au(r.mode)?r.mode&(xu|vu)?(dr('WARNING: password file "%s" has group or \
...
return Ue.slice(0,-1).reduce(function(t,n,i){return i==1&&Number(r[n]||Su)===Number(
e[n])?t&&!0:t&&(e[n]==="*"||e[n]===r[n])},!0)};de.exports.getPassword=function(r,e,t){
var n,i=e.pipe(bu());function s(c){var h=Iu(c);h&&Pu(h)&&Tu(r,h)&&(n=h[Cu],i.end())}
...
"PGPASS_NO_DEESCAPE")||(_=_.replace(/\\([:\\])/g,"$1")),o[Ue[l]]=_},"addToObj"),
...
pr?o:null,o},Pu=de.exports.isValidEntry=function(r){for(var e={0:function(o){return o.
...
"",s=n(i);if(!s)return!1}return!0}});var ts=I((Sl,yr)=>{"use strict";p();var bl=(or(),N(sr)),es=(ur(),N(ar)),mt=Xi();
...
e)})};yr.exports.warnTo=mt.warnTo});var wt=I((vl,rs)=>{"use strict";p();var Lu=Xe();function gt(r){this._types=r||Lu,
...
"text",this.getOverrides(e)[r]||this._types.getTypeParser(r,e)};rs.exports=gt});var ns={};te(ns,{default:()=>Bu});var Bu,is=z(()=>{"use strict";p();Bu={}});var ss={};te(ss,{parse:()=>mr});function mr(r,e=!1){let{protocol:t}=new URL(r),n="\
...
search:l,query:L,hash:S}}var gr=z(()=>{"use strict";p();a(mr,"parse")});var as=I((Il,os)=>{"use strict";p();var Ru=(gr(),N(ss)),wr=(ur(),N(ar));function br(r){
if(r.charAt(0)==="/"){var t=r.split(" ");return{host:t[0],database:t[1]}}var e=Ru.
...
return t}a(br,"parse");os.exports=br;br.parse=br});var bt=I((Bl,hs)=>{"use strict";p();var Fu=(is(),N(ns)),cs=et(),us=as().parse,K=a(
...
(e=Object.assign({},e,us(e.connectionString))),this.user=K("user",e),this.database=
...
options=K("options",e),this.ssl=typeof e.ssl>"u"?Mu():e.ssl,typeof this.ssl=="st\
...
ent_encoding="+Oe(this.client_encoding)),Fu.lookup(this.host,function(i,s){return i?
e(i,null):(t.push("hostaddr="+Oe(s)),e(null,t.join(" ")))})}};a(xr,"ConnectionPa\
rameters");var Sr=xr;hs.exports=Sr});var ps=I((Ml,fs)=>{"use strict";p();var ku=Xe(),ls=/^([A-Za-z]+)(?: (\d+))?(?: (\d+))?/,
...
Result");var vr=Er;fs.exports=vr});var gs=I((Ul,ms)=>{"use strict";p();var{EventEmitter:Du}=be(),ds=ps(),ys=tt(),Ar=class Ar extends Du{constructor(e,t,n){
...
var _r=Ar;ms.exports=_r});var Ss={};te(Ss,{Socket:()=>xe,isIP:()=>Uu});function Uu(r){return 0}var bs,ws,E,
xe,St=z(()=>{"use strict";p();bs=Ie(be(),1);a(Uu,"isIP");ws=/^[^.]+\./,E=class E extends bs.EventEmitter{constructor(){
...
rootCerts:"",pipelineTLS:!1,disableSNI:!1}),A(E,"opts",{});xe=E});var en=I(T=>{"use strict";p();Object.defineProperty(T,"__esModule",{value:!0});T.
...
this.dataTypeModifier=o,this.format=u}};a(jr,"Field");var Pr=jr;T.Field=Pr;var Hr=class Hr{constructor(e,t){
this.length=e,this.fieldCount=t,this.name="rowDescription",this.fields=new Array(
this.fieldCount)}};a(Hr,"RowDescriptionMessage");var Lr=Hr;T.RowDescriptionMessage=
Lr;var Gr=class Gr{constructor(e,t){this.length=e,this.parameterCount=t,this.name=
"parameterDescription",this.dataTypeIDs=new Array(this.parameterCount)}};a(Gr,"P\
arameterDescriptionMessage");var Br=Gr;T.ParameterDescriptionMessage=Br;var $r=class $r{constructor(e,t,n){
this.length=e,this.parameterName=t,this.parameterValue=n,this.name="parameterSta\
tus"}};a($r,"ParameterStatusMessage");var Rr=$r;T.ParameterStatusMessage=Rr;var Kr=class Kr{constructor(e,t){
this.length=e,this.salt=t,this.name="authenticationMD5Password"}};a(Kr,"Authenti\
cationMD5Password");var Fr=Kr;T.AuthenticationMD5Password=Fr;var Vr=class Vr{constructor(e,t,n){
this.length=e,this.processID=t,this.secretKey=n,this.name="backendKeyData"}};a(Vr,
"BackendKeyDataMessage");var Mr=Vr;T.BackendKeyDataMessage=Mr;var zr=class zr{constructor(e,t,n,i){
...
ForQuery"}};a(Yr,"ReadyForQueryMessage");var Dr=Yr;T.ReadyForQueryMessage=Dr;var Zr=class Zr{constructor(e,t){
...
iter");var tn=rn;xt.Writer=tn});var Es=I(Et=>{"use strict";p();Object.defineProperty(Et,"__esModule",{value:!0});
Et.serialize=void 0;var nn=xs(),M=new nn.Writer,Ou=a(r=>{M.addInt16(3).addInt16(
...
flush(80)},"parse"),Ne=new nn.Writer,Gu=a(function(r,e){for(let t=0;t<r.length;t++){
...
n)),Ne.addString(n))}},"writeValues"),$u=a((r={})=>{let e=r.portal||"",t=r.statement||
"",n=r.binary||!1,i=r.values||vs,s=i.length;return M.addCString(e).addCString(t),
M.addInt16(s),Gu(i,r.valueMapper),M.addInt16(s),M.add(Ne.flush()),M.addInt16(n?1:
0),M.flush(66)},"bind"),Ku=y.from([69,0,0,0,9,0,0,0,0,0]),Vu=a(r=>{if(!r||!r.portal&&
...
OnlyBuffer"),rc=vt(72),nc=vt(83),ic=vt(88),sc=vt(99),oc={startup:Ou,password:qu,
requestSsl:Nu,sendSASLInitialResponseMessage:Qu,sendSCRAMClientFinalMessage:Wu,query:ju,
parse:Hu,bind:$u,execute:Vu,describe:Ju,close:Xu,flush:a(()=>rc,"flush"),sync:a(
()=>nc,"sync"),end:a(()=>ic,"end"),copyData:ec,copyDone:a(()=>sc,"copyDone"),copyFail:tc,
cancel:zu};Et.serialize=oc});var _s=I(_t=>{"use strict";p();Object.defineProperty(_t,"__esModule",{value:!0});
_t.BufferReader=void 0;var ac=y.allocUnsafe(0),an=class an{constructor(e=0){this.
...
At.Parser=void 0;var k=en(),uc=_s(),un=1,cc=4,As=un+cc,Cs=y.allocUnsafe(0),hn=class hn{constructor(e){
...
line=s.L,c.routine=s.R,c}};a(hn,"Parser");var cn=hn;At.Parser=cn});var ln=I(ve=>{"use strict";p();Object.defineProperty(ve,"__esModule",{value:!0});
ve.DatabaseError=ve.serialize=ve.parse=void 0;var hc=en();Object.defineProperty(
ve,"DatabaseError",{enumerable:!0,get:a(function(){return hc.DatabaseError},"get")});
var lc=Es();Object.defineProperty(ve,"serialize",{enumerable:!0,get:a(function(){
return lc.serialize},"get")});var fc=Ts();function pc(r,e){let t=new fc.Parser;return r.
on("data",n=>t.parse(n,e)),new Promise(n=>r.on("end",()=>n()))}a(pc,"parse");ve.
parse=pc});var Is={};te(Is,{connect:()=>dc});function dc({socket:r,servername:e}){return r.
startTls(e),r}var Ps=z(()=>{"use strict";p();a(dc,"connect")});var dn=I((cf,Rs)=>{"use strict";p();var Ls=(St(),N(Ss)),yc=be().EventEmitter,{parse:mc,
serialize:Q}=ln(),Bs=Q.flush(),gc=Q.sync(),wc=Q.end(),pn=class pn extends yc{constructor(e){
...
nnection"))}var u=(Ps(),N(Is));let c={socket:n.stream};n.ssl!==!0&&(Object.assign(
...
_ending=!0,this._send(Bs),this._send(gc)}ref(){this.stream.ref()}unref(){this.stream.
...
this._send(Q.copyFail(e))}};a(pn,"Connection");var fn=pn;Rs.exports=fn});var ks=I((pf,Ms)=>{"use strict";p();var bc=be().EventEmitter,ff=(Ge(),N(He)),Sc=tt(),
yn=Hi(),xc=ts(),vc=wt(),Ec=bt(),Fs=gs(),_c=et(),Ac=dn(),mn=class mn extends bc{constructor(e){
...
t.connection||new Ac({stream:t.stream,ssl:this.connectionParameters.ssl,keepAlive:t.
...
Fs;Ms.exports=Ct});var Ns=I((mf,Os)=>{"use strict";p();var Cc=be().EventEmitter,Ds=a(function(){},"\
...
e}};a(Sn,"PendingItem");var qe=Sn;function Tc(){throw new Error("Release called \
...
length}};a(xn,"Pool");var wn=xn;Os.exports=wn});var qs={};te(qs,{default:()=>Pc});var Pc,Qs=z(()=>{"use strict";p();Pc={}});var Ws=I((Sf,Lc)=>{Lc.exports={name:"pg",version:"8.8.0",description:"PostgreSQL\
...
7b9a5491a178655"}});var Gs=I((xf,Hs)=>{"use strict";p();var js=be().EventEmitter,Bc=(Ge(),N(He)),vn=tt(),
Qe=Hs.exports=function(r,e,t){js.call(this),r=vn.normalizeQueryConfig(r,e,t),this.
...
Qe,js);var Rc={sqlState:"code",statementPosition:"position",messagePrimary:"mess\
...
if(e)for(var t in e){var n=Rc[t]||t;r[n]=e[t]}this.callback?this.callback(r):this.
...
text,t)}});var zs=I((Af,Vs)=>{"use strict";p();var Fc=(Qs(),N(qs)),Mc=wt(),_f=Ws(),$s=be().
EventEmitter,kc=(Ge(),N(He)),Dc=bt(),Ks=Gs(),J=Vs.exports=function(r){$s.call(this),
r=r||{},this._Promise=r.Promise||b.Promise,this._types=new Mc(r.types),this.native=
new Fc({types:this._types}),this._queryQueue=[],this._ending=!1,this._connecting=
...
e.port,this.namedQueries={}};J.Query=Ks;kc.inherits(J,$s);J.prototype._errorAllQueries=
...
query_timeout,n=new Ks(r,e,t),!n.callback){let c,h;i=new this._Promise((l,d)=>{c=
...
_types.getTypeParser(r,e)}});var En=I((If,Ys)=>{"use strict";p();Ys.exports=zs()});var It=I((Lf,nt)=>{"use strict";p();var Uc=ks(),Oc=et(),Nc=dn(),qc=Ns(),{DatabaseError:Qc}=ln(),
Wc=a(r=>{var e;return e=class extends qc{constructor(n){super(n,r)}},a(e,"BoundP\
ool"),e},"poolFactory"),_n=a(function(r){this.defaults=Oc,this.Client=r,this.Query=
...
exports=new _n(En()):(nt.exports=new _n(Uc),Object.defineProperty(nt.exports,"na\
tive",{configurable:!0,enumerable:!1,get(){var r=null;try{r=new _n(En())}catch(e){
if(e.code!=="MODULE_NOT_FOUND")throw e}return Object.defineProperty(nt.exports,"\
native",{value:r}),r}}))});var zc={};te(zc,{Client:()=>Lt,ClientBase:()=>se.ClientBase,Connection:()=>se.Connection,
DatabaseError:()=>se.DatabaseError,NeonDbError:()=>he,Pool:()=>Cn,Query:()=>se.Query,
defaults:()=>se.defaults,neon:()=>An,neonConfig:()=>xe,types:()=>se.types});module.
exports=N(zc);p();var Bt=Ie(It());St();p();St();gr();var Xs=Ie(tt()),eo=Ie(wt());function jc(r){return r instanceof y?"\\x"+r.toString("hex"):r}a(jc,"encodeBuffe\
...
P+=C[j],j<g.length&&(P+="$"+(j+1))}g=g.map(j=>jc((0,Xs.prepareValue)(j)));let U={
query:P,params:g};return u&&u(U),Gc(oe,U,W)}a(X,"resolve"),X.transaction=async(C,g)=>{
if(typeof C=="function"&&(C=C(X)),!Array.isArray(C))throw new Error(Zs);C.forEach(
U=>{if(U[Symbol.toStringTag]!=="NeonQueryPromise")throw new Error(Zs)});let P=C.
map(U=>U.parameterizedQuery),W=C.map(U=>U.opts??{});return oe(P,W,g)};async function oe(C,g,P){
let{fetchEndpoint:W,fetchFunction:U}=xe,j=Array.isArray(C)?{queries:C}:C,ee=n??{},
ae=e??!1,R=t??!1,$=i,le=s,ye=o;P!==void 0&&(P.fetchOptions!==void 0&&(ee={...ee,
...
(le=P.readOnly),P.deferrable!==void 0&&(ye=P.deferrable)),g!==void 0&&!Array.isArray(
g)&&g.fetchOptions!==void 0&&(ee={...ee,...g.fetchOptions});let Ee=h;!Array.isArray(
g)&&g?.authToken!==void 0&&(Ee=g.authToken);let We=typeof W=="function"?W(_,L,{jwtAuth:Ee!==
void 0}):W,fe={"Neon-Connection-String":r,"Neon-Raw-Text-Output":"true","Neon-Ar\
ray-Mode":"true"},it=await $c(Ee);it&&(fe.Authorization=`Bearer ${it}`),Array.isArray(
C)&&($!==void 0&&(fe["Neon-Batch-Isolation-Level"]=$),le!==void 0&&(fe["Neon-Bat\
ch-Read-Only"]=String(le)),ye!==void 0&&(fe["Neon-Batch-Deferrable"]=String(ye)));
let me;try{me=await(U??fetch)(We,{method:"POST",body:JSON.stringify(j),headers:fe,
...ee})}catch(V){let D=new he(`Error connecting to database: ${V}`);throw D.sourceError=
V,D}if(me.ok){let V=await me.json();if(Array.isArray(C)){let D=V.results;if(!Array.
isArray(D))throw new he("Neon internal error: unexpected result format");return D.
map((ge,_e)=>{let Rt=g[_e]??{},ro=Rt.arrayMode??ae,no=Rt.fullResults??R;return Js(
ge,{arrayMode:ro,fullResults:no,parameterizedQuery:C[_e],resultCallback:c,types:Rt.
types})})}else{let D=g??{},ge=D.arrayMode??ae,_e=D.fullResults??R;return Js(V,{arrayMode:ge,
fullResults:_e,parameterizedQuery:C,resultCallback:c,types:D.types})}}else{let{status:V}=me;
if(V===400){let D=await me.json(),ge=new he(D.message);for(let _e of Hc)ge[_e]=D[_e]??
void 0;throw ge}else{let D=await me.text();throw new he(`Server error (HTTP stat\
us ${V}): ${D}`)}}}return a(oe,"execute"),X}a(An,"neon");function Gc(r,e,t){return{
...
n: ${e.message}`)),t}}a($c,"getAuthToken");var to=Ie(bt()),se=Ie(It());var Kc="node:crypto",Tn=class Tn extends Bt.Client{constructor(t){super(t);this.
...
"u"&&w.subtle!==void 0&&w.subtle.importKey!==void 0?w.subtle:(await import(Kc)).
...
throw new Error("SASL: Invalid attribute pair entry");let D=V[0],ge=V.substring(
2);return[D,ge]})),c=u.r,h=u.s,l=u.i;if(!c||!/^[!-+--~]+$/.test(c))throw new Error(
...
oe=X;for(var C=0;C<d-1;C++)X=new Uint8Array(await n.sign("HMAC",G,X)),oe=y.from(
oe.map((V,D)=>oe[D]^X[D]));let g=oe,P=await n.importKey("raw",g,{name:"HMAC",hash:{
...
,s="+h+",i="+d,ae="c=biws,r="+c,R=j+","+ee+","+ae,$=await n.importKey("raw",U,{name:"\
HMAC",hash:{name:"SHA-256"}},!1,["sign"]);var le=new Uint8Array(await n.sign("HM\
AC",$,_.encode(R))),ye=y.from(W.map((V,D)=>W[D]^le[D])),Ee=ye.toString("base64");
let We=await n.importKey("raw",g,{name:"HMAC",hash:{name:"SHA-256"}},!1,["sign"]),
fe=await n.sign("HMAC",We,_.encode("Server Key")),it=await n.importKey("raw",fe,
{name:"HMAC",hash:{name:"SHA-256"}},!1,["sign"]);var me=y.from(await n.sign("HMA\
C",it,_.encode(R)));i.message="SASLResponse",i.serverSignature=me.toString("base\
64"),i.response=ae+",p="+Ee,this.connection.sendSCRAMClientFinalMessage(this.saslSession.
response)}};a(Tn,"NeonClient");var Lt=Tn;function Vc(r,e){if(e)return{callback:e,
result:void 0};let t,n,i=a(function(o,u){o?t(o):n(u)},"cb"),s=new r(function(o,u){
n=o,t=u});return{callback:i,result:s}}a(Vc,"promisify");var In=class In extends Bt.Pool{constructor(){
super(...arguments);A(this,"Client",Lt);A(this,"hasFetchUnsupportedListeners",!1)}on(t,n){
...
return super.query(t,n,i);typeof n=="function"&&(i=n,n=void 0);let s=Vc(this.Promise,
...
_))}catch(o){i(o)}return s.result}};a(In,"NeonPool");var Cn=In;
