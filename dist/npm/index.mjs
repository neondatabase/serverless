var ro=Object.create;var Ie=Object.defineProperty;var no=Object.getOwnPropertyDescriptor;var io=Object.getOwnPropertyNames;var so=Object.getPrototypeOf,oo=Object.prototype.hasOwnProperty;var ao=(r,e,t)=>e in r?Ie(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):
...
no(e,i))||n.enumerable});return r};var je=(r,e,t)=>(t=r!=null?ro(so(r)):{},An(e||!r||!r.__esModule?Ie(t,"default",{
value:r,enumerable:!0}):t,r)),k=r=>An(Ie({},"__esModule",{value:!0}),r);var P=(r,e,t)=>(ao(r,typeof e!="symbol"?e+"":e,t),t);var Pn=I(it=>{"use strict";p();it.byteLength=co;it.toByteArray=lo;it.fromByteArray=
yo;var oe=[],ee=[],uo=typeof Uint8Array<"u"?Uint8Array:Array,It="ABCDEFGHIJKLMNO\
...
"getLens");function co(r){var e=In(r),t=e[0],n=e[1];return(t+n)*3/4-n}a(co,"byte\
Length");function ho(r,e,t){return(e+t)*3/4-t}a(ho,"_byteLength");function lo(r){
var e,t=In(r),n=t[0],i=t[1],s=new uo(ho(r,n,i)),o=0,u=i>0?n-4:n,c;for(c=0;c<u;c+=
...
e&255),s}a(lo,"toByteArray");function fo(r){return oe[r>>18&63]+oe[r>>12&63]+oe[r>>
6&63]+oe[r&63]}a(fo,"tripletToBase64");function po(r,e,t){for(var n,i=[],s=e;s<t;s+=
...
u=t-n;o<u;o+=s)i.push(po(r,o,o+s>u?u:o+s));return n===1?(e=r[t-1],i.push(oe[e>>2]+
oe[e<<4&63]+"==")):n===2&&(e=(r[t-2]<<8)+r[t-1],i.push(oe[e>>10]+oe[e>>4&63]+oe[e<<
2&63]+"=")),i.join("")}a(yo,"fromByteArray")});var Tn=I(Pt=>{p();Pt.read=function(r,e,t,n,i){var s,o,u=i*8-n-1,c=(1<<u)-1,h=c>>
...
fer");f.poolSize=8192;function Mn(r,e,t){if(typeof r=="string")return wo(r,e);if(ArrayBuffer.
...
'The value "'+r+'" is invalid for option "size"')}a(Dn,"assertSize");function go(r,e,t){
return Dn(r),r<=0?le(r):e!==void 0?typeof t=="string"?le(r).fill(e,t):le(r).fill(
e):le(r)}a(go,"alloc");f.alloc=function(r,e,t){return go(r,e,t)};function Ft(r){
return Dn(r),le(r<0?0:Mt(r)|0)}a(Ft,"allocUnsafe");f.allocUnsafe=function(r){return Ft(
r)};f.allocUnsafeSlow=function(r){return Ft(r)};function wo(r,e){if((typeof e!="\
...
n}a(wo,"fromString");function Bt(r){let e=r.length<0?0:Mt(r.length)|0,t=le(e);for(let n=0;n<
e;n+=1)t[n]=r[n]&255;return t}a(Bt,"fromArrayLike");function bo(r){if(ae(r,Uint8Array)){
let e=new Uint8Array(r);return Lt(e.buffer,e.byteOffset,e.byteLength)}return Bt(
r)}a(bo,"fromArrayView");function Lt(r,e,t){if(e<0||r.byteLength<e)throw new RangeError(
...
n,f.prototype),n}a(Lt,"fromArrayBuffer");function So(r){if(f.isBuffer(r)){let e=Mt(
...
Array.isArray(r.data))return Bt(r.data)}a(So,"fromObject");function Mt(r){if(r>=
st)throw new RangeError("Attempt to allocate Buffer larger than maximum size: 0x"+
st.toString(16)+" bytes");return r|0}a(Mt,"checked");function xo(r){return+r!=r&&
...
i=!0}}a(On,"byteLength");f.byteLength=On;function Eo(r,e,t){let n=!1;if((e===void 0||
...
this,e,t);case"utf8":case"utf-8":return Un(this,e,t);case"ascii":return Bo(this,
...
Eo,"slowToString");f.prototype._isBuffer=!0;function ve(r,e,t){let n=r[e];r[e]=r[t],
...
this,0,e):Eo.apply(this,arguments)},"toString");f.prototype.toLocaleString=f.prototype.
...
a(function(e,t,n){return kn(this,e,t,n,!1)},"lastIndexOf");function vo(r,e,t,n){
...
return o;r[t+o]=u}return o}a(vo,"hexWrite");function _o(r,e,t,n){return ot(Rt(e,
r.length-t),r,t,n)}a(_o,"utf8Write");function Ao(r,e,t,n){return ot(ko(e),r,t,n)}
a(Ao,"asciiWrite");function Co(r,e,t,n){return ot(Gn(e),r,t,n)}a(Co,"base64Write");
function Io(r,e,t,n){return ot(Uo(e,r.length-t),r,t,n)}a(Io,"ucs2Write");f.prototype.
...
hex":return vo(this,e,t,n);case"utf8":case"utf-8":return _o(this,e,t,n);case"asc\
...
length?Tt.fromByteArray(r):Tt.fromByteArray(r.slice(e,t))}a(Po,"base64Slice");function Un(r,e,t){
...
o&1023),n.push(o),i+=u}return To(n)}a(Un,"utf8Slice");var Rn=4096;function To(r){
let e=r.length;if(e<=Rn)return String.fromCharCode.apply(String,r);let t="",n=0;
for(;n<e;)t+=String.fromCharCode.apply(String,r.slice(n,n+=Rn));return t}a(To,"d\
...
void 0||r[e+t]===void 0)&&We(e,r.length-(t+1))}a(Mo,"checkBounds");function Hn(r,e,t,n,i,s){
...
1:0} and <= ${e}`,r)}a(We,"boundsError");var Do=/[^+/0-9A-Za-z-_]/g;function Oo(r){
if(r=r.split("=")[0],r=r.trim().replace(Do,""),r.length<2)return"";for(;r.length%
4!==0;)r=r+"=";return r}a(Oo,"base64clean");function Rt(r,e){e=e||1/0;let t,n=r.
...
Rt,"utf8ToBytes");function ko(r){let e=[];for(let t=0;t<r.length;++t)e.push(r.charCodeAt(
...
a(Uo,"utf16leToBytes");function Gn(r){return Tt.toByteArray(Oo(r))}a(Gn,"base64T\
...
a(ae,"isInstance");function Ot(r){return r!==r}a(Ot,"numberIsNaN");var qo=function(){
let r="0123456789abcdef",e=new Array(256);for(let t=0;t<16;++t){let n=t*16;for(let i=0;i<
16;++i)e[n+i]=r[t]+r[i]}return e}();function me(r){return typeof BigInt>"u"?No:r}
a(me,"defineBigIntMethod");function No(){throw new Error("BigInt not supported")}
a(No,"BufferBigIntNotDefined")});var b,S,v,w,d,m,p=V(()=>{"use strict";b=globalThis,S=globalThis.setImmediate??(r=>setTimeout(
...
e.then.bind(e)}});var ge=I((rh,kt)=>{"use strict";p();var Re=typeof Reflect=="object"?Reflect:null,
...
B;kt.exports.once=Go;B.EventEmitter=B;B.prototype._events=void 0;B.prototype._eventsCount=
...
prependListener=a(function(e,t){return Zn(this,e,t,!0)},"prependListener");function jo(){
...
target,arguments)}a(jo,"onceWrapper");function Jn(r,e,t){var n={fired:!1,wrapFn:void 0,
target:r,type:e,listener:t},i=jo.bind(n);return i.listener=t,n.wrapFn=i,i}a(Jn,"\
...
0?n.shift():Wo(n,s),n.length===1&&(i[e]=n[0]),i.removeListener!==void 0&&this.emit(
...
on"?t?[i.listener||i]:[i]:t?Ho(i):ti(i,i.length)}a(Xn,"_listeners");B.prototype.
...
ed type '+typeof r)}a(ri,"eventTargetAgnosticAddListener")});var He={};X(He,{default:()=>Vo});var Vo,Ge=V(()=>{"use strict";p();Vo={}});function $e(r){let e=1779033703,t=3144134277,n=1013904242,i=2773480762,s=1359893119,
...
ut",[]),P(O,"onePassHasher",new O);Ve=O});var Ut={};X(Ut,{createHash:()=>zo,createHmac:()=>Yo,randomBytes:()=>Ko});function Ko(r){
return w.getRandomValues(d.alloc(r))}function zo(r){if(r==="sha256")return{update:function(e){
...
set($e(o),64),d.from($e(u))}}}}}var qt=V(()=>{"use strict";p();ni();ii();a(Ko,"r\
andomBytes");a(zo,"createHash");a(Yo,"createHmac")});var Qt=I(si=>{"use strict";p();si.parse=function(r,e){return new Nt(r,e).parse()};
...
entries}};a(ct,"ArrayParser");var Nt=ct;function Zo(r){return r}a(Zo,"identity")});var jt=I((bh,oi)=>{p();var Jo=Qt();oi.exports={create:function(r,e){return{parse:function(){
return Jo.parse(r,e)}}}}});var ci=I((xh,ui)=>{"use strict";p();var Xo=/(\d{1,})-(\d{2})-(\d{2}) (\d{2}):(\d{2}):(\d{2})(\.\d{1,})?.*?( BC)?$/,
...
l=l?1e3*parseFloat(l):0;var y,E=ia(e);return E!=null?(y=new Date(Date.UTC(i,s,o,
u,c,h,l)),Wt(i)&&y.setUTCFullYear(i),E!==0&&y.setTime(y.getTime()-E)):(y=new Date(
i,s,o,u,c,h,l),Wt(i)&&y.setFullYear(i)),y},"parseDate");function na(r){var e=ea.
exec(r);if(e){var t=parseInt(e[1],10),n=!!e[4];n&&(t=ai(t));var i=parseInt(e[2],
10)-1,s=e[3],o=new Date(t,i,s);return Wt(t)&&o.setFullYear(t),o}}a(na,"getDate");
...
"is0To99")});var li=I((_h,hi)=>{p();hi.exports=oa;var sa=Object.prototype.hasOwnProperty;function oa(r){
for(var e=1;e<arguments.length;e++){var t=arguments[e];for(var n in t)sa.call(t,
n)&&(r[n]=t[n])}return r}a(oa,"extend")});var di=I((Ih,pi)=>{"use strict";p();var aa=li();pi.exports=Fe;function Fe(r){if(!(this instanceof
...
"")),i+ca[n]}};var Ht="([+-]?\\d+)",fa=Ht+"\\s+years?",pa=Ht+"\\s+mons?",da=Ht+"\
...
o),n},{})}a(ba,"parse")});var mi=I((Bh,yi)=>{"use strict";p();yi.exports=a(function(e){if(/^\\x/.test(e))return new d(
...
"\\";n+=Math.floor(i/2)*2}return new d(t,"binary")},"parseBytea")});var vi=I((Fh,Ei)=>{p();var Ke=Qt(),ze=jt(),ht=ci(),wi=di(),bi=mi();function lt(r){
...
r==="1"}a(Si,"parseBool");function Sa(r){return r?Ke.parse(r,Si):null}a(Sa,"pars\
eBoolArray");function xa(r){return parseInt(r,10)}a(xa,"parseBaseTenInt");function Gt(r){
return r?Ke.parse(r,lt(xa)):null}a(Gt,"parseIntegerArray");function Ea(r){return r?
Ke.parse(r,lt(function(e){return xi(e).trim()})):null}a(Ea,"parseBigIntegerArray");
var va=a(function(r){if(!r)return null;var e=ze.create(r,function(t){return t!==
...
var s=zt(e);return s.radius=parseFloat(t),s},"parseCircle"),Ia=a(function(r){r(20,
xi),r(21,Kt),r(23,Kt),r(26,Kt),r(700,parseFloat),r(701,parseFloat),r(16,Si),r(1082,
ht),r(1114,ht),r(1184,ht),r(600,zt),r(651,te),r(718,Ca),r(1e3,Sa),r(1001,Aa),r(1005,
Gt),r(1007,Gt),r(1028,Gt),r(1016,Ea),r(1017,va),r(1021,$t),r(1022,$t),r(1231,$t),
r(1014,te),r(1015,te),r(1008,te),r(1009,te),r(1040,te),r(1041,te),r(1115,Vt),r(1182,
Vt),r(1185,Vt),r(1186,wi),r(1187,_a),r(17,bi),r(114,JSON.parse.bind(JSON)),r(3802,
JSON.parse.bind(JSON)),r(199,gi),r(3807,gi),r(3907,te),r(2951,te),r(791,te),r(1183,
te),r(1270,te)},"init");Ei.exports={init:Ia}});var Ai=I((Oh,_i)=>{"use strict";p();var Y=1e6;function Pa(r){var e=r.readInt32BE(
...
e%Y,o=4294967296*s+t,u=""+o%Y,n+u+i}a(Pa,"readInt8");_i.exports=Pa});var Bi=I((qh,Ti)=>{p();var Ta=Ai(),R=a(function(r,e,t,n,i){t=t||0,n=n||!1,i=i||function(_,T,N){
...
-1)*Math.pow(2,s-n)*c},"parseFloatFromBits"),Ba=a(function(r){return R(r,1)==1?-1*
(R(r,15,1,!0)+1):R(r,15,1)},"parseInt16"),Ci=a(function(r){return R(r,1)==1?-1*(R(
r,31,1,!0)+1):R(r,31,1)},"parseInt32"),La=a(function(r){return Pi(r,23,8)},"pars\
eFloat32"),Ra=a(function(r){return Pi(r,52,11)},"parseFloat64"),Fa=a(function(r){
...
null?null:R(r,8)>0},"parseBool"),Oa=a(function(r){r(20,Ta),r(21,Ba),r(23,Ci),r(26,
Ci),r(1700,Fa),r(700,La),r(701,Ra),r(16,Da),r(1114,Ii.bind(null,!1)),r(1184,Ii.bind(
null,!0)),r(1e3,Ye),r(1007,Ye),r(1016,Ye),r(1008,Ye),r(1009,Ye),r(25,Ma)},"init");
Ti.exports={init:Oa}});var Ri=I((jh,Li)=>{p();Li.exports={BOOL:16,BYTEA:17,CHAR:18,INT8:20,INT2:21,INT4:23,
...
REGCONFIG:3734,REGDICTIONARY:3769,JSONB:3802,REGNAMESPACE:4089,REGROLE:4096}});var Xe=I(Je=>{p();var ka=vi(),Ua=Bi(),qa=jt(),Na=Ri();Je.getTypeParser=Qa;Je.setTypeParser=
ja;Je.arrayParser=qa;Je.builtins=Na;var Ze={text:{},binary:{}};function Fi(r){return String(
r)}a(Fi,"noParse");function Qa(r,e){return e=e||"text",Ze[e]&&Ze[e][r]||Fi}a(Qa,
"getTypeParser");function ja(r,e,t){typeof e=="function"&&(t=e,e="text"),Ze[e][r]=
t}a(ja,"setTypeParser");ka.init(function(r,e){Ze.text[r]=e});Ua.init(function(r,e){
Ze.binary[r]=e})});var et=I((Vh,Yt)=>{"use strict";p();Yt.exports={host:"localhost",user:m.platform===
...
connect_timeout:0,keepalives:1,keepalives_idle:0};var Me=Xe(),Wa=Me.getTypeParser(
20,"text"),Ha=Me.getTypeParser(1016,"text");Yt.exports.__defineSetter__("parseIn\
t8",function(r){Me.setTypeParser(20,"text",r?Me.getTypeParser(23,"text"):Wa),Me.
setTypeParser(1016,"text",r?Me.getTypeParser(1007,"text"):Ha)})});var tt=I((zh,Di)=>{"use strict";p();var Ga=(qt(),k(Ut)),$a=et();function Va(r){var e=r.
...
toString("hex"):e+=Va(ft(r[t]));return e=e+"}",e}a(Mi,"arrayString");var ft=a(function(r,e){
...
a(Ka,"prepareObject");function W(r,e){for(r=""+r;r.length<e;)r="0"+r;return r}a(
W,"pad");function za(r){var e=-r.getTimezoneOffset(),t=r.getFullYear(),n=t<1;n&&
...
W(r.getUTCMilliseconds(),3);return n+="+00:00",t&&(n+=" BC"),n}a(Ya,"dateToStrin\
...
g");var Zt=a(function(r){return Ga.createHash("md5").update(r,"utf-8").digest("h\
ex")},"md5"),Ja=a(function(r,e,t){var n=Zt(e+r),i=Zt(d.concat([d.from(n),t]));return"\
md5"+i},"postgresMd5PasswordHash");Di.exports={prepareValue:a(function(e){return ft(
e)},"prepareValueWrapper"),normalizeQueryConfig:Za,postgresMd5PasswordHash:Ja,md5:Zt}});var Ni=I((Jh,qi)=>{"use strict";p();var Jt=(qt(),k(Ut));function Xa(r){if(r.indexOf(
...
se",r.serverSignature=J.toString("base64"),r.response=l+",p="+T}a(eu,"continueSe\
...
n=e.substring(2);return[t,n]}))}a(ki,"parseAttributePairs");function nu(r){let e=ki(
...
ssage");function iu(r){let t=ki(r).get("v");if(t){if(!Oi(t))throw new Error("SAS\
...
a(iu,"parseServerFinalMessage");function Ui(r,e){if(!d.isBuffer(r))throw new TypeError(
...
from(r.map((t,n)=>r[n]^e[n]))}a(Ui,"xorBuffers");function su(r){return Jt.createHash(
"sha256").update(r).digest()}a(su,"sha256");function De(r,e){return Jt.createHmac(
...
a(ou,"Hi");qi.exports={startSession:Xa,continueSession:eu,finalizeSession:tu}});var Xt={};X(Xt,{join:()=>au});function au(...r){return r.join("/")}var er=V(()=>{
"use strict";p();a(au,"join")});var tr={};X(tr,{stat:()=>uu});function uu(r,e){e(new Error("No filesystem"))}var rr=V(
()=>{"use strict";p();a(uu,"stat")});var nr={};X(nr,{default:()=>cu});var cu,ir=V(()=>{"use strict";p();cu={}});var Qi={};X(Qi,{StringDecoder:()=>sr});var or,sr,ji=V(()=>{"use strict";p();or=class or{constructor(e){
P(this,"td");this.td=new TextDecoder(e)}write(e){return this.td.decode(e,{stream:!0})}end(e){
return this.td.decode(e)}};a(or,"StringDecoder");sr=or});var $i=I((ul,Gi)=>{"use strict";p();var{Transform:hu}=(ir(),k(nr)),{StringDecoder:lu}=(ji(),k(Qi)),
we=Symbol("last"),pt=Symbol("decoder");function fu(r,e,t){let n;if(this.overflow){
...
let n=new hu(t);return n[we]="",n[pt]=new lu("utf8"),n.matcher=r,n.mapper=e,n.maxLength=
t.maxLength,n.skipOverflow=t.skipOverflow||!1,n.overflow=!1,n._destroy=function(i,s){
this._writableState.errorEmitted=!1,s(i)},n}a(du,"split");Gi.exports=du});var zi=I((ll,fe)=>{"use strict";p();var Vi=(er(),k(Xt)),yu=(ir(),k(nr)).Stream,mu=$i(),
Ki=(Ge(),k(He)),gu=5432,dt=m.platform==="win32",rt=m.stderr,wu=56,bu=7,Su=61440,
xu=32768;function Eu(r){return(r&Su)==xu}a(Eu,"isRegFile");var Oe=["host","port",
"database","user","password"],ar=Oe.length,vu=Oe[ar-1];function ur(){var r=rt instanceof
...
call(m.env,"PGPASSWORD")?!1:dt?!0:(e=e||"<unkn>",Eu(r.mode)?r.mode&(wu|bu)?(ur('\
...
e),!1))};var _u=fe.exports.match=function(r,e){return Oe.slice(0,-1).reduce(function(t,n,i){
return i==1&&Number(r[n]||gu)===Number(e[n])?t&&!0:t&&(e[n]==="*"||e[n]===r[n])},
!0)};fe.exports.getPassword=function(r,e,t){var n,i=e.pipe(mu());function s(c){var h=Au(
c);h&&Cu(h)&&_u(r,h)&&(n=h[vu],i.end())}a(s,"onLine");var o=a(function(){e.destroy(),
...
u)};var Au=fe.exports.parseLine=function(r){if(r.length<11||r.match(/^\s+#/))return null;
...
Object.keys(o).length===ar?o:null,o},Cu=fe.exports.isValidEntry=function(r){for(var e={
...
1){var n=e[t],i=r[Oe[t]]||"",s=n(i);if(!s)return!1}return!0}});var Zi=I((yl,cr)=>{"use strict";p();var dl=(er(),k(Xt)),Yi=(rr(),k(tr)),yt=zi();
...
e)})};cr.exports.warnTo=yt.warnTo});var hr=I((gl,Ji)=>{"use strict";p();var Iu=Xe();function mt(r){this._types=r||Iu,
...
"text",this.getOverrides(e)[r]||this._types.getTypeParser(r,e)};Ji.exports=mt});var Xi={};X(Xi,{default:()=>Pu});var Pu,es=V(()=>{"use strict";p();Pu={}});var ts={};X(ts,{parse:()=>lr});function lr(r,e=!1){let{protocol:t}=new URL(r),n="\
...
()=>{"use strict";p();a(lr,"parse")});var ns=I((vl,rs)=>{"use strict";p();var Tu=(fr(),k(ts)),pr=(rr(),k(tr));function dr(r){
if(r.charAt(0)==="/"){var t=r.split(" ");return{host:t[0],database:t[1]}}var e=Tu.
...
return t}a(dr,"parse");rs.exports=dr;dr.parse=dr});var gt=I((Cl,os)=>{"use strict";p();var Bu=(es(),k(Xi)),ss=et(),is=ns().parse,K=a(
...
teParamValue"),Ru=a(function(r){return r.split(".")[0]},"extractProjectValue"),re=a(
...
ssl=typeof e.ssl>"u"?Lu():e.ssl,typeof this.ssl=="string"&&this.ssl==="true"&&(this.
...
t.push("project="+Ru(this.host))),this.isDomainSocket)return e(null,t.join(" "));
this.client_encoding&&t.push("client_encoding="+ke(this.client_encoding)),Bu.lookup(
this.host,function(i,s){return i?e(i,null):(t.push("hostaddr="+ke(s)),e(null,t.join(
" ")))})}};a(mr,"ConnectionParameters");var yr=mr;os.exports=yr});var cs=I((Tl,us)=>{"use strict";p();var Fu=Xe(),as=/^([A-Za-z]+)(?: (\d+))?(?: (\d+))?/,
...
ext"):this._parsers[t]=Fu.getTypeParser(n.dataTypeID,n.format||"text")}}};a(wr,"\
Result");var gr=wr;us.exports=gr});var ps=I((Rl,fs)=>{"use strict";p();var{EventEmitter:Mu}=ge(),hs=cs(),ls=tt(),Sr=class Sr extends Mu{constructor(e,t,n){
...
var br=Sr;fs.exports=br});var gs={};X(gs,{Socket:()=>_e,isIP:()=>Du,isNeonHost:()=>xr});function Du(r){return 0}
var ys,ms,xr,ds,x,_e,wt=V(()=>{"use strict";p();ys=je(ge(),1);a(Du,"isIP");ms=/^(?:ep-)?([a-z]+)-([a-z]+)-(\w+)/,
xr=a(r=>ms.test(r),"isNeonHost"),ds=a(r=>r.replace(ms,"api"),"transformHost"),x=
...
xt.serialize=void 0;var Xr=ws(),F=new Xr.Writer,Ou=a(r=>{F.addInt16(3).addInt16(
...
Writer().addInt32(t).add(e).flush()},"startup"),ku=a(()=>{let r=d.allocUnsafe(8);
return r.writeInt32BE(8,0),r.writeInt32BE(80877103,4),r},"requestSsl"),Uu=a(r=>F.
addCString(r).flush(112),"password"),qu=a(function(r,e){return F.addCString(r).addInt32(
d.byteLength(e)).addString(e),F.flush(112)},"sendSASLInitialResponseMessage"),Nu=a(
function(r){return F.addString(r).flush(112)},"sendSCRAMClientFinalMessage"),Qu=a(
r=>F.addCString(r).flush(81),"query"),bs=[],ju=a(r=>{let e=r.name||"";e.length>63&&
...
flush(80)},"parse"),Ue=new Xr.Writer,Wu=a(function(r,e){for(let t=0;t<r.length;t++){
...
n)),Ue.addString(n))}},"writeValues"),Hu=a((r={})=>{let e=r.portal||"",t=r.statement||
"",n=r.binary||!1,i=r.values||bs,s=i.length;return F.addCString(e).addCString(t),
F.addInt16(s),Wu(i,r.valueMapper),F.addInt16(s),F.add(Ue.flush()),F.addInt16(n?1:
0),F.flush(66)},"bind"),Gu=d.from([69,0,0,0,9,0,0,0,0,0]),$u=a(r=>{if(!r||!r.portal&&
...
"cstringMessage"),Ku=F.addCString("P").flush(68),zu=F.addCString("S").flush(68),
Yu=a(r=>r.name?en(68,`${r.type}${r.name||""}`):r.type==="P"?Ku:zu,"describe"),Zu=a(
r=>{let e=`${r.type}${r.name||""}`;return en(67,e)},"close"),Ju=a(r=>F.add(r).flush(
100),"copyData"),Xu=a(r=>en(102,r),"copyFail"),St=a(r=>d.from([r,0,0,0,4]),"code\
OnlyBuffer"),ec=St(72),tc=St(83),rc=St(88),nc=St(99),ic={startup:Ou,password:Uu,
requestSsl:ku,sendSASLInitialResponseMessage:qu,sendSCRAMClientFinalMessage:Nu,query:Qu,
parse:ju,bind:Hu,execute:$u,describe:Yu,close:Zu,flush:()=>ec,sync:()=>tc,end:()=>rc,
copyData:Ju,copyDone:()=>nc,copyFail:Xu,cancel:Vu};xt.serialize=ic});var xs=I(Et=>{"use strict";p();Object.defineProperty(Et,"__esModule",{value:!0});
Et.BufferReader=void 0;var sc=d.allocUnsafe(0),rn=class rn{constructor(e=0){this.
...
tn});var Es={};X(Es,{default:()=>oc});var oc,vs=V(()=>{"use strict";p();oc={}});var Cs=I(qe=>{"use strict";p();var ac=qe&&qe.__importDefault||function(r){return r&&
r.__esModule?r:{default:r}};Object.defineProperty(qe,"__esModule",{value:!0});qe.
Parser=void 0;var M=Yr(),uc=xs(),cc=ac((vs(),k(Es))),nn=1,hc=4,_s=nn+hc,As=d.allocUnsafe(
...
be.DatabaseError=be.serialize=be.parse=void 0;var lc=Yr();Object.defineProperty(
be,"DatabaseError",{enumerable:!0,get:function(){return lc.DatabaseError}});var fc=Ss();
Object.defineProperty(be,"serialize",{enumerable:!0,get:function(){return fc.serialize}});
var pc=Cs();function dc(r,e){let t=new pc.Parser;return r.on("data",n=>t.parse(n,
e)),new Promise(n=>r.on("end",()=>n()))}a(dc,"parse");be.parse=dc});var Is={};X(Is,{connect:()=>yc});function yc({socket:r,servername:e}){return r.startTls(
e),r}var Ps=V(()=>{"use strict";p();a(yc,"connect")});var hn=I((sf,Ls)=>{"use strict";p();var Ts=(wt(),k(gs)),mc=ge().EventEmitter,{parse:gc,
...
nnection"))}var u=(Ps(),k(Is));let c={socket:n.stream};n.ssl!==!0&&(Object.assign(
...
this._send(q.copyFail(e))}};a(cn,"Connection");var un=cn;Ls.exports=un});var Ms=I((cf,Fs)=>{"use strict";p();var Sc=ge().EventEmitter,uf=(Ge(),k(He)),xc=tt(),
ln=Ni(),Ec=Zi(),vc=hr(),_c=gt(),Rs=ps(),Ac=et(),Cc=hn(),fn=class fn extends Sc{constructor(e){
...
Rs;Fs.exports=vt});var Us=I((ff,ks)=>{"use strict";p();var Ic=ge().EventEmitter,Ds=a(function(){},"\
...
e}};a(mn,"PendingItem");var Ne=mn;function Pc(){throw new Error("Release called \
on client which has already been released to the pool.")}a(Pc,"throwOnDoubleRele\
...
o),o});return{callback:i,result:s}}a(_t,"promisify");function Tc(r,e){return a(function t(n){
...
"idleListener")}a(Tc,"makeIdleListener");var gn=class gn extends Ic{constructor(e,t){
...
o),t.callback(u,c,h)},"queueCallback"),s=new Ne(i),o=setTimeout(()=>{Os(this._pendingQueue,
...
e,e.release)}_releaseOnce(e,t){let n=!1;return i=>{n&&Pc(),n=!0,this._release(e,
...
length}};a(gn,"Pool");var dn=gn;ks.exports=dn});var qs={};X(qs,{default:()=>Bc});var Bc,Ns=V(()=>{"use strict";p();Bc={}});var Qs=I((mf,Lc)=>{Lc.exports={name:"pg",version:"8.8.0",description:"PostgreSQL\
...
7b9a5491a178655"}});var Hs=I((gf,Ws)=>{"use strict";p();var js=ge().EventEmitter,Rc=(Ge(),k(He)),wn=tt(),
Qe=Ws.exports=function(r,e,t){js.call(this),r=wn.normalizeQueryConfig(r,e,t),this.
...
Qe,js);var Fc={sqlState:"code",statementPosition:"position",messagePrimary:"mess\
...
text,t)}});var Ks=I((xf,Vs)=>{"use strict";p();var Mc=(Ns(),k(qs)),Dc=hr(),Sf=Qs(),Gs=ge().
EventEmitter,Oc=(Ge(),k(He)),kc=gt(),$s=Hs(),Z=Vs.exports=function(r){Gs.call(this),
...
!1,this._connected=!1,this._queryable=!0;var e=this.connectionParameters=new kc(
...
e.port,this.namedQueries={}};Z.Query=$s;Oc.inherits(Z,Gs);Z.prototype._errorAllQueries=
...
_types.getTypeParser(r,e)}});var bn=I((_f,zs)=>{"use strict";p();zs.exports=Ks()});var At=I((Cf,nt)=>{"use strict";p();var Uc=Ms(),qc=et(),Nc=hn(),Qc=Us(),{DatabaseError:jc}=an(),
Wc=a(r=>{var e;return e=class extends Qc{constructor(n){super(n,r)}},a(e,"BoundP\
ool"),e},"poolFactory"),Sn=a(function(r){this.defaults=qc,this.Client=r,this.Query=
this.Client.Query,this.Pool=Wc(this.Client),this._pools=[],this.Connection=Nc,this.
types=Xe(),this.DatabaseError=jc},"PG");typeof m.env.NODE_PG_FORCE_NATIVE<"u"?nt.
exports=new Sn(bn()):(nt.exports=new Sn(Uc),Object.defineProperty(nt.exports,"na\
...
native",{value:r}),r}}))});p();var Ct=je(At());wt();p();fr();wt();var Js=je(tt());var xn=class xn extends Error{constructor(){super(...arguments);P(this,"name","N\
...
of queries";function Xs(r,{arrayMode:e,fullResults:t,fetchOptions:n,isolationLevel:i,
...
g=g.map(j=>(0,Js.prepareValue)(j));let Q={query:D,params:g};return u&&u(Q),Hc(pe,
Q,H)}a(J,"resolve"),J.transaction=async(A,g)=>{if(typeof A=="function"&&(A=A(J)),
!Array.isArray(A))throw new Error(Ys);let D=A.map(H=>{if(H[Symbol.toStringTag]!==
"NeonQueryPromise")throw new Error(Ys);return H.parameterizedQuery});return pe(D,
...
ternal error: unexpected result format");return $.map((ne,Ce)=>Zs(ne,{arrayMode:L,
fullResults:G,parameterizedQuery:A[Ce],resultCallback:c}))}else return Zs(se,{arrayMode:L,
...
pe,"execute"),J}a(Xs,"neon");function Hc(r,e,t){return{[Symbol.toStringTag]:"Neo\
nQueryPromise",parameterizedQuery:e,opts:t,then:(n,i)=>r(e,t).then(n,i),catch:n=>r(
e,t).catch(n),finally:n=>r(e,t).finally(n)}}a(Hc,"createNeonQueryPromise");function Zs(r,{
...
t?(r.viaNeonFetch=!0,r.rowAsArray=e,r.rows=u,r):u}a(Zs,"processQueryResult");var to=je(gt()),Se=je(At());var vn=class vn extends Ct.Client{constructor(t){super(t);this.config=t}get neonConfig(){
...
response)}};a(vn,"NeonClient");var En=vn;function Gc(r,e){if(e)return{callback:e,
result:void 0};let t,n,i=a(function(o,u){o?t(o):n(u)},"cb"),s=new r(function(o,u){
n=o,t=u});return{callback:i,result:s}}a(Gc,"promisify");var _n=class _n extends Ct.Pool{constructor(){
...
"string"?t:t.text,y=n??t.values??[];Xs(h,{fullResults:!0,arrayMode:t.rowMode==="\
array"})(l,y).then(_=>i(void 0,_)).catch(_=>i(_))}catch(o){i(o)}return s.result}};
a(_n,"NeonPool");var eo=_n;var export_ClientBase=Se.ClientBase;var export_Connection=Se.Connection;var export_DatabaseError=Se.DatabaseError;
...
export_DatabaseError as DatabaseError,Ae as NeonDbError,eo as Pool,export_Query as Query,
