var Xs=Object.create;var Ce=Object.defineProperty;var eo=Object.getOwnPropertyDescriptor;var to=Object.getOwnPropertyNames;var ro=Object.getPrototypeOf,no=Object.prototype.hasOwnProperty;var io=(r,e,t)=>e in r?Ce(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):
r[e]=t;var a=(r,e)=>Ce(r,"name",{value:e,configurable:!0});var $=(r,e)=>()=>(r&&(e=r(r=0)),e);var I=(r,e)=>()=>(e||r((e={exports:{}}).exports,e),e.exports),ee=(r,e)=>{for(var t in e)
Ce(r,t,{get:e[t],enumerable:!0})},vn=(r,e,t,n)=>{if(e&&typeof e=="object"||typeof e==
"function")for(let i of to(e))!no.call(r,i)&&i!==t&&Ce(r,i,{get:()=>e[i],enumerable:!(n=
eo(e,i))||n.enumerable});return r};var Qe=(r,e,t)=>(t=r!=null?Xs(ro(r)):{},vn(e||!r||!r.__esModule?Ce(t,"default",{
value:r,enumerable:!0}):t,r)),k=r=>vn(Ce({},"__esModule",{value:!0}),r);var T=(r,e,t)=>(io(r,typeof e!="symbol"?e+"":e,t),t);var Cn=I(nt=>{"use strict";p();nt.byteLength=oo;nt.toByteArray=uo;nt.fromByteArray=
lo;var ae=[],te=[],so=typeof Uint8Array<"u"?Uint8Array:Array,Ct="ABCDEFGHIJKLMNO\
PQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";for(Ee=0,_n=Ct.length;Ee<_n;++Ee)
ae[Ee]=Ct[Ee],te[Ct.charCodeAt(Ee)]=Ee;var Ee,_n;te[45]=62;te[95]=63;function An(r){
var e=r.length;if(e%4>0)throw new Error("Invalid string. Length must be a multip\
le of 4");var t=r.indexOf("=");t===-1&&(t=e);var n=t===e?0:4-t%4;return[t,n]}a(An,
"getLens");function oo(r){var e=An(r),t=e[0],n=e[1];return(t+n)*3/4-n}a(oo,"byte\
Length");function ao(r,e,t){return(e+t)*3/4-t}a(ao,"_byteLength");function uo(r){
var e,t=An(r),n=t[0],i=t[1],s=new so(ao(r,n,i)),o=0,u=i>0?n-4:n,c;for(c=0;c<u;c+=
...
e&255),s}a(uo,"toByteArray");function co(r){return ae[r>>18&63]+ae[r>>12&63]+ae[r>>
6&63]+ae[r&63]}a(co,"tripletToBase64");function ho(r,e,t){for(var n,i=[],s=e;s<t;s+=
...
u=t-n;o<u;o+=s)i.push(ho(r,o,o+s>u?u:o+s));return n===1?(e=r[t-1],i.push(ae[e>>2]+
ae[e<<4&63]+"==")):n===2&&(e=(r[t-2]<<8)+r[t-1],i.push(ae[e>>10]+ae[e>>4&63]+ae[e<<
2&63]+"=")),i.join("")}a(lo,"fromByteArray")});var In=I(It=>{p();It.read=function(r,e,t,n,i){var s,o,u=i*8-n-1,c=(1<<u)-1,h=c>>
1,l=-7,y=t?i-1:0,x=t?-1:1,_=r[e+y];for(y+=x,s=_&(1<<-l)-1,_>>=-l,l+=u;l>0;s=s*256+
...
-1:1)*o*Math.pow(2,s-n)};It.write=function(r,e,t,n,i,s){var o,u,c,h=s*8-i-1,l=(1<<
h)-1,y=l>>1,x=i===23?Math.pow(2,-24)-Math.pow(2,-77):0,_=n?0:s-1,P=n?1:-1,N=e<0||
...
i-=8);for(o=o<<i|u,h+=i;h>0;r[t+_]=o&255,_+=P,o/=256,h-=8);r[t+_-P]|=N*128}});var Hn=I(Be=>{"use strict";p();var Tt=Cn(),Te=In(),Tn=typeof Symbol=="function"&&
typeof Symbol.for=="function"?Symbol.for("nodejs.util.inspect.custom"):null;Be.Buffer=
f;Be.SlowBuffer=wo;Be.INSPECT_MAX_BYTES=50;var it=2147483647;Be.kMaxLength=it;f.
...
this))return this.byteOffset}});function fe(r){if(r>it)throw new RangeError('The\
...
be of type string. Received type number');return Rt(r)}return Rn(r,e,t)}a(f,"Buf\
fer");f.poolSize=8192;function Rn(r,e,t){if(typeof r=="string")return yo(r,e);if(ArrayBuffer.
...
"u"&&(ue(r,SharedArrayBuffer)||r&&ue(r.buffer,SharedArrayBuffer)))return Bt(r,e,
...
Rn,"from");f.from=function(r,e,t){return Rn(r,e,t)};Object.setPrototypeOf(f.prototype,
Uint8Array.prototype);Object.setPrototypeOf(f,Uint8Array);function Fn(r){if(typeof r!=
"number")throw new TypeError('"size" argument must be of type number');if(r<0)throw new RangeError(
'The value "'+r+'" is invalid for option "size"')}a(Fn,"assertSize");function po(r,e,t){
return Fn(r),r<=0?fe(r):e!==void 0?typeof t=="string"?fe(r).fill(e,t):fe(r).fill(
e):fe(r)}a(po,"alloc");f.alloc=function(r,e,t){return po(r,e,t)};function Rt(r){
return Fn(r),fe(r<0?0:Ft(r)|0)}a(Rt,"allocUnsafe");f.allocUnsafe=function(r){return Rt(
r)};f.allocUnsafeSlow=function(r){return Rt(r)};function yo(r,e){if((typeof e!="\
string"||e==="")&&(e="utf8"),!f.isEncoding(e))throw new TypeError("Unknown encod\
ing: "+e);let t=Mn(r,e)|0,n=fe(t),i=n.write(r,e);return i!==t&&(n=n.slice(0,i)),
n}a(yo,"fromString");function Pt(r){let e=r.length<0?0:Ft(r.length)|0,t=fe(e);for(let n=0;n<
e;n+=1)t[n]=r[n]&255;return t}a(Pt,"fromArrayLike");function mo(r){if(ue(r,Uint8Array)){
let e=new Uint8Array(r);return Bt(e.buffer,e.byteOffset,e.byteLength)}return Pt(
r)}a(mo,"fromArrayView");function Bt(r,e,t){if(e<0||r.byteLength<e)throw new RangeError(
...
n,f.prototype),n}a(Bt,"fromArrayBuffer");function go(r){if(f.isBuffer(r)){let e=Ft(
r.length)|0,t=fe(e);return t.length===0||r.copy(t,0,0,e),t}if(r.length!==void 0)
return typeof r.length!="number"||Dt(r.length)?fe(0):Pt(r);if(r.type==="Buffer"&&
Array.isArray(r.data))return Pt(r.data)}a(go,"fromObject");function Ft(r){if(r>=
it)throw new RangeError("Attempt to allocate Buffer larger than maximum size: 0x"+
it.toString(16)+" bytes");return r|0}a(Ft,"checked");function wo(r){return+r!=r&&
...
fers');s+=o.length}return i},"concat");function Mn(r,e){if(f.isBuffer(r))return r.
...
latin1":case"binary":return t;case"utf8":case"utf-8":return Lt(r).length;case"uc\
s2":case"ucs-2":case"utf16le":case"utf-16le":return t*2;case"hex":return t>>>1;case"\
base64":return jn(r).length;default:if(i)return n?-1:Lt(r).length;e=(""+e).toLowerCase(),
i=!0}}a(Mn,"byteLength");f.byteLength=Mn;function bo(r,e,t){let n=!1;if((e===void 0||
...
this,e,t);case"utf8":case"utf-8":return On(this,e,t);case"ascii":return Io(this,
...
e+">"},"inspect");Tn&&(f.prototype[Tn]=f.prototype.inspect);f.prototype.compare=
...
if(h[y]!==l[y]){o=h[y],u=l[y];break}return o<u?-1:u<o?1:0},"compare");function Dn(r,e,t,n,i){
if(r.length===0)return-1;if(typeof t=="string"?(n=t,t=0):t>2147483647?t=2147483647:
t<-2147483648&&(t=-2147483648),t=+t,Dt(t)&&(t=i?0:r.length-1),t<0&&(t=r.length+t),
t>=r.length){if(i)return-1;t=r.length-1}else if(t<0)if(i)t=0;else return-1;if(typeof e==
"string"&&(e=f.from(e,n)),f.isBuffer(e))return e.length===0?-1:Pn(r,e,t,n,i);if(typeof e==
"number")return e=e&255,typeof Uint8Array.prototype.indexOf=="function"?i?Uint8Array.
prototype.indexOf.call(r,e,t):Uint8Array.prototype.lastIndexOf.call(r,e,t):Pn(r,
[e],t,n,i);throw new TypeError("val must be string, number or Buffer")}a(Dn,"bid\
irectionalIndexOf");function Pn(r,e,t,n,i){let s=1,o=r.length,u=e.length;if(n!==
...
if(c(r,h+y)!==c(e,y)){l=!1;break}if(l)return h}return-1}a(Pn,"arrayIndexOf");f.prototype.
includes=a(function(e,t,n){return this.indexOf(e,t,n)!==-1},"includes");f.prototype.
indexOf=a(function(e,t,n){return Dn(this,e,t,n,!0)},"indexOf");f.prototype.lastIndexOf=
a(function(e,t,n){return Dn(this,e,t,n,!1)},"lastIndexOf");function So(r,e,t,n){
t=Number(t)||0;let i=r.length-t;n?(n=Number(n),n>i&&(n=i)):n=i;let s=e.length;n>
s/2&&(n=s/2);let o;for(o=0;o<n;++o){let u=parseInt(e.substr(o*2,2),16);if(Dt(u))
return o;r[t+o]=u}return o}a(So,"hexWrite");function xo(r,e,t,n){return st(Lt(e,
r.length-t),r,t,n)}a(xo,"utf8Write");function Eo(r,e,t,n){return st(Mo(e),r,t,n)}
a(Eo,"asciiWrite");function vo(r,e,t,n){return st(jn(e),r,t,n)}a(vo,"base64Write");
function _o(r,e,t,n){return st(Do(e,r.length-t),r,t,n)}a(_o,"ucs2Write");f.prototype.
...
length?Tt.fromByteArray(r):Tt.fromByteArray(r.slice(e,t))}a(Ao,"base64Slice");function On(r,e,t){
...
o&1023),n.push(o),i+=u}return Co(n)}a(On,"utf8Slice");var Bn=4096;function Co(r){
let e=r.length;if(e<=Bn)return String.fromCharCode.apply(String,r);let t="",n=0;
for(;n<e;)t+=String.fromCharCode.apply(String,r.slice(n,n+=Bn));return t}a(Co,"d\
...
readFloatLE=a(function(e,t){return e=e>>>0,t||U(e,4,this.length),Te.read(this,e,
!0,23,4)},"readFloatLE");f.prototype.readFloatBE=a(function(e,t){return e=e>>>0,
t||U(e,4,this.length),Te.read(this,e,!1,23,4)},"readFloatBE");f.prototype.readDoubleLE=
a(function(e,t){return e=e>>>0,t||U(e,8,this.length),Te.read(this,e,!0,52,8)},"r\
eadDoubleLE");f.prototype.readDoubleBE=a(function(e,t){return e=e>>>0,t||U(e,8,this.
length),Te.read(this,e,!1,52,8)},"readDoubleBE");function K(r,e,t,n,i,s){if(!f.isBuffer(
...
"Index out of range")}a(K,"checkInt");f.prototype.writeUintLE=f.prototype.writeUIntLE=
a(function(e,t,n,i){if(e=+e,t=t>>>0,n=n>>>0,!i){let u=Math.pow(2,8*n)-1;K(this,e,
...
if(e=+e,t=t>>>0,n=n>>>0,!i){let u=Math.pow(2,8*n)-1;K(this,e,t,n,u,0)}let s=n-1,
...
+e,t=t>>>0,n||K(this,e,t,1,255,0),this[t]=e&255,t+1},"writeUInt8");f.prototype.writeUint16LE=
f.prototype.writeUInt16LE=a(function(e,t,n){return e=+e,t=t>>>0,n||K(this,e,t,2,
65535,0),this[t]=e&255,this[t+1]=e>>>8,t+2},"writeUInt16LE");f.prototype.writeUint16BE=
f.prototype.writeUInt16BE=a(function(e,t,n){return e=+e,t=t>>>0,n||K(this,e,t,2,
65535,0),this[t]=e>>>8,this[t+1]=e&255,t+2},"writeUInt16BE");f.prototype.writeUint32LE=
f.prototype.writeUInt32LE=a(function(e,t,n){return e=+e,t=t>>>0,n||K(this,e,t,4,
...
return e=+e,t=t>>>0,n||K(this,e,t,4,4294967295,0),this[t]=e>>>24,this[t+1]=e>>>16,
this[t+2]=e>>>8,this[t+3]=e&255,t+4},"writeUInt32BE");function kn(r,e,t,n,i){Wn(
...
o,o=o>>8,r[t++]=o,o=o>>8,r[t++]=o,o=o>>8,r[t++]=o,t}a(kn,"wrtBigUInt64LE");function Un(r,e,t,n,i){
Wn(e,n,i,r,t,7);let s=Number(e&BigInt(4294967295));r[t+7]=s,s=s>>8,r[t+6]=s,s=s>>
8,r[t+5]=s,s=s>>8,r[t+4]=s;let o=Number(e>>BigInt(32)&BigInt(4294967295));return r[t+
3]=o,o=o>>8,r[t+2]=o,o=o>>8,r[t+1]=o,o=o>>8,r[t]=o,t+8}a(Un,"wrtBigUInt64BE");f.
prototype.writeBigUInt64LE=ge(a(function(e,t=0){return kn(this,e,t,BigInt(0),BigInt(
"0xffffffffffffffff"))},"writeBigUInt64LE"));f.prototype.writeBigUInt64BE=ge(a(function(e,t=0){
return Un(this,e,t,BigInt(0),BigInt("0xffffffffffffffff"))},"writeBigUInt64BE"));
f.prototype.writeIntLE=a(function(e,t,n,i){if(e=+e,t=t>>>0,!i){let c=Math.pow(2,
8*n-1);K(this,e,t,n,c-1,-c)}let s=0,o=1,u=0;for(this[t]=e&255;++s<n&&(o*=256);)e<
...
2,8*n-1);K(this,e,t,n,c-1,-c)}let s=n-1,o=1,u=0;for(this[t+s]=e&255;--s>=0&&(o*=
256);)e<0&&u===0&&this[t+s+1]!==0&&(u=1),this[t+s]=(e/o>>0)-u&255;return t+n},"w\
riteIntBE");f.prototype.writeInt8=a(function(e,t,n){return e=+e,t=t>>>0,n||K(this,
e,t,1,127,-128),e<0&&(e=255+e+1),this[t]=e&255,t+1},"writeInt8");f.prototype.writeInt16LE=
a(function(e,t,n){return e=+e,t=t>>>0,n||K(this,e,t,2,32767,-32768),this[t]=e&255,
this[t+1]=e>>>8,t+2},"writeInt16LE");f.prototype.writeInt16BE=a(function(e,t,n){
return e=+e,t=t>>>0,n||K(this,e,t,2,32767,-32768),this[t]=e>>>8,this[t+1]=e&255,
t+2},"writeInt16BE");f.prototype.writeInt32LE=a(function(e,t,n){return e=+e,t=t>>>
0,n||K(this,e,t,4,2147483647,-2147483648),this[t]=e&255,this[t+1]=e>>>8,this[t+2]=
e>>>16,this[t+3]=e>>>24,t+4},"writeInt32LE");f.prototype.writeInt32BE=a(function(e,t,n){
return e=+e,t=t>>>0,n||K(this,e,t,4,2147483647,-2147483648),e<0&&(e=4294967295+e+
1),this[t]=e>>>24,this[t+1]=e>>>16,this[t+2]=e>>>8,this[t+3]=e&255,t+4},"writeIn\
t32BE");f.prototype.writeBigInt64LE=ge(a(function(e,t=0){return kn(this,e,t,-BigInt(
"0x8000000000000000"),BigInt("0x7fffffffffffffff"))},"writeBigInt64LE"));f.prototype.
writeBigInt64BE=ge(a(function(e,t=0){return Un(this,e,t,-BigInt("0x8000000000000\
...
"Index out of range")}a(qn,"checkIEEE754");function Nn(r,e,t,n,i){return e=+e,t=
t>>>0,i||qn(r,e,t,4,34028234663852886e22,-34028234663852886e22),Te.write(r,e,t,n,
23,4),t+4}a(Nn,"writeFloat");f.prototype.writeFloatLE=a(function(e,t,n){return Nn(
this,e,t,!0,n)},"writeFloatLE");f.prototype.writeFloatBE=a(function(e,t,n){return Nn(
this,e,t,!1,n)},"writeFloatBE");function Qn(r,e,t,n,i){return e=+e,t=t>>>0,i||qn(
r,e,t,8,17976931348623157e292,-17976931348623157e292),Te.write(r,e,t,n,52,8),t+8}
a(Qn,"writeDouble");f.prototype.writeDoubleLE=a(function(e,t,n){return Qn(this,e,
t,!0,n)},"writeDoubleLE");f.prototype.writeDoubleBE=a(function(e,t,n){return Qn(
...
o[s%u]}return this},"fill");var Ie={};function Mt(r,e,t){var n;Ie[r]=(n=class extends t{constructor(){
...
a(n,"NodeError"),n)}a(Mt,"E");Mt("ERR_BUFFER_OUT_OF_BOUNDS",function(r){return r?
...
isInteger(t)&&Math.abs(t)>2**32?i=Ln(String(t)):typeof t=="bigint"&&(i=String(t),
(t>BigInt(2)**BigInt(32)||t<-(BigInt(2)**BigInt(32)))&&(i=Ln(i)),i+="n"),n+=` It\
 must be ${e}. Received ${i}`,n},RangeError);function Ln(r){let e="",t=r.length,
n=r[0]==="-"?1:0;for(;t>=n+4;t-=3)e=`_${r.slice(t-3,t)}${e}`;return`${r.slice(0,
t)}${e}`}a(Ln,"addNumericalSeparator");function Lo(r,e,t){Pe(e,"offset"),(r[e]===
void 0||r[e+t]===void 0)&&We(e,r.length-(t+1))}a(Lo,"checkBounds");function Wn(r,e,t,n,i,s){
...
"value",u,r)}Lo(n,i,s)}a(Wn,"checkIntBI");function Pe(r,e){if(typeof r!="number")
...
1:0} and <= ${e}`,r)}a(We,"boundsError");var Ro=/[^+/0-9A-Za-z-_]/g;function Fo(r){
if(r=r.split("=")[0],r=r.trim().replace(Ro,""),r.length<2)return"";for(;r.length%
4!==0;)r=r+"=";return r}a(Fo,"base64clean");function Lt(r,e){e=e||1/0;let t,n=r.
...
Lt,"utf8ToBytes");function Mo(r){let e=[];for(let t=0;t<r.length;++t)e.push(r.charCodeAt(
...
a(Do,"utf16leToBytes");function jn(r){return Tt.toByteArray(Fo(r))}a(jn,"base64T\
...
a(ue,"isInstance");function Dt(r){return r!==r}a(Dt,"numberIsNaN");var Oo=function(){
...
a(ko,"BufferBigIntNotDefined")});var b,S,E,w,d,m,p=$(()=>{"use strict";b=globalThis,S=globalThis.setImmediate??(r=>setTimeout(
...
Buffer.allocUnsafe=="function"?globalThis.Buffer:Hn().Buffer,m=globalThis.process??
{};m.env??(m.env={});try{m.nextTick(()=>{})}catch{let e=Promise.resolve();m.nextTick=
e.then.bind(e)}});var we=I((Xc,Ot)=>{"use strict";p();var Le=typeof Reflect=="object"?Reflect:null,
Gn=Le&&typeof Le.apply=="function"?Le.apply:a(function(e,t,n){return Function.prototype.
apply.call(e,t,n)},"ReflectApply"),ot;Le&&typeof Le.ownKeys=="function"?ot=Le.ownKeys:
...
e},"NumberIsNaN");function B(){B.init.call(this)}a(B,"EventEmitter");Ot.exports=
B;Ot.exports.once=Wo;B.EventEmitter=B;B.prototype._events=void 0;B.prototype._eventsCount=
0;B.prototype._maxListeners=void 0;var $n=10;function at(r){if(typeof r!="functi\
on")throw new TypeError('The "listener" argument must be of type Function. Recei\
ved type '+typeof r)}a(at,"checkListener");Object.defineProperty(B,"defaultMaxLi\
steners",{enumerable:!0,get:function(){return $n},set:function(r){if(typeof r!="\
number"||r<0||Vn(r))throw new RangeError('The value of "defaultMaxListeners" is \
out of range. It must be a non-negative number. Received '+r+".");$n=r}});B.init=
...
s");function Kn(r){return r._maxListeners===void 0?B.defaultMaxListeners:r._maxListeners}
a(Kn,"_getMaxListeners");B.prototype.getMaxListeners=a(function(){return Kn(this)},
...
o,u}var c=s[e];if(c===void 0)return!1;if(typeof c=="function")Gn(c,this,t);else for(var h=c.
length,l=Xn(c,h),n=0;n<h;++n)Gn(l[n],this,t);return!0},"emit");function zn(r,e,t,n){
...
n"?o=s[e]=n?[t,o]:[o,t]:n?o.unshift(t):o.push(t),i=Kn(r),i>0&&o.length>i&&!o.warned){
...
return r}a(zn,"_addListener");B.prototype.addListener=a(function(e,t){return zn(
this,e,t,!1)},"addListener");B.prototype.on=B.prototype.addListener;B.prototype.
prependListener=a(function(e,t){return zn(this,e,t,!0)},"prependListener");function qo(){
...
target,arguments)}a(qo,"onceWrapper");function Yn(r,e,t){var n={fired:!1,wrapFn:void 0,
target:r,type:e,listener:t},i=qo.bind(n);return i.listener=t,n.wrapFn=i,i}a(Yn,"\
_onceWrap");B.prototype.once=a(function(e,t){return at(t),this.on(e,Yn(this,e,t)),
this},"once");B.prototype.prependOnceListener=a(function(e,t){return at(t),this.
prependListener(e,Yn(this,e,t)),this},"prependOnceListener");B.prototype.removeListener=
...
removeListener(e,t[i]);return this},"removeAllListeners");function Zn(r,e,t){var n=r.
_events;if(n===void 0)return[];var i=n[e];return i===void 0?[]:typeof i=="functi\
on"?t?[i.listener||i]:[i]:t?Qo(i):Xn(i,i.length)}a(Zn,"_listeners");B.prototype.
listeners=a(function(e){return Zn(this,e,!0)},"listeners");B.prototype.rawListeners=
a(function(e){return Zn(this,e,!1)},"rawListeners");B.listenerCount=function(r,e){
return typeof r.listenerCount=="function"?r.listenerCount(e):Jn.call(r,e)};B.prototype.
listenerCount=Jn;function Jn(r){var e=this._events;if(e!==void 0){var t=e[r];if(typeof t==
"function")return 1;if(t!==void 0)return t.length}return 0}a(Jn,"listenerCount");
B.prototype.eventNames=a(function(){return this._eventsCount>0?ot(this._events):
[]},"eventNames");function Xn(r,e){for(var t=new Array(e),n=0;n<e;++n)t[n]=r[n];
return t}a(Xn,"arrayClone");function No(r,e){for(;e+1<r.length;e++)r[e]=r[e+1];r.
...
arguments))}a(s,"resolver"),ei(r,e,s,{once:!0}),e!=="error"&&jo(r,i,{once:!0})})}
a(Wo,"once");function jo(r,e,t){typeof r.on=="function"&&ei(r,"error",e,t)}a(jo,
"addErrorHandlerIfEventEmitter");function ei(r,e,t,n){if(typeof r.on=="function")
...
ed type '+typeof r)}a(ei,"eventTargetAgnosticAddListener")});var je={};ee(je,{default:()=>Ho});var Ho,He=$(()=>{"use strict";p();Ho={}});function Ge(r){let e=1779033703,t=3144134277,n=1013904242,i=2773480762,s=1359893119,
...
2361852424,2428436474,2756734187,3204031479,3329325298],x=a((A,g)=>A>>>g|A<<32-g,
"rrot"),_=new Uint32Array(64),P=new Uint8Array(64),N=a(()=>{for(let L=0,G=0;L<16;L++,
G+=4)_[L]=P[G]<<24|P[G+1]<<16|P[G+2]<<8|P[G+3];for(let L=16;L<64;L++){let G=x(_[L-
15],7)^x(_[L-15],18)^_[L-15]>>>3,he=x(_[L-2],17)^x(_[L-2],19)^_[L-2]>>>10;_[L]=_[L-
16]+G+_[L-7]+he|0}let A=e,g=t,D=n,H=i,Q=s,W=o,ce=u,se=c;for(let L=0;L<64;L++){let G=x(
Q,6)^x(Q,11)^x(Q,25),he=Q&W^~Q&ce,ye=se+G+he+y[L]+_[L]|0,me=x(A,2)^x(A,13)^x(A,22),
oe=A&g^A&D^g&D,J=me+oe|0;se=ce,ce=W,W=Q,Q=H+ye|0,H=D,D=g,g=A,A=ye+J|0}e=e+A|0,t=
t+g|0,n=n+D|0,i=i+H|0,s=s+Q|0,o=o+W|0,u=u+ce|0,c=c+se|0,l=0},"process"),Z=a(A=>{
...
g[31]=c&255,g},"digest");return r===void 0?{add:Z,digest:de}:(Z(r),de())}var ti=$(
()=>{"use strict";p();a(Ge,"sha256")});var O,$e,ri=$(()=>{"use strict";p();O=class O{constructor(){T(this,"_dataLength",
...
ut",[]),T(O,"onePassHasher",new O);$e=O});var kt={};ee(kt,{createHash:()=>$o,createHmac:()=>Vo,randomBytes:()=>Go});function Go(r){
...
set(Ge(o),64),d.from(Ge(u))}}}}}var Ut=$(()=>{"use strict";p();ti();ri();a(Go,"r\
andomBytes");a($o,"createHash");a(Vo,"createHmac")});var Nt=I(ni=>{"use strict";p();ni.parse=function(r,e){return new qt(r,e).parse()};
var ut=class ut{constructor(e,t){this.source=e,this.transform=t||Ko,this.position=
...
entries}};a(ut,"ArrayParser");var qt=ut;function Ko(r){return r}a(Ko,"identity")});var Qt=I((mh,ii)=>{p();var zo=Nt();ii.exports={create:function(r,e){return{parse:function(){
return zo.parse(r,e)}}}}});var ai=I((wh,oi)=>{"use strict";p();var Yo=/(\d{1,})-(\d{2})-(\d{2}) (\d{2}):(\d{2}):(\d{2})(\.\d{1,})?.*?( BC)?$/,
Zo=/^(\d{1,})-(\d{2})-(\d{2})( BC)?$/,Jo=/([Z+-])(\d{2})?:?(\d{2})?:?(\d{2})?/,Xo=/^-?infinity$/;
oi.exports=a(function(e){if(Xo.test(e))return Number(e.replace("i","I"));var t=Yo.
exec(e);if(!t)return ea(e)||null;var n=!!t[8],i=parseInt(t[1],10);n&&(i=si(i));var s=parseInt(
t[2],10)-1,o=t[3],u=parseInt(t[4],10),c=parseInt(t[5],10),h=parseInt(t[6],10),l=t[7];
l=l?1e3*parseFloat(l):0;var y,x=ta(e);return x!=null?(y=new Date(Date.UTC(i,s,o,
u,c,h,l)),Wt(i)&&y.setUTCFullYear(i),x!==0&&y.setTime(y.getTime()-x)):(y=new Date(
i,s,o,u,c,h,l),Wt(i)&&y.setFullYear(i)),y},"parseDate");function ea(r){var e=Zo.
exec(r);if(e){var t=parseInt(e[1],10),n=!!e[4];n&&(t=si(t));var i=parseInt(e[2],
10)-1,s=e[3],o=new Date(t,i,s);return Wt(t)&&o.setFullYear(t),o}}a(ea,"getDate");
...
e[3]||0,10)*60+parseInt(e[4]||0,10);return i*n*1e3}}a(ta,"timeZoneOffset");function si(r){
return-(r-1)}a(si,"bcYearToNegativeYear");function Wt(r){return r>=0&&r<100}a(Wt,
"is0To99")});var ci=I((xh,ui)=>{p();ui.exports=na;var ra=Object.prototype.hasOwnProperty;function na(r){
for(var e=1;e<arguments.length;e++){var t=arguments[e];for(var n in t)ra.call(t,
n)&&(r[n]=t[n])}return r}a(na,"extend")});var fi=I((_h,li)=>{"use strict";p();var ia=ci();li.exports=Re;function Re(r){if(!(this instanceof
...
"")),i+oa[n]}};var jt="([+-]?\\d+)",ca=jt+"\\s+years?",ha=jt+"\\s+mons?",la=jt+"\
\\s+days?",fa="([+-])?([\\d]*):(\\d\\d):(\\d\\d)\\.?(\\d{1,6})?",pa=new RegExp([
ca,ha,la,fa].map(function(r){return"("+r+")?"}).join("\\s*")),hi={years:2,months:4,
...
r),t=e[8]==="-";return Object.keys(hi).reduce(function(n,i){var s=hi[i],o=e[s];return!o||
(o=i==="milliseconds"?ya(o):parseInt(o,10),!o)||(t&&~da.indexOf(i)&&(o*=-1),n[i]=
o),n},{})}a(ma,"parse")});var di=I((Ih,pi)=>{"use strict";p();pi.exports=a(function(e){if(/^\\x/.test(e))return new d(
...
"\\";n+=Math.floor(i/2)*2}return new d(t,"binary")},"parseBytea")});var xi=I((Bh,Si)=>{p();var Ve=Nt(),Ke=Qt(),ct=ai(),mi=fi(),gi=di();function ht(r){
return a(function(t){return t===null?t:r(t)},"nullAllowed")}a(ht,"allowNull");function wi(r){
return r===null?r:r==="TRUE"||r==="t"||r==="true"||r==="y"||r==="yes"||r==="on"||
r==="1"}a(wi,"parseBool");function ga(r){return r?Ve.parse(r,wi):null}a(ga,"pars\
eBoolArray");function wa(r){return parseInt(r,10)}a(wa,"parseBaseTenInt");function Ht(r){
return r?Ve.parse(r,ht(wa)):null}a(Ht,"parseIntegerArray");function ba(r){return r?
Ve.parse(r,ht(function(e){return bi(e).trim()})):null}a(ba,"parseBigIntegerArray");
var Sa=a(function(r){if(!r)return null;var e=Ke.create(r,function(t){return t!==
null&&(t=Kt(t)),t});return e.parse()},"parsePointArray"),Gt=a(function(r){if(!r)
...
create(r);return e.parse()},"parseStringArray"),$t=a(function(r){if(!r)return null;
var e=Ke.create(r,function(t){return t!==null&&(t=ct(t)),t});return e.parse()},"\
parseDateArray"),xa=a(function(r){if(!r)return null;var e=Ke.create(r,function(t){
return t!==null&&(t=mi(t)),t});return e.parse()},"parseIntervalArray"),Ea=a(function(r){
return r?Ve.parse(r,ht(gi)):null},"parseByteAArray"),Vt=a(function(r){return parseInt(
r,10)},"parseInteger"),bi=a(function(r){var e=String(r);return/^\d+$/.test(e)?e:
r},"parseBigInteger"),yi=a(function(r){return r?Ve.parse(r,ht(JSON.parse)):null},
"parseJsonArray"),Kt=a(function(r){return r[0]!=="("?null:(r=r.substring(1,r.length-
...
var s=Kt(e);return s.radius=parseFloat(t),s},"parseCircle"),_a=a(function(r){r(20,
bi),r(21,Vt),r(23,Vt),r(26,Vt),r(700,parseFloat),r(701,parseFloat),r(16,wi),r(1082,
ct),r(1114,ct),r(1184,ct),r(600,Kt),r(651,re),r(718,va),r(1e3,ga),r(1001,Ea),r(1005,
Ht),r(1007,Ht),r(1028,Ht),r(1016,ba),r(1017,Sa),r(1021,Gt),r(1022,Gt),r(1231,Gt),
r(1014,re),r(1015,re),r(1008,re),r(1009,re),r(1040,re),r(1041,re),r(1115,$t),r(1182,
$t),r(1185,$t),r(1186,mi),r(1187,xa),r(17,gi),r(114,JSON.parse.bind(JSON)),r(3802,
JSON.parse.bind(JSON)),r(199,yi),r(3807,yi),r(3907,re),r(2951,re),r(791,re),r(1183,
re),r(1270,re)},"init");Si.exports={init:_a}});var vi=I((Fh,Ei)=>{"use strict";p();var z=1e6;function Aa(r){var e=r.readInt32BE(
...
e%z,o=4294967296*s+t,u=""+o%z,n+u+i}a(Aa,"readInt8");Ei.exports=Aa});var Ti=I((Oh,Ii)=>{p();var Ca=vi(),R=a(function(r,e,t,n,i){t=t||0,n=n||!1,i=i||function(_,P,N){
...
(h=i(h,o(r[l])>>8-x,x)),h},"parseBits"),Ci=a(function(r,e,t){var n=Math.pow(2,t-
...
(R(r,15,1,!0)+1):R(r,15,1)},"parseInt16"),_i=a(function(r){return R(r,1)==1?-1*(R(
r,31,1,!0)+1):R(r,31,1)},"parseInt32"),Ta=a(function(r){return Ci(r,23,8)},"pars\
eFloat32"),Pa=a(function(r){return Ci(r,52,11)},"parseFloat64"),Ba=a(function(r){
...
return(e===0?1:-1)*Math.round(n*u)/u},"parseNumeric"),Ai=a(function(r,e){var t=R(
...
return this.usec},i},"parseDate"),ze=a(function(r){for(var e=R(r,32),t=R(r,32,32),
...
var y=[],x;if(h.length>1){var _=h.shift();for(x=0;x<_;x++)y[x]=c(h,l);h.unshift(
_)}else for(x=0;x<h[0];x++)y[x]=u(l);return y},"parse");return c(s,n)},"parseArr\
ay"),La=a(function(r){return r.toString("utf8")},"parseText"),Ra=a(function(r){return r===
null?null:R(r,8)>0},"parseBool"),Fa=a(function(r){r(20,Ca),r(21,Ia),r(23,_i),r(26,
_i),r(1700,Ba),r(700,Ta),r(701,Pa),r(16,Ra),r(1114,Ai.bind(null,!1)),r(1184,Ai.bind(
null,!0)),r(1e3,ze),r(1007,ze),r(1016,ze),r(1008,ze),r(1009,ze),r(25,La)},"init");
Ii.exports={init:Fa}});var Bi=I((qh,Pi)=>{p();Pi.exports={BOOL:16,BYTEA:17,CHAR:18,INT8:20,INT2:21,INT4:23,
...
REGCONFIG:3734,REGDICTIONARY:3769,JSONB:3802,REGNAMESPACE:4089,REGROLE:4096}});var Je=I(Ze=>{p();var Ma=xi(),Da=Ti(),Oa=Qt(),ka=Bi();Ze.getTypeParser=Ua;Ze.setTypeParser=
qa;Ze.arrayParser=Oa;Ze.builtins=ka;var Ye={text:{},binary:{}};function Li(r){return String(
r)}a(Li,"noParse");function Ua(r,e){return e=e||"text",Ye[e]&&Ye[e][r]||Li}a(Ua,
"getTypeParser");function qa(r,e,t){typeof e=="function"&&(t=e,e="text"),Ye[e][r]=
t}a(qa,"setTypeParser");Ma.init(function(r,e){Ye.text[r]=e});Da.init(function(r,e){
Ye.binary[r]=e})});var Xe=I((Hh,zt)=>{"use strict";p();zt.exports={host:"localhost",user:m.platform===
...
connect_timeout:0,keepalives:1,keepalives_idle:0};var Fe=Je(),Na=Fe.getTypeParser(
20,"text"),Qa=Fe.getTypeParser(1016,"text");zt.exports.__defineSetter__("parseIn\
t8",function(r){Fe.setTypeParser(20,"text",r?Fe.getTypeParser(23,"text"):Na),Fe.
setTypeParser(1016,"text",r?Fe.getTypeParser(1007,"text"):Qa)})});var et=I(($h,Fi)=>{"use strict";p();var Wa=(Ut(),k(kt)),ja=Xe();function Ha(r){var e=r.
replace(/\\/g,"\\\\").replace(/"/g,'\\"');return'"'+e+'"'}a(Ha,"escapeElement");
function Ri(r){for(var e="{",t=0;t<r.length;t++)t>0&&(e=e+","),r[t]===null||typeof r[t]>
"u"?e=e+"NULL":Array.isArray(r[t])?e=e+Ri(r[t]):r[t]instanceof d?e+="\\\\x"+r[t].
toString("hex"):e+=Ha(lt(r[t]));return e=e+"}",e}a(Ri,"arrayString");var lt=a(function(r,e){
...
Va(r):$a(r):Array.isArray(r)?Ri(r):typeof r=="object"?Ga(r,e):r.toString()},"pre\
...
" BC"),i}a($a,"dateToString");function Va(r){var e=r.getUTCFullYear(),t=e<1;t&&(e=
Math.abs(e)+1);var n=j(e,4)+"-"+j(r.getUTCMonth()+1,2)+"-"+j(r.getUTCDate(),2)+"\
T"+j(r.getUTCHours(),2)+":"+j(r.getUTCMinutes(),2)+":"+j(r.getUTCSeconds(),2)+"."+
j(r.getUTCMilliseconds(),3);return n+="+00:00",t&&(n+=" BC"),n}a(Va,"dateToStrin\
gUTC");function Ka(r,e,t){return r=typeof r=="string"?{text:r}:r,e&&(typeof e=="\
function"?r.callback=e:r.values=e),t&&(r.callback=t),r}a(Ka,"normalizeQueryConfi\
g");var Yt=a(function(r){return Wa.createHash("md5").update(r,"utf-8").digest("h\
ex")},"md5"),za=a(function(r,e,t){var n=Yt(e+r),i=Yt(d.concat([d.from(n),t]));return"\
md5"+i},"postgresMd5PasswordHash");Fi.exports={prepareValue:a(function(e){return lt(
e)},"prepareValueWrapper"),normalizeQueryConfig:Ka,postgresMd5PasswordHash:za,md5:Yt}});var Ui=I((zh,ki)=>{"use strict";p();var Zt=(Ut(),k(kt));function Ya(r){if(r.indexOf(
...
",s="+n.salt+",i="+n.iteration,l="c=biws,r="+n.nonce,y=c+","+h+","+l,x=Me(u,y),_=Oi(
o,x),P=_.toString("base64"),N=Me(s,"Server Key"),Z=Me(N,y);r.message="SASLRespon\
se",r.serverSignature=Z.toString("base64"),r.response=l+",p="+P}a(Za,"continueSe\
...
hars");function Mi(r){return/^(?:[a-zA-Z0-9+/]{4})*(?:[a-zA-Z0-9+/]{2}==|[a-zA-Z0-9+/]{3}=)?$/.
test(r)}a(Mi,"isBase64");function Di(r){if(typeof r!="string")throw new TypeError(
...
n=e.substring(2);return[t,n]}))}a(Di,"parseAttributePairs");function eu(r){let e=Di(
...
RAM-SERVER-FIRST-MESSAGE: nonce missing");let n=e.get("s");if(n){if(!Mi(n))throw new Error(
...
ssage");function tu(r){let t=Di(r).get("v");if(t){if(!Mi(t))throw new Error("SAS\
...
a(tu,"parseServerFinalMessage");function Oi(r,e){if(!d.isBuffer(r))throw new TypeError(
...
from(r.map((t,n)=>r[n]^e[n]))}a(Oi,"xorBuffers");function ru(r){return Zt.createHash(
"sha256").update(r).digest()}a(ru,"sha256");function Me(r,e){return Zt.createHmac(
...
a(nu,"Hi");ki.exports={startSession:Ya,continueSession:Za,finalizeSession:Ja}});var Jt={};ee(Jt,{join:()=>iu});function iu(...r){return r.join("/")}var Xt=$(()=>{
"use strict";p();a(iu,"join")});var er={};ee(er,{stat:()=>su});function su(r,e){e(new Error("No filesystem"))}var tr=$(
()=>{"use strict";p();a(su,"stat")});var rr={};ee(rr,{default:()=>ou});var ou,nr=$(()=>{"use strict";p();ou={}});var qi={};ee(qi,{StringDecoder:()=>ir});var sr,ir,Ni=$(()=>{"use strict";p();sr=
class sr{constructor(e){T(this,"td");this.td=new TextDecoder(e)}write(e){return this.
td.decode(e,{stream:!0})}end(e){return this.td.decode(e)}};a(sr,"StringDecoder");
ir=sr});var Hi=I((sl,ji)=>{"use strict";p();var{Transform:au}=(nr(),k(rr)),{StringDecoder:uu}=(Ni(),k(qi)),
be=Symbol("last"),ft=Symbol("decoder");function cu(r,e,t){let n;if(this.overflow){
...
n.pop();for(let i=0;i<n.length;i++)try{Wi(this,this.mapper(n[i]))}catch(s){return t(
...
if(this[be]+=this[ft].end(),this[be])try{Wi(this,this.mapper(this[be]))}catch(e){
return r(e)}r()}a(hu,"flush");function Wi(r,e){e!==void 0&&r.push(e)}a(Wi,"push");
function Qi(r){return r}a(Qi,"noop");function lu(r,e,t){switch(r=r||/\r?\n/,e=e||
Qi,t=t||{},arguments.length){case 1:typeof r=="function"?(e=r,r=/\r?\n/):typeof r==
"object"&&!(r instanceof RegExp)&&!r[Symbol.split]&&(t=r,r=/\r?\n/);break;case 2:
typeof r=="function"?(t=e,e=r,r=/\r?\n/):typeof e=="object"&&(t=e,e=Qi)}t=Object.
assign({},t),t.autoDestroy=!0,t.transform=cu,t.flush=hu,t.readableObjectMode=!0;
let n=new au(t);return n[be]="",n[ft]=new uu("utf8"),n.matcher=r,n.mapper=e,n.maxLength=
t.maxLength,n.skipOverflow=t.skipOverflow||!1,n.overflow=!1,n._destroy=function(i,s){
this._writableState.errorEmitted=!1,s(i)},n}a(lu,"split");ji.exports=lu});var Vi=I((ul,pe)=>{"use strict";p();var Gi=(Xt(),k(Jt)),fu=(nr(),k(rr)).Stream,pu=Hi(),
$i=(He(),k(je)),du=5432,pt=m.platform==="win32",tt=m.stderr,yu=56,mu=7,gu=61440,
wu=32768;function bu(r){return(r&gu)==wu}a(bu,"isRegFile");var De=["host","port",
"database","user","password"],or=De.length,Su=De[or-1];function ar(){var r=tt instanceof
fu&&tt.writable===!0;if(r){var e=Array.prototype.slice.call(arguments).concat(`
`);tt.write($i.format.apply($i,e))}}a(ar,"warn");Object.defineProperty(pe.exports,
"isWin",{get:function(){return pt},set:function(r){pt=r}});pe.exports.warnTo=function(r){
var e=tt;return tt=r,e};pe.exports.getFileName=function(r){var e=r||m.env,t=e.PGPASSFILE||
(pt?Gi.join(e.APPDATA||"./","postgresql","pgpass.conf"):Gi.join(e.HOME||"./",".p\
gpass"));return t};pe.exports.usePgPass=function(r,e){return Object.prototype.hasOwnProperty.
call(m.env,"PGPASSWORD")?!1:pt?!0:(e=e||"<unkn>",bu(r.mode)?r.mode&(yu|mu)?(ar('\
WARNING: password file "%s" has group or world access; permissions should be u=r\
w (0600) or less',e),!1):!0:(ar('WARNING: password file "%s" is not a plain file',
e),!1))};var xu=pe.exports.match=function(r,e){return De.slice(0,-1).reduce(function(t,n,i){
...
t(n)},"onEnd"),u=a(function(c){e.destroy(),ar("WARNING: error on reading file: %\
...
for(var e="",t="",n=0,i=0,s=0,o={},u=!1,c=a(function(l,y,x){var _=r.substring(y,
x);Object.hasOwnProperty.call(m.env,"PGPASS_NO_DEESCAPE")||(_=_.replace(/\\([:\\])/g,
"$1")),o[De[l]]=_},"addToObj"),h=0;h<r.length-1;h+=1){if(e=r.charAt(h+1),t=r.charAt(
h),u=n==or-1,u){c(n,i);break}h>=0&&e==":"&&t!=="\\"&&(c(n,i,h+1),i=h+2,n+=1)}return o=
Object.keys(o).length===or?o:null,o},vu=pe.exports.isValidEntry=function(r){for(var e={
...
1){var n=e[t],i=r[De[t]]||"",s=n(i);if(!s)return!1}return!0}});var zi=I((fl,ur)=>{"use strict";p();var ll=(Xt(),k(Jt)),Ki=(tr(),k(er)),dt=Vi();
ur.exports=function(r,e){var t=dt.getFileName();Ki.stat(t,function(n,i){if(n||!dt.
usePgPass(i,t))return e(void 0);var s=Ki.createReadStream(t);dt.getPassword(r,s,
e)})};ur.exports.warnTo=dt.warnTo});var cr=I((dl,Yi)=>{"use strict";p();var _u=Je();function yt(r){this._types=r||_u,
...
"text",this.getOverrides(e)[r]||this._types.getTypeParser(r,e)};Yi.exports=yt});var Zi={};ee(Zi,{default:()=>Au});var Au,Ji=$(()=>{"use strict";p();Au={}});var Xi={};ee(Xi,{parse:()=>hr});function hr(r,e=!1){let{protocol:t}=new URL(r),n="\
http:"+r.substring(t.length),{username:i,password:s,host:o,hostname:u,port:c,pathname:h,
search:l,searchParams:y,hash:x}=new URL(n);s=decodeURIComponent(s);let _=i+":"+s,
P=e?Object.fromEntries(y.entries()):l;return{href:r,protocol:t,auth:_,username:i,
password:s,host:o,hostname:u,port:c,pathname:h,search:l,query:P,hash:x}}var lr=$(
()=>{"use strict";p();a(hr,"parse")});var ts=I((Sl,es)=>{"use strict";p();var Cu=(lr(),k(Xi)),fr=(tr(),k(er));function pr(r){
...
(t.ssl.cert=fr.readFileSync(t.sslcert).toString()),t.sslkey&&(t.ssl.key=fr.readFileSync(
t.sslkey).toString()),t.sslrootcert&&(t.ssl.ca=fr.readFileSync(t.sslrootcert).toString()),
...
return t}a(pr,"parse");es.exports=pr;pr.parse=pr});var mt=I((vl,is)=>{"use strict";p();var Iu=(Ji(),k(Zi)),ns=Xe(),rs=ts().parse,V=a(
function(r,e,t){return t===void 0?t=m.env["PG"+r.toUpperCase()]:t===!1||(t=m.env[t]),
e[r]||t||ns[r]},"val"),Tu=a(function(){switch(m.env.PGSSLMODE){case"disable":return!1;case"\
prefer":case"require":case"verify-ca":case"verify-full":return!0;case"no-verify":
return{rejectUnauthorized:!1}}return ns.ssl},"readSSLConfigFromEnvironment"),Oe=a(
function(r){return"'"+(""+r).replace(/\\/g,"\\\\").replace(/'/g,"\\'")+"'"},"quo\
teParamValue"),ne=a(function(r,e,t){var n=e[t];n!=null&&r.push(t+"="+Oe(n))},"ad\
d"),yr=class yr{constructor(e){e=typeof e=="string"?rs(e):e||{},e.connectionString&&
(e=Object.assign({},e,rs(e.connectionString))),this.user=V("user",e),this.database=
...
ne(t,n,"sslrootcert"),this.database&&t.push("dbname="+Oe(this.database)),this.replication&&
...
ent_encoding="+Oe(this.client_encoding)),Iu.lookup(this.host,function(i,s){return i?
e(i,null):(t.push("hostaddr="+Oe(s)),e(null,t.join(" ")))})}};a(yr,"ConnectionPa\
rameters");var dr=yr;is.exports=dr});var as=I((Cl,os)=>{"use strict";p();var Pu=Je(),ss=/^([A-Za-z]+)(?: (\d+))?(?: (\d+))?/,
gr=class gr{constructor(e,t){this.command=null,this.rowCount=null,this.oid=null,
...
var t;e.text?t=ss.exec(e.text):t=ss.exec(e.command),t&&(this.command=t[1],t[3]?(this.
...
ext"):this._parsers[t]=Pu.getTypeParser(n.dataTypeID,n.format||"text")}}};a(gr,"\
Result");var mr=gr;os.exports=mr});var ls=I((Pl,hs)=>{"use strict";p();var{EventEmitter:Bu}=we(),us=as(),cs=et(),br=class br extends Bu{constructor(e,t,n){
super(),e=cs.normalizeQueryConfig(e,t,n),this.text=e.text,this.values=e.values,this.
...
(this.callback=m.domain.bind(e.callback)),this._result=new us(this._rowMode,this.
...
(Array.isArray(this._results)||(this._results=[this._result]),this._result=new us(
...
binary,valueMapper:cs.prepareValue})}catch(t){this.handleError(t,e);return}e.describe(
{type:"P",name:this.portal||""}),this._getRows(e,this.rows)}handleCopyInResponse(e){
e.sendCopyFail("No source stream defined")}handleCopyData(e,t){}};a(br,"Query");
var wr=br;hs.exports=wr});var ps={};ee(ps,{Socket:()=>_e,isIP:()=>Lu});function Lu(r){return 0}var fs,Ru,v,
_e,gt=$(()=>{"use strict";p();fs=Qe(we(),1);a(Lu,"isIP");Ru=a(r=>r.replace(/^[^.]+\./,
"api."),"transformHost"),v=class v extends fs.EventEmitter{constructor(){super(...arguments);
...
tlsWrite")}static get poolQueryViaFetch(){return v.opts.poolQueryViaFetch??v.defaults.
poolQueryViaFetch}static set poolQueryViaFetch(t){v.opts.poolQueryViaFetch=t}static get fetchEndpoint(){
return v.opts.fetchEndpoint??v.defaults.fetchEndpoint}static set fetchEndpoint(t){
...
end()}};a(v,"Socket"),T(v,"defaults",{poolQueryViaFetch:!1,fetchEndpoint:t=>"htt\
ps://"+Ru(t)+"/sql",fetchConnectionCache:!0,fetchFunction:void 0,webSocketConstructor:void 0,
...
T(v,"opts",{});_e=v});var Kr=I(C=>{"use strict";p();Object.defineProperty(C,"__esModule",{value:!0});C.
...
{name:"copyDone",length:4};var Mr=class Mr extends Error{constructor(e,t,n){super(
e),this.length=t,this.name=n}};a(Mr,"DatabaseError");var Sr=Mr;C.DatabaseError=Sr;
var Dr=class Dr{constructor(e,t){this.length=e,this.chunk=t,this.name="copyData"}};
a(Dr,"CopyDataMessage");var xr=Dr;C.CopyDataMessage=xr;var Or=class Or{constructor(e,t,n,i){
this.length=e,this.name=t,this.binary=n,this.columnTypes=new Array(i)}};a(Or,"Co\
pyResponse");var Er=Or;C.CopyResponse=Er;var kr=class kr{constructor(e,t,n,i,s,o,u){
this.name=e,this.tableID=t,this.columnID=n,this.dataTypeID=i,this.dataTypeSize=s,
this.dataTypeModifier=o,this.format=u}};a(kr,"Field");var vr=kr;C.Field=vr;var Ur=class Ur{constructor(e,t){
this.length=e,this.fieldCount=t,this.name="rowDescription",this.fields=new Array(
this.fieldCount)}};a(Ur,"RowDescriptionMessage");var _r=Ur;C.RowDescriptionMessage=
...
arameterDescriptionMessage");var Ar=qr;C.ParameterDescriptionMessage=Ar;var Nr=class Nr{constructor(e,t,n){
this.length=e,this.parameterName=t,this.parameterValue=n,this.name="parameterSta\
tus"}};a(Nr,"ParameterStatusMessage");var Cr=Nr;C.ParameterStatusMessage=Cr;var Qr=class Qr{constructor(e,t){
this.length=e,this.salt=t,this.name="authenticationMD5Password"}};a(Qr,"Authenti\
cationMD5Password");var Ir=Qr;C.AuthenticationMD5Password=Ir;var Wr=class Wr{constructor(e,t,n){
this.length=e,this.processID=t,this.secretKey=n,this.name="backendKeyData"}};a(Wr,
"BackendKeyDataMessage");var Tr=Wr;C.BackendKeyDataMessage=Tr;var jr=class jr{constructor(e,t,n,i){
this.length=e,this.processId=t,this.channel=n,this.payload=i,this.name="notifica\
tion"}};a(jr,"NotificationResponseMessage");var Pr=jr;C.NotificationResponseMessage=
Pr;var Hr=class Hr{constructor(e,t){this.length=e,this.status=t,this.name="ready\
ForQuery"}};a(Hr,"ReadyForQueryMessage");var Br=Hr;C.ReadyForQueryMessage=Br;var Gr=class Gr{constructor(e,t){
this.length=e,this.text=t,this.name="commandComplete"}};a(Gr,"CommandCompleteMes\
sage");var Lr=Gr;C.CommandCompleteMessage=Lr;var $r=class $r{constructor(e,t){this.
length=e,this.fields=t,this.name="dataRow",this.fieldCount=t.length}};a($r,"Data\
RowMessage");var Rr=$r;C.DataRowMessage=Rr;var Vr=class Vr{constructor(e,t){this.
length=e,this.message=t,this.name="notice"}};a(Vr,"NoticeMessage");var Fr=Vr;C.NoticeMessage=
Fr});var ds=I(wt=>{"use strict";p();Object.defineProperty(wt,"__esModule",{value:!0});
wt.Writer=void 0;var Yr=class Yr{constructor(e=256){this.size=e,this.offset=5,this.
...
offset=5,this.headerPosition=0,this.buffer=d.allocUnsafe(this.size),t}};a(Yr,"Wr\
iter");var zr=Yr;wt.Writer=zr});var ms=I(St=>{"use strict";p();Object.defineProperty(St,"__esModule",{value:!0});
St.serialize=void 0;var Zr=ds(),F=new Zr.Writer,Fu=a(r=>{F.addInt16(3).addInt16(
0);for(let n of Object.keys(r))F.addCString(n).addCString(r[n]);F.addCString("cl\
ient_encoding").addCString("UTF8");var e=F.addCString("").flush(),t=e.length+4;return new Zr.
Writer().addInt32(t).add(e).flush()},"startup"),Mu=a(()=>{let r=d.allocUnsafe(8);
return r.writeInt32BE(8,0),r.writeInt32BE(80877103,4),r},"requestSsl"),Du=a(r=>F.
addCString(r).flush(112),"password"),Ou=a(function(r,e){return F.addCString(r).addInt32(
d.byteLength(e)).addString(e),F.flush(112)},"sendSASLInitialResponseMessage"),ku=a(
function(r){return F.addString(r).flush(112)},"sendSCRAMClientFinalMessage"),Uu=a(
r=>F.addCString(r).flush(81),"query"),ys=[],qu=a(r=>{let e=r.name||"";e.length>63&&
(console.error("Warning! Postgres only supports 63 characters for query names."),
console.error("You supplied %s (%s)",e,e.length),console.error("This can cause c\
onflicts and silent errors executing queries"));let t=r.types||ys;for(var n=t.length,
i=F.addCString(e).addCString(r.text).addInt16(n),s=0;s<n;s++)i.addInt32(t[s]);return F.
flush(80)},"parse"),ke=new Zr.Writer,Nu=a(function(r,e){for(let t=0;t<r.length;t++){
let n=e?e(r[t],t):r[t];n==null?(F.addInt16(0),ke.addInt32(-1)):n instanceof d?(F.
addInt16(1),ke.addInt32(n.length),ke.add(n)):(F.addInt16(0),ke.addInt32(d.byteLength(
n)),ke.addString(n))}},"writeValues"),Qu=a((r={})=>{let e=r.portal||"",t=r.statement||
"",n=r.binary||!1,i=r.values||ys,s=i.length;return F.addCString(e).addCString(t),
F.addInt16(s),Nu(i,r.valueMapper),F.addInt16(s),F.add(ke.flush()),F.addInt16(n?1:
0),F.flush(66)},"bind"),Wu=d.from([69,0,0,0,9,0,0,0,0,0]),ju=a(r=>{if(!r||!r.portal&&
!r.rows)return Wu;let e=r.portal||"",t=r.rows||0,n=d.byteLength(e),i=4+n+1+4,s=d.
allocUnsafe(1+i);return s[0]=69,s.writeInt32BE(i,1),s.write(e,5,"utf-8"),s[n+5]=
0,s.writeUInt32BE(t,s.length-4),s},"execute"),Hu=a((r,e)=>{let t=d.allocUnsafe(16);
return t.writeInt32BE(16,0),t.writeInt16BE(1234,4),t.writeInt16BE(5678,6),t.writeInt32BE(
r,8),t.writeInt32BE(e,12),t},"cancel"),Jr=a((r,e)=>{let n=4+d.byteLength(e)+1,i=d.
allocUnsafe(1+n);return i[0]=r,i.writeInt32BE(n,1),i.write(e,5,"utf-8"),i[n]=0,i},
"cstringMessage"),Gu=F.addCString("P").flush(68),$u=F.addCString("S").flush(68),
Vu=a(r=>r.name?Jr(68,`${r.type}${r.name||""}`):r.type==="P"?Gu:$u,"describe"),Ku=a(
r=>{let e=`${r.type}${r.name||""}`;return Jr(67,e)},"close"),zu=a(r=>F.add(r).flush(
100),"copyData"),Yu=a(r=>Jr(102,r),"copyFail"),bt=a(r=>d.from([r,0,0,0,4]),"code\
OnlyBuffer"),Zu=bt(72),Ju=bt(83),Xu=bt(88),ec=bt(99),tc={startup:Fu,password:Du,
requestSsl:Mu,sendSASLInitialResponseMessage:Ou,sendSCRAMClientFinalMessage:ku,query:Uu,
parse:qu,bind:Qu,execute:ju,describe:Vu,close:Ku,flush:()=>Zu,sync:()=>Ju,end:()=>Xu,
copyData:zu,copyDone:()=>ec,copyFail:Yu,cancel:Hu};St.serialize=tc});var gs=I(xt=>{"use strict";p();Object.defineProperty(xt,"__esModule",{value:!0});
xt.BufferReader=void 0;var rc=d.allocUnsafe(0),en=class en{constructor(e=0){this.
offset=e,this.buffer=rc,this.encoding="utf-8"}setBuffer(e,t){this.offset=e,this.
...
offset+e);return this.offset+=e,t}};a(en,"BufferReader");var Xr=en;xt.BufferReader=
Xr});var ws={};ee(ws,{default:()=>nc});var nc,bs=$(()=>{"use strict";p();nc={}});var Es=I(Ue=>{"use strict";p();var ic=Ue&&Ue.__importDefault||function(r){return r&&
r.__esModule?r:{default:r}};Object.defineProperty(Ue,"__esModule",{value:!0});Ue.
Parser=void 0;var M=Kr(),sc=gs(),oc=ic((bs(),k(ws))),tn=1,ac=4,Ss=tn+ac,xs=d.allocUnsafe(
0),nn=class nn{constructor(e){if(this.buffer=xs,this.bufferLength=0,this.bufferOffset=
0,this.reader=new sc.BufferReader,e?.mode==="binary")throw new Error("Binary mod\
e not supported yet");this.mode=e?.mode||"text"}parse(e,t){this.mergeBuffer(e);let n=this.
bufferOffset+this.bufferLength,i=this.bufferOffset;for(;i+Ss<=n;){let s=this.buffer[i],
o=this.buffer.readUInt32BE(i+tn),u=tn+o;if(u+i<=n){let c=this.handlePacket(i+Ss,
s,o,this.buffer);t(c),i+=u}else break}i===n?(this.buffer=xs,this.bufferLength=0,
...
return this.parseCopyData(e,n,i);default:oc.default.fail(`unknown message code: ${t.
...
line=s.L,c.routine=s.R,c}};a(nn,"Parser");var rn=nn;Ue.Parser=rn});var sn=I(Se=>{"use strict";p();Object.defineProperty(Se,"__esModule",{value:!0});
Se.DatabaseError=Se.serialize=Se.parse=void 0;var uc=Kr();Object.defineProperty(
Se,"DatabaseError",{enumerable:!0,get:function(){return uc.DatabaseError}});var cc=ms();
Object.defineProperty(Se,"serialize",{enumerable:!0,get:function(){return cc.serialize}});
var hc=Es();function lc(r,e){let t=new hc.Parser;return r.on("data",n=>t.parse(n,
e)),new Promise(n=>r.on("end",()=>n()))}a(lc,"parse");Se.parse=lc});var vs={};ee(vs,{connect:()=>fc});function fc({socket:r,servername:e}){return r.
startTls(e),r}var _s=$(()=>{"use strict";p();a(fc,"connect")});var un=I((tf,Is)=>{"use strict";p();var As=(gt(),k(ps)),pc=we().EventEmitter,{parse:dc,
serialize:q}=sn(),Cs=q.flush(),yc=q.sync(),mc=q.end(),an=class an extends pc{constructor(e){
...
nnection"))}var u=(_s(),k(vs));let c={socket:n.stream};n.ssl!==!0&&(Object.assign(
...
_ending=!0,this._send(Cs),this._send(yc)}ref(){this.stream.ref()}unref(){this.stream.
...
this._send(q.copyFail(e))}};a(an,"Connection");var on=an;Is.exports=on});var Bs=I((of,Ps)=>{"use strict";p();var gc=we().EventEmitter,sf=(He(),k(je)),wc=et(),
cn=Ui(),bc=zi(),Sc=cr(),xc=mt(),Ts=ls(),Ec=Xe(),vc=un(),hn=class hn extends gc{constructor(e){
super(),this.connectionParameters=new xc(e),this.user=this.connectionParameters.
...
t.Promise||b.Promise,this._types=new Sc(t.types),this._ending=!1,this._connecting=
...
binary||Ec.binary,this.processID=null,this.secretKey=null,this.ssl=this.connectionParameters.
...
this.saslSession=cn.startSession(e.mechanisms),this.connection.sendSASLInitialResponseMessage(
this.saslSession.mechanism,this.saslSession.response)})}_handleAuthSASLContinue(e){
cn.continueSession(this.saslSession,this.password,e.data),this.connection.sendSCRAMClientFinalMessage(
this.saslSession.response)}_handleAuthSASLFinal(e){cn.finalizeSession(this.saslSession,
...
_Promise(t=>{this.connection.once("end",t)})}};a(hn,"Client");var Et=hn;Et.Query=
Ts;Ps.exports=Et});var Ms=I((cf,Fs)=>{"use strict";p();var _c=we().EventEmitter,Ls=a(function(){},"\
NOOP"),Rs=a((r,e)=>{let t=r.findIndex(e);return t===-1?void 0:r.splice(t,1)[0]},
"removeWhere"),pn=class pn{constructor(e,t,n){this.client=e,this.idleListener=t,
this.timeoutId=n}};a(pn,"IdleItem");var ln=pn,dn=class dn{constructor(e){this.callback=
e}};a(dn,"PendingItem");var qe=dn;function Ac(){throw new Error("Release called \
...
o),o});return{callback:i,result:s}}a(vt,"promisify");function Cc(r,e){return a(function t(n){
...
"idleListener")}a(Cc,"makeIdleListener");var yn=class yn extends _c{constructor(e,t){
...
o),t.callback(u,c,h)},"queueCallback"),s=new qe(i),o=setTimeout(()=>{Rs(this._pendingQueue,
...
t,new qe((h,l,y)=>y()),n,!1)},this.options.maxLifetimeSeconds*1e3);u.unref(),t.once(
...
length}};a(yn,"Pool");var fn=yn;Fs.exports=fn});var Ds={};ee(Ds,{default:()=>Ic});var Ic,Os=$(()=>{"use strict";p();Ic={}});var ks=I((pf,Tc)=>{Tc.exports={name:"pg",version:"8.8.0",description:"PostgreSQL\
...
7b9a5491a178655"}});var Ns=I((df,qs)=>{"use strict";p();var Us=we().EventEmitter,Pc=(He(),k(je)),mn=et(),
Ne=qs.exports=function(r,e,t){Us.call(this),r=mn.normalizeQueryConfig(r,e,t),this.
...
Ne,Us);var Bc={sqlState:"code",statementPosition:"position",messagePrimary:"mess\
...
text,t)}});var Hs=I((wf,js)=>{"use strict";p();var Lc=(Os(),k(Ds)),Rc=cr(),gf=ks(),Qs=we().
EventEmitter,Fc=(He(),k(je)),Mc=mt(),Ws=Ns(),Y=js.exports=function(r){Qs.call(this),
r=r||{},this._Promise=r.Promise||b.Promise,this._types=new Rc(r.types),this.native=
...
e.port,this.namedQueries={}};Y.Query=Ws;Fc.inherits(Y,Qs);Y.prototype._errorAllQueries=
...
_types.getTypeParser(r,e)}});var gn=I((xf,Gs)=>{"use strict";p();Gs.exports=Hs()});var _t=I((vf,rt)=>{"use strict";p();var Dc=Bs(),Oc=Xe(),kc=un(),Uc=Ms(),{DatabaseError:qc}=sn(),
Nc=a(r=>{var e;return e=class extends Uc{constructor(n){super(n,r)}},a(e,"BoundP\
ool"),e},"poolFactory"),wn=a(function(r){this.defaults=Oc,this.Client=r,this.Query=
this.Client.Query,this.Pool=Nc(this.Client),this._pools=[],this.Connection=kc,this.
types=Je(),this.DatabaseError=qc},"PG");typeof m.env.NODE_PG_FORCE_NATIVE<"u"?rt.
exports=new wn(gn()):(rt.exports=new wn(Dc),Object.defineProperty(rt.exports,"na\
tive",{configurable:!0,enumerable:!1,get(){var r=null;try{r=new wn(gn())}catch(e){
if(e.code!=="MODULE_NOT_FOUND")throw e}return Object.defineProperty(rt.exports,"\
native",{value:r}),r}}))});p();var At=Qe(_t());gt();p();lr();gt();var Ks=Qe(et());var bn=class bn extends Error{constructor(){super(...arguments);T(this,"name","N\
eonDbError");T(this,"code",null);T(this,"sourceError")}};a(bn,"NeonDbError");var Ae=bn,
$s="transaction() expects an array of queries, or a function returning an array \
of queries";function zs(r,{arrayMode:e,fullResults:t,fetchOptions:n,isolationLevel:i,
...
variable has not been set?");let h;try{h=hr(r)}catch{throw new Error("Database c\
onnection string provided to `neon()` is not a valid URL. Connection string: "+String(
r))}let{protocol:l,username:y,password:x,hostname:_,port:P,pathname:N}=h;if(l!==
"postgres:"&&l!=="postgresql:"||!y||!x||!_||!N)throw new Error("Database connect\
ion string format for `neon()` should be: postgresql://user:password@host.tld/db\
name?option=value");function Z(A,...g){let D,H;if(typeof A=="string")D=A,H=g[1],
g=g[0]??[];else{D="";for(let W=0;W<A.length;W++)D+=A[W],W<g.length&&(D+="$"+(W+1))}
g=g.map(W=>(0,Ks.prepareValue)(W));let Q={query:D,params:g};return u&&u(Q),Qc(de,
Q,H)}a(Z,"resolve"),Z.transaction=async(A,g)=>{if(typeof A=="function"&&(A=A(Z)),
!Array.isArray(A))throw new Error($s);let D=A.map(H=>{if(H[Symbol.toStringTag]!==
"NeonQueryPromise")throw new Error($s);return H.parameterizedQuery});return de(D,
g)};async function de(A,g){let D=n??{},{fetchEndpoint:H,fetchFunction:Q}=_e,W=typeof H==
"function"?H(_,P):H,ce=Array.isArray(A)?{queries:A}:A,se=e??!1,L=t??!1,G=i,he=s,
ye=o;g!==void 0&&(g.arrayMode!==void 0&&(se=g.arrayMode),g.fullResults!==void 0&&
(L=g.fullResults),g.fetchOptions!==void 0&&(D={...D,...g.fetchOptions}),g.isolationLevel!==
void 0&&(G=g.isolationLevel),g.readOnly!==void 0&&(he=g.readOnly),g.deferrable!==
void 0&&(ye=g.deferrable));let me={"Neon-Connection-String":r,"Neon-Raw-Text-Out\
put":"true","Neon-Array-Mode":"true"};Array.isArray(A)&&(G!==void 0&&(me["Neon-B\
atch-Isolation-Level"]=G),he!==void 0&&(me["Neon-Batch-Read-Only"]=String(he)),ye!==
void 0&&(me["Neon-Batch-Deferrable"]=String(ye)));let oe;try{oe=await(Q??fetch)(
W,{method:"POST",body:JSON.stringify(ce),headers:me,...D})}catch(J){let ie=new Ae(
`Error connecting to database: ${J.message}`);throw ie.sourceError=J,ie}if(oe.ok){
let J=await oe.json();if(Array.isArray(A)){let ie=J.results;if(!Array.isArray(ie))
throw new Ae("Neon internal error: unexpected result format");return ie.map((le,X)=>Vs(
le,{arrayMode:se,fullResults:L,parameterizedQuery:A[X],resultCallback:c}))}else return Vs(
J,{arrayMode:se,fullResults:L,parameterizedQuery:A,resultCallback:c})}else{let{status:J}=oe;
if(J===400){let{message:ie,code:le}=await oe.json(),X=new Ae(ie);throw X.code=le,
X}else{let ie=await oe.text();throw new Ae(`Server error (HTTP status ${J}): ${ie}`)}}}
return a(de,"execute"),Z}a(zs,"neon");function Qc(r,e,t){return{[Symbol.toStringTag]:"\
NeonQueryPromise",parameterizedQuery:e,opts:t,then:(n,i)=>r(e,t).then(n,i),catch:n=>r(
e,t).catch(n),finally:n=>r(e,t).finally(n)}}a(Qc,"createNeonQueryPromise");function Vs(r,{
arrayMode:e,fullResults:t,parameterizedQuery:n,resultCallback:i}){let s=r.fields.
map(c=>c.name),o=r.fields.map(c=>xe.types.getTypeParser(c.dataTypeID)),u=e===!0?
...
t?(r.viaNeonFetch=!0,r.rowAsArray=e,r.rows=u,r):u}a(Vs,"processQueryResult");var Zs=Qe(mt()),xe=Qe(_t());var xn=class xn extends At.Client{constructor(t){super(t);this.config=t}get neonConfig(){
...
fromEntries(s.split(",").map(le=>{if(!/^.=/.test(le))throw new Error("SASL: Inva\
lid attribute pair entry");let X=le[0],Js=le.substring(2);return[X,Js]})),u=o.r,
c=o.s,h=o.i;if(!u||!/^[!-+--~]+$/.test(u))throw new Error("SASL: SCRAM-SERVER-FI\
...
_=x.encode(i),P=await w.subtle.importKey("raw",_,{name:"HMAC",hash:{name:"SHA-25\
6"}},!1,["sign"]),N=new Uint8Array(await w.subtle.sign("HMAC",P,d.concat([y,d.from(
[0,0,0,1])]))),Z=N;for(var de=0;de<l-1;de++)N=new Uint8Array(await w.subtle.sign(
"HMAC",P,N)),Z=d.from(Z.map((le,X)=>Z[X]^N[X]));let A=Z,g=await w.subtle.importKey(
"raw",A,{name:"HMAC",hash:{name:"SHA-256"}},!1,["sign"]),D=new Uint8Array(await w.
subtle.sign("HMAC",g,x.encode("Client Key"))),H=await w.subtle.digest("SHA-256",
D),Q="n=*,r="+n.clientNonce,W="r="+u+",s="+c+",i="+l,ce="c=biws,r="+u,se=Q+","+W+
","+ce,L=await w.subtle.importKey("raw",H,{name:"HMAC",hash:{name:"SHA-256"}},!1,
["sign"]);var G=new Uint8Array(await w.subtle.sign("HMAC",L,x.encode(se))),he=d.
from(D.map((le,X)=>D[X]^G[X])),ye=he.toString("base64");let me=await w.subtle.importKey(
"raw",A,{name:"HMAC",hash:{name:"SHA-256"}},!1,["sign"]),oe=await w.subtle.sign(
"HMAC",me,x.encode("Server Key")),J=await w.subtle.importKey("raw",oe,{name:"HMA\
C",hash:{name:"SHA-256"}},!1,["sign"]);var ie=d.from(await w.subtle.sign("HMAC",
J,x.encode(se)));n.message="SASLResponse",n.serverSignature=ie.toString("base64"),
n.response=ce+",p="+ye,this.connection.sendSCRAMClientFinalMessage(this.saslSession.
response)}};a(xn,"NeonClient");var Sn=xn;function Wc(r,e){if(e)return{callback:e,
result:void 0};let t,n,i=a(function(o,u){o?t(o):n(u)},"cb"),s=new r(function(o,u){
n=o,t=u});return{callback:i,result:s}}a(Wc,"promisify");var En=class En extends At.Pool{constructor(){
super(...arguments);T(this,"Client",Sn);T(this,"hasFetchUnsupportedListeners",!1)}on(t,n){
...
export{Sn as Client,export_ClientBase as ClientBase,export_Connection as Connection,
export_DatabaseError as DatabaseError,Ae as NeonDbError,Ys as Pool,export_Query as Query,
