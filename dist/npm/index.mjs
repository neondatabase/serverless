var to=Object.create;var Ie=Object.defineProperty;var ro=Object.getOwnPropertyDescriptor;var no=Object.getOwnPropertyNames;var io=Object.getPrototypeOf,so=Object.prototype.hasOwnProperty;var oo=(r,e,t)=>e in r?Ie(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):
r[e]=t;var a=(r,e)=>Ie(r,"name",{value:e,configurable:!0});var V=(r,e)=>()=>(r&&(e=r(r=0)),e);var I=(r,e)=>()=>(e||r((e={exports:{}}).exports,e),e.exports),X=(r,e)=>{for(var t in e)
...
ro(e,i))||n.enumerable});return r};var je=(r,e,t)=>(t=r!=null?to(io(r)):{},An(e||!r||!r.__esModule?Ie(t,"default",{
value:r,enumerable:!0}):t,r)),k=r=>An(Ie({},"__esModule",{value:!0}),r);var P=(r,e,t)=>(oo(r,typeof e!="symbol"?e+"":e,t),t);var Pn=I(it=>{"use strict";p();it.byteLength=uo;it.toByteArray=ho;it.fromByteArray=
po;var oe=[],ee=[],ao=typeof Uint8Array<"u"?Uint8Array:Array,It="ABCDEFGHIJKLMNO\
PQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";for(Ee=0,Cn=It.length;Ee<Cn;++Ee)
oe[Ee]=It[Ee],ee[It.charCodeAt(Ee)]=Ee;var Ee,Cn;ee[45]=62;ee[95]=63;function In(r){
...
"getLens");function uo(r){var e=In(r),t=e[0],n=e[1];return(t+n)*3/4-n}a(uo,"byte\
Length");function co(r,e,t){return(e+t)*3/4-t}a(co,"_byteLength");function ho(r){
var e,t=In(r),n=t[0],i=t[1],s=new ao(co(r,n,i)),o=0,u=i>0?n-4:n,c;for(c=0;c<u;c+=
...
e&255),s}a(ho,"toByteArray");function lo(r){return oe[r>>18&63]+oe[r>>12&63]+oe[r>>
6&63]+oe[r&63]}a(lo,"tripletToBase64");function fo(r,e,t){for(var n,i=[],s=e;s<t;s+=
...
u=t-n;o<u;o+=s)i.push(fo(r,o,o+s>u?u:o+s));return n===1?(e=r[t-1],i.push(oe[e>>2]+
oe[e<<4&63]+"==")):n===2&&(e=(r[t-2]<<8)+r[t-1],i.push(oe[e>>10]+oe[e>>4&63]+oe[e<<
2&63]+"=")),i.join("")}a(po,"fromByteArray")});var Tn=I(Pt=>{p();Pt.read=function(r,e,t,n,i){var s,o,u=i*8-n-1,c=(1<<u)-1,h=c>>
...
i-=8);for(o=o<<i|u,h+=i;h>0;r[t+_]=o&255,_+=T,o/=256,h-=8);r[t+_-T]|=N*128}});var $n=I(Le=>{"use strict";p();var Tt=Pn(),Te=Tn(),Bn=typeof Symbol=="function"&&
...
be of type string. Received type number');return Ft(r)}return Mn(r,e,t)}a(f,"Buf\
fer");f.poolSize=8192;function Mn(r,e,t){if(typeof r=="string")return go(r,e);if(ArrayBuffer.
...
Mn,"from");f.from=function(r,e,t){return Mn(r,e,t)};Object.setPrototypeOf(f.prototype,
Uint8Array.prototype);Object.setPrototypeOf(f,Uint8Array);function Dn(r){if(typeof r!=
"number")throw new TypeError('"size" argument must be of type number');if(r<0)throw new RangeError(
'The value "'+r+'" is invalid for option "size"')}a(Dn,"assertSize");function mo(r,e,t){
return Dn(r),r<=0?le(r):e!==void 0?typeof t=="string"?le(r).fill(e,t):le(r).fill(
e):le(r)}a(mo,"alloc");f.alloc=function(r,e,t){return mo(r,e,t)};function Ft(r){
return Dn(r),le(r<0?0:Mt(r)|0)}a(Ft,"allocUnsafe");f.allocUnsafe=function(r){return Ft(
r)};f.allocUnsafeSlow=function(r){return Ft(r)};function go(r,e){if((typeof e!="\
string"||e==="")&&(e="utf8"),!f.isEncoding(e))throw new TypeError("Unknown encod\
ing: "+e);let t=On(r,e)|0,n=le(t),i=n.write(r,e);return i!==t&&(n=n.slice(0,i)),
n}a(go,"fromString");function Bt(r){let e=r.length<0?0:Mt(r.length)|0,t=le(e);for(let n=0;n<
e;n+=1)t[n]=r[n]&255;return t}a(Bt,"fromArrayLike");function wo(r){if(ae(r,Uint8Array)){
let e=new Uint8Array(r);return Lt(e.buffer,e.byteOffset,e.byteLength)}return Bt(
r)}a(wo,"fromArrayView");function Lt(r,e,t){if(e<0||r.byteLength<e)throw new RangeError(
...
n,f.prototype),n}a(Lt,"fromArrayBuffer");function bo(r){if(f.isBuffer(r)){let e=Mt(
...
Array.isArray(r.data))return Bt(r.data)}a(bo,"fromObject");function Mt(r){if(r>=
st)throw new RangeError("Attempt to allocate Buffer larger than maximum size: 0x"+
st.toString(16)+" bytes");return r|0}a(Mt,"checked");function So(r){return+r!=r&&
...
this,e,t);case"utf8":case"utf-8":return Un(this,e,t);case"ascii":return To(this,
...
xo,"slowToString");f.prototype._isBuffer=!0;function ve(r,e,t){let n=r[e];r[e]=r[t],
...
if(h[y]!==l[y]){o=h[y],u=l[y];break}return o<u?-1:u<o?1:0},"compare");function kn(r,e,t,n,i){
...
indexOf=a(function(e,t,n){return kn(this,e,t,n,!0)},"indexOf");f.prototype.lastIndexOf=
a(function(e,t,n){return kn(this,e,t,n,!1)},"lastIndexOf");function Eo(r,e,t,n){
...
return o;r[t+o]=u}return o}a(Eo,"hexWrite");function vo(r,e,t,n){return ot(Rt(e,
r.length-t),r,t,n)}a(vo,"utf8Write");function _o(r,e,t,n){return ot(Oo(e),r,t,n)}
a(_o,"asciiWrite");function Ao(r,e,t,n){return ot(Gn(e),r,t,n)}a(Ao,"base64Write");
...
length?Tt.fromByteArray(r):Tt.fromByteArray(r.slice(e,t))}a(Io,"base64Slice");function Un(r,e,t){
...
o&1023),n.push(o),i+=u}return Po(n)}a(Un,"utf8Slice");var Rn=4096;function Po(r){
...
3]=o,o=o>>8,r[t+2]=o,o=o>>8,r[t+1]=o,o=o>>8,r[t]=o,t+8}a(Nn,"wrtBigUInt64BE");f.
...
writeBigInt64BE=me(a(function(e,t=0){return Nn(this,e,t,-BigInt("0x8000000000000\
...
o[s%u]}return this},"fill");var Pe={};function Dt(r,e,t){var n;Pe[r]=(n=class extends t{constructor(){
...
4!==0;)r=r+"=";return r}a(Do,"base64clean");function Rt(r,e){e=e||1/0;let t,n=r.
...
Rt,"utf8ToBytes");function Oo(r){let e=[];for(let t=0;t<r.length;++t)e.push(r.charCodeAt(
...
a(ko,"utf16leToBytes");function Gn(r){return Tt.toByteArray(Do(r))}a(Gn,"base64T\
...
a(ae,"isInstance");function Ot(r){return r!==r}a(Ot,"numberIsNaN");var Uo=function(){
let r="0123456789abcdef",e=new Array(256);for(let t=0;t<16;++t){let n=t*16;for(let i=0;i<
16;++i)e[n+i]=r[t]+r[i]}return e}();function me(r){return typeof BigInt>"u"?qo:r}
a(me,"defineBigIntMethod");function qo(){throw new Error("BigInt not supported")}
...
e.then.bind(e)}});var ge=I((nh,kt)=>{"use strict";p();var Re=typeof Reflect=="object"?Reflect:null,
...
B;kt.exports.once=Ho;B.EventEmitter=B;B.prototype._events=void 0;B.prototype._eventsCount=
...
s");function Yn(r){return r._maxListeners===void 0?B.defaultMaxListeners:r._maxListeners}
a(Yn,"_getMaxListeners");B.prototype.getMaxListeners=a(function(){return Yn(this)},
...
length,l=ti(c,h),n=0;n<h;++n)Vn(l[n],this,t);return!0},"emit");function Zn(r,e,t,n){
...
target,arguments)}a(Qo,"onceWrapper");function Jn(r,e,t){var n={fired:!1,wrapFn:void 0,
target:r,type:e,listener:t},i=Qo.bind(n);return i.listener=t,n.wrapFn=i,i}a(Jn,"\
_onceWrap");B.prototype.once=a(function(e,t){return ut(t),this.on(e,Jn(this,e,t)),
this},"once");B.prototype.prependOnceListener=a(function(e,t){return ut(t),this.
prependListener(e,Jn(this,e,t)),this},"prependOnceListener");B.prototype.removeListener=
...
on"?t?[i.listener||i]:[i]:t?Wo(i):ti(i,i.length)}a(Xn,"_listeners");B.prototype.
listeners=a(function(e){return Xn(this,e,!0)},"listeners");B.prototype.rawListeners=
a(function(e){return Xn(this,e,!1)},"rawListeners");B.listenerCount=function(r,e){
return typeof r.listenerCount=="function"?r.listenerCount(e):ei.call(r,e)};B.prototype.
...
return t}a(ti,"arrayClone");function jo(r,e){for(;e+1<r.length;e++)r[e]=r[e+1];r.
...
ed type '+typeof r)}a(ri,"eventTargetAgnosticAddListener")});var He={};X(He,{default:()=>$o});var $o,Ge=V(()=>{"use strict";p();$o={}});function $e(r){let e=1779033703,t=3144134277,n=1013904242,i=2773480762,s=1359893119,
...
16]+G+_[L-7]+ce|0}let A=e,g=t,D=n,H=i,Q=s,j=o,ue=u,de=c;for(let L=0;L<64;L++){let G=E(
Q,6)^E(Q,11)^E(Q,25),ce=Q&j^~Q&ue,ye=de+G+ce+y[L]+_[L]|0,xe=E(A,2)^E(A,13)^E(A,22),
he=A&g^A&D^g&D,ie=xe+he|0;de=ue,ue=j,j=Q,Q=H+ye|0,H=D,D=g,g=A,A=ye+ie|0}e=e+A|0,
t=t+g|0,n=n+D|0,i=i+H|0,s=s+Q|0,o=o+j|0,u=u+ue|0,c=c+de|0,l=0},"process"),J=a(A=>{
typeof A=="string"&&(A=new TextEncoder().encode(A));for(let g=0;g<A.length;g++)T[l++]=
A[g],l===64&&N();h+=A.length},"add"),pe=a(()=>{if(T[l++]=128,l==64&&N(),l+8>64){
...
g[31]=c&255,g},"digest");return r===void 0?{add:J,digest:pe}:(J(r),pe())}var ni=V(
()=>{"use strict";p();a($e,"sha256")});var O,Ve,ii=V(()=>{"use strict";p();O=class O{constructor(){P(this,"_dataLength",
...
ut",[]),P(O,"onePassHasher",new O);Ve=O});var Ut={};X(Ut,{createHash:()=>Ko,createHmac:()=>zo,randomBytes:()=>Vo});function Vo(r){
...
set($e(o),64),d.from($e(u))}}}}}var qt=V(()=>{"use strict";p();ni();ii();a(Vo,"r\
andomBytes");a(Ko,"createHash");a(zo,"createHmac")});var Qt=I(si=>{"use strict";p();si.parse=function(r,e){return new Nt(r,e).parse()};
...
entries}};a(ct,"ArrayParser");var Nt=ct;function Yo(r){return r}a(Yo,"identity")});var jt=I((Sh,oi)=>{p();var Zo=Qt();oi.exports={create:function(r,e){return{parse:function(){
return Zo.parse(r,e)}}}}});var ci=I((Eh,ui)=>{"use strict";p();var Jo=/(\d{1,})-(\d{2})-(\d{2}) (\d{2}):(\d{2}):(\d{2})(\.\d{1,})?.*?( BC)?$/,
...
u,c,h,l)),Wt(i)&&y.setUTCFullYear(i),E!==0&&y.setTime(y.getTime()-E)):(y=new Date(
i,s,o,u,c,h,l),Wt(i)&&y.setFullYear(i)),y},"parseDate");function ra(r){var e=Xo.
exec(r);if(e){var t=parseInt(e[1],10),n=!!e[4];n&&(t=ai(t));var i=parseInt(e[2],
10)-1,s=e[3],o=new Date(t,i,s);return Wt(t)&&o.setFullYear(t),o}}a(ra,"getDate");
...
return-(r-1)}a(ai,"bcYearToNegativeYear");function Wt(r){return r>=0&&r<100}a(Wt,
"is0To99")});var li=I((Ah,hi)=>{p();hi.exports=sa;var ia=Object.prototype.hasOwnProperty;function sa(r){
for(var e=1;e<arguments.length;e++){var t=arguments[e];for(var n in t)ia.call(t,
n)&&(r[n]=t[n])}return r}a(sa,"extend")});var di=I((Ph,pi)=>{"use strict";p();var oa=li();pi.exports=Fe;function Fe(r){if(!(this instanceof
...
"")),i+ua[n]}};var Ht="([+-]?\\d+)",la=Ht+"\\s+years?",fa=Ht+"\\s+mons?",pa=Ht+"\
...
o),n},{})}a(wa,"parse")});var mi=I((Lh,yi)=>{"use strict";p();yi.exports=a(function(e){if(/^\\x/.test(e))return new d(
...
"\\";n+=Math.floor(i/2)*2}return new d(t,"binary")},"parseBytea")});var vi=I((Mh,Ei)=>{p();var Ke=Qt(),ze=jt(),ht=ci(),wi=di(),bi=mi();function lt(r){
return a(function(t){return t===null?t:r(t)},"nullAllowed")}a(lt,"allowNull");function Si(r){
return r===null?r:r==="TRUE"||r==="t"||r==="true"||r==="y"||r==="yes"||r==="on"||
r==="1"}a(Si,"parseBool");function ba(r){return r?Ke.parse(r,Si):null}a(ba,"pars\
eBoolArray");function Sa(r){return parseInt(r,10)}a(Sa,"parseBaseTenInt");function Gt(r){
return r?Ke.parse(r,lt(Sa)):null}a(Gt,"parseIntegerArray");function xa(r){return r?
Ke.parse(r,lt(function(e){return xi(e).trim()})):null}a(xa,"parseBigIntegerArray");
...
return r?Ke.parse(r,lt(bi)):null},"parseByteAArray"),Kt=a(function(r){return parseInt(
r,10)},"parseInteger"),xi=a(function(r){var e=String(r);return/^\d+$/.test(e)?e:
r},"parseBigInteger"),gi=a(function(r){return r?Ke.parse(r,lt(JSON.parse)):null},
...
ht),r(1114,ht),r(1184,ht),r(600,zt),r(651,te),r(718,Aa),r(1e3,ba),r(1001,_a),r(1005,
Gt),r(1007,Gt),r(1028,Gt),r(1016,xa),r(1017,Ea),r(1021,$t),r(1022,$t),r(1231,$t),
r(1014,te),r(1015,te),r(1008,te),r(1009,te),r(1040,te),r(1041,te),r(1115,Vt),r(1182,
Vt),r(1185,Vt),r(1186,wi),r(1187,va),r(17,bi),r(114,JSON.parse.bind(JSON)),r(3802,
JSON.parse.bind(JSON)),r(199,gi),r(3807,gi),r(3907,te),r(2951,te),r(791,te),r(1183,
te),r(1270,te)},"init");Ei.exports={init:Ca}});var Ai=I((kh,_i)=>{"use strict";p();var Y=1e6;function Ia(r){var e=r.readInt32BE(
...
e%Y,o=4294967296*s+t,u=""+o%Y,n+u+i}a(Ia,"readInt8");_i.exports=Ia});var Bi=I((Nh,Ti)=>{p();var Pa=Ai(),R=a(function(r,e,t,n,i){t=t||0,n=n||!1,i=i||function(_,T,N){
...
(R(r,15,1,!0)+1):R(r,15,1)},"parseInt16"),Ci=a(function(r){return R(r,1)==1?-1*(R(
r,31,1,!0)+1):R(r,31,1)},"parseInt32"),Ba=a(function(r){return Pi(r,23,8)},"pars\
eFloat32"),La=a(function(r){return Pi(r,52,11)},"parseFloat64"),Ra=a(function(r){
...
return(e===0?1:-1)*Math.round(n*u)/u},"parseNumeric"),Ii=a(function(r,e){var t=R(
...
null?null:R(r,8)>0},"parseBool"),Da=a(function(r){r(20,Pa),r(21,Ta),r(23,Ci),r(26,
Ci),r(1700,Ra),r(700,Ba),r(701,La),r(16,Ma),r(1114,Ii.bind(null,!1)),r(1184,Ii.bind(
null,!0)),r(1e3,Ye),r(1007,Ye),r(1016,Ye),r(1008,Ye),r(1009,Ye),r(25,Fa)},"init");
Ti.exports={init:Da}});var Ri=I((Wh,Li)=>{p();Li.exports={BOOL:16,BYTEA:17,CHAR:18,INT8:20,INT2:21,INT4:23,
...
REGCONFIG:3734,REGDICTIONARY:3769,JSONB:3802,REGNAMESPACE:4089,REGROLE:4096}});var Xe=I(Je=>{p();var Oa=vi(),ka=Bi(),Ua=jt(),qa=Ri();Je.getTypeParser=Na;Je.setTypeParser=
Qa;Je.arrayParser=Ua;Je.builtins=qa;var Ze={text:{},binary:{}};function Fi(r){return String(
r)}a(Fi,"noParse");function Na(r,e){return e=e||"text",Ze[e]&&Ze[e][r]||Fi}a(Na,
...
Ze.binary[r]=e})});var et=I((Kh,Yt)=>{"use strict";p();Yt.exports={host:"localhost",user:m.platform===
...
setTypeParser(1016,"text",r?Me.getTypeParser(1007,"text"):Wa)})});var tt=I((Yh,Di)=>{"use strict";p();var Ha=(qt(),k(Ut)),Ga=et();function $a(r){var e=r.
...
toString("hex"):e+=$a(ft(r[t]));return e=e+"}",e}a(Mi,"arrayString");var ft=a(function(r,e){
...
g");var Zt=a(function(r){return Ha.createHash("md5").update(r,"utf-8").digest("h\
...
e)},"prepareValueWrapper"),normalizeQueryConfig:Ya,postgresMd5PasswordHash:Za,md5:Zt}});var Ni=I((Xh,qi)=>{"use strict";p();var Jt=(qt(),k(Ut));function Ja(r){if(r.indexOf(
...
",s="+n.salt+",i="+n.iteration,l="c=biws,r="+n.nonce,y=c+","+h+","+l,E=De(u,y),_=Ui(
o,E),T=_.toString("base64"),N=De(s,"Server Key"),J=De(N,y);r.message="SASLRespon\
se",r.serverSignature=J.toString("base64"),r.response=l+",p="+T}a(Xa,"continueSe\
...
test(r)}a(Oi,"isBase64");function ki(r){if(typeof r!="string")throw new TypeError(
...
n=e.substring(2);return[t,n]}))}a(ki,"parseAttributePairs");function ru(r){let e=ki(
...
ssage");function nu(r){let t=ki(r).get("v");if(t){if(!Oi(t))throw new Error("SAS\
...
a(nu,"parseServerFinalMessage");function Ui(r,e){if(!d.isBuffer(r))throw new TypeError(
...
from(r.map((t,n)=>r[n]^e[n]))}a(Ui,"xorBuffers");function iu(r){return Jt.createHash(
"sha256").update(r).digest()}a(iu,"sha256");function De(r,e){return Jt.createHmac(
"sha256",r).update(e).digest()}a(De,"hmacSha256");function su(r,e,t){for(var n=De(
r,d.concat([e,d.from([0,0,0,1])])),i=n,s=0;s<t-1;s++)n=De(r,n),i=Ui(i,n);return i}
a(su,"Hi");qi.exports={startSession:Ja,continueSession:Xa,finalizeSession:eu}});var Xt={};X(Xt,{join:()=>ou});function ou(...r){return r.join("/")}var er=V(()=>{
"use strict";p();a(ou,"join")});var tr={};X(tr,{stat:()=>au});function au(r,e){e(new Error("No filesystem"))}var rr=V(
()=>{"use strict";p();a(au,"stat")});var nr={};X(nr,{default:()=>uu});var uu,ir=V(()=>{"use strict";p();uu={}});var Qi={};X(Qi,{StringDecoder:()=>sr});var or,sr,ji=V(()=>{"use strict";p();or=class or{constructor(e){
P(this,"td");this.td=new TextDecoder(e)}write(e){return this.td.decode(e,{stream:!0})}end(e){
return this.td.decode(e)}};a(or,"StringDecoder");sr=or});var $i=I((cl,Gi)=>{"use strict";p();var{Transform:cu}=(ir(),k(nr)),{StringDecoder:hu}=(ji(),k(Qi)),
we=Symbol("last"),pt=Symbol("decoder");function lu(r,e,t){let n;if(this.overflow){
...
if(this[we]+=this[pt].end(),this[we])try{Hi(this,this.mapper(this[we]))}catch(e){
return r(e)}r()}a(fu,"flush");function Hi(r,e){e!==void 0&&r.push(e)}a(Hi,"push");
function Wi(r){return r}a(Wi,"noop");function pu(r,e,t){switch(r=r||/\r?\n/,e=e||
...
let n=new cu(t);return n[we]="",n[pt]=new hu("utf8"),n.matcher=r,n.mapper=e,n.maxLength=
t.maxLength,n.skipOverflow=t.skipOverflow||!1,n.overflow=!1,n._destroy=function(i,s){
this._writableState.errorEmitted=!1,s(i)},n}a(pu,"split");Gi.exports=pu});var zi=I((fl,fe)=>{"use strict";p();var Vi=(er(),k(Xt)),du=(ir(),k(nr)).Stream,yu=$i(),
Ki=(Ge(),k(He)),mu=5432,dt=m.platform==="win32",rt=m.stderr,gu=56,wu=7,bu=61440,
Su=32768;function xu(r){return(r&bu)==Su}a(xu,"isRegFile");var Oe=["host","port",
"database","user","password"],ar=Oe.length,Eu=Oe[ar-1];function ur(){var r=rt instanceof
...
call(m.env,"PGPASSWORD")?!1:dt?!0:(e=e||"<unkn>",xu(r.mode)?r.mode&(gu|wu)?(ur('\
...
e),!1))};var vu=fe.exports.match=function(r,e){return Oe.slice(0,-1).reduce(function(t,n,i){
return i==1&&Number(r[n]||mu)===Number(e[n])?t&&!0:t&&(e[n]==="*"||e[n]===r[n])},
!0)};fe.exports.getPassword=function(r,e,t){var n,i=e.pipe(yu());function s(c){var h=_u(
...
u)};var _u=fe.exports.parseLine=function(r){if(r.length<11||r.match(/^\s+#/))return null;
...
Object.keys(o).length===ar?o:null,o},Au=fe.exports.isValidEntry=function(r){for(var e={
...
1){var n=e[t],i=r[Oe[t]]||"",s=n(i);if(!s)return!1}return!0}});var Zi=I((ml,cr)=>{"use strict";p();var yl=(er(),k(Xt)),Yi=(rr(),k(tr)),yt=zi();
cr.exports=function(r,e){var t=yt.getFileName();Yi.stat(t,function(n,i){if(n||!yt.
usePgPass(i,t))return e(void 0);var s=Yi.createReadStream(t);yt.getPassword(r,s,
e)})};cr.exports.warnTo=yt.warnTo});var hr=I((wl,Ji)=>{"use strict";p();var Cu=Xe();function mt(r){this._types=r||Cu,
...
"text",this.getOverrides(e)[r]||this._types.getTypeParser(r,e)};Ji.exports=mt});var Xi={};X(Xi,{default:()=>Iu});var Iu,es=V(()=>{"use strict";p();Iu={}});var ts={};X(ts,{parse:()=>lr});function lr(r,e=!1){let{protocol:t}=new URL(r),n="\
...
password:s,host:o,hostname:u,port:c,pathname:h,search:l,query:T,hash:E}}var fr=V(
()=>{"use strict";p();a(lr,"parse")});var ns=I((_l,rs)=>{"use strict";p();var Pu=(fr(),k(ts)),pr=(rr(),k(tr));function dr(r){
...
return t}a(dr,"parse");rs.exports=dr;dr.parse=dr});var gt=I((Il,os)=>{"use strict";p();var Tu=(es(),k(Xi)),ss=et(),is=ns().parse,K=a(
...
teParamValue"),Lu=a(function(r){return r.split(".")[0]},"extractProjectValue"),re=a(
function(r,e,t){var n=e[t];n!=null&&r.push(t+"="+ke(n))},"add"),mr=class mr{constructor(e){
e=typeof e=="string"?is(e):e||{},e.connectionString&&(e=Object.assign({},e,is(e.
...
" ")))})}};a(mr,"ConnectionParameters");var yr=mr;os.exports=yr});var cs=I((Bl,us)=>{"use strict";p();var Ru=Xe(),as=/^([A-Za-z]+)(?: (\d+))?(?: (\d+))?/,
...
ext"):this._parsers[t]=Ru.getTypeParser(n.dataTypeID,n.format||"text")}}};a(wr,"\
Result");var gr=wr;us.exports=gr});var ps=I((Fl,fs)=>{"use strict";p();var{EventEmitter:Fu}=ge(),hs=cs(),ls=tt(),Sr=class Sr extends Fu{constructor(e,t,n){
...
var br=Sr;fs.exports=br});var ms={};X(ms,{Socket:()=>_e,isIP:()=>Mu,isNeonHost:()=>xr});function Mu(r){return 0}
var ys,Du,Ou,xr,ds,x,_e,wt=V(()=>{"use strict";p();ys=je(ge(),1);a(Mu,"isIP");Du=
/^(?:ep-)?([a-z]+)-([a-z]+)-(\w+)[.][^.]+[.][^.]+/,Ou=/^(?:ep-)?([a-z]+)-([a-z]+)-(\w+)/,
xr=a(r=>Du.test(r),"isNeonHost"),ds=a(r=>r.replace(Ou,"api"),"transformHost"),x=
class x extends ys.EventEmitter{constructor(){super(...arguments);P(this,"opts",
...
ps://"+ds(t)+"/sql",fetchConnectionCache:!1,fetchFunction:void 0,webSocketConstructor:void 0,
wsProxy:t=>ds(t)+"/v2",useSecureWebSocket:!0,forceDisablePgSSL:!0,coalesceWrites:!0,
pipelineConnect:"password",subtls:void 0,rootCerts:"",pipelineTLS:!1,disableSNI:!1}),
P(x,"opts",{});_e=x});var Yr=I(C=>{"use strict";p();Object.defineProperty(C,"__esModule",{value:!0});C.
...
arameterDescriptionMessage");var Ir=Qr;C.ParameterDescriptionMessage=Ir;var jr=class jr{constructor(e,t,n){
this.length=e,this.parameterName=t,this.parameterValue=n,this.name="parameterSta\
tus"}};a(jr,"ParameterStatusMessage");var Pr=jr;C.ParameterStatusMessage=Pr;var Wr=class Wr{constructor(e,t){
this.length=e,this.salt=t,this.name="authenticationMD5Password"}};a(Wr,"Authenti\
cationMD5Password");var Tr=Wr;C.AuthenticationMD5Password=Tr;var Hr=class Hr{constructor(e,t,n){
...
xt.serialize=void 0;var Xr=gs(),F=new Xr.Writer,ku=a(r=>{F.addInt16(3).addInt16(
...
r=>F.addCString(r).flush(81),"query"),ws=[],Wu=a(r=>{let e=r.name||"";e.length>63&&
...
flush(80)},"parse"),Ue=new Xr.Writer,Hu=a(function(r,e){for(let t=0;t<r.length;t++){
...
Zu=a(r=>r.name?en(68,`${r.type}${r.name||""}`):r.type==="P"?zu:Yu,"describe"),Ju=a(
r=>{let e=`${r.type}${r.name||""}`;return en(67,e)},"close"),Xu=a(r=>F.add(r).flush(
100),"copyData"),ec=a(r=>en(102,r),"copyFail"),St=a(r=>d.from([r,0,0,0,4]),"code\
...
copyData:Xu,copyDone:()=>ic,copyFail:ec,cancel:Ku};xt.serialize=sc});var Ss=I(Et=>{"use strict";p();Object.defineProperty(Et,"__esModule",{value:!0});
Et.BufferReader=void 0;var oc=d.allocUnsafe(0),rn=class rn{constructor(e=0){this.
...
tn});var xs={};X(xs,{default:()=>ac});var ac,Es=V(()=>{"use strict";p();ac={}});var As=I(qe=>{"use strict";p();var uc=qe&&qe.__importDefault||function(r){return r&&
r.__esModule?r:{default:r}};Object.defineProperty(qe,"__esModule",{value:!0});qe.
Parser=void 0;var M=Yr(),cc=Ss(),hc=uc((Es(),k(xs))),nn=1,lc=4,vs=nn+lc,_s=d.allocUnsafe(
...
line=s.L,c.routine=s.R,c}};a(on,"Parser");var sn=on;qe.Parser=sn});var an=I(be=>{"use strict";p();Object.defineProperty(be,"__esModule",{value:!0});
be.DatabaseError=be.serialize=be.parse=void 0;var fc=Yr();Object.defineProperty(
be,"DatabaseError",{enumerable:!0,get:function(){return fc.DatabaseError}});var pc=bs();
Object.defineProperty(be,"serialize",{enumerable:!0,get:function(){return pc.serialize}});
var dc=As();function yc(r,e){let t=new dc.Parser;return r.on("data",n=>t.parse(n,
e)),new Promise(n=>r.on("end",()=>n()))}a(yc,"parse");be.parse=yc});var Cs={};X(Cs,{connect:()=>mc});function mc({socket:r,servername:e}){return r.startTls(
e),r}var Is=V(()=>{"use strict";p();a(mc,"connect")});var hn=I((of,Bs)=>{"use strict";p();var Ps=(wt(),k(ms)),gc=ge().EventEmitter,{parse:wc,
serialize:q}=an(),Ts=q.flush(),bc=q.sync(),Sc=q.end(),cn=class cn extends gc{constructor(e){
...
nnection"))}var u=(Is(),k(Cs));let c={socket:n.stream};n.ssl!==!0&&(Object.assign(
...
_ending=!0,this._send(Ts),this._send(bc)}ref(){this.stream.ref()}unref(){this.stream.
...
this._send(q.copyFail(e))}};a(cn,"Connection");var un=cn;Bs.exports=un});var Fs=I((hf,Rs)=>{"use strict";p();var xc=ge().EventEmitter,cf=(Ge(),k(He)),Ec=tt(),
ln=Ni(),vc=Zi(),_c=hr(),Ac=gt(),Ls=ps(),Cc=et(),Ic=hn(),fn=class fn extends xc{constructor(e){
...
Ls;Rs.exports=vt});var ks=I((pf,Os)=>{"use strict";p();var Pc=ge().EventEmitter,Ms=a(function(){},"\
...
"idleListener")}a(Bc,"makeIdleListener");var gn=class gn extends Pc{constructor(e,t){
...
length}};a(gn,"Pool");var dn=gn;Os.exports=dn});var Us={};X(Us,{default:()=>Lc});var Lc,qs=V(()=>{"use strict";p();Lc={}});var Ns=I((gf,Rc)=>{Rc.exports={name:"pg",version:"8.8.0",description:"PostgreSQL\
...
7b9a5491a178655"}});var Ws=I((wf,js)=>{"use strict";p();var Qs=ge().EventEmitter,Fc=(Ge(),k(He)),wn=tt(),
Qe=js.exports=function(r,e,t){Qs.call(this),r=wn.normalizeQueryConfig(r,e,t),this.
...
Qe,Qs);var Mc={sqlState:"code",statementPosition:"position",messagePrimary:"mess\
...
text,t)}});var Vs=I((Ef,$s)=>{"use strict";p();var Dc=(qs(),k(Us)),Oc=hr(),xf=Ns(),Hs=ge().
EventEmitter,kc=(Ge(),k(He)),Uc=gt(),Gs=Ws(),Z=$s.exports=function(r){Hs.call(this),
...
e.port,this.namedQueries={}};Z.Query=Gs;kc.inherits(Z,Hs);Z.prototype._errorAllQueries=
...
query_timeout,n=new Gs(r,e,t),!n.callback){let c,h;i=new this._Promise((l,y)=>{c=
...
_types.getTypeParser(r,e)}});var bn=I((Af,Ks)=>{"use strict";p();Ks.exports=Vs()});var At=I((If,nt)=>{"use strict";p();var qc=Fs(),Nc=et(),Qc=hn(),jc=ks(),{DatabaseError:Wc}=an(),
Hc=a(r=>{var e;return e=class extends jc{constructor(n){super(n,r)}},a(e,"BoundP\
ool"),e},"poolFactory"),Sn=a(function(r){this.defaults=Nc,this.Client=r,this.Query=
...
exports=new Sn(bn()):(nt.exports=new Sn(qc),Object.defineProperty(nt.exports,"na\
...
native",{value:r}),r}}))});p();var Ct=je(At());wt();p();fr();wt();var Zs=je(tt());var xn=class xn extends Error{constructor(){super(...arguments);P(this,"name","N\
eonDbError");P(this,"code",null);P(this,"sourceError")}};a(xn,"NeonDbError");var Ae=xn,
zs="transaction() expects an array of queries, or a function returning an array \
of queries";function Js(r,{arrayMode:e,fullResults:t,fetchOptions:n,isolationLevel:i,
...
g=g.map(j=>(0,Zs.prepareValue)(j));let Q={query:D,params:g};return u&&u(Q),Gc(pe,
...
"NeonQueryPromise")throw new Error(zs);return H.parameterizedQuery});return pe(D,
g)};async function pe(A,g){let D=n??{},{fetchEndpoint:H,fetchConnectionCache:Q,fetchFunction:j}=_e,
ue=typeof H=="function"?H(_,T):H,de=Array.isArray(A)?{queries:A}:A,L=e??!1,G=t??
...
h-Deferrable"]=String(xe)));let ie;try{ie=await(j??fetch)(ue,{method:"POST",body:JSON.
...
ternal error: unexpected result format");return $.map((ne,Ce)=>Ys(ne,{arrayMode:L,
fullResults:G,parameterizedQuery:A[Ce],resultCallback:c}))}else return Ys(se,{arrayMode:L,
...
pe,"execute"),J}a(Js,"neon");function Gc(r,e,t){return{[Symbol.toStringTag]:"Neo\
nQueryPromise",parameterizedQuery:e,opts:t,then:(n,i)=>r(e,t).then(n,i),catch:n=>r(
e,t).catch(n),finally:n=>r(e,t).finally(n)}}a(Gc,"createNeonQueryPromise");function Ys(r,{
...
t?(r.viaNeonFetch=!0,r.rowAsArray=e,r.rows=u,r):u}a(Ys,"processQueryResult");var eo=je(gt()),Se=je(At());var vn=class vn extends Ct.Client{constructor(t){super(t);this.config=t}get neonConfig(){
...
se set the host to 'localhost' explicitly.`);if(xr(this.host)){let l="endpoint="+
...
"HMAC",T,N)),J=d.from(J.map(($,ne)=>J[ne]^N[ne]));let A=J,g=await w.subtle.importKey(
...
D),Q="n=*,r="+n.clientNonce,j="r="+u+",s="+c+",i="+l,ue="c=biws,r="+u,de=Q+","+j+
...
response)}};a(vn,"NeonClient");var En=vn;function $c(r,e){if(e)return{callback:e,
result:void 0};let t,n,i=a(function(o,u){o?t(o):n(u)},"cb"),s=new r(function(o,u){
n=o,t=u});return{callback:i,result:s}}a($c,"promisify");var _n=class _n extends Ct.Pool{constructor(){
super(...arguments);P(this,"Client",En);P(this,"hasFetchUnsupportedListeners",!1)}on(t,n){
...
"string"?t:t.text,y=n??t.values??[];Js(h,{fullResults:!0,arrayMode:t.rowMode==="\
array"})(l,y).then(_=>i(void 0,_)).catch(_=>i(_))}catch(o){i(o)}return s.result}};
a(_n,"NeonPool");var Xs=_n;var export_ClientBase=Se.ClientBase;var export_Connection=Se.Connection;var export_DatabaseError=Se.DatabaseError;
...
export_DatabaseError as DatabaseError,Ae as NeonDbError,Xs as Pool,export_Query as Query,
export_defaults as defaults,Js as neon,_e as neonConfig,export_types as types};
