...
to(e,i))||n.enumerable});return r};var je=(r,e,t)=>(t=r!=null?eo(no(r)):{},_n(e||!r||!r.__esModule?Ie(t,"default",{
value:r,enumerable:!0}):t,r)),k=r=>_n(Ie({},"__esModule",{value:!0}),r);var T=(r,e,t)=>(so(r,typeof e!="symbol"?e+"":e,t),t);var In=I(it=>{"use strict";p();it.byteLength=ao;it.toByteArray=co;it.fromByteArray=
fo;var oe=[],ee=[],oo=typeof Uint8Array<"u"?Uint8Array:Array,It="ABCDEFGHIJKLMNO\
...
"getLens");function ao(r){var e=Cn(r),t=e[0],n=e[1];return(t+n)*3/4-n}a(ao,"byte\
Length");function uo(r,e,t){return(e+t)*3/4-t}a(uo,"_byteLength");function co(r){
var e,t=Cn(r),n=t[0],i=t[1],s=new oo(uo(r,n,i)),o=0,u=i>0?n-4:n,c;for(c=0;c<u;c+=
...
e&255),s}a(co,"toByteArray");function ho(r){return oe[r>>18&63]+oe[r>>12&63]+oe[r>>
6&63]+oe[r&63]}a(ho,"tripletToBase64");function lo(r,e,t){for(var n,i=[],s=e;s<t;s+=
...
u=t-n;o<u;o+=s)i.push(lo(r,o,o+s>u?u:o+s));return n===1?(e=r[t-1],i.push(oe[e>>2]+
oe[e<<4&63]+"==")):n===2&&(e=(r[t-2]<<8)+r[t-1],i.push(oe[e>>10]+oe[e>>4&63]+oe[e<<
2&63]+"=")),i.join("")}a(fo,"fromByteArray")});var Tn=I(Tt=>{p();Tt.read=function(r,e,t,n,i){var s,o,u=i*8-n-1,c=(1<<u)-1,h=c>>
...
f;Le.SlowBuffer=bo;Le.INSPECT_MAX_BYTES=50;var st=2147483647;Le.kMaxLength=st;f.
...
rowser support.");function po(){try{let r=new Uint8Array(1),e={foo:function(){return 42}};
return Object.setPrototypeOf(e,Uint8Array.prototype),Object.setPrototypeOf(r,e),
r.foo()===42}catch{return!1}}a(po,"typedArraySupport");Object.defineProperty(f.prototype,
...
fer");f.poolSize=8192;function Fn(r,e,t){if(typeof r=="string")return mo(r,e);if(ArrayBuffer.
isView(r))return go(r);if(r==null)throw new TypeError("The first argument must b\
...
r)return f.from(n,e,t);let i=wo(r);if(i)return i;if(typeof Symbol<"u"&&Symbol.toPrimitive!=
...
'The value "'+r+'" is invalid for option "size"')}a(Mn,"assertSize");function yo(r,e,t){
return Mn(r),r<=0?le(r):e!==void 0?typeof t=="string"?le(r).fill(e,t):le(r).fill(
e):le(r)}a(yo,"alloc");f.alloc=function(r,e,t){return yo(r,e,t)};function Ft(r){
return Mn(r),le(r<0?0:Mt(r)|0)}a(Ft,"allocUnsafe");f.allocUnsafe=function(r){return Ft(
r)};f.allocUnsafeSlow=function(r){return Ft(r)};function mo(r,e){if((typeof e!="\
...
n}a(mo,"fromString");function Bt(r){let e=r.length<0?0:Mt(r.length)|0,t=le(e);for(let n=0;n<
e;n+=1)t[n]=r[n]&255;return t}a(Bt,"fromArrayLike");function go(r){if(ae(r,Uint8Array)){
let e=new Uint8Array(r);return Lt(e.buffer,e.byteOffset,e.byteLength)}return Bt(
r)}a(go,"fromArrayView");function Lt(r,e,t){if(e<0||r.byteLength<e)throw new RangeError(
...
st.toString(16)+" bytes");return r|0}a(Mt,"checked");function bo(r){return+r!=r&&
...
i=!0}}a(Dn,"byteLength");f.byteLength=Dn;function So(r,e,t){let n=!1;if((e===void 0||
...
this,e,t);case"utf8":case"utf-8":return kn(this,e,t);case"ascii":return To(this,
...
So,"slowToString");f.prototype._isBuffer=!0;function ve(r,e,t){let n=r[e];r[e]=r[t],
...
a(function(e,t,n){return On(this,e,t,n,!1)},"lastIndexOf");function xo(r,e,t,n){
...
return o;r[t+o]=u}return o}a(xo,"hexWrite");function Eo(r,e,t,n){return ot(Rt(e,
r.length-t),r,t,n)}a(Eo,"utf8Write");function vo(r,e,t,n){return ot(Do(e),r,t,n)}
a(vo,"asciiWrite");function _o(r,e,t,n){return ot(Hn(e),r,t,n)}a(_o,"base64Write");
function Ao(r,e,t,n){return ot(Oo(e,r.length-t),r,t,n)}a(Ao,"ucs2Write");f.prototype.
...
hex":return xo(this,e,t,n);case"utf8":case"utf-8":return Eo(this,e,t,n);case"asc\
ii":case"latin1":case"binary":return vo(this,e,t,n);case"base64":return _o(this,
...
length?Pt.fromByteArray(r):Pt.fromByteArray(r.slice(e,t))}a(Co,"base64Slice");function kn(r,e,t){
...
o&1023),n.push(o),i+=u}return Io(n)}a(kn,"utf8Slice");var Ln=4096;function Io(r){
let e=r.length;if(e<=Ln)return String.fromCharCode.apply(String,r);let t="",n=0;
for(;n<e;)t+=String.fromCharCode.apply(String,r.slice(n,n+=Ln));return t}a(Io,"d\
...
(!t||t<0||t>n)&&(t=n);let i="";for(let s=e;s<t;++s)i+=ko[r[s]];return i}a(Bo,"he\
...
this[t+2]=e>>>8,this[t+3]=e&255,t+4},"writeUInt32BE");function Un(r,e,t,n,i){Wn(
...
this,e,t,!1,n)},"writeFloatBE");function jn(r,e,t,n,i){return e=+e,t=t>>>0,i||Nn(
...
t)}${e}`}a(Rn,"addNumericalSeparator");function Ro(r,e,t){Be(e,"offset"),(r[e]===
void 0||r[e+t]===void 0)&&We(e,r.length-(t+1))}a(Ro,"checkBounds");function Wn(r,e,t,n,i,s){
...
"value",u,r)}Ro(n,i,s)}a(Wn,"checkIntBI");function Be(r,e){if(typeof r!="number")
...
t)&255);return e}a(Do,"asciiToBytes");function Oo(r,e){let t,n,i,s=[];for(let o=0;o<
r.length&&!((e-=2)<0);++o)t=r.charCodeAt(o),n=t>>8,i=t%256,s.push(i),s.push(n);return s}
a(Oo,"utf16leToBytes");function Hn(r){return Pt.toByteArray(Mo(r))}a(Hn,"base64T\
...
a(ae,"isInstance");function Ot(r){return r!==r}a(Ot,"numberIsNaN");var ko=function(){
let r="0123456789abcdef",e=new Array(256);for(let t=0;t<16;++t){let n=t*16;for(let i=0;i<
16;++i)e[n+i]=r[t]+r[i]}return e}();function me(r){return typeof BigInt>"u"?Uo:r}
a(me,"defineBigIntMethod");function Uo(){throw new Error("BigInt not supported")}
a(Uo,"BufferBigIntNotDefined")});var b,S,v,w,d,m,p=V(()=>{"use strict";b=globalThis,S=globalThis.setImmediate??(r=>setTimeout(
...
e.then.bind(e)}});var ge=I((eh,kt)=>{"use strict";p();var Re=typeof Reflect=="object"?Reflect:null,
...
console.warn(r)}a(qo,"ProcessEmitWarning");var Kn=Number.isNaN||a(function(e){return e!==
...
void 0};B.prototype.setMaxListeners=a(function(e){if(typeof e!="number"||e<0||Kn(
...
prependListener=a(function(e,t){return Yn(this,e,t,!0)},"prependListener");function No(){
...
target,arguments)}a(No,"onceWrapper");function Zn(r,e,t){var n={fired:!1,wrapFn:void 0,
target:r,type:e,listener:t},i=No.bind(n);return i.listener=t,n.wrapFn=i,i}a(Zn,"\
...
on"?t?[i.listener||i]:[i]:t?jo(i):ei(i,i.length)}a(Jn,"_listeners");B.prototype.
...
return t}a(ei,"arrayClone");function Qo(r,e){for(;e+1<r.length;e++)r[e]=r[e+1];r.
pop()}a(Qo,"spliceOne");function jo(r){for(var e=new Array(r.length),t=0;t<e.length;++t)
e[t]=r[t].listener||r[t];return e}a(jo,"unwrapListeners");function Wo(r,e){return new Promise(
function(t,n){function i(o){r.removeListener(e,s),n(o)}a(i,"errorListener");function s(){
typeof r.removeListener=="function"&&r.removeListener("error",i),t([].slice.call(
arguments))}a(s,"resolver"),ti(r,e,s,{once:!0}),e!=="error"&&Ho(r,i,{once:!0})})}
a(Wo,"once");function Ho(r,e,t){typeof r.on=="function"&&ti(r,"error",e,t)}a(Ho,
...
ed type '+typeof r)}a(ti,"eventTargetAgnosticAddListener")});var He={};X(He,{default:()=>Go});var Go,Ge=V(()=>{"use strict";p();Go={}});function $e(r){let e=1779033703,t=3144134277,n=1013904242,i=2773480762,s=1359893119,
...
g[31]=c&255,g},"digest");return r===void 0?{add:J,digest:pe}:(J(r),pe())}var ri=V(
()=>{"use strict";p();a($e,"sha256")});var O,Ve,ni=V(()=>{"use strict";p();O=class O{constructor(){T(this,"_dataLength",
...
ut",[]),T(O,"onePassHasher",new O);Ve=O});var Ut={};X(Ut,{createHash:()=>Vo,createHmac:()=>Ko,randomBytes:()=>$o});function $o(r){
...
set($e(o),64),d.from($e(u))}}}}}var qt=V(()=>{"use strict";p();ri();ni();a($o,"r\
andomBytes");a(Vo,"createHash");a(Ko,"createHmac")});var Qt=I(ii=>{"use strict";p();ii.parse=function(r,e){return new Nt(r,e).parse()};
...
entries}};a(ct,"ArrayParser");var Nt=ct;function zo(r){return r}a(zo,"identity")});var jt=I((gh,si)=>{p();var Yo=Qt();si.exports={create:function(r,e){return{parse:function(){
return Yo.parse(r,e)}}}}});var ui=I((bh,ai)=>{"use strict";p();var Zo=/(\d{1,})-(\d{2})-(\d{2}) (\d{2}):(\d{2}):(\d{2})(\.\d{1,})?.*?( BC)?$/,
Jo=/^(\d{1,})-(\d{2})-(\d{2})( BC)?$/,Xo=/([Z+-])(\d{2})?:?(\d{2})?:?(\d{2})?/,ea=/^-?infinity$/;
ai.exports=a(function(e){if(ea.test(e))return Number(e.replace("i","I"));var t=Zo.
exec(e);if(!t)return ta(e)||null;var n=!!t[8],i=parseInt(t[1],10);n&&(i=oi(i));var s=parseInt(
t[2],10)-1,o=t[3],u=parseInt(t[4],10),c=parseInt(t[5],10),h=parseInt(t[6],10),l=t[7];
l=l?1e3*parseFloat(l):0;var y,E=ra(e);return E!=null?(y=new Date(Date.UTC(i,s,o,
u,c,h,l)),Wt(i)&&y.setUTCFullYear(i),E!==0&&y.setTime(y.getTime()-E)):(y=new Date(
i,s,o,u,c,h,l),Wt(i)&&y.setFullYear(i)),y},"parseDate");function ta(r){var e=Jo.
exec(r);if(e){var t=parseInt(e[1],10),n=!!e[4];n&&(t=oi(t));var i=parseInt(e[2],
10)-1,s=e[3],o=new Date(t,i,s);return Wt(t)&&o.setFullYear(t),o}}a(ta,"getDate");
...
e[3]||0,10)*60+parseInt(e[4]||0,10);return i*n*1e3}}a(ra,"timeZoneOffset");function oi(r){
return-(r-1)}a(oi,"bcYearToNegativeYear");function Wt(r){return r>=0&&r<100}a(Wt,
"is0To99")});var hi=I((Eh,ci)=>{p();ci.exports=ia;var na=Object.prototype.hasOwnProperty;function ia(r){
for(var e=1;e<arguments.length;e++){var t=arguments[e];for(var n in t)na.call(t,
n)&&(r[n]=t[n])}return r}a(ia,"extend")});var pi=I((Ah,fi)=>{"use strict";p();var sa=hi();fi.exports=Fe;function Fe(r){if(!(this instanceof
...
ha,la,fa,pa].map(function(r){return"("+r+")?"}).join("\\s*")),li={years:2,months:4,
...
o),n},{})}a(ga,"parse")});var yi=I((Th,di)=>{"use strict";p();di.exports=a(function(e){if(/^\\x/.test(e))return new d(
...
"\\";n+=Math.floor(i/2)*2}return new d(t,"binary")},"parseBytea")});var Ei=I((Lh,xi)=>{p();var Ke=Qt(),ze=jt(),ht=ui(),gi=pi(),wi=yi();function lt(r){
...
r==="1"}a(bi,"parseBool");function wa(r){return r?Ke.parse(r,bi):null}a(wa,"pars\
eBoolArray");function ba(r){return parseInt(r,10)}a(ba,"parseBaseTenInt");function Gt(r){
return r?Ke.parse(r,lt(ba)):null}a(Gt,"parseIntegerArray");function Sa(r){return r?
Ke.parse(r,lt(function(e){return Si(e).trim()})):null}a(Sa,"parseBigIntegerArray");
var xa=a(function(r){if(!r)return null;var e=ze.create(r,function(t){return t!==
...
parseDateArray"),Ea=a(function(r){if(!r)return null;var e=ze.create(r,function(t){
return t!==null&&(t=gi(t)),t});return e.parse()},"parseIntervalArray"),va=a(function(r){
return r?Ke.parse(r,lt(wi)):null},"parseByteAArray"),Kt=a(function(r){return parseInt(
r,10)},"parseInteger"),Si=a(function(r){var e=String(r);return/^\d+$/.test(e)?e:
r},"parseBigInteger"),mi=a(function(r){return r?Ke.parse(r,lt(JSON.parse)):null},
...
Si),r(21,Kt),r(23,Kt),r(26,Kt),r(700,parseFloat),r(701,parseFloat),r(16,bi),r(1082,
ht),r(1114,ht),r(1184,ht),r(600,zt),r(651,te),r(718,_a),r(1e3,wa),r(1001,va),r(1005,
...
Vt),r(1185,Vt),r(1186,gi),r(1187,Ea),r(17,wi),r(114,JSON.parse.bind(JSON)),r(3802,
JSON.parse.bind(JSON)),r(199,mi),r(3807,mi),r(3907,te),r(2951,te),r(791,te),r(1183,
te),r(1270,te)},"init");xi.exports={init:Aa}});var _i=I((Mh,vi)=>{"use strict";p();var Y=1e6;function Ca(r){var e=r.readInt32BE(
...
e%Y,o=4294967296*s+t,u=""+o%Y,n+u+i}a(Ca,"readInt8");vi.exports=Ca});var Pi=I((kh,Ti)=>{p();var Ia=_i(),R=a(function(r,e,t,n,i){t=t||0,n=n||!1,i=i||function(_,P,N){
...
r,31,1,!0)+1):R(r,31,1)},"parseInt32"),Pa=a(function(r){return Ii(r,23,8)},"pars\
eFloat32"),Ba=a(function(r){return Ii(r,52,11)},"parseFloat64"),La=a(function(r){
...
null?null:R(r,8)>0},"parseBool"),Ma=a(function(r){r(20,Ia),r(21,Ta),r(23,Ai),r(26,
Ai),r(1700,La),r(700,Pa),r(701,Ba),r(16,Fa),r(1114,Ci.bind(null,!1)),r(1184,Ci.bind(
null,!0)),r(1e3,Ye),r(1007,Ye),r(1016,Ye),r(1008,Ye),r(1009,Ye),r(25,Ra)},"init");
Ti.exports={init:Ma}});var Li=I((Nh,Bi)=>{p();Bi.exports={BOOL:16,BYTEA:17,CHAR:18,INT8:20,INT2:21,INT4:23,
...
REGCONFIG:3734,REGDICTIONARY:3769,JSONB:3802,REGNAMESPACE:4089,REGROLE:4096}});var Xe=I(Je=>{p();var Da=Ei(),Oa=Pi(),ka=jt(),Ua=Li();Je.getTypeParser=qa;Je.setTypeParser=
Na;Je.arrayParser=ka;Je.builtins=Ua;var Ze={text:{},binary:{}};function Ri(r){return String(
r)}a(Ri,"noParse");function qa(r,e){return e=e||"text",Ze[e]&&Ze[e][r]||Ri}a(qa,
"getTypeParser");function Na(r,e,t){typeof e=="function"&&(t=e,e="text"),Ze[e][r]=
t}a(Na,"setTypeParser");Da.init(function(r,e){Ze.text[r]=e});Oa.init(function(r,e){
Ze.binary[r]=e})});var et=I((Gh,Yt)=>{"use strict";p();Yt.exports={host:"localhost",user:m.platform===
...
connect_timeout:0,keepalives:1,keepalives_idle:0};var Me=Xe(),Qa=Me.getTypeParser(
...
setTypeParser(1016,"text",r?Me.getTypeParser(1007,"text"):ja)})});var tt=I((Vh,Mi)=>{"use strict";p();var Wa=(qt(),k(Ut)),Ha=et();function Ga(r){var e=r.
...
toString("hex"):e+=Ga(ft(r[t]));return e=e+"}",e}a(Fi,"arrayString");var ft=a(function(r,e){
...
Ka(r):Va(r):Array.isArray(r)?Fi(r):typeof r=="object"?$a(r,e):r.toString()},"pre\
...
a($a,"prepareObject");function W(r,e){for(r=""+r;r.length<e;)r="0"+r;return r}a(
W,"pad");function Va(r){var e=-r.getTimezoneOffset(),t=r.getFullYear(),n=t<1;n&&
...
W(r.getUTCMilliseconds(),3);return n+="+00:00",t&&(n+=" BC"),n}a(Ka,"dateToStrin\
...
e)},"prepareValueWrapper"),normalizeQueryConfig:za,postgresMd5PasswordHash:Ya,md5:Zt}});var qi=I((Yh,Ui)=>{"use strict";p();var Jt=(qt(),k(Ut));function Za(r){if(r.indexOf(
...
se",r.serverSignature=J.toString("base64"),r.response=l+",p="+P}a(Ja,"continueSe\
...
n=e.substring(2);return[t,n]}))}a(Oi,"parseAttributePairs");function tu(r){let e=Oi(
...
ssage");function ru(r){let t=Oi(r).get("v");if(t){if(!Di(t))throw new Error("SAS\
...
a(ru,"parseServerFinalMessage");function ki(r,e){if(!d.isBuffer(r))throw new TypeError(
...
from(r.map((t,n)=>r[n]^e[n]))}a(ki,"xorBuffers");function nu(r){return Jt.createHash(
...
a(iu,"Hi");Ui.exports={startSession:Za,continueSession:Ja,finalizeSession:Xa}});var Xt={};X(Xt,{join:()=>su});function su(...r){return r.join("/")}var er=V(()=>{
"use strict";p();a(su,"join")});var tr={};X(tr,{stat:()=>ou});function ou(r,e){e(new Error("No filesystem"))}var rr=V(
()=>{"use strict";p();a(ou,"stat")});var nr={};X(nr,{default:()=>au});var au,ir=V(()=>{"use strict";p();au={}});var Ni={};X(Ni,{StringDecoder:()=>sr});var or,sr,Qi=V(()=>{"use strict";p();or=class or{constructor(e){
T(this,"td");this.td=new TextDecoder(e)}write(e){return this.td.decode(e,{stream:!0})}end(e){
return this.td.decode(e)}};a(or,"StringDecoder");sr=or});var Gi=I((ol,Hi)=>{"use strict";p();var{Transform:uu}=(ir(),k(nr)),{StringDecoder:cu}=(Qi(),k(Ni)),
we=Symbol("last"),pt=Symbol("decoder");function hu(r,e,t){let n;if(this.overflow){
...
if(this[we]+=this[pt].end(),this[we])try{Wi(this,this.mapper(this[we]))}catch(e){
return r(e)}r()}a(lu,"flush");function Wi(r,e){e!==void 0&&r.push(e)}a(Wi,"push");
...
let n=new uu(t);return n[we]="",n[pt]=new cu("utf8"),n.matcher=r,n.mapper=e,n.maxLength=
t.maxLength,n.skipOverflow=t.skipOverflow||!1,n.overflow=!1,n._destroy=function(i,s){
this._writableState.errorEmitted=!1,s(i)},n}a(fu,"split");Hi.exports=fu});var Ki=I((cl,fe)=>{"use strict";p();var $i=(er(),k(Xt)),pu=(ir(),k(nr)).Stream,du=Gi(),
Vi=(Ge(),k(He)),yu=5432,dt=m.platform==="win32",rt=m.stderr,mu=56,gu=7,wu=61440,
bu=32768;function Su(r){return(r&wu)==bu}a(Su,"isRegFile");var Oe=["host","port",
"database","user","password"],ar=Oe.length,xu=Oe[ar-1];function ur(){var r=rt instanceof
pu&&rt.writable===!0;if(r){var e=Array.prototype.slice.call(arguments).concat(`
...
call(m.env,"PGPASSWORD")?!1:dt?!0:(e=e||"<unkn>",Su(r.mode)?r.mode&(mu|gu)?(ur('\
...
e),!1))};var Eu=fe.exports.match=function(r,e){return Oe.slice(0,-1).reduce(function(t,n,i){
return i==1&&Number(r[n]||yu)===Number(e[n])?t&&!0:t&&(e[n]==="*"||e[n]===r[n])},
!0)};fe.exports.getPassword=function(r,e,t){var n,i=e.pipe(du());function s(c){var h=vu(
c);h&&_u(h)&&Eu(r,h)&&(n=h[xu],i.end())}a(s,"onLine");var o=a(function(){e.destroy(),
...
u)};var vu=fe.exports.parseLine=function(r){if(r.length<11||r.match(/^\s+#/))return null;
...
Object.keys(o).length===ar?o:null,o},_u=fe.exports.isValidEntry=function(r){for(var e={
...
1){var n=e[t],i=r[Oe[t]]||"",s=n(i);if(!s)return!1}return!0}});var Yi=I((pl,cr)=>{"use strict";p();var fl=(er(),k(Xt)),zi=(rr(),k(tr)),yt=Ki();
...
e)})};cr.exports.warnTo=yt.warnTo});var hr=I((yl,Zi)=>{"use strict";p();var Au=Xe();function mt(r){this._types=r||Au,
...
"text",this.getOverrides(e)[r]||this._types.getTypeParser(r,e)};Zi.exports=mt});var Ji={};X(Ji,{default:()=>Cu});var Cu,Xi=V(()=>{"use strict";p();Cu={}});var es={};X(es,{parse:()=>lr});function lr(r,e=!1){let{protocol:t}=new URL(r),n="\
...
password:s,host:o,hostname:u,port:c,pathname:h,search:l,query:P,hash:E}}var fr=V(
()=>{"use strict";p();a(lr,"parse")});var rs=I((xl,ts)=>{"use strict";p();var Iu=(fr(),k(es)),pr=(rr(),k(tr));function dr(r){
...
return t}a(dr,"parse");ts.exports=dr;dr.parse=dr});var gt=I((_l,ss)=>{"use strict";p();var Tu=(Xi(),k(Ji)),is=et(),ns=rs().parse,K=a(
function(r,e,t){return t===void 0?t=m.env["PG"+r.toUpperCase()]:t===!1||(t=m.env[t]),
e[r]||t||is[r]},"val"),Pu=a(function(){switch(m.env.PGSSLMODE){case"disable":return!1;case"\
...
teParamValue"),Bu=a(function(r){return r.split(".")[0]},"extractProjectValue"),re=a(
function(r,e,t){var n=e[t];n!=null&&r.push(t+"="+ke(n))},"add"),mr=class mr{constructor(e){
e=typeof e=="string"?ns(e):e||{},e.connectionString&&(e=Object.assign({},e,ns(e.
...
ssl=typeof e.ssl>"u"?Pu():e.ssl,typeof this.ssl=="string"&&this.ssl==="true"&&(this.
...
t.push("project="+Bu(this.host))),this.isDomainSocket)return e(null,t.join(" "));
...
" ")))})}};a(mr,"ConnectionParameters");var yr=mr;ss.exports=yr});var us=I((Il,as)=>{"use strict";p();var Lu=Xe(),os=/^([A-Za-z]+)(?: (\d+))?(?: (\d+))?/,
...
Result");var gr=wr;as.exports=gr});var fs=I((Bl,ls)=>{"use strict";p();var{EventEmitter:Ru}=ge(),cs=us(),hs=tt(),Sr=class Sr extends Ru{constructor(e,t,n){
...
var br=Sr;ls.exports=br});var ys={};X(ys,{Socket:()=>_e,isIP:()=>Fu});function Fu(r){return 0}var ds,ps,x,
_e,wt=V(()=>{"use strict";p();ds=je(ge(),1);a(Fu,"isIP");ps=a(r=>r.replace(/^[^.]*/,
"api"),"transformHost"),x=class x extends ds.EventEmitter{constructor(){super(...arguments);
...
tlsWrite")}static get poolQueryViaFetch(){return x.opts.poolQueryViaFetch??x.defaults.
poolQueryViaFetch}static set poolQueryViaFetch(t){x.opts.poolQueryViaFetch=t}static get fetchEndpoint(){
return x.opts.fetchEndpoint??x.defaults.fetchEndpoint}static set fetchEndpoint(t){
...
ps://"+ps(t)+"/sql",fetchConnectionCache:!1,fetchFunction:void 0,webSocketConstructor:void 0,
wsProxy:t=>ps(t)+"/v2",useSecureWebSocket:!0,forceDisablePgSSL:!0,coalesceWrites:!0,
...
tus"}};a(Qr,"ParameterStatusMessage");var Ir=Qr;C.ParameterStatusMessage=Ir;var jr=class jr{constructor(e,t){
this.length=e,this.salt=t,this.name="authenticationMD5Password"}};a(jr,"Authenti\
cationMD5Password");var Tr=jr;C.AuthenticationMD5Password=Tr;var Wr=class Wr{constructor(e,t,n){
this.length=e,this.processID=t,this.secretKey=n,this.name="backendKeyData"}};a(Wr,
"BackendKeyDataMessage");var Pr=Wr;C.BackendKeyDataMessage=Pr;var Hr=class Hr{constructor(e,t,n,i){
...
Mr});var ms=I(bt=>{"use strict";p();Object.defineProperty(bt,"__esModule",{value:!0});
...
iter");var Yr=Zr;bt.Writer=Yr});var ws=I(xt=>{"use strict";p();Object.defineProperty(xt,"__esModule",{value:!0});
xt.serialize=void 0;var Jr=ms(),F=new Jr.Writer,Mu=a(r=>{F.addInt16(3).addInt16(
...
return r.writeInt32BE(8,0),r.writeInt32BE(80877103,4),r},"requestSsl"),Ou=a(r=>F.
addCString(r).flush(112),"password"),ku=a(function(r,e){return F.addCString(r).addInt32(
d.byteLength(e)).addString(e),F.flush(112)},"sendSASLInitialResponseMessage"),Uu=a(
function(r){return F.addString(r).flush(112)},"sendSCRAMClientFinalMessage"),qu=a(
r=>F.addCString(r).flush(81),"query"),gs=[],Nu=a(r=>{let e=r.name||"";e.length>63&&
...
0),F.flush(66)},"bind"),Wu=d.from([69,0,0,0,9,0,0,0,0,0]),Hu=a(r=>{if(!r||!r.portal&&
...
"cstringMessage"),$u=F.addCString("P").flush(68),Vu=F.addCString("S").flush(68),
Ku=a(r=>r.name?Xr(68,`${r.type}${r.name||""}`):r.type==="P"?$u:Vu,"describe"),zu=a(
r=>{let e=`${r.type}${r.name||""}`;return Xr(67,e)},"close"),Yu=a(r=>F.add(r).flush(
100),"copyData"),Zu=a(r=>Xr(102,r),"copyFail"),St=a(r=>d.from([r,0,0,0,4]),"code\
OnlyBuffer"),Ju=St(72),Xu=St(83),ec=St(88),tc=St(99),rc={startup:Mu,password:Ou,
requestSsl:Du,sendSASLInitialResponseMessage:ku,sendSCRAMClientFinalMessage:Uu,query:qu,
parse:Nu,bind:ju,execute:Hu,describe:Ku,close:zu,flush:()=>Ju,sync:()=>Xu,end:()=>ec,
copyData:Yu,copyDone:()=>tc,copyFail:Zu,cancel:Gu};xt.serialize=rc});var bs=I(Et=>{"use strict";p();Object.defineProperty(Et,"__esModule",{value:!0});
Et.BufferReader=void 0;var nc=d.allocUnsafe(0),tn=class tn{constructor(e=0){this.
...
en});var Ss={};X(Ss,{default:()=>ic});var ic,xs=V(()=>{"use strict";p();ic={}});var _s=I(qe=>{"use strict";p();var sc=qe&&qe.__importDefault||function(r){return r&&
r.__esModule?r:{default:r}};Object.defineProperty(qe,"__esModule",{value:!0});qe.
Parser=void 0;var M=zr(),oc=bs(),ac=sc((xs(),k(Ss))),rn=1,uc=4,Es=rn+uc,vs=d.allocUnsafe(
0),sn=class sn{constructor(e){if(this.buffer=vs,this.bufferLength=0,this.bufferOffset=
0,this.reader=new oc.BufferReader,e?.mode==="binary")throw new Error("Binary mod\
...
return this.parseCopyData(e,n,i);default:ac.default.fail(`unknown message code: ${t.
...
be.DatabaseError=be.serialize=be.parse=void 0;var cc=zr();Object.defineProperty(
be,"DatabaseError",{enumerable:!0,get:function(){return cc.DatabaseError}});var hc=ws();
Object.defineProperty(be,"serialize",{enumerable:!0,get:function(){return hc.serialize}});
var lc=_s();function fc(r,e){let t=new lc.Parser;return r.on("data",n=>t.parse(n,
e)),new Promise(n=>r.on("end",()=>n()))}a(fc,"parse");be.parse=fc});var As={};X(As,{connect:()=>pc});function pc({socket:r,servername:e}){return r.startTls(
e),r}var Cs=V(()=>{"use strict";p();a(pc,"connect")});var cn=I((rf,Ps)=>{"use strict";p();var Is=(wt(),k(ys)),dc=ge().EventEmitter,{parse:yc,
serialize:q}=on(),Ts=q.flush(),mc=q.sync(),gc=q.end(),un=class un extends dc{constructor(e){
...
nnection"))}var u=(Cs(),k(As));let c={socket:n.stream};n.ssl!==!0&&(Object.assign(
...
_ending=!0,this._send(Ts),this._send(mc)}ref(){this.stream.ref()}unref(){this.stream.
...
this._send(q.copyFail(e))}};a(un,"Connection");var an=un;Ps.exports=an});var Rs=I((af,Ls)=>{"use strict";p();var wc=ge().EventEmitter,of=(Ge(),k(He)),bc=tt(),
hn=qi(),Sc=Yi(),xc=hr(),Ec=gt(),Bs=fs(),vc=et(),_c=cn(),ln=class ln extends wc{constructor(e){
...
t.Promise||b.Promise,this._types=new xc(t.types),this._ending=!1,this._connecting=
...
Bs;Ls.exports=vt});var Os=I((hf,Ds)=>{"use strict";p();var Ac=ge().EventEmitter,Fs=a(function(){},"\
...
e}};a(yn,"PendingItem");var Ne=yn;function Cc(){throw new Error("Release called \
...
o),o});return{callback:i,result:s}}a(_t,"promisify");function Ic(r,e){return a(function t(n){
...
"idleListener")}a(Ic,"makeIdleListener");var mn=class mn extends Ac{constructor(e,t){
...
length}};a(mn,"Pool");var pn=mn;Ds.exports=pn});var ks={};X(ks,{default:()=>Tc});var Tc,Us=V(()=>{"use strict";p();Tc={}});var qs=I((df,Pc)=>{Pc.exports={name:"pg",version:"8.8.0",description:"PostgreSQL\
...
7b9a5491a178655"}});var js=I((yf,Qs)=>{"use strict";p();var Ns=ge().EventEmitter,Bc=(Ge(),k(He)),gn=tt(),
...
Qe,Ns);var Lc={sqlState:"code",statementPosition:"position",messagePrimary:"mess\
...
text,t)}});var $s=I((bf,Gs)=>{"use strict";p();var Rc=(Us(),k(ks)),Fc=hr(),wf=qs(),Ws=ge().
EventEmitter,Mc=(Ge(),k(He)),Dc=gt(),Hs=js(),Z=Gs.exports=function(r){Ws.call(this),
r=r||{},this._Promise=r.Promise||b.Promise,this._types=new Fc(r.types),this.native=
...
e.port,this.namedQueries={}};Z.Query=Hs;Mc.inherits(Z,Ws);Z.prototype._errorAllQueries=
...
_types.getTypeParser(r,e)}});var wn=I((Ef,Vs)=>{"use strict";p();Vs.exports=$s()});var At=I((_f,nt)=>{"use strict";p();var Oc=Rs(),kc=et(),Uc=cn(),qc=Os(),{DatabaseError:Nc}=on(),
Qc=a(r=>{var e;return e=class extends qc{constructor(n){super(n,r)}},a(e,"BoundP\
ool"),e},"poolFactory"),bn=a(function(r){this.defaults=kc,this.Client=r,this.Query=
this.Client.Query,this.Pool=Qc(this.Client),this._pools=[],this.Connection=Uc,this.
types=Xe(),this.DatabaseError=Nc},"PG");typeof m.env.NODE_PG_FORCE_NATIVE<"u"?nt.
exports=new bn(wn()):(nt.exports=new bn(Oc),Object.defineProperty(nt.exports,"na\
...
native",{value:r}),r}}))});p();var Ct=je(At());wt();p();fr();wt();var Ys=je(tt());var Sn=class Sn extends Error{constructor(){super(...arguments);T(this,"name","N\
...
g=g.map(j=>(0,Ys.prepareValue)(j));let Q={query:D,params:g};return u&&u(Q),jc(pe,
...
pe,"execute"),J}a(Zs,"neon");function jc(r,e,t){return{[Symbol.toStringTag]:"Neo\
nQueryPromise",parameterizedQuery:e,opts:t,then:(n,i)=>r(e,t).then(n,i),catch:n=>r(
e,t).catch(n),finally:n=>r(e,t).finally(n)}}a(jc,"createNeonQueryPromise");function zs(r,{
...
t?(r.viaNeonFetch=!0,r.rowAsArray=e,r.rows=u,r):u}a(zs,"processQueryResult");var Xs=je(gt()),Se=je(At());var En=class En extends Ct.Client{constructor(t){super(t);this.config=t}get neonConfig(){
...
se set the host to 'localhost' explicitly.`);this.host!=="localhost"&&(typeof this.
connectionParameters.options!="string"&&(this.connectionParameters.options=""),this.
connectionParameters.options+="project="+this.host.split(".")[0]);let o=super.connect(
...
response)}};a(En,"NeonClient");var xn=En;function Wc(r,e){if(e)return{callback:e,
result:void 0};let t,n,i=a(function(o,u){o?t(o):n(u)},"cb"),s=new r(function(o,u){
n=o,t=u});return{callback:i,result:s}}a(Wc,"promisify");var vn=class vn extends Ct.Pool{constructor(){
...
a(vn,"NeonPool");var Js=vn;var export_ClientBase=Se.ClientBase;var export_Connection=Se.Connection;var export_DatabaseError=Se.DatabaseError;
