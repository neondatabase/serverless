...
value:r,enumerable:!0}):t,r)),X=r=>kn(st({},"__esModule",{value:!0}),r);var jn=P(Pt=>{"use strict";y();Pt.byteLength=Za;Pt.toByteArray=eo;Pt.fromByteArray=
no;var ge=[],ye=[],Ya=typeof Uint8Array<"u"?Uint8Array:Array,sr="ABCDEFGHIJKLMNO\
PQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";for(Ne=0,Qn=sr.length;Ne<Qn;++Ne)
ge[Ne]=sr[Ne],ye[sr.charCodeAt(Ne)]=Ne;var Ne,Qn;ye[45]=62;ye[95]=63;function $n(r){
...
"getLens");function Za(r){var e=$n(r),t=e[0],n=e[1];return(t+n)*3/4-n}o(Za,"byte\
Length");function Xa(r,e,t){return(e+t)*3/4-t}o(Xa,"_byteLength");function eo(r){
var e,t=$n(r),n=t[0],i=t[1],s=new Ya(Xa(r,n,i)),a=0,u=i>0?n-4:n,c;for(c=0;c<u;c+=
...
e&255),s}o(eo,"toByteArray");function to(r){return ge[r>>18&63]+ge[r>>12&63]+ge[r>>
6&63]+ge[r&63]}o(to,"tripletToBase64");function ro(r,e,t){for(var n,i=[],s=e;s<t;s+=
...
u=t-n;a<u;a+=s)i.push(ro(r,a,a+s>u?u:a+s));return n===1?(e=r[t-1],i.push(ge[e>>2]+
ge[e<<4&63]+"==")):n===2&&(e=(r[t-2]<<8)+r[t-1],i.push(ge[e>>10]+ge[e>>4&63]+ge[e<<
2&63]+"=")),i.join("")}o(no,"fromByteArray")});var Hn=P(ar=>{y();ar.read=function(r,e,t,n,i){var s,a,u=i*8-n-1,c=(1<<u)-1,l=c>>
...
l)-1,f=h>>1,d=i===23?Math.pow(2,-24)-Math.pow(2,-77):0,S=n?0:s-1,b=n?1:-1,C=e<0||
...
i-=8);for(a=a<<i|u,l+=i;l>0;r[t+S]=a&255,S+=b,a/=256,l-=8);r[t+S-b]|=C*128}});var oi=P($e=>{"use strict";y();var or=jn(),ke=Hn(),Kn=typeof Symbol=="function"&&
typeof Symbol.for=="function"?Symbol.for("nodejs.util.inspect.custom"):null;$e.Buffer=
p;$e.SlowBuffer=co;$e.INSPECT_MAX_BYTES=50;var Bt=2147483647;$e.kMaxLength=Bt;p.
TYPED_ARRAY_SUPPORT=io();!p.TYPED_ARRAY_SUPPORT&&typeof console<"u"&&typeof console.
...
r.foo()===42}catch{return!1}}o(io,"typedArraySupport");Object.defineProperty(p.prototype,
...
this))return this.byteOffset}});function xe(r){if(r>Bt)throw new RangeError('The\
...
be of type string. Received type number');return hr(r)}return zn(r,e,t)}o(p,"Buf\
fer");p.poolSize=8192;function zn(r,e,t){if(typeof r=="string")return ao(r,e);if(ArrayBuffer.
...
e one of type string, Buffer, ArrayBuffer, Array, or Array-like Object. Received\
 type "+typeof r);if(Se(r,ArrayBuffer)||r&&Se(r.buffer,ArrayBuffer)||typeof SharedArrayBuffer<
"u"&&(Se(r,SharedArrayBuffer)||r&&Se(r.buffer,SharedArrayBuffer)))return cr(r,e,
...
r)return p.from(n,e,t);let i=uo(r);if(i)return i;if(typeof Symbol<"u"&&Symbol.toPrimitive!=
...
e):xe(r)}o(so,"alloc");p.alloc=function(r,e,t){return so(r,e,t)};function hr(r){
return Jn(r),xe(r<0?0:fr(r)|0)}o(hr,"allocUnsafe");p.allocUnsafe=function(r){return hr(
r)};p.allocUnsafeSlow=function(r){return hr(r)};function ao(r,e){if((typeof e!="\
...
n}o(ao,"fromString");function ur(r){let e=r.length<0?0:fr(r.length)|0,t=xe(e);for(let n=0;n<
e;n+=1)t[n]=r[n]&255;return t}o(ur,"fromArrayLike");function oo(r){if(Se(r,Uint8Array)){
let e=new Uint8Array(r);return cr(e.buffer,e.byteOffset,e.byteLength)}return ur(
r)}o(oo,"fromArrayView");function cr(r,e,t){if(e<0||r.byteLength<e)throw new RangeError(
...
n,p.prototype),n}o(cr,"fromArrayBuffer");function uo(r){if(p.isBuffer(r)){let e=fr(
...
Bt.toString(16)+" bytes");return r|0}o(fr,"checked");function co(r){return+r!=r&&
(r=0),p.alloc(+r)}o(co,"SlowBuffer");p.isBuffer=o(function(e){return e!=null&&e.
_isBuffer===!0&&e!==p.prototype},"isBuffer");p.compare=o(function(e,t){if(Se(e,Uint8Array)&&
(e=p.from(e,e.offset,e.byteLength)),Se(t,Uint8Array)&&(t=p.from(t,t.offset,t.byteLength)),
...
for(n=0;n<e.length;++n){let a=e[n];if(Se(a,Uint8Array))s+a.length>i.length?(p.isBuffer(
...
i=!0}}o(Yn,"byteLength");p.byteLength=Yn;function lo(r,e,t){let n=!1;if((e===void 0||
...
lo,"slowToString");p.prototype._isBuffer=!0;function Me(r,e,t){let n=r[e];r[e]=r[t],
r[t]=n}o(Me,"swap");p.prototype.swap16=o(function(){let e=this.length;if(e%2!==0)
throw new RangeError("Buffer size must be a multiple of 16-bits");for(let t=0;t<
e;t+=2)Me(this,t,t+1);return this},"swap16");p.prototype.swap32=o(function(){let e=this.
...
Me(this,t+1,t+6),Me(this,t+2,t+5),Me(this,t+3,t+4);return this},"swap64");p.prototype.
toString=o(function(){let e=this.length;return e===0?"":arguments.length===0?Xn(
this,0,e):lo.apply(this,arguments)},"toString");p.prototype.toLocaleString=p.prototype.
...
o(function(e,t,n,i,s){if(Se(e,Uint8Array)&&(e=p.from(e,e.offset,e.byteLength)),!p.
...
return a;r[t+a]=u}return a}o(ho,"hexWrite");function fo(r,e,t,n){return Rt(lr(e,
r.length-t),r,t,n)}o(fo,"utf8Write");function po(r,e,t,n){return Rt(_o(e),r,t,n)}
o(po,"asciiWrite");function yo(r,e,t,n){return Rt(ai(e),r,t,n)}o(yo,"base64Write");
function wo(r,e,t,n){return Rt(Lo(e,r.length-t),r,t,n)}o(wo,"ucs2Write");p.prototype.
...
length?or.fromByteArray(r):or.fromByteArray(r.slice(e,t))}o(mo,"base64Slice");function Xn(r,e,t){
...
(!t||t<0||t>n)&&(t=n);let i="";for(let s=e;s<t;++s)i+=To[r[s]];return i}o(bo,"he\
xSlice");function xo(r,e,t){let n=r.slice(e,t),i="";for(let s=0;s<n.length-1;s+=
2)i+=String.fromCharCode(n[s]+n[s+1]*256);return i}o(xo,"utf16leSlice");p.prototype.
...
e,t);return Object.setPrototypeOf(i,p.prototype),i},"slice");function ee(r,e,t){
if(r%1!==0||r<0)throw new RangeError("offset is not uint");if(r+e>t)throw new RangeError(
"Trying to access beyond buffer length")}o(ee,"checkOffset");p.prototype.readUintLE=
p.prototype.readUIntLE=o(function(e,t,n){e=e>>>0,t=t>>>0,n||ee(e,t,this.length);
...
return e=e>>>0,t||ee(e,1,this.length),this[e]},"readUInt8");p.prototype.readUint16LE=
p.prototype.readUInt16LE=o(function(e,t){return e=e>>>0,t||ee(e,2,this.length),this[e]|
...
0,Qe(e,"offset");let t=this[e],n=this[e+7];(t===void 0||n===void 0)&&ot(e,this.length-
...
Int64LE"));p.prototype.readBigUInt64BE=_e(o(function(e){e=e>>>0,Qe(e,"offset");let t=this[e],
n=this[e+7];(t===void 0||n===void 0)&&ot(e,this.length-8);let i=t*2**24+this[++e]*
...
LE");p.prototype.readIntBE=o(function(e,t,n){e=e>>>0,t=t>>>0,n||ee(e,t,this.length);
...
p.prototype.readInt16LE=o(function(e,t){e=e>>>0,t||ee(e,2,this.length);let n=this[e]|
...
readInt32LE");p.prototype.readInt32BE=o(function(e,t){return e=e>>>0,t||ee(e,4,this.
...
(t===void 0||n===void 0)&&ot(e,this.length-8);let i=this[e+4]+this[e+5]*2**8+this[e+
...
igInt64BE"));p.prototype.readFloatLE=o(function(e,t){return e=e>>>0,t||ee(e,4,this.
length),ke.read(this,e,!0,23,4)},"readFloatLE");p.prototype.readFloatBE=o(function(e,t){
return e=e>>>0,t||ee(e,4,this.length),ke.read(this,e,!1,23,4)},"readFloatBE");p.
...
n>r.length)throw new RangeError("Index out of range")}o(ce,"checkInt");p.prototype.
...
p.prototype.writeUInt32BE=o(function(e,t,n){return e=+e,t=t>>>0,n||ce(this,e,t,4,
...
r[t+2]=a,a=a>>8,r[t+1]=a,a=a>>8,r[t]=a,t+8}o(ti,"wrtBigUInt64BE");p.prototype.writeBigUInt64LE=
_e(o(function(e,t=0){return ei(this,e,t,BigInt(0),BigInt("0xffffffffffffffff"))},
"writeBigUInt64LE"));p.prototype.writeBigUInt64BE=_e(o(function(e,t=0){return ti(
...
iteInt16LE");p.prototype.writeInt16BE=o(function(e,t,n){return e=+e,t=t>>>0,n||ce(
...
LE");p.prototype.writeInt32BE=o(function(e,t,n){return e=+e,t=t>>>0,n||ce(this,e,
...
_e(o(function(e,t=0){return ei(this,e,t,-BigInt("0x8000000000000000"),BigInt("0x\
...
-34028234663852886e22),ke.write(r,e,t,n,23,4),t+4}o(ni,"writeFloat");p.prototype.
writeFloatLE=o(function(e,t,n){return ni(this,e,t,!0,n)},"writeFloatLE");p.prototype.
...
ke.write(r,e,t,n,52,8),t+8}o(ii,"writeDouble");p.prototype.writeDoubleLE=o(function(e,t,n){
return ii(this,e,t,!0,n)},"writeDoubleLE");p.prototype.writeDoubleBE=o(function(e,t,n){
return ii(this,e,t,!1,n)},"writeDoubleBE");p.prototype.copy=o(function(e,t,n,i){
...
return`${r.slice(0,t)}${e}`}o(Vn,"addNumericalSeparator");function Ao(r,e,t){Qe(
e,"offset"),(r[e]===void 0||r[e+t]===void 0)&&ot(e,r.length-(t+1))}o(Ao,"checkBo\
...
new Oe.ERR_OUT_OF_RANGE("value",u,r)}Ao(n,i,s)}o(si,"checkIntBI");function Qe(r,e){
if(typeof r!="number")throw new Oe.ERR_INVALID_ARG_TYPE(e,"number",r)}o(Qe,"vali\
dateNumber");function ot(r,e,t){throw Math.floor(r)!==r?(Qe(r,t),new Oe.ERR_OUT_OF_RANGE(
t||"offset","an integer",r)):e<0?new Oe.ERR_BUFFER_OUT_OF_BOUNDS:new Oe.ERR_OUT_OF_RANGE(
t||"offset",`>= ${t?1:0} and <= ${e}`,r)}o(ot,"boundsError");var vo=/[^+/0-9A-Za-z-_]/g;
function Co(r){if(r=r.split("=")[0],r=r.trim().replace(vo,""),r.length<2)return"";
for(;r.length%4!==0;)r=r+"=";return r}o(Co,"base64clean");function lr(r,e){e=e||
...
point")}return s}o(lr,"utf8ToBytes");function _o(r){let e=[];for(let t=0;t<r.length;++t)
e.push(r.charCodeAt(t)&255);return e}o(_o,"asciiToBytes");function Lo(r,e){let t,
n,i,s=[];for(let a=0;a<r.length&&!((e-=2)<0);++a)t=r.charCodeAt(a),n=t>>8,i=t%256,
s.push(i),s.push(n);return s}o(Lo,"utf16leToBytes");function ai(r){return or.toByteArray(
Co(r))}o(ai,"base64ToBytes");function Rt(r,e,t,n){let i;for(i=0;i<n&&!(i+t>=e.length||
...
e.name}o(Se,"isInstance");function pr(r){return r!==r}o(pr,"numberIsNaN");var To=function(){
...
o(Uo,"BufferBigIntNotDefined")});var _,L,T,A,w,m,y=oe(()=>{"use strict";_=globalThis,L=globalThis.setImmediate??(r=>setTimeout(
...
m.nextTick(()=>{})}catch{let e=Promise.resolve();m.nextTick=e.then.bind(e)}});var Ue=P((ff,_r)=>{"use strict";y();var We=typeof Reflect=="object"?Reflect:null,
...
e},"NumberIsNaN");function O(){O.init.call(this)}o(O,"EventEmitter");_r.exports=
O;_r.exports.once=Iu;O.EventEmitter=O;O.prototype._events=void 0;O.prototype._eventsCount=
0;O.prototype._maxListeners=void 0;var Pi=10;function kt(r){if(typeof r!="functi\
on")throw new TypeError('The "listener" argument must be of type Function. Recei\
ved type '+typeof r)}o(kt,"checkListener");Object.defineProperty(O,"defaultMaxLi\
...
_onceWrap");O.prototype.once=o(function(e,t){return kt(t),this.on(e,Mi(this,e,t)),
this},"once");O.prototype.prependOnceListener=o(function(e,t){return kt(t),this.
...
0?n.shift():Tu(n,s),n.length===1&&(i[e]=n[0]),i.removeListener!==void 0&&this.emit(
...
on"?t?[i.listener||i]:[i]:t?Uu(i):qi(i,i.length)}o(Di,"_listeners");O.prototype.
...
O.prototype.eventNames=o(function(){return this._eventsCount>0?Ot(this._events):
[]},"eventNames");function qi(r,e){for(var t=new Array(e),n=0;n<e;++n)t[n]=r[n];
return t}o(qi,"arrayClone");function Tu(r,e){for(;e+1<r.length;e++)r[e]=r[e+1];r.
pop()}o(Tu,"spliceOne");function Uu(r){for(var e=new Array(r.length),t=0;t<e.length;++t)
...
ed type '+typeof r)}o(Oi,"eventTargetAgnosticAddListener")});var ht={};fe(ht,{default:()=>Bu});var Bu,ft=oe(()=>{"use strict";y();Bu={}});function dt(r){let e=1779033703,t=3144134277,n=1013904242,i=2773480762,s=1359893119,
...
2361852424,2428436474,2756734187,3204031479,3329325298],d=o((E,g)=>E>>>g|E<<32-g,
"rrot"),S=new Uint32Array(64),b=new Uint8Array(64),C=o(()=>{for(let M=0,$=0;M<16;M++,
$+=4)S[M]=b[$]<<24|b[$+1]<<16|b[$+2]<<8|b[$+3];for(let M=16;M<64;M++){let $=d(S[M-
15],7)^d(S[M-15],18)^S[M-15]>>>3,j=d(S[M-2],17)^d(S[M-2],19)^S[M-2]>>>10;S[M]=S[M-
16]+$+S[M-7]+j|0}let E=e,g=t,v=n,N=i,B=s,k=a,Q=u,Y=c;for(let M=0;M<64;M++){let $=d(
B,6)^d(B,11)^d(B,25),j=B&k^~B&Q,H=Y+$+j+f[M]+S[M]|0,W=d(E,2)^d(E,13)^d(E,22),G=E&
g^E&v^g&v,D=W+G|0;Y=Q,Q=k,k=B,B=N+H|0,N=v,v=g,g=E,E=H+D|0}e=e+E|0,t=t+g|0,n=n+v|
0,i=i+N|0,s=s+B|0,a=a+k|0,u=u+Q|0,c=c+Y|0,h=0},"process"),x=o(E=>{typeof E=="str\
ing"&&(E=new TextEncoder().encode(E));for(let g=0;g<E.length;g++)b[h++]=E[g],h===
64&&C();l+=E.length},"add"),U=o(()=>{if(b[h++]=128,h==64&&C(),h+8>64){for(;h<64;)
b[h++]=0;C()}for(;h<58;)b[h++]=0;let E=l*8;b[h++]=E/1099511627776&255,b[h++]=E/4294967296&
255,b[h++]=E>>>24,b[h++]=E>>>16&255,b[h++]=E>>>8&255,b[h++]=E&255,C();let g=new Uint8Array(
32);return g[0]=e>>>24,g[1]=e>>>16&255,g[2]=e>>>8&255,g[3]=e&255,g[4]=t>>>24,g[5]=
t>>>16&255,g[6]=t>>>8&255,g[7]=t&255,g[8]=n>>>24,g[9]=n>>>16&255,g[10]=n>>>8&255,
g[11]=n&255,g[12]=i>>>24,g[13]=i>>>16&255,g[14]=i>>>8&255,g[15]=i&255,g[16]=s>>>
24,g[17]=s>>>16&255,g[18]=s>>>8&255,g[19]=s&255,g[20]=a>>>24,g[21]=a>>>16&255,g[22]=
a>>>8&255,g[23]=a&255,g[24]=u>>>24,g[25]=u>>>16&255,g[26]=u>>>8&255,g[27]=u&255,
g[28]=c>>>24,g[29]=c>>>16&255,g[30]=c>>>8&255,g[31]=c&255,g},"digest");return r===
void 0?{add:x,digest:U}:(x(r),U())}var ki=oe(()=>{"use strict";y();o(dt,"sha256")});var pt,Qi=oe(()=>{"use strict";y();pt=class r{static{o(this,"Md5")}static hashByteArray(e,t=!1){
...
_state:r._hex(this._state)}}});var Lr={};fe(Lr,{createHash:()=>Nu,createHmac:()=>Mu,randomBytes:()=>Ru});function Ru(r){
return A.getRandomValues(w.alloc(r))}function Nu(r){if(r==="sha256")return{update:function(e){
...
set(dt(a),64),w.from(dt(u))}}}}}var Tr=oe(()=>{"use strict";y();ki();Qi();o(Ru,"\
randomBytes");o(Nu,"createHash");o(Mu,"createHmac")});var Ir=P($i=>{"use strict";y();$i.parse=function(r,e){return new Ur(r,e).parse()};
...
return r}o(Du,"identity")});var Pr=P((Uf,ji)=>{y();var Fu=Ir();ji.exports={create:function(r,e){return{parse:function(){
return Fu.parse(r,e)}}}}});var Wi=P((Pf,Ki)=>{"use strict";y();var qu=/(\d{1,})-(\d{2})-(\d{2}) (\d{2}):(\d{2}):(\d{2})(\.\d{1,})?.*?( BC)?$/,
...
h=h?1e3*parseFloat(h):0;var f,d=ju(e);return d!=null?(f=new Date(Date.UTC(i,s,a,
u,c,l,h)),Br(i)&&f.setUTCFullYear(i),d!==0&&f.setTime(f.getTime()-d)):(f=new Date(
i,s,a,u,c,l,h),Br(i)&&f.setFullYear(i)),f},"parseDate");function $u(r){var e=Ou.
exec(r);if(e){var t=parseInt(e[1],10),n=!!e[4];n&&(t=Hi(t));var i=parseInt(e[2],
10)-1,s=e[3],a=new Date(t,i,s);return Br(t)&&a.setFullYear(t),a}}o($u,"getDate");
...
"is0To99")});var Vi=P((Nf,Gi)=>{y();Gi.exports=Ku;var Hu=Object.prototype.hasOwnProperty;function Ku(r){
for(var e=1;e<arguments.length;e++){var t=arguments[e];for(var n in t)Hu.call(t,
n)&&(r[n]=t[n])}return r}o(Ku,"extend")});var Yi=P((Ff,Ji)=>{"use strict";y();var Wu=Vi();Ji.exports=Ge;function Ge(r){if(!(this instanceof
...
"")),i+Vu[n]}};var Rr="([+-]?\\d+)",Yu=Rr+"\\s+years?",Zu=Rr+"\\s+mons?",Xu=Rr+"\
...
a),n},{})}o(ic,"parse")});var Xi=P((kf,Zi)=>{"use strict";y();Zi.exports=o(function(e){if(/^\\x/.test(e))return new w(
...
"\\";n+=Math.floor(i/2)*2}return new w(t,"binary")},"parseBytea")});var as=P((jf,ss)=>{y();var yt=Ir(),wt=Pr(),Qt=Wi(),ts=Yi(),rs=Xi();function $t(r){
...
eBoolArray");function ac(r){return parseInt(r,10)}o(ac,"parseBaseTenInt");function Nr(r){
return r?yt.parse(r,$t(ac)):null}o(Nr,"parseIntegerArray");function oc(r){return r?
yt.parse(r,$t(function(e){return is(e).trim()})):null}o(oc,"parseBigIntegerArray");
...
return e.parse()},"parseFloatArray"),we=o(function(r){if(!r)return null;var e=wt.
create(r);return e.parse()},"parseStringArray"),Dr=o(function(r){if(!r)return null;
var e=wt.create(r,function(t){return t!==null&&(t=Qt(t)),t});return e.parse()},"\
...
return r?yt.parse(r,$t(rs)):null},"parseByteAArray"),Fr=o(function(r){return parseInt(
r,10)},"parseInteger"),is=o(function(r){var e=String(r);return/^\d+$/.test(e)?e:
r},"parseBigInteger"),es=o(function(r){return r?yt.parse(r,$t(JSON.parse)):null},
...
Qt),r(1114,Qt),r(1184,Qt),r(600,qr),r(651,we),r(718,hc),r(1e3,sc),r(1001,lc),r(1005,
Nr),r(1007,Nr),r(1028,Nr),r(1016,oc),r(1017,uc),r(1021,Mr),r(1022,Mr),r(1231,Mr),
r(1014,we),r(1015,we),r(1008,we),r(1009,we),r(1040,we),r(1041,we),r(1115,Dr),r(1182,
Dr),r(1185,Dr),r(1186,ts),r(1187,cc),r(17,rs),r(114,JSON.parse.bind(JSON)),r(3802,
JSON.parse.bind(JSON)),r(199,es),r(3807,es),r(3907,we),r(2951,we),r(791,we),r(1183,
we),r(1270,we)},"init");ss.exports={init:fc}});var us=P((Wf,os)=>{"use strict";y();var le=1e6;function dc(r){var e=r.readInt32BE(
...
c+="0";i=c+u+i}return s=e%le,a=4294967296*s+t,u=""+a%le,n+u+i}o(dc,"readInt8");os.
exports=dc});var ds=P((zf,fs)=>{y();var pc=us(),V=o(function(r,e,t,n,i){t=t||0,n=n||!1,i=i||function(S,b,C){
return S*Math.pow(2,C)+b};var s=t>>3,a=o(function(S){return n?~S&255:S},"inv"),u=255,
...
fs.exports={init:bc}});var ys=P((Zf,ps)=>{y();ps.exports={BOOL:16,BYTEA:17,CHAR:18,INT8:20,INT2:21,INT4:23,
...
REGCONFIG:3734,REGDICTIONARY:3769,JSONB:3802,REGNAMESPACE:4089,REGROLE:4096}});var Et=P(St=>{y();var xc=as(),Ac=ds(),vc=Pr(),Cc=ys();St.getTypeParser=_c;St.setTypeParser=
...
gt.binary[r]=e})});var bt=P((nd,Or)=>{"use strict";y();Or.exports={host:"localhost",user:m.platform===
...
connect_timeout:0,keepalives:1,keepalives_idle:0};var Ve=Et(),Tc=Ve.getTypeParser(
20,"text"),Uc=Ve.getTypeParser(1016,"text");Or.exports.__defineSetter__("parseIn\
t8",function(r){Ve.setTypeParser(20,"text",r?Ve.getTypeParser(23,"text"):Tc),Ve.
setTypeParser(1016,"text",r?Ve.getTypeParser(1007,"text"):Uc)})});var xt=P((sd,gs)=>{"use strict";y();var Ic=(Tr(),X(Lr)),Pc=bt();function Bc(r){var e=r.
...
toString("hex"):e+=Bc(jt(r[t]));return e=e+"}",e}o(ms,"arrayString");var jt=o(function(r,e){
...
ig");var kr=o(function(r){return Ic.createHash("md5").update(r,"utf-8").digest("\
hex")},"md5"),Fc=o(function(r,e,t){var n=kr(e+r),i=kr(w.concat([w.from(n),t]));return"\
md5"+i},"postgresMd5PasswordHash");gs.exports={prepareValue:o(function(e){return jt(
e)},"prepareValueWrapper"),normalizeQueryConfig:Dc,postgresMd5PasswordHash:Fc,md5:kr}});var As=P((ud,xs)=>{"use strict";y();var Qr=(Tr(),X(Lr));function qc(r){if(r.indexOf(
...
i,n.iteration),a=ze(s,"Client Key"),u=Hc(a),c="n=*,r="+r.clientNonce,l="r="+n.nonce+
",s="+n.salt+",i="+n.iteration,h="c=biws,r="+n.nonce,f=c+","+l+","+h,d=ze(u,f),S=bs(
a,d),b=S.toString("base64"),C=ze(s,"Server Key"),x=ze(C,f);r.message="SASLRespon\
se",r.serverSignature=x.toString("base64"),r.response=h+",p="+b}o(Oc,"continueSe\
...
from(r.map((t,n)=>r[n]^e[n]))}o(bs,"xorBuffers");function Hc(r){return Qr.createHash(
"sha256").update(r).digest()}o(Hc,"sha256");function ze(r,e){return Qr.createHmac(
...
o(Kc,"Hi");xs.exports={startSession:qc,continueSession:Oc,finalizeSession:kc}});var $r={};fe($r,{join:()=>Wc});function Wc(...r){return r.join("/")}var jr=oe(()=>{
"use strict";y();o(Wc,"join")});var Hr={};fe(Hr,{stat:()=>Gc});function Gc(r,e){e(new Error("No filesystem"))}var Kr=oe(
()=>{"use strict";y();o(Gc,"stat")});var Wr={};fe(Wr,{default:()=>Vc});var Vc,Gr=oe(()=>{"use strict";y();Vc={}});var vs={};fe(vs,{StringDecoder:()=>Vr});var Vr,Cs=oe(()=>{"use strict";y();Vr=class{static{
o(this,"StringDecoder")}td;constructor(e){this.td=new TextDecoder(e)}write(e){return this.
td.decode(e,{stream:!0})}end(e){return this.td.decode(e)}}});var Us=P((gd,Ts)=>{"use strict";y();var{Transform:zc}=(Gr(),X(Wr)),{StringDecoder:Jc}=(Cs(),X(vs)),
...
if(this[Ie]+=this[Ht].end(),this[Ie])try{Ls(this,this.mapper(this[Ie]))}catch(e){
...
this._writableState.errorEmitted=!1,s(i)},n}o(Xc,"split");Ts.exports=Xc});var Bs=P((bd,Ae)=>{"use strict";y();var Is=(jr(),X($r)),el=(Gr(),X(Wr)).Stream,tl=Us(),
Ps=(ft(),X(ht)),rl=5432,Kt=m.platform==="win32",At=m.stderr,nl=56,il=7,sl=61440,
al=32768;function ol(r){return(r&sl)==al}o(ol,"isRegFile");var Je=["host","port",
"database","user","password"],zr=Je.length,ul=Je[zr-1];function Jr(){var r=At instanceof
el&&At.writable===!0;if(r){var e=Array.prototype.slice.call(arguments).concat(`
`);At.write(Ps.format.apply(Ps,e))}}o(Jr,"warn");Object.defineProperty(Ae.exports,
"isWin",{get:function(){return Kt},set:function(r){Kt=r}});Ae.exports.warnTo=function(r){
var e=At;return At=r,e};Ae.exports.getFileName=function(r){var e=r||m.env,t=e.PGPASSFILE||
(Kt?Is.join(e.APPDATA||"./","postgresql","pgpass.conf"):Is.join(e.HOME||"./",".p\
gpass"));return t};Ae.exports.usePgPass=function(r,e){return Object.prototype.hasOwnProperty.
call(m.env,"PGPASSWORD")?!1:Kt?!0:(e=e||"<unkn>",ol(r.mode)?r.mode&(nl|il)?(Jr('\
...
!0)};Ae.exports.getPassword=function(r,e,t){var n,i=e.pipe(tl());function s(c){var l=ll(
c);l&&hl(l)&&cl(r,l)&&(n=l[ul],i.end())}o(s,"onLine");var a=o(function(){e.destroy(),
...
d);Object.hasOwnProperty.call(m.env,"PGPASS_NO_DEESCAPE")||(S=S.replace(/\\([:\\])/g,
...
Object.keys(a).length===zr?a:null,a},hl=Ae.exports.isValidEntry=function(r){for(var e={
...
1){var n=e[t],i=r[Je[t]]||"",s=n(i);if(!s)return!1}return!0}});var Ns=P((Cd,Yr)=>{"use strict";y();var vd=(jr(),X($r)),Rs=(Kr(),X(Hr)),Wt=Bs();
...
e)})};Yr.exports.warnTo=Wt.warnTo});var Zr=P((Ld,Ms)=>{"use strict";y();var fl=Et();function Gt(r){this._types=r||fl,
...
"text",this.getOverrides(e)[r]||this._types.getTypeParser(r,e)};Ms.exports=Gt});var Ds={};fe(Ds,{default:()=>dl});var dl,Fs=oe(()=>{"use strict";y();dl={}});var qs={};fe(qs,{parse:()=>Xr});function Xr(r,e=!1){let{protocol:t}=new URL(r),n="\
...
password:s,host:a,hostname:u,port:c,pathname:l,search:h,query:b,hash:d}}var en=oe(
()=>{"use strict";y();o(Xr,"parse")});var ks=P((Rd,Os)=>{"use strict";y();var pl=(en(),X(qs)),tn=(Kr(),X(Hr));function rn(r){
...
return t}o(rn,"parse");Os.exports=rn;rn.parse=rn});var Vt=P((Dd,js)=>{"use strict";y();var yl=(Fs(),X(Ds)),$s=bt(),Qs=ks().parse,ue=o(
function(r,e,t){return t===void 0?t=m.env["PG"+r.toUpperCase()]:t===!1||(t=m.env[t]),
e[r]||t||$s[r]},"val"),wl=o(function(){switch(m.env.PGSSLMODE){case"disable":return!1;case"\
...
e(i,null):(t.push("hostaddr="+Ye(s)),e(null,t.join(" ")))})}};js.exports=nn});var Ws=P((Od,Ks)=>{"use strict";y();var ml=Et(),Hs=/^([A-Za-z]+)(?: (\d+))?(?: (\d+))?/,
...
n.dataTypeID,n.format||"text")}}};Ks.exports=sn});var Js=P(($d,zs)=>{"use strict";y();var{EventEmitter:gl}=Ue(),Gs=Ws(),Vs=xt(),an=class extends gl{static{
...
e.sendCopyFail("No source stream defined")}handleCopyData(e,t){}};zs.exports=an});var Zs={};fe(Zs,{Socket:()=>de,isIP:()=>Sl});function Sl(r){return 0}var Ys,El,de,
zt=oe(()=>{"use strict";y();Ys=at(Ue(),1);o(Sl,"isIP");El=o(r=>r.replace(/^[^.]+\./,
"api."),"transformHost"),de=class r extends Ys.EventEmitter{static{o(this,"Socke\
t")}static defaults={poolQueryViaFetch:!1,fetchEndpoint:e=>"https://"+El(e)+"/sq\
l",fetchConnectionCache:!0,fetchFunction:void 0,webSocketConstructor:void 0,wsProxy:e=>e+
"/v2",useSecureWebSocket:!0,forceDisablePgSSL:!0,coalesceWrites:!0,pipelineConnect:"\
password",subtls:void 0,rootCerts:"",pipelineTLS:!1,disableSNI:!1};static opts={};opts={};static get poolQueryViaFetch(){
...
"notice"}};I.NoticeMessage=En});var Xs=P(Jt=>{"use strict";y();Object.defineProperty(Jt,"__esModule",{value:!0});
...
size),t}};Jt.Writer=xn});var ta=P(Zt=>{"use strict";y();Object.defineProperty(Zt,"__esModule",{value:!0});
Zt.serialize=void 0;var An=Xs(),z=new An.Writer,bl=o(r=>{z.addInt16(3).addInt16(
...
Writer().addInt32(t).add(e).flush()},"startup"),xl=o(()=>{let r=w.allocUnsafe(8);
return r.writeInt32BE(8,0),r.writeInt32BE(80877103,4),r},"requestSsl"),Al=o(r=>z.
addCString(r).flush(112),"password"),vl=o(function(r,e){return z.addCString(r).addInt32(
w.byteLength(e)).addString(e),z.flush(112)},"sendSASLInitialResponseMessage"),Cl=o(
function(r){return z.addString(r).flush(112)},"sendSCRAMClientFinalMessage"),_l=o(
r=>z.addCString(r).flush(81),"query"),ea=[],Ll=o(r=>{let e=r.name||"";e.length>63&&
...
flush(80)},"parse"),Ze=new An.Writer,Tl=o(function(r,e){for(let t=0;t<r.length;t++){
...
z.addInt16(s),Tl(i,r.valueMapper),z.addInt16(s),z.add(Ze.flush()),z.addInt16(n?1:
0),z.flush(66)},"bind"),Il=w.from([69,0,0,0,9,0,0,0,0,0]),Pl=o(r=>{if(!r||!r.portal&&
!r.rows)return Il;let e=r.portal||"",t=r.rows||0,n=w.byteLength(e),i=4+n+1+4,s=w.
allocUnsafe(1+i);return s[0]=69,s.writeInt32BE(i,1),s.write(e,5,"utf-8"),s[n+5]=
0,s.writeUInt32BE(t,s.length-4),s},"execute"),Bl=o((r,e)=>{let t=w.allocUnsafe(16);
...
"cstringMessage"),Rl=z.addCString("P").flush(68),Nl=z.addCString("S").flush(68),
Ml=o(r=>r.name?vn(68,`${r.type}${r.name||""}`):r.type==="P"?Rl:Nl,"describe"),Dl=o(
r=>{let e=`${r.type}${r.name||""}`;return vn(67,e)},"close"),Fl=o(r=>z.add(r).flush(
100),"copyData"),ql=o(r=>vn(102,r),"copyFail"),Yt=o(r=>w.from([r,0,0,0,4]),"code\
OnlyBuffer"),Ol=Yt(72),kl=Yt(83),Ql=Yt(88),$l=Yt(99),jl={startup:bl,password:Al,
requestSsl:xl,sendSASLInitialResponseMessage:vl,sendSCRAMClientFinalMessage:Cl,query:_l,
parse:Ll,bind:Ul,execute:Pl,describe:Ml,close:Dl,flush:()=>Ol,sync:()=>kl,end:()=>Ql,
copyData:Fl,copyDone:()=>$l,copyFail:ql,cancel:Bl};Zt.serialize=jl});var ra=P(Xt=>{"use strict";y();Object.defineProperty(Xt,"__esModule",{value:!0});
Xt.BufferReader=void 0;var Hl=w.allocUnsafe(0),Cn=class{static{o(this,"BufferRea\
der")}constructor(e=0){this.offset=e,this.buffer=Hl,this.encoding="utf-8"}setBuffer(e,t){
...
offset+e);return this.offset+=e,t}};Xt.BufferReader=Cn});var na={};fe(na,{default:()=>Kl});var Kl,ia=oe(()=>{"use strict";y();Kl={}});var oa=P(Xe=>{"use strict";y();var Wl=Xe&&Xe.__importDefault||function(r){return r&&
r.__esModule?r:{default:r}};Object.defineProperty(Xe,"__esModule",{value:!0});Xe.
Parser=void 0;var J=bn(),Gl=ra(),Vl=Wl((ia(),X(na))),_n=1,zl=4,sa=_n+zl,aa=w.allocUnsafe(
0),Ln=class{static{o(this,"Parser")}constructor(e){if(this.buffer=aa,this.bufferLength=
0,this.bufferOffset=0,this.reader=new Gl.BufferReader,e?.mode==="binary")throw new Error(
...
return this.parseCopyData(e,n,i);default:Vl.default.fail(`unknown message code: ${t.
...
line=s.L,c.routine=s.R,c}};Xe.Parser=Ln});var Tn=P(Pe=>{"use strict";y();Object.defineProperty(Pe,"__esModule",{value:!0});
Pe.DatabaseError=Pe.serialize=Pe.parse=void 0;var Jl=bn();Object.defineProperty(
Pe,"DatabaseError",{enumerable:!0,get:function(){return Jl.DatabaseError}});var Yl=ta();
Object.defineProperty(Pe,"serialize",{enumerable:!0,get:function(){return Yl.serialize}});
var Zl=oa();function Xl(r,e){let t=new Zl.Parser;return r.on("data",n=>t.parse(n,
e)),new Promise(n=>r.on("end",()=>n()))}o(Xl,"parse");Pe.parse=Xl});var ua={};fe(ua,{connect:()=>eh});function eh({socket:r,servername:e}){return r.
startTls(e),r}var ca=oe(()=>{"use strict";y();o(eh,"connect")});var In=P((pp,fa)=>{"use strict";y();var la=(zt(),X(Zs)),th=Ue().EventEmitter,{parse:rh,
serialize:te}=Tn(),ha=te.flush(),nh=te.sync(),ih=te.end(),Un=class extends th{static{
...
ns"));default:return n.stream.end(),n.emit("error",new Error("There was an error\
 establishing an SSL connection"))}var u=(ca(),X(ua));let c={socket:n.stream};n.
...
e.on("end",()=>{this.emit("end")}),rh(e,t=>{var n=t.name==="error"?"errorMessage":
...
this._send(nh)}ref(){this.stream.ref()}unref(){this.stream.unref()}end(){if(this.
_ending=!0,!this._connecting||!this.stream.writable){this.stream.end();return}return this.
stream.write(ih,()=>{this.stream.end()})}close(e){this._send(te.close(e))}describe(e){
this._send(te.describe(e))}sendCopyFromChunk(e){this._send(te.copyData(e))}endCopyFrom(){
this._send(te.copyDone())}sendCopyFail(e){this._send(te.copyFail(e))}};fa.exports=
Un});var ya=P((gp,pa)=>{"use strict";y();var sh=Ue().EventEmitter,mp=(ft(),X(ht)),ah=xt(),
Pn=As(),oh=Ns(),uh=Zr(),ch=Vt(),da=Js(),lh=bt(),hh=In(),er=class extends sh{static{
o(this,"Client")}constructor(e){super(),this.connectionParameters=new ch(e),this.
...
replication;var t=e||{};this._Promise=t.Promise||_.Promise,this._types=new uh(t.
types),this._ending=!1,this._connecting=!1,this._connected=!1,this._connectionError=
!1,this._queryable=!0,this.connection=t.connection||new hh({stream:t.stream,ssl:this.
...
"utf8"}),this.queryQueue=[],this.binary=t.binary||lh.binary,this.processID=null,
...
"error",n)}):this.password!==null?e():oh(this.connectionParameters,n=>{n!==void 0&&
...
this._checkPgPass(()=>{let t=ah.postgresMd5PasswordHash(this.user,this.password,
...
_Promise(t=>{this.connection.once("end",t)})}};er.Query=da;pa.exports=er});var Sa=P((bp,ga)=>{"use strict";y();var fh=Ue().EventEmitter,wa=o(function(){},"\
...
this.callback=e}};function dh(){throw new Error("Release called on client which \
has already been released to the pool.")}o(dh,"throwOnDoubleRelease");function tr(r,e){
...
callback:i,result:s}}o(tr,"promisify");function ph(r,e){return o(function t(n){n.
...
idleListener")}o(ph,"makeIdleListener");var Rn=class extends fh{static{o(this,"P\
...
this._clients.push(t);let n=ph(this,t);this.log("checking client timeout");let i,
...
e,e.release)}_releaseOnce(e,t){let n=!1;return i=>{n&&dh(),n=!0,this._release(e,
...
length}};ga.exports=Rn});var Ea={};fe(Ea,{default:()=>yh});var yh,ba=oe(()=>{"use strict";y();yh={}});var xa=P((Cp,wh)=>{wh.exports={name:"pg",version:"8.8.0",description:"PostgreSQL\
...
7b9a5491a178655"}});var Ca=P((_p,va)=>{"use strict";y();var Aa=Ue().EventEmitter,mh=(ft(),X(ht)),Nn=xt(),
tt=va.exports=function(r,e,t){Aa.call(this),r=Nn.normalizeQueryConfig(r,e,t),this.
...
newListener",function(n){n==="row"&&(this._emitRowEvents=!0)}.bind(this))};mh.inherits(
tt,Aa);var gh={sqlState:"code",statementPosition:"position",messagePrimary:"mess\
...
if(e)for(var t in e){var n=gh[t]||t;r[n]=e[t]}this.callback?this.callback(r):this.
...
text,t)}});var Ua=P((Ip,Ta)=>{"use strict";y();var Sh=(ba(),X(Ea)),Eh=Zr(),Up=xa(),_a=Ue().
EventEmitter,bh=(ft(),X(ht)),xh=Vt(),La=Ca(),he=Ta.exports=function(r){_a.call(this),
r=r||{},this._Promise=r.Promise||_.Promise,this._types=new Eh(r.types),this.native=
new Sh({types:this._types}),this._queryQueue=[],this._ending=!1,this._connecting=
!1,this._connected=!1,this._queryable=!0;var e=this.connectionParameters=new xh(
...
e.port,this.namedQueries={}};he.Query=La;bh.inherits(he,_a);he.prototype._errorAllQueries=
...
"Connection terminated")),m.nextTick(()=>{e.emit("end"),r&&r()})}),t};he.prototype.
...
_types.getTypeParser(r,e)}});var Mn=P((Rp,Ia)=>{"use strict";y();Ia.exports=Ua()});var rr=P((Dp,vt)=>{"use strict";y();var Ah=ya(),vh=bt(),Ch=In(),_h=Sa(),{DatabaseError:Lh}=Tn(),
Th=o(r=>class extends _h{static{o(this,"BoundPool")}constructor(t){super(t,r)}},
"poolFactory"),Dn=o(function(r){this.defaults=vh,this.Client=r,this.Query=this.Client.
Query,this.Pool=Th(this.Client),this._pools=[],this.Connection=Ch,this.types=Et(),
this.DatabaseError=Lh},"PG");typeof m.env.NODE_PG_FORCE_NATIVE<"u"?vt.exports=new Dn(
Mn()):(vt.exports=new Dn(Ah),Object.defineProperty(vt.exports,"native",{configurable:!0,
enumerable:!1,get(){var r=null;try{r=new Dn(Mn())}catch(e){if(e.code!=="MODULE_N\
OT_FOUND")throw e}return Object.defineProperty(vt.exports,"native",{value:r}),r}}))});y();var vr={};fe(vr,{SocketReadQueue:()=>eu,TrustedCert:()=>wi,WebSocketReadQueue:()=>Xo,
startTls:()=>Zo});y();function ie(...r){if(r.length===1&&r[0]instanceof Uint8Array)return r[0];let e=r.
...
ui=new TextEncoder,Io=new TextDecoder,Ee=class{static{o(this,"N")}offset;dataView;data;comments;indents;indent;constructor(r){
...
${gr.repeat(t)}`)}return e}};function Po(r,e,t,n=!0){let i=new Ee(1024);i.writeUint8(
...
0);if(n){i.writeUint16(0,0);let B=i.writeLengthUint16(0),k=i.writeLengthUint16(0);
i.writeUint8(0,0);let Q=i.writeLengthUint16(0);i.writeUTF8String(r),Q(),k(),B()}
i.writeUint16(11,0);let f=i.writeLengthUint16(0),d=i.writeLengthUint8(0);i.writeUint8(
0,0),d(),f(),i.writeUint16(10,0);let S=i.writeLengthUint16(0),b=i.writeLengthUint16(
0);i.writeUint16(23,0),b(),S(),i.writeUint16(13,0);let C=i.writeLengthUint16(0),
x=i.writeLengthUint16(0);i.writeUint16(1027,0),i.writeUint16(2052,0),x(),C(),i.writeUint16(
43,0);let U=i.writeLengthUint16(0),E=i.writeLengthUint8(0);i.writeUint16(772,0),
E(),U(),i.writeUint16(51,0);let g=i.writeLengthUint16(0),v=i.writeLengthUint16(0);
i.writeUint16(23,0);let N=i.writeLengthUint16(0);return i.writeBytes(new Uint8Array(
e)),N(),v(),g(),h(),a(),s(),i}o(Po,"St");function Le(r,e=""){return[...r].map(t=>t.
toString(16).padStart(2,"0")).join(e)}o(Le,"K");function Bo(r,e){let t,n,[i]=r.expectLength(
...
o(Bo,"Ut");var Hh=new RegExp(`  .+|^(${gr})+`,"gm"),ut=16384,Ro=ut+1+255;async function Sr(r,e,t=ut){
...
o(Sr,"ht");async function Er(r,e,t){let n=await Sr(r,23,Ro);if(n===void 0)return;
...
toString(16).padStart(2,"0")})`);return l}}o(Er,"dt");async function No(r,e,t){let n=ie(
...
a,e,t);i.push(u)}return i}o(ci,"At");var F=A.subtle,pi=new TextEncoder;async function br(r,e,t){
let n=await F.importKey("raw",r,{name:"HMAC",hash:{name:`SHA-${t}`}},!1,["sign"]);
var i=new Uint8Array(await F.sign("HMAC",n,e));return i}o(br,"lt");async function Mo(r,e,t,n){
...
c=d}return a.subarray(0,t)}o(Mo,"ne");var li=pi.encode("tls13 ");async function se(r,e,t,n,i){
...
`SHA-${n}`,new Uint8Array(0)),b=new Uint8Array(S),C=await se(d,"derived",b,s,n),
x=await br(C,l,n),U=await se(x,"c hs traffic",f,s,n),E=await se(x,"s hs traffic",
f,s,n),g=await se(U,"key",new Uint8Array(0),i,n),v=await se(E,"key",new Uint8Array(
0),i,n),N=await se(U,"iv",new Uint8Array(0),12,n),B=await se(E,"iv",new Uint8Array(
0),12,n);return{serverHandshakeKey:v,serverHandshakeIV:B,clientHandshakeKey:g,clientHandshakeIV:N,
handshakeSecret:x,clientSecret:U,serverSecret:E}}o(Do,"Kt");async function Fo(r,e,t,n){
...
t),C=await se(f,"iv",new Uint8Array(0),12,t);return{serverApplicationKey:S,serverApplicationIV:C,
clientApplicationKey:d,clientApplicationIV:b}}o(Fo,"Tt");var Nt=class{static{o(this,
...
l=await F[this.mode](c,this.key,r);return new Uint8Array(l)}};function Mt(r){return r>
64&&r<91?r-65:r>96&&r<123?r-71:r>47&&r<58?r+4:r===43?62:r===47?63:r===61?64:void 0}
o(Mt,"yt");function qo(r){let e=r.length,t=0,n=0,i=64,s=64,a=64,u=64,c=new Uint8Array(
...
6|u;let l=s===64?0:a===64?2:u===64?1:0;return c.subarray(0,n-l)}o(qo,"Dt");var Dt=class extends Ee{static{
...
255)i=!0;else if(n===0)i=!1;else throw new Error(`Boolean has weird value: 0x${Le(
...
"mt");var yr=1,Ft=2,ne=48,Oo=49,He=6,ko=19,Qo=12,fi=23,wr=5,De=4,mr=3,$o=163,je=128,
...
r.expectUint8(He,0);let u=r.readASN1OID(),c=jo[u]??u,l=r.readUint8();if(l!==ko&&
l!==Qo)throw new Error(`Unexpected item type in certificate ${e}: 0x${Le([l])}`);
...
0);t.expectUint8(ne,0);let[C,x]=t.expectASN1Length(0),U=[];for(;x()>0;){let Y=t.
readUint8();if(Y===He){let M=t.readASN1OID();U.push(M)}else Y===wr&&t.expectUint8(
0,0)}C(),t.expectUint8(mr,0);let E=t.readASN1BitString();this.publicKey={identifiers:U,
data:E,all:t.data.subarray(S,t.offset)},b(),t.expectUint8($o,0);let[g]=t.expectASN1Length();
t.expectUint8(ne,0);let[v,N]=t.expectASN1Length(0);for(;N()>0;){t.expectUint8(ne,
...
let H=Ko(t,je);this.subjectAltNames=H.filter(W=>W.type===(2|je)).map(W=>W.name),
...
G=Ho(W),D=new Set(Vo.filter((K,q)=>G&1<<q));H(),this.keyUsage={critical:j,usages:D}}else if($===
...
t.expectUint8(ne,0);let[G,D]=t.expectASN1Length(),K;D()>0&&(t.expectUint8(yr,0),
K=t.readASN1Boolean());let q;if(D()>0){t.expectUint8(Ft,0);let R=t.readASN1Length(
...
skip(M(),0);Y()}v(),g(),s(),this.signedData=t.data.subarray(i,t.offset),t.expectUint8(
ne,0);let[B,k]=t.expectASN1Length(0);t.expectUint8(He,0);let Q=t.readASN1OID();if(k()>
0&&(t.expectUint8(wr,0),t.expectUint8(0,0)),B(),Q!==this.algorithm)throw new Error(
...
u=qo(a),c=new this(u);i.push(c)}return i}subjectAltNameMatchingHost(e){let t=/[.][^.]+[.][^.]+$/;
...
0),f=r.readBytes(h());l(),s();let d=o((x,U)=>x.length>U?x.subarray(x.length-U):x.
length<U?ie(new Uint8Array(U-x.length),x):x,"m"),S=n==="P-256"?32:48,b=ie(d(c,S),
d(f,S)),C=await F.importKey("spki",e,{name:"ECDSA",namedCurve:n},!1,["verify"]);
if(await F.verify({name:"ECDSA",hash:i},C,b,t)!==!0)throw new Error("ECDSA-SECP2\
...
g key curve");let U=new Dt(l.signature);await mi(U,f.publicKey.all,l.signedData,
x,b)}else if(l.algorithm==="1.2.840.113549.1.1.11"||l.algorithm==="1.2.840.11354\
9.1.1.12"){let b=l.algorithm==="1.2.840.113549.1.1.11"?"SHA-256":"SHA-384",C=await F.
importKey("spki",f.publicKey.all,{name:"RSASSA-PKCS1-v1_5",hash:b},!1,["verify"]);
if(await F.verify({name:"RSASSA-PKCS1-v1_5"},C,l.signature,l.signedData)!==!0)throw new Error(
"RSASSA_PKCS1-v1_5-SHA256 certificate verify failed")}else throw new Error("Unsu\
pported signing algorithm");if(d){a=!0;break}}return a}o(zo,"jt");var Jo=new TextEncoder;
...
readUint16(0);if(R===0)u.expectUint16(0,0);else if(R===10){let[Z,pe]=u.expectLengthUint16(
"groups data");u.skip(pe(),0),Z()}else throw new Error(`Unsupported server encry\
pted extension type 0x${Le([R]).padStart(4,"0")}`)}l(),c(),u.remaining()===0&&u.
extend(await e());let f=!1,d=u.readUint8();if(d===13){f=!0;let[R]=u.expectLengthUint24(
"certificate request data");u.expectUint8(0,0);let[Z,pe]=u.expectLengthUint16("c\
ertificate request extensions");u.skip(pe(),0),Z(),R(),u.remaining()===0&&u.extend(
await e()),d=u.readUint8()}if(d!==11)throw new Error(`Unexpected handshake messa\
ge type 0x${Le([d])}`);let[S]=u.expectLengthUint24(0);u.expectUint8(0,0);let[b,C]=u.
expectLengthUint24(0),x=[];for(;C()>0;){let[R]=u.expectLengthUint24(0),Z=new Ar(
u);x.push(Z),R();let[pe,Ce]=u.expectLengthUint16(),Lt=u.subarray(Ce());pe()}if(b(),
S(),x.length===0)throw new Error("No certificates supplied");let U=x[0],E=u.data.
subarray(0,u.offset),g=ie(n,E),v=await F.digest("SHA-256",g),N=new Uint8Array(v),
B=ie(Jo.encode(" ".repeat(64)+"TLS 1.3, server CertificateVerify"),[0],N);u.remaining()===
0&&u.extend(await e()),u.expectUint8(15,0);let[k]=u.expectLengthUint24(0),Q=u.readUint16();
if(Q===1027){let[R]=u.expectLengthUint16();await mi(u,U.publicKey.all,B,"P-256",
"SHA-256"),R()}else if(Q===2052){let[R,Z]=u.expectLengthUint16(),pe=u.subarray(Z());
R();let Ce=await F.importKey("spki",U.publicKey.all,{name:"RSA-PSS",hash:"SHA-25\
6"},!1,["verify"]);if(await F.verify({name:"RSA-PSS",saltLength:32},Ce,pe,B)!==!0)
throw new Error("RSA-PSS-RSAE-SHA256 certificate verify failed")}else throw new Error(
`Unsupported certificate verify signature type 0x${Le([Q]).padStart(4,"0")}`);k();
let Y=u.data.subarray(0,u.offset),M=ie(n,Y),$=await se(t,"finished",new Uint8Array(
0),32,256),j=await F.digest("SHA-256",M),H=await F.importKey("raw",$,{name:"HMAC",
hash:{name:"SHA-256"}},!1,["sign"]),W=await F.sign("HMAC",H,j),G=new Uint8Array(
...
0),q=u.readBytes(K());if(D(),u.remaining()!==0)throw new Error("Unexpected extra\
 bytes in server handshake");if(ct(q,G)!==!0)throw new Error("Invalid server ver\
ify hash");if(!await zo(r,x,i,s,a))throw new Error("Validated certificate chain \
...
"raw",h.publicKey),d=new Uint8Array(32);A.getRandomValues(d);let S=Po(r,f,d,i).array(),
b=u?ie(u,S):S;if(n(b),c){let re=await t(c.length);if(!re||!ct(re,c))throw new Error(
"Pre data did not match expectation")}let C=await Sr(t,22);if(C===void 0)throw new Error(
"Connection closed while awaiting server hello");let x=new Ee(C.content),U=Bo(x,
d),E=await Sr(t,20);if(E===void 0)throw new Error("Connection closed awaiting se\
rver cipher change");let g=new Ee(E.content),[v]=g.expectLength(1);g.expectUint8(
1,0),v();let N=S.subarray(5),B=C.content,k=ie(N,B),Q=await Do(U,h.privateKey,k,256,
16),Y=await F.importKey("raw",Q.serverHandshakeKey,{name:"AES-GCM"},!1,["decrypt"]),
M=new Nt("decrypt",Y,Q.serverHandshakeIV),$=await F.importKey("raw",Q.clientHandshakeKey,
...
ed server handshake");return re},"C"),[W,G]=await Yo(r,H,Q.serverSecret,k,e,s,a),
...
0,0),re.writeUint24(0,0),it(),R=re.array()}let Z=ie(k,W,R),pe=await F.digest("SH\
A-256",Z),Ce=new Uint8Array(pe),Lt=await se(Q.clientSecret,"finished",new Uint8Array(
0),32,256),Da=await F.importKey("raw",Lt,{name:"HMAC",hash:{name:"SHA-256"}},!1,
["sign"]),Fa=await F.sign("HMAC",Da,Ce),qa=new Uint8Array(Fa),Tt=new Ee(36);Tt.writeUint8(
20,0);let Oa=Tt.writeLengthUint24(0);Tt.writeBytes(qa),Oa();let ka=Tt.array(),Fn=await ci(
ie(R,ka),j,22),qn=Ce;if(R.length>0){let re=Z.subarray(0,Z.length-R.length),it=await F.
digest("SHA-256",re);qn=new Uint8Array(it)}let Ut=await Fo(Q.handshakeSecret,qn,
256,16),Qa=await F.importKey("raw",Ut.clientApplicationKey,{name:"AES-GCM"},!0,[
"encrypt"]),$a=new Nt("encrypt",Qa,Ut.clientApplicationIV),ja=await F.importKey(
"raw",Ut.serverApplicationKey,{name:"AES-GCM"},!0,["decrypt"]),Ha=new Nt("decryp\
t",ja,Ut.serverApplicationIV),It=!1;return[()=>{if(!It){let re=ie(q,...Fn);n(re),
It=!0}return Er(t,Ha)},async re=>{let it=It;It=!0;let On=await ci(re,$a,23),Ka=it?
ie(...On):ie(q,...Fn,...On);n(Ka)}]}o(Zo,"he");var gi=class{static{o(this,"xt")}queue;outstandingRequest;constructor(){
...
-----END CERTIFICATE-----
`;y();var ru=Object.getOwnPropertyNames,nu=Object.getOwnPropertySymbols,iu=Object.prototype.
...
function bi(r){return ru(r).concat(nu(r))}o(bi,"getStrictProperties");var Ti=Object.
...
b=u.value,C=b[0],x=b[1];!l&&!n[h]&&(l=t.equals(d,C,s,h,r,e,t)&&t.equals(S,x,d,C,
r,e,t))&&(n[h]=!0),h++}if(!l)return!1;s++}return!0}o(vi,"areMapsEqual");function ou(r,e,t){
...
l++;if(!c)return!1}return!0}o(Ci,"areSetsEqual");function lu(r,e){var t=r.length;
...
h,f,d);if(Eu(h))return e(h,f,d);if(_i!=null&&_i(h))return c(h,f,d);if(S===Date)return t(
h,f,d);if(S===RegExp)return a(h,f,d);if(S===Map)return n(h,f,d);if(S===Set)return u(
h,f,d);var b=bu(h);return b===du?t(h,f,d):b===mu?a(h,f,d):b===pu?n(h,f,d):b===gu?
u(h,f,d):b===wu?typeof h.then!="function"&&typeof f.then!="function"&&i(h,f,d):b===
hu?i(h,f,d):b===fu||b===yu||b===Su?s(h,f,d):!1},"comparator")}o(xu,"createEquali\
...
areTypedArraysEqual:n?lt:lu};if(t&&(i=Li({},i,t(i))),e){var s=qt(i.areArraysEqual),
...
var Cr=Te(),tf=Te({strict:!0}),rf=Te({circular:!0}),nf=Te({circular:!0,strict:!0}),
sf=Te({createInternalComparator:function(){return Ke}}),af=Te({strict:!0,createInternalComparator:function(){
return Ke}}),of=Te({circular:!0,createInternalComparator:function(){return Ke}}),
uf=Te({circular:!0,createInternalComparator:function(){return Ke},strict:!0});function Te(r){
r===void 0&&(r={});var e=r.circular,t=e===void 0?!1:e,n=r.createInternalComparator,
i=r.createState,s=r.strict,a=s===void 0?!1:s,u=Au(r),c=xu(u),l=n?n(c):vu(c);return Cu(
{circular:t,comparator:c,createState:i,equals:l,strict:a})}o(Te,"createCustomEqu\
al");y();var nr=at(rr());zt();y();en();zt();var Ra=at(xt());var Fe=class extends Error{static{o(this,"NeonDbError")}name="NeonDbError";code=null;sourceError},
Pa="transaction() expects an array of queries, or a function returning an array \
of queries";function be(r,{arrayMode:e,fullResults:t,fetchOptions:n,isolationLevel:i,
...
r))}let{protocol:h,username:f,password:d,hostname:S,port:b,pathname:C}=l;if(h!==
"postgres:"&&h!=="postgresql:"||!f||!d||!S||!C)throw new Error("Database connect\
ion string format for `neon()` should be: postgresql://user:password@host.tld/db\
name?option=value");function x(E,...g){let v,N;if(typeof E=="string")v=E,N=g[1],
g=g[0]??[];else{v="";for(let k=0;k<E.length;k++)v+=E[k],k<g.length&&(v+="$"+(k+1))}
g=g.map(k=>(0,Ra.prepareValue)(k));let B={query:v,params:g};return u&&u(B),Uh(U,
B,N)}o(x,"resolve"),x.transaction=async(E,g)=>{if(typeof E=="function"&&(E=E(x)),
!Array.isArray(E))throw new Error(Pa);E.forEach(B=>{if(B[Symbol.toStringTag]!=="\
NeonQueryPromise")throw new Error(Pa)});let v=E.map(B=>B.parameterizedQuery),N=E.
map(B=>B.opts??{});return U(v,N,g)};async function U(E,g,v){let{fetchEndpoint:N,
fetchFunction:B}=de,k=typeof N=="function"?N(S,b):N,Q=Array.isArray(E)?{queries:E}:
E,Y=n??{},M=e??!1,$=t??!1,j=i,H=s,W=a;v!==void 0&&(v.fetchOptions!==void 0&&(Y={
...Y,...v.fetchOptions}),v.arrayMode!==void 0&&(M=v.arrayMode),v.fullResults!==void 0&&
($=v.fullResults),v.isolationLevel!==void 0&&(j=v.isolationLevel),v.readOnly!==void 0&&
(H=v.readOnly),v.deferrable!==void 0&&(W=v.deferrable)),g!==void 0&&!Array.isArray(
g)&&g.fetchOptions!==void 0&&(Y={...Y,...g.fetchOptions});let G={"Neon-Connectio\
...
try{D=await(B??fetch)(k,{method:"POST",body:JSON.stringify(Q),headers:G,...Y})}catch(K){
...
let pe=g[Z]??{},Ce=pe.arrayMode??M,Lt=pe.fullResults??$;return Ba(R,{arrayMode:Ce,
fullResults:Lt,parameterizedQuery:E[Z],resultCallback:c})})}else{let q=g??{},R=q.
arrayMode??M,Z=q.fullResults??$;return Ba(K,{arrayMode:R,fullResults:Z,parameterizedQuery:E,
resultCallback:c})}}else{let{status:K}=D;if(K===400){let{message:q,code:R}=await D.
json(),Z=new Fe(q);throw Z.code=R,Z}else{let q=await D.text();throw new Fe(`Serv\
er error (HTTP status ${K}): ${q}`)}}}return o(U,"execute"),x}o(be,"neon");function Uh(r,e,t){
return{[Symbol.toStringTag]:"NeonQueryPromise",parameterizedQuery:e,opts:t,then:(n,i)=>r(
e,t).then(n,i),catch:n=>r(e,t).catch(n),finally:n=>r(e,t).finally(n)}}o(Uh,"crea\
teNeonQueryPromise");function Ba(r,{arrayMode:e,fullResults:t,parameterizedQuery:n,
resultCallback:i}){let s=r.fields.map(c=>c.name),a=r.fields.map(c=>Be.types.getTypeParser(
c.dataTypeID)),u=e===!0?r.rows.map(c=>c.map((l,h)=>l===null?null:a[h](l))):r.rows.
map(c=>Object.fromEntries(c.map((l,h)=>[s[h],l===null?null:a[h](l)])));return i&&
i(n,r,u,{arrayMode:e,fullResults:t}),t?(r.viaNeonFetch=!0,r.rowAsArray=e,r.rows=
u,r):u}o(Ba,"processQueryResult");var Na=at(Vt()),Be=at(rr());var ve=class extends nr.Client{constructor(t){super(t);this.config=t}static{o(this,
...
S=d.encode(i),b=await A.subtle.importKey("raw",S,{name:"HMAC",hash:{name:"SHA-25\
6"}},!1,["sign"]),C=new Uint8Array(await A.subtle.sign("HMAC",b,w.concat([f,w.from(
[0,0,0,1])]))),x=C;for(var U=0;U<h-1;U++)C=new Uint8Array(await A.subtle.sign("H\
MAC",b,C)),x=w.from(x.map((q,R)=>x[R]^C[R]));let E=x,g=await A.subtle.importKey(
"raw",E,{name:"HMAC",hash:{name:"SHA-256"}},!1,["sign"]),v=new Uint8Array(await A.
subtle.sign("HMAC",g,d.encode("Client Key"))),N=await A.subtle.digest("SHA-256",
v),B="n=*,r="+n.clientNonce,k="r="+u+",s="+c+",i="+h,Q="c=biws,r="+u,Y=B+","+k+"\
,"+Q,M=await A.subtle.importKey("raw",N,{name:"HMAC",hash:{name:"SHA-256"}},!1,[
"sign"]);var $=new Uint8Array(await A.subtle.sign("HMAC",M,d.encode(Y))),j=w.from(
v.map((q,R)=>v[R]^$[R])),H=j.toString("base64");let W=await A.subtle.importKey("\
raw",E,{name:"HMAC",hash:{name:"SHA-256"}},!1,["sign"]),G=await A.subtle.sign("H\
MAC",W,d.encode("Server Key")),D=await A.subtle.importKey("raw",G,{name:"HMAC",hash:{
...
Ih,"promisify");var qe=class extends nr.Pool{static{o(this,"NeonPool")}Client=ve;hasFetchUnsupportedListeners=!1;on(e,t){
...
array"})(l,h).then(d=>n(void 0,d)).catch(d=>n(d))}catch(s){n(s)}return i.result}};y();async function Ph(r){let e=Date.now(),t=await r();return[Date.now()-e,t]}o(Ph,"t\
...
nt,"clientRunQuery");async function ir(r,e,t,n){let i=new qe({connectionString:e}),
s=await rt(r,()=>Ct(i,n));return t.waitUntil(i.end()),s}o(ir,"poolRunQuery");async function Ma(r,e,t,n){
let i=be(e,{fullResults:!0});return await rt(r,()=>Ct(i,n))}o(Ma,"httpRunQuery");y();var _t=[{sql:"SELECT * FROM employees LIMIT 10",test:r=>r.length>1&&typeof r[0].
first_name=="string"},{sql:"SELECT now()",test:r=>/^2\d\d\d-\d\d-\d\dT\d\d:\d\d:\d\d.\d+Z$/.
test(r[0].now.toISOString())}];async function l0(r,e,t){let n=[];for(let i of _t){let[,[[,s]]]=await ir(1,e.NEON_DB_URL,
...
ation/json"}})}o(l0,"cf");var Re={waitUntil(r){},passThroughOnException(){}};async function Bh(r,e=(...t)=>{}){
...
[s],[a]]=await t.transaction(v=>[v`SELECT ${1}::int AS "batchInt"`,v`SELECT ${"h\
...
transaction(v=>[]);e("empty txn result:",JSON.stringify(u),`
`);let[[[c]],[[l]]]=await t.transaction(v=>[v`SELECT ${1}::int AS "batchInt"`,v`SELECT ${"\
...
v=>[v`SELECT ${1}::int AS "batchInt"`,v`SELECT ${"hello"} AS "batchStr"`]);if(e(
"array mode (via neon options) batch results:",JSON.stringify(f),JSON.stringify(
d),`
`),f!==1||d!=="hello")throw new Error("Batch query problem");let S=be(r.NEON_DB_URL,
{arrayMode:!0}),[[b],[C]]=await S.transaction(v=>[v`SELECT ${1}::int AS "batchInt"`,
v`SELECT ${"hello"} AS "batchStr"`],{arrayMode:!1});if(e("ordinary (via overridd\
en options) batch results:",JSON.stringify(b),JSON.stringify(C),`
`),b.batchInt!==1||C.batchStr!=="hello")throw new Error("Batch query problem");let[
[x],[U]]=await t.transaction(v=>[v`SELECT ${1}::int AS "batchInt"`,v('SELECT $1 \
AS "batchStr"',["hello"],{arrayMode:!0})]);if(e("ignored query options batch res\
ults:",JSON.stringify(x),JSON.stringify(U),`
`),x.batchInt!==1||U.batchStr!=="hello")throw new Error("Batch query problem");let E;
try{await t.transaction(v=>[v`SELECT ${1}::int AS "batchInt"`,`SELECT 'hello' AS\
 "batchStr"`])}catch(v){E=v}if(E===void 0)throw new Error("Error should have bee\
n raised for string passed to `transaction()`");e("caught invalid query passed t\
o `transaction()`\n");let g;try{let v=r.NEON_DB_URL.replace(/@/,"x@");await be(v).
transaction(N=>[N`SELECT 'never' AS this_should_be_seen_precisely`])}catch(v){g=
v}if(g===void 0)throw new Error("Error should have been raised for bad password");
e("caught invalid password passed to `neon()`\n")}o(Bh,"batchQueryTest");async function h0(r,e,t=(...n)=>{}){
let n=[1,3],i=9;t(`Warm-up ...

`),await ir(1,r.NEON_DB_URL,Re,_t[0]);let s=0;t(`
===== SQL-over-HTTP tests =====

`);let a=new Set(["command","rowCount","rows","fields"]),u=await new qe({connectionString:r.
NEON_DB_URL}),c=be(r.NEON_DB_URL,{resultCallback:async(d,S,b,C)=>{let x=await u.
query({text:d.query,values:d.params,...C.arrayMode?{rowMode:"array"}:{}}),U=S.command===
x.command,E=S.rowCount===x.rowCount,g=Cr(S.fields.map(B=>B.dataTypeID),x.fields.
map(B=>B.dataTypeID)),v=Cr(b,x.rows);t(U&&E&&v&&g?"\u2713":"X",JSON.stringify(d),
`
  -> us:`,JSON.stringify(b),`
...
hello"} AS str`,await c`SELECT ${"world"} AS str`,await c("SELECT 123 AS num");function h(d,S,b=3){
return async function(C,...x){let U="";for(let E=0;E<C.length;E++)U+=C[E],E<x.length&&
(U+="$"+(E+1));for(let E=1;;E++){let g=new AbortController,v=setTimeout(()=>g.abort(
"fetch timed out"),S);try{let{signal:N}=g;return await d(U,x,{fetchOptions:{signal:N}})}catch(N){
if(!(N.sourceError&&N.sourceError instanceof DOMException&&N.sourceError.name===
"AbortError")||E>=b)throw N}finally{clearTimeout(v)}}}}o(h,"sqlWithRetries"),await h(
c,5e3)`SELECT ${"did this time out?"} AS str`,await Bh(r,t),de.fetchFunction=(d,S)=>(console.
...
`);async function S(C,x){let U=String.fromCharCode(s+(s>25?23:65));t(`${U}
`);try{await fetch(`http://localhost:443/${U}`)}catch{}t('<span class="live">Liv\
e:</span>    ');let[,E]=await rt(i,()=>x(C),g=>t(`<span class="live">${g.toFixed()}\
ms</span> `));t(`
Sorted:  `),E.map(([g])=>g).sort((g,v)=>g-v).forEach((g,v)=>{t(v===(i-1)/2?`<spa\
n class="median">${g.toFixed()}ms</span> `:`${g.toFixed()}ms `)}),t(`

`),s+=1}o(S,"section");async function b(C,x){t(`----- ${C} -----

`);for(let U of n)t(`${U} quer${U===1?"y":"ies"} \u2013 `),await S(U,x)}o(b,"sec\
tions"),await b("Neon/wss, no pipelining",async C=>{let x=new ve(r.NEON_DB_URL);
x.neonConfig.pipelineConnect=!1,await nt(C,x,Re,d)}),await b("Neon/wss, pipeline\
d connect (default)",async C=>{let x=new ve(r.NEON_DB_URL);await nt(C,x,Re,d)}),
await b("Neon/wss, pipelined connect, no coalescing",async C=>{let x=new ve(r.NEON_DB_URL);
x.neonConfig.coalesceWrites=!1,await nt(C,x,Re,d)}),await b("Neon/wss, pipelined\
 connect using Pool.query",async C=>{await ir(C,r.NEON_DB_URL,Re,d)}),await b("N\
eon/wss, pipelined connect using Pool.connect",async C=>{let x=new qe({connectionString:r.
NEON_DB_URL}),U=await x.connect();await rt(C,()=>Ct(U,d)),U.release(),Re.waitUntil(
x.end())}),await b("Patched pg/wss, pipelined connect [currently broken, since p\
roxy is down]",async C=>{let x=new ve(r.MY_DB_URL);x.neonConfig.wsProxy=(U,E)=>`\
ws.manipulexity.com/v1?address=${U}:${E}`,x.neonConfig.pipelineConnect="password";
try{await nt(C,x,Re,d)}catch(U){console.error(`
*** ${U.message}`)}}),e&&(de.subtls=vr,de.rootCerts=Si,await b("Patched pg/subtl\
s, pipelined TLS + connect [currently broken, since proxy is down]",async C=>{let x=new ve(
r.MY_DB_URL);x.neonConfig.wsProxy=(U,E)=>`ws.manipulexity.com/v1?address=${U}:${E}`,
x.neonConfig.forceDisablePgSSL=x.neonConfig.useSecureWebSocket=!1,x.neonConfig.pipelineTLS=
!0,x.neonConfig.pipelineConnect="password";try{await nt(C,x,Re,d)}catch(U){console.
error(`
*** ${U.message}`)}}))}}o(h0,"latencies");export{Bh as batchQueryTest,l0 as cf,h0 as latencies,de as neonConfig};
