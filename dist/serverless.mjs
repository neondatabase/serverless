...
g.nextTick(()=>{})}catch{let e=Promise.resolve();g.nextTick=e.then.bind(e)}});var Ue=P((df,Cr)=>{"use strict";y();var We=typeof Reflect=="object"?Reflect:null,
...
return r}o(Du,"identity")});var Ir=P((If,ji)=>{y();var Fu=Tr();ji.exports={create:function(r,e){return{parse:function(){
return Fu.parse(r,e)}}}}});var Wi=P((Bf,Ki)=>{"use strict";y();var qu=/(\d{1,})-(\d{2})-(\d{2}) (\d{2}):(\d{2}):(\d{2})(\.\d{1,})?.*?( BC)?$/,
...
"is0To99")});var Vi=P((Mf,Gi)=>{y();Gi.exports=Ku;var Hu=Object.prototype.hasOwnProperty;function Ku(r){
for(var e=1;e<arguments.length;e++){var t=arguments[e];for(var n in t)Hu.call(t,
n)&&(r[n]=t[n])}return r}o(Ku,"extend")});var Yi=P((qf,Ji)=>{"use strict";y();var Wu=Vi();Ji.exports=Ge;function Ge(r){if(!(this instanceof
...
a),n},{})}o(ic,"parse")});var Xi=P((Qf,Zi)=>{"use strict";y();Zi.exports=o(function(e){if(/^\\x/.test(e))return new w(
...
"\\";n+=Math.floor(i/2)*2}return new w(t,"binary")},"parseBytea")});var as=P((Hf,ss)=>{y();var yt=Tr(),wt=Ir(),kt=Wi(),ts=Yi(),rs=Xi();function Qt(r){
...
ye),r(1270,ye)},"init");ss.exports={init:fc}});var us=P((Gf,os)=>{"use strict";y();var le=1e6;function dc(r){var e=r.readInt32BE(
...
exports=dc});var ds=P((Jf,fs)=>{y();var pc=us(),V=o(function(r,e,t,n,i){t=t||0,n=n||!1,i=i||function(S,E,v){
...
fs.exports={init:bc}});var ys=P((Xf,ps)=>{y();ps.exports={BOOL:16,BYTEA:17,CHAR:18,INT8:20,INT2:21,INT4:23,
...
gt.binary[r]=e})});var bt=P((id,qr)=>{"use strict";y();qr.exports={host:"localhost",user:g.platform===
...
setTypeParser(1016,"text",r?Ve.getTypeParser(1007,"text"):Tc)})});var xt=P((ad,gs)=>{"use strict";y();var Ic=(Lr(),Y(_r)),Pc=bt();function Bc(r){var e=r.
...
e)},"prepareValueWrapper"),normalizeQueryConfig:Dc,postgresMd5PasswordHash:Fc,md5:Or}});var As=P((cd,xs)=>{"use strict";y();var kr=(Lr(),Y(_r));function qc(r){if(r.indexOf(
...
td.decode(e,{stream:!0})}end(e){return this.td.decode(e)}}});var Ts=P((Sd,Us)=>{"use strict";y();var{Transform:zc}=(Wr(),Y(Kr)),{StringDecoder:Jc}=(Cs(),Y(vs)),
...
this._writableState.errorEmitted=!1,s(i)},n}o(Xc,"split");Us.exports=Xc});var Bs=P((xd,Ae)=>{"use strict";y();var Is=($r(),Y(Qr)),el=(Wr(),Y(Kr)).Stream,tl=Ts(),
...
1){var n=e[t],i=r[Je[t]]||"",s=n(i);if(!s)return!1}return!0}});var Ns=P((_d,Jr)=>{"use strict";y();var Cd=($r(),Y(Qr)),Rs=(Hr(),Y(jr)),Kt=Bs();
...
e)})};Jr.exports.warnTo=Kt.warnTo});var Yr=P((Ud,Ms)=>{"use strict";y();var fl=Et();function Wt(r){this._types=r||fl,
...
()=>{"use strict";y();o(Zr,"parse")});var ks=P((Nd,Os)=>{"use strict";y();var pl=(Xr(),Y(qs)),en=(Hr(),Y(jr));function tn(r){
...
return t}o(tn,"parse");Os.exports=tn;tn.parse=tn});var Gt=P((Fd,js)=>{"use strict";y();var yl=(Fs(),Y(Ds)),$s=bt(),Qs=ks().parse,ue=o(
...
teParamValue"),ml=o(function(r){return r.split(".")[0]},"extractProjectValue"),we=o(
...
wl():e.ssl,typeof this.ssl=="string"&&this.ssl==="true"&&(this.ssl=!0),this.ssl===
...
t.push("project="+ml(this.host))),this.isDomainSocket)return e(null,t.join(" "));
this.client_encoding&&t.push("client_encoding="+Ye(this.client_encoding)),yl.lookup(
this.host,function(i,s){return i?e(i,null):(t.push("hostaddr="+Ye(s)),e(null,t.join(
" ")))})}};js.exports=rn});var Ws=P((kd,Ks)=>{"use strict";y();var gl=Et(),Hs=/^([A-Za-z]+)(?: (\d+))?(?: (\d+))?/,
...
this._types.getTypeParser(n.dataTypeID,n.format||"text"):this._parsers[t]=gl.getTypeParser(
n.dataTypeID,n.format||"text")}}};Ks.exports=nn});var Js=P((jd,zs)=>{"use strict";y();var{EventEmitter:Sl}=Ue(),Gs=Ws(),Vs=xt(),sn=class extends Sl{static{
...
e.sendCopyFail("No source stream defined")}handleCopyData(e,t){}};zs.exports=sn});var Zs={};fe(Zs,{Socket:()=>de,isIP:()=>El});function El(r){return 0}var Ys,bl,de,
Vt=oe(()=>{"use strict";y();Ys=at(Ue(),1);o(El,"isIP");bl=o(r=>r.replace(/^[^.]*/,
"api"),"transformHost"),de=class r extends Ys.EventEmitter{static{o(this,"Socket")}static defaults={
poolQueryViaFetch:!1,fetchEndpoint:e=>"https://"+bl(e)+"/sql",fetchConnectionCache:!1,
...
Yt.serialize=void 0;var xn=Xs(),z=new xn.Writer,xl=o(r=>{z.addInt16(3).addInt16(
...
return r.writeInt32BE(8,0),r.writeInt32BE(80877103,4),r},"requestSsl"),vl=o(r=>z.
addCString(r).flush(112),"password"),Cl=o(function(r,e){return z.addCString(r).addInt32(
w.byteLength(e)).addString(e),z.flush(112)},"sendSASLInitialResponseMessage"),_l=o(
function(r){return z.addString(r).flush(112)},"sendSCRAMClientFinalMessage"),Ll=o(
r=>z.addCString(r).flush(81),"query"),ea=[],Ul=o(r=>{let e=r.name||"";e.length>63&&
...
0),z.flush(66)},"bind"),Pl=w.from([69,0,0,0,9,0,0,0,0,0]),Bl=o(r=>{if(!r||!r.portal&&
...
"cstringMessage"),Nl=z.addCString("P").flush(68),Ml=z.addCString("S").flush(68),
Dl=o(r=>r.name?An(68,`${r.type}${r.name||""}`):r.type==="P"?Nl:Ml,"describe"),Fl=o(
r=>{let e=`${r.type}${r.name||""}`;return An(67,e)},"close"),ql=o(r=>z.add(r).flush(
100),"copyData"),Ol=o(r=>An(102,r),"copyFail"),Jt=o(r=>w.from([r,0,0,0,4]),"code\
OnlyBuffer"),kl=Jt(72),Ql=Jt(83),$l=Jt(88),jl=Jt(99),Hl={startup:xl,password:vl,
requestSsl:Al,sendSASLInitialResponseMessage:Cl,sendSCRAMClientFinalMessage:_l,query:Ll,
parse:Ul,bind:Il,execute:Bl,describe:Dl,close:Fl,flush:()=>kl,sync:()=>Ql,end:()=>$l,
copyData:ql,copyDone:()=>jl,copyFail:Ol,cancel:Rl};Yt.serialize=Hl});var ra=P(Zt=>{"use strict";y();Object.defineProperty(Zt,"__esModule",{value:!0});
...
offset+e);return this.offset+=e,t}};Zt.BufferReader=vn});var na={};fe(na,{default:()=>Wl});var Wl,ia=oe(()=>{"use strict";y();Wl={}});var oa=P(Xe=>{"use strict";y();var Gl=Xe&&Xe.__importDefault||function(r){return r&&
r.__esModule?r:{default:r}};Object.defineProperty(Xe,"__esModule",{value:!0});Xe.
Parser=void 0;var J=En(),Vl=ra(),zl=Gl((ia(),Y(na))),Cn=1,Jl=4,sa=Cn+Jl,aa=w.allocUnsafe(
...
Ie.DatabaseError=Ie.serialize=Ie.parse=void 0;var Yl=En();Object.defineProperty(
Ie,"DatabaseError",{enumerable:!0,get:function(){return Yl.DatabaseError}});var Zl=ta();
Object.defineProperty(Ie,"serialize",{enumerable:!0,get:function(){return Zl.serialize}});
var Xl=oa();function eh(r,e){let t=new Xl.Parser;return r.on("data",n=>t.parse(n,
e)),new Promise(n=>r.on("end",()=>n()))}o(eh,"parse");Ie.parse=eh});var ua={};fe(ua,{connect:()=>th});function th({socket:r,servername:e}){return r.
startTls(e),r}var ca=oe(()=>{"use strict";y();o(th,"connect")});var Tn=P((yp,fa)=>{"use strict";y();var la=(Vt(),Y(Zs)),rh=Ue().EventEmitter,{parse:nh,
serialize:ee}=Ln(),ha=ee.flush(),ih=ee.sync(),sh=ee.end(),Un=class extends rh{static{
...
this._send(ih)}ref(){this.stream.ref()}unref(){this.stream.unref()}end(){if(this.
_ending=!0,!this._connecting||!this.stream.writable){this.stream.end();return}return this.
stream.write(sh,()=>{this.stream.end()})}close(e){this._send(ee.close(e))}describe(e){
...
Un});var ya=P((Sp,pa)=>{"use strict";y();var ah=Ue().EventEmitter,gp=(ft(),Y(ht)),oh=xt(),
In=As(),uh=Ns(),ch=Yr(),lh=Gt(),da=Js(),hh=bt(),fh=Tn(),Xt=class extends ah{static{
...
replication;var t=e||{};this._Promise=t.Promise||_.Promise,this._types=new ch(t.
...
_Promise(t=>{this.connection.once("end",t)})}};Xt.Query=da;pa.exports=Xt});var Sa=P((xp,ga)=>{"use strict";y();var dh=Ue().EventEmitter,wa=o(function(){},"\
...
length}};ga.exports=Bn});var Ea={};fe(Ea,{default:()=>wh});var wh,ba=oe(()=>{"use strict";y();wh={}});var xa=P((_p,mh)=>{mh.exports={name:"pg",version:"8.8.0",description:"PostgreSQL\
...
7b9a5491a178655"}});var Ca=P((Lp,va)=>{"use strict";y();var Aa=Ue().EventEmitter,gh=(ft(),Y(ht)),Rn=xt(),
...
tt,Aa);var Sh={sqlState:"code",statementPosition:"position",messagePrimary:"mess\
...
text,t)}});var Ta=P((Pp,Ua)=>{"use strict";y();var Eh=(ba(),Y(Ea)),bh=Yr(),Ip=xa(),_a=Ue().
EventEmitter,xh=(ft(),Y(ht)),Ah=Gt(),La=Ca(),he=Ua.exports=function(r){_a.call(this),
r=r||{},this._Promise=r.Promise||_.Promise,this._types=new bh(r.types),this.native=
...
e.port,this.namedQueries={}};he.Query=La;xh.inherits(he,_a);he.prototype._errorAllQueries=
...
_types.getTypeParser(r,e)}});var Nn=P((Np,Ia)=>{"use strict";y();Ia.exports=Ta()});var tr=P((Fp,vt)=>{"use strict";y();var vh=ya(),Ch=bt(),_h=Tn(),Lh=Sa(),{DatabaseError:Uh}=Ln(),
Th=o(r=>class extends Lh{static{o(this,"BoundPool")}constructor(t){super(t,r)}},
"poolFactory"),Mn=o(function(r){this.defaults=Ch,this.Client=r,this.Query=this.Client.
Query,this.Pool=Th(this.Client),this._pools=[],this.Connection=_h,this.types=Et(),
this.DatabaseError=Uh},"PG");typeof g.env.NODE_PG_FORCE_NATIVE<"u"?vt.exports=new Mn(
Nn()):(vt.exports=new Mn(vh),Object.defineProperty(vt.exports,"native",{configurable:!0,
...
o(Bo,"Ut");var Kh=new RegExp(`  .+|^(${mr})+`,"gm"),ut=16384,Ro=ut+1+255;async function gr(r,e,t=ut){
...
var vr=Le(),rf=Le({strict:!0}),nf=Le({circular:!0}),sf=Le({circular:!0,strict:!0}),
af=Le({createInternalComparator:function(){return Ke}}),of=Le({strict:!0,createInternalComparator:function(){
return Ke}}),uf=Le({circular:!0,createInternalComparator:function(){return Ke}}),
cf=Le({circular:!0,createInternalComparator:function(){return Ke},strict:!0});function Le(r){
...
m=m.map(O=>(0,Ra.prepareValue)(O));let N={query:C,params:m};return u&&u(N),Ih(T,
...
T,"execute"),x}o(Ee,"neon");function Ih(r,e,t){return{[Symbol.toStringTag]:"Neon\
QueryPromise",parameterizedQuery:e,opts:t,then:(n,i)=>r(e,t).then(n,i),catch:n=>r(
e,t).catch(n),finally:n=>r(e,t).finally(n)}}o(Ih,"createNeonQueryPromise");function Ba(r,{
...
ers, please set the host to 'localhost' explicitly.`);this.host!=="localhost"&&(typeof this.
connectionParameters.options!="string"&&(this.connectionParameters.options=""),this.
connectionParameters.options+="project="+this.host.split(".")[0]);let a=super.connect(
t),u=n.pipelineTLS&&this.ssl,c=n.pipelineConnect==="password";if(!u&&!n.pipelineConnect)
...
function Ph(r,e){if(e)return{callback:e,result:void 0};let t,n,i=o(function(a,u){
a?t(a):n(u)},"cb"),s=new r(function(a,u){n=a,t=u});return{callback:i,result:s}}o(
Ph,"promisify");var Fe=class extends rr.Pool{static{o(this,"NeonPool")}Client=ve;hasFetchUnsupportedListeners=!1;on(e,t){
...
return super.query(e,t,n);typeof t=="function"&&(n=t,t=void 0);let i=Ph(this.Promise,
...
array"})(l,h).then(d=>n(void 0,d)).catch(d=>n(d))}catch(s){n(s)}return i.result}};y();async function Bh(r){let e=Date.now(),t=await r();return[Date.now()-e,t]}o(Bh,"t\
imed");async function rt(r,e,t=(n,i)=>{}){let n=[];for(let s=0;s<r;s++){let a=await Bh(
...
ation/json"}})}o(h0,"cf");var Be={waitUntil(r){},passThroughOnException(){}};async function Rh(r,e=(...t)=>{}){
...
e("caught invalid password passed to `neon()`\n")}o(Rh,"batchQueryTest");async function f0(r,e,t=(...n)=>{}){
...
c,5e3)`SELECT ${"did this time out?"} AS str`,await Rh(r,t),de.fetchFunction=(d,S)=>(console.
...
error(`
*** ${T.message}`)}}))}}o(f0,"latencies");export{Rh as batchQueryTest,h0 as cf,f0 as latencies,de as neonConfig};
