...
t")}static defaults={poolQueryViaFetch:!1,fetchEndpoint:e=>"https://"+bl(e)+"/sq\
...
let i=Ee(e,{fullResults:!0});return await rt(r,()=>Ct(i,n))}o(Ma,"httpRunQuery");y();var _t=[{sql:"SELECT now()",test:r=>/^2\d\d\d-\d\d-\d\dT\d\d:\d\d:\d\d.\d+Z$/.
