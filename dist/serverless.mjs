...
// shims/shims.js
var global, process, setImmediate, crypto, Buffer2;
...
function log(...args) {
  ...
  console.log(datetime, ...args.map((arg) => arg instanceof Uint8Array ? hexDump(arg) : arg instanceof ArrayBuffer ? hexDump(new Uint8Array(arg)) : arg));
}
function isIP(input) {
  return 0;
}
  ...
  "shims/net/index.ts"() {
    ...
    _Socket = class extends import_events.EventEmitter {
      ...
      async connect(port, host, connectListener) {
        if (host === void 0)
          throw new Error("No database host specified (are you missing an environment variable?)");
