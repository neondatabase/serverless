...
value:r,enumerable:!0}):t,r)),X=r=>$n(st({},"__esModule",{value:!0}),r);var Kn=B(Pt=>{"use strict";p();Pt.byteLength=Za;Pt.toByteArray=eo;Pt.fromByteArray=
...
2&63]+"=")),i.join("")}o(no,"fromByteArray")});var Wn=B(cr=>{p();cr.read=function(r,e,t,n,i){var s,a,u=i*8-n-1,c=(1<<u)-1,l=c>>
...
l)-1,f=h>>1,y=i===23?Math.pow(2,-24)-Math.pow(2,-77):0,m=n?0:s-1,b=n?1:-1,U=e<0||
...
i-=8);for(a=a<<i|u,l+=i;l>0;r[t+m]=a&255,m+=b,a/=256,l-=8);r[t+m-b]|=U*128}});var ci=B(je=>{"use strict";p();var lr=Kn(),Qe=Wn(),Gn=typeof Symbol=="function"&&
...
return typeof r.length!="number"||mr(r.length)?Ae(0):hr(r);if(r.type==="Buffer"&&
...
t<-2147483648&&(t=-2147483648),t=+t,mr(t)&&(t=i?0:r.length-1),t<0&&(t=r.length+t),
...
s/2&&(n=s/2);let a;for(a=0;a<n;++a){let u=parseInt(e.substr(a*2,2),16);if(mr(u))
...
function wo(r,e,t,n){return Rt(To(e,r.length-t),r,t,n)}o(wo,"ucs2Write");d.prototype.
...
length?lr.fromByteArray(r):lr.fromByteArray(r.slice(e,t))}o(mo,"base64Slice");function ti(r,e,t){
...
for(s=0;s<n-t;++s)this[s+t]=a[s%u]}return this},"fill");var ke={};function wr(r,e,t){
...
e.name}o(Ee,"isInstance");function mr(r){return r!==r}o(mr,"numberIsNaN");var Lo=function(){
...
o(Uo,"BufferBigIntNotDefined")});var _,T,L,A,w,S,p=le(()=>{"use strict";_=globalThis,T=globalThis.setImmediate??(r=>setTimeout(
r,0)),L=globalThis.clearImmediate??(r=>clearTimeout(r)),A=globalThis.crypto??{};
A.subtle??={};w=typeof globalThis.Buffer=="function"&&typeof globalThis.Buffer.allocUnsafe==
"function"?globalThis.Buffer:ci().Buffer,S=globalThis.process??{};S.env??={};try{
S.nextTick(()=>{})}catch{let e=Promise.resolve();S.nextTick=e.then.bind(e)}});var Ue=B((hf,Ur)=>{"use strict";p();var Ge=typeof Reflect=="object"?Reflect:null,
...
2361852424,2428436474,2756734187,3204031479,3329325298],y=o((E,g)=>E>>>g|E<<32-g,
"rrot"),m=new Uint32Array(64),b=new Uint8Array(64),U=o(()=>{for(let M=0,$=0;M<16;M++,
...
16]+$+m[M-7]+j|0}let E=e,g=t,x=n,N=i,P=s,D=a,q=u,Z=c;for(let M=0;M<64;M++){let $=y(
P,6)^y(P,11)^y(P,25),j=P&D^~P&q,H=Z+$+j+f[M]+m[M]|0,K=y(E,2)^y(E,13)^y(E,22),J=E&
g^E&x^g&x,F=K+J|0;Z=q,q=D,D=P,P=N+H|0,N=x,x=g,g=E,E=H+F|0}e=e+E|0,t=t+g|0,n=n+x|
0,i=i+N|0,s=s+P|0,a=a+D|0,u=u+q|0,c=c+Z|0,h=0},"process"),v=o(E=>{typeof E=="str\
...
255,b[h++]=E>>>24,b[h++]=E>>>16&255,b[h++]=E>>>8&255,b[h++]=E&255,U();let g=new Uint8Array(
...
void 0?{add:v,digest:C}:(v(r),C())}var $i=le(()=>{"use strict";p();o(ft,"sha256")});var dt,ji=le(()=>{"use strict";p();dt=class r{static{o(this,"Md5")}static hashByteArray(e,t=!1){
...
o(Ru,"randomBytes");o(Nu,"createHash");o(Mu,"createHmac")});var Rr=B(Hi=>{"use strict";p();Hi.parse=function(r,e){return new Br(r,e).parse()};
...
return r}o(Du,"identity")});var Nr=B((Lf,Ki)=>{p();var qu=Rr();Ki.exports={create:o(function(r,e){return{parse:o(
function(){return qu.parse(r,e)},"parse")}},"create")}});var Vi=B((Pf,Gi)=>{"use strict";p();var Fu=/(\d{1,})-(\d{2})-(\d{2}) (\d{2}):(\d{2}):(\d{2})(\.\d{1,})?.*?( BC)?$/,
...
"is0To99")});var Ji=B((Nf,zi)=>{p();zi.exports=Ku;var Hu=Object.prototype.hasOwnProperty;function Ku(r){
for(var e=1;e<arguments.length;e++){var t=arguments[e];for(var n in t)Hu.call(t,
n)&&(r[n]=t[n])}return r}o(Ku,"extend")});var Xi=B((qf,Zi)=>{"use strict";p();var Wu=Ji();Zi.exports=Ve;function Ve(r){if(!(this instanceof
...
a),n},{})}o(ic,"parse")});var ts=B((kf,es)=>{"use strict";p();es.exports=o(function(e){if(/^\\x/.test(e))return new w(
...
"\\";n+=Math.floor(i/2)*2}return new w(t,"binary")},"parseBytea")});var us=B((jf,os)=>{p();var pt=Rr(),yt=Nr(),Qt=Vi(),ns=Xi(),is=ts();function $t(r){
...
return e.parse()},"parseFloatArray"),we=o(function(r){if(!r)return null;var e=yt.
...
r(1014,we),r(1015,we),r(1008,we),r(1009,we),r(1040,we),r(1041,we),r(1115,Or),r(1182,
Or),r(1185,Or),r(1186,ns),r(1187,cc),r(17,is),r(114,JSON.parse.bind(JSON)),r(3802,
JSON.parse.bind(JSON)),r(199,rs),r(3807,rs),r(3907,we),r(2951,we),r(791,we),r(1183,
we),r(1270,we)},"init");os.exports={init:fc}});var ls=B((Wf,cs)=>{"use strict";p();var fe=1e6;function dc(r){var e=r.readInt32BE(
...
exports=dc});var ys=B((zf,ps)=>{p();var pc=ls(),G=o(function(r,e,t,n,i){t=t||0,n=n||!1,i=i||function(m,b,U){
return m*Math.pow(2,U)+b};var s=t>>3,a=o(function(m){return n?~m&255:m},"inv"),u=255,
...
(G(r,15,1,!0)+1):G(r,15,1)},"parseInt16"),hs=o(function(r){return G(r,1)==1?-1*(G(
r,31,1,!0)+1):G(r,31,1)},"parseInt32"),wc=o(function(r){return ds(r,23,8)},"pars\
eFloat32"),mc=o(function(r){return ds(r,52,11)},"parseFloat64"),gc=o(function(r){
...
return(e===0?1:-1)*Math.round(n*u)/u},"parseNumeric"),fs=o(function(r,e){var t=G(
...
return this.usec},i},"parseDate"),wt=o(function(r){for(var e=G(r,32),t=G(r,32,32),
...
null?null:G(r,8)>0},"parseBool"),bc=o(function(r){r(20,pc),r(21,yc),r(23,hs),r(26,
hs),r(1700,gc),r(700,wc),r(701,mc),r(16,Ec),r(1114,fs.bind(null,!1)),r(1184,fs.bind(
null,!0)),r(1e3,wt),r(1007,wt),r(1016,wt),r(1008,wt),r(1009,wt),r(25,Sc)},"init");
ps.exports={init:bc}});var ms=B((Zf,ws)=>{p();ws.exports={BOOL:16,BYTEA:17,CHAR:18,INT8:20,INT2:21,INT4:23,
...
REGCONFIG:3734,REGDICTIONARY:3769,JSONB:3802,REGNAMESPACE:4089,REGROLE:4096}});var St=B(gt=>{p();var xc=us(),Ac=ys(),vc=Nr(),Cc=ms();gt.getTypeParser=_c;gt.setTypeParser=
Tc;gt.arrayParser=vc;gt.builtins=Cc;var mt={text:{},binary:{}};function gs(r){return String(
r)}o(gs,"noParse");function _c(r,e){return e=e||"text",mt[e]&&mt[e][r]||gs}o(_c,
"getTypeParser");function Tc(r,e,t){typeof e=="function"&&(t=e,e="text"),mt[e][r]=
t}o(Tc,"setTypeParser");xc.init(function(r,e){mt.text[r]=e});Ac.init(function(r,e){
mt.binary[r]=e})});var Et=B((nd,$r)=>{"use strict";p();$r.exports={host:"localhost",user:S.platform===
...
setTypeParser(1016,"text",r?ze.getTypeParser(1007,"text"):Uc)})});var bt=B((sd,Es)=>{"use strict";p();var Ic=(Pr(),X(Ir)),Pc=Et();function Bc(r){var e=r.
...
e)},"prepareValueWrapper"),normalizeQueryConfig:Dc,postgresMd5PasswordHash:qc,md5:jr}});var Cs=B((ud,vs)=>{"use strict";p();var Hr=(Pr(),X(Ir));function Fc(r){if(r.indexOf(
...
",s="+n.salt+",i="+n.iteration,h="c=biws,r="+n.nonce,f=c+","+l+","+h,y=Je(u,f),m=As(
a,y),b=m.toString("base64"),U=Je(s,"Server Key"),v=Je(U,f);r.message="SASLRespon\
...
td.decode(e,{stream:!0})}end(e){return this.td.decode(e)}}});var Ps=B((gd,Is)=>{"use strict";p();var{Transform:zc}=(Jr(),X(zr)),{StringDecoder:Jc}=(Ts(),X(_s)),
...
this._writableState.errorEmitted=!1,s(i)},n}o(Xc,"split");Is.exports=Xc});var Ns=B((bd,ve)=>{"use strict";p();var Bs=(Wr(),X(Kr)),el=(Jr(),X(zr)).Stream,tl=Ps(),
Rs=(ht(),X(lt)),rl=5432,Kt=S.platform==="win32",xt=S.stderr,nl=56,il=7,sl=61440,
...
var e=r||S.env,t=e.PGPASSFILE||(Kt?Bs.join(e.APPDATA||"./","postgresql","pgpass.\
conf"):Bs.join(e.HOME||"./",".pgpass"));return t};ve.exports.usePgPass=function(r,e){
return Object.prototype.hasOwnProperty.call(S.env,"PGPASSWORD")?!1:Kt?!0:(e=e||"\
...
u=!1,c=o(function(h,f,y){var m=r.substring(f,y);Object.hasOwnProperty.call(S.env,
"PGPASS_NO_DEESCAPE")||(m=m.replace(/\\([:\\])/g,"$1")),a[Ye[h]]=m},"addToObj"),
...
"",s=n(i);if(!s)return!1}return!0}});var Ds=B((Cd,en)=>{"use strict";p();var vd=(Wr(),X(Kr)),Ms=(Vr(),X(Gr)),Wt=Ns();
...
e)})};en.exports.warnTo=Wt.warnTo});var Vt=B((Td,qs)=>{"use strict";p();var fl=St();function Gt(r){this._types=r||fl,
...
search:h,query:b,hash:y}}var rn=le(()=>{"use strict";p();o(tn,"parse")});var $s=B((Rd,Qs)=>{"use strict";p();var pl=(rn(),X(ks)),nn=(Vr(),X(Gr));function sn(r){
...
return t}o(sn,"parse");Qs.exports=sn;sn.parse=sn});var zt=B((Dd,Ks)=>{"use strict";p();var yl=(Os(),X(Fs)),Hs=Et(),js=$s().parse,ue=o(
function(r,e,t){return t===void 0?t=S.env["PG"+r.toUpperCase()]:t===!1||(t=S.env[t]),
e[r]||t||Hs[r]},"val"),wl=o(function(){switch(S.env.PGSSLMODE){case"disable":return!1;case"\
...
teParamValue"),me=o(function(r,e,t){var n=e[t];n!=null&&r.push(t+"="+Ze(n))},"ad\
...
me(t,n,"sslrootcert"),this.database&&t.push("dbname="+Ze(this.database)),this.replication&&
...
e(i,null):(t.push("hostaddr="+Ze(s)),e(null,t.join(" ")))})}};Ks.exports=an});var Vs=B((Od,Gs)=>{"use strict";p();var ml=St(),Ws=/^([A-Za-z]+)(?: (\d+))?(?: (\d+))?/,
...
n.dataTypeID,n.format||"text")}}};Gs.exports=on});var Zs=B(($d,Ys)=>{"use strict";p();var{EventEmitter:gl}=Ue(),zs=Vs(),Js=bt(),un=class extends gl{static{
...
end()}}});var An=B(I=>{"use strict";p();Object.defineProperty(I,"__esModule",{value:!0});I.
...
wn;var mn=class{static{o(this,"BackendKeyDataMessage")}constructor(e,t,n){this.length=
e,this.processID=t,this.secretKey=n,this.name="backendKeyData"}};I.BackendKeyDataMessage=
mn;var gn=class{static{o(this,"NotificationResponseMessage")}constructor(e,t,n,i){
...
"notice"}};I.NoticeMessage=xn});var ra=B(Yt=>{"use strict";p();Object.defineProperty(Yt,"__esModule",{value:!0});
...
size),t}};Yt.Writer=vn});var ia=B(Xt=>{"use strict";p();Object.defineProperty(Xt,"__esModule",{value:!0});
Xt.serialize=void 0;var Cn=ra(),V=new Cn.Writer,El=o(r=>{V.addInt16(3).addInt16(
0);for(let n of Object.keys(r))V.addCString(n).addCString(r[n]);V.addCString("cl\
ient_encoding").addCString("UTF8");var e=V.addCString("").flush(),t=e.length+4;return new Cn.
Writer().addInt32(t).add(e).flush()},"startup"),bl=o(()=>{let r=w.allocUnsafe(8);
return r.writeInt32BE(8,0),r.writeInt32BE(80877103,4),r},"requestSsl"),xl=o(r=>V.
addCString(r).flush(112),"password"),Al=o(function(r,e){return V.addCString(r).addInt32(
w.byteLength(e)).addString(e),V.flush(112)},"sendSASLInitialResponseMessage"),vl=o(
function(r){return V.addString(r).flush(112)},"sendSCRAMClientFinalMessage"),Cl=o(
r=>V.addCString(r).flush(81),"query"),na=[],_l=o(r=>{let e=r.name||"";e.length>63&&
...
let n=e?e(r[t],t):r[t];n==null?(V.addInt16(0),Xe.addInt32(-1)):n instanceof w?(V.
addInt16(1),Xe.addInt32(n.length),Xe.add(n)):(V.addInt16(0),Xe.addInt32(w.byteLength(
n)),Xe.addString(n))}},"writeValues"),Ll=o((r={})=>{let e=r.portal||"",t=r.statement||
"",n=r.binary||!1,i=r.values||na,s=i.length;return V.addCString(e).addCString(t),
V.addInt16(s),Tl(i,r.valueMapper),V.addInt16(s),V.add(Xe.flush()),V.addInt16(n?1:
0),V.flush(66)},"bind"),Ul=w.from([69,0,0,0,9,0,0,0,0,0]),Il=o(r=>{if(!r||!r.portal&&
...
"cstringMessage"),Bl=V.addCString("P").flush(68),Rl=V.addCString("S").flush(68),
Nl=o(r=>r.name?_n(68,`${r.type}${r.name||""}`):r.type==="P"?Bl:Rl,"describe"),Ml=o(
r=>{let e=`${r.type}${r.name||""}`;return _n(67,e)},"close"),Dl=o(r=>V.add(r).flush(
...
cancel:Pl};Xt.serialize=$l});var sa=B(er=>{"use strict";p();Object.defineProperty(er,"__esModule",{value:!0});
...
offset+e);return this.offset+=e,t}};er.BufferReader=Tn});var ua=B(tr=>{"use strict";p();Object.defineProperty(tr,"__esModule",{value:!0});
tr.Parser=void 0;var z=An(),Hl=sa(),Ln=1,Kl=4,aa=Ln+Kl,oa=w.allocUnsafe(0),Un=class{static{
...
return this.parseCopyData(e,n,i);default:return new z.DatabaseError("received in\
valid response: "+t.toString(16),n,"error")}}parseReadyForQueryMessage(e,t,n){this.
reader.setBuffer(e,n);let i=this.reader.string(1);return new z.ReadyForQueryMessage(
t,i)}parseCommandCompleteMessage(e,t,n){this.reader.setBuffer(e,n);let i=this.reader.
cstring();return new z.CommandCompleteMessage(t,i)}parseCopyData(e,t,n){let i=n.
slice(e,e+(t-4));return new z.CopyDataMessage(t,i)}parseCopyInMessage(e,t,n){return this.
...
setBuffer(e,n);let s=this.reader.byte()!==0,a=this.reader.int16(),u=new z.CopyResponse(
...
reader.cstring();return new z.NotificationResponseMessage(t,i,s,a)}parseRowDescriptionMessage(e,t,n){
this.reader.setBuffer(e,n);let i=this.reader.int16(),s=new z.RowDescriptionMessage(
...
nary";return new z.Field(e,t,n,i,s,a,u)}parseParameterDescriptionMessage(e,t,n){
this.reader.setBuffer(e,n);let i=this.reader.int16(),s=new z.ParameterDescriptionMessage(
...
i;a++){let u=this.reader.int32();s[a]=u===-1?null:this.reader.string(u)}return new z.
DataRowMessage(t,s)}parseParameterStatusMessage(e,t,n){this.reader.setBuffer(e,n);
let i=this.reader.cstring(),s=this.reader.cstring();return new z.ParameterStatusMessage(
t,i,s)}parseBackendKeyData(e,t,n){this.reader.setBuffer(e,n);let i=this.reader.int32(),
s=this.reader.int32();return new z.BackendKeyDataMessage(t,i,s)}parseAuthenticationResponse(e,t,n){
...
d";let u=this.reader.bytes(4);return new z.AuthenticationMD5Password(t,u)}break;case 10:
...
a=this.reader.string(1);let u=s.M,c=i==="notice"?new z.NoticeMessage(t,u):new z.
...
routine=s.R,c}};tr.Parser=Un});var In=B(Pe=>{"use strict";p();Object.defineProperty(Pe,"__esModule",{value:!0});
...
startTls(e),r}var la=le(()=>{"use strict";p();o(Jl,"connect")});var Bn=B((dp,da)=>{"use strict";p();var ha=(Jt(),X(ta)),Yl=Ue().EventEmitter,{parse:Zl,
...
Pn});var wa=B((mp,ya)=>{"use strict";p();var th=Ue().EventEmitter,wp=(ht(),X(lt)),rh=bt(),
...
_Promise(t=>{this.connection.once("end",t)})}};rr.Query=pa;ya.exports=rr});var Ea=B((Ep,Sa)=>{"use strict";p();var uh=Ue().EventEmitter,ma=o(function(){},"\
...
length}};Sa.exports=Mn});var ba={};pe(ba,{default:()=>hh});var hh,xa=le(()=>{"use strict";p();hh={}});var Aa=B((vp,fh)=>{fh.exports={name:"pg",version:"8.8.0",description:"PostgreSQL\
...
7b9a5491a178655"}});var _a=B((Cp,Ca)=>{"use strict";p();var va=Ue().EventEmitter,dh=(ht(),X(lt)),Dn=bt(),
...
text,t)}});var Ia=B((Up,Ua)=>{"use strict";p();var yh=(xa(),X(ba)),wh=Vt(),Lp=Aa(),Ta=Ue().
EventEmitter,mh=(ht(),X(lt)),gh=zt(),La=_a(),de=Ua.exports=function(r){Ta.call(this),
r=r||{},this._Promise=r.Promise||_.Promise,this._types=new wh(r.types),this.native=
...
e.port,this.namedQueries={}};de.Query=La;mh.inherits(de,Ta);de.prototype._errorAllQueries=
...
"Connection terminated")),S.nextTick(()=>{e.emit("end"),r&&r()})}),t};de.prototype.
...
_types.getTypeParser(r,e)}});var qn=B((Bp,Pa)=>{"use strict";p();Pa.exports=Ia()});var ir=B((Mp,At)=>{"use strict";p();var Sh=wa(),Eh=Et(),bh=Bn(),xh=Ea(),{DatabaseError:Ah}=In(),
...
this.DatabaseError=Ah},"PG");typeof S.env.NODE_PG_FORCE_NATIVE<"u"?At.exports=new Fn(
...
0);i.writeUint16(23,0),b(),m(),i.writeUint16(13,0);let U=i.writeLengthUint16(0),
...
E(),C(),i.writeUint16(51,0);let g=i.writeLengthUint16(0),x=i.writeLengthUint16(0);
i.writeUint16(23,0);let N=i.writeLengthUint16(0);return i.writeBytes(new Uint8Array(
e)),N(),x(),g(),h(),a(),s(),i}o(Po,"St");function Te(r,e=""){return[...r].map(t=>t.
...
a,e,t);i.push(u)}return i}o(hi,"At");var O=A.subtle,wi=new TextEncoder;async function vr(r,e,t){
...
c=y}return a.subarray(0,t)}o(Mo,"ne");var fi=wi.encode("tls13 ");async function ae(r,e,t,n,i){
let s=wi.encode(e),a=se([(n&65280)>>8,n&255],[fi.length+s.length],fi,s,[t.length],
...
HA-256",t),f=new Uint8Array(h),y=await vr(new Uint8Array(1),a,n),m=await O.digest(
`SHA-${n}`,new Uint8Array(0)),b=new Uint8Array(m),U=await ae(y,"derived",b,s,n),
v=await vr(U,l,n),C=await ae(v,"c hs traffic",f,s,n),E=await ae(v,"s hs traffic",
f,s,n),g=await ae(C,"key",new Uint8Array(0),i,n),x=await ae(E,"key",new Uint8Array(
0),i,n),N=await ae(C,"iv",new Uint8Array(0),12,n),P=await ae(E,"iv",new Uint8Array(
0),12,n);return{serverHandshakeKey:x,serverHandshakeIV:P,clientHandshakeKey:g,clientHandshakeIV:N,
handshakeSecret:v,clientSecret:C,serverSecret:E}}o(Do,"Kt");async function qo(r,e,t,n){
...
m=await ae(f,"key",new Uint8Array(0),n,t),b=await ae(h,"iv",new Uint8Array(0),12,
t),U=await ae(f,"iv",new Uint8Array(0),12,t);return{serverApplicationKey:m,serverApplicationIV:U,
clientApplicationKey:y,clientApplicationIV:b}}o(qo,"Tt");var Nt=class{static{o(this,
...
throw new Error(`Unsupported algorithm identifier: ${r}`);return e}o(Wo,"Ft");function mi(r,e=[]){
return Object.values(r).forEach(t=>{typeof t=="string"?e=[...e,t]:e=mi(t,e)}),e}
o(mi,"Ot");function Go(r){return mi(r).join(" / ")}o(Go,"Pt");var Vo=["digitalSi\
...
this.subject=yi(t,"subject");let m=t.offset;t.expectUint8(ie,0);let[b]=t.expectASN1Length(
0);t.expectUint8(ie,0);let[U,v]=t.expectASN1Length(0),C=[];for(;v()>0;){let Z=t.
readUint8();if(Z===Ke){let M=t.readASN1OID();C.push(M)}else Z===Sr&&t.expectUint8(
0,0)}U(),t.expectUint8(Er,0);let E=t.readASN1BitString();this.publicKey={identifiers:C,
data:E,all:t.data.subarray(m,t.offset)},b(),t.expectUint8($o,0);let[g]=t.expectASN1Length();
t.expectUint8(ie,0);let[x,N]=t.expectASN1Length(0);for(;N()>0;){t.expectUint8(ie,
0);let[Z,M]=t.expectASN1Length();t.expectUint8(Ke,0);let $=t.readASN1OID();if($===
"2.5.29.17"){t.expectUint8(De,0);let[j]=t.expectASN1Length(0);t.expectUint8(ie,0);
let H=Ko(t,He);this.subjectAltNames=H.filter(K=>K.type===(2|He)).map(K=>K.name),
j()}else if($==="2.5.29.15"){t.expectUint8(gr,0);let j=t.readASN1Boolean();t.expectUint8(
De,0);let[H]=t.expectASN1Length(0);t.expectUint8(Er,0);let K=t.readASN1BitString(),
J=Ho(K),F=new Set(Vo.filter((Y,W)=>J&1<<W));H(),this.keyUsage={critical:j,usages:F}}else if($===
"2.5.29.37"){this.extKeyUsage={},t.expectUint8(De,0);let[j]=t.expectASN1Length(0);
t.expectUint8(ie,0);let[H,K]=t.expectASN1Length(0);for(;K()>0;){t.expectUint8(Ke,
0);let J=t.readASN1OID();J==="1.3.6.1.5.5.7.3.1"&&(this.extKeyUsage.serverTls=!0),
J==="1.3.6.1.5.5.7.3.2"&&(this.extKeyUsage.clientTls=!0)}H(),j()}else if($==="2.\
5.29.35"){t.expectUint8(De,0);let[j]=t.expectASN1Length(0);t.expectUint8(ie,0);let[
H,K]=t.expectASN1Length(0);for(;K()>0;){let J=t.readUint8();if(J===(He|0)){let[F,
Y]=t.expectASN1Length(0);this.authorityKeyIdentifier=t.readBytes(Y()),F()}else if(J===
(He|1)){let[F,Y]=t.expectASN1Length(0);t.skip(Y(),0),F()}else if(J===(He|2)){let[
F,Y]=t.expectASN1Length(0);t.skip(Y(),0),F()}else if(J===(He|33)){let[F,Y]=t.expectASN1Length(
0);t.skip(Y(),0),F()}else throw new Error(`Unexpected data type ${J} in authorit\
yKeyIdentifier certificate extension`)}H(),j()}else if($==="2.5.29.14"){t.expectUint8(
De,0);let[j]=t.expectASN1Length(0);t.expectUint8(De,0);let[H,K]=t.expectASN1Length(
0);this.subjectKeyIdentifier=t.readBytes(K()),H(),j()}else if($==="2.5.29.19"){let j,
H=t.readUint8();if(H===gr&&(j=t.readASN1Boolean(),H=t.readUint8()),H!==De)throw new Error(
"Unexpected type in certificate basic constraints");let[K]=t.expectASN1Length(0);
t.expectUint8(ie,0);let[J,F]=t.expectASN1Length(),Y;F()>0&&(t.expectUint8(gr,0),
Y=t.readASN1Boolean());let W;if(F()>0){t.expectUint8(qt,0);let R=t.readASN1Length(
0);if(W=R===1?t.readUint8():R===2?t.readUint16():R===3?t.readUint24():void 0,W===
void 0)throw new Error("Too many bytes in max path length in certificate basicCo\
nstraints")}J(),K(),this.basicConstraints={critical:j,ca:Y,pathLength:W}}else t.
skip(M(),0);Z()}x(),g(),s(),this.signedData=t.data.subarray(i,t.offset),t.expectUint8(
ie,0);let[P,D]=t.expectASN1Length(0);t.expectUint8(Ke,0);let q=t.readASN1OID();if(D()>
0&&(t.expectUint8(Sr,0),t.expectUint8(0,0)),P(),q!==this.algorithm)throw new Error(
`Certificate specifies different signature algorithms inside (${this.algorithm})\
 and out (${q})`);t.expectUint8(Er,0),this.signature=t.readASN1BitString(),n()}static fromPEM(e){
...
length<C?se(new Uint8Array(C-v.length),v):v,"m"),m=n==="P-256"?32:48,b=se(y(c,m),
y(f,m)),U=await O.importKey("spki",e,{name:"ECDSA",namedCurve:n},!1,["verify"]);
...
b=>_r.distinguishedNamesAreEqual(b.subject,l.issuer)):f=t.find(b=>b.subjectKeyIdentifier!==
void 0&&ut(b.subjectKeyIdentifier,h)),f===void 0&&(f=e[u+1]),f===void 0)throw new Error(
...
g key curve");let C=new Dt(l.signature);await Si(C,f.publicKey.all,l.signedData,
...
readUint16(0);if(R===0)u.expectUint16(0,0);else if(R===10){let[k,ne]=u.expectLengthUint16(
"groups data");u.skip(ne(),0),k()}else throw new Error(`Unsupported server encry\
pted extension type 0x${Te([R]).padStart(4,"0")}`)}l(),c(),u.remaining()===0&&u.
...
ertificate request extensions");u.skip(ne(),0),k(),R(),u.remaining()===0&&u.extend(
await e()),y=u.readUint8()}if(y!==11)throw new Error(`Unexpected handshake messa\
ge type 0x${Te([y])}`);let[m]=u.expectLengthUint24(0);u.expectUint8(0,0);let[b,U]=u.
expectLengthUint24(0),v=[];for(;U()>0;){let[R]=u.expectLengthUint24(0),k=new _r(
u);v.push(k),R();let[ne,ce]=u.expectLengthUint16(),Fe=u.subarray(ce());ne()}if(b(),
m(),v.length===0)throw new Error("No certificates supplied");let C=v[0],E=u.data.
subarray(0,u.offset),g=se(n,E),x=await O.digest("SHA-256",g),N=new Uint8Array(x),
P=se(Jo.encode(" ".repeat(64)+"TLS 1.3, server CertificateVerify"),[0],N);u.remaining()===
0&&u.extend(await e()),u.expectUint8(15,0);let[D]=u.expectLengthUint24(0),q=u.readUint16();
if(q===1027){let[R]=u.expectLengthUint16();await Si(u,C.publicKey.all,P,"P-256",
"SHA-256"),R()}else if(q===2052){let[R,k]=u.expectLengthUint16(),ne=u.subarray(k());
R();let ce=await O.importKey("spki",C.publicKey.all,{name:"RSA-PSS",hash:"SHA-25\
6"},!1,["verify"]);if(await O.verify({name:"RSA-PSS",saltLength:32},ce,ne,P)!==!0)
throw new Error("RSA-PSS-RSAE-SHA256 certificate verify failed")}else throw new Error(
`Unsupported certificate verify signature type 0x${Te([q]).padStart(4,"0")}`);D();
let Z=u.data.subarray(0,u.offset),M=se(n,Z),$=await ae(t,"finished",new Uint8Array(
0),32,256),j=await O.digest("SHA-256",M),H=await O.importKey("raw",$,{name:"HMAC",
hash:{name:"SHA-256"}},!1,["sign"]),K=await O.sign("HMAC",H,j),J=new Uint8Array(
K);u.remaining()===0&&u.extend(await e()),u.expectUint8(20,0);let[F,Y]=u.expectLengthUint24(
0),W=u.readBytes(Y());if(F(),u.remaining()!==0)throw new Error("Unexpected extra\
 bytes in server handshake");if(ut(W,J)!==!0)throw new Error("Invalid server ver\
...
"raw",h.publicKey),y=new Uint8Array(32);A.getRandomValues(y);let m=Po(r,f,y,i).array(),
b=u?se(u,m):m;if(n(b),c){let re=await t(c.length);if(!re||!ut(re,c))throw new Error(
"Pre data did not match expectation")}let U=await xr(t,22);if(U===void 0)throw new Error(
"Connection closed while awaiting server hello");let v=new be(U.content),C=Bo(v,
y),E=await xr(t,20);if(E===void 0)throw new Error("Connection closed awaiting se\
rver cipher change");let g=new be(E.content),[x]=g.expectLength(1);g.expectUint8(
1,0),x();let N=m.subarray(5),P=U.content,D=se(N,P),q=await Do(C,h.privateKey,D,256,
16),Z=await O.importKey("raw",q.serverHandshakeKey,{name:"AES-GCM"},!1,["decrypt"]),
M=new Nt("decrypt",Z,q.serverHandshakeIV),$=await O.importKey("raw",q.clientHandshakeKey,
{name:"AES-GCM"},!1,["encrypt"]),j=new Nt("encrypt",$,q.clientHandshakeIV),H=o(async()=>{
let re=await Ar(t,M,22);if(re===void 0)throw new Error("Premature end of encrypt\
ed server handshake");return re},"C"),[K,J]=await Yo(r,H,q.serverSecret,D,e,s,a),
F=new be(6);F.writeUint8(20,0),F.writeUint16(771,0);let Y=F.writeLengthUint16();
F.writeUint8(1,0),Y();let W=F.array(),R=new Uint8Array(0);if(J){let re=new be(8);
re.writeUint8(11,0);let it=re.writeLengthUint24("client certificate data");re.writeUint8(
0,0),re.writeUint24(0,0),it(),R=re.array()}let k=se(D,K,R),ne=await O.digest("SH\
A-256",k),ce=new Uint8Array(ne),Fe=await ae(q.clientSecret,"finished",new Uint8Array(
...
se(R,ka),j,22),kn=ce;if(R.length>0){let re=k.subarray(0,k.length-R.length),it=await O.
digest("SHA-256",re);kn=new Uint8Array(it)}let Ut=await qo(q.handshakeSecret,kn,
...
t",ja,Ut.serverApplicationIV),It=!1;return[()=>{if(!It){let re=se(W,...On);n(re),
It=!0}return Ar(t,Ha)},async re=>{let it=It;It=!0;let Qn=await hi(re,$a,23),Ka=it?
se(...Qn):se(W,...On,...Qn);n(Ka)}]}o(Zo,"he");var Ei=class{static{o(this,"xt")}queue;outstandingRequest;constructor(){
...
b=u.value,U=b[0],v=b[1];!l&&!n[h]&&(l=t.equals(y,U,s,h,r,e,t)&&t.equals(m,v,y,U,
...
h,f,y);if(Eu(h))return e(h,f,y);if(Li!=null&&Li(h))return c(h,f,y);if(m===Date)return t(
...
username:y,hostname:m,port:b,pathname:U}=h;if(f!=="postgres:"&&f!=="postgresql:"||
!y||!m||!U)throw new Error("Database connection string format for `neon()` shoul\
d be: postgresql://user:password@host.tld/dbname?option=value");function v(E,...g){
let x,N;if(typeof E=="string")x=E,N=g[1],g=g[0]??[];else{x="";for(let D=0;D<E.length;D++)
x+=E[D],D<g.length&&(x+="$"+(D+1))}g=g.map(D=>Ch((0,Na.prepareValue)(D)));let P={
query:x,params:g};return u&&u(P),Th(C,P,N)}o(v,"resolve"),v.transaction=async(E,g)=>{
if(typeof E=="function"&&(E=E(v)),!Array.isArray(E))throw new Error(Ba);E.forEach(
P=>{if(P[Symbol.toStringTag]!=="NeonQueryPromise")throw new Error(Ba)});let x=E.
map(P=>P.parameterizedQuery),N=E.map(P=>P.opts??{});return C(x,N,g)};async function C(E,g,x){
let{fetchEndpoint:N,fetchFunction:P}=ge,D=Array.isArray(E)?{queries:E}:E,q=n??{},
Z=e??!1,M=t??!1,$=i,j=s,H=a;x!==void 0&&(x.fetchOptions!==void 0&&(q={...q,...x.
fetchOptions}),x.arrayMode!==void 0&&(Z=x.arrayMode),x.fullResults!==void 0&&(M=
x.fullResults),x.isolationLevel!==void 0&&($=x.isolationLevel),x.readOnly!==void 0&&
(j=x.readOnly),x.deferrable!==void 0&&(H=x.deferrable)),g!==void 0&&!Array.isArray(
g)&&g.fetchOptions!==void 0&&(q={...q,...g.fetchOptions});let K=l;!Array.isArray(
g)&&g?.authToken!==void 0&&(K=g.authToken);let J=typeof N=="function"?N(m,b,{jwtAuth:K!==
void 0}):N,F={"Neon-Connection-String":r,"Neon-Raw-Text-Output":"true","Neon-Arr\
ay-Mode":"true"},Y=await Lh(K);Y&&(F.Authorization=`Bearer ${Y}`),Array.isArray(
E)&&($!==void 0&&(F["Neon-Batch-Isolation-Level"]=$),j!==void 0&&(F["Neon-Batch-\
Read-Only"]=String(j)),H!==void 0&&(F["Neon-Batch-Deferrable"]=String(H)));let W;
try{W=await(P??fetch)(J,{method:"POST",body:JSON.stringify(D),headers:F,...q})}catch(R){
let k=new Ce(`Error connecting to database: ${R.message}`);throw k.sourceError=R,
k}if(W.ok){let R=await W.json();if(Array.isArray(E)){let k=R.results;if(!Array.isArray(
k))throw new Ce("Neon internal error: unexpected result format");return k.map((ne,ce)=>{
let Fe=g[ce]??{},ar=Fe.arrayMode??Z,or=Fe.fullResults??M;return Ra(ne,{arrayMode:ar,
fullResults:or,parameterizedQuery:E[ce],resultCallback:c,types:Fe.types})})}else{
let k=g??{},ne=k.arrayMode??Z,ce=k.fullResults??M;return Ra(R,{arrayMode:ne,fullResults:ce,
parameterizedQuery:E,resultCallback:c,types:k.types})}}else{let{status:R}=W;if(R===
400){let k=await W.json(),ne=new Ce(k.message);for(let ce of _h)ne[ce]=k[ce]??void 0;
throw ne}else{let k=await W.text();throw new Ce(`Server error (HTTP status ${R})\
: ${k}`)}}}return o(C,"execute"),v}o(xe,"neon");function Th(r,e,t){return{[Symbol.
...
n),"finally")}}o(Th,"createNeonQueryPromise");function Ra(r,{arrayMode:e,fullResults:t,
...
processQueryResult");async function Lh(r){if(typeof r=="string")return r;if(typeof r==
...
n: ${e.message}`)),t}}o(Lh,"getAuthToken");var Da=Oe(zt()),rt=Oe(ir());var Be=class extends sr.Client{constructor(t){super(t);this.config=t}static{o(this,
...
d attribute pair entry");let R=W[0],k=W.substring(2);return[R,k]})),u=a.r,c=a.s,
...
6"}},!1,["sign"]),U=new Uint8Array(await A.subtle.sign("HMAC",b,w.concat([f,w.from(
[0,0,0,1])]))),v=U;for(var C=0;C<h-1;C++)U=new Uint8Array(await A.subtle.sign("H\
MAC",b,U)),v=w.from(v.map((W,R)=>v[R]^U[R]));let E=v,g=await A.subtle.importKey(
"raw",E,{name:"HMAC",hash:{name:"SHA-256"}},!1,["sign"]),x=new Uint8Array(await A.
subtle.sign("HMAC",g,y.encode("Client Key"))),N=await A.subtle.digest("SHA-256",
x),P="n=*,r="+n.clientNonce,D="r="+u+",s="+c+",i="+h,q="c=biws,r="+u,Z=P+","+D+"\
,"+q,M=await A.subtle.importKey("raw",N,{name:"HMAC",hash:{name:"SHA-256"}},!1,[
"sign"]);var $=new Uint8Array(await A.subtle.sign("HMAC",M,y.encode(Z))),j=w.from(
x.map((W,R)=>x[R]^$[R])),H=j.toString("base64");let K=await A.subtle.importKey("\
raw",E,{name:"HMAC",hash:{name:"SHA-256"}},!1,["sign"]),J=await A.subtle.sign("H\
MAC",K,y.encode("Server Key")),F=await A.subtle.importKey("raw",J,{name:"HMAC",hash:{
name:"SHA-256"}},!1,["sign"]);var Y=w.from(await A.subtle.sign("HMAC",F,y.encode(
Z)));n.message="SASLResponse",n.serverSignature=Y.toString("base64"),n.response=
...
y),`
`),f!==1||y!=="hello")throw new Error("Batch query problem");let m=xe(r.NEON_DB_URL,
{arrayMode:!0}),[[b],[U]]=await m.transaction(x=>[x`SELECT ${1}::int AS "batchInt"`,
...
ised for string passed to `transaction()`");e("successfully caught invalid query\
 passed to `transaction()`\n");let g;try{let x=r.NEON_DB_URL.replace(/@/,"x@");await xe(
x).transaction(N=>[N`SELECT 'never' AS this_should_be_seen_precisely`])}catch(x){
g=x}if(g===void 0)throw new Error("Error should have been raised for bad passwor\
...
NEON_DB_URL}),c=xe(r.NEON_DB_URL,{resultCallback:o(async(m,b,U,v)=>{let C=await u.
query({text:m.query,values:m.params,...v.arrayMode?{rowMode:"array"}:{}}),E=b.command===
C.command,g=b.rowCount===C.rowCount,x=Lr(b.fields.map(D=>D.dataTypeID),C.fields.
map(D=>D.dataTypeID)),N=Lr(U,C.rows);t(E&&g&&N&&x?"\u2713":"X",JSON.stringify(m),
`
  -> us:`,JSON.stringify(U),`
...
await c("SELECT $1::timestamp AS timestampnow",[l]),await c("SELECT $1 || ' ' ||\
 ...
 123 AS num",[],{arrayMode:!0,fullResults:!0});function h(m,b,U=3){return async function(v,...C){
let E="";for(let g=0;g<v.length;g++)E+=v[g],g<C.length&&(E+="$"+(g+1));for(let g=1;;g++){
...
P.sourceError instanceof DOMException&&P.sourceError.name==="AbortError")||g>=U)
throw P}finally{clearTimeout(N)}}}}o(h,"sqlWithRetries"),await h(c,5e3)`SELECT ${"\
did this time out?"} AS str`,await Ph(r,t),ge.fetchFunction=(m,b)=>(console.log(
"custom fetch:",m,b),fetch(m,b)),await c`SELECT ${"customFetch"} AS str`;let y="\
SELECT 123::int[] WHERE x";try{await c(y)}catch(m){console.log("Fields of this e\
xpected error should match the following error, except for having no `length` fi\
eld"),console.log(m)}try{await _t(1,r.NEON_DB_URL,Re,{sql:y,test:o(()=>!0,"test")})}catch(m){
...
e:</span>    ');let[,g]=await nt(i,()=>C(v),x=>t(`<span class="live">${x.toFixed()}\
ms</span> `));t(`
Sorted:  `),g.map(([x])=>x).sort((x,N)=>x-N).forEach((x,N)=>{t(N===(i-1)/2?`<spa\
...
tions"),await U("Neon/wss, no pipelining",async v=>{let C=new Be(r.NEON_DB_URL);
C.neonConfig.pipelineConnect=!1,await Ct(v,C,Re,m)}),await U("Neon/wss, pipeline\
d connect (default)",async v=>{let C=new Be(r.NEON_DB_URL);await Ct(v,C,Re,m)}),
await U("Neon/wss, pipelined connect, no coalescing",async v=>{let C=new Be(r.NEON_DB_URL);
C.neonConfig.coalesceWrites=!1,await Ct(v,C,Re,m)}),await U("Neon/wss, pipelined\
 connect using Pool.query",async v=>{await _t(v,r.NEON_DB_URL,Re,m)}),await U("N\
eon/wss, pipelined connect using Pool.connect",async v=>{let C=new qe({connectionString:r.
NEON_DB_URL}),E=await C.connect();await nt(v,()=>vt(E,m)),E.release(),Re.waitUntil(
C.end())}),e&&(ge.subtls=Tr,ge.rootCerts=bi,await U("pg/subtls, pipelined connec\
t",async v=>{let C=new Be(r.NEON_DB_URL);C.neonConfig.wsProxy=(E,g)=>`subtls-wsp\
roxy.jawj.workers.dev/?address=${E}:${g}`,C.neonConfig.forceDisablePgSSL=C.neonConfig.
useSecureWebSocket=!1,C.neonConfig.pipelineTLS=!1,C.neonConfig.pipelineConnect=!1;
try{await Ct(v,C,Re,m)}catch(E){console.error(`
*** ${E.message}`)}}))}}o(l0,"latencies");export{Ph as batchQueryTest,c0 as cf,l0 as latencies,ge as neonConfig};
