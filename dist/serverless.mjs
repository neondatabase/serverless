var Ga=Object.create;var st=Object.defineProperty;var Va=Object.getOwnPropertyDescriptor;var za=Object.getOwnPropertyNames;var Ja=Object.getPrototypeOf,Ya=Object.prototype.hasOwnProperty;var o=(r,e)=>st(r,"name",{value:e,configurable:!0});var oe=(r,e)=>()=>(r&&(e=r(r=0)),e);var P=(r,e)=>()=>(e||r((e={exports:{}}).exports,e),e.exports),fe=(r,e)=>{for(var t in e)
st(r,t,{get:e[t],enumerable:!0})},kn=(r,e,t,n)=>{if(e&&typeof e=="object"||typeof e==
"function")for(let i of za(e))!Ya.call(r,i)&&i!==t&&st(r,i,{get:()=>e[i],enumerable:!(n=
Va(e,i))||n.enumerable});return r};var at=(r,e,t)=>(t=r!=null?Ga(Ja(r)):{},kn(e||!r||!r.__esModule?st(t,"default",{
value:r,enumerable:!0}):t,r)),Y=r=>kn(st({},"__esModule",{value:!0}),r);var jn=P(It=>{"use strict";y();It.byteLength=Xa;It.toByteArray=to;It.fromByteArray=
io;var me=[],pe=[],Za=typeof Uint8Array<"u"?Uint8Array:Array,ir="ABCDEFGHIJKLMNO\
...
"getLens");function Xa(r){var e=$n(r),t=e[0],n=e[1];return(t+n)*3/4-n}o(Xa,"byte\
Length");function eo(r,e,t){return(e+t)*3/4-t}o(eo,"_byteLength");function to(r){
var e,t=$n(r),n=t[0],i=t[1],s=new Za(eo(r,n,i)),a=0,u=i>0?n-4:n,c;for(c=0;c<u;c+=
...
e&255),s}o(to,"toByteArray");function ro(r){return me[r>>18&63]+me[r>>12&63]+me[r>>
6&63]+me[r&63]}o(ro,"tripletToBase64");function no(r,e,t){for(var n,i=[],s=e;s<t;s+=
...
u=t-n;a<u;a+=s)i.push(no(r,a,a+s>u?u:a+s));return n===1?(e=r[t-1],i.push(me[e>>2]+
me[e<<4&63]+"==")):n===2&&(e=(r[t-2]<<8)+r[t-1],i.push(me[e>>10]+me[e>>4&63]+me[e<<
2&63]+"=")),i.join("")}o(io,"fromByteArray")});var Hn=P(sr=>{y();sr.read=function(r,e,t,n,i){var s,a,u=i*8-n-1,c=(1<<u)-1,l=c>>
...
p;$e.SlowBuffer=lo;$e.INSPECT_MAX_BYTES=50;var Pt=2147483647;$e.kMaxLength=Pt;p.
TYPED_ARRAY_SUPPORT=so();!p.TYPED_ARRAY_SUPPORT&&typeof console<"u"&&typeof console.
...
rowser support.");function so(){try{let r=new Uint8Array(1),e={foo:function(){return 42}};
return Object.setPrototypeOf(e,Uint8Array.prototype),Object.setPrototypeOf(r,e),
r.foo()===42}catch{return!1}}o(so,"typedArraySupport");Object.defineProperty(p.prototype,
...
fer");p.poolSize=8192;function zn(r,e,t){if(typeof r=="string")return oo(r,e);if(ArrayBuffer.
isView(r))return uo(r);if(r==null)throw new TypeError("The first argument must b\
...
r)return p.from(n,e,t);let i=co(r);if(i)return i;if(typeof Symbol<"u"&&Symbol.toPrimitive!=
...
'The value "'+r+'" is invalid for option "size"')}o(Jn,"assertSize");function ao(r,e,t){
return Jn(r),r<=0?xe(r):e!==void 0?typeof t=="string"?xe(r).fill(e,t):xe(r).fill(
e):xe(r)}o(ao,"alloc");p.alloc=function(r,e,t){return ao(r,e,t)};function lr(r){
return Jn(r),xe(r<0?0:hr(r)|0)}o(lr,"allocUnsafe");p.allocUnsafe=function(r){return lr(
r)};p.allocUnsafeSlow=function(r){return lr(r)};function oo(r,e){if((typeof e!="\
...
n}o(oo,"fromString");function or(r){let e=r.length<0?0:hr(r.length)|0,t=xe(e);for(let n=0;n<
e;n+=1)t[n]=r[n]&255;return t}o(or,"fromArrayLike");function uo(r){if(ge(r,Uint8Array)){
let e=new Uint8Array(r);return ur(e.buffer,e.byteOffset,e.byteLength)}return or(
r)}o(uo,"fromArrayView");function ur(r,e,t){if(e<0||r.byteLength<e)throw new RangeError(
...
n,p.prototype),n}o(ur,"fromArrayBuffer");function co(r){if(p.isBuffer(r)){let e=hr(
...
Array.isArray(r.data))return or(r.data)}o(co,"fromObject");function hr(r){if(r>=
Pt)throw new RangeError("Attempt to allocate Buffer larger than maximum size: 0x"+
Pt.toString(16)+" bytes");return r|0}o(hr,"checked");function lo(r){return+r!=r&&
(r=0),p.alloc(+r)}o(lo,"SlowBuffer");p.isBuffer=o(function(e){return e!=null&&e.
...
i=!0}}o(Yn,"byteLength");p.byteLength=Yn;function ho(r,e,t){let n=!1;if((e===void 0||
...
this,e,t);case"utf8":case"utf-8":return Xn(this,e,t);case"ascii":return Eo(this,
e,t);case"latin1":case"binary":return bo(this,e,t);case"base64":return go(this,e,
...
ho,"slowToString");p.prototype._isBuffer=!0;function Ne(r,e,t){let n=r[e];r[e]=r[t],
...
this,0,e):ho.apply(this,arguments)},"toString");p.prototype.toLocaleString=p.prototype.
...
o(function(e,t,n){return Zn(this,e,t,n,!1)},"lastIndexOf");function fo(r,e,t,n){
...
return a;r[t+a]=u}return a}o(fo,"hexWrite");function po(r,e,t,n){return Bt(cr(e,
r.length-t),r,t,n)}o(po,"utf8Write");function yo(r,e,t,n){return Bt(Lo(e),r,t,n)}
o(yo,"asciiWrite");function wo(r,e,t,n){return Bt(ai(e),r,t,n)}o(wo,"base64Write");
function mo(r,e,t,n){return Bt(Uo(e,r.length-t),r,t,n)}o(mo,"ucs2Write");p.prototype.
...
ii":case"latin1":case"binary":return yo(this,e,t,n);case"base64":return wo(this,
...
length?ar.fromByteArray(r):ar.fromByteArray(r.slice(e,t))}o(go,"base64Slice");function Xn(r,e,t){
...
a&1023),n.push(a),i+=u}return So(n)}o(Xn,"utf8Slice");var Gn=4096;function So(r){
let e=r.length;if(e<=Gn)return String.fromCharCode.apply(String,r);let t="",n=0;
for(;n<e;)t+=String.fromCharCode.apply(String,r.slice(n,n+=Gn));return t}o(So,"d\
ecodeCodePointsArray");function Eo(r,e,t){let n="";t=Math.min(r.length,t);for(let i=e;i<
t;++i)n+=String.fromCharCode(r[i]&127);return n}o(Eo,"asciiSlice");function bo(r,e,t){
let n="";t=Math.min(r.length,t);for(let i=e;i<t;++i)n+=String.fromCharCode(r[i]);
return n}o(bo,"latin1Slice");function xo(r,e,t){let n=r.length;(!e||e<0)&&(e=0),
(!t||t<0||t>n)&&(t=n);let i="";for(let s=e;s<t;++s)i+=To[r[s]];return i}o(xo,"he\
xSlice");function Ao(r,e,t){let n=r.slice(e,t),i="";for(let s=0;s<n.length-1;s+=
2)i+=String.fromCharCode(n[s]+n[s+1]*256);return i}o(Ao,"utf16leSlice");p.prototype.
...
slice(0,t)}${e}`}o(Vn,"addNumericalSeparator");function vo(r,e,t){Qe(e,"offset"),
(r[e]===void 0||r[e+t]===void 0)&&ot(e,r.length-(t+1))}o(vo,"checkBounds");function si(r,e,t,n,i,s){
...
"value",u,r)}vo(n,i,s)}o(si,"checkIntBI");function Qe(r,e){if(typeof r!="number")
...
1:0} and <= ${e}`,r)}o(ot,"boundsError");var Co=/[^+/0-9A-Za-z-_]/g;function _o(r){
if(r=r.split("=")[0],r=r.trim().replace(Co,""),r.length<2)return"";for(;r.length%
4!==0;)r=r+"=";return r}o(_o,"base64clean");function cr(r,e){e=e||1/0;let t,n=r.
...
t)&255);return e}o(Lo,"asciiToBytes");function Uo(r,e){let t,n,i,s=[];for(let a=0;a<
r.length&&!((e-=2)<0);++a)t=r.charCodeAt(a),n=t>>8,i=t%256,s.push(i),s.push(n);return s}
o(Uo,"utf16leToBytes");function ai(r){return ar.toByteArray(_o(r))}o(ai,"base64T\
...
o(ge,"isInstance");function dr(r){return r!==r}o(dr,"numberIsNaN");var To=function(){
let r="0123456789abcdef",e=new Array(256);for(let t=0;t<16;++t){let n=t*16;for(let i=0;i<
16;++i)e[n+i]=r[t]+r[i]}return e}();function Ce(r){return typeof BigInt>"u"?Io:r}
o(Ce,"defineBigIntMethod");function Io(){throw new Error("BigInt not supported")}
o(Io,"BufferBigIntNotDefined")});var _,L,U,A,w,g,y=oe(()=>{"use strict";_=globalThis,L=globalThis.setImmediate??(r=>setTimeout(
...
g.nextTick(()=>{})}catch{let e=Promise.resolve();g.nextTick=e.then.bind(e)}});var Ue=P((wf,Cr)=>{"use strict";y();var We=typeof Reflect=="object"?Reflect:null,
...
console.warn(r)}o(Lu,"ProcessEmitWarning");var Bi=Number.isNaN||o(function(e){return e!==
e},"NumberIsNaN");function q(){q.init.call(this)}o(q,"EventEmitter");Cr.exports=
q;Cr.exports.once=Pu;q.EventEmitter=q;q.prototype._events=void 0;q.prototype._eventsCount=
...
prependListener=o(function(e,t){return Ni(this,e,t,!0)},"prependListener");function Uu(){
...
target,arguments)}o(Uu,"onceWrapper");function Mi(r,e,t){var n={fired:!1,wrapFn:void 0,
target:r,type:e,listener:t},i=Uu.bind(n);return i.listener=t,n.wrapFn=i,i}o(Mi,"\
...
on"?t?[i.listener||i]:[i]:t?Iu(i):qi(i,i.length)}o(Di,"_listeners");q.prototype.
...
pop()}o(Tu,"spliceOne");function Iu(r){for(var e=new Array(r.length),t=0;t<e.length;++t)
e[t]=r[t].listener||r[t];return e}o(Iu,"unwrapListeners");function Pu(r,e){return new Promise(
function(t,n){function i(a){r.removeListener(e,s),n(a)}o(i,"errorListener");function s(){
typeof r.removeListener=="function"&&r.removeListener("error",i),t([].slice.call(
arguments))}o(s,"resolver"),Oi(r,e,s,{once:!0}),e!=="error"&&Bu(r,i,{once:!0})})}
o(Pu,"once");function Bu(r,e,t){typeof r.on=="function"&&Oi(r,"error",e,t)}o(Bu,
...
ed type '+typeof r)}o(Oi,"eventTargetAgnosticAddListener")});var ht={};fe(ht,{default:()=>Ru});var Ru,ft=oe(()=>{"use strict";y();Ru={}});function dt(r){let e=1779033703,t=3144134277,n=1013904242,i=2773480762,s=1359893119,
...
void 0?{add:x,digest:T}:(x(r),T())}var ki=oe(()=>{"use strict";y();o(dt,"sha256")});var pt,Qi=oe(()=>{"use strict";y();pt=class r{static{o(this,"Md5")}static hashByteArray(e,t=!1){
...
_state:r._hex(this._state)}}});var _r={};fe(_r,{createHash:()=>Mu,createHmac:()=>Du,randomBytes:()=>Nu});function Nu(r){
return A.getRandomValues(w.alloc(r))}function Mu(r){if(r==="sha256")return{update:function(e){
...
e)}}}};throw new Error(`Hash type '${r}' not supported`)}function Du(r,e){if(r!==
...
set(dt(a),64),w.from(dt(u))}}}}}var Lr=oe(()=>{"use strict";y();ki();Qi();o(Nu,"\
randomBytes");o(Mu,"createHash");o(Du,"createHmac")});var Tr=P($i=>{"use strict";y();$i.parse=function(r,e){return new Ur(r,e).parse()};
var Ur=class r{static{o(this,"ArrayParser")}constructor(e,t){this.source=e,this.
transform=t||Fu,this.position=0,this.entries=[],this.recorded=[],this.dimension=
...
0)throw new Error("array dimension not balanced");return this.entries}};function Fu(r){
return r}o(Fu,"identity")});var Ir=P((Rf,ji)=>{y();var qu=Tr();ji.exports={create:function(r,e){return{parse:function(){
return qu.parse(r,e)}}}}});var Wi=P((Mf,Ki)=>{"use strict";y();var Ou=/(\d{1,})-(\d{2})-(\d{2}) (\d{2}):(\d{2}):(\d{2})(\.\d{1,})?.*?( BC)?$/,
ku=/^(\d{1,})-(\d{2})-(\d{2})( BC)?$/,Qu=/([Z+-])(\d{2})?:?(\d{2})?:?(\d{2})?/,$u=/^-?infinity$/;
Ki.exports=o(function(e){if($u.test(e))return Number(e.replace("i","I"));var t=Ou.
exec(e);if(!t)return ju(e)||null;var n=!!t[8],i=parseInt(t[1],10);n&&(i=Hi(i));var s=parseInt(
t[2],10)-1,a=t[3],u=parseInt(t[4],10),c=parseInt(t[5],10),l=parseInt(t[6],10),h=t[7];
h=h?1e3*parseFloat(h):0;var f,d=Hu(e);return d!=null?(f=new Date(Date.UTC(i,s,a,
u,c,l,h)),Pr(i)&&f.setUTCFullYear(i),d!==0&&f.setTime(f.getTime()-d)):(f=new Date(
i,s,a,u,c,l,h),Pr(i)&&f.setFullYear(i)),f},"parseDate");function ju(r){var e=ku.
exec(r);if(e){var t=parseInt(e[1],10),n=!!e[4];n&&(t=Hi(t));var i=parseInt(e[2],
10)-1,s=e[3],a=new Date(t,i,s);return Pr(t)&&a.setFullYear(t),a}}o(ju,"getDate");
function Hu(r){if(r.endsWith("+00"))return 0;var e=Qu.exec(r.split(" ")[1]);if(e){
var t=e[1];if(t==="Z")return 0;var n=t==="-"?-1:1,i=parseInt(e[2],10)*3600+parseInt(
e[3]||0,10)*60+parseInt(e[4]||0,10);return i*n*1e3}}o(Hu,"timeZoneOffset");function Hi(r){
return-(r-1)}o(Hi,"bcYearToNegativeYear");function Pr(r){return r>=0&&r<100}o(Pr,
"is0To99")});var Vi=P((qf,Gi)=>{y();Gi.exports=Wu;var Ku=Object.prototype.hasOwnProperty;function Wu(r){
for(var e=1;e<arguments.length;e++){var t=arguments[e];for(var n in t)Ku.call(t,
n)&&(r[n]=t[n])}return r}o(Wu,"extend")});var Yi=P((Qf,Ji)=>{"use strict";y();var Gu=Vi();Ji.exports=Ge;function Ge(r){if(!(this instanceof
Ge))return new Ge(r);Gu(this,sc(r))}o(Ge,"PostgresInterval");var Vu=["seconds","\
minutes","hours","days","months","years"];Ge.prototype.toPostgres=function(){var r=Vu.
...
"")),t+" "+e},this).join(" ")};var zu={years:"Y",months:"M",days:"D",hours:"H",minutes:"\
M",seconds:"S"},Ju=["years","months","days"],Yu=["hours","minutes","seconds"];Ge.
prototype.toISOString=Ge.prototype.toISO=function(){var r=Ju.map(t,this).join(""),
e=Yu.map(t,this).join("");return"P"+r+"T"+e;function t(n){var i=this[n]||0;return n===
"seconds"&&this.milliseconds&&(i=(i+this.milliseconds/1e3).toFixed(6).replace(/0+$/,
"")),i+zu[n]}};var Br="([+-]?\\d+)",Zu=Br+"\\s+years?",Xu=Br+"\\s+mons?",ec=Br+"\
\\s+days?",tc="([+-])?([\\d]*):(\\d\\d):(\\d\\d)\\.?(\\d{1,6})?",rc=new RegExp([
Zu,Xu,ec,tc].map(function(r){return"("+r+")?"}).join("\\s*")),zi={years:2,months:4,
days:6,hours:9,minutes:10,seconds:11,milliseconds:12},nc=["hours","minutes","sec\
onds","milliseconds"];function ic(r){var e=r+"000000".slice(r.length);return parseInt(
e,10)/1e3}o(ic,"parseMilliseconds");function sc(r){if(!r)return{};var e=rc.exec(
r),t=e[8]==="-";return Object.keys(zi).reduce(function(n,i){var s=zi[i],a=e[s];return!a||
(a=i==="milliseconds"?ic(a):parseInt(a,10),!a)||(t&&~nc.indexOf(i)&&(a*=-1),n[i]=
a),n},{})}o(sc,"parse")});var Xi=P((Hf,Zi)=>{"use strict";y();Zi.exports=o(function(e){if(/^\\x/.test(e))return new w(
...
"\\";n+=Math.floor(i/2)*2}return new w(t,"binary")},"parseBytea")});var as=P((Gf,ss)=>{y();var yt=Tr(),wt=Ir(),kt=Wi(),ts=Yi(),rs=Xi();function Qt(r){
...
r==="1"}o(ns,"parseBool");function ac(r){return r?yt.parse(r,ns):null}o(ac,"pars\
eBoolArray");function oc(r){return parseInt(r,10)}o(oc,"parseBaseTenInt");function Rr(r){
return r?yt.parse(r,Qt(oc)):null}o(Rr,"parseIntegerArray");function uc(r){return r?
yt.parse(r,Qt(function(e){return is(e).trim()})):null}o(uc,"parseBigIntegerArray");
var cc=o(function(r){if(!r)return null;var e=wt.create(r,function(t){return t!==
...
parseDateArray"),lc=o(function(r){if(!r)return null;var e=wt.create(r,function(t){
return t!==null&&(t=ts(t)),t});return e.parse()},"parseIntervalArray"),hc=o(function(r){
...
1).split(","),{x:parseFloat(r[0]),y:parseFloat(r[1])})},"parsePoint"),fc=o(function(r){
if(r[0]!=="<"&&r[1]!=="(")return null;for(var e="(",t="",n=!1,i=2;i<r.length-1;i++){
if(n||(e+=r[i]),r[i]===")"){n=!0;continue}else if(!n)continue;r[i]!==","&&(t+=r[i])}
var s=Fr(e);return s.radius=parseFloat(t),s},"parseCircle"),dc=o(function(r){r(20,
is),r(21,Dr),r(23,Dr),r(26,Dr),r(700,parseFloat),r(701,parseFloat),r(16,ns),r(1082,
kt),r(1114,kt),r(1184,kt),r(600,Fr),r(651,ye),r(718,fc),r(1e3,ac),r(1001,hc),r(1005,
Rr),r(1007,Rr),r(1028,Rr),r(1016,uc),r(1017,cc),r(1021,Nr),r(1022,Nr),r(1231,Nr),
r(1014,ye),r(1015,ye),r(1008,ye),r(1009,ye),r(1040,ye),r(1041,ye),r(1115,Mr),r(1182,
Mr),r(1185,Mr),r(1186,ts),r(1187,lc),r(17,rs),r(114,JSON.parse.bind(JSON)),r(3802,
JSON.parse.bind(JSON)),r(199,es),r(3807,es),r(3907,ye),r(2951,ye),r(791,ye),r(1183,
ye),r(1270,ye)},"init");ss.exports={init:dc}});var us=P((Jf,os)=>{"use strict";y();var le=1e6;function pc(r){var e=r.readInt32BE(
...
c+="0";i=c+u+i}return s=e%le,a=4294967296*s+t,u=""+a%le,n+u+i}o(pc,"readInt8");os.
exports=pc});var ds=P((Xf,fs)=>{y();var yc=us(),V=o(function(r,e,t,n,i){t=t||0,n=n||!1,i=i||function(S,E,v){
...
-1)*Math.pow(2,s-n)*c},"parseFloatFromBits"),wc=o(function(r){return V(r,1)==1?-1*
(V(r,15,1,!0)+1):V(r,15,1)},"parseInt16"),cs=o(function(r){return V(r,1)==1?-1*(V(
r,31,1,!0)+1):V(r,31,1)},"parseInt32"),mc=o(function(r){return hs(r,23,8)},"pars\
eFloat32"),gc=o(function(r){return hs(r,52,11)},"parseFloat64"),Sc=o(function(r){
...
ay"),Ec=o(function(r){return r.toString("utf8")},"parseText"),bc=o(function(r){return r===
null?null:V(r,8)>0},"parseBool"),xc=o(function(r){r(20,yc),r(21,wc),r(23,cs),r(26,
cs),r(1700,Sc),r(700,mc),r(701,gc),r(16,bc),r(1114,ls.bind(null,!1)),r(1184,ls.bind(
null,!0)),r(1e3,mt),r(1007,mt),r(1016,mt),r(1008,mt),r(1009,mt),r(25,Ec)},"init");
fs.exports={init:xc}});var ys=P((rd,ps)=>{y();ps.exports={BOOL:16,BYTEA:17,CHAR:18,INT8:20,INT2:21,INT4:23,
...
REGCONFIG:3734,REGDICTIONARY:3769,JSONB:3802,REGNAMESPACE:4089,REGROLE:4096}});var Et=P(St=>{y();var Ac=as(),vc=ds(),Cc=Ir(),_c=ys();St.getTypeParser=Lc;St.setTypeParser=
Uc;St.arrayParser=Cc;St.builtins=_c;var gt={text:{},binary:{}};function ws(r){return String(
r)}o(ws,"noParse");function Lc(r,e){return e=e||"text",gt[e]&&gt[e][r]||ws}o(Lc,
"getTypeParser");function Uc(r,e,t){typeof e=="function"&&(t=e,e="text"),gt[e][r]=
t}o(Uc,"setTypeParser");Ac.init(function(r,e){gt.text[r]=e});vc.init(function(r,e){
gt.binary[r]=e})});var bt=P((od,qr)=>{"use strict";y();qr.exports={host:"localhost",user:g.platform===
...
20,"text"),Ic=Ve.getTypeParser(1016,"text");qr.exports.__defineSetter__("parseIn\
t8",function(r){Ve.setTypeParser(20,"text",r?Ve.getTypeParser(23,"text"):Tc),Ve.
setTypeParser(1016,"text",r?Ve.getTypeParser(1007,"text"):Ic)})});var xt=P((cd,gs)=>{"use strict";y();var Pc=(Lr(),Y(_r)),Bc=bt();function Rc(r){var e=r.
replace(/\\/g,"\\\\").replace(/"/g,'\\"');return'"'+e+'"'}o(Rc,"escapeElement");
...
toString("hex"):e+=Rc($t(r[t]));return e=e+"}",e}o(ms,"arrayString");var $t=o(function(r,e){
...
r.byteOffset,r.byteOffset+r.byteLength)}return r instanceof Date?Bc.parseInputDatesAsUTC?
Dc(r):Mc(r):Array.isArray(r)?ms(r):typeof r=="object"?Nc(r,e):r.toString()},"pre\
pareValue");function Nc(r,e){if(r&&typeof r.toPostgres=="function"){if(e=e||[],e.
...
o(Nc,"prepareObject");function ae(r,e){for(r=""+r;r.length<e;)r="0"+r;return r}o(
ae,"pad");function Mc(r){var e=-r.getTimezoneOffset(),t=r.getFullYear(),n=t<1;n&&
...
":"+ae(e%60,2),n&&(i+=" BC"),i}o(Mc,"dateToString");function Dc(r){var e=r.getUTCFullYear(),
...
2)+"."+ae(r.getUTCMilliseconds(),3);return n+="+00:00",t&&(n+=" BC"),n}o(Dc,"dat\
eToStringUTC");function Fc(r,e,t){return r=typeof r=="string"?{text:r}:r,e&&(typeof e==
"function"?r.callback=e:r.values=e),t&&(r.callback=t),r}o(Fc,"normalizeQueryConf\
ig");var Or=o(function(r){return Pc.createHash("md5").update(r,"utf-8").digest("\
hex")},"md5"),qc=o(function(r,e,t){var n=Or(e+r),i=Or(w.concat([w.from(n),t]));return"\
md5"+i},"postgresMd5PasswordHash");gs.exports={prepareValue:o(function(e){return $t(
e)},"prepareValueWrapper"),normalizeQueryConfig:Fc,postgresMd5PasswordHash:qc,md5:Or}});var As=P((fd,xs)=>{"use strict";y();var kr=(Lr(),Y(_r));function Oc(r){if(r.indexOf(
...
o(Oc,"startSession");function kc(r,e,t){if(r.message!=="SASLInitialResponse")throw new Error(
...
er nonce does not start with client nonce");var i=w.from(n.salt,"base64"),s=Wc(e,
i,n.iteration),a=ze(s,"Client Key"),u=Kc(a),c="n=*,r="+r.clientNonce,l="r="+n.nonce+
...
se",r.serverSignature=x.toString("base64"),r.response=h+",p="+E}o(kc,"continueSe\
...
CRAM-SERVER-FINAL-MESSAGE: serverData must be a string");let{serverSignature:t}=Hc(
e);if(t!==r.serverSignature)throw new Error("SASL: SCRAM-SERVER-FINAL-MESSAGE: s\
erver signature does not match")}o(Qc,"finalizeSession");function $c(r){if(typeof r!=
"string")throw new TypeError("SASL: text must be a string");return r.split("").map(
(e,t)=>r.charCodeAt(t)).every(e=>e>=33&&e<=43||e>=45&&e<=126)}o($c,"isPrintableC\
...
n=e.substring(2);return[t,n]}))}o(Es,"parseAttributePairs");function jc(r){let e=Es(
r),t=e.get("r");if(t){if(!$c(t))throw new Error("SASL: SCRAM-SERVER-FIRST-MESSAG\
...
ssage");function Hc(r){let t=Es(r).get("v");if(t){if(!Ss(t))throw new Error("SAS\
...
o(Hc,"parseServerFinalMessage");function bs(r,e){if(!w.isBuffer(r))throw new TypeError(
...
from(r.map((t,n)=>r[n]^e[n]))}o(bs,"xorBuffers");function Kc(r){return kr.createHash(
"sha256").update(r).digest()}o(Kc,"sha256");function ze(r,e){return kr.createHmac(
"sha256",r).update(e).digest()}o(ze,"hmacSha256");function Wc(r,e,t){for(var n=ze(
r,w.concat([e,w.from([0,0,0,1])])),i=n,s=0;s<t-1;s++)n=ze(r,n),i=bs(i,n);return i}
o(Wc,"Hi");xs.exports={startSession:Oc,continueSession:kc,finalizeSession:Qc}});var Qr={};fe(Qr,{join:()=>Gc});function Gc(...r){return r.join("/")}var $r=oe(()=>{
"use strict";y();o(Gc,"join")});var jr={};fe(jr,{stat:()=>Vc});function Vc(r,e){e(new Error("No filesystem"))}var Hr=oe(
()=>{"use strict";y();o(Vc,"stat")});var Kr={};fe(Kr,{default:()=>zc});var zc,Wr=oe(()=>{"use strict";y();zc={}});var vs={};fe(vs,{StringDecoder:()=>Gr});var Gr,Cs=oe(()=>{"use strict";y();Gr=class{static{
o(this,"StringDecoder")}td;constructor(e){this.td=new TextDecoder(e)}write(e){return this.
td.decode(e,{stream:!0})}end(e){return this.td.decode(e)}}});var Ts=P((xd,Us)=>{"use strict";y();var{Transform:Jc}=(Wr(),Y(Kr)),{StringDecoder:Yc}=(Cs(),Y(vs)),
Te=Symbol("last"),jt=Symbol("decoder");function Zc(r,e,t){let n;if(this.overflow){
...
t(new Error("maximum buffer reached"));return}t()}o(Zc,"transform");function Xc(r){
if(this[Te]+=this[jt].end(),this[Te])try{Ls(this,this.mapper(this[Te]))}catch(e){
return r(e)}r()}o(Xc,"flush");function Ls(r,e){e!==void 0&&r.push(e)}o(Ls,"push");
function _s(r){return r}o(_s,"noop");function el(r,e,t){switch(r=r||/\r?\n/,e=e||
...
assign({},t),t.autoDestroy=!0,t.transform=Zc,t.flush=Xc,t.readableObjectMode=!0;
let n=new Jc(t);return n[Te]="",n[jt]=new Yc("utf8"),n.matcher=r,n.mapper=e,n.maxLength=
t.maxLength,n.skipOverflow=t.skipOverflow||!1,n.overflow=!1,n._destroy=function(i,s){
this._writableState.errorEmitted=!1,s(i)},n}o(el,"split");Us.exports=el});var Bs=P((Cd,Ae)=>{"use strict";y();var Is=($r(),Y(Qr)),tl=(Wr(),Y(Kr)).Stream,rl=Ts(),
Ps=(ft(),Y(ht)),nl=5432,Ht=g.platform==="win32",At=g.stderr,il=56,sl=7,al=61440,
ol=32768;function ul(r){return(r&al)==ol}o(ul,"isRegFile");var Je=["host","port",
"database","user","password"],Vr=Je.length,cl=Je[Vr-1];function zr(){var r=At instanceof
tl&&At.writable===!0;if(r){var e=Array.prototype.slice.call(arguments).concat(`
...
call(g.env,"PGPASSWORD")?!1:Ht?!0:(e=e||"<unkn>",ul(r.mode)?r.mode&(il|sl)?(zr('\
...
e),!1))};var ll=Ae.exports.match=function(r,e){return Je.slice(0,-1).reduce(function(t,n,i){
return i==1&&Number(r[n]||nl)===Number(e[n])?t&&!0:t&&(e[n]==="*"||e[n]===r[n])},
!0)};Ae.exports.getPassword=function(r,e,t){var n,i=e.pipe(rl());function s(c){var l=hl(
c);l&&fl(l)&&ll(r,l)&&(n=l[cl],i.end())}o(s,"onLine");var a=o(function(){e.destroy(),
...
u)};var hl=Ae.exports.parseLine=function(r){if(r.length<11||r.match(/^\s+#/))return null;
...
Object.keys(a).length===Vr?a:null,a},fl=Ae.exports.isValidEntry=function(r){for(var e={
...
1){var n=e[t],i=r[Je[t]]||"",s=n(i);if(!s)return!1}return!0}});var Ns=P((Td,Jr)=>{"use strict";y();var Ud=($r(),Y(Qr)),Rs=(Hr(),Y(jr)),Kt=Bs();
...
e)})};Jr.exports.warnTo=Kt.warnTo});var Yr=P((Pd,Ms)=>{"use strict";y();var dl=Et();function Wt(r){this._types=r||dl,
...
"text",this.getOverrides(e)[r]||this._types.getTypeParser(r,e)};Ms.exports=Wt});var Ds={};fe(Ds,{default:()=>pl});var pl,Fs=oe(()=>{"use strict";y();pl={}});var qs={};fe(qs,{parse:()=>Zr});function Zr(r,e=!1){let{protocol:t}=new URL(r),n="\
...
()=>{"use strict";y();o(Zr,"parse")});var ks=P((Fd,Os)=>{"use strict";y();var yl=(Xr(),Y(qs)),en=(Hr(),Y(jr));function tn(r){
if(r.charAt(0)==="/"){var t=r.split(" ");return{host:t[0],database:t[1]}}var e=yl.
...
return t}o(tn,"parse");Os.exports=tn;tn.parse=tn});var Gt=P((kd,js)=>{"use strict";y();var wl=(Fs(),Y(Ds)),$s=bt(),Qs=ks().parse,ue=o(
function(r,e,t){return t===void 0?t=g.env["PG"+r.toUpperCase()]:t===!1||(t=g.env[t]),
e[r]||t||$s[r]},"val"),ml=o(function(){switch(g.env.PGSSLMODE){case"disable":return!1;case"\
...
teParamValue"),gl=o(function(r){return r.split(".")[0]},"extractProjectValue"),we=o(
function(r,e,t){var n=e[t];n!=null&&r.push(t+"="+Ye(n))},"add"),rn=class{static{
o(this,"ConnectionParameters")}constructor(e){e=typeof e=="string"?Qs(e):e||{},e.
connectionString&&(e=Object.assign({},e,Qs(e.connectionString))),this.user=ue("u\
...
ml():e.ssl,typeof this.ssl=="string"&&this.ssl==="true"&&(this.ssl=!0),this.ssl===
...
t.push("project="+gl(this.host))),this.isDomainSocket)return e(null,t.join(" "));
this.client_encoding&&t.push("client_encoding="+Ye(this.client_encoding)),wl.lookup(
this.host,function(i,s){return i?e(i,null):(t.push("hostaddr="+Ye(s)),e(null,t.join(
" ")))})}};js.exports=rn});var Ws=P((jd,Ks)=>{"use strict";y();var Sl=Et(),Hs=/^([A-Za-z]+)(?: (\d+))?(?: (\d+))?/,
...
this._types.getTypeParser(n.dataTypeID,n.format||"text"):this._parsers[t]=Sl.getTypeParser(
n.dataTypeID,n.format||"text")}}};Ks.exports=nn});var Js=P((Wd,zs)=>{"use strict";y();var{EventEmitter:El}=Ue(),Gs=Ws(),Vs=xt(),sn=class extends El{static{
...
fetchFunction:void 0,webSocketConstructor:void 0,wsProxy:e=>e+"/v2",useSecureWebSocket:!0,
forceDisablePgSSL:!0,coalesceWrites:!0,pipelineConnect:"password",subtls:void 0,
rootCerts:"",pipelineTLS:!1,disableSNI:!1};static opts={};opts={};static get poolQueryViaFetch(){
...
"notice"}};I.NoticeMessage=Sn});var ea=P(zt=>{"use strict";y();Object.defineProperty(zt,"__esModule",{value:!0});
...
size),t}};zt.Writer=bn});var ra=P(Yt=>{"use strict";y();Object.defineProperty(Yt,"__esModule",{value:!0});
Yt.serialize=void 0;var xn=ea(),z=new xn.Writer,Cl=o(r=>{z.addInt16(3).addInt16(
...
Writer().addInt32(t).add(e).flush()},"startup"),_l=o(()=>{let r=w.allocUnsafe(8);
return r.writeInt32BE(8,0),r.writeInt32BE(80877103,4),r},"requestSsl"),Ll=o(r=>z.
addCString(r).flush(112),"password"),Ul=o(function(r,e){return z.addCString(r).addInt32(
w.byteLength(e)).addString(e),z.flush(112)},"sendSASLInitialResponseMessage"),Tl=o(
function(r){return z.addString(r).flush(112)},"sendSCRAMClientFinalMessage"),Il=o(
r=>z.addCString(r).flush(81),"query"),ta=[],Pl=o(r=>{let e=r.name||"";e.length>63&&
...
flush(80)},"parse"),Ze=new xn.Writer,Bl=o(function(r,e){for(let t=0;t<r.length;t++){
...
n)),Ze.addString(n))}},"writeValues"),Rl=o((r={})=>{let e=r.portal||"",t=r.statement||
"",n=r.binary||!1,i=r.values||ta,s=i.length;return z.addCString(e).addCString(t),
z.addInt16(s),Bl(i,r.valueMapper),z.addInt16(s),z.add(Ze.flush()),z.addInt16(n?1:
0),z.flush(66)},"bind"),Nl=w.from([69,0,0,0,9,0,0,0,0,0]),Ml=o(r=>{if(!r||!r.portal&&
!r.rows)return Nl;let e=r.portal||"",t=r.rows||0,n=w.byteLength(e),i=4+n+1+4,s=w.
allocUnsafe(1+i);return s[0]=69,s.writeInt32BE(i,1),s.write(e,5,"utf-8"),s[n+5]=
0,s.writeUInt32BE(t,s.length-4),s},"execute"),Dl=o((r,e)=>{let t=w.allocUnsafe(16);
...
"cstringMessage"),Fl=z.addCString("P").flush(68),ql=z.addCString("S").flush(68),
Ol=o(r=>r.name?An(68,`${r.type}${r.name||""}`):r.type==="P"?Fl:ql,"describe"),kl=o(
r=>{let e=`${r.type}${r.name||""}`;return An(67,e)},"close"),Ql=o(r=>z.add(r).flush(
100),"copyData"),$l=o(r=>An(102,r),"copyFail"),Jt=o(r=>w.from([r,0,0,0,4]),"code\
OnlyBuffer"),jl=Jt(72),Hl=Jt(83),Kl=Jt(88),Wl=Jt(99),Gl={startup:Cl,password:Ll,
requestSsl:_l,sendSASLInitialResponseMessage:Ul,sendSCRAMClientFinalMessage:Tl,query:Il,
parse:Pl,bind:Rl,execute:Ml,describe:Ol,close:kl,flush:()=>jl,sync:()=>Hl,end:()=>Kl,
copyData:Ql,copyDone:()=>Wl,copyFail:$l,cancel:Dl};Yt.serialize=Gl});var na=P(Zt=>{"use strict";y();Object.defineProperty(Zt,"__esModule",{value:!0});
Zt.BufferReader=void 0;var Vl=w.allocUnsafe(0),vn=class{static{o(this,"BufferRea\
der")}constructor(e=0){this.offset=e,this.buffer=Vl,this.encoding="utf-8"}setBuffer(e,t){
...
offset+e);return this.offset+=e,t}};Zt.BufferReader=vn});var ia={};fe(ia,{default:()=>zl});var zl,sa=oe(()=>{"use strict";y();zl={}});var ua=P(Xe=>{"use strict";y();var Jl=Xe&&Xe.__importDefault||function(r){return r&&
r.__esModule?r:{default:r}};Object.defineProperty(Xe,"__esModule",{value:!0});Xe.
Parser=void 0;var J=En(),Yl=na(),Zl=Jl((sa(),Y(ia))),Cn=1,Xl=4,aa=Cn+Xl,oa=w.allocUnsafe(
0),_n=class{static{o(this,"Parser")}constructor(e){if(this.buffer=oa,this.bufferLength=
0,this.bufferOffset=0,this.reader=new Yl.BufferReader,e?.mode==="binary")throw new Error(
...
Ie.DatabaseError=Ie.serialize=Ie.parse=void 0;var eh=En();Object.defineProperty(
Ie,"DatabaseError",{enumerable:!0,get:function(){return eh.DatabaseError}});var th=ra();
Object.defineProperty(Ie,"serialize",{enumerable:!0,get:function(){return th.serialize}});
var rh=ua();function nh(r,e){let t=new rh.Parser;return r.on("data",n=>t.parse(n,
e)),new Promise(n=>r.on("end",()=>n()))}o(nh,"parse");Ie.parse=nh});var ca={};fe(ca,{connect:()=>ih});function ih({socket:r,servername:e}){return r.
startTls(e),r}var la=oe(()=>{"use strict";y();o(ih,"connect")});var Tn=P((gp,da)=>{"use strict";y();var ha=(Vt(),Y(Xs)),sh=Ue().EventEmitter,{parse:ah,
serialize:ee}=Ln(),fa=ee.flush(),oh=ee.sync(),uh=ee.end(),Un=class extends sh{static{
...
stream.write(uh,()=>{this.stream.end()})}close(e){this._send(ee.close(e))}describe(e){
this._send(ee.describe(e))}sendCopyFromChunk(e){this._send(ee.copyData(e))}endCopyFrom(){
this._send(ee.copyDone())}sendCopyFail(e){this._send(ee.copyFail(e))}};da.exports=
Un});var wa=P((xp,ya)=>{"use strict";y();var ch=Ue().EventEmitter,bp=(ft(),Y(ht)),lh=xt(),
In=As(),hh=Ns(),fh=Yr(),dh=Gt(),pa=Js(),ph=bt(),yh=Tn(),Xt=class extends ch{static{
...
_Promise(t=>{this.connection.once("end",t)})}};Xt.Query=pa;ya.exports=Xt});var Ea=P((Cp,Sa)=>{"use strict";y();var wh=Ue().EventEmitter,ma=o(function(){},"\
...
has already been released to the pool.")}o(mh,"throwOnDoubleRelease");function er(r,e){
...
callback:i,result:s}}o(er,"promisify");function gh(r,e){return o(function t(n){n.
...
idleListener")}o(gh,"makeIdleListener");var Bn=class extends wh{static{o(this,"P\
...
length}};Sa.exports=Bn});var ba={};fe(ba,{default:()=>Sh});var Sh,xa=oe(()=>{"use strict";y();Sh={}});var Aa=P((Tp,Eh)=>{Eh.exports={name:"pg",version:"8.8.0",description:"PostgreSQL\
...
7b9a5491a178655"}});var _a=P((Ip,Ca)=>{"use strict";y();var va=Ue().EventEmitter,bh=(ft(),Y(ht)),Rn=xt(),
tt=Ca.exports=function(r,e,t){va.call(this),r=Rn.normalizeQueryConfig(r,e,t),this.
...
newListener",function(n){n==="row"&&(this._emitRowEvents=!0)}.bind(this))};bh.inherits(
tt,va);var xh={sqlState:"code",statementPosition:"position",messagePrimary:"mess\
...
text,t)}});var Ia=P((Np,Ta)=>{"use strict";y();var Ah=(xa(),Y(ba)),vh=Yr(),Rp=Aa(),La=Ue().
EventEmitter,Ch=(ft(),Y(ht)),_h=Gt(),Ua=_a(),he=Ta.exports=function(r){La.call(this),
r=r||{},this._Promise=r.Promise||_.Promise,this._types=new vh(r.types),this.native=
new Ah({types:this._types}),this._queryQueue=[],this._ending=!1,this._connecting=
...
e.port,this.namedQueries={}};he.Query=Ua;Ch.inherits(he,La);he.prototype._errorAllQueries=
...
_types.getTypeParser(r,e)}});var Nn=P((Fp,Pa)=>{"use strict";y();Pa.exports=Ia()});var tr=P((kp,vt)=>{"use strict";y();var Lh=wa(),Uh=bt(),Th=Tn(),Ih=Ea(),{DatabaseError:Ph}=Ln(),
Bh=o(r=>class extends Ih{static{o(this,"BoundPool")}constructor(t){super(t,r)}},
"poolFactory"),Mn=o(function(r){this.defaults=Uh,this.Client=r,this.Query=this.Client.
Query,this.Pool=Bh(this.Client),this._pools=[],this.Connection=Th,this.types=Et(),
this.DatabaseError=Ph},"PG");typeof g.env.NODE_PG_FORCE_NATIVE<"u"?vt.exports=new Mn(
Nn()):(vt.exports=new Mn(Lh),Object.defineProperty(vt.exports,"native",{configurable:!0,
enumerable:!1,get(){var r=null;try{r=new Mn(Nn())}catch(e){if(e.code!=="MODULE_N\
OT_FOUND")throw e}return Object.defineProperty(vt.exports,"native",{value:r}),r}}))});y();var Ar={};fe(Ar,{SocketReadQueue:()=>tu,TrustedCert:()=>wi,WebSocketReadQueue:()=>eu,
startTls:()=>Xo});y();function ie(...r){if(r.length===1&&r[0]instanceof Uint8Array)return r[0];let e=r.
...
ui=new TextEncoder,Po=new TextDecoder,Se=class{static{o(this,"N")}offset;dataView;data;comments;indents;indent;constructor(r){
...
offset,this.offset+=r)}readUTF8String(r){let e=this.subarray(r);return Po.decode(
...
${mr.repeat(t)}`)}return e}};function Bo(r,e,t,n=!0){let i=new Se(1024);i.writeUint8(
...
e)),B(),C(),m(),h(),a(),s(),i}o(Bo,"St");function _e(r,e=""){return[...r].map(t=>t.
toString(16).padStart(2,"0")).join(e)}o(_e,"K");function Ro(r,e){let t,n,[i]=r.expectLength(
...
o(Ro,"Ut");var Vh=new RegExp(`  .+|^(${mr})+`,"gm"),ut=16384,No=ut+1+255;async function gr(r,e,t=ut){
...
o(gr,"ht");async function Sr(r,e,t){let n=await gr(r,23,No);if(n===void 0)return;
...
toString(16).padStart(2,"0")})`);return l}}o(Sr,"dt");async function Mo(r,e,t){let n=ie(
...
l.length-16)),u(),a.array()}o(Mo,"ee");async function ci(r,e,t){let n=Math.ceil(
r.length/ut),i=[];for(let s=0;s<n;s++){let a=r.subarray(s*ut,(s+1)*ut),u=await Mo(
...
var i=new Uint8Array(await F.sign("HMAC",n,e));return i}o(Er,"lt");async function Do(r,e,t,n){
...
c=d}return a.subarray(0,t)}o(Do,"ne");var li=pi.encode("tls13 ");async function se(r,e,t,n,i){
let s=pi.encode(e),a=ie([(n&65280)>>8,n&255],[li.length+s.length],li,s,[t.length],
t);return Do(r,a,n,i)}o(se,"S");async function Fo(r,e,t,n,i){let s=n>>>3,a=new Uint8Array(
...
handshakeSecret:x,clientSecret:T,serverSecret:b}}o(Fo,"Kt");async function qo(r,e,t,n){
...
clientApplicationKey:d,clientApplicationIV:E}}o(qo,"Tt");var Rt=class{static{o(this,
...
o(Nt,"yt");function Oo(r){let e=r.length,t=0,n=0,i=64,s=64,a=64,u=64,c=new Uint8Array(
...
6|u;let l=s===64?0:a===64?2:u===64?1:0;return c.subarray(0,n-l)}o(Oo,"Dt");var Mt=class extends Se{static{
...
"mt");var pr=1,Dt=2,ne=48,ko=49,He=6,Qo=19,$o=12,fi=23,yr=5,Me=4,wr=3,jo=163,je=128,
Ho={"2.5.4.6":"C","2.5.4.10":"O","2.5.4.11":"OU","2.5.4.3":"CN","2.5.4.7":"L","2\
.5.4.8":"ST","2.5.4.12":"T","2.5.4.42":"GN","2.5.4.43":"I","2.5.4.4":"SN","1.2.8\
40.113549.1.9.1":"E-mail"};function Ko(r){let{length:e}=r;if(e>4)throw new Error(
`Bit string length ${e} would overflow JS bit operators`);let t=0,n=0;for(let i=r.
length-1;i>=0;i--)t|=r[i]<<n,n+=8;return t}o(Ko,"qt");function di(r,e){let t={};
r.expectUint8(ne,0);let[n,i]=r.expectASN1Length(0);for(;i()>0;){r.expectUint8(ko,
0);let[s]=r.expectASN1Length(0);r.expectUint8(ne,0);let[a]=r.expectASN1Length(0);
r.expectUint8(He,0);let u=r.readASN1OID(),c=Ho[u]??u,l=r.readUint8();if(l!==Qo&&
l!==$o)throw new Error(`Unexpected item type in certificate ${e}: 0x${_e([l])}`);
...
di,"Ct");function Wo(r,e=0){let t=[],[n,i]=r.expectASN1Length(0);for(;i()>0;){let s=r.
readUint8(0),[a,u]=r.expectASN1Length(0),c;s===(e|2)?c=r.readUTF8String(u()):c=r.
readBytes(u()),t.push({name:c,type:s}),a()}return n(),t}o(Wo,"Bt");function Go(r){
...
throw new Error(`Unsupported algorithm identifier: ${r}`);return e}o(Go,"Ft");function yi(r,e=[]){
return Object.values(r).forEach(t=>{typeof t=="string"?e=[...e,t]:e=yi(t,e)}),e}
o(yi,"Ot");function Vo(r){return yi(r).join(" / ")}o(Vo,"Pt");var zo=["digitalSi\
...
data:b,all:t.data.subarray(S,t.offset)},E(),t.expectUint8(jo,0);let[m]=t.expectASN1Length();
...
let j=Wo(t,je);this.subjectAltNames=j.filter(G=>G.type===(2|je)).map(G=>G.name),
...
H=Ko(G),D=new Set(zo.filter((K,W)=>H&1<<W));j(),this.keyUsage={critical:$,usages:D}}else if(Q===
...
pathLength}`:"")+`
signature algorithm: `+Vo(Go(this.algorithm))}toJSON(){return{serialNumber:[...this.
...
pported signing algorithm");if(d){a=!0;break}}return a}o(Jo,"jt");var Yo=new TextEncoder;
...
u);x.push(Z),M();let[be,qe]=u.expectLengthUint16(),Dn=u.subarray(qe());be()}if(E(),
...
N=ie(Yo.encode(" ".repeat(64)+"TLS 1.3, server CertificateVerify"),[0],B);u.remaining()===
0&&u.extend(await e()),u.expectUint8(15,0);let[O]=u.expectLengthUint24(0),k=u.readUint16();
if(k===1027){let[M]=u.expectLengthUint16();await mi(u,T.publicKey.all,N,"P-256",
...
ify hash");if(!await Jo(r,x,i,s,a))throw new Error("Validated certificate chain \
did not end in a trusted root");return[u.data,f]}o(Zo,"Vt");async function Xo(r,e,t,n,{
...
"raw",h.publicKey),d=new Uint8Array(32);A.getRandomValues(d);let S=Bo(r,f,d,i).array(),
...
"Connection closed while awaiting server hello");let x=new Se(v.content),T=Ro(x,
...
1,0),C();let B=S.subarray(5),N=v.content,O=ie(B,N),k=await Fo(T,h.privateKey,O,256,
...
ed server handshake");return re},"C"),[G,H]=await Zo(r,j,k.serverSecret,O,e,s,a),
...
0),32,256),Fa=await F.importKey("raw",Dn,{name:"HMAC",hash:{name:"SHA-256"}},!1,
["sign"]),qa=await F.sign("HMAC",Fa,qe),Oa=new Uint8Array(qa),Lt=new Se(36);Lt.writeUint8(
20,0);let ka=Lt.writeLengthUint24(0);Lt.writeBytes(Oa),ka();let Qa=Lt.array(),Fn=await ci(
ie(M,Qa),$,22),qn=qe;if(M.length>0){let re=Z.subarray(0,Z.length-M.length),it=await F.
digest("SHA-256",re);qn=new Uint8Array(it)}let Ut=await qo(k.handshakeSecret,qn,
256,16),$a=await F.importKey("raw",Ut.clientApplicationKey,{name:"AES-GCM"},!0,[
"encrypt"]),ja=new Rt("encrypt",$a,Ut.clientApplicationIV),Ha=await F.importKey(
"raw",Ut.serverApplicationKey,{name:"AES-GCM"},!0,["decrypt"]),Ka=new Rt("decryp\
t",Ha,Ut.serverApplicationIV),Tt=!1;return[()=>{if(!Tt){let re=ie(W,...Fn);n(re),
Tt=!0}return Sr(t,Ka)},async re=>{let it=Tt;Tt=!0;let On=await ci(re,ja,23),Wa=it?
ie(...On):ie(W,...Fn,...On);n(Wa)}]}o(Xo,"he");var gi=class{static{o(this,"xt")}queue;outstandingRequest;constructor(){
...
{resolve:e,bytes:r},this.dequeue()})}},eu=class extends gi{static{o(this,"vt")}constructor(r){
...
socket:r}=this,{readyState:e}=r;return e<=1}},tu=class extends gi{static{o(this,
...
-----END CERTIFICATE-----
`;y();var nu=Object.getOwnPropertyNames,iu=Object.getOwnPropertySymbols,su=Object.prototype.
...
function bi(r){return nu(r).concat(iu(r))}o(bi,"getStrictProperties");var Ui=Object.
hasOwn||function(r,e){return su.call(r,e)};function Ke(r,e){return r||e?r===e:r===
e||r!==r&&e!==e}o(Ke,"sameValueZeroEqual");var Ti="_owner",xi=Object.getOwnPropertyDescriptor,
Ai=Object.keys;function au(r,e,t){var n=r.length;if(e.length!==n)return!1;for(;n-- >
0;)if(!t.equals(r[n],e[n],n,n,r,e,t))return!1;return!0}o(au,"areArraysEqual");function ou(r,e){
return Ke(r.getTime(),e.getTime())}o(ou,"areDatesEqual");function vi(r,e,t){if(r.
...
r,e,t))&&(n[h]=!0),h++}if(!l)return!1;s++}return!0}o(vi,"areMapsEqual");function uu(r,e,t){
...
e[s],s,s,r,e,t))return!1;return!0}o(uu,"areObjectsEqual");function lt(r,e,t){var n=bi(
...
reObjectsEqualStrict");function cu(r,e){return Ke(r.valueOf(),e.valueOf())}o(cu,
"arePrimitiveWrappersEqual");function lu(r,e){return r.source===e.source&&r.flags===
e.flags}o(lu,"areRegExpsEqual");function Ci(r,e,t){if(r.size!==e.size)return!1;for(var n={},
...
l++;if(!c)return!1}return!0}o(Ci,"areSetsEqual");function hu(r,e){var t=r.length;
if(e.length!==t)return!1;for(;t-- >0;)if(r[t]!==e[t])return!1;return!0}o(hu,"are\
TypedArraysEqual");var fu="[object Arguments]",du="[object Boolean]",pu="[object\
 Date]",yu="[object Map]",wu="[object Number]",mu="[object Object]",gu="[object \
RegExp]",Su="[object Set]",Eu="[object String]",bu=Array.isArray,_i=typeof ArrayBuffer==
"function"&&ArrayBuffer.isView?ArrayBuffer.isView:null,Li=Object.assign,xu=Object.
prototype.toString.call.bind(Object.prototype.toString);function Au(r){var e=r.areArraysEqual,
...
h,f,d);if(bu(h))return e(h,f,d);if(_i!=null&&_i(h))return c(h,f,d);if(S===Date)return t(
h,f,d);if(S===RegExp)return a(h,f,d);if(S===Map)return n(h,f,d);if(S===Set)return u(
h,f,d);var E=xu(h);return E===pu?t(h,f,d):E===gu?a(h,f,d):E===yu?n(h,f,d):E===Su?
u(h,f,d):E===mu?typeof h.then!="function"&&typeof f.then!="function"&&i(h,f,d):E===
fu?i(h,f,d):E===du||E===wu||E===Eu?s(h,f,d):!1},"comparator")}o(Au,"createEquali\
tyComparator");function vu(r){var e=r.circular,t=r.createCustomConfig,n=r.strict,
i={areArraysEqual:n?lt:au,areDatesEqual:ou,areMapsEqual:n?Ei(vi,lt):vi,areObjectsEqual:n?
lt:uu,arePrimitiveWrappersEqual:cu,areRegExpsEqual:lu,areSetsEqual:n?Ei(Ci,lt):Ci,
areTypedArraysEqual:n?lt:hu};if(t&&(i=Li({},i,t(i))),e){var s=Ft(i.areArraysEqual),
a=Ft(i.areMapsEqual),u=Ft(i.areObjectsEqual),c=Ft(i.areSetsEqual);i=Li({},i,{areArraysEqual:s,
areMapsEqual:a,areObjectsEqual:u,areSetsEqual:c})}return i}o(vu,"createEqualityC\
omparatorConfig");function Cu(r){return function(e,t,n,i,s,a,u){return r(e,t,u)}}
o(Cu,"createInternalEqualityComparator");function _u(r){var e=r.circular,t=r.comparator,
...
strict:s};return o(function(c,l){return t(c,l,a)},"isEqual")}o(_u,"createIsEqual");
var vr=Le(),af=Le({strict:!0}),of=Le({circular:!0}),uf=Le({circular:!0,strict:!0}),
cf=Le({createInternalComparator:function(){return Ke}}),lf=Le({strict:!0,createInternalComparator:function(){
return Ke}}),hf=Le({circular:!0,createInternalComparator:function(){return Ke}}),
ff=Le({circular:!0,createInternalComparator:function(){return Ke},strict:!0});function Le(r){
r===void 0&&(r={});var e=r.circular,t=e===void 0?!1:e,n=r.createInternalComparator,
i=r.createState,s=r.strict,a=s===void 0?!1:s,u=vu(r),c=Au(u),l=n?n(c):Cu(c);return _u(
{circular:t,comparator:c,createState:i,equals:l,strict:a})}o(Le,"createCustomEqu\
al");y();var rr=at(tr());Vt();y();Xr();Vt();var Na=at(xt());var De=class extends Error{static{o(this,"NeonDbError")}name="NeonDbError";code=null;sourceError},
...
m=m.map(O=>(0,Na.prepareValue)(O));let N={query:C,params:m};return u&&u(N),Rh(T,
N,B)}o(x,"resolve"),x.transaction=async(b,m)=>{if(typeof b=="function"&&(b=b(x)),
!Array.isArray(b))throw new Error(Ba);let C=b.map(B=>{if(B[Symbol.toStringTag]!==
"NeonQueryPromise")throw new Error(Ba);return B.parameterizedQuery});return T(C,
...
W))throw new De("Neon internal error: unexpected result format");return W.map((M,Z)=>Ra(
M,{arrayMode:R,fullResults:Q,parameterizedQuery:b[Z],resultCallback:c}))}else return Ra(
...
T,"execute"),x}o(Ee,"neon");function Rh(r,e,t){return{[Symbol.toStringTag]:"Neon\
QueryPromise",parameterizedQuery:e,opts:t,then:(n,i)=>r(e,t).then(n,i),catch:n=>r(
e,t).catch(n),finally:n=>r(e,t).finally(n)}}o(Rh,"createNeonQueryPromise");function Ra(r,{
...
t?(r.viaNeonFetch=!0,r.rowAsArray=e,r.rows=u,r):u}o(Ra,"processQueryResult");var Ma=at(Gt()),Pe=at(tr());var ve=class extends rr.Client{constructor(t){super(t);this.config=t}static{o(this,
...
d attribute pair entry");let M=W[0],Z=W.substring(2);return[M,Z]})),u=a.r,c=a.s,
...
function Nh(r,e){if(e)return{callback:e,result:void 0};let t,n,i=o(function(a,u){
a?t(a):n(u)},"cb"),s=new r(function(a,u){n=a,t=u});return{callback:i,result:s}}o(
Nh,"promisify");var Fe=class extends rr.Pool{static{o(this,"NeonPool")}Client=ve;hasFetchUnsupportedListeners=!1;on(e,t){
...
return super.query(e,t,n);typeof t=="function"&&(n=t,t=void 0);let i=Nh(this.Promise,
n);n=i.callback;try{let s=new Ma.default(this.options),a=encodeURIComponent,u=encodeURI,
...
array"})(l,h).then(d=>n(void 0,d)).catch(d=>n(d))}catch(s){n(s)}return i.result}};y();async function Mh(r){let e=Date.now(),t=await r();return[Date.now()-e,t]}o(Mh,"t\
imed");async function rt(r,e,t=(n,i)=>{}){let n=[];for(let s=0;s<r;s++){let a=await Mh(
...
ation/json"}})}o(p0,"cf");var Be={waitUntil(r){},passThroughOnException(){}};async function Dh(r,e=(...t)=>{}){
...
e("caught invalid password passed to `neon()`\n")}o(Dh,"batchQueryTest");async function y0(r,e,t=(...n)=>{}){
...
c,5e3)`SELECT ${"did this time out?"} AS str`,await Dh(r,t),de.fetchFunction=(d,S)=>(console.
...
error(`
*** ${T.message}`)}}))}}o(y0,"latencies");export{Dh as batchQueryTest,p0 as cf,y0 as latencies,de as neonConfig};
