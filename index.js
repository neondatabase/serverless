...
enumerable:!0})},Ln=(r,e,t,n)=>{if(e&&typeof e=="object"||typeof e=="function")for(let i of bo(e))!So.
call(r,i)&&i!==t&&Ie(r,i,{get:()=>e[i],enumerable:!(n=wo(e,i))||n.enumerable});return r};var Se=(r,e,t)=>(t=r!=null?go(vo(r)):{},Ln(e||!r||!r.__esModule?Ie(t,"default",{value:r,enumerable:!0}):
t,r)),D=r=>Ln(Ie({},"__esModule",{value:!0}),r);var E=(r,e,t)=>xo(r,typeof e!="symbol"?e+"":e,t);var kn=T(ct=>{"use strict";p();ct.byteLength=Ao;ct.toByteArray=Co;ct.fromByteArray=Po;var ue=[],te=[],
...
function Ao(r){var e=Mn(r),t=e[0],n=e[1];return(t+n)*3/4-n}a(Ao,"byteLength");function _o(r,e,t){return(e+
t)*3/4-t}a(_o,"_byteLength");function Co(r){var e,t=Mn(r),n=t[0],i=t[1],s=new Eo(_o(r,n,i)),o=0,u=i>
...
i.push(ue[e>>10]+ue[e>>4&63]+ue[e<<2&63]+"=")),i.join("")}a(Po,"fromByteArray")});var Un=T(Dt=>{p();Dt.read=function(r,e,t,n,i){var s,o,u=i*8-n-1,c=(1<<u)-1,l=c>>1,f=-7,y=t?i-1:0,g=t?
...
_,u/=256,i-=8);for(o=o<<i|u,l+=i;l>0;r[t+A]=o&255,A+=_,o/=256,l-=8);r[t+A-_]|=q*128}});var Xn=T(Be=>{"use strict";p();var Ot=kn(),Pe=Un(),Dn=typeof Symbol=="function"&&typeof Symbol.for==
"function"?Symbol.for("nodejs.util.inspect.custom"):null;Be.Buffer=h;Be.SlowBuffer=ko;Be.INSPECT_MAX_BYTES=
50;var lt=2147483647;Be.kMaxLength=lt;h.TYPED_ARRAY_SUPPORT=Ro();!h.TYPED_ARRAY_SUPPORT&&typeof console<
...
'The "string" argument must be of type string. Received type number');return jt(r)}return Nn(r,e,t)}
a(h,"Buffer");h.poolSize=8192;function Nn(r,e,t){if(typeof r=="string")return Lo(r,e);if(ArrayBuffer.
...
for option "size"')}a(jn,"assertSize");function Bo(r,e,t){return jn(r),r<=0?pe(r):e!==void 0?typeof t==
...
let e=new Uint8Array(r);return qt(e.buffer,e.byteOffset,e.byteLength)}return Qt(r)}a(Fo,"fromArrayVi\
...
r,e,t),Object.setPrototypeOf(n,h.prototype),n}a(qt,"fromArrayBuffer");function Mo(r){if(h.isBuffer(r)){
...
a(Mo,"fromObject");function Wt(r){if(r>=lt)throw new RangeError("Attempt to allocate Buffer larger t\
han maximum size: 0x"+lt.toString(16)+" bytes");return r|0}a(Wt,"checked");function ko(r){return+r!=
...
if(i)return n?-1:Nt(r).length;e=(""+e).toLowerCase(),i=!0}}a(Wn,"byteLength");h.byteLength=Wn;function Uo(r,e,t){
...
tf8":case"utf-8":return Gn(this,e,t);case"ascii":return Ho(this,e,t);case"latin1":case"binary":return Go(
...
h.prototype.lastIndexOf=a(function(e,t,n){return Hn(this,e,t,n,!1)},"lastIndexOf");function Do(r,e,t,n){
...
return ft(Nt(e,r.length-t),r,t,n)}a(Oo,"utf8Write");function Qo(r,e,t,n){return ft(Zo(e),r,t,n)}a(Qo,
"asciiWrite");function qo(r,e,t,n){return ft(Jn(e),r,t,n)}a(qo,"base64Write");function No(r,e,t,n){return ft(
...
a(jo,"base64Slice");function Gn(r,e,t){t=Math.min(r.length,t);let n=[],i=e;for(;i<t;){let s=r[i],o=null,
...
n.push(o),i+=u}return Wo(n)}a(Gn,"utf8Slice");var Qn=4096;function Wo(r){let e=r.length;if(e<=Qn)return String.
fromCharCode.apply(String,r);let t="",n=0;for(;n<e;)t+=String.fromCharCode.apply(String,r.slice(n,n+=
Qn));return t}a(Wo,"decodeCodePointsArray");function Ho(r,e,t){let n="";t=Math.min(r.length,t);for(let i=e;i<
...
if(t<0)throw new RangeError("Index out of range")}a(zn,"checkIEEE754");function Kn(r,e,t,n,i){return e=
+e,t=t>>>0,i||zn(r,e,t,4,34028234663852886e22,-34028234663852886e22),Pe.write(r,e,t,n,23,4),t+4}a(Kn,
"writeFloat");h.prototype.writeFloatLE=a(function(e,t,n){return Kn(this,e,t,!0,n)},"writeFloatLE");h.
prototype.writeFloatBE=a(function(e,t,n){return Kn(this,e,t,!1,n)},"writeFloatBE");function Yn(r,e,t,n,i){
...
Re(e,"offset"),(r[e]===void 0||r[e+t]===void 0)&&He(e,r.length-(t+1))}a(zo,"checkBounds");function Zn(r,e,t,n,i,s){
...
nd <= ${t}${o}`,new Te.ERR_OUT_OF_RANGE("value",u,r)}zo(n,i,s)}a(Zn,"checkIntBI");function Re(r,e){if(typeof r!=
...
new Te.ERR_OUT_OF_RANGE(t||"offset",`>= ${t?1:0} and <= ${e}`,r)}a(He,"boundsError");var Ko=/[^+/0-9A-Za-z-_]/g;
function Yo(r){if(r=r.split("=")[0],r=r.trim().replace(Ko,""),r.length<2)return"";for(;r.length%4!==
0;)r=r+"=";return r}a(Yo,"base64clean");function Nt(r,e){e=e||1/0;let t,n=r.length,i=null,s=[];for(let o=0;o<
...
o),n=t>>8,i=t%256,s.push(i),s.push(n);return s}a(Jo,"utf16leToBytes");function Jn(r){return Ot.toByteArray(
Yo(r))}a(Jn,"base64ToBytes");function ft(r,e,t,n){let i;for(i=0;i<n&&!(i+t>=e.length||i>=r.length);++i)
...
m.nextTick(()=>{})}catch{let e=Promise.resolve();m.nextTick=e.then.bind(e)}});var we=T((Tl,$t)=>{"use strict";p();var Le=typeof Reflect=="object"?Reflect:null,ei=Le&&typeof Le.apply==
...
void 0;R.prototype._eventsCount=0;R.prototype._maxListeners=void 0;var ti=10;function pt(r){if(typeof r!=
...
length,f=ui(c,l),n=0;n<l;++n)ei(f[n],this,t);return!0},"emit");function ii(r,e,t,n){var i,s,o;if(pt(
...
r,u.type=e,u.count=o.length,ta(u)}return r}a(ii,"_addListener");R.prototype.addListener=a(function(e,t){
return ii(this,e,t,!1)},"addListener");R.prototype.on=R.prototype.addListener;R.prototype.prependListener=
a(function(e,t){return ii(this,e,t,!0)},"prependListener");function ra(){if(!this.fired)return this.
...
rap");R.prototype.once=a(function(e,t){return pt(t),this.on(e,si(this,e,t)),this},"once");R.prototype.
prependOnceListener=a(function(e,t){return pt(t),this.prependListener(e,si(this,e,t)),this},"prepend\
...
ia(i):ui(i,i.length)}a(oi,"_listeners");R.prototype.listeners=a(function(e){return oi(this,e,!0)},"l\
...
return this._eventsCount>0?ht(this._events):[]},"eventNames");function ui(r,e){for(var t=new Array(e),
n=0;n<e;++n)t[n]=r[n];return t}a(ui,"arrayClone");function na(r,e){for(;e+1<r.length;e++)r[e]=r[e+1];
...
oa(r,i,{once:!0})})}a(sa,"once");function oa(r,e,t){typeof r.on=="function"&&ci(r,"error",e,t)}a(oa,
...
ust be of type EventEmitter. Received type '+typeof r)}a(ci,"eventTargetAgnosticAddListener")});var hi={};ee(hi,{Socket:()=>de,isIP:()=>aa});function aa(r){return 0}var fi,li,x,de,Ge=z(()=>{"use s\
trict";p();fi=Se(we(),1);a(aa,"isIP");li=/^[^.]+\./,x=class x extends fi.EventEmitter{constructor(){
...
pathname:l,search:f,query:_,hash:g}}var zt=z(()=>{"use strict";p();a(Vt,"parse")});var Zt=T(bi=>{"use strict";p();bi.parse=function(r,e){return new Yt(r,e).parse()};var gt=class gt{constructor(e,t){
...
dimension>1&&(n=new gt(this.source.substr(this.position-1),this.transform),this.entries.push(n.parse(
...
not balanced");return this.entries}};a(gt,"ArrayParser");var Yt=gt;function va(r){return r}a(va,"ide\
ntity")});var Jt=T((Hl,vi)=>{p();var Sa=Zt();vi.exports={create:a(function(r,e){return{parse:a(function(){return Sa.
parse(r,e)},"parse")}},"create")}});var Ei=T((Vl,xi)=>{"use strict";p();var xa=/(\d{1,})-(\d{2})-(\d{2}) (\d{2}):(\d{2}):(\d{2})(\.\d{1,})?.*?( BC)?$/,
Ea=/^(\d{1,})-(\d{2})-(\d{2})( BC)?$/,Aa=/([Z+-])(\d{2})?:?(\d{2})?:?(\d{2})?/,_a=/^-?infinity$/;xi.
exports=a(function(e){if(_a.test(e))return Number(e.replace("i","I"));var t=xa.exec(e);if(!t)return Ca(
e)||null;var n=!!t[8],i=parseInt(t[1],10);n&&(i=Si(i));var s=parseInt(t[2],10)-1,o=t[3],u=parseInt(t[4],
10),c=parseInt(t[5],10),l=parseInt(t[6],10),f=t[7];f=f?1e3*parseFloat(f):0;var y,g=Ia(e);return g!=null?
(y=new Date(Date.UTC(i,s,o,u,c,l,f)),Xt(i)&&y.setUTCFullYear(i),g!==0&&y.setTime(y.getTime()-g)):(y=
new Date(i,s,o,u,c,l,f),Xt(i)&&y.setFullYear(i)),y},"parseDate");function Ca(r){var e=Ea.exec(r);if(e){
var t=parseInt(e[1],10),n=!!e[4];n&&(t=Si(t));var i=parseInt(e[2],10)-1,s=e[3],o=new Date(t,i,s);return Xt(
...
e[3]||0,10)*60+parseInt(e[4]||0,10);return i*n*1e3}}a(Ia,"timeZoneOffset");function Si(r){return-(r-
1)}a(Si,"bcYearToNegativeYear");function Xt(r){return r>=0&&r<100}a(Xt,"is0To99")});var _i=T((Yl,Ai)=>{p();Ai.exports=Pa;var Ta=Object.prototype.hasOwnProperty;function Pa(r){for(var e=1;e<
arguments.length;e++){var t=arguments[e];for(var n in t)Ta.call(t,n)&&(r[n]=t[n])}return r}a(Pa,"ext\
end")});var Ti=T((Xl,Ii)=>{"use strict";p();var Ra=_i();Ii.exports=Fe;function Fe(r){if(!(this instanceof Fe))
...
/0+$/,"")),i+La[n]}};var er="([+-]?\\d+)",ka=er+"\\s+years?",Ua=er+"\\s+mons?",Da=er+"\\s+days?",Oa="\
([+-])?([\\d]*):(\\d\\d):(\\d\\d)\\.?(\\d{1,6})?",Qa=new RegExp([ka,Ua,Da,Oa].map(function(r){return"\
("+r+")?"}).join("\\s*")),Ci={years:2,months:4,days:6,hours:9,minutes:10,seconds:11,milliseconds:12},
...
keys(Ci).reduce(function(n,i){var s=Ci[i],o=e[s];return!o||(o=i==="milliseconds"?Na(o):parseInt(o,10),
!o)||(t&&~qa.indexOf(i)&&(o*=-1),n[i]=o),n},{})}a(ja,"parse")});var Ri=T((rf,Pi)=>{"use strict";p();Pi.exports=a(function(e){if(/^\\x/.test(e))return new d(e.substr(
...
parseBytea")});var Di=T((of,Ui)=>{p();var ze=Zt(),Ke=Jt(),wt=Ei(),Li=Ti(),Fi=Ri();function bt(r){return a(function(t){
return t===null?t:r(t)},"nullAllowed")}a(bt,"allowNull");function Mi(r){return r===null?r:r==="TRUE"||
r==="t"||r==="true"||r==="y"||r==="yes"||r==="on"||r==="1"}a(Mi,"parseBool");function Wa(r){return r?
ze.parse(r,Mi):null}a(Wa,"parseBoolArray");function Ha(r){return parseInt(r,10)}a(Ha,"parseBaseTenIn\
t");function tr(r){return r?ze.parse(r,bt(Ha)):null}a(tr,"parseIntegerArray");function Ga(r){return r?
ze.parse(r,bt(function(e){return ki(e).trim()})):null}a(Ga,"parseBigIntegerArray");var $a=a(function(r){
if(!r)return null;var e=Ke.create(r,function(t){return t!==null&&(t=sr(t)),t});return e.parse()},"pa\
rsePointArray"),rr=a(function(r){if(!r)return null;var e=Ke.create(r,function(t){return t!==null&&(t=
parseFloat(t)),t});return e.parse()},"parseFloatArray"),re=a(function(r){if(!r)return null;var e=Ke.
create(r);return e.parse()},"parseStringArray"),nr=a(function(r){if(!r)return null;var e=Ke.create(r,
function(t){return t!==null&&(t=wt(t)),t});return e.parse()},"parseDateArray"),Va=a(function(r){if(!r)
return null;var e=Ke.create(r,function(t){return t!==null&&(t=Li(t)),t});return e.parse()},"parseInt\
ervalArray"),za=a(function(r){return r?ze.parse(r,bt(Fi)):null},"parseByteAArray"),ir=a(function(r){
return parseInt(r,10)},"parseInteger"),ki=a(function(r){var e=String(r);return/^\d+$/.test(e)?e:r},"\
parseBigInteger"),Bi=a(function(r){return r?ze.parse(r,bt(JSON.parse)):null},"parseJsonArray"),sr=a(
...
r[i])}var s=sr(e);return s.radius=parseFloat(t),s},"parseCircle"),Ya=a(function(r){r(20,ki),r(21,ir),
r(23,ir),r(26,ir),r(700,parseFloat),r(701,parseFloat),r(16,Mi),r(1082,wt),r(1114,wt),r(1184,wt),r(600,
sr),r(651,re),r(718,Ka),r(1e3,Wa),r(1001,za),r(1005,tr),r(1007,tr),r(1028,tr),r(1016,Ga),r(1017,$a),
r(1021,rr),r(1022,rr),r(1231,rr),r(1014,re),r(1015,re),r(1008,re),r(1009,re),r(1040,re),r(1041,re),r(
1115,nr),r(1182,nr),r(1185,nr),r(1186,Li),r(1187,Va),r(17,Fi),r(114,JSON.parse.bind(JSON)),r(3802,JSON.
parse.bind(JSON)),r(199,Bi),r(3807,Bi),r(3907,re),r(2951,re),r(791,re),r(1183,re),r(1270,re)},"init");
Ui.exports={init:Ya}});var Qi=T((cf,Oi)=>{"use strict";p();var Y=1e6;function Za(r){var e=r.readInt32BE(0),t=r.readUInt32BE(
...
""+o%Y,n+u+i}a(Za,"readInt8");Oi.exports=Za});var Hi=T((hf,Wi)=>{p();var Ja=Qi(),F=a(function(r,e,t,n,i){t=t||0,n=n||!1,i=i||function(A,_,q){return A*
...
r,31,1,!0)+1):F(r,31,1)},"parseInt32"),eu=a(function(r){return ji(r,23,8)},"parseFloat32"),tu=a(function(r){
return ji(r,52,11)},"parseFloat64"),ru=a(function(r){var e=F(r,16,32);if(e==49152)return NaN;for(var t=Math.
pow(1e4,F(r,16,16)),n=0,i=[],s=F(r,16),o=0;o<s;o++)n+=F(r,16,64+16*o)*t,t/=1e4;var u=Math.pow(10,F(r,
16,48));return(e===0?1:-1)*Math.round(n*u)/u},"parseNumeric"),Ni=a(function(r,e){var t=F(e,1),n=F(e,
...
usec=s},i.getUTCMicroSeconds=function(){return this.usec},i},"parseDate"),Ye=a(function(r){for(var e=F(
...
r(701,tu),r(16,iu),r(1114,Ni.bind(null,!1)),r(1184,Ni.bind(null,!0)),r(1e3,Ye),r(1007,Ye),r(1016,Ye),
r(1008,Ye),r(1009,Ye),r(25,nu)},"init");Wi.exports={init:su}});var $i=T((yf,Gi)=>{p();Gi.exports={BOOL:16,BYTEA:17,CHAR:18,INT8:20,INT2:21,INT4:23,REGPROC:24,TEXT:25,
...
REGROLE:4096}});var Xe=T(Je=>{p();var ou=Di(),au=Hi(),uu=Jt(),cu=$i();Je.getTypeParser=lu;Je.setTypeParser=fu;Je.arrayParser=
uu;Je.builtins=cu;var Ze={text:{},binary:{}};function Vi(r){return String(r)}a(Vi,"noParse");function lu(r,e){
return e=e||"text",Ze[e]&&Ze[e][r]||Vi}a(lu,"getTypeParser");function fu(r,e,t){typeof e=="function"&&
(t=e,e="text"),Ze[e][r]=t}a(fu,"setTypeParser");ou.init(function(r,e){Ze.text[r]=e});au.init(function(r,e){
Ze.binary[r]=e})});var St=T((vf,zi)=>{"use strict";p();var hu=Xe();function vt(r){this._types=r||hu,this.text={},this.binary=
...
e||"text",this.getOverrides(e)[r]||this._types.getTypeParser(r,e)};zi.exports=vt});function et(r){let e=1779033703,t=3144134277,n=1013904242,i=2773480762,s=1359893119,o=2600822924,u=528734635,
...
for(let B=0;B<64;B++){let G=g(N,6)^g(N,11)^g(N,25),fe=N&ie^~N&se,_e=oe+G+fe+y[B]+A[B]|0,he=g(C,2)^g(
C,13)^g(C,22),Ce=C&S^C&H^S&H,ae=he+Ce|0;oe=se,se=ie,ie=N,N=le+_e|0,le=H,H=S,S=C,C=_e+ae|0}e=e+C|0,t=
...
return r===void 0?{add:P,digest:L}:(P(r),L())}var Ki=z(()=>{"use strict";p();a(et,"sha256")});var U,tt,Yi=z(()=>{"use strict";p();U=class U{constructor(){E(this,"_dataLength",0);E(this,"_bufferL\
...
abcdef"),E(U,"hexOut",[]),E(U,"onePassHasher",new U);tt=U});var or={};ee(or,{createHash:()=>du,createHmac:()=>yu,randomBytes:()=>pu});function pu(r){return crypto.
...
"digest")}},"update")}}var ar=z(()=>{"use strict";p();Ki();Yi();a(pu,"randomBytes");a(du,"createHash");
a(yu,"createHmac")});var rt=T((Ff,ur)=>{"use strict";p();ur.exports={host:"localhost",user:m.platform==="win32"?m.env.USERNAME:
...
keepalives:1,keepalives_idle:0};var Me=Xe(),mu=Me.getTypeParser(20,"text"),gu=Me.getTypeParser(1016,
"text");ur.exports.__defineSetter__("parseInt8",function(r){Me.setTypeParser(20,"text",r?Me.getTypeParser(
23,"text"):mu),Me.setTypeParser(1016,"text",r?Me.getTypeParser(1007,"text"):gu)})});var nt=T((kf,Ji)=>{"use strict";p();var wu=(ar(),D(or)),bu=rt();function vu(r){var e=r.replace(/\\/g,
"\\\\").replace(/"/g,'\\"');return'"'+e+'"'}a(vu,"escapeElement");function Zi(r){for(var e="{",t=0;t<
r.length;t++)t>0&&(e=e+","),r[t]===null||typeof r[t]>"u"?e=e+"NULL":Array.isArray(r[t])?e=e+Zi(r[t]):
r[t]instanceof d?e+="\\\\x"+r[t].toString("hex"):e+=vu(xt(r[t]));return e=e+"}",e}a(Zi,"arrayString");
var xt=a(function(r,e){if(r==null)return null;if(r instanceof d)return r;if(ArrayBuffer.isView(r)){var t=d.
from(r.buffer,r.byteOffset,r.byteLength);return t.length===r.byteLength?t:t.slice(r.byteOffset,r.byteOffset+
r.byteLength)}return r instanceof Date?bu.parseInputDatesAsUTC?Eu(r):xu(r):Array.isArray(r)?Zi(r):typeof r==
...
r query');return e.push(r),xt(r.toPostgres(xt),e)}return JSON.stringify(r)}a(Su,"prepareObject");function W(r,e){
...
t),r}a(Au,"normalizeQueryConfig");var cr=a(function(r){return wu.createHash("md5").update(r,"utf-8").
digest("hex")},"md5"),_u=a(function(r,e,t){var n=cr(e+r),i=cr(d.concat([d.from(n),t]));return"md5"+i},
"postgresMd5PasswordHash");Ji.exports={prepareValue:a(function(e){return xt(e)},"prepareValueWrapper"),
normalizeQueryConfig:Au,postgresMd5PasswordHash:_u,md5:cr}});var it={};ee(it,{default:()=>Pu});var Pu,st=z(()=>{"use strict";p();Pu={}});var cs=T(($f,us)=>{"use strict";p();var fr=(ar(),D(or));function Ru(r){if(r.indexOf("SCRAM-SHA-256")===
...
a(as,"xorBuffers");function Uu(r){return fr.createHash("sha256").update(r).digest()}a(Uu,"sha256");function ke(r,e){
return fr.createHmac("sha256",r).update(e).digest()}a(ke,"hmacSha256");function Du(r,e,t){for(var n=ke(
r,d.concat([e,d.from([0,0,0,1])])),i=n,s=0;s<t-1;s++)n=ke(r,n),i=as(i,n);return i}a(Du,"Hi");us.exports=
{startSession:Ru,continueSession:Bu,finalizeSession:Lu}});var hr={};ee(hr,{join:()=>Ou});function Ou(...r){return r.join("/")}var pr=z(()=>{"use strict";p();a(
Ou,"join")});var dr={};ee(dr,{stat:()=>Qu});function Qu(r,e){e(new Error("No filesystem"))}var yr=z(()=>{"use str\
ict";p();a(Qu,"stat")});var mr={};ee(mr,{default:()=>qu});var qu,gr=z(()=>{"use strict";p();qu={}});var ls={};ee(ls,{StringDecoder:()=>wr});var br,wr,fs=z(()=>{"use strict";p();br=class br{constructor(e){
E(this,"td");this.td=new TextDecoder(e)}write(e){return this.td.decode(e,{stream:!0})}end(e){return this.
td.decode(e)}};a(br,"StringDecoder");wr=br});var ys=T((rh,ds)=>{"use strict";p();var{Transform:Nu}=(gr(),D(mr)),{StringDecoder:ju}=(fs(),D(ls)),be=Symbol(
"last"),At=Symbol("decoder");function Wu(r,e,t){let n;if(this.overflow){if(n=this[At].write(r).split(
...
"maximum buffer reached"));return}t()}a(Wu,"transform");function Hu(r){if(this[be]+=this[At].end(),this[be])
...
!0;let n=new Nu(t);return n[be]="",n[At]=new ju("utf8"),n.matcher=r,n.mapper=e,n.maxLength=t.maxLength,
n.skipOverflow=t.skipOverflow||!1,n.overflow=!1,n._destroy=function(i,s){this._writableState.errorEmitted=
!1,s(i)},n}a(Gu,"split");ds.exports=Gu});var ws=T((sh,me)=>{"use strict";p();var ms=(pr(),D(hr)),$u=(gr(),D(mr)).Stream,Vu=ys(),gs=(st(),D(it)),
zu=5432,_t=m.platform==="win32",ot=m.stderr,Ku=56,Yu=7,Zu=61440,Ju=32768;function Xu(r){return(r&Zu)==
Ju}a(Xu,"isRegFile");var Ue=["host","port","database","user","password"],vr=Ue.length,ec=Ue[vr-1];function Sr(){
var r=ot instanceof $u&&ot.writable===!0;if(r){var e=Array.prototype.slice.call(arguments).concat(`
`);ot.write(gs.format.apply(gs,e))}}a(Sr,"warn");Object.defineProperty(me.exports,"isWin",{get:a(function(){
return _t},"get"),set:a(function(r){_t=r},"set")});me.exports.warnTo=function(r){var e=ot;return ot=
...
return Object.prototype.hasOwnProperty.call(m.env,"PGPASSWORD")?!1:_t?!0:(e=e||"<unkn>",Xu(r.mode)?r.
mode&(Ku|Yu)?(Sr('WARNING: password file "%s" has group or world access; permissions should be u=rw \
(0600) or less',e),!1):!0:(Sr('WARNING: password file "%s" is not a plain file',e),!1))};var tc=me.exports.
...
void 0)},"onErr");e.on("error",u),i.on("data",s).on("end",o).on("error",u)};var rc=me.exports.parseLine=
...
length===vr?o:null,o},nc=me.exports.isValidEntry=function(r){for(var e={0:function(o){return o.length>
...
0}},t=0;t<Ue.length;t+=1){var n=e[t],i=r[Ue[t]]||"",s=n(i);if(!s)return!1}return!0}});var vs=T((ch,xr)=>{"use strict";p();var uh=(pr(),D(hr)),bs=(yr(),D(dr)),Ct=ws();xr.exports=function(r,e){
var t=Ct.getFileName();bs.stat(t,function(n,i){if(n||!Ct.usePgPass(i,t))return e(void 0);var s=bs.createReadStream(
t);Ct.getPassword(r,s,e)})};xr.exports.warnTo=Ct.warnTo});var Ss={};ee(Ss,{default:()=>ic});var ic,xs=z(()=>{"use strict";p();ic={}});var As=T((hh,Es)=>{"use strict";p();var sc=(zt(),D(pi)),Er=(yr(),D(dr));function Ar(r){if(r.charAt(0)===
...
!1;break}}return t}a(Ar,"parse");Es.exports=Ar;Ar.parse=Ar});var It=T((yh,Is)=>{"use strict";p();var oc=(xs(),D(Ss)),Cs=rt(),_s=As().parse,$=a(function(r,e,t){return t===
...
var n=e[t];n!=null&&r.push(t+"="+De(n))},"add"),Cr=class Cr{constructor(e){e=typeof e=="string"?_s(e):
...
a(Cr,"ConnectionParameters");var _r=Cr;Is.exports=_r});var Rs=T((wh,Ps)=>{"use strict";p();var uc=Xe(),Ts=/^([A-Za-z]+)(?: (\d+))?(?: (\d+))?/,Tr=class Tr{constructor(e,t){
...
format||"text")}}};a(Tr,"Result");var Ir=Tr;Ps.exports=Ir});var Ms=T((Sh,Fs)=>{"use strict";p();var{EventEmitter:cc}=we(),Bs=Rs(),Ls=nt(),Rr=class Rr extends cc{constructor(e,t,n){
...
e.sendCopyFail("No source stream defined")}handleCopyData(e,t){}};a(Rr,"Query");var Pr=Rr;Fs.exports=
...
I.CopyResponse=Fr;var zr=class zr{constructor(e,t,n,i,s,o,u){this.name=e,this.tableID=t,this.columnID=
n,this.dataTypeID=i,this.dataTypeSize=s,this.dataTypeModifier=o,this.format=u}};a(zr,"Field");var Mr=zr;
I.Field=Mr;var Kr=class Kr{constructor(e,t){this.length=e,this.fieldCount=t,this.name="rowDescriptio\
n",this.fields=new Array(this.fieldCount)}};a(Kr,"RowDescriptionMessage");var kr=Kr;I.RowDescriptionMessage=
...
ge");var qr=en;I.NotificationResponseMessage=qr;var tn=class tn{constructor(e,t){this.length=e,this.
status=t,this.name="readyForQuery"}};a(tn,"ReadyForQueryMessage");var Nr=tn;I.ReadyForQueryMessage=Nr;
...
ssage");var Hr=sn;I.NoticeMessage=Hr});var ks=T(Tt=>{"use strict";p();Object.defineProperty(Tt,"__esModule",{value:!0});Tt.Writer=void 0;var un=class un{constructor(e=256){
...
headerPosition=0,this.buffer=d.allocUnsafe(this.size),t}};a(un,"Writer");var an=un;Tt.Writer=an});var Ds=T(Rt=>{"use strict";p();Object.defineProperty(Rt,"__esModule",{value:!0});Rt.serialize=void 0;
var cn=ks(),M=new cn.Writer,lc=a(r=>{M.addInt16(3).addInt16(0);for(let n of Object.keys(r))M.addCString(
n).addCString(r[n]);M.addCString("client_encoding").addCString("UTF8");var e=M.addCString("").flush(),
t=e.length+4;return new cn.Writer().addInt32(t).add(e).flush()},"startup"),fc=a(()=>{let r=d.allocUnsafe(
...
n),s=0;s<n;s++)i.addInt32(t[s]);return M.flush(80)},"parse"),Oe=new cn.Writer,gc=a(function(r,e){for(let t=0;t<
...
6),t.writeInt32BE(r,8),t.writeInt32BE(e,12),t},"cancel"),ln=a((r,e)=>{let n=4+d.byteLength(e)+1,i=d.
allocUnsafe(1+n);return i[0]=r,i.writeInt32BE(n,1),i.write(e,5,"utf-8"),i[n]=0,i},"cstringMessage"),
xc=M.addCString("P").flush(68),Ec=M.addCString("S").flush(68),Ac=a(r=>r.name?ln(68,`${r.type}${r.name||
""}`):r.type==="P"?xc:Ec,"describe"),_c=a(r=>{let e=`${r.type}${r.name||""}`;return ln(67,e)},"close"),
Cc=a(r=>M.add(r).flush(100),"copyData"),Ic=a(r=>ln(102,r),"copyFail"),Pt=a(r=>d.from([r,0,0,0,4]),"c\
odeOnlyBuffer"),Tc=Pt(72),Pc=Pt(83),Rc=Pt(88),Bc=Pt(99),Lc={startup:lc,password:hc,requestSsl:fc,sendSASLInitialResponseMessage:pc,
...
cancel:Sc};Rt.serialize=Lc});var Os=T(Bt=>{"use strict";p();Object.defineProperty(Bt,"__esModule",{value:!0});Bt.BufferReader=void 0;
var Fc=d.allocUnsafe(0),hn=class hn{constructor(e=0){this.offset=e,this.buffer=Fc,this.encoding="utf\
...
Mc=Os(),pn=1,kc=4,Qs=pn+kc,qs=d.allocUnsafe(0),yn=class yn{constructor(e){if(this.buffer=qs,this.bufferLength=
...
i+pn),u=pn+o;if(u+i<=n){let c=this.handlePacket(i+Qs,s,o,this.buffer);t(c),i+=u}else break}i===n?(this.
...
serialize=ve.parse=void 0;var Uc=on();Object.defineProperty(ve,"DatabaseError",{enumerable:!0,get:a(
...
on("data",n=>t.parse(n,e)),new Promise(n=>r.on("end",()=>n()))}a(Qc,"parse");ve.parse=Qc});var js={};ee(js,{connect:()=>qc});function qc({socket:r,servername:e}){return r.startTls(e),r}var Ws=z(
()=>{"use strict";p();a(qc,"connect")});var bn=T((Hh,$s)=>{"use strict";p();var Hs=(Ge(),D(hi)),Nc=we().EventEmitter,{parse:jc,serialize:Q}=mn(),
Gs=Q.flush(),Wc=Q.sync(),Hc=Q.end(),wn=class wn extends Nc{constructor(e){super(),e=e||{},this.stream=
...
this._send(Q.copyDone())}sendCopyFail(e){this._send(Q.copyFail(e))}};a(wn,"Connection");var gn=wn;$s.
exports=gn});var Ks=T((zh,zs)=>{"use strict";p();var Gc=we().EventEmitter,Vh=(st(),D(it)),$c=nt(),vn=cs(),Vc=vs(),
zc=St(),Kc=It(),Vs=Ms(),Yc=rt(),Zc=bn(),Sn=class Sn extends Gc{constructor(e){super(),this.connectionParameters=
...
_Promise(t=>{this.connection.once("end",t)})}};a(Sn,"Client");var Ft=Sn;Ft.Query=Vs;zs.exports=Ft});var Xs=T((Zh,Js)=>{"use strict";p();var Jc=we().EventEmitter,Ys=a(function(){},"NOOP"),Zs=a((r,e)=>{
...
this.callback=e}};a(_n,"PendingItem");var Qe=_n;function Xc(){throw new Error("Release called on cli\
ent which has already been released to the pool.")}a(Xc,"throwOnDoubleRelease");function Mt(r,e){if(e)
...
dleListener")}a(el,"makeIdleListener");var Cn=class Cn extends Jc{constructor(e,t){super(),this.options=
...
this.Client=this.options.Client||t||at().Client,this.Promise=this.options.Promise||w.Promise,typeof this.
...
length}};a(Cn,"Pool");var En=Cn;Js.exports=En});var eo={};ee(eo,{default:()=>tl});var tl,to=z(()=>{"use strict";p();tl={}});var ro=T((tp,rl)=>{rl.exports={name:"pg",version:"8.8.0",description:"PostgreSQL client - pure javas\
...
a178655"}});var so=T((rp,io)=>{"use strict";p();var no=we().EventEmitter,nl=(st(),D(it)),In=nt(),qe=io.exports=function(r,e,t){
no.call(this),r=In.normalizeQueryConfig(r,e,t),this.text=r.text,this.values=r.values,this.name=r.name,
...
prepareValue);r.native.query(this.text,i,t)}else r.native.query(this.text,t)}});var co=T((op,uo)=>{"use strict";p();var sl=(to(),D(eo)),ol=St(),sp=ro(),oo=we().EventEmitter,al=(st(),D(it)),
ul=It(),ao=so(),Z=uo.exports=function(r){oo.call(this),r=r||{},this._Promise=r.Promise||w.Promise,this.
...
r,e,t)};Z.prototype.getTypeParser=function(r,e){return this._types.getTypeParser(r,e)}});var Tn=T((cp,lo)=>{"use strict";p();lo.exports=co()});var at=T((fp,ut)=>{"use strict";p();var cl=Ks(),ll=rt(),fl=bn(),hl=Xs(),{DatabaseError:pl}=mn(),dl=a(
r=>{var e;return e=class extends hl{constructor(n){super(n,r)}},a(e,"BoundPool"),e},"poolFactory"),Pn=a(
function(r){this.defaults=ll,this.Client=r,this.Query=this.Client.Query,this.Pool=dl(this.Client),this.
_pools=[],this.Connection=fl,this.types=Xe(),this.DatabaseError=pl},"PG");typeof m.env.NODE_PG_FORCE_NATIVE<
"u"?ut.exports=new Pn(Tn()):(ut.exports=new Pn(cl),Object.defineProperty(ut.exports,"native",{configurable:!0,
enumerable:!1,get(){var r=null;try{r=new Pn(Tn())}catch(e){if(e.code!=="MODULE_NOT_FOUND")throw e}return Object.
defineProperty(ut.exports,"native",{value:r}),r}}))});var gl={};ee(gl,{Client:()=>Ne,DatabaseError:()=>je.DatabaseError,NeonDbError:()=>ye,Pool:()=>kt,SqlTemplate:()=>Ae,
_bundleExt:()=>ml,defaults:()=>je.defaults,neon:()=>lr,neonConfig:()=>de,types:()=>je.types});module.
exports=D(gl);p();p();Ge();zt();p();var ua=Object.defineProperty,ca=Object.defineProperties,la=Object.getOwnPropertyDescriptors,di=Object.
getOwnPropertySymbols,fa=Object.prototype.hasOwnProperty,ha=Object.prototype.propertyIsEnumerable,yi=a(
(r,e,t)=>e in r?ua(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t,"__defNormalProp"),
pa=a((r,e)=>{for(var t in e||(e={}))fa.call(e,t)&&yi(r,t,e[t]);if(di)for(var t of di(e))ha.call(e,t)&&
yi(r,t,e[t]);return r},"__spreadValues"),da=a((r,e)=>ca(r,la(e)),"__spreadProps"),ya=1008e3,mi=new Uint8Array(
new Uint16Array([258]).buffer)[0]===2,ma=new TextDecoder,Kt=new TextEncoder,dt=Kt.encode("0123456789\
abcdef"),yt=Kt.encode("0123456789ABCDEF"),ga=Kt.encode("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqr\
stuvwxyz0123456789+/");var gi=ga.slice();gi[62]=45;gi[63]=95;var $e,mt;function wa(r,{alphabet:e,scratchArr:t}={}){if(!$e)if($e=
new Uint16Array(256),mt=new Uint16Array(256),mi)for(let _=0;_<256;_++)$e[_]=dt[_&15]<<8|dt[_>>>4],mt[_]=
yt[_&15]<<8|yt[_>>>4];else for(let _=0;_<256;_++)$e[_]=dt[_&15]|dt[_>>>4]<<8,mt[_]=yt[_&15]|yt[_>>>4]<<
8;r.byteOffset%4!==0&&(r=new Uint8Array(r));let n=r.length,i=n>>>1,s=n>>>2,o=t||new Uint16Array(n),u=new Uint32Array(
r.buffer,r.byteOffset,s),c=new Uint32Array(o.buffer,o.byteOffset,i),l=e==="upper"?mt:$e,f=0,y=0,g;if(mi)
...
{},e),{scratchArr:o}))}return t}a(ba,"_toHexChunked");function wi(r,e={}){return e.alphabet!=="upper"&&
typeof r.toHex=="function"?r.toHex():ba(r,e)}a(wi,"toHex");p();var Ve=class Ve{constructor(e,t){this.strings=e;this.values=t}compile(e={query:"",params:[]}){let{strings:t,
values:n}=this;for(let i=0,s=t.length;i<s;i++)if(e.query+=t[i],i<n.length){let o=n[i];if(o instanceof
Ve)o.compile(e);else if(o&&o[Symbol.toStringTag]==="NeonQueryPromise")if(o.query instanceof Ve)o.query.
compile(e);else throw new Error("Only sql`...` template queries are composable");else{let{params:u}=e;
u.push(o),e.query+="$"+u.length}}return e}};a(Ve,"SqlTemplate");var Ae=Ve;var ns=Se(St()),is=Se(nt());var Et=class Et extends Error{constructor(t){super(t);E(this,"name","NeonDbError");E(this,"severity");
...
tackTrace"in Error&&typeof Error.captureStackTrace=="function"&&Error.captureStackTrace(this,Et)}};a(
Et,"NeonDbError");var ye=Et,Xi="transaction() expects an array of queries, or a function returning a\
...
return r instanceof d?"\\x"+wi(r):r}a(Iu,"encodeBuffersAsBytea");function es(r){let{query:e,params:t}=r instanceof
Ae?r.compile():r,n={query:e,params:t.map(i=>Iu((0,is.prepareValue)(i)))};return console.log(n),n}a(es,
"prepareQuery");function lr(r,{arrayMode:e,fullResults:t,fetchOptions:n,isolationLevel:i,readOnly:s,
deferrable:o,authToken:u}={}){if(!r)throw new Error("No database connection string was provided to `\
neon()`. Perhaps an environment variable has not been set?");let c;try{c=Vt(r)}catch{throw new Error(
...
...`)");return ts(q,new Ae(P,L))}a(_,"templateFn"),_.query=(P,L,C)=>ts(q,{query:P,params:L??[]},C),_.
unsafe=P=>new Ae([P],[]),_.transaction=async(P,L)=>{if(typeof P=="function"&&(P=P(_)),!Array.isArray(
P))throw new Error(Xi);P.forEach(H=>{if(H[Symbol.toStringTag]!=="NeonQueryPromise")throw new Error(Xi)});
let C=P.map(H=>H.query),S=P.map(H=>H.opts??{});return q(C,S,L)};async function q(P,L,C){let{fetchEndpoint:S,
fetchFunction:H}=de,le=Array.isArray(P)?{queries:P.map(J=>es(J))}:es(P),N=n??{},ie=e??!1,se=t??!1,oe=i,
...
void 0&&(fe=L.authToken);let _e=typeof S=="function"?S(y,g,{jwtAuth:fe!==void 0}):S,he={"Neon-Connec\
tion-String":r,"Neon-Raw-Text-Output":"true","Neon-Array-Mode":"true"},Ce=await Tu(fe);Ce&&(he.Authorization=
`Bearer ${Ce}`),Array.isArray(P)&&(oe!==void 0&&(he["Neon-Batch-Isolation-Level"]=oe),B!==void 0&&(he["\
Neon-Batch-Read-Only"]=String(B)),G!==void 0&&(he["Neon-Batch-Deferrable"]=String(G)));let ae;try{ae=
await(H??fetch)(_e,{method:"POST",body:JSON.stringify(le),headers:he,...N})}catch(J){let j=new ye(`E\
rror connecting to database: ${J}`);throw j.sourceError=J,j}if(ae.ok){let J=await ae.json();if(Array.
isArray(P)){let j=J.results;if(!Array.isArray(j))throw new ye("Neon internal error: unexpected resul\
t format");return j.map((X,V)=>{let We=L[V]??{},yo=We.arrayMode??ie,mo=We.fullResults??se;return rs(
X,{arrayMode:yo,fullResults:mo,types:We.types})})}else{let j=L??{},X=j.arrayMode??ie,V=j.fullResults??
se;return rs(J,{arrayMode:X,fullResults:V,types:j.types})}}else{let{status:J}=ae;if(J===400){let j=await ae.
json(),X=new ye(j.message);for(let V of Cu)X[V]=j[V]??void 0;throw X}else{let j=await ae.text();throw new ye(
`Server error (HTTP status ${J}): ${j}`)}}}return a(q,"execute"),_}a(lr,"neon");function ts(r,e,t){return{
[Symbol.toStringTag]:"NeonQueryPromise",query:e,opts:t,then:a((n,i)=>r(e,t).then(n,i),"then"),catch:a(
n=>r(e,t).catch(n),"catch"),finally:a(n=>r(e,t).finally(n),"finally")}}a(ts,"createNeonQueryPromise");
function rs(r,{arrayMode:e,fullResults:t,types:n}){let i=new ns.default(n),s=r.fields.map(c=>c.name),
...
!0,r.rowAsArray=e,r.rows=u,r._parsers=o,r._types=i,r):u}a(rs,"processQueryResult");async function Tu(r){
...
ken: ${e.message}`)),t}}a(Tu,"getAuthToken");p();var ho=Se(at());p();var fo=Se(at());var Rn=class Rn extends fo.Client{constructor(t){super(t);this.config=t}get neonConfig(){return this.
...
"HMAC",G,A.encode(B))),_e=d.from(le.map((X,V)=>le[V]^fe[V])),he=_e.toString("base64");let Ce=await n.
...
a(Rn,"NeonClient");var Ne=Rn;Ge();var po=Se(It());function yl(r,e){if(e)return{callback:e,result:void 0};let t,n,i=a(function(o,u){o?t(o):n(u)},"cb"),
s=new r(function(o,u){n=o,t=u});return{callback:i,result:s}}a(yl,"promisify");var Bn=class Bn extends ho.Pool{constructor(){
super(...arguments);E(this,"Client",Ne);E(this,"hasFetchUnsupportedListeners",!1);E(this,"addListene\
...
/${c(o.database)}`,f=typeof t=="string"?t:t.text,y=n??t.values??[];lr(l,{fullResults:!0,arrayMode:t.
rowMode==="array"}).query(f,y,{types:t.types??this.options?.types}).then(A=>i(void 0,A)).catch(A=>i(
A))}catch(o){i(o)}return s.result}};a(Bn,"NeonPool");var kt=Bn;Ge();var je=Se(at()),ml="js";
