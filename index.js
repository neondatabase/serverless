"use strict";var Co=Object.create;var Re=Object.defineProperty;var _o=Object.getOwnPropertyDescriptor;var Io=Object.getOwnPropertyNames;var To=Object.getPrototypeOf,Po=Object.prototype.hasOwnProperty;var Bo=(r,e,t)=>e in r?Re(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t;var a=(r,e)=>Re(r,"name",{value:e,configurable:!0});var K=(r,e)=>()=>(r&&(e=r(r=0)),e);var I=(r,e)=>()=>(e||r((e={exports:{}}).exports,e),e.exports),te=(r,e)=>{for(var t in e)Re(r,t,{get:e[t],
enumerable:!0})},Nn=(r,e,t,n)=>{if(e&&typeof e=="object"||typeof e=="function")for(let i of Io(e))!Po.
call(r,i)&&i!==t&&Re(r,i,{get:()=>e[i],enumerable:!(n=_o(e,i))||n.enumerable});return r};var _e=(r,e,t)=>(t=r!=null?Co(To(r)):{},Nn(e||!r||!r.__esModule?Re(t,"default",{value:r,enumerable:!0}):
t,r)),O=r=>Nn(Re({},"__esModule",{value:!0}),r);var A=(r,e,t)=>Bo(r,typeof e!="symbol"?e+"":e,t);var Hn=I(pt=>{"use strict";p();pt.byteLength=Lo;pt.toByteArray=ko;pt.fromByteArray=Do;var ae=[],re=[],
Ro=typeof Uint8Array<"u"?Uint8Array:Array,jt="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz01\
23456789+/";for(Ie=0,Wn=jt.length;Ie<Wn;++Ie)ae[Ie]=jt[Ie],re[jt.charCodeAt(Ie)]=Ie;var Ie,Wn;re[45]=
...
function Lo(r){var e=jn(r),t=e[0],n=e[1];return(t+n)*3/4-n}a(Lo,"byteLength");function Fo(r,e,t){return(e+
t)*3/4-t}a(Fo,"_byteLength");function ko(r){var e,t=jn(r),n=t[0],i=t[1],s=new Ro(Fo(r,n,i)),o=0,u=i>
...
4|re[r.charCodeAt(c+2)]>>2,s[o++]=e>>8&255,s[o++]=e&255),s}a(ko,"toByteArray");function Mo(r){return ae[r>>
18&63]+ae[r>>12&63]+ae[r>>6&63]+ae[r&63]}a(Mo,"tripletToBase64");function Uo(r,e,t){for(var n,i=[],s=e;s<
t;s+=3)n=(r[s]<<16&16711680)+(r[s+1]<<8&65280)+(r[s+2]&255),i.push(Mo(n));return i.join("")}a(Uo,"en\
codeChunk");function Do(r){for(var e,t=r.length,n=t%3,i=[],s=16383,o=0,u=t-n;o<u;o+=s)i.push(Uo(r,o,
o+s>u?u:o+s));return n===1?(e=r[t-1],i.push(ae[e>>2]+ae[e<<4&63]+"==")):n===2&&(e=(r[t-2]<<8)+r[t-1],
i.push(ae[e>>10]+ae[e>>4&63]+ae[e<<2&63]+"=")),i.join("")}a(Do,"fromByteArray")});var $n=I(Ht=>{p();Ht.read=function(r,e,t,n,i){var s,o,u=i*8-n-1,c=(1<<u)-1,l=c>>1,f=-7,y=t?i-1:0,w=t?
-1:1,S=r[e+y];for(y+=w,s=S&(1<<-f)-1,S>>=-f,f+=u;f>0;s=s*256+r[e+y],y+=w,f-=8);for(o=s&(1<<-f)-1,s>>=
-f,f+=n;f>0;o=o*256+r[e+y],y+=w,f-=8);if(s===0)s=1-l;else{if(s===c)return o?NaN:(S?-1:1)*(1/0);o=o+Math.
pow(2,n),s=s-l}return(S?-1:1)*o*Math.pow(2,s-n)};Ht.write=function(r,e,t,n,i,s){var o,u,c,l=s*8-i-1,
f=(1<<l)-1,y=f>>1,w=i===23?Math.pow(2,-24)-Math.pow(2,-77):0,S=n?0:s-1,C=n?1:-1,N=e<0||e===0&&1/e<0?
1:0;for(e=Math.abs(e),isNaN(e)||e===1/0?(u=isNaN(e)?1:0,o=f):(o=Math.floor(Math.log(e)/Math.LN2),e*(c=
Math.pow(2,-o))<1&&(o--,c*=2),o+y>=1?e+=w/c:e+=w*Math.pow(2,1-y),e*c>=2&&(o++,c/=2),o+y>=f?(u=0,o=f):
o+y>=1?(u=(e*c-1)*Math.pow(2,i),o=o+y):(u=e*Math.pow(2,y-1)*Math.pow(2,i),o=0));i>=8;r[t+S]=u&255,S+=
C,u/=256,i-=8);for(o=o<<i|u,l+=i;l>0;r[t+S]=o&255,S+=C,o/=256,l-=8);r[t+S-C]|=N*128}});var ui=I(Me=>{"use strict";p();var $t=Hn(),Fe=$n(),Gn=typeof Symbol=="function"&&typeof Symbol.for==
"function"?Symbol.for("nodejs.util.inspect.custom"):null;Me.Buffer=h;Me.SlowBuffer=jo;Me.INSPECT_MAX_BYTES=
50;var dt=2147483647;Me.kMaxLength=dt;h.TYPED_ARRAY_SUPPORT=Oo();!h.TYPED_ARRAY_SUPPORT&&typeof console<
...
'The "string" argument must be of type string. Received type number');return Kt(r)}return Yn(r,e,t)}
a(h,"Buffer");h.poolSize=8192;function Yn(r,e,t){if(typeof r=="string")return Qo(r,e);if(ArrayBuffer.
...
SharedArrayBuffer)))return Vt(r,e,t);if(typeof r=="number")throw new TypeError('The "value" argument\
...
for option "size"')}a(Zn,"assertSize");function qo(r,e,t){return Zn(r),r<=0?fe(r):e!==void 0?typeof t==
"string"?fe(r).fill(e,t):fe(r).fill(e):fe(r)}a(qo,"alloc");h.alloc=function(r,e,t){return qo(r,e,t)};
function Kt(r){return Zn(r),fe(r<0?0:Yt(r)|0)}a(Kt,"allocUnsafe");h.allocUnsafe=function(r){return Kt(
r)};h.allocUnsafeSlow=function(r){return Kt(r)};function Qo(r,e){if((typeof e!="string"||e==="")&&(e=
"utf8"),!h.isEncoding(e))throw new TypeError("Unknown encoding: "+e);let t=Jn(r,e)|0,n=fe(t),i=n.write(
r,e);return i!==t&&(n=n.slice(0,i)),n}a(Qo,"fromString");function Gt(r){let e=r.length<0?0:Yt(r.length)|
0,t=fe(e);for(let n=0;n<e;n+=1)t[n]=r[n]&255;return t}a(Gt,"fromArrayLike");function No(r){if(ue(r,Uint8Array)){
let e=new Uint8Array(r);return Vt(e.buffer,e.byteOffset,e.byteLength)}return Gt(r)}a(No,"fromArrayVi\
ew");function Vt(r,e,t){if(e<0||r.byteLength<e)throw new RangeError('"offset" is outside of buffer b\
...
r,e,t),Object.setPrototypeOf(n,h.prototype),n}a(Vt,"fromArrayBuffer");function Wo(r){if(h.isBuffer(r)){
let e=Yt(r.length)|0,t=fe(e);return t.length===0||r.copy(t,0,0,e),t}if(r.length!==void 0)return typeof r.
length!="number"||Jt(r.length)?fe(0):Gt(r);if(r.type==="Buffer"&&Array.isArray(r.data))return Gt(r.data)}
a(Wo,"fromObject");function Yt(r){if(r>=dt)throw new RangeError("Attempt to allocate Buffer larger t\
han maximum size: 0x"+dt.toString(16)+" bytes");return r|0}a(Yt,"checked");function jo(r){return+r!=
...
ascii":case"latin1":case"binary":return t;case"utf8":case"utf-8":return zt(r).length;case"ucs2":case"\
ucs-2":case"utf16le":case"utf-16le":return t*2;case"hex":return t>>>1;case"base64":return ai(r).length;default:
if(i)return n?-1:zt(r).length;e=(""+e).toLowerCase(),i=!0}}a(Jn,"byteLength");h.byteLength=Jn;function Ho(r,e,t){
...
tf8":case"utf-8":return ei(this,e,t);case"ascii":return Jo(this,e,t);case"latin1":case"binary":return Xo(
...
"slowToString");h.prototype._isBuffer=!0;function Te(r,e,t){let n=r[e];r[e]=r[t],r[t]=n}a(Te,"swap");
h.prototype.swap16=a(function(){let e=this.length;if(e%2!==0)throw new RangeError("Buffer size must \
be a multiple of 16-bits");for(let t=0;t<e;t+=2)Te(this,t,t+1);return this},"swap16");h.prototype.swap32=
a(function(){let e=this.length;if(e%4!==0)throw new RangeError("Buffer size must be a multiple of 32\
-bits");for(let t=0;t<e;t+=4)Te(this,t,t+3),Te(this,t+1,t+2);return this},"swap32");h.prototype.swap64=
a(function(){let e=this.length;if(e%8!==0)throw new RangeError("Buffer size must be a multiple of 64\
-bits");for(let t=0;t<e;t+=8)Te(this,t,t+7),Te(this,t+1,t+6),Te(this,t+2,t+5),Te(this,t+3,t+4);return this},
...
e?!0:h.compare(this,e)===0},"equals");h.prototype.inspect=a(function(){let e="",t=Me.INSPECT_MAX_BYTES;
...
t=2147483647:t<-2147483648&&(t=-2147483648),t=+t,Jt(t)&&(t=i?0:r.length-1),t<0&&(t=r.length+t),t>=r.
...
h.prototype.lastIndexOf=a(function(e,t,n){return Xn(this,e,t,n,!1)},"lastIndexOf");function $o(r,e,t,n){
t=Number(t)||0;let i=r.length-t;n?(n=Number(n),n>i&&(n=i)):n=i;let s=e.length;n>s/2&&(n=s/2);let o;for(o=
0;o<n;++o){let u=parseInt(e.substr(o*2,2),16);if(Jt(u))return o;r[t+o]=u}return o}a($o,"hexWrite");function Go(r,e,t,n){
return yt(zt(e,r.length-t),r,t,n)}a(Go,"utf8Write");function Vo(r,e,t,n){return yt(sa(e),r,t,n)}a(Vo,
"asciiWrite");function zo(r,e,t,n){return yt(ai(e),r,t,n)}a(zo,"base64Write");function Ko(r,e,t,n){return yt(
...
N");function Yo(r,e,t){return e===0&&t===r.length?$t.fromByteArray(r):$t.fromByteArray(r.slice(e,t))}
a(Yo,"base64Slice");function ei(r,e,t){t=Math.min(r.length,t);let n=[],i=e;for(;i<t;){let s=r[i],o=null,
...
n.push(o),i+=u}return Zo(n)}a(ei,"utf8Slice");var zn=4096;function Zo(r){let e=r.length;if(e<=zn)return String.
fromCharCode.apply(String,r);let t="",n=0;for(;n<e;)t+=String.fromCharCode.apply(String,r.slice(n,n+=
zn));return t}a(Zo,"decodeCodePointsArray");function Jo(r,e,t){let n="";t=Math.min(r.length,t);for(let i=e;i<
...
2]<<8|this[e+3])},"readUInt32BE");h.prototype.readBigUInt64LE=we(a(function(e){e=e>>>0,ke(e,"offset");
let t=this[e],n=this[e+7];(t===void 0||n===void 0)&&Ke(e,this.length-8);let i=t+this[++e]*2**8+this[++e]*
2**16+this[++e]*2**24,s=this[++e]+this[++e]*2**8+this[++e]*2**16+n*2**24;return BigInt(i)+(BigInt(s)<<
BigInt(32))},"readBigUInt64LE"));h.prototype.readBigUInt64BE=we(a(function(e){e=e>>>0,ke(e,"offset");
let t=this[e],n=this[e+7];(t===void 0||n===void 0)&&Ke(e,this.length-8);let i=t*2**24+this[++e]*2**16+
...
readBigInt64LE=we(a(function(e){e=e>>>0,ke(e,"offset");let t=this[e],n=this[e+7];(t===void 0||n===void 0)&&
Ke(e,this.length-8);let i=this[e+4]+this[e+5]*2**8+this[e+6]*2**16+(n<<24);return(BigInt(i)<<BigInt(
32))+BigInt(t+this[++e]*2**8+this[++e]*2**16+this[++e]*2**24)},"readBigInt64LE"));h.prototype.readBigInt64BE=
we(a(function(e){e=e>>>0,ke(e,"offset");let t=this[e],n=this[e+7];(t===void 0||n===void 0)&&Ke(e,this.
...
return e=e>>>0,t||q(e,4,this.length),Fe.read(this,e,!0,23,4)},"readFloatLE");h.prototype.readFloatBE=
a(function(e,t){return e=e>>>0,t||q(e,4,this.length),Fe.read(this,e,!1,23,4)},"readFloatBE");h.prototype.
readDoubleLE=a(function(e,t){return e=e>>>0,t||q(e,8,this.length),Fe.read(this,e,!0,52,8)},"readDoub\
leLE");h.prototype.readDoubleBE=a(function(e,t){return e=e>>>0,t||q(e,8,this.length),Fe.read(this,e,
!1,52,8)},"readDoubleBE");function Y(r,e,t,n,i,s){if(!h.isBuffer(r))throw new TypeError('"buffer" ar\
gument must be a Buffer instance');if(e>i||e<s)throw new RangeError('"value" argument is out of boun\
ds');if(t+n>r.length)throw new RangeError("Index out of range")}a(Y,"checkInt");h.prototype.writeUintLE=
h.prototype.writeUIntLE=a(function(e,t,n,i){if(e=+e,t=t>>>0,n=n>>>0,!i){let u=Math.pow(2,8*n)-1;Y(this,
...
+e,t=t>>>0,n||Y(this,e,t,1,255,0),this[t]=e&255,t+1},"writeUInt8");h.prototype.writeUint16LE=h.prototype.
...
+e,t=t>>>0,n||Y(this,e,t,2,65535,0),this[t]=e>>>8,this[t+1]=e&255,t+2},"writeUInt16BE");h.prototype.
writeUint32LE=h.prototype.writeUInt32LE=a(function(e,t,n){return e=+e,t=t>>>0,n||Y(this,e,t,4,4294967295,
0),this[t+3]=e>>>24,this[t+2]=e>>>16,this[t+1]=e>>>8,this[t]=e&255,t+4},"writeUInt32LE");h.prototype.
writeUint32BE=h.prototype.writeUInt32BE=a(function(e,t,n){return e=+e,t=t>>>0,n||Y(this,e,t,4,4294967295,
...
writeBigUInt64LE=we(a(function(e,t=0){return ti(this,e,t,BigInt(0),BigInt("0xffffffffffffffff"))},"w\
riteBigUInt64LE"));h.prototype.writeBigUInt64BE=we(a(function(e,t=0){return ri(this,e,t,BigInt(0),BigInt(
...
n},"writeIntBE");h.prototype.writeInt8=a(function(e,t,n){return e=+e,t=t>>>0,n||Y(this,e,t,1,127,-128),
e<0&&(e=255+e+1),this[t]=e&255,t+1},"writeInt8");h.prototype.writeInt16LE=a(function(e,t,n){return e=
+e,t=t>>>0,n||Y(this,e,t,2,32767,-32768),this[t]=e&255,this[t+1]=e>>>8,t+2},"writeInt16LE");h.prototype.
writeInt16BE=a(function(e,t,n){return e=+e,t=t>>>0,n||Y(this,e,t,2,32767,-32768),this[t]=e>>>8,this[t+
1]=e&255,t+2},"writeInt16BE");h.prototype.writeInt32LE=a(function(e,t,n){return e=+e,t=t>>>0,n||Y(this,
e,t,4,2147483647,-2147483648),this[t]=e&255,this[t+1]=e>>>8,this[t+2]=e>>>16,this[t+3]=e>>>24,t+4},"\
writeInt32LE");h.prototype.writeInt32BE=a(function(e,t,n){return e=+e,t=t>>>0,n||Y(this,e,t,4,2147483647,
-2147483648),e<0&&(e=4294967295+e+1),this[t]=e>>>24,this[t+1]=e>>>16,this[t+2]=e>>>8,this[t+3]=e&255,
t+4},"writeInt32BE");h.prototype.writeBigInt64LE=we(a(function(e,t=0){return ti(this,e,t,-BigInt("0x\
...
+e,t=t>>>0,i||ni(r,e,t,4,34028234663852886e22,-34028234663852886e22),Fe.write(r,e,t,n,23,4),t+4}a(ii,
...
return e=+e,t=t>>>0,i||ni(r,e,t,8,17976931348623157e292,-17976931348623157e292),Fe.write(r,e,t,n,52,
...
0;s<n-t;++s)this[s+t]=o[s%u]}return this},"fill");var Le={};function Zt(r,e,t){var n;Le[r]=(n=class extends t{constructor(){
...
_${r.slice(t-3,t)}${e}`;return`${r.slice(0,t)}${e}`}a(Kn,"addNumericalSeparator");function ra(r,e,t){
ke(e,"offset"),(r[e]===void 0||r[e+t]===void 0)&&Ke(e,r.length-(t+1))}a(ra,"checkBounds");function oi(r,e,t,n,i,s){
...
nd <= ${t}${o}`,new Le.ERR_OUT_OF_RANGE("value",u,r)}ra(n,i,s)}a(oi,"checkIntBI");function ke(r,e){if(typeof r!=
"number")throw new Le.ERR_INVALID_ARG_TYPE(e,"number",r)}a(ke,"validateNumber");function Ke(r,e,t){throw Math.
floor(r)!==r?(ke(r,t),new Le.ERR_OUT_OF_RANGE(t||"offset","an integer",r)):e<0?new Le.ERR_BUFFER_OUT_OF_BOUNDS:
new Le.ERR_OUT_OF_RANGE(t||"offset",`>= ${t?1:0} and <= ${e}`,r)}a(Ke,"boundsError");var na=/[^+/0-9A-Za-z-_]/g;
function ia(r){if(r=r.split("=")[0],r=r.trim().replace(na,""),r.length<2)return"";for(;r.length%4!==
0;)r=r+"=";return r}a(ia,"base64clean");function zt(r,e){e=e||1/0;let t,n=r.length,i=null,s=[];for(let o=0;o<
...
240,t>>12&63|128,t>>6&63|128,t&63|128)}else throw new Error("Invalid code point")}return s}a(zt,"utf\
...
o),n=t>>8,i=t%256,s.push(i),s.push(n);return s}a(oa,"utf16leToBytes");function ai(r){return $t.toByteArray(
ia(r))}a(ai,"base64ToBytes");function yt(r,e,t,n){let i;for(i=0;i<n&&!(i+t>=e.length||i>=r.length);++i)
e[i+t]=r[i];return i}a(yt,"blitBuffer");function ue(r,e){return r instanceof e||r!=null&&r.constructor!=
null&&r.constructor.name!=null&&r.constructor.name===e.name}a(ue,"isInstance");function Jt(r){return r!==
r}a(Jt,"numberIsNaN");var aa=function(){let r="0123456789abcdef",e=new Array(256);for(let t=0;t<16;++t){
...
gIntNotDefined")});var g,b,v,d,m,p=K(()=>{"use strict";g=globalThis,b=globalThis.setImmediate??(r=>setTimeout(r,0)),v=globalThis.
clearImmediate??(r=>clearTimeout(r)),d=typeof globalThis.Buffer=="function"&&typeof globalThis.Buffer.
allocUnsafe=="function"?globalThis.Buffer:ui().Buffer,m=globalThis.process??{};m.env??(m.env={});try{
m.nextTick(()=>{})}catch{let e=Promise.resolve();m.nextTick=e.then.bind(e)}});var ge=I((Dl,Xt)=>{"use strict";p();var Ue=typeof Reflect=="object"?Reflect:null,ci=Ue&&typeof Ue.apply==
"function"?Ue.apply:a(function(e,t,n){return Function.prototype.apply.call(e,t,n)},"ReflectApply"),mt;
Ue&&typeof Ue.ownKeys=="function"?mt=Ue.ownKeys:Object.getOwnPropertySymbols?mt=a(function(e){return Object.
getOwnPropertyNames(e).concat(Object.getOwnPropertySymbols(e))},"ReflectOwnKeys"):mt=a(function(e){return Object.
getOwnPropertyNames(e)},"ReflectOwnKeys");function ca(r){console&&console.warn&&console.warn(r)}a(ca,
"ProcessEmitWarning");var fi=Number.isNaN||a(function(e){return e!==e},"NumberIsNaN");function L(){L.
init.call(this)}a(L,"EventEmitter");Xt.exports=L;Xt.exports.once=pa;L.EventEmitter=L;L.prototype._events=
void 0;L.prototype._eventsCount=0;L.prototype._maxListeners=void 0;var li=10;function wt(r){if(typeof r!=
"function")throw new TypeError('The "listener" argument must be of type Function. Received type '+typeof r)}
a(wt,"checkListener");Object.defineProperty(L,"defaultMaxListeners",{enumerable:!0,get:a(function(){
...
L.prototype.setMaxListeners=a(function(e){if(typeof e!="number"||e<0||fi(e))throw new RangeError('Th\
e value of "n" is out of range. It must be a non-negative number. Received '+e+".");return this._maxListeners=
e,this},"setMaxListeners");function hi(r){return r._maxListeners===void 0?L.defaultMaxListeners:r._maxListeners}
a(hi,"_getMaxListeners");L.prototype.getMaxListeners=a(function(){return hi(this)},"getMaxListeners");
...
length,f=wi(c,l),n=0;n<l;++n)ci(f[n],this,t);return!0},"emit");function pi(r,e,t,n){var i,s,o;if(wt(
...
r,u.type=e,u.count=o.length,ca(u)}return r}a(pi,"_addListener");L.prototype.addListener=a(function(e,t){
return pi(this,e,t,!1)},"addListener");L.prototype.on=L.prototype.addListener;L.prototype.prependListener=
a(function(e,t){return pi(this,e,t,!0)},"prependListener");function la(){if(!this.fired)return this.
target.removeListener(this.type,this.wrapFn),this.fired=!0,arguments.length===0?this.listener.call(this.
target):this.listener.apply(this.target,arguments)}a(la,"onceWrapper");function di(r,e,t){var n={fired:!1,
wrapFn:void 0,target:r,type:e,listener:t},i=la.bind(n);return i.listener=t,n.wrapFn=i,i}a(di,"_onceW\
rap");L.prototype.once=a(function(e,t){return wt(t),this.on(e,di(this,e,t)),this},"once");L.prototype.
prependOnceListener=a(function(e,t){return wt(t),this.prependListener(e,di(this,e,t)),this},"prepend\
OnceListener");L.prototype.removeListener=a(function(e,t){var n,i,s,o,u;if(wt(t),i=this._events,i===
...
listener,s=o;break}if(s<0)return this;s===0?n.shift():fa(n,s),n.length===1&&(i[e]=n[0]),i.removeListener!==
...
ha(i):wi(i,i.length)}a(yi,"_listeners");L.prototype.listeners=a(function(e){return yi(this,e,!0)},"l\
isteners");L.prototype.rawListeners=a(function(e){return yi(this,e,!1)},"rawListeners");L.listenerCount=
function(r,e){return typeof r.listenerCount=="function"?r.listenerCount(e):mi.call(r,e)};L.prototype.
listenerCount=mi;function mi(r){var e=this._events;if(e!==void 0){var t=e[r];if(typeof t=="function")
return 1;if(t!==void 0)return t.length}return 0}a(mi,"listenerCount");L.prototype.eventNames=a(function(){
return this._eventsCount>0?mt(this._events):[]},"eventNames");function wi(r,e){for(var t=new Array(e),
n=0;n<e;++n)t[n]=r[n];return t}a(wi,"arrayClone");function fa(r,e){for(;e+1<r.length;e++)r[e]=r[e+1];
r.pop()}a(fa,"spliceOne");function ha(r){for(var e=new Array(r.length),t=0;t<e.length;++t)e[t]=r[t].
listener||r[t];return e}a(ha,"unwrapListeners");function pa(r,e){return new Promise(function(t,n){function i(o){
r.removeListener(e,s),n(o)}a(i,"errorListener");function s(){typeof r.removeListener=="function"&&r.
removeListener("error",i),t([].slice.call(arguments))}a(s,"resolver"),gi(r,e,s,{once:!0}),e!=="error"&&
da(r,i,{once:!0})})}a(pa,"once");function da(r,e,t){typeof r.on=="function"&&gi(r,"error",e,t)}a(da,
"addErrorHandlerIfEventEmitter");function gi(r,e,t,n){if(typeof r.on=="function")n.once?r.once(e,t):
...
ust be of type EventEmitter. Received type '+typeof r)}a(gi,"eventTargetAgnosticAddListener")});var xi={};te(xi,{Socket:()=>oe,isIP:()=>ya});function ya(r){return 0}var vi,bi,x,oe,De=K(()=>{"use s\
trict";p();vi=_e(ge(),1);a(ya,"isIP");bi=/^[^.]+\./,x=class x extends vi.EventEmitter{constructor(){
...
opts.disableSNI=t}static get disableWarningInBrowsers(){return x.opts.disableWarningInBrowsers??x.defaults.
disableWarningInBrowsers}static set disableWarningInBrowsers(t){x.opts.disableWarningInBrowsers=t}get disableWarningInBrowsers(){
return this.opts.disableWarningInBrowsers??x.disableWarningInBrowsers}set disableWarningInBrowsers(t){
this.opts.disableWarningInBrowsers=t}static get pipelineConnect(){return x.opts.pipelineConnect??x.defaults.
pipelineConnect}static set pipelineConnect(t){x.opts.pipelineConnect=t}get pipelineConnect(){return this.
opts.pipelineConnect??x.pipelineConnect}set pipelineConnect(t){this.opts.pipelineConnect=t}static get subtls(){
return x.opts.subtls??x.defaults.subtls}static set subtls(t){x.opts.subtls=t}get subtls(){return this.
opts.subtls??x.subtls}set subtls(t){this.opts.subtls=t}static get pipelineTLS(){return x.opts.pipelineTLS??
x.defaults.pipelineTLS}static set pipelineTLS(t){x.opts.pipelineTLS=t}get pipelineTLS(){return this.
opts.pipelineTLS??x.pipelineTLS}set pipelineTLS(t){this.opts.pipelineTLS=t}static get rootCerts(){return x.
opts.rootCerts??x.defaults.rootCerts}static set rootCerts(t){x.opts.rootCerts=t}get rootCerts(){return this.
opts.rootCerts??x.rootCerts}set rootCerts(t){this.opts.rootCerts=t}wsProxyAddrForHost(t,n){let i=this.
...
ws.close(),i()}),this}destroy(){return this.destroyed=!0,this.end()}};a(x,"Socket"),A(x,"defaults",{
poolQueryViaFetch:!1,fetchEndpoint:a((t,n,i)=>{let s;return i?.override?s=t:i?.jwtAuth?s=t.replace(bi,
"apiauth."):s=t.replace(bi,"api."),"https://"+s+"/sql"},"fetchEndpoint"),fetchConnectionCache:!0,fetchFunction:void 0,
...
disableWarningInBrowsers:!1}),A(x,"opts",{});oe=x});var Si={};te(Si,{parse:()=>er});function er(r,e=!1){let{protocol:t}=new URL(r),n="http:"+r.substring(
t.length),{username:i,password:s,host:o,hostname:u,port:c,pathname:l,search:f,searchParams:y,hash:w}=new URL(
n);s=decodeURIComponent(s),i=decodeURIComponent(i),l=decodeURIComponent(l);let S=null;s.startsWith("\
endpoint=")&&([S,s]=s.substring(9).split(/[\;\$]/,2));let C=y.get("options");if(C){let T=new URLSearchParams(
C).get("endpoint");T&&(S=T)}let N=i+":"+s,W=e?Object.fromEntries(y.entries()):f;return{href:r,protocol:t,
auth:N,username:i,password:s,host:o,hostname:u,port:c,pathname:l,search:f,query:W,hash:w,endpoint:S}}
var tr=K(()=>{"use strict";p();a(er,"parse")});var sr=I(Ti=>{"use strict";p();Ti.parse=function(r,e){return new ir(r,e).parse()};var St=class St{constructor(e,t){
...
not balanced");return this.entries}};a(St,"ArrayParser");var ir=St;function Ta(r){return r}a(Ta,"ide\
ntity")});var or=I((nf,Pi)=>{p();var Pa=sr();Pi.exports={create:a(function(r,e){return{parse:a(function(){return Pa.
parse(r,e)},"parse")}},"create")}});var Li=I((af,Ri)=>{"use strict";p();var Ba=/(\d{1,})-(\d{2})-(\d{2}) (\d{2}):(\d{2}):(\d{2})(\.\d{1,})?.*?( BC)?$/,
Ra=/^(\d{1,})-(\d{2})-(\d{2})( BC)?$/,La=/([Z+-])(\d{2})?:?(\d{2})?:?(\d{2})?/,Fa=/^-?infinity$/;Ri.
exports=a(function(e){if(Fa.test(e))return Number(e.replace("i","I"));var t=Ba.exec(e);if(!t)return ka(
e)||null;var n=!!t[8],i=parseInt(t[1],10);n&&(i=Bi(i));var s=parseInt(t[2],10)-1,o=t[3],u=parseInt(t[4],
10),c=parseInt(t[5],10),l=parseInt(t[6],10),f=t[7];f=f?1e3*parseFloat(f):0;var y,w=Ma(e);return w!=null?
(y=new Date(Date.UTC(i,s,o,u,c,l,f)),ar(i)&&y.setUTCFullYear(i),w!==0&&y.setTime(y.getTime()-w)):(y=
new Date(i,s,o,u,c,l,f),ar(i)&&y.setFullYear(i)),y},"parseDate");function ka(r){var e=Ra.exec(r);if(e){
var t=parseInt(e[1],10),n=!!e[4];n&&(t=Bi(t));var i=parseInt(e[2],10)-1,s=e[3],o=new Date(t,i,s);return ar(
t)&&o.setFullYear(t),o}}a(ka,"getDate");function Ma(r){if(r.endsWith("+00"))return 0;var e=La.exec(r.
split(" ")[1]);if(e){var t=e[1];if(t==="Z")return 0;var n=t==="-"?-1:1,i=parseInt(e[2],10)*3600+parseInt(
e[3]||0,10)*60+parseInt(e[4]||0,10);return i*n*1e3}}a(Ma,"timeZoneOffset");function Bi(r){return-(r-
1)}a(Bi,"bcYearToNegativeYear");function ar(r){return r>=0&&r<100}a(ar,"is0To99")});var ki=I((lf,Fi)=>{p();Fi.exports=Da;var Ua=Object.prototype.hasOwnProperty;function Da(r){for(var e=1;e<
arguments.length;e++){var t=arguments[e];for(var n in t)Ua.call(t,n)&&(r[n]=t[n])}return r}a(Da,"ext\
end")});var Di=I((pf,Ui)=>{"use strict";p();var Oa=ki();Ui.exports=Qe;function Qe(r){if(!(this instanceof Qe))
return new Qe(r);Oa(this,Ya(r))}a(Qe,"PostgresInterval");var qa=["seconds","minutes","hours","days",
"months","years"];Qe.prototype.toPostgres=function(){var r=qa.filter(this.hasOwnProperty,this);return this.
...
"")),t+" "+e},this).join(" ")};var Qa={years:"Y",months:"M",days:"D",hours:"H",minutes:"M",seconds:"\
S"},Na=["years","months","days"],Wa=["hours","minutes","seconds"];Qe.prototype.toISOString=Qe.prototype.
toISO=function(){var r=Na.map(t,this).join(""),e=Wa.map(t,this).join("");return"P"+r+"T"+e;function t(n){
var i=this[n]||0;return n==="seconds"&&this.milliseconds&&(i=(i+this.milliseconds/1e3).toFixed(6).replace(
/0+$/,"")),i+Qa[n]}};var ur="([+-]?\\d+)",ja=ur+"\\s+years?",Ha=ur+"\\s+mons?",$a=ur+"\\s+days?",Ga="\
([+-])?([\\d]*):(\\d\\d):(\\d\\d)\\.?(\\d{1,6})?",Va=new RegExp([ja,Ha,$a,Ga].map(function(r){return"\
("+r+")?"}).join("\\s*")),Mi={years:2,months:4,days:6,hours:9,minutes:10,seconds:11,milliseconds:12},
za=["hours","minutes","seconds","milliseconds"];function Ka(r){var e=r+"000000".slice(r.length);return parseInt(
e,10)/1e3}a(Ka,"parseMilliseconds");function Ya(r){if(!r)return{};var e=Va.exec(r),t=e[8]==="-";return Object.
keys(Mi).reduce(function(n,i){var s=Mi[i],o=e[s];return!o||(o=i==="milliseconds"?Ka(o):parseInt(o,10),
!o)||(t&&~za.indexOf(i)&&(o*=-1),n[i]=o),n},{})}a(Ya,"parse")});var qi=I((mf,Oi)=>{"use strict";p();Oi.exports=a(function(e){if(/^\\x/.test(e))return new d(e.substr(
...
parseBytea")});var Gi=I((bf,$i)=>{p();var Je=sr(),Xe=or(),Et=Li(),Ni=Di(),Wi=qi();function At(r){return a(function(t){
return t===null?t:r(t)},"nullAllowed")}a(At,"allowNull");function ji(r){return r===null?r:r==="TRUE"||
r==="t"||r==="true"||r==="y"||r==="yes"||r==="on"||r==="1"}a(ji,"parseBool");function Za(r){return r?
Je.parse(r,ji):null}a(Za,"parseBoolArray");function Ja(r){return parseInt(r,10)}a(Ja,"parseBaseTenIn\
t");function cr(r){return r?Je.parse(r,At(Ja)):null}a(cr,"parseIntegerArray");function Xa(r){return r?
Je.parse(r,At(function(e){return Hi(e).trim()})):null}a(Xa,"parseBigIntegerArray");var eu=a(function(r){
if(!r)return null;var e=Xe.create(r,function(t){return t!==null&&(t=pr(t)),t});return e.parse()},"pa\
rsePointArray"),lr=a(function(r){if(!r)return null;var e=Xe.create(r,function(t){return t!==null&&(t=
parseFloat(t)),t});return e.parse()},"parseFloatArray"),ne=a(function(r){if(!r)return null;var e=Xe.
create(r);return e.parse()},"parseStringArray"),fr=a(function(r){if(!r)return null;var e=Xe.create(r,
function(t){return t!==null&&(t=Et(t)),t});return e.parse()},"parseDateArray"),tu=a(function(r){if(!r)
return null;var e=Xe.create(r,function(t){return t!==null&&(t=Ni(t)),t});return e.parse()},"parseInt\
ervalArray"),ru=a(function(r){return r?Je.parse(r,At(Wi)):null},"parseByteAArray"),hr=a(function(r){
return parseInt(r,10)},"parseInteger"),Hi=a(function(r){var e=String(r);return/^\d+$/.test(e)?e:r},"\
parseBigInteger"),Qi=a(function(r){return r?Je.parse(r,At(JSON.parse)):null},"parseJsonArray"),pr=a(
function(r){return r[0]!=="("?null:(r=r.substring(1,r.length-1).split(","),{x:parseFloat(r[0]),y:parseFloat(
r[1])})},"parsePoint"),nu=a(function(r){if(r[0]!=="<"&&r[1]!=="(")return null;for(var e="(",t="",n=!1,
i=2;i<r.length-1;i++){if(n||(e+=r[i]),r[i]===")"){n=!0;continue}else if(!n)continue;r[i]!==","&&(t+=
r[i])}var s=pr(e);return s.radius=parseFloat(t),s},"parseCircle"),iu=a(function(r){r(20,Hi),r(21,hr),
r(23,hr),r(26,hr),r(700,parseFloat),r(701,parseFloat),r(16,ji),r(1082,Et),r(1114,Et),r(1184,Et),r(600,
pr),r(651,ne),r(718,nu),r(1e3,Za),r(1001,ru),r(1005,cr),r(1007,cr),r(1028,cr),r(1016,Xa),r(1017,eu),
r(1021,lr),r(1022,lr),r(1231,lr),r(1014,ne),r(1015,ne),r(1008,ne),r(1009,ne),r(1040,ne),r(1041,ne),r(
1115,fr),r(1182,fr),r(1185,fr),r(1186,Ni),r(1187,tu),r(17,Wi),r(114,JSON.parse.bind(JSON)),r(3802,JSON.
parse.bind(JSON)),r(199,Qi),r(3807,Qi),r(3907,ne),r(2951,ne),r(791,ne),r(1183,ne),r(1270,ne)},"init");
$i.exports={init:iu}});var zi=I((Sf,Vi)=>{"use strict";p();var Z=1e6;function su(r){var e=r.readInt32BE(0),t=r.readUInt32BE(
...
""+o%Z,n+u+i}a(su,"readInt8");Vi.exports=su});var Xi=I((Cf,Ji)=>{p();var ou=zi(),k=a(function(r,e,t,n,i){t=t||0,n=n||!1,i=i||function(S,C,N){return S*
Math.pow(2,N)+C};var s=t>>3,o=a(function(S){return n?~S&255:S},"inv"),u=255,c=8-t%8;e<c&&(u=255<<8-e&
255,c=e),t&&(u=u>>t%8);var l=0;t%8+e>=8&&(l=i(0,o(r[s])&u,c));for(var f=e+t>>3,y=s+1;y<f;y++)l=i(l,o(
r[y]),8);var w=(e+t)%8;return w>0&&(l=i(l,o(r[f])>>8-w,w)),l},"parseBits"),Zi=a(function(r,e,t){var n=Math.
pow(2,t-1)-1,i=k(r,1),s=k(r,t,1);if(s===0)return 0;var o=1,u=a(function(l,f,y){l===0&&(l=1);for(var w=1;w<=
y;w++)o/=2,(f&1<<y-w)>0&&(l+=o);return l},"parsePrecisionBits"),c=k(r,e,t+1,!1,u);return s==Math.pow(
2,t+1)-1?c===0?i===0?1/0:-1/0:NaN:(i===0?1:-1)*Math.pow(2,s-n)*c},"parseFloatFromBits"),au=a(function(r){
return k(r,1)==1?-1*(k(r,15,1,!0)+1):k(r,15,1)},"parseInt16"),Ki=a(function(r){return k(r,1)==1?-1*(k(
r,31,1,!0)+1):k(r,31,1)},"parseInt32"),uu=a(function(r){return Zi(r,23,8)},"parseFloat32"),cu=a(function(r){
return Zi(r,52,11)},"parseFloat64"),lu=a(function(r){var e=k(r,16,32);if(e==49152)return NaN;for(var t=Math.
pow(1e4,k(r,16,16)),n=0,i=[],s=k(r,16),o=0;o<s;o++)n+=k(r,16,64+16*o)*t,t/=1e4;var u=Math.pow(10,k(r,
16,48));return(e===0?1:-1)*Math.round(n*u)/u},"parseNumeric"),Yi=a(function(r,e){var t=k(e,1),n=k(e,
...
usec=s},i.getUTCMicroSeconds=function(){return this.usec},i},"parseDate"),et=a(function(r){for(var e=k(
r,32),t=k(r,32,32),n=k(r,32,64),i=96,s=[],o=0;o<e;o++)s[o]=k(r,32,i),i+=32,i+=32;var u=a(function(l){
var f=k(r,32,i);if(i+=32,f==4294967295)return null;var y;if(l==23||l==20)return y=k(r,f*8,i),i+=f*8,
y;if(l==25)return y=r.toString(this.encoding,i>>3,(i+=f<<3)>>3),y;console.log("ERROR: ElementType no\
t implemented: "+l)},"parseElement"),c=a(function(l,f){var y=[],w;if(l.length>1){var S=l.shift();for(w=
0;w<S;w++)y[w]=c(l,f);l.unshift(S)}else for(w=0;w<l[0];w++)y[w]=u(f);return y},"parse");return c(s,n)},
"parseArray"),fu=a(function(r){return r.toString("utf8")},"parseText"),hu=a(function(r){return r===null?
null:k(r,8)>0},"parseBool"),pu=a(function(r){r(20,ou),r(21,au),r(23,Ki),r(26,Ki),r(1700,lu),r(700,uu),
r(701,cu),r(16,hu),r(1114,Yi.bind(null,!1)),r(1184,Yi.bind(null,!0)),r(1e3,et),r(1007,et),r(1016,et),
r(1008,et),r(1009,et),r(25,fu)},"init");Ji.exports={init:pu}});var ts=I((Tf,es)=>{p();es.exports={BOOL:16,BYTEA:17,CHAR:18,INT8:20,INT2:21,INT4:23,REGPROC:24,TEXT:25,
...
REGROLE:4096}});var nt=I(rt=>{p();var du=Gi(),yu=Xi(),mu=or(),wu=ts();rt.getTypeParser=gu;rt.setTypeParser=bu;rt.arrayParser=
mu;rt.builtins=wu;var tt={text:{},binary:{}};function rs(r){return String(r)}a(rs,"noParse");function gu(r,e){
return e=e||"text",tt[e]&&tt[e][r]||rs}a(gu,"getTypeParser");function bu(r,e,t){typeof e=="function"&&
(t=e,e="text"),tt[e][r]=t}a(bu,"setTypeParser");du.init(function(r,e){tt.text[r]=e});yu.init(function(r,e){
tt.binary[r]=e})});var _t=I((Ff,ns)=>{"use strict";p();var vu=nt();function Ct(r){this._types=r||vu,this.text={},this.binary=
...
e||"text",this.getOverrides(e)[r]||this._types.getTypeParser(r,e)};ns.exports=Ct});function it(r){let e=1779033703,t=3144134277,n=1013904242,i=2773480762,s=1359893119,o=2600822924,u=528734635,
...
2024104815,2227730452,2361852424,2428436474,2756734187,3204031479,3329325298],w=a((T,E)=>T>>>E|T<<32-
E,"rrot"),S=new Uint32Array(64),C=new Uint8Array(64),N=a(()=>{for(let R=0,H=0;R<16;R++,H+=4)S[R]=C[H]<<
24|C[H+1]<<16|C[H+2]<<8|C[H+3];for(let R=16;R<64;R++){let H=w(S[R-15],7)^w(S[R-15],18)^S[R-15]>>>3,le=w(
S[R-2],17)^w(S[R-2],19)^S[R-2]>>>10;S[R]=S[R-16]+H+S[R-7]+le|0}let T=e,E=t,P=n,F=i,B=s,X=o,G=u,de=c;
for(let R=0;R<64;R++){let H=w(B,6)^w(B,11)^w(B,25),le=B&X^~B&G,ye=de+H+le+y[R]+S[R]|0,Se=w(T,2)^w(T,
13)^w(T,22),Ee=T&E^T&P^E&P,Ae=Se+Ee|0;de=G,G=X,X=B,B=F+ye|0,F=P,P=E,E=T,T=ye+Ae|0}e=e+T|0,t=t+E|0,n=
n+P|0,i=i+F|0,s=s+B|0,o=o+X|0,u=u+G|0,c=c+de|0,f=0},"process"),W=a(T=>{typeof T=="string"&&(T=new TextEncoder().
encode(T));for(let E=0;E<T.length;E++)C[f++]=T[E],f===64&&N();l+=T.length},"add"),se=a(()=>{if(C[f++]=
128,f==64&&N(),f+8>64){for(;f<64;)C[f++]=0;N()}for(;f<58;)C[f++]=0;let T=l*8;C[f++]=T/1099511627776&
255,C[f++]=T/4294967296&255,C[f++]=T>>>24,C[f++]=T>>>16&255,C[f++]=T>>>8&255,C[f++]=T&255,N();let E=new Uint8Array(
32);return E[0]=e>>>24,E[1]=e>>>16&255,E[2]=e>>>8&255,E[3]=e&255,E[4]=t>>>24,E[5]=t>>>16&255,E[6]=t>>>
8&255,E[7]=t&255,E[8]=n>>>24,E[9]=n>>>16&255,E[10]=n>>>8&255,E[11]=n&255,E[12]=i>>>24,E[13]=i>>>16&255,
E[14]=i>>>8&255,E[15]=i&255,E[16]=s>>>24,E[17]=s>>>16&255,E[18]=s>>>8&255,E[19]=s&255,E[20]=o>>>24,E[21]=
o>>>16&255,E[22]=o>>>8&255,E[23]=o&255,E[24]=u>>>24,E[25]=u>>>16&255,E[26]=u>>>8&255,E[27]=u&255,E[28]=
c>>>24,E[29]=c>>>16&255,E[30]=c>>>8&255,E[31]=c&255,E},"digest");return r===void 0?{add:W,digest:se}:
(W(r),se())}var is=K(()=>{"use strict";p();a(it,"sha256")});var D,st,ss=K(()=>{"use strict";p();D=class D{constructor(){A(this,"_dataLength",0);A(this,"_bufferL\
...
abcdef"),A(D,"hexOut",[]),A(D,"onePassHasher",new D);st=D});var dr={};te(dr,{createHash:()=>Su,createHmac:()=>Eu,randomBytes:()=>xu});function xu(r){return crypto.
getRandomValues(d.alloc(r))}function Su(r){if(r==="sha256")return{update:a(function(e){return{digest:a(
function(){return d.from(it(e))},"digest")}},"update")};if(r==="md5")return{update:a(function(e){return{
digest:a(function(){return typeof e=="string"?st.hashStr(e):st.hashByteArray(e)},"digest")}},"update")};
throw new Error(`Hash type '${r}' not supported`)}function Eu(r,e){if(r!=="sha256")throw new Error(`\
...
64);o.set(i,0),o.set(t,64);let u=new Uint8Array(96);return u.set(s,0),u.set(it(o),64),d.from(it(u))},
"digest")}},"update")}}var yr=K(()=>{"use strict";p();is();ss();a(xu,"randomBytes");a(Su,"createHash");
a(Eu,"createHmac")});var ot=I((Gf,mr)=>{"use strict";p();mr.exports={host:"localhost",user:m.platform==="win32"?m.env.USERNAME:
...
keepalives:1,keepalives_idle:0};var Ne=nt(),Au=Ne.getTypeParser(20,"text"),Cu=Ne.getTypeParser(1016,
"text");mr.exports.__defineSetter__("parseInt8",function(r){Ne.setTypeParser(20,"text",r?Ne.getTypeParser(
23,"text"):Au),Ne.setTypeParser(1016,"text",r?Ne.getTypeParser(1007,"text"):Cu)})});var at=I((zf,as)=>{"use strict";p();var _u=(yr(),O(dr)),Iu=ot();function Tu(r){var e=r.replace(/\\/g,
"\\\\").replace(/"/g,'\\"');return'"'+e+'"'}a(Tu,"escapeElement");function os(r){for(var e="{",t=0;t<
r.length;t++)t>0&&(e=e+","),r[t]===null||typeof r[t]>"u"?e=e+"NULL":Array.isArray(r[t])?e=e+os(r[t]):
r[t]instanceof d?e+="\\\\x"+r[t].toString("hex"):e+=Tu(It(r[t]));return e=e+"}",e}a(os,"arrayString");
var It=a(function(r,e){if(r==null)return null;if(r instanceof d)return r;if(ArrayBuffer.isView(r)){var t=d.
from(r.buffer,r.byteOffset,r.byteLength);return t.length===r.byteLength?t:t.slice(r.byteOffset,r.byteOffset+
r.byteLength)}return r instanceof Date?Iu.parseInputDatesAsUTC?Ru(r):Bu(r):Array.isArray(r)?os(r):typeof r==
"object"?Pu(r,e):r.toString()},"prepareValue");function Pu(r,e){if(r&&typeof r.toPostgres=="function"){
if(e=e||[],e.indexOf(r)!==-1)throw new Error('circular reference detected while preparing "'+r+'" fo\
r query');return e.push(r),It(r.toPostgres(It),e)}return JSON.stringify(r)}a(Pu,"prepareObject");function j(r,e){
for(r=""+r;r.length<e;)r="0"+r;return r}a(j,"pad");function Bu(r){var e=-r.getTimezoneOffset(),t=r.getFullYear(),
...
-1):i+="+",i+=j(Math.floor(e/60),2)+":"+j(e%60,2),n&&(i+=" BC"),i}a(Bu,"dateToString");function Ru(r){
...
r.getUTCMilliseconds(),3);return n+="+00:00",t&&(n+=" BC"),n}a(Ru,"dateToStringUTC");function Lu(r,e,t){
return r=typeof r=="string"?{text:r}:r,e&&(typeof e=="function"?r.callback=e:r.values=e),t&&(r.callback=
t),r}a(Lu,"normalizeQueryConfig");var wr=a(function(r){return _u.createHash("md5").update(r,"utf-8").
digest("hex")},"md5"),Fu=a(function(r,e,t){var n=wr(e+r),i=wr(d.concat([d.from(n),t]));return"md5"+i},
"postgresMd5PasswordHash");as.exports={prepareValue:a(function(e){return It(e)},"prepareValueWrapper"),
normalizeQueryConfig:Lu,postgresMd5PasswordHash:Fu,md5:wr}});var ut={};te(ut,{default:()=>Ou});var Ou,ct=K(()=>{"use strict";p();Ou={}});var ws=I((ah,ms)=>{"use strict";p();var vr=(yr(),O(dr));function qu(r){if(r.indexOf("SCRAM-SHA-256")===
-1)throw new Error("SASL: Only mechanism SCRAM-SHA-256 is currently supported");let e=vr.randomBytes(
...
art with client nonce");var i=d.from(n.salt,"base64"),s=Gu(e,i,n.iteration),o=We(s,"Client Key"),u=$u(
o),c="n=*,r="+r.clientNonce,l="r="+n.nonce+",s="+n.salt+",i="+n.iteration,f="c=biws,r="+n.nonce,y=c+
","+l+","+f,w=We(u,y),S=ys(o,w),C=S.toString("base64"),N=We(s,"Server Key"),W=We(N,y);r.message="SAS\
LResponse",r.serverSignature=W.toString("base64"),r.response=f+",p="+C}a(Qu,"continueSession");function Nu(r,e){
...
e<=126)}a(Wu,"isPrintableChars");function ps(r){return/^(?:[a-zA-Z0-9+/]{4})*(?:[a-zA-Z0-9+/]{2}==|[a-zA-Z0-9+/]{3}=)?$/.
test(r)}a(ps,"isBase64");function ds(r){if(typeof r!="string")throw new TypeError("SASL: attribute p\
airs text must be a string");return new Map(r.split(",").map(e=>{if(!/^.=/.test(e))throw new Error("\
SASL: Invalid attribute pair entry");let t=e[0],n=e.substring(2);return[t,n]}))}a(ds,"parseAttribute\
Pairs");function ju(r){let e=ds(r),t=e.get("r");if(t){if(!Wu(t))throw new Error("SASL: SCRAM-SERVER-\
FIRST-MESSAGE: nonce must only contain printable characters")}else throw new Error("SASL: SCRAM-SERV\
ER-FIRST-MESSAGE: nonce missing");let n=e.get("s");if(n){if(!ps(n))throw new Error("SASL: SCRAM-SERV\
...
function Hu(r){let t=ds(r).get("v");if(t){if(!ps(t))throw new Error("SASL: SCRAM-SERVER-FINAL-MESSAG\
E: server signature must be base64")}else throw new Error("SASL: SCRAM-SERVER-FINAL-MESSAGE: server \
signature is missing");return{serverSignature:t}}a(Hu,"parseServerFinalMessage");function ys(r,e){if(!d.
...
a(ys,"xorBuffers");function $u(r){return vr.createHash("sha256").update(r).digest()}a($u,"sha256");function We(r,e){
return vr.createHmac("sha256",r).update(e).digest()}a(We,"hmacSha256");function Gu(r,e,t){for(var n=We(
r,d.concat([e,d.from([0,0,0,1])])),i=n,s=0;s<t-1;s++)n=We(r,n),i=ys(i,n);return i}a(Gu,"Hi");ms.exports=
{startSession:qu,continueSession:Qu,finalizeSession:Nu}});var xr={};te(xr,{join:()=>Vu});function Vu(...r){return r.join("/")}var Sr=K(()=>{"use strict";p();a(
Vu,"join")});var Er={};te(Er,{stat:()=>zu});function zu(r,e){e(new Error("No filesystem"))}var Ar=K(()=>{"use str\
ict";p();a(zu,"stat")});var Cr={};te(Cr,{default:()=>Ku});var Ku,_r=K(()=>{"use strict";p();Ku={}});var gs={};te(gs,{StringDecoder:()=>Ir});var Tr,Ir,bs=K(()=>{"use strict";p();Tr=class Tr{constructor(e){
A(this,"td");this.td=new TextDecoder(e)}write(e){return this.td.decode(e,{stream:!0})}end(e){return this.
td.decode(e)}};a(Tr,"StringDecoder");Ir=Tr});var Es=I((wh,Ss)=>{"use strict";p();var{Transform:Yu}=(_r(),O(Cr)),{StringDecoder:Zu}=(bs(),O(gs)),ve=Symbol(
"last"),Pt=Symbol("decoder");function Ju(r,e,t){let n;if(this.overflow){if(n=this[Pt].write(r).split(
this.matcher),n.length===1)return t();n.shift(),this.overflow=!1}else this[ve]+=this[Pt].write(r),n=
this[ve].split(this.matcher);this[ve]=n.pop();for(let i=0;i<n.length;i++)try{xs(this,this.mapper(n[i]))}catch(s){
return t(s)}if(this.overflow=this[ve].length>this.maxLength,this.overflow&&!this.skipOverflow){t(new Error(
"maximum buffer reached"));return}t()}a(Ju,"transform");function Xu(r){if(this[ve]+=this[Pt].end(),this[ve])
try{xs(this,this.mapper(this[ve]))}catch(e){return r(e)}r()}a(Xu,"flush");function xs(r,e){e!==void 0&&
r.push(e)}a(xs,"push");function vs(r){return r}a(vs,"noop");function ec(r,e,t){switch(r=r||/\r?\n/,e=
e||vs,t=t||{},arguments.length){case 1:typeof r=="function"?(e=r,r=/\r?\n/):typeof r=="object"&&!(r instanceof
RegExp)&&!r[Symbol.split]&&(t=r,r=/\r?\n/);break;case 2:typeof r=="function"?(t=e,e=r,r=/\r?\n/):typeof e==
"object"&&(t=e,e=vs)}t=Object.assign({},t),t.autoDestroy=!0,t.transform=Ju,t.flush=Xu,t.readableObjectMode=
!0;let n=new Yu(t);return n[ve]="",n[Pt]=new Zu("utf8"),n.matcher=r,n.mapper=e,n.maxLength=t.maxLength,
n.skipOverflow=t.skipOverflow||!1,n.overflow=!1,n._destroy=function(i,s){this._writableState.errorEmitted=
!1,s(i)},n}a(ec,"split");Ss.exports=ec});var _s=I((vh,pe)=>{"use strict";p();var As=(Sr(),O(xr)),tc=(_r(),O(Cr)).Stream,rc=Es(),Cs=(ct(),O(ut)),
nc=5432,Bt=m.platform==="win32",lt=m.stderr,ic=56,sc=7,oc=61440,ac=32768;function uc(r){return(r&oc)==
ac}a(uc,"isRegFile");var je=["host","port","database","user","password"],Pr=je.length,cc=je[Pr-1];function Br(){
var r=lt instanceof tc&&lt.writable===!0;if(r){var e=Array.prototype.slice.call(arguments).concat(`
`);lt.write(Cs.format.apply(Cs,e))}}a(Br,"warn");Object.defineProperty(pe.exports,"isWin",{get:a(function(){
return Bt},"get"),set:a(function(r){Bt=r},"set")});pe.exports.warnTo=function(r){var e=lt;return lt=
r,e};pe.exports.getFileName=function(r){var e=r||m.env,t=e.PGPASSFILE||(Bt?As.join(e.APPDATA||"./","\
postgresql","pgpass.conf"):As.join(e.HOME||"./",".pgpass"));return t};pe.exports.usePgPass=function(r,e){
return Object.prototype.hasOwnProperty.call(m.env,"PGPASSWORD")?!1:Bt?!0:(e=e||"<unkn>",uc(r.mode)?r.
mode&(ic|sc)?(Br('WARNING: password file "%s" has group or world access; permissions should be u=rw \
(0600) or less',e),!1):!0:(Br('WARNING: password file "%s" is not a plain file',e),!1))};var lc=pe.exports.
match=function(r,e){return je.slice(0,-1).reduce(function(t,n,i){return i==1&&Number(r[n]||nc)===Number(
...
e.destroy(),t(n)},"onEnd"),u=a(function(c){e.destroy(),Br("WARNING: error on reading file: %s",c),t(
void 0)},"onErr");e.on("error",u),i.on("data",s).on("end",o).on("error",u)};var fc=pe.exports.parseLine=
function(r){if(r.length<11||r.match(/^\s+#/))return null;for(var e="",t="",n=0,i=0,s=0,o={},u=!1,c=a(
function(f,y,w){var S=r.substring(y,w);Object.hasOwnProperty.call(m.env,"PGPASS_NO_DEESCAPE")||(S=S.
replace(/\\([:\\])/g,"$1")),o[je[f]]=S},"addToObj"),l=0;l<r.length-1;l+=1){if(e=r.charAt(l+1),t=r.charAt(
l),u=n==Pr-1,u){c(n,i);break}l>=0&&e==":"&&t!=="\\"&&(c(n,i,l+1),i=l+2,n+=1)}return o=Object.keys(o).
length===Pr?o:null,o},hc=pe.exports.isValidEntry=function(r){for(var e={0:function(o){return o.length>
...
0}},t=0;t<je.length;t+=1){var n=e[t],i=r[je[t]]||"",s=n(i);if(!s)return!1}return!0}});var Ts=I((Ah,Rr)=>{"use strict";p();var Eh=(Sr(),O(xr)),Is=(Ar(),O(Er)),Rt=_s();Rr.exports=function(r,e){
var t=Rt.getFileName();Is.stat(t,function(n,i){if(n||!Rt.usePgPass(i,t))return e(void 0);var s=Is.createReadStream(
t);Rt.getPassword(r,s,e)})};Rr.exports.warnTo=Rt.warnTo});var Ps={};te(Ps,{default:()=>pc});var pc,Bs=K(()=>{"use strict";p();pc={}});var Ls=I((Ih,Rs)=>{"use strict";p();var dc=(tr(),O(Si)),Lr=(Ar(),O(Er));function Fr(r){if(r.charAt(0)===
...
cert=Lr.readFileSync(t.sslcert).toString()),t.sslkey&&(t.ssl.key=Lr.readFileSync(t.sslkey).toString()),
t.sslrootcert&&(t.ssl.ca=Lr.readFileSync(t.sslrootcert).toString()),t.sslmode){case"disable":{t.ssl=
!1;break}case"prefer":case"require":case"verify-ca":case"verify-full":break;case"no-verify":{t.ssl.rejectUnauthorized=
!1;break}}return t}a(Fr,"parse");Rs.exports=Fr;Fr.parse=Fr});var Lt=I((Bh,Ms)=>{"use strict";p();var yc=(Bs(),O(Ps)),ks=ot(),Fs=Ls().parse,$=a(function(r,e,t){return t===
void 0?t=m.env["PG"+r.toUpperCase()]:t===!1||(t=m.env[t]),e[r]||t||ks[r]},"val"),mc=a(function(){switch(m.
env.PGSSLMODE){case"disable":return!1;case"prefer":case"require":case"verify-ca":case"verify-full":return!0;case"\
no-verify":return{rejectUnauthorized:!1}}return ks.ssl},"readSSLConfigFromEnvironment"),He=a(function(r){
return"'"+(""+r).replace(/\\/g,"\\\\").replace(/'/g,"\\'")+"'"},"quoteParamValue"),ie=a(function(r,e,t){
var n=e[t];n!=null&&r.push(t+"="+He(n))},"add"),Mr=class Mr{constructor(e){e=typeof e=="string"?Fs(e):
e||{},e.connectionString&&(e=Object.assign({},e,Fs(e.connectionString))),this.user=$("user",e),this.
...
slkey"),ie(t,n,"sslcert"),ie(t,n,"sslrootcert"),this.database&&t.push("dbname="+He(this.database)),this.
replication&&t.push("replication="+He(this.replication)),this.host&&t.push("host="+He(this.host)),this.
isDomainSocket)return e(null,t.join(" "));this.client_encoding&&t.push("client_encoding="+He(this.client_encoding)),
yc.lookup(this.host,function(i,s){return i?e(i,null):(t.push("hostaddr="+He(s)),e(null,t.join(" ")))})}};
a(Mr,"ConnectionParameters");var kr=Mr;Ms.exports=kr});var Os=I((Fh,Ds)=>{"use strict";p();var wc=nt(),Us=/^([A-Za-z]+)(?: (\d+))?(?: (\d+))?/,Dr=class Dr{constructor(e,t){
...
format||"text")}}};a(Dr,"Result");var Ur=Dr;Ds.exports=Ur});var Ws=I((Uh,Ns)=>{"use strict";p();var{EventEmitter:gc}=ge(),qs=Os(),Qs=at(),qr=class qr extends gc{constructor(e,t,n){
...
e.sendCopyFail("No source stream defined")}handleCopyData(e,t){}};a(qr,"Query");var Or=qr;Ns.exports=
Or});var yn=I(_=>{"use strict";p();Object.defineProperty(_,"__esModule",{value:!0});_.NoticeMessage=_.DataRowMessage=
...
{name:"copyDone",length:4};var en=class en extends Error{constructor(e,t,n){super(e),this.length=t,this.
name=n}};a(en,"DatabaseError");var Qr=en;_.DatabaseError=Qr;var tn=class tn{constructor(e,t){this.length=
e,this.chunk=t,this.name="copyData"}};a(tn,"CopyDataMessage");var Nr=tn;_.CopyDataMessage=Nr;var rn=class rn{constructor(e,t,n,i){
this.length=e,this.name=t,this.binary=n,this.columnTypes=new Array(i)}};a(rn,"CopyResponse");var Wr=rn;
_.CopyResponse=Wr;var nn=class nn{constructor(e,t,n,i,s,o,u){this.name=e,this.tableID=t,this.columnID=
n,this.dataTypeID=i,this.dataTypeSize=s,this.dataTypeModifier=o,this.format=u}};a(nn,"Field");var jr=nn;
_.Field=jr;var sn=class sn{constructor(e,t){this.length=e,this.fieldCount=t,this.name="rowDescriptio\
n",this.fields=new Array(this.fieldCount)}};a(sn,"RowDescriptionMessage");var Hr=sn;_.RowDescriptionMessage=
Hr;var on=class on{constructor(e,t){this.length=e,this.parameterCount=t,this.name="parameterDescript\
ion",this.dataTypeIDs=new Array(this.parameterCount)}};a(on,"ParameterDescriptionMessage");var $r=on;
_.ParameterDescriptionMessage=$r;var an=class an{constructor(e,t,n){this.length=e,this.parameterName=
t,this.parameterValue=n,this.name="parameterStatus"}};a(an,"ParameterStatusMessage");var Gr=an;_.ParameterStatusMessage=
Gr;var un=class un{constructor(e,t){this.length=e,this.salt=t,this.name="authenticationMD5Password"}};
a(un,"AuthenticationMD5Password");var Vr=un;_.AuthenticationMD5Password=Vr;var cn=class cn{constructor(e,t,n){
this.length=e,this.processID=t,this.secretKey=n,this.name="backendKeyData"}};a(cn,"BackendKeyDataMes\
sage");var zr=cn;_.BackendKeyDataMessage=zr;var ln=class ln{constructor(e,t,n,i){this.length=e,this.
processId=t,this.channel=n,this.payload=i,this.name="notification"}};a(ln,"NotificationResponseMessa\
ge");var Kr=ln;_.NotificationResponseMessage=Kr;var fn=class fn{constructor(e,t){this.length=e,this.
status=t,this.name="readyForQuery"}};a(fn,"ReadyForQueryMessage");var Yr=fn;_.ReadyForQueryMessage=Yr;
var hn=class hn{constructor(e,t){this.length=e,this.text=t,this.name="commandComplete"}};a(hn,"Comma\
ndCompleteMessage");var Zr=hn;_.CommandCompleteMessage=Zr;var pn=class pn{constructor(e,t){this.length=
e,this.fields=t,this.name="dataRow",this.fieldCount=t.length}};a(pn,"DataRowMessage");var Jr=pn;_.DataRowMessage=
Jr;var dn=class dn{constructor(e,t){this.length=e,this.message=t,this.name="notice"}};a(dn,"NoticeMe\
ssage");var Xr=dn;_.NoticeMessage=Xr});var js=I(Ft=>{"use strict";p();Object.defineProperty(Ft,"__esModule",{value:!0});Ft.Writer=void 0;var wn=class wn{constructor(e=256){
...
headerPosition=0,this.buffer=d.allocUnsafe(this.size),t}};a(wn,"Writer");var mn=wn;Ft.Writer=mn});var $s=I(Mt=>{"use strict";p();Object.defineProperty(Mt,"__esModule",{value:!0});Mt.serialize=void 0;
var gn=js(),M=new gn.Writer,bc=a(r=>{M.addInt16(3).addInt16(0);for(let n of Object.keys(r))M.addCString(
n).addCString(r[n]);M.addCString("client_encoding").addCString("UTF8");let e=M.addCString("").flush(),
t=e.length+4;return new gn.Writer().addInt32(t).add(e).flush()},"startup"),vc=a(()=>{let r=d.allocUnsafe(
8);return r.writeInt32BE(8,0),r.writeInt32BE(80877103,4),r},"requestSsl"),xc=a(r=>M.addCString(r).flush(
112),"password"),Sc=a(function(r,e){return M.addCString(r).addInt32(d.byteLength(e)).addString(e),M.
flush(112)},"sendSASLInitialResponseMessage"),Ec=a(function(r){return M.addString(r).flush(112)},"se\
ndSCRAMClientFinalMessage"),Ac=a(r=>M.addCString(r).flush(81),"query"),Hs=[],Cc=a(r=>{let e=r.name||
...
xecuting queries"));let t=r.types||Hs,n=t.length,i=M.addCString(e).addCString(r.text).addInt16(n);for(let s=0;s<
n;s++)i.addInt32(t[s]);return M.flush(80)},"parse"),$e=new gn.Writer,_c=a(function(r,e){for(let t=0;t<
r.length;t++){let n=e?e(r[t],t):r[t];n==null?(M.addInt16(0),$e.addInt32(-1)):n instanceof d?(M.addInt16(
1),$e.addInt32(n.length),$e.add(n)):(M.addInt16(0),$e.addInt32(d.byteLength(n)),$e.addString(n))}},"\
writeValues"),Ic=a((r={})=>{let e=r.portal||"",t=r.statement||"",n=r.binary||!1,i=r.values||Hs,s=i.length;
return M.addCString(e).addCString(t),M.addInt16(s),_c(i,r.valueMapper),M.addInt16(s),M.add($e.flush()),
M.addInt16(n?1:0),M.flush(66)},"bind"),Tc=d.from([69,0,0,0,9,0,0,0,0,0]),Pc=a(r=>{if(!r||!r.portal&&
!r.rows)return Tc;let e=r.portal||"",t=r.rows||0,n=d.byteLength(e),i=4+n+1+4,s=d.allocUnsafe(1+i);return s[0]=
69,s.writeInt32BE(i,1),s.write(e,5,"utf-8"),s[n+5]=0,s.writeUInt32BE(t,s.length-4),s},"execute"),Bc=a(
(r,e)=>{let t=d.allocUnsafe(16);return t.writeInt32BE(16,0),t.writeInt16BE(1234,4),t.writeInt16BE(5678,
6),t.writeInt32BE(r,8),t.writeInt32BE(e,12),t},"cancel"),bn=a((r,e)=>{let n=4+d.byteLength(e)+1,i=d.
allocUnsafe(1+n);return i[0]=r,i.writeInt32BE(n,1),i.write(e,5,"utf-8"),i[n]=0,i},"cstringMessage"),
Rc=M.addCString("P").flush(68),Lc=M.addCString("S").flush(68),Fc=a(r=>r.name?bn(68,`${r.type}${r.name||
""}`):r.type==="P"?Rc:Lc,"describe"),kc=a(r=>{let e=`${r.type}${r.name||""}`;return bn(67,e)},"close"),
Mc=a(r=>M.add(r).flush(100),"copyData"),Uc=a(r=>bn(102,r),"copyFail"),kt=a(r=>d.from([r,0,0,0,4]),"c\
odeOnlyBuffer"),Dc=kt(72),Oc=kt(83),qc=kt(88),Qc=kt(99),Nc={startup:bc,password:xc,requestSsl:vc,sendSASLInitialResponseMessage:Sc,
sendSCRAMClientFinalMessage:Ec,query:Ac,parse:Cc,bind:Ic,execute:Pc,describe:Fc,close:kc,flush:a(()=>Dc,
"flush"),sync:a(()=>Oc,"sync"),end:a(()=>qc,"end"),copyData:Mc,copyDone:a(()=>Qc,"copyDone"),copyFail:Uc,
cancel:Bc};Mt.serialize=Nc});var Gs=I(Ut=>{"use strict";p();Object.defineProperty(Ut,"__esModule",{value:!0});Ut.BufferReader=void 0;
var Wc=d.allocUnsafe(0),xn=class xn{constructor(e=0){this.offset=e,this.buffer=Wc,this.encoding="utf\
...
offset+=e,t}};a(xn,"BufferReader");var vn=xn;Ut.BufferReader=vn});var Ks=I(Dt=>{"use strict";p();Object.defineProperty(Dt,"__esModule",{value:!0});Dt.Parser=void 0;var U=yn(),
jc=Gs(),Sn=1,Hc=4,Vs=Sn+Hc,zs=d.allocUnsafe(0),An=class An{constructor(e){if(this.buffer=zs,this.bufferLength=
0,this.bufferOffset=0,this.reader=new jc.BufferReader,e?.mode==="binary")throw new Error("Binary mod\
...
buffer=zs,this.bufferLength=0,this.bufferOffset=0):(this.bufferLength=n-i,this.bufferOffset=i)}mergeBuffer(e){
...
switch(t){case 50:return U.bindComplete;case 49:return U.parseComplete;case 51:return U.closeComplete;case 110:
return U.noData;case 115:return U.portalSuspended;case 99:return U.copyDone;case 87:return U.replicationStart;case 73:
return U.emptyQuery;case 68:return this.parseDataRowMessage(e,n,i);case 67:return this.parseCommandCompleteMessage(
...
return new U.DatabaseError("received invalid response: "+t.toString(16),n,"error")}}parseReadyForQueryMessage(e,t,n){
this.reader.setBuffer(e,n);let i=this.reader.string(1);return new U.ReadyForQueryMessage(t,i)}parseCommandCompleteMessage(e,t,n){
this.reader.setBuffer(e,n);let i=this.reader.cstring();return new U.CommandCompleteMessage(t,i)}parseCopyData(e,t,n){
let i=n.slice(e,e+(t-4));return new U.CopyDataMessage(t,i)}parseCopyInMessage(e,t,n){return this.parseCopyMessage(
...
int16(),u=new U.CopyResponse(t,i,s,o);for(let c=0;c<o;c++)u.columnTypes[c]=this.reader.int16();return u}parseNotificationMessage(e,t,n){
this.reader.setBuffer(e,n);let i=this.reader.int32(),s=this.reader.cstring(),o=this.reader.cstring();
return new U.NotificationResponseMessage(t,i,s,o)}parseRowDescriptionMessage(e,t,n){this.reader.setBuffer(
e,n);let i=this.reader.int16(),s=new U.RowDescriptionMessage(t,i);for(let o=0;o<i;o++)s.fields[o]=this.
...
"text":"binary";return new U.Field(e,t,n,i,s,o,u)}parseParameterDescriptionMessage(e,t,n){this.reader.
setBuffer(e,n);let i=this.reader.int16(),s=new U.ParameterDescriptionMessage(t,i);for(let o=0;o<i;o++)
...
null:this.reader.string(u)}return new U.DataRowMessage(t,s)}parseParameterStatusMessage(e,t,n){this.
reader.setBuffer(e,n);let i=this.reader.cstring(),s=this.reader.cstring();return new U.ParameterStatusMessage(
t,i,s)}parseBackendKeyData(e,t,n){this.reader.setBuffer(e,n);let i=this.reader.int32(),s=this.reader.
int32();return new U.BackendKeyDataMessage(t,i,s)}parseAuthenticationResponse(e,t,n){this.reader.setBuffer(
...
ticationMD5Password";let o=this.reader.bytes(4);return new U.AuthenticationMD5Password(t,o)}break;case 10:
...
c=i==="notice"?new U.NoticeMessage(t,u):new U.DatabaseError(u,t,i);return c.severity=s.S,c.code=s.C,
...
a(An,"Parser");var En=An;Dt.Parser=En});var Cn=I(xe=>{"use strict";p();Object.defineProperty(xe,"__esModule",{value:!0});xe.DatabaseError=xe.
serialize=xe.parse=void 0;var $c=yn();Object.defineProperty(xe,"DatabaseError",{enumerable:!0,get:a(
function(){return $c.DatabaseError},"get")});var Gc=$s();Object.defineProperty(xe,"serialize",{enumerable:!0,
get:a(function(){return Gc.serialize},"get")});var Vc=Ks();function zc(r,e){let t=new Vc.Parser;return r.
on("data",n=>t.parse(n,e)),new Promise(n=>r.on("end",()=>n()))}a(zc,"parse");xe.parse=zc});var Ys={};te(Ys,{connect:()=>Kc});function Kc({socket:r,servername:e}){return r.startTls(e),r}var Zs=K(
()=>{"use strict";p();a(Kc,"connect")});var Tn=I((sp,eo)=>{"use strict";p();var Js=(De(),O(xi)),Yc=ge().EventEmitter,{parse:Zc,serialize:Q}=Cn(),
Xs=Q.flush(),Jc=Q.sync(),Xc=Q.end(),In=class In extends Yc{constructor(e){super(),e=e||{},this.stream=
...
var u=(Zs(),O(Ys));let c={socket:n.stream};n.ssl!==!0&&(Object.assign(c,n.ssl),"key"in n.ssl&&(c.key=
...
stream.writable&&this.stream.write(Xs)}sync(){this._ending=!0,this._send(Xs),this._send(Jc)}ref(){this.
stream.ref()}unref(){this.stream.unref()}end(){if(this._ending=!0,!this._connecting||!this.stream.writable){
this.stream.end();return}return this.stream.write(Xc,()=>{this.stream.end()})}close(e){this._send(Q.
close(e))}describe(e){this._send(Q.describe(e))}sendCopyFromChunk(e){this._send(Q.copyData(e))}endCopyFrom(){
this._send(Q.copyDone())}sendCopyFail(e){this._send(Q.copyFail(e))}};a(In,"Connection");var _n=In;eo.
exports=_n});var no=I((cp,ro)=>{"use strict";p();var el=ge().EventEmitter,up=(ct(),O(ut)),tl=at(),Pn=ws(),rl=Ts(),
nl=_t(),il=Lt(),to=Ws(),sl=ot(),ol=Tn(),Bn=class Bn extends el{constructor(e){super(),this.connectionParameters=
new il(e),this.user=this.connectionParameters.user,this.database=this.connectionParameters.database,
...
this.replication=this.connectionParameters.replication;var t=e||{};this._Promise=t.Promise||g.Promise,
this._types=new nl(t.types),this._ending=!1,this._connecting=!1,this._connected=!1,this._connectionError=
!1,this._queryable=!0,this.connection=t.connection||new ol({stream:t.stream,ssl:this.connectionParameters.
ssl,keepAlive:t.keepAlive||!1,keepAliveInitialDelayMillis:t.keepAliveInitialDelayMillis||0,encoding:this.
connectionParameters.client_encoding||"utf8"}),this.queryQueue=[],this.binary=t.binary||sl.binary,this.
...
password=this.password=null;e()}).catch(n=>{t.emit("error",n)}):this.password!==null?e():rl(this.connectionParameters,
n=>{n!==void 0&&(this.connectionParameters.password=this.password=n),e()})}_handleAuthCleartextPassword(e){
this._checkPgPass(()=>{this.connection.password(this.password)})}_handleAuthMD5Password(e){this._checkPgPass(
()=>{let t=tl.postgresMd5PasswordHash(this.user,this.password,e.salt);this.connection.password(t)})}_handleAuthSASL(e){
...
connectionParameters.query_timeout,i=new to(e,t,n),i.callback||(s=new this._Promise((l,f)=>{i.callback=
(y,w)=>y?f(y):l(w)}))),o&&(c=i.callback,u=setTimeout(()=>{var l=new Error("Query read timeout");m.nextTick(
...
_Promise(t=>{this.connection.once("end",t)})}};a(Bn,"Client");var Ot=Bn;Ot.Query=to;ro.exports=Ot});var ao=I((hp,oo)=>{"use strict";p();var al=ge().EventEmitter,io=a(function(){},"NOOP"),so=a((r,e)=>{
let t=r.findIndex(e);return t===-1?void 0:r.splice(t,1)[0]},"removeWhere"),Fn=class Fn{constructor(e,t,n){
this.client=e,this.idleListener=t,this.timeoutId=n}};a(Fn,"IdleItem");var Rn=Fn,kn=class kn{constructor(e){
this.callback=e}};a(kn,"PendingItem");var Ge=kn;function ul(){throw new Error("Release called on cli\
ent which has already been released to the pool.")}a(ul,"throwOnDoubleRelease");function qt(r,e){if(e)
return{callback:e,result:void 0};let t,n,i=a(function(o,u){o?t(o):n(u)},"cb"),s=new r(function(o,u){
n=o,t=u}).catch(o=>{throw Error.captureStackTrace(o),o});return{callback:i,result:s}}a(qt,"promisify");
function cl(r,e){return a(function t(n){n.client=e,e.removeListener("error",t),e.on("error",()=>{r.log(
"additional client error after disconnection due to error",n)}),r._remove(e),r.emit("error",n,e)},"i\
dleListener")}a(cl,"makeIdleListener");var Mn=class Mn extends al{constructor(e,t){super(),this.options=
...
this.log=this.options.log||function(){},this.Client=this.options.Client||t||ft().Client,this.Promise=
this.options.Promise||g.Promise,typeof this.options.idleTimeoutMillis>"u"&&(this.options.idleTimeoutMillis=
...
if(!this._isFull())return this.newClient(e);throw new Error("unexpected condition")}_remove(e){let t=so(
...
l after calling end on the pool");return e?e(i):this.Promise.reject(i)}let t=qt(this.Promise,e),n=t.
result;if(this._isFull()||this._idle.length){if(this._idle.length&&m.nextTick(()=>this._pulseQueue()),
!this.options.connectionTimeoutMillis)return this._pendingQueue.push(new Ge(t.callback)),n;let i=a((u,c,l)=>{
clearTimeout(o),t.callback(u,c,l)},"queueCallback"),s=new Ge(i),o=setTimeout(()=>{so(this._pendingQueue,
...
newClient(new Ge(t.callback)),n}newClient(e){let t=new this.Client(this.options);this._clients.push(
t);let n=cl(this,t);this.log("checking client timeout");let i,s=!1;this.options.connectionTimeoutMillis&&
...
_pulseQueue(),e.timedOut||e.callback(o,void 0,io);else{if(this.log("new client connected"),this.options.
maxLifetimeSeconds!==0){let u=setTimeout(()=>{this.log("ending client due to expired lifetime"),this.
_expired.add(t),this._idle.findIndex(l=>l.client===t)!==-1&&this._acquireClient(t,new Ge((l,f,y)=>y()),
...
release(s),t.callback(s,void 0,io);t.callback(void 0,e,e.release)}):t.callback(void 0,e,e.release)}_releaseOnce(e,t){
let n=!1;return i=>{n&&ul(),n=!0,this._release(e,t,i)}}_release(e,t,n){if(e.on("error",t),e._poolUseCount=
...
this.options.allowExitOnIdle&&s.unref()),this.options.allowExitOnIdle&&e.unref(),this._idle.push(new Rn(
e,t,s)),this._pulseQueue()}query(e,t,n){if(typeof e=="function"){let s=qt(this.Promise,e);return b(function(){
return s.callback(new Error("Passing a function as the first parameter to pool.query is not supporte\
d"))}),s.result}typeof t=="function"&&(n=t,t=void 0);let i=qt(this.Promise,n);return n=i.callback,this.
...
this.Promise.reject(n)}this.ending=!0;let t=qt(this.Promise,e);return this._endCallback=t.callback,this.
...
return this._clients.length}};a(Mn,"Pool");var Ln=Mn;oo.exports=Ln});var uo={};te(uo,{default:()=>ll});var ll,co=K(()=>{"use strict";p();ll={}});var lo=I((mp,fl)=>{fl.exports={name:"pg",version:"8.8.0",description:"PostgreSQL client - pure javas\
...
a178655"}});var po=I((wp,ho)=>{"use strict";p();var fo=ge().EventEmitter,hl=(ct(),O(ut)),Un=at(),Ve=ho.exports=function(r,e,t){
fo.call(this),r=Un.normalizeQueryConfig(r,e,t),this.text=r.text,this.values=r.values,this.name=r.name,
this.callback=r.callback,this.state="new",this._arrayMode=r.rowMode==="array",this._emitRowEvents=!1,
this.on("newListener",function(n){n==="row"&&(this._emitRowEvents=!0)}.bind(this))};hl.inherits(Ve,fo);
var pl={sqlState:"code",statementPosition:"position",messagePrimary:"message",context:"where",schemaName:"\
schema",tableName:"table",columnName:"column",dataTypeName:"dataType",constraintName:"constraint",sourceFile:"\
file",sourceLine:"line",sourceFunction:"routine"};Ve.prototype.handleError=function(r){var e=this.native.
pq.resultErrorFields();if(e)for(var t in e){var n=pl[t]||t;r[n]=e[t]}this.callback?this.callback(r):
this.emit("error",r),this.state="error"};Ve.prototype.then=function(r,e){return this._getPromise().then(
r,e)};Ve.prototype.catch=function(r){return this._getPromise().catch(r)};Ve.prototype._getPromise=function(){
return this._promise?this._promise:(this._promise=new Promise(function(r,e){this._once("end",r),this.
_once("error",e)}.bind(this)),this._promise)};Ve.prototype.submit=function(r){this.state="running";var e=this;
...
prepareValue);r.native.query(this.text,i,t)}else r.native.query(this.text,t)}});var go=I((xp,wo)=>{"use strict";p();var dl=(co(),O(uo)),yl=_t(),vp=lo(),yo=ge().EventEmitter,ml=(ct(),O(ut)),
wl=Lt(),mo=po(),J=wo.exports=function(r){yo.call(this),r=r||{},this._Promise=r.Promise||g.Promise,this.
_types=new yl(r.types),this.native=new dl({types:this._types}),this._queryQueue=[],this._ending=!1,this.
_connecting=!1,this._connected=!1,this._queryable=!0;var e=this.connectionParameters=new wl(r);this.
...
mo;ml.inherits(J,yo);J.prototype._errorAllQueries=function(r){let e=a(t=>{m.nextTick(()=>{t.native=this.
...
r,e,t)};J.prototype.getTypeParser=function(r,e){return this._types.getTypeParser(r,e)}});var Dn=I((Ap,bo)=>{"use strict";p();bo.exports=go()});var ft=I((_p,ht)=>{"use strict";p();var gl=no(),bl=ot(),vl=Tn(),xl=ao(),{DatabaseError:Sl}=Cn(),El=a(
r=>{var e;return e=class extends xl{constructor(n){super(n,r)}},a(e,"BoundPool"),e},"poolFactory"),On=a(
function(r){this.defaults=bl,this.Client=r,this.Query=this.Client.Query,this.Pool=El(this.Client),this.
_pools=[],this.Connection=vl,this.types=nt(),this.DatabaseError=Sl},"PG");typeof m.env.NODE_PG_FORCE_NATIVE<
"u"?ht.exports=new On(Dn()):(ht.exports=new On(gl),Object.defineProperty(ht.exports,"native",{configurable:!0,
enumerable:!1,get(){var r=null;try{r=new On(Dn())}catch(e){if(e.code!=="MODULE_NOT_FOUND")throw e}return Object.
defineProperty(ht.exports,"native",{value:r}),r}}))});var _l={};te(_l,{Client:()=>ze,DatabaseError:()=>ce.DatabaseError,NeonDbError:()=>he,NeonQueryPromise:()=>be,
Pool:()=>Qt,SqlTemplate:()=>Oe,UnsafeRawSql:()=>qe,_bundleExt:()=>Cl,defaults:()=>ce.defaults,escapeIdentifier:()=>ce.escapeIdentifier,
escapeLiteral:()=>ce.escapeLiteral,neon:()=>gr,neonConfig:()=>oe,types:()=>ce.types,warnIfBrowser:()=>Ze});
module.exports=O(_l);p();p();De();tr();p();var ma=Object.defineProperty,wa=Object.defineProperties,ga=Object.getOwnPropertyDescriptors,Ei=Object.
getOwnPropertySymbols,ba=Object.prototype.hasOwnProperty,va=Object.prototype.propertyIsEnumerable,Ai=a(
(r,e,t)=>e in r?ma(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t,"__defNormalProp"),
xa=a((r,e)=>{for(var t in e||(e={}))ba.call(e,t)&&Ai(r,t,e[t]);if(Ei)for(var t of Ei(e))va.call(e,t)&&
Ai(r,t,e[t]);return r},"__spreadValues"),Sa=a((r,e)=>wa(r,ga(e)),"__spreadProps"),Ea=1008e3,Ci=new Uint8Array(
new Uint16Array([258]).buffer)[0]===2,Aa=new TextDecoder,rr=new TextEncoder,gt=rr.encode("0123456789\
abcdef"),bt=rr.encode("0123456789ABCDEF"),Ca=rr.encode("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqr\
stuvwxyz0123456789+/");var _i=Ca.slice();_i[62]=45;_i[63]=95;var Ye,vt;function _a(r,{alphabet:e,scratchArr:t}={}){if(!Ye)if(Ye=
new Uint16Array(256),vt=new Uint16Array(256),Ci)for(let C=0;C<256;C++)Ye[C]=gt[C&15]<<8|gt[C>>>4],vt[C]=
bt[C&15]<<8|bt[C>>>4];else for(let C=0;C<256;C++)Ye[C]=gt[C&15]|gt[C>>>4]<<8,vt[C]=bt[C&15]|bt[C>>>4]<<
8;r.byteOffset%4!==0&&(r=new Uint8Array(r));let n=r.length,i=n>>>1,s=n>>>2,o=t||new Uint16Array(n),u=new Uint32Array(
r.buffer,r.byteOffset,s),c=new Uint32Array(o.buffer,o.byteOffset,i),l=e==="upper"?vt:Ye,f=0,y=0,w;if(Ci)
for(;f<s;)w=u[f++],c[y++]=l[w>>>8&255]<<16|l[w&255],c[y++]=l[w>>>24]<<16|l[w>>>16&255];else for(;f<s;)
w=u[f++],c[y++]=l[w>>>24]<<16|l[w>>>16&255],c[y++]=l[w>>>8&255]<<16|l[w&255];for(f<<=2;f<n;)o[f]=l[r[f++]];
return Aa.decode(o.subarray(0,n))}a(_a,"_toHex");function Ia(r,e={}){let t="",n=r.length,i=Ea>>>1,s=Math.
ceil(n/i),o=new Uint16Array(s>1?i:n);for(let u=0;u<s;u++){let c=u*i,l=c+i;t+=_a(r.subarray(c,l),Sa(xa(
{},e),{scratchArr:o}))}return t}a(Ia,"_toHexChunked");function Ii(r,e={}){return e.alphabet!=="upper"&&
typeof r.toHex=="function"?r.toHex():Ia(r,e)}a(Ii,"toHex");p();var xt=class xt{constructor(e,t){this.strings=e;this.values=t}toParameterizedQuery(e={query:"",params:[]}){
let{strings:t,values:n}=this;for(let i=0,s=t.length;i<s;i++)if(e.query+=t[i],i<n.length){let o=n[i];
if(o instanceof qe)e.query+=o.sql;else if(o instanceof be)if(o.queryData instanceof xt)o.queryData.toParameterizedQuery(
...
(e.query+="::bytea")}}return e}};a(xt,"SqlTemplate");var Oe=xt,nr=class nr{constructor(e){this.sql=e}};
a(nr,"UnsafeRawSql");var qe=nr;p();function Ze(){typeof window<"u"&&typeof document<"u"&&typeof console<"u"&&typeof console.warn=="func\
tion"&&console.warn(`          
        ************************************************************
        *                                                          *
        ...
        *  parameter.                                              *
        *                                                          *
        ************************************************************`)}a(Ze,"warnIfBrowser");De();var fs=_e(_t()),hs=_e(at());var Tt=class Tt extends Error{constructor(t){super(t);A(this,"name","NeonDbError");A(this,"severity");
...
tackTrace"in Error&&typeof Error.captureStackTrace=="function"&&Error.captureStackTrace(this,Tt)}};a(
Tt,"NeonDbError");var he=Tt,us="transaction() expects an array of queries, or a function returning a\
n array of queries",ku=["severity","code","detail","hint","position","internalPosition","internalQue\
ry","where","schema","table","column","dataType","constraint","file","line","routine"];function Mu(r){
return r instanceof d?"\\x"+Ii(r):r}a(Mu,"encodeBuffersAsBytea");function cs(r){let{query:e,params:t}=r instanceof
Oe?r.toParameterizedQuery():r;return{query:e,params:t.map(n=>Mu((0,hs.prepareValue)(n)))}}a(cs,"prep\
...
authToken:u,disableWarningInBrowsers:c}={}){if(!r)throw new Error("No database connection string was\
 provided to `neon()`. Perhaps an environment variable has not been set?");let l;try{l=er(r)}catch{throw new Error(
"Database connection string provided to `neon()` is not a valid URL. Connection string: "+String(r))}
let{protocol:f,username:y,hostname:w,port:S,pathname:C,password:N,endpoint:W}=l;if(f!=="postgres:"&&
f!=="postgresql:"||!y||!w||!C)throw new Error("Database connection string format for `neon()` should\
 be: postgresql://user:password@host.tld/dbname?option=value");let se=!1;W&&!w.startsWith(W)&&(r=Du(
r,N,W),console.table({endpoint:W,connectionString:r}),se=!0);function T(P,...F){if(!(Array.isArray(P)&&
Array.isArray(P.raw)&&Array.isArray(F)))throw new Error('This function can now be called only as a t\
agged-template function: sql`SELECT ${value}`, not sql("SELECT $1", [value], options). For a convent\
ional function call with value placeholders ($1, $2, etc.), use sql.query("SELECT $1", [value], opti\
ons).');return new be(E,new Oe(P,F))}a(T,"templateFn"),T.query=(P,F,B)=>new be(E,{query:P,params:F??
[]},B),T.unsafe=P=>new qe(P),T.transaction=async(P,F)=>{if(typeof P=="function"&&(P=P(T)),!Array.isArray(
P))throw new Error(us);P.forEach(G=>{if(!(G instanceof be))throw new Error(us)});let B=P.map(G=>G.queryData),
X=P.map(G=>G.opts??{});return E(B,X,F)};async function E(P,F,B){let{fetchEndpoint:X,fetchFunction:G}=oe,
de=Array.isArray(P)?{queries:P.map(ee=>cs(ee))}:cs(P),R=n??{},H=e??!1,le=t??!1,ye=i,Se=s,Ee=o;B!==void 0&&
(B.fetchOptions!==void 0&&(R={...R,...B.fetchOptions}),B.arrayMode!==void 0&&(H=B.arrayMode),B.fullResults!==
void 0&&(le=B.fullResults),B.isolationLevel!==void 0&&(ye=B.isolationLevel),B.readOnly!==void 0&&(Se=
B.readOnly),B.deferrable!==void 0&&(Ee=B.deferrable)),F!==void 0&&!Array.isArray(F)&&F.fetchOptions!==
void 0&&(R={...R,...F.fetchOptions});let Ae=u;!Array.isArray(F)&&F?.authToken!==void 0&&(Ae=F.authToken);
let Nt=typeof X=="function"?X(w,S,{jwtAuth:Ae!==void 0,override:se}):X,Ce={"Neon-Connection-String":r,
"Neon-Raw-Text-Output":"true","Neon-Array-Mode":"true"},me=await Uu(Ae);me&&(Ce.Authorization=`Beare\
r ${me}`),Array.isArray(P)&&(ye!==void 0&&(Ce["Neon-Batch-Isolation-Level"]=ye),Se!==void 0&&(Ce["Ne\
on-Batch-Read-Only"]=String(Se)),Ee!==void 0&&(Ce["Neon-Batch-Deferrable"]=String(Ee))),c||oe.disableWarningInBrowsers||
Ze();let V;try{V=await(G??fetch)(Nt,{method:"POST",body:JSON.stringify(de),headers:Ce,...R})}catch(ee){
let z=new he(`Error connecting to database: ${ee}`);throw z.sourceError=ee,z}if(V.ok){let ee=await V.
json();if(Array.isArray(P)){let z=ee.results;if(!Array.isArray(z))throw new he("Neon internal error:\
 unexpected result format");return z.map((Pe,Be)=>{let Wt=F[Be]??{},Eo=Wt.arrayMode??H,Ao=Wt.fullResults??
le;return ls(Pe,{arrayMode:Eo,fullResults:Ao,types:Wt.types})})}else{let z=F??{},Pe=z.arrayMode??H,Be=z.
fullResults??le;return ls(ee,{arrayMode:Pe,fullResults:Be,types:z.types})}}else{let{status:ee}=V;if(ee===
400){let z=await V.json(),Pe=new he(z.message);for(let Be of ku)Pe[Be]=z[Be]??void 0;throw Pe}else{let z=await V.
text();throw new he(`Server error (HTTP status ${ee}): ${z}`)}}}return a(E,"execute"),T}a(gr,"neon");
var br=class br{constructor(e,t,n){this.execute=e;this.queryData=t;this.opts=n}then(e,t){return this.
execute(this.queryData,this.opts).then(e,t)}catch(e){return this.execute(this.queryData,this.opts).catch(
e)}finally(e){return this.execute(this.queryData,this.opts).finally(e)}};a(br,"NeonQueryPromise");var be=br;
function ls(r,{arrayMode:e,fullResults:t,types:n}){let i=new fs.default(n),s=r.fields.map(c=>c.name),
...
!0,r.rowAsArray=e,r.rows=u,r._parsers=o,r._types=i,r):u}a(ls,"processQueryResult");async function Uu(r){
if(typeof r=="string")return r;if(typeof r=="function")try{return await Promise.resolve(r())}catch(e){
let t=new he("Error getting auth token.");throw e instanceof Error&&(t=new he(`Error getting auth to\
ken: ${e.message}`)),t}}a(Uu,"getAuthToken");function Du(r,e,t){let{protocol:n}=new URL(r),i="http:"+
r.substring(n.length),s=new URL(i);return s.password=e,s.hostname=t,n+s.toString().substring(5)}a(Du,
"rewriteConnectionString");p();var xo=_e(ft());p();var vo=_e(ft());var qn=class qn extends vo.Client{constructor(t){super(t);this.config=t}get neonConfig(){return this.
...
Ze(),this._handleAuthCleartextPassword(),this._handleReadyForQuery()})}return o}async _handleAuthSASLContinue(t){
...
"SASL: protocol error");let u=Object.fromEntries(o.split(",").map(me=>{if(!/^.=/.test(me))throw new Error(
"SASL: Invalid attribute pair entry");let V=me[0],ee=me.substring(2);return[V,ee]})),c=u.r,l=u.s,f=u.
...
length===i.clientNonce.length)throw new Error("SASL: SCRAM-SERVER-FIRST-MESSAGE: server nonce is too\
 short");let y=parseInt(f,10),w=d.from(l,"base64"),S=new TextEncoder,C=S.encode(s),N=await n.importKey(
"raw",C,{name:"HMAC",hash:{name:"SHA-256"}},!1,["sign"]),W=new Uint8Array(await n.sign("HMAC",N,d.concat(
[w,d.from([0,0,0,1])]))),se=W;for(var T=0;T<y-1;T++)W=new Uint8Array(await n.sign("HMAC",N,W)),se=d.
from(se.map((me,V)=>se[V]^W[V]));let E=se,P=await n.importKey("raw",E,{name:"HMAC",hash:{name:"SHA-2\
56"}},!1,["sign"]),F=new Uint8Array(await n.sign("HMAC",P,S.encode("Client Key"))),B=await n.digest(
"SHA-256",F),X="n=*,r="+i.clientNonce,G="r="+c+",s="+l+",i="+y,de="c=biws,r="+c,R=X+","+G+","+de,H=await n.
importKey("raw",B,{name:"HMAC",hash:{name:"SHA-256"}},!1,["sign"]);var le=new Uint8Array(await n.sign(
"HMAC",H,S.encode(R))),ye=d.from(F.map((me,V)=>F[V]^le[V])),Se=ye.toString("base64");let Ee=await n.
importKey("raw",E,{name:"HMAC",hash:{name:"SHA-256"}},!1,["sign"]),Ae=await n.sign("HMAC",Ee,S.encode(
"Server Key")),Nt=await n.importKey("raw",Ae,{name:"HMAC",hash:{name:"SHA-256"}},!1,["sign"]);var Ce=d.
from(await n.sign("HMAC",Nt,S.encode(R)));i.message="SASLResponse",i.serverSignature=Ce.toString("ba\
se64"),i.response=de+",p="+Se,this.connection.sendSCRAMClientFinalMessage(this.saslSession.response)}};
a(qn,"NeonClient");var ze=qn;De();var So=_e(Lt());function Al(r,e){if(e)return{callback:e,result:void 0};let t,n,i=a(function(o,u){o?t(o):n(u)},"cb"),
s=new r(function(o,u){n=o,t=u});return{callback:i,result:s}}a(Al,"promisify");var Qn=class Qn extends xo.Pool{constructor(){
super(...arguments);A(this,"Client",ze);A(this,"hasFetchUnsupportedListeners",!1);A(this,"addListene\
...
t,n,i);typeof n=="function"&&(i=n,n=void 0);let s=Al(this.Promise,i);i=s.callback;try{let o=new So.default(
this.options),u=encodeURIComponent,c=encodeURI,l=`postgresql://${u(o.user)}:${u(o.password)}@${u(o.host)}\
/${c(o.database)}`,f=typeof t=="string"?t:t.text,y=n??t.values??[];gr(l,{fullResults:!0,arrayMode:t.
rowMode==="array"}).query(f,y,{types:t.types??this.options?.types}).then(S=>i(void 0,S)).catch(S=>i(
S))}catch(o){i(o)}return s.result}};a(Qn,"NeonPool");var Qt=Qn;De();var ce=_e(ft()),Cl="js";
