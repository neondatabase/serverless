"use strict";var Ao=Object.create;var Te=Object.defineProperty;var Co=Object.getOwnPropertyDescriptor;var _o=Object.getOwnPropertyNames;var Io=Object.getPrototypeOf,To=Object.prototype.hasOwnProperty;var Po=(r,e,t)=>e in r?Te(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t;var a=(r,e)=>Te(r,"name",{value:e,configurable:!0});var $=(r,e)=>()=>(r&&(e=r(r=0)),e);var T=(r,e)=>()=>(e||r((e={exports:{}}).exports,e),e.exports),te=(r,e)=>{for(var t in e)Te(r,t,{get:e[t],
enumerable:!0})},Qn=(r,e,t,n)=>{if(e&&typeof e=="object"||typeof e=="function")for(let i of _o(e))!To.
call(r,i)&&i!==t&&Te(r,i,{get:()=>e[i],enumerable:!(n=Co(e,i))||n.enumerable});return r};var be=(r,e,t)=>(t=r!=null?Ao(Io(r)):{},Qn(e||!r||!r.__esModule?Te(t,"default",{value:r,enumerable:!0}):
t,r)),O=r=>Qn(Te({},"__esModule",{value:!0}),r);var E=(r,e,t)=>Po(r,typeof e!="symbol"?e+"":e,t);var jn=T(ht=>{"use strict";p();ht.byteLength=Bo;ht.toByteArray=Fo;ht.fromByteArray=Uo;var ue=[],re=[],
Ro=typeof Uint8Array<"u"?Uint8Array:Array,Nt="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz01\
23456789+/";for(Ce=0,Nn=Nt.length;Ce<Nn;++Ce)ue[Ce]=Nt[Ce],re[Nt.charCodeAt(Ce)]=Ce;var Ce,Nn;re[45]=
...
function Bo(r){var e=Wn(r),t=e[0],n=e[1];return(t+n)*3/4-n}a(Bo,"byteLength");function Lo(r,e,t){return(e+
t)*3/4-t}a(Lo,"_byteLength");function Fo(r){var e,t=Wn(r),n=t[0],i=t[1],s=new Ro(Lo(r,n,i)),o=0,u=i>
...
4|re[r.charCodeAt(c+2)]>>2,s[o++]=e>>8&255,s[o++]=e&255),s}a(Fo,"toByteArray");function ko(r){return ue[r>>
18&63]+ue[r>>12&63]+ue[r>>6&63]+ue[r&63]}a(ko,"tripletToBase64");function Mo(r,e,t){for(var n,i=[],s=e;s<
t;s+=3)n=(r[s]<<16&16711680)+(r[s+1]<<8&65280)+(r[s+2]&255),i.push(ko(n));return i.join("")}a(Mo,"en\
codeChunk");function Uo(r){for(var e,t=r.length,n=t%3,i=[],s=16383,o=0,u=t-n;o<u;o+=s)i.push(Mo(r,o,
o+s>u?u:o+s));return n===1?(e=r[t-1],i.push(ue[e>>2]+ue[e<<4&63]+"==")):n===2&&(e=(r[t-2]<<8)+r[t-1],
i.push(ue[e>>10]+ue[e>>4&63]+ue[e<<2&63]+"=")),i.join("")}a(Uo,"fromByteArray")});var Hn=T(Wt=>{p();Wt.read=function(r,e,t,n,i){var s,o,u=i*8-n-1,c=(1<<u)-1,l=c>>1,f=-7,y=t?i-1:0,w=t?
-1:1,A=r[e+y];for(y+=w,s=A&(1<<-f)-1,A>>=-f,f+=u;f>0;s=s*256+r[e+y],y+=w,f-=8);for(o=s&(1<<-f)-1,s>>=
-f,f+=n;f>0;o=o*256+r[e+y],y+=w,f-=8);if(s===0)s=1-l;else{if(s===c)return o?NaN:(A?-1:1)*(1/0);o=o+Math.
pow(2,n),s=s-l}return(A?-1:1)*o*Math.pow(2,s-n)};Wt.write=function(r,e,t,n,i,s){var o,u,c,l=s*8-i-1,
f=(1<<l)-1,y=f>>1,w=i===23?Math.pow(2,-24)-Math.pow(2,-77):0,A=n?0:s-1,C=n?1:-1,D=e<0||e===0&&1/e<0?
...
C,u/=256,i-=8);for(o=o<<i|u,l+=i;l>0;r[t+A]=o&255,A+=C,o/=256,l-=8);r[t+A-C]|=D*128}});var ai=T(Le=>{"use strict";p();var jt=jn(),Re=Hn(),Gn=typeof Symbol=="function"&&typeof Symbol.for==
"function"?Symbol.for("nodejs.util.inspect.custom"):null;Le.Buffer=h;Le.SlowBuffer=Wo;Le.INSPECT_MAX_BYTES=
50;var pt=2147483647;Le.kMaxLength=pt;h.TYPED_ARRAY_SUPPORT=Do();!h.TYPED_ARRAY_SUPPORT&&typeof console<
"u"&&typeof console.error=="function"&&console.error("This browser lacks typed array (Uint8Array) su\
pport which is required by `buffer` v5.x. Use `buffer` v4.x if you require old browser support.");function Do(){
try{let r=new Uint8Array(1),e={foo:a(function(){return 42},"foo")};return Object.setPrototypeOf(e,Uint8Array.
prototype),Object.setPrototypeOf(r,e),r.foo()===42}catch{return!1}}a(Do,"typedArraySupport");Object.
...
this))return this.byteOffset},"get")});function pe(r){if(r>pt)throw new RangeError('The value "'+r+'\
...
isView(r))return Qo(r);if(r==null)throw new TypeError("The first argument must be one of type string\
...
from(n,e,t);let i=No(r);if(i)return i;if(typeof Symbol<"u"&&Symbol.toPrimitive!=null&&typeof r[Symbol.
...
for option "size"')}a(Yn,"assertSize");function Oo(r,e,t){return Yn(r),r<=0?pe(r):e!==void 0?typeof t==
"string"?pe(r).fill(e,t):pe(r).fill(e):pe(r)}a(Oo,"alloc");h.alloc=function(r,e,t){return Oo(r,e,t)};
function Vt(r){return Yn(r),pe(r<0?0:Kt(r)|0)}a(Vt,"allocUnsafe");h.allocUnsafe=function(r){return Vt(
r)};h.allocUnsafeSlow=function(r){return Vt(r)};function qo(r,e){if((typeof e!="string"||e==="")&&(e=
"utf8"),!h.isEncoding(e))throw new TypeError("Unknown encoding: "+e);let t=Zn(r,e)|0,n=pe(t),i=n.write(
r,e);return i!==t&&(n=n.slice(0,i)),n}a(qo,"fromString");function Ht(r){let e=r.length<0?0:Kt(r.length)|
0,t=pe(e);for(let n=0;n<e;n+=1)t[n]=r[n]&255;return t}a(Ht,"fromArrayLike");function Qo(r){if(ce(r,Uint8Array)){
let e=new Uint8Array(r);return Gt(e.buffer,e.byteOffset,e.byteLength)}return Ht(r)}a(Qo,"fromArrayVi\
...
r,e,t),Object.setPrototypeOf(n,h.prototype),n}a(Gt,"fromArrayBuffer");function No(r){if(h.isBuffer(r)){
let e=Kt(r.length)|0,t=pe(e);return t.length===0||r.copy(t,0,0,e),t}if(r.length!==void 0)return typeof r.
length!="number"||Yt(r.length)?pe(0):Ht(r);if(r.type==="Buffer"&&Array.isArray(r.data))return Ht(r.data)}
a(No,"fromObject");function Kt(r){if(r>=pt)throw new RangeError("Attempt to allocate Buffer larger t\
han maximum size: 0x"+pt.toString(16)+" bytes");return r|0}a(Kt,"checked");function Wo(r){return+r!=
r&&(r=0),h.alloc(+r)}a(Wo,"SlowBuffer");h.isBuffer=a(function(e){return e!=null&&e._isBuffer===!0&&e!==
...
if(i)return n?-1:$t(r).length;e=(""+e).toLowerCase(),i=!0}}a(Zn,"byteLength");h.byteLength=Zn;function jo(r,e,t){
let n=!1;if((e===void 0||e<0)&&(e=0),e>this.length||((t===void 0||t>this.length)&&(t=this.length),t<=
0)||(t>>>=0,e>>>=0,t<=e))return"";for(r||(r="utf8");;)switch(r){case"hex":return Xo(this,e,t);case"u\
tf8":case"utf-8":return Xn(this,e,t);case"ascii":return Zo(this,e,t);case"latin1":case"binary":return Jo(
this,e,t);case"base64":return zo(this,e,t);case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return ea(
this,e,t);default:if(n)throw new TypeError("Unknown encoding: "+r);r=(r+"").toLowerCase(),n=!0}}a(jo,
...
this,0,e):jo.apply(this,arguments)},"toString");h.prototype.toLocaleString=h.prototype.toString;h.prototype.
...
call(r,e,t):$n(r,[e],t,n,i);throw new TypeError("val must be string, number or Buffer")}a(Jn,"bidire\
...
h.prototype.lastIndexOf=a(function(e,t,n){return Jn(this,e,t,n,!1)},"lastIndexOf");function Ho(r,e,t,n){
t=Number(t)||0;let i=r.length-t;n?(n=Number(n),n>i&&(n=i)):n=i;let s=e.length;n>s/2&&(n=s/2);let o;for(o=
0;o<n;++o){let u=parseInt(e.substr(o*2,2),16);if(Yt(u))return o;r[t+o]=u}return o}a(Ho,"hexWrite");function Go(r,e,t,n){
return dt($t(e,r.length-t),r,t,n)}a(Go,"utf8Write");function $o(r,e,t,n){return dt(ia(e),r,t,n)}a($o,
"asciiWrite");function Vo(r,e,t,n){return dt(oi(e),r,t,n)}a(Vo,"base64Write");function Ko(r,e,t,n){return dt(
sa(e,r.length-t),r,t,n)}a(Ko,"ucs2Write");h.prototype.write=a(function(e,t,n,i){if(t===void 0)i="utf\
...
fer bounds");i||(i="utf8");let o=!1;for(;;)switch(i){case"hex":return Ho(this,e,t,n);case"utf8":case"\
utf-8":return Go(this,e,t,n);case"ascii":case"latin1":case"binary":return $o(this,e,t,n);case"base64":
return Vo(this,e,t,n);case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return Ko(this,e,t,n);default:
...
n.push(o),i+=u}return Yo(n)}a(Xn,"utf8Slice");var Vn=4096;function Yo(r){let e=r.length;if(e<=Vn)return String.
fromCharCode.apply(String,r);let t="",n=0;for(;n<e;)t+=String.fromCharCode.apply(String,r.slice(n,n+=
Vn));return t}a(Yo,"decodeCodePointsArray");function Zo(r,e,t){let n="";t=Math.min(r.length,t);for(let i=e;i<
t;++i)n+=String.fromCharCode(r[i]&127);return n}a(Zo,"asciiSlice");function Jo(r,e,t){let n="";t=Math.
min(r.length,t);for(let i=e;i<t;++i)n+=String.fromCharCode(r[i]);return n}a(Jo,"latin1Slice");function Xo(r,e,t){
let n=r.length;(!e||e<0)&&(e=0),(!t||t<0||t>n)&&(t=n);let i="";for(let s=e;s<t;++s)i+=oa[r[s]];return i}
a(Xo,"hexSlice");function ea(r,e,t){let n=r.slice(e,t),i="";for(let s=0;s<n.length-1;s+=2)i+=String.
fromCharCode(n[s]+n[s+1]*256);return i}a(ea,"utf16leSlice");h.prototype.slice=a(function(e,t){let n=this.
...
ve(a(function(e){e=e>>>0,Be(e,"offset");let t=this[e],n=this[e+7];(t===void 0||n===void 0)&&Ve(e,this.
...
writeBigUInt64LE=ve(a(function(e,t=0){return ei(this,e,t,BigInt(0),BigInt("0xffffffffffffffff"))},"w\
riteBigUInt64LE"));h.prototype.writeBigUInt64BE=ve(a(function(e,t=0){return ti(this,e,t,BigInt(0),BigInt(
...
t+4},"writeInt32BE");h.prototype.writeBigInt64LE=ve(a(function(e,t=0){return ei(this,e,t,-BigInt("0x\
...
+e,t=t>>>0,i||ri(r,e,t,4,34028234663852886e22,-34028234663852886e22),Re.write(r,e,t,n,23,4),t+4}a(ni,
...
return e=+e,t=t>>>0,i||ri(r,e,t,8,17976931348623157e292,-17976931348623157e292),Re.write(r,e,t,n,52,
...
_${r.slice(t-3,t)}${e}`;return`${r.slice(0,t)}${e}`}a(Kn,"addNumericalSeparator");function ta(r,e,t){
Be(e,"offset"),(r[e]===void 0||r[e+t]===void 0)&&Ve(e,r.length-(t+1))}a(ta,"checkBounds");function si(r,e,t,n,i,s){
...
nd <= ${t}${o}`,new Pe.ERR_OUT_OF_RANGE("value",u,r)}ta(n,i,s)}a(si,"checkIntBI");function Be(r,e){if(typeof r!=
...
new Pe.ERR_OUT_OF_RANGE(t||"offset",`>= ${t?1:0} and <= ${e}`,r)}a(Ve,"boundsError");var ra=/[^+/0-9A-Za-z-_]/g;
function na(r){if(r=r.split("=")[0],r=r.trim().replace(ra,""),r.length<2)return"";for(;r.length%4!==
0;)r=r+"=";return r}a(na,"base64clean");function $t(r,e){e=e||1/0;let t,n=r.length,i=null,s=[];for(let o=0;o<
...
8ToBytes");function ia(r){let e=[];for(let t=0;t<r.length;++t)e.push(r.charCodeAt(t)&255);return e}a(
ia,"asciiToBytes");function sa(r,e){let t,n,i,s=[];for(let o=0;o<r.length&&!((e-=2)<0);++o)t=r.charCodeAt(
o),n=t>>8,i=t%256,s.push(i),s.push(n);return s}a(sa,"utf16leToBytes");function oi(r){return jt.toByteArray(
na(r))}a(oi,"base64ToBytes");function dt(r,e,t,n){let i;for(i=0;i<n&&!(i+t>=e.length||i>=r.length);++i)
e[i+t]=r[i];return i}a(dt,"blitBuffer");function ce(r,e){return r instanceof e||r!=null&&r.constructor!=
null&&r.constructor.name!=null&&r.constructor.name===e.name}a(ce,"isInstance");function Yt(r){return r!==
r}a(Yt,"numberIsNaN");var oa=function(){let r="0123456789abcdef",e=new Array(256);for(let t=0;t<16;++t){
let n=t*16;for(let i=0;i<16;++i)e[n+i]=r[t]+r[i]}return e}();function ve(r){return typeof BigInt>"u"?
aa:r}a(ve,"defineBigIntMethod");function aa(){throw new Error("BigInt not supported")}a(aa,"BufferBi\
gIntNotDefined")});var b,v,x,d,m,p=$(()=>{"use strict";b=globalThis,v=globalThis.setImmediate??(r=>setTimeout(r,0)),x=globalThis.
...
m.nextTick(()=>{})}catch{let e=Promise.resolve();m.nextTick=e.then.bind(e)}});var xe=T((Ml,Zt)=>{"use strict";p();var Fe=typeof Reflect=="object"?Reflect:null,ui=Fe&&typeof Fe.apply==
...
getOwnPropertyNames(e)},"ReflectOwnKeys");function ua(r){console&&console.warn&&console.warn(r)}a(ua,
"ProcessEmitWarning");var li=Number.isNaN||a(function(e){return e!==e},"NumberIsNaN");function R(){R.
init.call(this)}a(R,"EventEmitter");Zt.exports=R;Zt.exports.once=ha;R.EventEmitter=R;R.prototype._events=
void 0;R.prototype._eventsCount=0;R.prototype._maxListeners=void 0;var ci=10;function mt(r){if(typeof r!=
...
R.prototype.setMaxListeners=a(function(e){if(typeof e!="number"||e<0||li(e))throw new RangeError('Th\
e value of "n" is out of range. It must be a non-negative number. Received '+e+".");return this._maxListeners=
e,this},"setMaxListeners");function fi(r){return r._maxListeners===void 0?R.defaultMaxListeners:r._maxListeners}
a(fi,"_getMaxListeners");R.prototype.getMaxListeners=a(function(){return fi(this)},"getMaxListeners");
...
r,u.type=e,u.count=o.length,ua(u)}return r}a(hi,"_addListener");R.prototype.addListener=a(function(e,t){
return hi(this,e,t,!1)},"addListener");R.prototype.on=R.prototype.addListener;R.prototype.prependListener=
a(function(e,t){return hi(this,e,t,!0)},"prependListener");function ca(){if(!this.fired)return this.
target.removeListener(this.type,this.wrapFn),this.fired=!0,arguments.length===0?this.listener.call(this.
target):this.listener.apply(this.target,arguments)}a(ca,"onceWrapper");function pi(r,e,t){var n={fired:!1,
wrapFn:void 0,target:r,type:e,listener:t},i=ca.bind(n);return i.listener=t,n.wrapFn=i,i}a(pi,"_onceW\
rap");R.prototype.once=a(function(e,t){return mt(t),this.on(e,pi(this,e,t)),this},"once");R.prototype.
...
fa(i):mi(i,i.length)}a(di,"_listeners");R.prototype.listeners=a(function(e){return di(this,e,!0)},"l\
isteners");R.prototype.rawListeners=a(function(e){return di(this,e,!1)},"rawListeners");R.listenerCount=
function(r,e){return typeof r.listenerCount=="function"?r.listenerCount(e):yi.call(r,e)};R.prototype.
listenerCount=yi;function yi(r){var e=this._events;if(e!==void 0){var t=e[r];if(typeof t=="function")
return 1;if(t!==void 0)return t.length}return 0}a(yi,"listenerCount");R.prototype.eventNames=a(function(){
return this._eventsCount>0?yt(this._events):[]},"eventNames");function mi(r,e){for(var t=new Array(e),
n=0;n<e;++n)t[n]=r[n];return t}a(mi,"arrayClone");function la(r,e){for(;e+1<r.length;e++)r[e]=r[e+1];
r.pop()}a(la,"spliceOne");function fa(r){for(var e=new Array(r.length),t=0;t<e.length;++t)e[t]=r[t].
listener||r[t];return e}a(fa,"unwrapListeners");function ha(r,e){return new Promise(function(t,n){function i(o){
...
pa(r,i,{once:!0})})}a(ha,"once");function pa(r,e,t){typeof r.on=="function"&&gi(r,"error",e,t)}a(pa,
...
ust be of type EventEmitter. Received type '+typeof r)}a(gi,"eventTargetAgnosticAddListener")});var vi={};te(vi,{Socket:()=>se,isIP:()=>da});function da(r){return 0}var bi,wi,S,se,ke=$(()=>{"use s\
trict";p();bi=be(xe(),1);a(da,"isIP");wi=/^[^.]+\./,S=class S extends bi.EventEmitter{constructor(){
...
poolQueryViaFetch:!1,fetchEndpoint:a((t,n,i)=>{let s;return i?.jwtAuth?s=t.replace(wi,"apiauth."):s=
t.replace(wi,"api."),"https://"+s+"/sql"},"fetchEndpoint"),fetchConnectionCache:!0,fetchFunction:void 0,
...
disableWarningInBrowsers:!1}),E(S,"opts",{});se=S});var xi={};te(xi,{parse:()=>Jt});function Jt(r,e=!1){let{protocol:t}=new URL(r),n="http:"+r.substring(
...
pathname:l,search:f,query:C,hash:w}}var Xt=$(()=>{"use strict";p();a(Jt,"parse")});var nr=T(Ii=>{"use strict";p();Ii.parse=function(r,e){return new rr(r,e).parse()};var xt=class xt{constructor(e,t){
this.source=e,this.transform=t||Ia,this.position=0,this.entries=[],this.recorded=[],this.dimension=0}isEof(){
...
dimension>1&&(n=new xt(this.source.substr(this.position-1),this.transform),this.entries.push(n.parse(
...
not balanced");return this.entries}};a(xt,"ArrayParser");var rr=xt;function Ia(r){return r}a(Ia,"ide\
ntity")});var ir=T((nf,Ti)=>{p();var Ta=nr();Ti.exports={create:a(function(r,e){return{parse:a(function(){return Ta.
parse(r,e)},"parse")}},"create")}});var Bi=T((af,Ri)=>{"use strict";p();var Pa=/(\d{1,})-(\d{2})-(\d{2}) (\d{2}):(\d{2}):(\d{2})(\.\d{1,})?.*?( BC)?$/,
Ra=/^(\d{1,})-(\d{2})-(\d{2})( BC)?$/,Ba=/([Z+-])(\d{2})?:?(\d{2})?:?(\d{2})?/,La=/^-?infinity$/;Ri.
exports=a(function(e){if(La.test(e))return Number(e.replace("i","I"));var t=Pa.exec(e);if(!t)return Fa(
e)||null;var n=!!t[8],i=parseInt(t[1],10);n&&(i=Pi(i));var s=parseInt(t[2],10)-1,o=t[3],u=parseInt(t[4],
10),c=parseInt(t[5],10),l=parseInt(t[6],10),f=t[7];f=f?1e3*parseFloat(f):0;var y,w=ka(e);return w!=null?
(y=new Date(Date.UTC(i,s,o,u,c,l,f)),sr(i)&&y.setUTCFullYear(i),w!==0&&y.setTime(y.getTime()-w)):(y=
new Date(i,s,o,u,c,l,f),sr(i)&&y.setFullYear(i)),y},"parseDate");function Fa(r){var e=Ra.exec(r);if(e){
var t=parseInt(e[1],10),n=!!e[4];n&&(t=Pi(t));var i=parseInt(e[2],10)-1,s=e[3],o=new Date(t,i,s);return sr(
t)&&o.setFullYear(t),o}}a(Fa,"getDate");function ka(r){if(r.endsWith("+00"))return 0;var e=Ba.exec(r.
...
1)}a(Pi,"bcYearToNegativeYear");function sr(r){return r>=0&&r<100}a(sr,"is0To99")});var Fi=T((lf,Li)=>{p();Li.exports=Ua;var Ma=Object.prototype.hasOwnProperty;function Ua(r){for(var e=1;e<
arguments.length;e++){var t=arguments[e];for(var n in t)Ma.call(t,n)&&(r[n]=t[n])}return r}a(Ua,"ext\
end")});var Ui=T((pf,Mi)=>{"use strict";p();var Da=Fi();Mi.exports=De;function De(r){if(!(this instanceof De))
return new De(r);Da(this,za(r))}a(De,"PostgresInterval");var Oa=["seconds","minutes","hours","days",
"months","years"];De.prototype.toPostgres=function(){var r=Oa.filter(this.hasOwnProperty,this);return this.
...
S"},Qa=["years","months","days"],Na=["hours","minutes","seconds"];De.prototype.toISOString=De.prototype.
toISO=function(){var r=Qa.map(t,this).join(""),e=Na.map(t,this).join("");return"P"+r+"T"+e;function t(n){
var i=this[n]||0;return n==="seconds"&&this.milliseconds&&(i=(i+this.milliseconds/1e3).toFixed(6).replace(
/0+$/,"")),i+qa[n]}};var or="([+-]?\\d+)",Wa=or+"\\s+years?",ja=or+"\\s+mons?",Ha=or+"\\s+days?",Ga="\
([+-])?([\\d]*):(\\d\\d):(\\d\\d)\\.?(\\d{1,6})?",$a=new RegExp([Wa,ja,Ha,Ga].map(function(r){return"\
("+r+")?"}).join("\\s*")),ki={years:2,months:4,days:6,hours:9,minutes:10,seconds:11,milliseconds:12},
Va=["hours","minutes","seconds","milliseconds"];function Ka(r){var e=r+"000000".slice(r.length);return parseInt(
e,10)/1e3}a(Ka,"parseMilliseconds");function za(r){if(!r)return{};var e=$a.exec(r),t=e[8]==="-";return Object.
keys(ki).reduce(function(n,i){var s=ki[i],o=e[s];return!o||(o=i==="milliseconds"?Ka(o):parseInt(o,10),
!o)||(t&&~Va.indexOf(i)&&(o*=-1),n[i]=o),n},{})}a(za,"parse")});var Oi=T((mf,Di)=>{"use strict";p();Di.exports=a(function(e){if(/^\\x/.test(e))return new d(e.substr(
...
parseBytea")});var Gi=T((bf,Hi)=>{p();var Ze=nr(),Je=ir(),St=Bi(),Qi=Ui(),Ni=Oi();function Et(r){return a(function(t){
return t===null?t:r(t)},"nullAllowed")}a(Et,"allowNull");function Wi(r){return r===null?r:r==="TRUE"||
r==="t"||r==="true"||r==="y"||r==="yes"||r==="on"||r==="1"}a(Wi,"parseBool");function Ya(r){return r?
Ze.parse(r,Wi):null}a(Ya,"parseBoolArray");function Za(r){return parseInt(r,10)}a(Za,"parseBaseTenIn\
t");function ar(r){return r?Ze.parse(r,Et(Za)):null}a(ar,"parseIntegerArray");function Ja(r){return r?
Ze.parse(r,Et(function(e){return ji(e).trim()})):null}a(Ja,"parseBigIntegerArray");var Xa=a(function(r){
if(!r)return null;var e=Je.create(r,function(t){return t!==null&&(t=fr(t)),t});return e.parse()},"pa\
rsePointArray"),ur=a(function(r){if(!r)return null;var e=Je.create(r,function(t){return t!==null&&(t=
parseFloat(t)),t});return e.parse()},"parseFloatArray"),ne=a(function(r){if(!r)return null;var e=Je.
create(r);return e.parse()},"parseStringArray"),cr=a(function(r){if(!r)return null;var e=Je.create(r,
function(t){return t!==null&&(t=St(t)),t});return e.parse()},"parseDateArray"),eu=a(function(r){if(!r)
return null;var e=Je.create(r,function(t){return t!==null&&(t=Qi(t)),t});return e.parse()},"parseInt\
ervalArray"),tu=a(function(r){return r?Ze.parse(r,Et(Ni)):null},"parseByteAArray"),lr=a(function(r){
return parseInt(r,10)},"parseInteger"),ji=a(function(r){var e=String(r);return/^\d+$/.test(e)?e:r},"\
parseBigInteger"),qi=a(function(r){return r?Ze.parse(r,Et(JSON.parse)):null},"parseJsonArray"),fr=a(
function(r){return r[0]!=="("?null:(r=r.substring(1,r.length-1).split(","),{x:parseFloat(r[0]),y:parseFloat(
r[1])})},"parsePoint"),ru=a(function(r){if(r[0]!=="<"&&r[1]!=="(")return null;for(var e="(",t="",n=!1,
i=2;i<r.length-1;i++){if(n||(e+=r[i]),r[i]===")"){n=!0;continue}else if(!n)continue;r[i]!==","&&(t+=
r[i])}var s=fr(e);return s.radius=parseFloat(t),s},"parseCircle"),nu=a(function(r){r(20,ji),r(21,lr),
r(23,lr),r(26,lr),r(700,parseFloat),r(701,parseFloat),r(16,Wi),r(1082,St),r(1114,St),r(1184,St),r(600,
fr),r(651,ne),r(718,ru),r(1e3,Ya),r(1001,tu),r(1005,ar),r(1007,ar),r(1028,ar),r(1016,Ja),r(1017,Xa),
r(1021,ur),r(1022,ur),r(1231,ur),r(1014,ne),r(1015,ne),r(1008,ne),r(1009,ne),r(1040,ne),r(1041,ne),r(
1115,cr),r(1182,cr),r(1185,cr),r(1186,Qi),r(1187,eu),r(17,Ni),r(114,JSON.parse.bind(JSON)),r(3802,JSON.
parse.bind(JSON)),r(199,qi),r(3807,qi),r(3907,ne),r(2951,ne),r(791,ne),r(1183,ne),r(1270,ne)},"init");
Hi.exports={init:nu}});var Vi=T((Sf,$i)=>{"use strict";p();var K=1e6;function iu(r){var e=r.readInt32BE(0),t=r.readUInt32BE(
4),n="";e<0&&(e=~e+(t===0),t=~t+1>>>0,n="-");var i="",s,o,u,c,l,f;{if(s=e%K,e=e/K>>>0,o=4294967296*s+
t,t=o/K>>>0,u=""+(o-K*t),t===0&&e===0)return n+u+i;for(c="",l=6-u.length,f=0;f<l;f++)c+="0";i=c+u+i}
{if(s=e%K,e=e/K>>>0,o=4294967296*s+t,t=o/K>>>0,u=""+(o-K*t),t===0&&e===0)return n+u+i;for(c="",l=6-u.
length,f=0;f<l;f++)c+="0";i=c+u+i}{if(s=e%K,e=e/K>>>0,o=4294967296*s+t,t=o/K>>>0,u=""+(o-K*t),t===0&&
e===0)return n+u+i;for(c="",l=6-u.length,f=0;f<l;f++)c+="0";i=c+u+i}return s=e%K,o=4294967296*s+t,u=
""+o%K,n+u+i}a(iu,"readInt8");$i.exports=iu});var Ji=T((Cf,Zi)=>{p();var su=Vi(),L=a(function(r,e,t,n,i){t=t||0,n=n||!1,i=i||function(A,C,D){return A*
...
pow(2,t-1)-1,i=L(r,1),s=L(r,t,1);if(s===0)return 0;var o=1,u=a(function(l,f,y){l===0&&(l=1);for(var w=1;w<=
y;w++)o/=2,(f&1<<y-w)>0&&(l+=o);return l},"parsePrecisionBits"),c=L(r,e,t+1,!1,u);return s==Math.pow(
2,t+1)-1?c===0?i===0?1/0:-1/0:NaN:(i===0?1:-1)*Math.pow(2,s-n)*c},"parseFloatFromBits"),ou=a(function(r){
return L(r,1)==1?-1*(L(r,15,1,!0)+1):L(r,15,1)},"parseInt16"),Ki=a(function(r){return L(r,1)==1?-1*(L(
r,31,1,!0)+1):L(r,31,1)},"parseInt32"),au=a(function(r){return Yi(r,23,8)},"parseFloat32"),uu=a(function(r){
return Yi(r,52,11)},"parseFloat64"),cu=a(function(r){var e=L(r,16,32);if(e==49152)return NaN;for(var t=Math.
pow(1e4,L(r,16,16)),n=0,i=[],s=L(r,16),o=0;o<s;o++)n+=L(r,16,64+16*o)*t,t/=1e4;var u=Math.pow(10,L(r,
16,48));return(e===0?1:-1)*Math.round(n*u)/u},"parseNumeric"),zi=a(function(r,e){var t=L(e,1),n=L(e,
...
usec=s},i.getUTCMicroSeconds=function(){return this.usec},i},"parseDate"),Xe=a(function(r){for(var e=L(
...
t implemented: "+l)},"parseElement"),c=a(function(l,f){var y=[],w;if(l.length>1){var A=l.shift();for(w=
0;w<A;w++)y[w]=c(l,f);l.unshift(A)}else for(w=0;w<l[0];w++)y[w]=u(f);return y},"parse");return c(s,n)},
"parseArray"),lu=a(function(r){return r.toString("utf8")},"parseText"),fu=a(function(r){return r===null?
null:L(r,8)>0},"parseBool"),hu=a(function(r){r(20,su),r(21,ou),r(23,Ki),r(26,Ki),r(1700,cu),r(700,au),
r(701,uu),r(16,fu),r(1114,zi.bind(null,!1)),r(1184,zi.bind(null,!0)),r(1e3,Xe),r(1007,Xe),r(1016,Xe),
r(1008,Xe),r(1009,Xe),r(25,lu)},"init");Zi.exports={init:hu}});var es=T((Tf,Xi)=>{p();Xi.exports={BOOL:16,BYTEA:17,CHAR:18,INT8:20,INT2:21,INT4:23,REGPROC:24,TEXT:25,
...
REGROLE:4096}});var rt=T(tt=>{p();var pu=Gi(),du=Ji(),yu=ir(),mu=es();tt.getTypeParser=gu;tt.setTypeParser=wu;tt.arrayParser=
yu;tt.builtins=mu;var et={text:{},binary:{}};function ts(r){return String(r)}a(ts,"noParse");function gu(r,e){
return e=e||"text",et[e]&&et[e][r]||ts}a(gu,"getTypeParser");function wu(r,e,t){typeof e=="function"&&
(t=e,e="text"),et[e][r]=t}a(wu,"setTypeParser");pu.init(function(r,e){et.text[r]=e});du.init(function(r,e){
et.binary[r]=e})});var Ct=T((Ff,rs)=>{"use strict";p();var bu=rt();function At(r){this._types=r||bu,this.text={},this.binary=
...
e||"text",this.getOverrides(e)[r]||this._types.getTypeParser(r,e)};rs.exports=At});function nt(r){let e=1779033703,t=3144134277,n=1013904242,i=2773480762,s=1359893119,o=2600822924,u=528734635,
...
2024104815,2227730452,2361852424,2428436474,2756734187,3204031479,3329325298],w=a((I,g)=>I>>>g|I<<32-
g,"rrot"),A=new Uint32Array(64),C=new Uint8Array(64),D=a(()=>{for(let B=0,j=0;B<16;B++,j+=4)A[B]=C[j]<<
24|C[j+1]<<16|C[j+2]<<8|C[j+3];for(let B=16;B<64;B++){let j=w(A[B-15],7)^w(A[B-15],18)^A[B-15]>>>3,fe=w(
A[B-2],17)^w(A[B-2],19)^A[B-2]>>>10;A[B]=A[B-16]+j+A[B-7]+fe|0}let I=e,g=t,Z=n,W=i,J=s,X=o,oe=u,ae=c;
for(let B=0;B<64;B++){let j=w(J,6)^w(J,11)^w(J,25),fe=J&X^~J&oe,me=ae+j+fe+y[B]+A[B]|0,$e=w(I,2)^w(I,
13)^w(I,22),he=I&g^I&Z^g&Z,Ie=$e+he|0;ae=oe,oe=X,X=J,J=W+me|0,W=Z,Z=g,g=I,I=me+Ie|0}e=e+I|0,t=t+g|0,
n=n+Z|0,i=i+W|0,s=s+J|0,o=o+X|0,u=u+oe|0,c=c+ae|0,f=0},"process"),Y=a(I=>{typeof I=="string"&&(I=new TextEncoder().
encode(I));for(let g=0;g<I.length;g++)C[f++]=I[g],f===64&&D();l+=I.length},"add"),P=a(()=>{if(C[f++]=
128,f==64&&D(),f+8>64){for(;f<64;)C[f++]=0;D()}for(;f<58;)C[f++]=0;let I=l*8;C[f++]=I/1099511627776&
255,C[f++]=I/4294967296&255,C[f++]=I>>>24,C[f++]=I>>>16&255,C[f++]=I>>>8&255,C[f++]=I&255,D();let g=new Uint8Array(
...
c>>>24,g[29]=c>>>16&255,g[30]=c>>>8&255,g[31]=c&255,g},"digest");return r===void 0?{add:Y,digest:P}:
(Y(r),P())}var ns=$(()=>{"use strict";p();a(nt,"sha256")});var U,it,is=$(()=>{"use strict";p();U=class U{constructor(){E(this,"_dataLength",0);E(this,"_bufferL\
...
abcdef"),E(U,"hexOut",[]),E(U,"onePassHasher",new U);it=U});var hr={};te(hr,{createHash:()=>xu,createHmac:()=>Su,randomBytes:()=>vu});function vu(r){return crypto.
getRandomValues(d.alloc(r))}function xu(r){if(r==="sha256")return{update:a(function(e){return{digest:a(
...
"digest")}},"update")}}var pr=$(()=>{"use strict";p();ns();is();a(vu,"randomBytes");a(xu,"createHash");
a(Su,"createHmac")});var st=T(($f,dr)=>{"use strict";p();dr.exports={host:"localhost",user:m.platform==="win32"?m.env.USERNAME:
...
keepalives:1,keepalives_idle:0};var Oe=rt(),Eu=Oe.getTypeParser(20,"text"),Au=Oe.getTypeParser(1016,
"text");dr.exports.__defineSetter__("parseInt8",function(r){Oe.setTypeParser(20,"text",r?Oe.getTypeParser(
23,"text"):Eu),Oe.setTypeParser(1016,"text",r?Oe.getTypeParser(1007,"text"):Au)})});var ot=T((Kf,os)=>{"use strict";p();var Cu=(pr(),O(hr)),_u=st();function Iu(r){var e=r.replace(/\\/g,
"\\\\").replace(/"/g,'\\"');return'"'+e+'"'}a(Iu,"escapeElement");function ss(r){for(var e="{",t=0;t<
r.length;t++)t>0&&(e=e+","),r[t]===null||typeof r[t]>"u"?e=e+"NULL":Array.isArray(r[t])?e=e+ss(r[t]):
r[t]instanceof d?e+="\\\\x"+r[t].toString("hex"):e+=Iu(_t(r[t]));return e=e+"}",e}a(ss,"arrayString");
...
r.byteLength)}return r instanceof Date?_u.parseInputDatesAsUTC?Ru(r):Pu(r):Array.isArray(r)?ss(r):typeof r==
"object"?Tu(r,e):r.toString()},"prepareValue");function Tu(r,e){if(r&&typeof r.toPostgres=="function"){
if(e=e||[],e.indexOf(r)!==-1)throw new Error('circular reference detected while preparing "'+r+'" fo\
r query');return e.push(r),_t(r.toPostgres(_t),e)}return JSON.stringify(r)}a(Tu,"prepareObject");function N(r,e){
for(r=""+r;r.length<e;)r="0"+r;return r}a(N,"pad");function Pu(r){var e=-r.getTimezoneOffset(),t=r.getFullYear(),
...
-1):i+="+",i+=N(Math.floor(e/60),2)+":"+N(e%60,2),n&&(i+=" BC"),i}a(Pu,"dateToString");function Ru(r){
...
r.getUTCMilliseconds(),3);return n+="+00:00",t&&(n+=" BC"),n}a(Ru,"dateToStringUTC");function Bu(r,e,t){
return r=typeof r=="string"?{text:r}:r,e&&(typeof e=="function"?r.callback=e:r.values=e),t&&(r.callback=
t),r}a(Bu,"normalizeQueryConfig");var yr=a(function(r){return Cu.createHash("md5").update(r,"utf-8").
digest("hex")},"md5"),Lu=a(function(r,e,t){var n=yr(e+r),i=yr(d.concat([d.from(n),t]));return"md5"+i},
"postgresMd5PasswordHash");os.exports={prepareValue:a(function(e){return _t(e)},"prepareValueWrapper"),
normalizeQueryConfig:Bu,postgresMd5PasswordHash:Lu,md5:yr}});var at={};te(at,{default:()=>Uu});var Uu,ut=$(()=>{"use strict";p();Uu={}});var ms=T((uh,ys)=>{"use strict";p();var wr=(pr(),O(hr));function Du(r){if(r.indexOf("SCRAM-SHA-256")===
...
SASLInitialResponse"}}a(Du,"startSession");function Ou(r,e,t){if(r.message!=="SASLInitialResponse")throw new Error(
...
L: SCRAM-SERVER-FIRST-MESSAGE: serverData must be a string");let n=Nu(t);if(n.nonce.startsWith(r.clientNonce)){
...
art with client nonce");var i=d.from(n.salt,"base64"),s=Hu(e,i,n.iteration),o=qe(s,"Client Key"),u=ju(
o),c="n=*,r="+r.clientNonce,l="r="+n.nonce+",s="+n.salt+",i="+n.iteration,f="c=biws,r="+n.nonce,y=c+
","+l+","+f,w=qe(u,y),A=ds(o,w),C=A.toString("base64"),D=qe(s,"Server Key"),Y=qe(D,y);r.message="SAS\
LResponse",r.serverSignature=Y.toString("base64"),r.response=f+",p="+C}a(Ou,"continueSession");function qu(r,e){
if(r.message!=="SASLResponse")throw new Error("SASL: Last message was not SASLResponse");if(typeof e!=
"string")throw new Error("SASL: SCRAM-SERVER-FINAL-MESSAGE: serverData must be a string");let{serverSignature:t}=Wu(
e);if(t!==r.serverSignature)throw new Error("SASL: SCRAM-SERVER-FINAL-MESSAGE: server signature does\
 not match")}a(qu,"finalizeSession");function Qu(r){if(typeof r!="string")throw new TypeError("SASL:\
 text must be a string");return r.split("").map((e,t)=>r.charCodeAt(t)).every(e=>e>=33&&e<=43||e>=45&&
e<=126)}a(Qu,"isPrintableChars");function hs(r){return/^(?:[a-zA-Z0-9+/]{4})*(?:[a-zA-Z0-9+/]{2}==|[a-zA-Z0-9+/]{3}=)?$/.
...
Pairs");function Nu(r){let e=ps(r),t=e.get("r");if(t){if(!Qu(t))throw new Error("SASL: SCRAM-SERVER-\
...
tion missing");let s=parseInt(i,10);return{nonce:t,salt:n,iteration:s}}a(Nu,"parseServerFirstMessage");
function Wu(r){let t=ps(r).get("v");if(t){if(!hs(t))throw new Error("SASL: SCRAM-SERVER-FINAL-MESSAG\
E: server signature must be base64")}else throw new Error("SASL: SCRAM-SERVER-FINAL-MESSAGE: server \
signature is missing");return{serverSignature:t}}a(Wu,"parseServerFinalMessage");function ds(r,e){if(!d.
...
a(ds,"xorBuffers");function ju(r){return wr.createHash("sha256").update(r).digest()}a(ju,"sha256");function qe(r,e){
return wr.createHmac("sha256",r).update(e).digest()}a(qe,"hmacSha256");function Hu(r,e,t){for(var n=qe(
r,d.concat([e,d.from([0,0,0,1])])),i=n,s=0;s<t-1;s++)n=qe(r,n),i=ds(i,n);return i}a(Hu,"Hi");ys.exports=
{startSession:Du,continueSession:Ou,finalizeSession:qu}});var br={};te(br,{join:()=>Gu});function Gu(...r){return r.join("/")}var vr=$(()=>{"use strict";p();a(
Gu,"join")});var xr={};te(xr,{stat:()=>$u});function $u(r,e){e(new Error("No filesystem"))}var Sr=$(()=>{"use str\
ict";p();a($u,"stat")});var Er={};te(Er,{default:()=>Vu});var Vu,Ar=$(()=>{"use strict";p();Vu={}});var gs={};te(gs,{StringDecoder:()=>Cr});var _r,Cr,ws=$(()=>{"use strict";p();_r=class _r{constructor(e){
E(this,"td");this.td=new TextDecoder(e)}write(e){return this.td.decode(e,{stream:!0})}end(e){return this.
td.decode(e)}};a(_r,"StringDecoder");Cr=_r});var Ss=T((wh,xs)=>{"use strict";p();var{Transform:Ku}=(Ar(),O(Er)),{StringDecoder:zu}=(ws(),O(gs)),Ee=Symbol(
"last"),Tt=Symbol("decoder");function Yu(r,e,t){let n;if(this.overflow){if(n=this[Tt].write(r).split(
this.matcher),n.length===1)return t();n.shift(),this.overflow=!1}else this[Ee]+=this[Tt].write(r),n=
this[Ee].split(this.matcher);this[Ee]=n.pop();for(let i=0;i<n.length;i++)try{vs(this,this.mapper(n[i]))}catch(s){
return t(s)}if(this.overflow=this[Ee].length>this.maxLength,this.overflow&&!this.skipOverflow){t(new Error(
"maximum buffer reached"));return}t()}a(Yu,"transform");function Zu(r){if(this[Ee]+=this[Tt].end(),this[Ee])
try{vs(this,this.mapper(this[Ee]))}catch(e){return r(e)}r()}a(Zu,"flush");function vs(r,e){e!==void 0&&
r.push(e)}a(vs,"push");function bs(r){return r}a(bs,"noop");function Ju(r,e,t){switch(r=r||/\r?\n/,e=
...
"object"&&(t=e,e=bs)}t=Object.assign({},t),t.autoDestroy=!0,t.transform=Yu,t.flush=Zu,t.readableObjectMode=
!0;let n=new Ku(t);return n[Ee]="",n[Tt]=new zu("utf8"),n.matcher=r,n.mapper=e,n.maxLength=t.maxLength,
n.skipOverflow=t.skipOverflow||!1,n.overflow=!1,n._destroy=function(i,s){this._writableState.errorEmitted=
!1,s(i)},n}a(Ju,"split");xs.exports=Ju});var Cs=T((xh,ye)=>{"use strict";p();var Es=(vr(),O(br)),Xu=(Ar(),O(Er)).Stream,ec=Ss(),As=(ut(),O(at)),
tc=5432,Pt=m.platform==="win32",ct=m.stderr,rc=56,nc=7,ic=61440,sc=32768;function oc(r){return(r&ic)==
sc}a(oc,"isRegFile");var Qe=["host","port","database","user","password"],Ir=Qe.length,ac=Qe[Ir-1];function Tr(){
var r=ct instanceof Xu&&ct.writable===!0;if(r){var e=Array.prototype.slice.call(arguments).concat(`
`);ct.write(As.format.apply(As,e))}}a(Tr,"warn");Object.defineProperty(ye.exports,"isWin",{get:a(function(){
return Pt},"get"),set:a(function(r){Pt=r},"set")});ye.exports.warnTo=function(r){var e=ct;return ct=
r,e};ye.exports.getFileName=function(r){var e=r||m.env,t=e.PGPASSFILE||(Pt?Es.join(e.APPDATA||"./","\
postgresql","pgpass.conf"):Es.join(e.HOME||"./",".pgpass"));return t};ye.exports.usePgPass=function(r,e){
return Object.prototype.hasOwnProperty.call(m.env,"PGPASSWORD")?!1:Pt?!0:(e=e||"<unkn>",oc(r.mode)?r.
mode&(rc|nc)?(Tr('WARNING: password file "%s" has group or world access; permissions should be u=rw \
(0600) or less',e),!1):!0:(Tr('WARNING: password file "%s" is not a plain file',e),!1))};var uc=ye.exports.
match=function(r,e){return Qe.slice(0,-1).reduce(function(t,n,i){return i==1&&Number(r[n]||tc)===Number(
e[n])?t&&!0:t&&(e[n]==="*"||e[n]===r[n])},!0)};ye.exports.getPassword=function(r,e,t){var n,i=e.pipe(
ec());function s(c){var l=cc(c);l&&lc(l)&&uc(r,l)&&(n=l[ac],i.end())}a(s,"onLine");var o=a(function(){
e.destroy(),t(n)},"onEnd"),u=a(function(c){e.destroy(),Tr("WARNING: error on reading file: %s",c),t(
void 0)},"onErr");e.on("error",u),i.on("data",s).on("end",o).on("error",u)};var cc=ye.exports.parseLine=
function(r){if(r.length<11||r.match(/^\s+#/))return null;for(var e="",t="",n=0,i=0,s=0,o={},u=!1,c=a(
function(f,y,w){var A=r.substring(y,w);Object.hasOwnProperty.call(m.env,"PGPASS_NO_DEESCAPE")||(A=A.
...
length===Ir?o:null,o},lc=ye.exports.isValidEntry=function(r){for(var e={0:function(o){return o.length>
...
0}},t=0;t<Qe.length;t+=1){var n=e[t],i=r[Qe[t]]||"",s=n(i);if(!s)return!1}return!0}});var Is=T((Ch,Pr)=>{"use strict";p();var Ah=(vr(),O(br)),_s=(Sr(),O(xr)),Rt=Cs();Pr.exports=function(r,e){
var t=Rt.getFileName();_s.stat(t,function(n,i){if(n||!Rt.usePgPass(i,t))return e(void 0);var s=_s.createReadStream(
t);Rt.getPassword(r,s,e)})};Pr.exports.warnTo=Rt.warnTo});var Ts={};te(Ts,{default:()=>fc});var fc,Ps=$(()=>{"use strict";p();fc={}});var Lr=T((Th,Rs)=>{"use strict";p();var hc=(Xt(),O(xi)),Rr=(Sr(),O(xr));function Br(r){if(r.charAt(0)===
"/"){var t=r.split(" ");return{host:t[0],database:t[1]}}var e=hc.parse(/ |%[^a-f0-9]|%[a-f0-9][^a-f0-9]/i.
...
!1;break}}return t}a(Br,"parse");Rs.exports=Br;Br.parse=Br});var Bt=T((Bh,Fs)=>{"use strict";p();var pc=(Ps(),O(Ts)),Ls=st(),Bs=Lr().parse,H=a(function(r,e,t){return t===
void 0?t=m.env["PG"+r.toUpperCase()]:t===!1||(t=m.env[t]),e[r]||t||Ls[r]},"val"),dc=a(function(){switch(m.
env.PGSSLMODE){case"disable":return!1;case"prefer":case"require":case"verify-ca":case"verify-full":return!0;case"\
no-verify":return{rejectUnauthorized:!1}}return Ls.ssl},"readSSLConfigFromEnvironment"),Ne=a(function(r){
return"'"+(""+r).replace(/\\/g,"\\\\").replace(/'/g,"\\'")+"'"},"quoteParamValue"),ie=a(function(r,e,t){
var n=e[t];n!=null&&r.push(t+"="+Ne(n))},"add"),kr=class kr{constructor(e){e=typeof e=="string"?Bs(e):
...
pc.lookup(this.host,function(i,s){return i?e(i,null):(t.push("hostaddr="+Ne(s)),e(null,t.join(" ")))})}};
a(kr,"ConnectionParameters");var Fr=kr;Fs.exports=Fr});var Us=T((kh,Ms)=>{"use strict";p();var yc=rt(),ks=/^([A-Za-z]+)(?: (\d+))?(?: (\d+))?/,Ur=class Ur{constructor(e,t){
...
var t;e.text?t=ks.exec(e.text):t=ks.exec(e.command),t&&(this.command=t[1],t[3]?(this.oid=parseInt(t[2],
...
_types.getTypeParser(n.dataTypeID,n.format||"text"):this._parsers[t]=yc.getTypeParser(n.dataTypeID,n.
format||"text")}}};a(Ur,"Result");var Mr=Ur;Ms.exports=Mr});var Qs=T((Dh,qs)=>{"use strict";p();var{EventEmitter:mc}=xe(),Ds=Us(),Os=ot(),Or=class Or extends mc{constructor(e,t,n){
...
e.sendCopyFail("No source stream defined")}handleCopyData(e,t){}};a(Or,"Query");var Dr=Or;qs.exports=
Dr});var dn=T(_=>{"use strict";p();Object.defineProperty(_,"__esModule",{value:!0});_.NoticeMessage=_.DataRowMessage=
...
name=n}};a(Xr,"DatabaseError");var qr=Xr;_.DatabaseError=qr;var en=class en{constructor(e,t){this.length=
...
_.CopyResponse=Nr;var rn=class rn{constructor(e,t,n,i,s,o,u){this.name=e,this.tableID=t,this.columnID=
...
t,this.parameterValue=n,this.name="parameterStatus"}};a(on,"ParameterStatusMessage");var Gr=on;_.ParameterStatusMessage=
Gr;var an=class an{constructor(e,t){this.length=e,this.salt=t,this.name="authenticationMD5Password"}};
a(an,"AuthenticationMD5Password");var $r=an;_.AuthenticationMD5Password=$r;var un=class un{constructor(e,t,n){
...
ge");var Kr=cn;_.NotificationResponseMessage=Kr;var ln=class ln{constructor(e,t){this.length=e,this.
status=t,this.name="readyForQuery"}};a(ln,"ReadyForQueryMessage");var zr=ln;_.ReadyForQueryMessage=zr;
...
e,this.fields=t,this.name="dataRow",this.fieldCount=t.length}};a(hn,"DataRowMessage");var Zr=hn;_.DataRowMessage=
Zr;var pn=class pn{constructor(e,t){this.length=e,this.message=t,this.name="notice"}};a(pn,"NoticeMe\
ssage");var Jr=pn;_.NoticeMessage=Jr});var Ns=T(Lt=>{"use strict";p();Object.defineProperty(Lt,"__esModule",{value:!0});Lt.Writer=void 0;var mn=class mn{constructor(e=256){
...
headerPosition=0,this.buffer=d.allocUnsafe(this.size),t}};a(mn,"Writer");var yn=mn;Lt.Writer=yn});var js=T(kt=>{"use strict";p();Object.defineProperty(kt,"__esModule",{value:!0});kt.serialize=void 0;
var gn=Ns(),F=new gn.Writer,gc=a(r=>{F.addInt16(3).addInt16(0);for(let n of Object.keys(r))F.addCString(
n).addCString(r[n]);F.addCString("client_encoding").addCString("UTF8");let e=F.addCString("").flush(),
t=e.length+4;return new gn.Writer().addInt32(t).add(e).flush()},"startup"),wc=a(()=>{let r=d.allocUnsafe(
8);return r.writeInt32BE(8,0),r.writeInt32BE(80877103,4),r},"requestSsl"),bc=a(r=>F.addCString(r).flush(
112),"password"),vc=a(function(r,e){return F.addCString(r).addInt32(d.byteLength(e)).addString(e),F.
flush(112)},"sendSASLInitialResponseMessage"),xc=a(function(r){return F.addString(r).flush(112)},"se\
ndSCRAMClientFinalMessage"),Sc=a(r=>F.addCString(r).flush(81),"query"),Ws=[],Ec=a(r=>{let e=r.name||
...
xecuting queries"));let t=r.types||Ws,n=t.length,i=F.addCString(e).addCString(r.text).addInt16(n);for(let s=0;s<
n;s++)i.addInt32(t[s]);return F.flush(80)},"parse"),We=new gn.Writer,Ac=a(function(r,e){for(let t=0;t<
...
writeValues"),Cc=a((r={})=>{let e=r.portal||"",t=r.statement||"",n=r.binary||!1,i=r.values||Ws,s=i.length;
return F.addCString(e).addCString(t),F.addInt16(s),Ac(i,r.valueMapper),F.addInt16(s),F.add(We.flush()),
F.addInt16(n?1:0),F.flush(66)},"bind"),_c=d.from([69,0,0,0,9,0,0,0,0,0]),Ic=a(r=>{if(!r||!r.portal&&
!r.rows)return _c;let e=r.portal||"",t=r.rows||0,n=d.byteLength(e),i=4+n+1+4,s=d.allocUnsafe(1+i);return s[0]=
69,s.writeInt32BE(i,1),s.write(e,5,"utf-8"),s[n+5]=0,s.writeUInt32BE(t,s.length-4),s},"execute"),Tc=a(
...
Pc=F.addCString("P").flush(68),Rc=F.addCString("S").flush(68),Bc=a(r=>r.name?wn(68,`${r.type}${r.name||
""}`):r.type==="P"?Pc:Rc,"describe"),Lc=a(r=>{let e=`${r.type}${r.name||""}`;return wn(67,e)},"close"),
Fc=a(r=>F.add(r).flush(100),"copyData"),kc=a(r=>wn(102,r),"copyFail"),Ft=a(r=>d.from([r,0,0,0,4]),"c\
odeOnlyBuffer"),Mc=Ft(72),Uc=Ft(83),Dc=Ft(88),Oc=Ft(99),qc={startup:gc,password:bc,requestSsl:wc,sendSASLInitialResponseMessage:vc,
sendSCRAMClientFinalMessage:xc,query:Sc,parse:Ec,bind:Cc,execute:Ic,describe:Bc,close:Lc,flush:a(()=>Mc,
"flush"),sync:a(()=>Uc,"sync"),end:a(()=>Dc,"end"),copyData:Fc,copyDone:a(()=>Oc,"copyDone"),copyFail:kc,
cancel:Tc};kt.serialize=qc});var Hs=T(Mt=>{"use strict";p();Object.defineProperty(Mt,"__esModule",{value:!0});Mt.BufferReader=void 0;
var Qc=d.allocUnsafe(0),vn=class vn{constructor(e=0){this.offset=e,this.buffer=Qc,this.encoding="utf\
...
offset+=e,t}};a(vn,"BufferReader");var bn=vn;Mt.BufferReader=bn});var Vs=T(Ut=>{"use strict";p();Object.defineProperty(Ut,"__esModule",{value:!0});Ut.Parser=void 0;var k=dn(),
Nc=Hs(),xn=1,Wc=4,Gs=xn+Wc,$s=d.allocUnsafe(0),En=class En{constructor(e){if(this.buffer=$s,this.bufferLength=
0,this.bufferOffset=0,this.reader=new Nc.BufferReader,e?.mode==="binary")throw new Error("Binary mod\
e not supported yet");this.mode=e?.mode||"text"}parse(e,t){this.mergeBuffer(e);let n=this.bufferOffset+
this.bufferLength,i=this.bufferOffset;for(;i+Gs<=n;){let s=this.buffer[i],o=this.buffer.readUInt32BE(
i+xn),u=xn+o;if(u+i<=n){let c=this.handlePacket(i+Gs,s,o,this.buffer);t(c),i+=u}else break}i===n?(this.
...
a(En,"Parser");var Sn=En;Ut.Parser=Sn});var An=T(Ae=>{"use strict";p();Object.defineProperty(Ae,"__esModule",{value:!0});Ae.DatabaseError=Ae.
serialize=Ae.parse=void 0;var jc=dn();Object.defineProperty(Ae,"DatabaseError",{enumerable:!0,get:a(
function(){return jc.DatabaseError},"get")});var Hc=js();Object.defineProperty(Ae,"serialize",{enumerable:!0,
get:a(function(){return Hc.serialize},"get")});var Gc=Vs();function $c(r,e){let t=new Gc.Parser;return r.
on("data",n=>t.parse(n,e)),new Promise(n=>r.on("end",()=>n()))}a($c,"parse");Ae.parse=$c});var Ks={};te(Ks,{connect:()=>Vc});function Vc({socket:r,servername:e}){return r.startTls(e),r}var zs=$(
()=>{"use strict";p();a(Vc,"connect")});var In=T((op,Js)=>{"use strict";p();var Ys=(ke(),O(vi)),Kc=xe().EventEmitter,{parse:zc,serialize:Q}=An(),
Zs=Q.flush(),Yc=Q.sync(),Zc=Q.end(),_n=class _n extends Kc{constructor(e){super(),e=e||{},this.stream=
...
var u=(zs(),O(Ks));let c={socket:n.stream};n.ssl!==!0&&(Object.assign(c,n.ssl),"key"in n.ssl&&(c.key=
...
stream.writable&&this.stream.write(Zs)}sync(){this._ending=!0,this._send(Zs),this._send(Yc)}ref(){this.
stream.ref()}unref(){this.stream.unref()}end(){if(this._ending=!0,!this._connecting||!this.stream.writable){
this.stream.end();return}return this.stream.write(Zc,()=>{this.stream.end()})}close(e){this._send(Q.
close(e))}describe(e){this._send(Q.describe(e))}sendCopyFromChunk(e){this._send(Q.copyData(e))}endCopyFrom(){
this._send(Q.copyDone())}sendCopyFail(e){this._send(Q.copyFail(e))}};a(_n,"Connection");var Cn=_n;Js.
exports=Cn});var to=T((lp,eo)=>{"use strict";p();var Jc=xe().EventEmitter,cp=(ut(),O(at)),Xc=ot(),Tn=ms(),el=Is(),
tl=Ct(),rl=Bt(),Xs=Qs(),nl=st(),il=In(),Pn=class Pn extends Jc{constructor(e){super(),this.connectionParameters=
new rl(e),this.user=this.connectionParameters.user,this.database=this.connectionParameters.database,
...
this._types=new tl(t.types),this._ending=!1,this._connecting=!1,this._connected=!1,this._connectionError=
!1,this._queryable=!0,this.connection=t.connection||new il({stream:t.stream,ssl:this.connectionParameters.
ssl,keepAlive:t.keepAlive||!1,keepAliveInitialDelayMillis:t.keepAliveInitialDelayMillis||0,encoding:this.
connectionParameters.client_encoding||"utf8"}),this.queryQueue=[],this.binary=t.binary||nl.binary,this.
...
password=this.password=null;e()}).catch(n=>{t.emit("error",n)}):this.password!==null?e():el(this.connectionParameters,
...
connectionParameters.query_timeout,i=new Xs(e,t,n),i.callback||(s=new this._Promise((l,f)=>{i.callback=
...
_Promise(t=>{this.connection.once("end",t)})}};a(Pn,"Client");var Dt=Pn;Dt.Query=Xs;eo.exports=Dt});var so=T((pp,io)=>{"use strict";p();var sl=xe().EventEmitter,ro=a(function(){},"NOOP"),no=a((r,e)=>{
let t=r.findIndex(e);return t===-1?void 0:r.splice(t,1)[0]},"removeWhere"),Ln=class Ln{constructor(e,t,n){
this.client=e,this.idleListener=t,this.timeoutId=n}};a(Ln,"IdleItem");var Rn=Ln,Fn=class Fn{constructor(e){
this.callback=e}};a(Fn,"PendingItem");var je=Fn;function ol(){throw new Error("Release called on cli\
ent which has already been released to the pool.")}a(ol,"throwOnDoubleRelease");function Ot(r,e){if(e)
...
function al(r,e){return a(function t(n){n.client=e,e.removeListener("error",t),e.on("error",()=>{r.log(
"additional client error after disconnection due to error",n)}),r._remove(e),r.emit("error",n,e)},"i\
dleListener")}a(al,"makeIdleListener");var kn=class kn extends sl{constructor(e,t){super(),this.options=
...
clearTimeout(o),t.callback(u,c,l)},"queueCallback"),s=new je(i),o=setTimeout(()=>{no(this._pendingQueue,
...
t);let n=al(this,t);this.log("checking client timeout");let i,s=!1;this.options.connectionTimeoutMillis&&
...
let n=!1;return i=>{n&&ol(),n=!0,this._release(e,t,i)}}_release(e,t,n){if(e.on("error",t),e._poolUseCount=
...
e,t,s)),this._pulseQueue()}query(e,t,n){if(typeof e=="function"){let s=Ot(this.Promise,e);return v(function(){
...
return this._clients.length}};a(kn,"Pool");var Bn=kn;io.exports=Bn});var oo={};te(oo,{default:()=>ul});var ul,ao=$(()=>{"use strict";p();ul={}});var uo=T((gp,cl)=>{cl.exports={name:"pg",version:"8.8.0",description:"PostgreSQL client - pure javas\
...
a178655"}});var fo=T((wp,lo)=>{"use strict";p();var co=xe().EventEmitter,ll=(ut(),O(at)),Mn=ot(),He=lo.exports=function(r,e,t){
...
this.on("newListener",function(n){n==="row"&&(this._emitRowEvents=!0)}.bind(this))};ll.inherits(He,co);
var fl={sqlState:"code",statementPosition:"position",messagePrimary:"message",context:"where",schemaName:"\
...
pq.resultErrorFields();if(e)for(var t in e){var n=fl[t]||t;r[n]=e[t]}this.callback?this.callback(r):
...
prepareValue);r.native.query(this.text,i,t)}else r.native.query(this.text,t)}});var mo=T((Sp,yo)=>{"use strict";p();var hl=(ao(),O(oo)),pl=Ct(),xp=uo(),ho=xe().EventEmitter,dl=(ut(),O(at)),
yl=Bt(),po=fo(),z=yo.exports=function(r){ho.call(this),r=r||{},this._Promise=r.Promise||b.Promise,this.
_types=new pl(r.types),this.native=new hl({types:this._types}),this._queryQueue=[],this._ending=!1,this.
_connecting=!1,this._connected=!1,this._queryable=!0;var e=this.connectionParameters=new yl(r);this.
...
po;dl.inherits(z,ho);z.prototype._errorAllQueries=function(r){let e=a(t=>{m.nextTick(()=>{t.native=this.
...
r,e,t)};z.prototype.getTypeParser=function(r,e){return this._types.getTypeParser(r,e)}});var Un=T((Cp,go)=>{"use strict";p();go.exports=mo()});var lt=T((Ip,ft)=>{"use strict";p();var ml=to(),gl=st(),wl=In(),bl=so(),{DatabaseError:vl}=An(),xl=a(
r=>{var e;return e=class extends bl{constructor(n){super(n,r)}},a(e,"BoundPool"),e},"poolFactory"),Dn=a(
function(r){this.defaults=gl,this.Client=r,this.Query=this.Client.Query,this.Pool=xl(this.Client),this.
_pools=[],this.Connection=wl,this.types=rt(),this.DatabaseError=vl},"PG");typeof m.env.NODE_PG_FORCE_NATIVE<
"u"?ft.exports=new Dn(Un()):(ft.exports=new Dn(ml),Object.defineProperty(ft.exports,"native",{configurable:!0,
enumerable:!1,get(){var r=null;try{r=new Dn(Un())}catch(e){if(e.code!=="MODULE_NOT_FOUND")throw e}return Object.
defineProperty(ft.exports,"native",{value:r}),r}}))});var Al={};te(Al,{Client:()=>Ge,DatabaseError:()=>le.DatabaseError,NeonDbError:()=>de,NeonQueryPromise:()=>Se,
Pool:()=>qt,SqlTemplate:()=>Me,UnsafeRawSql:()=>Ue,_bundleExt:()=>El,defaults:()=>le.defaults,escapeIdentifier:()=>le.escapeIdentifier,
escapeLiteral:()=>le.escapeLiteral,neon:()=>mr,neonConfig:()=>se,parseConnectionString:()=>xo.parse,
types:()=>le.types,warnIfBrowser:()=>ze});module.exports=O(Al);p();p();ke();Xt();p();var ya=Object.defineProperty,ma=Object.defineProperties,ga=Object.getOwnPropertyDescriptors,Si=Object.
getOwnPropertySymbols,wa=Object.prototype.hasOwnProperty,ba=Object.prototype.propertyIsEnumerable,Ei=a(
(r,e,t)=>e in r?ya(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t,"__defNormalProp"),
va=a((r,e)=>{for(var t in e||(e={}))wa.call(e,t)&&Ei(r,t,e[t]);if(Si)for(var t of Si(e))ba.call(e,t)&&
Ei(r,t,e[t]);return r},"__spreadValues"),xa=a((r,e)=>ma(r,ga(e)),"__spreadProps"),Sa=1008e3,Ai=new Uint8Array(
new Uint16Array([258]).buffer)[0]===2,Ea=new TextDecoder,er=new TextEncoder,gt=er.encode("0123456789\
abcdef"),wt=er.encode("0123456789ABCDEF"),Aa=er.encode("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqr\
stuvwxyz0123456789+/");var Ci=Aa.slice();Ci[62]=45;Ci[63]=95;var Ke,bt;function Ca(r,{alphabet:e,scratchArr:t}={}){if(!Ke)if(Ke=
new Uint16Array(256),bt=new Uint16Array(256),Ai)for(let C=0;C<256;C++)Ke[C]=gt[C&15]<<8|gt[C>>>4],bt[C]=
wt[C&15]<<8|wt[C>>>4];else for(let C=0;C<256;C++)Ke[C]=gt[C&15]|gt[C>>>4]<<8,bt[C]=wt[C&15]|wt[C>>>4]<<
8;r.byteOffset%4!==0&&(r=new Uint8Array(r));let n=r.length,i=n>>>1,s=n>>>2,o=t||new Uint16Array(n),u=new Uint32Array(
r.buffer,r.byteOffset,s),c=new Uint32Array(o.buffer,o.byteOffset,i),l=e==="upper"?bt:Ke,f=0,y=0,w;if(Ai)
...
return Ea.decode(o.subarray(0,n))}a(Ca,"_toHex");function _a(r,e={}){let t="",n=r.length,i=Sa>>>1,s=Math.
ceil(n/i),o=new Uint16Array(s>1?i:n);for(let u=0;u<s;u++){let c=u*i,l=c+i;t+=Ca(r.subarray(c,l),xa(va(
{},e),{scratchArr:o}))}return t}a(_a,"_toHexChunked");function _i(r,e={}){return e.alphabet!=="upper"&&
typeof r.toHex=="function"?r.toHex():_a(r,e)}a(_i,"toHex");p();var vt=class vt{constructor(e,t){this.strings=e;this.values=t}toParameterizedQuery(e={query:"",params:[]}){
let{strings:t,values:n}=this;for(let i=0,s=t.length;i<s;i++)if(e.query+=t[i],i<n.length){let o=n[i];
if(o instanceof Ue)e.query+=o.sql;else if(o instanceof Se)if(o.queryData instanceof vt)o.queryData.toParameterizedQuery(
...
(e.query+="::bytea")}}return e}};a(vt,"SqlTemplate");var Me=vt,tr=class tr{constructor(e){this.sql=e}};
a(tr,"UnsafeRawSql");var Ue=tr;p();function ze(){typeof window<"u"&&typeof document<"u"&&typeof console<"u"&&typeof console.warn=="func\
tion"&&console.warn(`          
        ************************************************************
        *                                                          *
        ...
        *  parameter.                                              *
        *                                                          *
        ************************************************************`)}a(ze,"warnIfBrowser");p();var Ye="pkg:npm/%40neondatabase/serverless@1.1.0";ke();var ls=be(Ct()),fs=be(ot());var It=class It extends Error{constructor(t){super(t);E(this,"name","NeonDbError");E(this,"severity");
...
It,"NeonDbError");var de=It,as="transaction() expects an array of queries, or a function returning a\
n array of queries",Fu=["severity","code","detail","hint","position","internalPosition","internalQue\
ry","where","schema","table","column","dataType","constraint","file","line","routine"];function ku(r){
return r instanceof d?"\\x"+_i(r):r}a(ku,"encodeBuffersAsBytea");function us(r){let{query:e,params:t}=r instanceof
Me?r.toParameterizedQuery():r;return{query:e,params:t.map(n=>ku((0,fs.prepareValue)(n)))}}a(us,"prep\
areQuery");function mr(r,{arrayMode:e,fullResults:t,fetchOptions:n,isolationLevel:i,readOnly:s,deferrable:o,
...
let{protocol:f,username:y,hostname:w,port:A,pathname:C}=l;if(f!=="postgres:"&&f!=="postgresql:"||!y||
!w||!C)throw new Error("Database connection string format for `neon()` should be: postgresql://user:\
...
Y,new Me(P,I))}a(D,"templateFn"),D.query=(P,I,g)=>new Se(Y,{query:P,params:I??[]},g),D.unsafe=P=>new Ue(
P),D.transaction=async(P,I)=>{if(typeof P=="function"&&(P=P(D)),!Array.isArray(P))throw new Error(as);
P.forEach(W=>{if(!(W instanceof Se))throw new Error(as)});let g=P.map(W=>W.queryData),Z=P.map(W=>W.opts??
{});return Y(g,Z,I)};async function Y(P,I,g){let{fetchEndpoint:Z,fetchFunction:W}=se,J=Array.isArray(
P)?{queries:P.map(ee=>us(ee))}:us(P),X=n??{},oe=e??!1,ae=t??!1,B=i,j=s,fe=o;g!==void 0&&(g.fetchOptions!==
void 0&&(X={...X,...g.fetchOptions}),g.arrayMode!==void 0&&(oe=g.arrayMode),g.fullResults!==void 0&&
(ae=g.fullResults),g.isolationLevel!==void 0&&(B=g.isolationLevel),g.readOnly!==void 0&&(j=g.readOnly),
g.deferrable!==void 0&&(fe=g.deferrable)),I!==void 0&&!Array.isArray(I)&&I.fetchOptions!==void 0&&(X=
{...X,...I.fetchOptions});let me=u;!Array.isArray(I)&&I?.authToken!==void 0&&(me=I.authToken);let $e=typeof Z==
"function"?Z(w,A,{jwtAuth:me!==void 0}):Z,he={"Neon-Connection-String":r,"Neon-Raw-Text-Output":"tru\
e","Neon-Array-Mode":"true","Neon-Client-Info":Ye},Ie=await Mu(me);Ie&&(he.Authorization=`Bearer ${Ie}`),
Array.isArray(P)&&(B!==void 0&&(he["Neon-Batch-Isolation-Level"]=B),j!==void 0&&(he["Neon-Batch-Read\
-Only"]=String(j)),fe!==void 0&&(he["Neon-Batch-Deferrable"]=String(fe))),c||se.disableWarningInBrowsers||
ze();let ge;try{ge=await(W??fetch)($e,{method:"POST",body:JSON.stringify(J),headers:he,...X})}catch(ee){
let M=new de(`Error connecting to database: ${ee}`);throw M.sourceError=ee,M}if(ge.ok){let ee=await ge.
json();if(Array.isArray(P)){let M=ee.results;if(!Array.isArray(M))throw new de("Neon internal error:\
 unexpected result format");return M.map((G,we)=>{let Qt=I[we]??{},So=Qt.arrayMode??oe,Eo=Qt.fullResults??
ae;return cs(G,{arrayMode:So,fullResults:Eo,types:Qt.types})})}else{let M=I??{},G=M.arrayMode??oe,we=M.
fullResults??ae;return cs(ee,{arrayMode:G,fullResults:we,types:M.types})}}else{let{status:ee}=ge;if(ee===
400){let M=await ge.json(),G=new de(M.message);for(let we of Fu)G[we]=M[we]??void 0;throw G}else{let M=await ge.
text();throw new de(`Server error (HTTP status ${ee}): ${M}`)}}}return a(Y,"execute"),D}a(mr,"neon");
var gr=class gr{constructor(e,t,n){this.execute=e;this.queryData=t;this.opts=n}then(e,t){return this.
execute(this.queryData,this.opts).then(e,t)}catch(e){return this.execute(this.queryData,this.opts).catch(
e)}finally(e){return this.execute(this.queryData,this.opts).finally(e)}};a(gr,"NeonQueryPromise");var Se=gr;
...
!0,r.rowAsArray=e,r.rows=u,r._parsers=o,r._types=i,r):u}a(cs,"processQueryResult");async function Mu(r){
if(typeof r=="string")return r;if(typeof r=="function")try{return await Promise.resolve(r())}catch(e){
let t=new de("Error getting auth token.");throw e instanceof Error&&(t=new de(`Error getting auth to\
ken: ${e.message}`)),t}}a(Mu,"getAuthToken");p();var bo=be(lt());p();var wo=be(lt());var On=class On extends wo.Client{constructor(t){super(typeof t=="string"?{connectionString:t,fallback_application_name:Ye}:
{fallback_application_name:Ye,...t});this.config=t}get neonConfig(){return this.connection.stream}connect(t){
let{neonConfig:n}=this;n.forceDisablePgSSL&&(this.ssl=this.connection.ssl=!1),this.ssl&&n.useSecureWebSocket&&
console.warn("SSL is enabled for both Postgres (e.g. ?sslmode=require in the connection string + for\
ceDisablePgSSL = false) and the WebSocket tunnel (useSecureWebSocket = true). Double encryption will\
 increase latency and CPU usage. It may be appropriate to disable SSL in the Postgres connection par\
ameters or set forceDisablePgSSL = true.");let i=typeof this.config!="string"&&this.config?.host!==void 0||
typeof this.config!="string"&&this.config?.connectionString!==void 0||m.env.PGHOST!==void 0,s=m.env.
USER??m.env.USERNAME;if(!i&&this.host==="localhost"&&this.user===s&&this.database===s&&this.password===
null)throw new Error(`No database host or connection string was set, and key parameters have default\
 values (host: localhost, user: ${s}, db: ${s}, password: null). Is an environment variable missing?\
 Alternatively, if you intended to connect with these parameters, please set the host to 'localhost'\
 explicitly.`);let o=super.connect(t),u=n.pipelineTLS&&this.ssl,c=n.pipelineConnect==="password";if(!u&&
!n.pipelineConnect)return o;let l=this.connection;if(u&&l.on("connect",()=>l.stream.emit("data","S")),
c){l.removeAllListeners("authenticationCleartextPassword"),l.removeAllListeners("readyForQuery"),l.once(
"readyForQuery",()=>l.on("readyForQuery",this._handleReadyForQuery.bind(this)));let f=this.ssl?"sslc\
onnect":"connect";l.on(f,()=>{this.neonConfig.disableWarningInBrowsers||ze(),this._handleAuthCleartextPassword(),
this._handleReadyForQuery()})}return o}async _handleAuthSASLContinue(t){if(typeof crypto>"u"||crypto.
subtle===void 0||crypto.subtle.importKey===void 0)throw new Error("Cannot use SASL auth when `crypto\
.subtle` is not defined");let n=crypto.subtle,i=this.saslSession,s=this.password,o=t.data;if(i.message!==
"SASLInitialResponse"||typeof s!="string"||typeof o!="string")throw new Error("SASL: protocol error");
let u=Object.fromEntries(o.split(",").map(M=>{if(!/^.=/.test(M))throw new Error("SASL: Invalid attri\
bute pair entry");let G=M[0],we=M.substring(2);return[G,we]})),c=u.r,l=u.s,f=u.i;if(!c||!/^[!-+--~]+$/.
test(c))throw new Error("SASL: SCRAM-SERVER-FIRST-MESSAGE: nonce missing/unprintable");if(!l||!/^(?:[a-zA-Z0-9+/]{4})*(?:[a-zA-Z0-9+/]{2}==|[a-zA-Z0-9+/]{3}=)?$/.
...
server nonce is too short");let y=parseInt(f,10),w=d.from(l,"base64"),A=new TextEncoder,C=A.encode(s),
D=await n.importKey("raw",C,{name:"HMAC",hash:{name:"SHA-256"}},!1,["sign"]),Y=new Uint8Array(await n.
sign("HMAC",D,d.concat([w,d.from([0,0,0,1])]))),P=Y;for(var I=0;I<y-1;I++)Y=new Uint8Array(await n.sign(
"HMAC",D,Y)),P=d.from(P.map((M,G)=>P[G]^Y[G]));let g=P,Z=await n.importKey("raw",g,{name:"HMAC",hash:{
name:"SHA-256"}},!1,["sign"]),W=new Uint8Array(await n.sign("HMAC",Z,A.encode("Client Key"))),J=await n.
digest("SHA-256",W),X="n=*,r="+i.clientNonce,oe="r="+c+",s="+l+",i="+y,ae="c=biws,r="+c,B=X+","+oe+"\
,"+ae,j=await n.importKey("raw",J,{name:"HMAC",hash:{name:"SHA-256"}},!1,["sign"]);var fe=new Uint8Array(
await n.sign("HMAC",j,A.encode(B))),me=d.from(W.map((M,G)=>W[G]^fe[G])),$e=me.toString("base64");let he=await n.
importKey("raw",g,{name:"HMAC",hash:{name:"SHA-256"}},!1,["sign"]),Ie=await n.sign("HMAC",he,A.encode(
"Server Key")),ge=await n.importKey("raw",Ie,{name:"HMAC",hash:{name:"SHA-256"}},!1,["sign"]);var ee=d.
from(await n.sign("HMAC",ge,A.encode(B)));i.message="SASLResponse",i.serverSignature=ee.toString("ba\
se64"),i.response=ae+",p="+$e,this.connection.sendSCRAMClientFinalMessage(this.saslSession.response)}};
a(On,"NeonClient");var Ge=On;ke();var vo=be(Bt());function Sl(r,e){if(e)return{callback:e,result:void 0};let t,n,i=a(function(o,u){o?t(o):n(u)},"cb"),
s=new r(function(o,u){n=o,t=u});return{callback:i,result:s}}a(Sl,"promisify");var qn=class qn extends bo.Pool{constructor(){
super(...arguments);E(this,"Client",Ge);E(this,"hasFetchUnsupportedListeners",!1);E(this,"addListene\
...
/${c(o.database)}`,f=typeof t=="string"?t:t.text,y=n??t.values??[];mr(l,{fullResults:!0,arrayMode:t.
rowMode==="array"}).query(f,y,{types:t.types??this.options?.types}).then(A=>i(void 0,A)).catch(A=>i(
A))}catch(o){i(o)}return s.result}};a(qn,"NeonPool");var qt=qn;ke();var le=be(lt()),xo=be(Lr()),El="js";
