...
offset+e);return this.offset+=e,t}};a(hn,"BufferReader");var fn=hn;Bt.BufferReader=fn});var Ns=T(Lt=>{"use strict";p();Object.defineProperty(Lt,"__esModule",{value:!0});Lt.Parser=void 0;var k=on(),
...
s.L,c.routine=s.R,c}};a(yn,"Parser");var dn=yn;Lt.Parser=dn});var mn=T(ve=>{"use strict";p();Object.defineProperty(ve,"__esModule",{value:!0});ve.DatabaseError=ve.
...
findIndex(l=>l.client===t)!==-1&&this._acquireClient(t,new Qe((l,f,d)=>d()),n,!1)},this.options.maxLifetimeSeconds*
...
e.unref(),this._idle.push(new xn(e,t,s)),this._pulseQueue()}query(e,t,n){if(typeof e=="function"){let s=Mt(
...
Zs.exports=En});var Xs={};ee(Xs,{default:()=>el});var el,eo=K(()=>{"use strict";p();el={}});var to=T((Yh,tl)=>{tl.exports={name:"pg",version:"8.8.0",description:"PostgreSQL client - pure javas\
...
(P,L,C)=>es(N,new Me([P],L??[]),C),_.unsafe=P=>new Me([P],[]),_.transaction=async(P,L)=>{if(typeof P==
"function"&&(P=P(_)),!Array.isArray(P))throw new Error(Xi);P.forEach(H=>{if(H[Symbol.toStringTag]!==
"NeonQueryPromise")throw new Error(Xi)});let C=P.map(H=>H.sqlTemplate),S=P.map(H=>H.opts??{});return N(
