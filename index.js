"use strict";var Eo=Object.create;var Te=Object.defineProperty;var Ao=Object.getOwnPropertyDescriptor;var Co=Object.getOwnPropertyNames;var _o=Object.getPrototypeOf,Io=Object.prototype.hasOwnProperty;var To=(r,e,t)=>e in r?Te(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t;var a=(r,e)=>Te(r,"name",{value:e,configurable:!0});var $=(r,e)=>()=>(r&&(e=r(r=0)),e);var T=(r,e)=>()=>(e||r((e={exports:{}}).exports,e),e.exports),te=(r,e)=>{for(var t in e)Te(r,t,{get:e[t],
...
t,r)),O=r=>qn(Te({},"__esModule",{value:!0}),r);var E=(r,e,t)=>To(r,typeof e!="symbol"?e+"":e,t);var Wn=T(ht=>{"use strict";p();ht.byteLength=Ro;ht.toByteArray=Lo;ht.fromByteArray=Mo;var ue=[],re=[],
Po=typeof Uint8Array<"u"?Uint8Array:Array,Nt="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz01\
23456789+/";for(Ce=0,Qn=Nt.length;Ce<Qn;++Ce)ue[Ce]=Nt[Ce],re[Nt.charCodeAt(Ce)]=Ce;var Ce,Qn;re[45]=
62;re[95]=63;function Nn(r){var e=r.length;if(e%4>0)throw new Error("Invalid string. Length must be \
...
4|re[r.charCodeAt(c+2)]>>2,s[o++]=e>>8&255,s[o++]=e&255),s}a(Lo,"toByteArray");function Fo(r){return ue[r>>
18&63]+ue[r>>12&63]+ue[r>>6&63]+ue[r&63]}a(Fo,"tripletToBase64");function ko(r,e,t){for(var n,i=[],s=e;s<
...
i.push(ue[e>>10]+ue[e>>4&63]+ue[e<<2&63]+"=")),i.join("")}a(Mo,"fromByteArray")});var jn=T(Wt=>{p();Wt.read=function(r,e,t,n,i){var s,o,u=i*8-n-1,c=(1<<u)-1,l=c>>1,f=-7,y=t?i-1:0,g=t?
...
C,u/=256,i-=8);for(o=o<<i|u,l+=i;l>0;r[t+A]=o&255,A+=C,o/=256,l-=8);r[t+A-C]|=D*128}});var oi=T(Le=>{"use strict";p();var jt=Wn(),Re=jn(),Hn=typeof Symbol=="function"&&typeof Symbol.for==
"function"?Symbol.for("nodejs.util.inspect.custom"):null;Le.Buffer=h;Le.SlowBuffer=No;Le.INSPECT_MAX_BYTES=
50;var pt=2147483647;Le.kMaxLength=pt;h.TYPED_ARRAY_SUPPORT=Uo();!h.TYPED_ARRAY_SUPPORT&&typeof console<
...
for option "size"')}a(zn,"assertSize");function Do(r,e,t){return zn(r),r<=0?pe(r):e!==void 0?typeof t==
"string"?pe(r).fill(e,t):pe(r).fill(e):pe(r)}a(Do,"alloc");h.alloc=function(r,e,t){return Do(r,e,t)};
function Vt(r){return zn(r),pe(r<0?0:Kt(r)|0)}a(Vt,"allocUnsafe");h.allocUnsafe=function(r){return Vt(
...
r,e);return i!==t&&(n=n.slice(0,i)),n}a(Oo,"fromString");function Ht(r){let e=r.length<0?0:Kt(r.length)|
...
r,e,t),Object.setPrototypeOf(n,h.prototype),n}a(Gt,"fromArrayBuffer");function Qo(r){if(h.isBuffer(r)){
...
a(Qo,"fromObject");function Kt(r){if(r>=pt)throw new RangeError("Attempt to allocate Buffer larger t\
han maximum size: 0x"+pt.toString(16)+" bytes");return r|0}a(Kt,"checked");function No(r){return+r!=
...
if(i)return n?-1:$t(r).length;e=(""+e).toLowerCase(),i=!0}}a(Yn,"byteLength");h.byteLength=Yn;function Wo(r,e,t){
...
return dt($t(e,r.length-t),r,t,n)}a(Ho,"utf8Write");function Go(r,e,t,n){return dt(na(e),r,t,n)}a(Go,
"asciiWrite");function $o(r,e,t,n){return dt(si(e),r,t,n)}a($o,"base64Write");function Vo(r,e,t,n){return dt(
...
N");function Ko(r,e,t){return e===0&&t===r.length?jt.fromByteArray(r):jt.fromByteArray(r.slice(e,t))}
...
riteBigUInt64LE"));h.prototype.writeBigUInt64BE=be(a(function(e,t=0){return ei(this,e,t,BigInt(0),BigInt(
...
t+4},"writeInt32BE");h.prototype.writeBigInt64LE=be(a(function(e,t=0){return Xn(this,e,t,-BigInt("0x\
...
Be(e,"offset"),(r[e]===void 0||r[e+t]===void 0)&&Ve(e,r.length-(t+1))}a(ea,"checkBounds");function ii(r,e,t,n,i,s){
...
nd <= ${t}${o}`,new Pe.ERR_OUT_OF_RANGE("value",u,r)}ea(n,i,s)}a(ii,"checkIntBI");function Be(r,e){if(typeof r!=
...
new Pe.ERR_OUT_OF_RANGE(t||"offset",`>= ${t?1:0} and <= ${e}`,r)}a(Ve,"boundsError");var ta=/[^+/0-9A-Za-z-_]/g;
...
o),n=t>>8,i=t%256,s.push(i),s.push(n);return s}a(ia,"utf16leToBytes");function si(r){return jt.toByteArray(
ra(r))}a(si,"base64ToBytes");function dt(r,e,t,n){let i;for(i=0;i<n&&!(i+t>=e.length||i>=r.length);++i)
...
oa:r}a(be,"defineBigIntMethod");function oa(){throw new Error("BigInt not supported")}a(oa,"BufferBi\
...
m.nextTick(()=>{})}catch{let e=Promise.resolve();m.nextTick=e.then.bind(e)}});var ve=T((kl,Zt)=>{"use strict";p();var Fe=typeof Reflect=="object"?Reflect:null,ai=Fe&&typeof Fe.apply==
...
init.call(this)}a(R,"EventEmitter");Zt.exports=R;Zt.exports.once=fa;R.EventEmitter=R;R.prototype._events=
void 0;R.prototype._eventsCount=0;R.prototype._maxListeners=void 0;var ui=10;function mt(r){if(typeof r!=
...
length,f=yi(c,l),n=0;n<l;++n)ai(f[n],this,t);return!0},"emit");function fi(r,e,t,n){var i,s,o;if(mt(
...
rap");R.prototype.once=a(function(e,t){return mt(t),this.on(e,hi(this,e,t)),this},"once");R.prototype.
prependOnceListener=a(function(e,t){return mt(t),this.prependListener(e,hi(this,e,t)),this},"prepend\
...
return this._eventsCount>0?yt(this._events):[]},"eventNames");function yi(r,e){for(var t=new Array(e),
...
ust be of type EventEmitter. Received type '+typeof r)}a(mi,"eventTargetAgnosticAddListener")});var bi={};te(bi,{Socket:()=>se,isIP:()=>pa});function pa(r){return 0}var gi,wi,S,se,ke=$(()=>{"use s\
trict";p();gi=Ae(ve(),1);a(pa,"isIP");wi=/^[^.]+\./,S=class S extends gi.EventEmitter{constructor(){
...
disableWarningInBrowsers:!1}),E(S,"opts",{});se=S});var vi={};te(vi,{parse:()=>Jt});function Jt(r,e=!1){let{protocol:t}=new URL(r),n="http:"+r.substring(
...
pathname:l,search:f,query:C,hash:g}}var Xt=$(()=>{"use strict";p();a(Jt,"parse")});var nr=T(_i=>{"use strict";p();_i.parse=function(r,e){return new rr(r,e).parse()};var xt=class xt{constructor(e,t){
...
not balanced");return this.entries}};a(xt,"ArrayParser");var rr=xt;function _a(r){return r}a(_a,"ide\
ntity")});var ir=T((rf,Ii)=>{p();var Ia=nr();Ii.exports={create:a(function(r,e){return{parse:a(function(){return Ia.
parse(r,e)},"parse")}},"create")}});var Ri=T((of,Pi)=>{"use strict";p();var Ta=/(\d{1,})-(\d{2})-(\d{2}) (\d{2}):(\d{2}):(\d{2})(\.\d{1,})?.*?( BC)?$/,
...
(y=new Date(Date.UTC(i,s,o,u,c,l,f)),sr(i)&&y.setUTCFullYear(i),g!==0&&y.setTime(y.getTime()-g)):(y=
new Date(i,s,o,u,c,l,f),sr(i)&&y.setFullYear(i)),y},"parseDate");function La(r){var e=Pa.exec(r);if(e){
var t=parseInt(e[1],10),n=!!e[4];n&&(t=Ti(t));var i=parseInt(e[2],10)-1,s=e[3],o=new Date(t,i,s);return sr(
...
1)}a(Ti,"bcYearToNegativeYear");function sr(r){return r>=0&&r<100}a(sr,"is0To99")});var Li=T((cf,Bi)=>{p();Bi.exports=Ma;var ka=Object.prototype.hasOwnProperty;function Ma(r){for(var e=1;e<
arguments.length;e++){var t=arguments[e];for(var n in t)ka.call(t,n)&&(r[n]=t[n])}return r}a(Ma,"ext\
end")});var Mi=T((hf,ki)=>{"use strict";p();var Ua=Li();ki.exports=De;function De(r){if(!(this instanceof De))
return new De(r);Ua(this,Ka(r))}a(De,"PostgresInterval");var Da=["seconds","minutes","hours","days",
"months","years"];De.prototype.toPostgres=function(){var r=Da.filter(this.hasOwnProperty,this);return this.
...
S"},qa=["years","months","days"],Qa=["hours","minutes","seconds"];De.prototype.toISOString=De.prototype.
...
/0+$/,"")),i+Oa[n]}};var or="([+-]?\\d+)",Na=or+"\\s+years?",Wa=or+"\\s+mons?",ja=or+"\\s+days?",Ha="\
...
!o)||(t&&~$a.indexOf(i)&&(o*=-1),n[i]=o),n},{})}a(Ka,"parse")});var Di=T((yf,Ui)=>{"use strict";p();Ui.exports=a(function(e){if(/^\\x/.test(e))return new d(e.substr(
...
parseBytea")});var Hi=T((gf,ji)=>{p();var Ze=nr(),Je=ir(),St=Ri(),qi=Mi(),Qi=Di();function Et(r){return a(function(t){
...
Ze.parse(r,Ni):null}a(za,"parseBoolArray");function Ya(r){return parseInt(r,10)}a(Ya,"parseBaseTenIn\
t");function ar(r){return r?Ze.parse(r,Et(Ya)):null}a(ar,"parseIntegerArray");function Za(r){return r?
Ze.parse(r,Et(function(e){return Wi(e).trim()})):null}a(Za,"parseBigIntegerArray");var Ja=a(function(r){
...
ervalArray"),eu=a(function(r){return r?Ze.parse(r,Et(Qi)):null},"parseByteAArray"),lr=a(function(r){
return parseInt(r,10)},"parseInteger"),Wi=a(function(r){var e=String(r);return/^\d+$/.test(e)?e:r},"\
parseBigInteger"),Oi=a(function(r){return r?Ze.parse(r,Et(JSON.parse)):null},"parseJsonArray"),fr=a(
...
r[i])}var s=fr(e);return s.radius=parseFloat(t),s},"parseCircle"),ru=a(function(r){r(20,Wi),r(21,lr),
r(23,lr),r(26,lr),r(700,parseFloat),r(701,parseFloat),r(16,Ni),r(1082,St),r(1114,St),r(1184,St),r(600,
fr),r(651,ne),r(718,tu),r(1e3,za),r(1001,eu),r(1005,ar),r(1007,ar),r(1028,ar),r(1016,Za),r(1017,Ja),
r(1021,ur),r(1022,ur),r(1231,ur),r(1014,ne),r(1015,ne),r(1008,ne),r(1009,ne),r(1040,ne),r(1041,ne),r(
1115,cr),r(1182,cr),r(1185,cr),r(1186,qi),r(1187,Xa),r(17,Qi),r(114,JSON.parse.bind(JSON)),r(3802,JSON.
parse.bind(JSON)),r(199,Oi),r(3807,Oi),r(3907,ne),r(2951,ne),r(791,ne),r(1183,ne),r(1270,ne)},"init");
ji.exports={init:ru}});var $i=T((xf,Gi)=>{"use strict";p();var K=1e6;function nu(r){var e=r.readInt32BE(0),t=r.readUInt32BE(
...
""+o%K,n+u+i}a(nu,"readInt8");Gi.exports=nu});var Zi=T((Af,Yi)=>{p();var iu=$i(),L=a(function(r,e,t,n,i){t=t||0,n=n||!1,i=i||function(A,C,D){return A*
...
r(701,au),r(16,lu),r(1114,Ki.bind(null,!1)),r(1184,Ki.bind(null,!0)),r(1e3,Xe),r(1007,Xe),r(1016,Xe),
r(1008,Xe),r(1009,Xe),r(25,cu)},"init");Yi.exports={init:fu}});var Xi=T((If,Ji)=>{p();Ji.exports={BOOL:16,BYTEA:17,CHAR:18,INT8:20,INT2:21,INT4:23,REGPROC:24,TEXT:25,
...
REGROLE:4096}});var rt=T(tt=>{p();var hu=Hi(),pu=Zi(),du=ir(),yu=Xi();tt.getTypeParser=mu;tt.setTypeParser=wu;tt.arrayParser=
du;tt.builtins=yu;var et={text:{},binary:{}};function es(r){return String(r)}a(es,"noParse");function mu(r,e){
return e=e||"text",et[e]&&et[e][r]||es}a(mu,"getTypeParser");function wu(r,e,t){typeof e=="function"&&
(t=e,e="text"),et[e][r]=t}a(wu,"setTypeParser");hu.init(function(r,e){et.text[r]=e});pu.init(function(r,e){
et.binary[r]=e})});var Ct=T((Lf,ts)=>{"use strict";p();var gu=rt();function At(r){this._types=r||gu,this.text={},this.binary=
...
e||"text",this.getOverrides(e)[r]||this._types.getTypeParser(r,e)};ts.exports=At});function nt(r){let e=1779033703,t=3144134277,n=1013904242,i=2773480762,s=1359893119,o=2600822924,u=528734635,
...
for(let B=0;B<64;B++){let j=g(J,6)^g(J,11)^g(J,25),fe=J&X^~J&oe,me=ae+j+fe+y[B]+A[B]|0,$e=g(I,2)^g(I,
13)^g(I,22),he=I&w^I&Z^w&Z,Ie=$e+he|0;ae=oe,oe=X,X=J,J=W+me|0,W=Z,Z=w,w=I,I=me+Ie|0}e=e+I|0,t=t+w|0,
...
(Y(r),P())}var rs=$(()=>{"use strict";p();a(nt,"sha256")});var U,it,ns=$(()=>{"use strict";p();U=class U{constructor(){E(this,"_dataLength",0);E(this,"_bufferL\
...
abcdef"),E(U,"hexOut",[]),E(U,"onePassHasher",new U);it=U});var hr={};te(hr,{createHash:()=>vu,createHmac:()=>xu,randomBytes:()=>bu});function bu(r){return crypto.
...
"digest")}},"update")}}var pr=$(()=>{"use strict";p();rs();ns();a(bu,"randomBytes");a(vu,"createHash");
a(xu,"createHmac")});var st=T((Gf,dr)=>{"use strict";p();dr.exports={host:"localhost",user:m.platform==="win32"?m.env.USERNAME:
...
keepalives:1,keepalives_idle:0};var Oe=rt(),Su=Oe.getTypeParser(20,"text"),Eu=Oe.getTypeParser(1016,
"text");dr.exports.__defineSetter__("parseInt8",function(r){Oe.setTypeParser(20,"text",r?Oe.getTypeParser(
23,"text"):Su),Oe.setTypeParser(1016,"text",r?Oe.getTypeParser(1007,"text"):Eu)})});var ot=T((Vf,ss)=>{"use strict";p();var Au=(pr(),O(hr)),Cu=st();function _u(r){var e=r.replace(/\\/g,
...
t),r}a(Ru,"normalizeQueryConfig");var yr=a(function(r){return Au.createHash("md5").update(r,"utf-8").
digest("hex")},"md5"),Bu=a(function(r,e,t){var n=yr(e+r),i=yr(d.concat([d.from(n),t]));return"md5"+i},
"postgresMd5PasswordHash");ss.exports={prepareValue:a(function(e){return _t(e)},"prepareValueWrapper"),
normalizeQueryConfig:Ru,postgresMd5PasswordHash:Bu,md5:yr}});var at={};te(at,{default:()=>Mu});var Mu,ut=$(()=>{"use strict";p();Mu={}});var ys=T((ah,ds)=>{"use strict";p();var gr=(pr(),O(hr));function Uu(r){if(r.indexOf("SCRAM-SHA-256")===
...
art with client nonce");var i=d.from(n.salt,"base64"),s=ju(e,i,n.iteration),o=qe(s,"Client Key"),u=Wu(
o),c="n=*,r="+r.clientNonce,l="r="+n.nonce+",s="+n.salt+",i="+n.iteration,f="c=biws,r="+n.nonce,y=c+
","+l+","+f,g=qe(u,y),A=ps(o,g),C=A.toString("base64"),D=qe(s,"Server Key"),Y=qe(D,y);r.message="SAS\
...
e<=126)}a(qu,"isPrintableChars");function fs(r){return/^(?:[a-zA-Z0-9+/]{4})*(?:[a-zA-Z0-9+/]{2}==|[a-zA-Z0-9+/]{3}=)?$/.
...
Pairs");function Qu(r){let e=hs(r),t=e.get("r");if(t){if(!qu(t))throw new Error("SASL: SCRAM-SERVER-\
...
function Nu(r){let t=hs(r).get("v");if(t){if(!fs(t))throw new Error("SASL: SCRAM-SERVER-FINAL-MESSAG\
E: server signature must be base64")}else throw new Error("SASL: SCRAM-SERVER-FINAL-MESSAGE: server \
signature is missing");return{serverSignature:t}}a(Nu,"parseServerFinalMessage");function ps(r,e){if(!d.
...
a(ps,"xorBuffers");function Wu(r){return gr.createHash("sha256").update(r).digest()}a(Wu,"sha256");function qe(r,e){
return gr.createHmac("sha256",r).update(e).digest()}a(qe,"hmacSha256");function ju(r,e,t){for(var n=qe(
r,d.concat([e,d.from([0,0,0,1])])),i=n,s=0;s<t-1;s++)n=qe(r,n),i=ps(i,n);return i}a(ju,"Hi");ds.exports=
{startSession:Uu,continueSession:Du,finalizeSession:Ou}});var br={};te(br,{join:()=>Hu});function Hu(...r){return r.join("/")}var vr=$(()=>{"use strict";p();a(
Hu,"join")});var xr={};te(xr,{stat:()=>Gu});function Gu(r,e){e(new Error("No filesystem"))}var Sr=$(()=>{"use str\
ict";p();a(Gu,"stat")});var Er={};te(Er,{default:()=>$u});var $u,Ar=$(()=>{"use strict";p();$u={}});var ms={};te(ms,{StringDecoder:()=>Cr});var _r,Cr,ws=$(()=>{"use strict";p();_r=class _r{constructor(e){
E(this,"td");this.td=new TextDecoder(e)}write(e){return this.td.decode(e,{stream:!0})}end(e){return this.
td.decode(e)}};a(_r,"StringDecoder");Cr=_r});var xs=T((wh,vs)=>{"use strict";p();var{Transform:Vu}=(Ar(),O(Er)),{StringDecoder:Ku}=(ws(),O(ms)),Se=Symbol(
...
"maximum buffer reached"));return}t()}a(zu,"transform");function Yu(r){if(this[Se]+=this[Tt].end(),this[Se])
try{bs(this,this.mapper(this[Se]))}catch(e){return r(e)}r()}a(Yu,"flush");function bs(r,e){e!==void 0&&
r.push(e)}a(bs,"push");function gs(r){return r}a(gs,"noop");function Zu(r,e,t){switch(r=r||/\r?\n/,e=
...
"object"&&(t=e,e=gs)}t=Object.assign({},t),t.autoDestroy=!0,t.transform=zu,t.flush=Yu,t.readableObjectMode=
!0;let n=new Vu(t);return n[Se]="",n[Tt]=new Ku("utf8"),n.matcher=r,n.mapper=e,n.maxLength=t.maxLength,
n.skipOverflow=t.skipOverflow||!1,n.overflow=!1,n._destroy=function(i,s){this._writableState.errorEmitted=
!1,s(i)},n}a(Zu,"split");vs.exports=Zu});var As=T((vh,ye)=>{"use strict";p();var Ss=(vr(),O(br)),Ju=(Ar(),O(Er)).Stream,Xu=xs(),Es=(ut(),O(at)),
ec=5432,Pt=m.platform==="win32",ct=m.stderr,tc=56,rc=7,nc=61440,ic=32768;function sc(r){return(r&nc)==
ic}a(sc,"isRegFile");var Qe=["host","port","database","user","password"],Ir=Qe.length,oc=Qe[Ir-1];function Tr(){
var r=ct instanceof Ju&&ct.writable===!0;if(r){var e=Array.prototype.slice.call(arguments).concat(`
`);ct.write(Es.format.apply(Es,e))}}a(Tr,"warn");Object.defineProperty(ye.exports,"isWin",{get:a(function(){
return Pt},"get"),set:a(function(r){Pt=r},"set")});ye.exports.warnTo=function(r){var e=ct;return ct=
r,e};ye.exports.getFileName=function(r){var e=r||m.env,t=e.PGPASSFILE||(Pt?Ss.join(e.APPDATA||"./","\
postgresql","pgpass.conf"):Ss.join(e.HOME||"./",".pgpass"));return t};ye.exports.usePgPass=function(r,e){
return Object.prototype.hasOwnProperty.call(m.env,"PGPASSWORD")?!1:Pt?!0:(e=e||"<unkn>",sc(r.mode)?r.
mode&(tc|rc)?(Tr('WARNING: password file "%s" has group or world access; permissions should be u=rw \
(0600) or less',e),!1):!0:(Tr('WARNING: password file "%s" is not a plain file',e),!1))};var ac=ye.exports.
match=function(r,e){return Qe.slice(0,-1).reduce(function(t,n,i){return i==1&&Number(r[n]||ec)===Number(
...
void 0)},"onErr");e.on("error",u),i.on("data",s).on("end",o).on("error",u)};var uc=ye.exports.parseLine=
...
length===Ir?o:null,o},cc=ye.exports.isValidEntry=function(r){for(var e={0:function(o){return o.length>
...
0}},t=0;t<Qe.length;t+=1){var n=e[t],i=r[Qe[t]]||"",s=n(i);if(!s)return!1}return!0}});var _s=T((Ah,Pr)=>{"use strict";p();var Eh=(vr(),O(br)),Cs=(Sr(),O(xr)),Rt=As();Pr.exports=function(r,e){
var t=Rt.getFileName();Cs.stat(t,function(n,i){if(n||!Rt.usePgPass(i,t))return e(void 0);var s=Cs.createReadStream(
t);Rt.getPassword(r,s,e)})};Pr.exports.warnTo=Rt.warnTo});var Is={};te(Is,{default:()=>lc});var lc,Ts=$(()=>{"use strict";p();lc={}});var Rs=T((Ih,Ps)=>{"use strict";p();var fc=(Xt(),O(vi)),Rr=(Sr(),O(xr));function Br(r){if(r.charAt(0)===
...
!1;break}}return t}a(Br,"parse");Ps.exports=Br;Br.parse=Br});var Bt=T((Rh,Fs)=>{"use strict";p();var hc=(Ts(),O(Is)),Ls=st(),Bs=Rs().parse,H=a(function(r,e,t){return t===
...
var n=e[t];n!=null&&r.push(t+"="+Ne(n))},"add"),Fr=class Fr{constructor(e){e=typeof e=="string"?Bs(e):
...
hc.lookup(this.host,function(i,s){return i?e(i,null):(t.push("hostaddr="+Ne(s)),e(null,t.join(" ")))})}};
a(Fr,"ConnectionParameters");var Lr=Fr;Fs.exports=Lr});var Us=T((Fh,Ms)=>{"use strict";p();var dc=rt(),ks=/^([A-Za-z]+)(?: (\d+))?(?: (\d+))?/,Mr=class Mr{constructor(e,t){
...
format||"text")}}};a(Mr,"Result");var kr=Mr;Ms.exports=kr});var Qs=T((Uh,qs)=>{"use strict";p();var{EventEmitter:yc}=ve(),Ds=Us(),Os=ot(),Dr=class Dr extends yc{constructor(e,t,n){
...
e.sendCopyFail("No source stream defined")}handleCopyData(e,t){}};a(Dr,"Query");var Ur=Dr;qs.exports=
Ur});var pn=T(_=>{"use strict";p();Object.defineProperty(_,"__esModule",{value:!0});_.NoticeMessage=_.DataRowMessage=
...
a(on,"AuthenticationMD5Password");var Gr=on;_.AuthenticationMD5Password=Gr;var an=class an{constructor(e,t,n){
this.length=e,this.processID=t,this.secretKey=n,this.name="backendKeyData"}};a(an,"BackendKeyDataMes\
sage");var $r=an;_.BackendKeyDataMessage=$r;var un=class un{constructor(e,t,n,i){this.length=e,this.
...
ssage");var Zr=hn;_.NoticeMessage=Zr});var Ns=T(Lt=>{"use strict";p();Object.defineProperty(Lt,"__esModule",{value:!0});Lt.Writer=void 0;var yn=class yn{constructor(e=256){
...
headerPosition=0,this.buffer=d.allocUnsafe(this.size),t}};a(yn,"Writer");var dn=yn;Lt.Writer=dn});var js=T(kt=>{"use strict";p();Object.defineProperty(kt,"__esModule",{value:!0});kt.serialize=void 0;
var mn=Ns(),F=new mn.Writer,mc=a(r=>{F.addInt16(3).addInt16(0);for(let n of Object.keys(r))F.addCString(
n).addCString(r[n]);F.addCString("client_encoding").addCString("UTF8");let e=F.addCString("").flush(),
t=e.length+4;return new mn.Writer().addInt32(t).add(e).flush()},"startup"),wc=a(()=>{let r=d.allocUnsafe(
8);return r.writeInt32BE(8,0),r.writeInt32BE(80877103,4),r},"requestSsl"),gc=a(r=>F.addCString(r).flush(
...
n;s++)i.addInt32(t[s]);return F.flush(80)},"parse"),We=new mn.Writer,Ec=a(function(r,e){for(let t=0;t<
...
return F.addCString(e).addCString(t),F.addInt16(s),Ec(i,r.valueMapper),F.addInt16(s),F.add(We.flush()),
...
Tc=F.addCString("P").flush(68),Pc=F.addCString("S").flush(68),Rc=a(r=>r.name?wn(68,`${r.type}${r.name||
""}`):r.type==="P"?Tc:Pc,"describe"),Bc=a(r=>{let e=`${r.type}${r.name||""}`;return wn(67,e)},"close"),
Lc=a(r=>F.add(r).flush(100),"copyData"),Fc=a(r=>wn(102,r),"copyFail"),Ft=a(r=>d.from([r,0,0,0,4]),"c\
odeOnlyBuffer"),kc=Ft(72),Mc=Ft(83),Uc=Ft(88),Dc=Ft(99),Oc={startup:mc,password:gc,requestSsl:wc,sendSASLInitialResponseMessage:bc,
...
var qc=d.allocUnsafe(0),bn=class bn{constructor(e=0){this.offset=e,this.buffer=qc,this.encoding="utf\
...
offset+=e,t}};a(bn,"BufferReader");var gn=bn;Mt.BufferReader=gn});var Vs=T(Ut=>{"use strict";p();Object.defineProperty(Ut,"__esModule",{value:!0});Ut.Parser=void 0;var k=pn(),
Qc=Hs(),vn=1,Nc=4,Gs=vn+Nc,$s=d.allocUnsafe(0),Sn=class Sn{constructor(e){if(this.buffer=$s,this.bufferLength=
...
i+vn),u=vn+o;if(u+i<=n){let c=this.handlePacket(i+Gs,s,o,this.buffer);t(c),i+=u}else break}i===n?(this.
...
a(Sn,"Parser");var xn=Sn;Ut.Parser=xn});var En=T(Ee=>{"use strict";p();Object.defineProperty(Ee,"__esModule",{value:!0});Ee.DatabaseError=Ee.
serialize=Ee.parse=void 0;var Wc=pn();Object.defineProperty(Ee,"DatabaseError",{enumerable:!0,get:a(
function(){return Wc.DatabaseError},"get")});var jc=js();Object.defineProperty(Ee,"serialize",{enumerable:!0,
get:a(function(){return jc.serialize},"get")});var Hc=Vs();function Gc(r,e){let t=new Hc.Parser;return r.
on("data",n=>t.parse(n,e)),new Promise(n=>r.on("end",()=>n()))}a(Gc,"parse");Ee.parse=Gc});var Ks={};te(Ks,{connect:()=>$c});function $c({socket:r,servername:e}){return r.startTls(e),r}var zs=$(
()=>{"use strict";p();a($c,"connect")});var _n=T((sp,Js)=>{"use strict";p();var Ys=(ke(),O(bi)),Vc=ve().EventEmitter,{parse:Kc,serialize:Q}=En(),
Zs=Q.flush(),zc=Q.sync(),Yc=Q.end(),Cn=class Cn extends Vc{constructor(e){super(),e=e||{},this.stream=
...
this._send(Q.copyDone())}sendCopyFail(e){this._send(Q.copyFail(e))}};a(Cn,"Connection");var An=Cn;Js.
exports=An});var to=T((cp,eo)=>{"use strict";p();var Zc=ve().EventEmitter,up=(ut(),O(at)),Jc=ot(),In=ys(),Xc=_s(),
el=Ct(),tl=Bt(),Xs=Qs(),rl=st(),nl=_n(),Tn=class Tn extends Zc{constructor(e){super(),this.connectionParameters=
...
_Promise(t=>{this.connection.once("end",t)})}};a(Tn,"Client");var Dt=Tn;Dt.Query=Xs;eo.exports=Dt});var so=T((hp,io)=>{"use strict";p();var il=ve().EventEmitter,ro=a(function(){},"NOOP"),no=a((r,e)=>{
...
this.callback=e}};a(Ln,"PendingItem");var je=Ln;function sl(){throw new Error("Release called on cli\
...
return this._clients.length}};a(Fn,"Pool");var Rn=Fn;io.exports=Rn});var oo={};te(oo,{default:()=>al});var al,ao=$(()=>{"use strict";p();al={}});var uo=T((mp,ul)=>{ul.exports={name:"pg",version:"8.8.0",description:"PostgreSQL client - pure javas\
...
a178655"}});var fo=T((wp,lo)=>{"use strict";p();var co=ve().EventEmitter,cl=(ut(),O(at)),kn=ot(),He=lo.exports=function(r,e,t){
co.call(this),r=kn.normalizeQueryConfig(r,e,t),this.text=r.text,this.values=r.values,this.name=r.name,
this.callback=r.callback,this.state="new",this._arrayMode=r.rowMode==="array",this._emitRowEvents=!1,
this.on("newListener",function(n){n==="row"&&(this._emitRowEvents=!0)}.bind(this))};cl.inherits(He,co);
...
prepareValue);r.native.query(this.text,i,t)}else r.native.query(this.text,t)}});var mo=T((xp,yo)=>{"use strict";p();var fl=(ao(),O(oo)),hl=Ct(),vp=uo(),ho=ve().EventEmitter,pl=(ut(),O(at)),
...
r,e,t)};z.prototype.getTypeParser=function(r,e){return this._types.getTypeParser(r,e)}});var Mn=T((Ap,wo)=>{"use strict";p();wo.exports=mo()});var lt=T((_p,ft)=>{"use strict";p();var yl=to(),ml=st(),wl=_n(),gl=so(),{DatabaseError:bl}=En(),vl=a(
r=>{var e;return e=class extends gl{constructor(n){super(n,r)}},a(e,"BoundPool"),e},"poolFactory"),Un=a(
function(r){this.defaults=ml,this.Client=r,this.Query=this.Client.Query,this.Pool=vl(this.Client),this.
_pools=[],this.Connection=wl,this.types=rt(),this.DatabaseError=bl},"PG");typeof m.env.NODE_PG_FORCE_NATIVE<
"u"?ft.exports=new Un(Mn()):(ft.exports=new Un(yl),Object.defineProperty(ft.exports,"native",{configurable:!0,
enumerable:!1,get(){var r=null;try{r=new Un(Mn())}catch(e){if(e.code!=="MODULE_NOT_FOUND")throw e}return Object.
defineProperty(ft.exports,"native",{value:r}),r}}))});var El={};te(El,{Client:()=>Ge,DatabaseError:()=>le.DatabaseError,NeonDbError:()=>de,NeonQueryPromise:()=>xe,
Pool:()=>qt,SqlTemplate:()=>Me,UnsafeRawSql:()=>Ue,_bundleExt:()=>Sl,defaults:()=>le.defaults,escapeIdentifier:()=>le.escapeIdentifier,
escapeLiteral:()=>le.escapeLiteral,neon:()=>mr,neonConfig:()=>se,types:()=>le.types,warnIfBrowser:()=>ze});
module.exports=O(El);p();p();ke();Xt();p();var da=Object.defineProperty,ya=Object.defineProperties,ma=Object.getOwnPropertyDescriptors,xi=Object.
...
ba=a((r,e)=>{for(var t in e||(e={}))wa.call(e,t)&&Si(r,t,e[t]);if(xi)for(var t of xi(e))ga.call(e,t)&&
Si(r,t,e[t]);return r},"__spreadValues"),va=a((r,e)=>ya(r,ma(e)),"__spreadProps"),xa=1008e3,Ei=new Uint8Array(
new Uint16Array([258]).buffer)[0]===2,Sa=new TextDecoder,er=new TextEncoder,wt=er.encode("0123456789\
abcdef"),gt=er.encode("0123456789ABCDEF"),Ea=er.encode("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqr\
stuvwxyz0123456789+/");var Ai=Ea.slice();Ai[62]=45;Ai[63]=95;var Ke,bt;function Aa(r,{alphabet:e,scratchArr:t}={}){if(!Ke)if(Ke=
new Uint16Array(256),bt=new Uint16Array(256),Ei)for(let C=0;C<256;C++)Ke[C]=wt[C&15]<<8|wt[C>>>4],bt[C]=
gt[C&15]<<8|gt[C>>>4];else for(let C=0;C<256;C++)Ke[C]=wt[C&15]|wt[C>>>4]<<8,bt[C]=gt[C&15]|gt[C>>>4]<<
8;r.byteOffset%4!==0&&(r=new Uint8Array(r));let n=r.length,i=n>>>1,s=n>>>2,o=t||new Uint16Array(n),u=new Uint32Array(
r.buffer,r.byteOffset,s),c=new Uint32Array(o.buffer,o.byteOffset,i),l=e==="upper"?bt:Ke,f=0,y=0,g;if(Ei)
...
typeof r.toHex=="function"?r.toHex():Ca(r,e)}a(Ci,"toHex");p();var vt=class vt{constructor(e,t){this.strings=e;this.values=t}toParameterizedQuery(e={query:"",params:[]}){
let{strings:t,values:n}=this;for(let i=0,s=t.length;i<s;i++)if(e.query+=t[i],i<n.length){let o=n[i];
if(o instanceof Ue)e.query+=o.sql;else if(o instanceof xe)if(o.queryData instanceof vt)o.queryData.toParameterizedQuery(
...
tion"&&console.warn(`          
        ...
        *  parameter.                                              *
        *                                                          *
        ************************************************************`)}a(ze,"warnIfBrowser");p();var Ye="pkg:npm/%40neondatabase/serverless@1.0.2";ke();var cs=Ae(Ct()),ls=Ae(ot());var It=class It extends Error{constructor(t){super(t);E(this,"name","NeonDbError");E(this,"severity");
...
It,"NeonDbError");var de=It,os="transaction() expects an array of queries, or a function returning a\
...
Me?r.toParameterizedQuery():r;return{query:e,params:t.map(n=>Fu((0,ls.prepareValue)(n)))}}a(as,"prep\
...
P.forEach(W=>{if(!(W instanceof xe))throw new Error(os)});let w=P.map(W=>W.queryData),Z=P.map(W=>W.opts??
{});return Y(w,Z,I)};async function Y(P,I,w){let{fetchEndpoint:Z,fetchFunction:W}=se,J=Array.isArray(
P)?{queries:P.map(ee=>as(ee))}:as(P),X=n??{},oe=e??!1,ae=t??!1,B=i,j=s,fe=o;w!==void 0&&(w.fetchOptions!==
...
e","Neon-Array-Mode":"true","Neon-Client-Info":Ye},Ie=await ku(me);Ie&&(he.Authorization=`Bearer ${Ie}`),
...
ze();let we;try{we=await(W??fetch)($e,{method:"POST",body:JSON.stringify(J),headers:he,...X})}catch(ee){
let M=new de(`Error connecting to database: ${ee}`);throw M.sourceError=ee,M}if(we.ok){let ee=await we.
json();if(Array.isArray(P)){let M=ee.results;if(!Array.isArray(M))throw new de("Neon internal error:\
 unexpected result format");return M.map((G,ge)=>{let Qt=I[ge]??{},xo=Qt.arrayMode??oe,So=Qt.fullResults??
ae;return us(G,{arrayMode:xo,fullResults:So,types:Qt.types})})}else{let M=I??{},G=M.arrayMode??oe,ge=M.
fullResults??ae;return us(ee,{arrayMode:G,fullResults:ge,types:M.types})}}else{let{status:ee}=we;if(ee===
400){let M=await we.json(),G=new de(M.message);for(let ge of Lu)G[ge]=M[ge]??void 0;throw G}else{let M=await we.
...
e)}finally(e){return this.execute(this.queryData,this.opts).finally(e)}};a(wr,"NeonQueryPromise");var xe=wr;
...
ken: ${e.message}`)),t}}a(ku,"getAuthToken");p();var bo=Ae(lt());p();var go=Ae(lt());var Dn=class Dn extends go.Client{constructor(t){super(typeof t=="string"?{connectionString:t,fallback_application_name:Ye}:
...
bute pair entry");let G=M[0],ge=M.substring(2);return[G,ge]})),c=u.r,l=u.s,f=u.i;if(!c||!/^[!-+--~]+$/.
...
sign("HMAC",D,d.concat([g,d.from([0,0,0,1])]))),P=Y;for(var I=0;I<y-1;I++)Y=new Uint8Array(await n.sign(
"HMAC",D,Y)),P=d.from(P.map((M,G)=>P[G]^Y[G]));let w=P,Z=await n.importKey("raw",w,{name:"HMAC",hash:{
...
importKey("raw",w,{name:"HMAC",hash:{name:"SHA-256"}},!1,["sign"]),Ie=await n.sign("HMAC",he,A.encode(
"Server Key")),we=await n.importKey("raw",Ie,{name:"HMAC",hash:{name:"SHA-256"}},!1,["sign"]);var ee=d.
from(await n.sign("HMAC",we,A.encode(B)));i.message="SASLResponse",i.serverSignature=ee.toString("ba\
se64"),i.response=ae+",p="+$e,this.connection.sendSCRAMClientFinalMessage(this.saslSession.response)}};
a(Dn,"NeonClient");var Ge=Dn;ke();var vo=Ae(Bt());function xl(r,e){if(e)return{callback:e,result:void 0};let t,n,i=a(function(o,u){o?t(o):n(u)},"cb"),
...
A))}catch(o){i(o)}return s.result}};a(On,"NeonPool");var qt=On;ke();var le=Ae(lt()),Sl="js";
