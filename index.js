"use strict";var Po=Object.create;var Pe=Object.defineProperty;var Ro=Object.getOwnPropertyDescriptor;var Lo=Object.getOwnPropertyNames;var Bo=Object.getPrototypeOf,Fo=Object.prototype.hasOwnProperty;var ko=(r,e,t)=>e in r?Pe(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t;var a=(r,e)=>Pe(r,"name",{value:e,configurable:!0});var V=(r,e,t)=>()=>{if(t)throw t[0];try{return r&&(e=r(r=0)),e}catch(n){throw t=[n],n}};var T=(r,e)=>()=>{try{return e||r((e={exports:{}}).exports,e),e.exports}catch(t){throw e=0,t}},X=(r,e)=>{
for(var t in e)Pe(r,t,{get:e[t],enumerable:!0})},Qn=(r,e,t,n)=>{if(e&&typeof e=="object"||typeof e==
"function")for(let i of Lo(e))!Fo.call(r,i)&&i!==t&&Pe(r,i,{get:()=>e[i],enumerable:!(n=Ro(e,i))||n.
enumerable});return r};var be=(r,e,t)=>(t=r!=null?Po(Bo(r)):{},Qn(e||!r||!r.__esModule?Pe(t,"default",{value:r,enumerable:!0}):
t,r)),U=r=>Qn(Pe({},"__esModule",{value:!0}),r);var E=(r,e,t)=>ko(r,typeof e!="symbol"?e+"":e,t);var jn=T(lt=>{"use strict";h();lt.byteLength=Uo;lt.toByteArray=Do;lt.fromByteArray=No;var le=[],ee=[],
...
function Uo(r){var e=Wn(r),t=e[0],n=e[1];return(t+n)*3/4-n}a(Uo,"byteLength");function Oo(r,e,t){return(e+
t)*3/4-t}a(Oo,"_byteLength");function Do(r){var e,t=Wn(r),n=t[0],i=t[1],s=new Mo(Oo(r,n,i)),o=0,u=i>
...
4|ee[r.charCodeAt(c+2)]>>2,s[o++]=e>>8&255,s[o++]=e&255),s}a(Do,"toByteArray");function qo(r){return le[r>>
18&63]+le[r>>12&63]+le[r>>6&63]+le[r&63]}a(qo,"tripletToBase64");function Qo(r,e,t){for(var n,i=[],s=e;s<
t;s+=3)n=(r[s]<<16&16711680)+(r[s+1]<<8&65280)+(r[s+2]&255),i.push(qo(n));return i.join("")}a(Qo,"en\
codeChunk");function No(r){for(var e,t=r.length,n=t%3,i=[],s=16383,o=0,u=t-n;o<u;o+=s)i.push(Qo(r,o,
o+s>u?u:o+s));return n===1?(e=r[t-1],i.push(le[e>>2]+le[e<<4&63]+"==")):n===2&&(e=(r[t-2]<<8)+r[t-1],
i.push(le[e>>10]+le[e>>4&63]+le[e<<2&63]+"=")),i.join("")}a(No,"fromByteArray")});var Hn=T(Nt=>{h();Nt.read=function(r,e,t,n,i){var s,o,u=i*8-n-1,c=(1<<u)-1,l=c>>1,f=-7,y=t?i-1:0,g=t?
...
v,u/=256,i-=8);for(o=o<<i|u,l+=i;l>0;r[t+w]=o&255,w+=v,o/=256,l-=8);r[t+w-v]|=M*128}});var ai=T(Fe=>{"use strict";h();var Wt=jn(),Le=Hn(),$n=typeof Symbol=="function"&&typeof Symbol.for==
"function"?Symbol.for("nodejs.util.inspect.custom"):null;Fe.Buffer=p;Fe.SlowBuffer=Vo;Fe.INSPECT_MAX_BYTES=
50;var ft=2147483647;Fe.kMaxLength=ft;p.TYPED_ARRAY_SUPPORT=Wo();!p.TYPED_ARRAY_SUPPORT&&typeof console<
...
Uint8Array.prototype);Object.setPrototypeOf(p,Uint8Array);function Yn(r){if(typeof r!="number")throw new TypeError(
'"size" argument must be of type number');if(r<0)throw new RangeError('The value "'+r+'" is invalid \
for option "size"')}a(Yn,"assertSize");function jo(r,e,t){return Yn(r),r<=0?ye(r):e!==void 0?typeof t==
"string"?ye(r).fill(e,t):ye(r).fill(e):ye(r)}a(jo,"alloc");p.alloc=function(r,e,t){return jo(r,e,t)};
function Gt(r){return Yn(r),ye(r<0?0:Vt(r)|0)}a(Gt,"allocUnsafe");p.allocUnsafe=function(r){return Gt(
r)};p.allocUnsafeSlow=function(r){return Gt(r)};function Ho(r,e){if((typeof e!="string"||e==="")&&(e=
"utf8"),!p.isEncoding(e))throw new TypeError("Unknown encoding: "+e);let t=Zn(r,e)|0,n=ye(t),i=n.write(
r,e);return i!==t&&(n=n.slice(0,i)),n}a(Ho,"fromString");function jt(r){let e=r.length<0?0:Vt(r.length)|
0,t=ye(e);for(let n=0;n<e;n+=1)t[n]=r[n]&255;return t}a(jt,"fromArrayLike");function $o(r){if(fe(r,Uint8Array)){
...
an Array of Buffers');s+=o.length}return i},"concat");function Zn(r,e){if(p.isBuffer(r))return r.length;
...
if(i)return n?-1:$t(r).length;e=(""+e).toLowerCase(),i=!0}}a(Zn,"byteLength");p.byteLength=Zn;function zo(r,e,t){
...
tf8":case"utf-8":return Xn(this,e,t);case"ascii":return ra(this,e,t);case"latin1":case"binary":return na(
...
"swap64");p.prototype.toString=a(function(){let e=this.length;return e===0?"":arguments.length===0?Xn(
...
er "+e+">"},"inspect");$n&&(p.prototype[$n]=p.prototype.inspect);p.prototype.compare=a(function(e,t,n,i,s){
...
e,n)),p.isBuffer(e))return e.length===0?-1:Gn(r,e,t,n,i);if(typeof e=="number")return e=e&255,typeof Uint8Array.
...
if(f)return l}return-1}a(Gn,"arrayIndexOf");p.prototype.includes=a(function(e,t,n){return this.indexOf(
e,t,n)!==-1},"includes");p.prototype.indexOf=a(function(e,t,n){return Jn(this,e,t,n,!0)},"indexOf");
p.prototype.lastIndexOf=a(function(e,t,n){return Jn(this,e,t,n,!1)},"lastIndexOf");function Ko(r,e,t,n){
t=Number(t)||0;let i=r.length-t;n?(n=Number(n),n>i&&(n=i)):n=i;let s=e.length;n>s/2&&(n=s/2);let o;for(o=
0;o<n;++o){let u=parseInt(e.substr(o*2,2),16);if(Kt(u))return o;r[t+o]=u}return o}a(Ko,"hexWrite");function Yo(r,e,t,n){
return ht($t(e,r.length-t),r,t,n)}a(Yo,"utf8Write");function Zo(r,e,t,n){return ht(ca(e),r,t,n)}a(Zo,
"asciiWrite");function Jo(r,e,t,n){return ht(oi(e),r,t,n)}a(Jo,"base64Write");function Xo(r,e,t,n){return ht(
...
a(ea,"base64Slice");function Xn(r,e,t){t=Math.min(r.length,t);let n=[],i=e;for(;i<t;){let s=r[i],o=null,
...
n.push(o),i+=u}return ta(n)}a(Xn,"utf8Slice");var Vn=4096;function ta(r){let e=r.length;if(e<=Vn)return String.
fromCharCode.apply(String,r);let t="",n=0;for(;n<e;)t+=String.fromCharCode.apply(String,r.slice(n,n+=
Vn));return t}a(ta,"decodeCodePointsArray");function ra(r,e,t){let n="";t=Math.min(r.length,t);for(let i=e;i<
...
return r[t+3]=o,o=o>>8,r[t+2]=o,o=o>>8,r[t+1]=o,o=o>>8,r[t]=o,t+8}a(ti,"wrtBigUInt64BE");p.prototype.
writeBigUInt64LE=xe(a(function(e,t=0){return ei(this,e,t,BigInt(0),BigInt("0xffffffffffffffff"))},"w\
riteBigUInt64LE"));p.prototype.writeBigUInt64BE=xe(a(function(e,t=0){return ti(this,e,t,BigInt(0),BigInt(
...
t+4},"writeInt32BE");p.prototype.writeBigInt64LE=xe(a(function(e,t=0){return ei(this,e,t,-BigInt("0x\
...
"writeFloat");p.prototype.writeFloatLE=a(function(e,t,n){return ni(this,e,t,!0,n)},"writeFloatLE");p.
...
8),t+8}a(ii,"writeDouble");p.prototype.writeDoubleLE=a(function(e,t,n){return ii(this,e,t,!0,n)},"wr\
iteDoubleLE");p.prototype.writeDoubleBE=a(function(e,t,n){return ii(this,e,t,!1,n)},"writeDoubleBE");
...
_${r.slice(t-3,t)}${e}`;return`${r.slice(0,t)}${e}`}a(zn,"addNumericalSeparator");function oa(r,e,t){
Be(e,"offset"),(r[e]===void 0||r[e+t]===void 0)&&Ge(e,r.length-(t+1))}a(oa,"checkBounds");function si(r,e,t,n,i,s){
...
nd <= ${t}${o}`,new Re.ERR_OUT_OF_RANGE("value",u,r)}oa(n,i,s)}a(si,"checkIntBI");function Be(r,e){if(typeof r!=
...
new Re.ERR_OUT_OF_RANGE(t||"offset",`>= ${t?1:0} and <= ${e}`,r)}a(Ge,"boundsError");var aa=/[^+/0-9A-Za-z-_]/g;
...
o),n=t>>8,i=t%256,s.push(i),s.push(n);return s}a(la,"utf16leToBytes");function oi(r){return Wt.toByteArray(
ua(r))}a(oi,"base64ToBytes");function ht(r,e,t,n){let i;for(i=0;i<n&&!(i+t>=e.length||i>=r.length);++i)
...
r}a(Kt,"numberIsNaN");var fa=(function(){let r="0123456789abcdef",e=new Array(256);for(let t=0;t<16;++t){
let n=t*16;for(let i=0;i<16;++i)e[n+i]=r[t]+r[i]}return e})();function xe(r){return typeof BigInt>"u"?
ha:r}a(xe,"defineBigIntMethod");function ha(){throw new Error("BigInt not supported")}a(ha,"BufferBi\
...
m.nextTick(()=>{})}catch{let e=Promise.resolve();m.nextTick=e.then.bind(e)}});var Se=T((Af,er)=>{"use strict";h();var Ue=typeof Reflect=="object"?Reflect:null,mi=Ue&&typeof Ue.apply==
...
init.call(this)}a(P,"EventEmitter");er.exports=P;er.exports.once=Ba;P.EventEmitter=P;P.prototype._events=
...
rict";h();Ti=be(Se(),1);a(ka,"isIP");_i=/^[^.]+\./,A=class A extends Ti.EventEmitter{constructor(){super(
...
disableWarningInBrowsers:!1}),E(A,"opts",{});he=A});var rr=T(Pi=>{"use strict";h();Pi.parse=function(r,e){return new tr(r,e).parse()};var vt=class vt{constructor(e,t){
...
not balanced");return this.entries}};a(vt,"ArrayParser");var tr=vt;function Ma(r){return r}a(Ma,"ide\
ntity")});var nr=T((Bf,Ri)=>{h();var Ua=rr();Ri.exports={create:a(function(r,e){return{parse:a(function(){return Ua.
parse(r,e)},"parse")}},"create")}});var Fi=T((Mf,Bi)=>{"use strict";h();var Oa=/(\d{1,})-(\d{2})-(\d{2}) (\d{2}):(\d{2}):(\d{2})(\.\d{1,})?.*?( BC)?$/,
...
10),c=parseInt(t[5],10),l=parseInt(t[6],10),f=t[7];f=f?1e3*parseFloat(f):0;var y,g=Wa(e);return g!=null?
(y=new Date(Date.UTC(i,s,o,u,c,l,f)),ir(i)&&y.setUTCFullYear(i),g!==0&&y.setTime(y.getTime()-g)):(y=
new Date(i,s,o,u,c,l,f),ir(i)&&y.setFullYear(i)),y},"parseDate");function Na(r){var e=Da.exec(r);if(e){
...
1)}a(Li,"bcYearToNegativeYear");function ir(r){return r>=0&&r<100}a(ir,"is0To99")});var Mi=T((Df,ki)=>{h();ki.exports=Ha;var ja=Object.prototype.hasOwnProperty;function Ha(r){for(var e=1;e<
arguments.length;e++){var t=arguments[e];for(var n in t)ja.call(t,n)&&(r[n]=t[n])}return r}a(Ha,"ext\
end")});var Di=T((Nf,Oi)=>{"use strict";h();var $a=Mi();Oi.exports=Oe;function Oe(r){if(!(this instanceof Oe))
return new Oe(r);$a(this,nu(r))}a(Oe,"PostgresInterval");var Ga=["seconds","minutes","hours","days",
"months","years"];Oe.prototype.toPostgres=function(){var r=Ga.filter(this.hasOwnProperty,this);return this.
...
S"},za=["years","months","days"],Ka=["hours","minutes","seconds"];Oe.prototype.toISOString=Oe.prototype.
toISO=function(){var r=za.map(t,this).join(""),e=Ka.map(t,this).join("");return"P"+r+"T"+e;function t(n){
var i=this[n]||0;return n==="seconds"&&this.milliseconds&&(i=(i+this.milliseconds/1e3).toFixed(6).replace(
/0+$/,"")),i+Va[n]}};var sr="([+-]?\\d+)",Ya=sr+"\\s+years?",Za=sr+"\\s+mons?",Ja=sr+"\\s+days?",Xa="\
...
!o)||(t&&~tu.indexOf(i)&&(o*=-1),n[i]=o),n},{})}a(nu,"parse")});var Ni=T((Hf,Qi)=>{"use strict";h();var qi=d.from||d;Qi.exports=a(function(e){if(/^\\x/.test(e))return qi(
...
y")},"parseBytea")});var zi=T((Vf,Vi)=>{h();var Ke=rr(),Ye=nr(),St=Fi(),ji=Di(),Hi=Ni();function Et(r){return a(function(t){
...
Ke.parse(r,$i):null}a(iu,"parseBoolArray");function su(r){return parseInt(r,10)}a(su,"parseBaseTenIn\
t");function or(r){return r?Ke.parse(r,Et(su)):null}a(or,"parseIntegerArray");function ou(r){return r?
Ke.parse(r,Et(function(e){return Gi(e).trim()})):null}a(ou,"parseBigIntegerArray");var au=a(function(r){
...
function(t){return t!==null&&(t=St(t)),t});return e.parse()},"parseDateArray"),uu=a(function(r){if(!r)
return null;var e=Ye.create(r,function(t){return t!==null&&(t=ji(t)),t});return e.parse()},"parseInt\
ervalArray"),cu=a(function(r){return r?Ke.parse(r,Et(Hi)):null},"parseByteAArray"),cr=a(function(r){
...
r[i])}var s=lr(e);return s.radius=parseFloat(t),s},"parseCircle"),fu=a(function(r){r(20,Gi),r(21,cr),
r(23,cr),r(26,cr),r(700,parseFloat),r(701,parseFloat),r(16,$i),r(1082,St),r(1114,St),r(1184,St),r(600,
lr),r(651,te),r(718,lu),r(1e3,iu),r(1001,cu),r(1005,or),r(1007,or),r(1028,or),r(1016,ou),r(1017,au),
r(1021,ar),r(1022,ar),r(1231,ar),r(1014,te),r(1015,te),r(1008,te),r(1009,te),r(1040,te),r(1041,te),r(
1115,ur),r(1182,ur),r(1185,ur),r(1186,ji),r(1187,uu),r(17,Hi),r(114,JSON.parse.bind(JSON)),r(3802,JSON.
parse.bind(JSON)),r(199,Wi),r(3807,Wi),r(3907,te),r(2951,te),r(791,te),r(1183,te),r(1270,te)},"init");
Vi.exports={init:fu}});var Yi=T((Yf,Ki)=>{"use strict";h();var K=1e6;function hu(r){var e=r.readInt32BE(0),t=r.readUInt32BE(
...
""+o%K,n+u+i}a(hu,"readInt8");Ki.exports=hu});var ts=T((Xf,es)=>{h();var pu=Yi(),B=a(function(r,e,t,n,i){t=t||0,n=n||!1,i=i||function(w,v,M){return w*
...
r[y]),8);var g=(e+t)%8;return g>0&&(l=i(l,o(r[f])>>8-g,g)),l},"parseBits"),Xi=a(function(r,e,t){var n=Math.
...
r(1008,Ze),r(1009,Ze),r(25,wu)},"init");es.exports={init:xu}});var ns=T((rh,rs)=>{h();rs.exports={BOOL:16,BYTEA:17,CHAR:18,INT8:20,INT2:21,INT4:23,REGPROC:24,TEXT:25,
...
REGROLE:4096}});var et=T(Xe=>{h();var vu=zi(),Su=ts(),Eu=nr(),Au=ns();Xe.getTypeParser=Cu;Xe.setTypeParser=_u;Xe.arrayParser=
Eu;Xe.builtins=Au;var Je={text:{},binary:{}};function is(r){return String(r)}a(is,"noParse");function Cu(r,e){
return e=e||"text",Je[e]&&Je[e][r]||is}a(Cu,"getTypeParser");function _u(r,e,t){typeof e=="function"&&
(t=e,e="text"),Je[e][r]=t}a(_u,"setTypeParser");vu.init(function(r,e){Je.text[r]=e});Su.init(function(r,e){
Je.binary[r]=e})});var Ct=T((ah,ss)=>{"use strict";h();var Tu=et();function At(r){this._types=r||Tu,this.text={},this.binary=
...
for(let R=0;R<64;R++){let $=g(H,6)^g(H,11)^g(H,25),Ae=H&oe^~H&ae,ue=ge+$+Ae+y[R]+w[R]|0,Ie=g(I,2)^g(
...
est");return r===void 0?{add:q,digest:de}:(q(r),de())}var os=V(()=>{"use strict";h();a(tt,"sha256")});var k,rt,as=V(()=>{"use strict";h();k=class k{constructor(){E(this,"_dataLength",0);E(this,"_bufferL\
...
abcdef"),E(k,"hexOut",[]),E(k,"onePassHasher",new k);rt=k});var fr={};X(fr,{createHash:()=>Pu,createHmac:()=>Ru,randomBytes:()=>Iu});function Iu(r){return crypto.
...
"digest")}},"update")}}var hr=V(()=>{"use strict";h();os();as();a(Iu,"randomBytes");a(Pu,"createHash");
a(Ru,"createHmac")});var nt=T((xh,pr)=>{"use strict";h();pr.exports={host:"localhost",user:m.platform==="win32"?m.env.USERNAME:
...
keepalives:1,keepalives_idle:0};var De=et(),Lu=De.getTypeParser(20,"text"),Bu=De.getTypeParser(1016,
"text");pr.exports.__defineSetter__("parseInt8",function(r){De.setTypeParser(20,"text",r?De.getTypeParser(
23,"text"):Lu),De.setTypeParser(1016,"text",r?De.getTypeParser(1007,"text"):Bu)})});var it=T((Sh,cs)=>{"use strict";h();var Fu=(hr(),U(fr)),ku=nt();function Mu(r){var e=r.replace(/\\/g,
...
r[t]instanceof d?e+="\\\\x"+r[t].toString("hex"):e+=Mu(_t(r[t]));return e=e+"}",e}a(us,"arrayString");
...
r query');return e.push(r),_t(r.toPostgres(_t),e)}return JSON.stringify(r)}a(Uu,"prepareObject");function W(r,e){
...
t),r}a(qu,"normalizeQueryConfig");var dr=a(function(r){return Fu.createHash("md5").update(r,"utf-8").
...
normalizeQueryConfig:qu,postgresMd5PasswordHash:Qu,md5:dr}});var st={};X(st,{default:()=>ju});var ju,ot=V(()=>{"use strict";h();ju={}});var bs=T((Uh,ws)=>{"use strict";h();var mr=(hr(),U(fr));function Hu(r){if(r.indexOf("SCRAM-SHA-256")===
...
art with client nonce");var i=d.from(n.salt,"base64"),s=Zu(e,i,n.iteration),o=qe(s,"Client Key"),u=Yu(
o),c="n=*,r="+r.clientNonce,l="r="+n.nonce+",s="+n.salt+",i="+n.iteration,f="c=biws,r="+n.nonce,y=c+
","+l+","+f,g=qe(u,y),w=gs(o,g),v=w.toString("base64"),M=qe(s,"Server Key"),q=qe(M,y);r.message="SAS\
...
e<=126)}a(Vu,"isPrintableChars");function ys(r){return/^(?:[a-zA-Z0-9+/]{4})*(?:[a-zA-Z0-9+/]{2}==|[a-zA-Z0-9+/]{3}=)?$/.
...
Pairs");function zu(r){let e=ms(r),t=e.get("r");if(t){if(!Vu(t))throw new Error("SASL: SCRAM-SERVER-\
...
function Ku(r){let t=ms(r).get("v");if(t){if(!ys(t))throw new Error("SASL: SCRAM-SERVER-FINAL-MESSAG\
E: server signature must be base64")}else throw new Error("SASL: SCRAM-SERVER-FINAL-MESSAGE: server \
signature is missing");return{serverSignature:t}}a(Ku,"parseServerFinalMessage");function gs(r,e){if(!d.
...
a(gs,"xorBuffers");function Yu(r){return mr.createHash("sha256").update(r).digest()}a(Yu,"sha256");function qe(r,e){
return mr.createHmac("sha256",r).update(e).digest()}a(qe,"hmacSha256");function Zu(r,e,t){for(var n=qe(
r,d.concat([e,d.from([0,0,0,1])])),i=n,s=0;s<t-1;s++)n=qe(r,n),i=gs(i,n);return i}a(Zu,"Hi");ws.exports=
{startSession:Hu,continueSession:$u,finalizeSession:Gu}});var gr={};X(gr,{join:()=>Ju});function Ju(...r){return r.join("/")}var wr=V(()=>{"use strict";h();a(
Ju,"join")});var br={};X(br,{stat:()=>Xu});function Xu(r,e){e(new Error("No filesystem"))}var xr=V(()=>{"use stri\
ct";h();a(Xu,"stat")});var vr={};X(vr,{default:()=>ec});var ec,Sr=V(()=>{"use strict";h();ec={}});var xs={};X(xs,{StringDecoder:()=>Er});var Ar,Er,vs=V(()=>{"use strict";h();Ar=class Ar{constructor(e){
E(this,"td");this.td=new TextDecoder(e)}write(e){return this.td.decode(e,{stream:!0})}end(e){return this.
td.decode(e)}};a(Ar,"StringDecoder");Er=Ar});var Cs=T((Gh,As)=>{"use strict";h();var{Transform:tc}=(Sr(),U(vr)),{StringDecoder:rc}=(vs(),U(xs)),Ee=Symbol(
"last"),Tt=Symbol("decoder");function nc(r,e,t){let n;if(this.overflow){if(n=this[Tt].write(r).split(
...
"maximum buffer reached"));return}t()}a(nc,"transform");function ic(r){if(this[Ee]+=this[Tt].end(),this[Ee])
try{Es(this,this.mapper(this[Ee]))}catch(e){return r(e)}r()}a(ic,"flush");function Es(r,e){e!==void 0&&
r.push(e)}a(Es,"push");function Ss(r){return r}a(Ss,"noop");function sc(r,e,t){switch(r=r||/\r?\n/,e=
...
"object"&&(t=e,e=Ss)}t=Object.assign({},t),t.autoDestroy=!0,t.transform=nc,t.flush=ic,t.readableObjectMode=
!0;let n=new tc(t);return n[Ee]="",n[Tt]=new rc("utf8"),n.matcher=r,n.mapper=e,n.maxLength=t.maxLength,
n.skipOverflow=t.skipOverflow||!1,n.overflow=!1,n._destroy=function(i,s){this._writableState.errorEmitted=
!1,s(i)},n}a(sc,"split");As.exports=sc});var Is=T((Kh,me)=>{"use strict";h();var _s=(wr(),U(gr)),oc=(Sr(),U(vr)).Stream,ac=Cs(),Ts=(ot(),U(st)),
uc=5432,It=m.platform==="win32",at=m.stderr,cc=56,lc=7,fc=61440,hc=32768;function pc(r){return(r&fc)==
hc}a(pc,"isRegFile");var Qe=["host","port","database","user","password"],Cr=Qe.length,dc=Qe[Cr-1];function _r(){
var r=at instanceof oc&&at.writable===!0;if(r){var e=Array.prototype.slice.call(arguments).concat(`
...
r,e};me.exports.getFileName=function(r){var e=r||m.env,t=e.PGPASSFILE||(It?_s.join(e.APPDATA||"./","\
postgresql","pgpass.conf"):_s.join(e.HOME||"./",".pgpass"));return t};me.exports.usePgPass=function(r,e){
return Object.prototype.hasOwnProperty.call(m.env,"PGPASSWORD")?!1:It?!0:(e=e||"<unkn>",pc(r.mode)?r.
mode&(cc|lc)?(_r('WARNING: password file "%s" has group or world access; permissions should be u=rw \
(0600) or less',e),!1):!0:(_r('WARNING: password file "%s" is not a plain file',e),!1))};var yc=me.exports.
match=function(r,e){return Qe.slice(0,-1).reduce(function(t,n,i){return i==1&&Number(r[n]||uc)===Number(
...
void 0)},"onErr");e.on("error",u),i.on("data",s).on("end",o).on("error",u)};var mc=me.exports.parseLine=
...
length===Cr?o:null,o},gc=me.exports.isValidEntry=function(r){for(var e={0:function(o){return o.length>
...
0}},t=0;t<Qe.length;t+=1){var n=e[t],i=r[Qe[t]]||"",s=n(i);if(!s)return!1}return!0}});var Rs=T((Xh,Tr)=>{"use strict";h();var Jh=(wr(),U(gr)),Ps=(xr(),U(br)),Pt=Is();Tr.exports=function(r,e){
var t=Pt.getFileName();Ps.stat(t,function(n,i){if(n||!Pt.usePgPass(i,t))return e(void 0);var s=Ps.createReadStream(
t);Pt.getPassword(r,s,e)})};Tr.exports.warnTo=Pt.warnTo});var Ls={};X(Ls,{default:()=>wc});var wc,Bs=V(()=>{"use strict";h();wc={}});var Fs={};X(Fs,{parse:()=>bc});function bc(r,e=!1){let{protocol:t}=new URL(r),n="http:"+r.substring(
...
pathname:l,search:f,query:v,hash:g}}var ks=V(()=>{"use strict";h();a(bc,"parse")});var Rr=T((ip,Ms)=>{"use strict";h();var xc=(ks(),U(Fs)),Ir=(xr(),U(br));function Pr(r){if(r.charAt(0)===
...
!1;break}}return t}a(Pr,"parse");Ms.exports=Pr;Pr.parse=Pr});var Rt=T((ap,Ds)=>{"use strict";h();var vc=(Bs(),U(Ls)),Os=nt(),Us=Rr().parse,j=a(function(r,e,t){return t===
void 0?t=m.env["PG"+r.toUpperCase()]:t===!1||(t=m.env[t]),e[r]||t||Os[r]},"val"),Sc=a(function(){switch(m.
...
vc.lookup(this.host,function(i,s){return i?e(i,null):(t.push("hostaddr="+Ne(s)),e(null,t.join(" ")))})}};
a(Br,"ConnectionParameters");var Lr=Br;Ds.exports=Lr});var Ns=T((lp,Qs)=>{"use strict";h();var Ec=et(),qs=/^([A-Za-z]+)(?: (\d+))?(?: (\d+))?/,kr=class kr{constructor(e,t){
...
format||"text")}}};a(kr,"Result");var Fr=kr;Qs.exports=Fr});var $s=T((pp,Hs)=>{"use strict";h();var{EventEmitter:Ac}=Se(),Ws=Ns(),js=it(),Ur=class Ur extends Ac{constructor(e,t,n){
...
Mr});var hn=T(_=>{"use strict";h();Object.defineProperty(_,"__esModule",{value:!0});_.NoticeMessage=_.DataRowMessage=
...
ssage");var Yr=fn;_.NoticeMessage=Yr});var Gs=T(Lt=>{"use strict";h();Object.defineProperty(Lt,"__esModule",{value:!0});Lt.Writer=void 0;var dn=class dn{constructor(e=256){
...
a(dn,"Writer");var pn=dn;Lt.Writer=pn});var zs=T(Ft=>{"use strict";h();Object.defineProperty(Ft,"__esModule",{value:!0});Ft.serialize=void 0;
var yn=Gs(),L=new yn.Writer,Cc=a(r=>{L.addInt16(3).addInt16(0);for(let n of Object.keys(r))L.addCString(
n).addCString(r[n]);L.addCString("client_encoding").addCString("UTF8");let e=L.addCString("").flush(),
t=e.length+4;return new yn.Writer().addInt32(t).add(e).flush()},"startup"),_c=a(()=>{let r=d.allocUnsafe(
...
FinalMessage"),Rc=a(r=>L.addCString(r).flush(81),"query"),Vs=[],Lc=a(r=>{let e=r.name||"";e.length>63&&
...
n;s++)i.addInt32(t[s]);return L.flush(80)},"parse"),We=new yn.Writer,Bc=a(function(r,e){for(let t=0;t<
r.length;t++){let n=e?e(r[t],t):r[t];n==null?(L.addInt16(0),We.addInt32(-1)):n instanceof d?(L.addInt16(
1),We.addInt32(n.length),We.add(n)):(L.addInt16(0),We.addInt32PrefixedString(n))}},"writeValues"),Fc=a(
(r={})=>{let e=r.portal||"",t=r.statement||"",n=r.binary||!1,i=r.values||Vs,s=i.length;L.addCString(
e).addCString(t),L.addInt16(s);try{Bc(i,r.valueMapper)}catch(o){throw L.clear(),We.clear(),o}return L.
...
flush(68),qc=a(r=>r.name?mn(68,`${r.type}${r.name||""}`):r.type==="P"?Oc:Dc,"describe"),Qc=a(r=>{let e=`${r.
type}${r.name||""}`;return mn(67,e)},"close"),Nc=a(r=>L.add(r).flush(100),"copyData"),Wc=a(r=>mn(102,
r),"copyFail"),Bt=a(r=>d.from([r,0,0,0,4]),"codeOnlyBuffer"),jc=Bt(72),Hc=Bt(83),$c=Bt(88),Gc=Bt(99),
...
c"),end:a(()=>$c,"end"),copyData:Nc,copyDone:a(()=>Gc,"copyDone"),copyFail:Wc,cancel:Uc};Ft.serialize=
Vc});var Ks=T(kt=>{"use strict";h();Object.defineProperty(kt,"__esModule",{value:!0});kt.BufferReader=void 0;
...
offset+=e,t}};a(wn,"BufferReader");var gn=wn;kt.BufferReader=gn});var Xs=T(Mt=>{"use strict";h();Object.defineProperty(Mt,"__esModule",{value:!0});Mt.Parser=void 0;var F=hn(),
zc=Ks(),xn=1,Kc=4,Ys=xn+Kc,Z=-1,bn=d.allocUnsafe(0),Sn=class Sn{constructor(e){if(this.buffer=bn,this.
...
o=tl(s);break;case 82:o=ul(s,n);break;case 83:o=ol(s);break;case 75:o=al(s);break;case 69:o=Zs(s,"er\
ror");break;case 78:o=Zs(s,"notice");break;case 84:o=rl(s);break;case 116:o=il(s);break;case 71:o=Xc(
...
var vn=Sn;Mt.Parser=vn;var Yc=a(r=>{let e=r.string(1);return new F.ReadyForQueryMessage(Z,e)},"parse\
...
Data"),Xc=a(r=>Js(r,"copyInResponse"),"parseCopyInMessage"),el=a(r=>Js(r,"copyOutResponse"),"parseCo\
...
t.n,s.file=t.F,s.line=t.L,s.routine=t.R,s},"parseErrorMessage")});var En=T(Te=>{"use strict";h();Object.defineProperty(Te,"__esModule",{value:!0});Te.DatabaseError=Te.
serialize=void 0;Te.parse=hl;var cl=hn();Object.defineProperty(Te,"DatabaseError",{enumerable:!0,get:a(
function(){return cl.DatabaseError},"get")});var ll=zs();Object.defineProperty(Te,"serialize",{enumerable:!0,
get:a(function(){return ll.serialize},"get")});var fl=Xs();function hl(r,e){let t=new fl.Parser;return r.
on("data",n=>t.parse(n,e)),new Promise(n=>r.on("end",()=>n()))}a(hl,"parse")});var eo={};X(eo,{connect:()=>pl});function pl({socket:r,servername:e}){return r.startTls(e),r}var to=V(
()=>{"use strict";h();a(pl,"connect")});var _n=T((Up,io)=>{"use strict";h();var ro=(ze(),U(Ii)),dl=Se().EventEmitter,{parse:yl,serialize:D}=En(),
no=D.flush(),ml=D.sync(),gl=D.end(),Cn=class Cn extends dl{constructor(e){super(),e=e||{},this.stream=
...
stream.writable&&this.stream.write(no)}sync(){this._ending=!0,this._send(no),this._send(ml)}ref(){this.
...
exports=An});var ao=T((Qp,oo)=>{"use strict";h();var wl=Se().EventEmitter,qp=(ot(),U(st)),bl=it(),Tn=bs(),xl=Rs(),
vl=Ct(),Sl=Rt(),so=$s(),El=nt(),Al=_n(),In=class In extends wl{constructor(e){super(),this.connectionParameters=
...
_Promise(t=>{this.connection.once("end",t)})}};a(In,"Client");var Ut=In;Ut.Query=so;oo.exports=Ut});var lo=T((jp,co)=>{"use strict";h();var Cl=Se().EventEmitter,Pn=a(function(){},"NOOP"),uo=a((r,e)=>{
let t=r.findIndex(e);return t===-1?void 0:r.splice(t,1)[0]},"removeWhere"),Bn=class Bn{constructor(e,t,n){
this.client=e,this.idleListener=t,this.timeoutId=n}};a(Bn,"IdleItem");var Rn=Bn,Fn=class Fn{constructor(e){
this.callback=e}};a(Fn,"PendingItem");var je=Fn;function _l(){throw new Error("Release called on cli\
ent which has already been released to the pool.")}a(_l,"throwOnDoubleRelease");function Ot(r,e){if(e)
...
dleListener")}a(Tl,"makeIdleListener");var kn=class kn extends Cl{constructor(e,t){super(),this.options=
...
(this._expired.has(t)?1:0),0)}get totalCount(){return this._clients.length}};a(kn,"Pool");var Ln=kn;
co.exports=Ln});var fo={};X(fo,{default:()=>Il});var Il,ho=V(()=>{"use strict";h();Il={}});var po=T((Vp,Pl)=>{Pl.exports={name:"pg",version:"8.8.0",description:"PostgreSQL client - pure javas\
...
a178655"}});var go=T((zp,mo)=>{"use strict";h();var yo=Se().EventEmitter,Rl=(ot(),U(st)),Mn=it(),He=mo.exports=function(r,e,t){
...
this.on("newListener",function(n){n==="row"&&(this._emitRowEvents=!0)}.bind(this))};Rl.inherits(He,yo);
...
prepareValue);r.native.query(this.text,i,t)}else r.native.query(this.text,t)}});var vo=T((Jp,xo)=>{"use strict";h();var Bl=(ho(),U(fo)),Fl=Ct(),Zp=po(),wo=Se().EventEmitter,kl=(ot(),U(st)),
Ml=Rt(),bo=go(),Y=xo.exports=function(r){wo.call(this),r=r||{},this._Promise=r.Promise||b.Promise,this.
...
bo;kl.inherits(Y,wo);Y.prototype._errorAllQueries=function(r){let e=a(t=>{m.nextTick(()=>{t.native=this.
...
r,e,t)};Y.prototype.getTypeParser=function(r,e){return this._types.getTypeParser(r,e)}});var Un=T((td,So)=>{"use strict";h();So.exports=vo()});var ut=T((nd,ct)=>{"use strict";h();var Ul=ao(),Ol=nt(),Dl=_n(),ql=lo(),{DatabaseError:Ql}=En(),Nl=a(
r=>{var e;return e=class extends ql{constructor(n){super(n,r)}},a(e,"BoundPool"),e},"poolFactory"),On=a(
function(r){this.defaults=Ol,this.Client=r,this.Query=this.Client.Query,this.Pool=Nl(this.Client),this.
_pools=[],this.Connection=Dl,this.types=et(),this.DatabaseError=Ql},"PG");typeof m.env.NODE_PG_FORCE_NATIVE<
"u"?ct.exports=new On(Un()):(ct.exports=new On(Ul),Object.defineProperty(ct.exports,"native",{configurable:!0,
enumerable:!1,get(){var r=null;try{r=new On(Un())}catch(e){if(e.code!=="MODULE_NOT_FOUND")throw e}return Object.
defineProperty(ct.exports,"native",{value:r}),r}}))});var Gl={};X(Gl,{Client:()=>$e,DatabaseError:()=>pe.DatabaseError,NeonDbError:()=>Q,Pool:()=>Dt,SqlTemplate:()=>ke,
UnsafeRawSql:()=>Me,_bundleExt:()=>$l,defaults:()=>pe.defaults,errorFields:()=>Xt,escapeIdentifier:()=>pe.escapeIdentifier,
escapeLiteral:()=>pe.escapeLiteral,neon:()=>yr,neonConfig:()=>he,parseIntoClientConfig:()=>To,types:()=>pe.types});
module.exports=U(Gl);h();h();h();var pa=Object.defineProperty,da=Object.defineProperties,ya=Object.getOwnPropertyDescriptors,ui=Object.
getOwnPropertySymbols,ma=Object.prototype.hasOwnProperty,ga=Object.prototype.propertyIsEnumerable,ci=a(
(r,e,t)=>e in r?pa(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t,"__defNormalProp"),
wa=a((r,e)=>{for(var t in e||(e={}))ma.call(e,t)&&ci(r,t,e[t]);if(ui)for(var t of ui(e))ga.call(e,t)&&
ci(r,t,e[t]);return r},"__spreadValues"),ba=a((r,e)=>da(r,ya(e)),"__spreadProps"),xa=1008e3,li=new Uint8Array(
...
stuvwxyz0123456789+/");var fi=Sa.slice();fi[62]=45;fi[63]=95;var Ve,yt;function Ea(r,{alphabet:e,scratchArr:t}={}){if(!Ve)if(Ve=
new Uint16Array(256),yt=new Uint16Array(256),li)for(let v=0;v<256;v++)Ve[v]=pt[v&15]<<8|pt[v>>>4],yt[v]=
...
r.buffer,r.byteOffset,s),c=new Uint32Array(o.buffer,o.byteOffset,i),l=e==="upper"?yt:Ve,f=0,y=0,g;if(li)
...
i;t+=Ea(r.subarray(l,f),u)}return t}a(Aa,"_toHexChunked");function hi(r,e={}){return e.alphabet!=="u\
pper"&&typeof r.toHex=="function"?r.toHex():Aa(r,e)}a(hi,"toHex");h();h();var Zt=class Zt{constructor(e,t,n){E(this,"execute",e);E(this,"queryData",t);E(this,"opts",n)}then(e,t){
...
QueryPromise");var ve=Zt;var mt=class mt{constructor(e,t){E(this,"strings",e);E(this,"values",t)}toParameterizedQuery(e={query:"",
...
d||ArrayBuffer.isView(o))&&(e.query+="::bytea")}}return e}};a(mt,"SqlTemplate");var ke=mt,Jt=class Jt{constructor(e){
E(this,"sql",e)}};a(Jt,"UnsafeRawSql");var Me=Jt;h();function gt(){typeof window<"u"&&typeof document<"u"&&typeof console<"u"&&typeof console.warn=="func\
tion"&&console.warn(`          
        ************************************************************
        *                                                          *
...
a(yi,"resolveConnectionParams");ze();var ps=be(Ct()),ds=be(it());var ls="transaction() expects an array of queries, or a function returning an array of queries";function Nu(r){
return r instanceof d?"\\x"+hi(r):r}a(Nu,"encodeBuffersAsBytea");function fs(r){let{query:e,params:t}=r instanceof
ke?r.toParameterizedQuery():r;return{query:e,params:t.map(n=>Nu((0,ds.prepareValue)(n)))}}a(fs,"prep\
...
LECT $1", [value], options).');return new ve(y,new ke(g,w))}a(f,"templateFn"),f.query=(g,w,v)=>new ve(
y,{query:g,params:w??[]},v),f.unsafe=g=>new Me(g),f.transaction=async(g,w)=>{if(typeof g=="function"&&
...
void 0&&(ae=w.authToken);let ge=di(e,v??{},Array.isArray(w)||!w?{}:w),{resolvedConnectionString:R,resolvedURL:$}=await yi(
r,ge),Ae=typeof M=="function"?M($.hostname,$.port,{jwtAuth:ae!==void 0}):M,ue={"Neon-Connection-Stri\
ng":R,"Neon-Raw-Text-Output":"true","Neon-Array-Mode":"true"},Ie=await Wu(ae);Ie&&(ue.Authorization=
...
ed result format");return N.map((we,J)=>{let se=w[J]??{},qt=se.arrayMode??C,Io=se.fullResults??ne;return hs(
we,{arrayMode:qt,fullResults:Io,types:se.types})})}else{let N=w??{},we=N.arrayMode??C,J=N.fullResults??
...
`Server error (HTTP status ${G}): ${N}`)}}}return a(y,"execute"),f}a(yr,"neon");function hs(r,{arrayMode:e,
...
o,r._types=i,r):u}a(hs,"processQueryResult");async function Wu(r){if(typeof r=="string")return r;if(typeof r==
"function")try{return await Promise.resolve(r())}catch(e){let t=new Q("Error getting auth token.");throw e instanceof
Error&&(t=new Q(`Error getting auth token: ${e.message}`)),t}}a(Wu,"getAuthToken");h();var Ao=be(ut());h();var Eo=be(ut());var Dn=class Dn extends Eo.Client{constructor(t){super(t);E(this,"config",t)}get neonConfig(){return this.
...
[g,d.from([0,0,0,1])]))),de=q;for(var I=0;I<y-1;I++)q=new Uint8Array(await n.sign("HMAC",M,q)),de=d.
...
"SHA-256",ie),oe="n=*,r="+i.clientNonce,ae="r="+c+",s="+l+",i="+y,ge="c=biws,r="+c,R=oe+","+ae+","+ge,
...
a(Dn,"NeonClient");var $e=Dn;ze();var Co=be(Rt());function Wl(r,e){if(e)return{callback:e,result:void 0};let t,n,i=a(function(o,u){o?t(o):n(u)},"cb"),
s=new r(function(o,u){n=o,t=u});return{callback:i,result:s}}a(Wl,"promisify");var qn=class qn extends Ao.Pool{constructor(){
...
t,n,i);typeof n=="function"&&(i=n,n=void 0);let s=Wl(this.Promise,i);i=s.callback;try{let o=new Co.default(
...
w))}catch(o){i(o)}return s.result}};a(qn,"NeonPool");var Dt=qn;ze();var pe=be(ut());h();var _o=be(Rr());function jl(r){return Object.entries(r).reduce((t,[n,i])=>(i!=null&&(t[n]=i),t),Object.create(null))}
...
i;return t},Object.create(null))}a(Hl,"toClientConfig");function To(r){return Hl((0,_o.parse)(r))}a(
To,"parseIntoClientConfig");var $l="js";
