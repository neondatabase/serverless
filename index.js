"use strict";var go=Object.create;var Ie=Object.defineProperty;var wo=Object.getOwnPropertyDescriptor;var bo=Object.getOwnPropertyNames;var vo=Object.getPrototypeOf,So=Object.prototype.hasOwnProperty;var xo=(r,e,t)=>e in r?Ie(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t;var a=(r,e)=>Ie(r,"name",{value:e,configurable:!0});var z=(r,e)=>()=>(r&&(e=r(r=0)),e);var T=(r,e)=>()=>(e||r((e={exports:{}}).exports,e),e.exports),ee=(r,e)=>{for(var t in e)Ie(r,t,{get:e[t],
enumerable:!0})},Fn=(r,e,t,n)=>{if(e&&typeof e=="object"||typeof e=="function")for(let i of bo(e))!So.
call(r,i)&&i!==t&&Ie(r,i,{get:()=>e[i],enumerable:!(n=wo(e,i))||n.enumerable});return r};var xe=(r,e,t)=>(t=r!=null?go(vo(r)):{},Fn(e||!r||!r.__esModule?Ie(t,"default",{value:r,enumerable:!0}):
t,r)),D=r=>Fn(Ie({},"__esModule",{value:!0}),r);var E=(r,e,t)=>xo(r,typeof e!="symbol"?e+"":e,t);var Un=T(ut=>{"use strict";p();ut.byteLength=Ao;ut.toByteArray=Co;ut.fromByteArray=Po;var ue=[],te=[],
Eo=typeof Uint8Array<"u"?Uint8Array:Array,Ut="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz01\
23456789+/";for(Ee=0,Mn=Ut.length;Ee<Mn;++Ee)ue[Ee]=Ut[Ee],te[Ut.charCodeAt(Ee)]=Ee;var Ee,Mn;te[45]=
62;te[95]=63;function kn(r){var e=r.length;if(e%4>0)throw new Error("Invalid string. Length must be \
a multiple of 4");var t=r.indexOf("=");t===-1&&(t=e);var n=t===e?0:4-t%4;return[t,n]}a(kn,"getLens");
function Ao(r){var e=kn(r),t=e[0],n=e[1];return(t+n)*3/4-n}a(Ao,"byteLength");function _o(r,e,t){return(e+
t)*3/4-t}a(_o,"_byteLength");function Co(r){var e,t=kn(r),n=t[0],i=t[1],s=new Eo(_o(r,n,i)),o=0,u=i>
...
4|te[r.charCodeAt(c+2)]>>2,s[o++]=e>>8&255,s[o++]=e&255),s}a(Co,"toByteArray");function Io(r){return ue[r>>
...
i.push(ue[e>>10]+ue[e>>4&63]+ue[e<<2&63]+"=")),i.join("")}a(Po,"fromByteArray")});var Dn=T(Dt=>{p();Dt.read=function(r,e,t,n,i){var s,o,u=i*8-n-1,c=(1<<u)-1,l=c>>1,f=-7,y=t?i-1:0,g=t?
...
f=(1<<l)-1,y=f>>1,g=i===23?Math.pow(2,-24)-Math.pow(2,-77):0,A=n?0:s-1,_=n?1:-1,N=e<0||e===0&&1/e<0?
...
_,u/=256,i-=8);for(o=o<<i|u,l+=i;l>0;r[t+A]=o&255,A+=_,o/=256,l-=8);r[t+A-_]|=N*128}});var ei=T(Be=>{"use strict";p();var Ot=Un(),Pe=Dn(),On=typeof Symbol=="function"&&typeof Symbol.for==
"function"?Symbol.for("nodejs.util.inspect.custom"):null;Be.Buffer=h;Be.SlowBuffer=ko;Be.INSPECT_MAX_BYTES=
50;var ct=2147483647;Be.kMaxLength=ct;h.TYPED_ARRAY_SUPPORT=Ro();!h.TYPED_ARRAY_SUPPORT&&typeof console<
...
'The "string" argument must be of type string. Received type number');return jt(r)}return jn(r,e,t)}
a(h,"Buffer");h.poolSize=8192;function jn(r,e,t){if(typeof r=="string")return Lo(r,e);if(ArrayBuffer.
...
ed type "+typeof r)}a(jn,"from");h.from=function(r,e,t){return jn(r,e,t)};Object.setPrototypeOf(h.prototype,
Uint8Array.prototype);Object.setPrototypeOf(h,Uint8Array);function Wn(r){if(typeof r!="number")throw new TypeError(
'"size" argument must be of type number');if(r<0)throw new RangeError('The value "'+r+'" is invalid \
for option "size"')}a(Wn,"assertSize");function Bo(r,e,t){return Wn(r),r<=0?pe(r):e!==void 0?typeof t==
"string"?pe(r).fill(e,t):pe(r).fill(e):pe(r)}a(Bo,"alloc");h.alloc=function(r,e,t){return Bo(r,e,t)};
function jt(r){return Wn(r),pe(r<0?0:Wt(r)|0)}a(jt,"allocUnsafe");h.allocUnsafe=function(r){return jt(
r)};h.allocUnsafeSlow=function(r){return jt(r)};function Lo(r,e){if((typeof e!="string"||e==="")&&(e=
"utf8"),!h.isEncoding(e))throw new TypeError("Unknown encoding: "+e);let t=Hn(r,e)|0,n=pe(t),i=n.write(
r,e);return i!==t&&(n=n.slice(0,i)),n}a(Lo,"fromString");function Qt(r){let e=r.length<0?0:Wt(r.length)|
0,t=pe(e);for(let n=0;n<e;n+=1)t[n]=r[n]&255;return t}a(Qt,"fromArrayLike");function Fo(r){if(ce(r,Uint8Array)){
let e=new Uint8Array(r);return Nt(e.buffer,e.byteOffset,e.byteLength)}return Qt(r)}a(Fo,"fromArrayVi\
...
r,e,t),Object.setPrototypeOf(n,h.prototype),n}a(Nt,"fromArrayBuffer");function Mo(r){if(h.isBuffer(r)){
...
a(Mo,"fromObject");function Wt(r){if(r>=ct)throw new RangeError("Attempt to allocate Buffer larger t\
han maximum size: 0x"+ct.toString(16)+" bytes");return r|0}a(Wt,"checked");function ko(r){return+r!=
...
an Array of Buffers');s+=o.length}return i},"concat");function Hn(r,e){if(h.isBuffer(r))return r.length;
...
ucs-2":case"utf16le":case"utf-16le":return t*2;case"hex":return t>>>1;case"base64":return Xn(r).length;default:
if(i)return n?-1:qt(r).length;e=(""+e).toLowerCase(),i=!0}}a(Hn,"byteLength");h.byteLength=Hn;function Uo(r,e,t){
...
tf8":case"utf-8":return $n(this,e,t);case"ascii":return Ho(this,e,t);case"latin1":case"binary":return Go(
...
"swap64");h.prototype.toString=a(function(){let e=this.length;return e===0?"":arguments.length===0?$n(
...
er "+e+">"},"inspect");On&&(h.prototype[On]=h.prototype.inspect);h.prototype.compare=a(function(e,t,n,i,s){
...
compare");function Gn(r,e,t,n,i){if(r.length===0)return-1;if(typeof t=="string"?(n=t,t=0):t>2147483647?
...
e,n)),h.isBuffer(e))return e.length===0?-1:Qn(r,e,t,n,i);if(typeof e=="number")return e=e&255,typeof Uint8Array.
prototype.indexOf=="function"?i?Uint8Array.prototype.indexOf.call(r,e,t):Uint8Array.prototype.lastIndexOf.
call(r,e,t):Qn(r,[e],t,n,i);throw new TypeError("val must be string, number or Buffer")}a(Gn,"bidire\
ctionalIndexOf");function Qn(r,e,t,n,i){let s=1,o=r.length,u=e.length;if(n!==void 0&&(n=String(n).toLowerCase(),
...
if(f)return l}return-1}a(Qn,"arrayIndexOf");h.prototype.includes=a(function(e,t,n){return this.indexOf(
e,t,n)!==-1},"includes");h.prototype.indexOf=a(function(e,t,n){return Gn(this,e,t,n,!0)},"indexOf");
h.prototype.lastIndexOf=a(function(e,t,n){return Gn(this,e,t,n,!1)},"lastIndexOf");function Do(r,e,t,n){
t=Number(t)||0;let i=r.length-t;n?(n=Number(n),n>i&&(n=i)):n=i;let s=e.length;n>s/2&&(n=s/2);let o;for(o=
0;o<n;++o){let u=parseInt(e.substr(o*2,2),16);if(Gt(u))return o;r[t+o]=u}return o}a(Do,"hexWrite");function Oo(r,e,t,n){
return lt(qt(e,r.length-t),r,t,n)}a(Oo,"utf8Write");function Qo(r,e,t,n){return lt(Zo(e),r,t,n)}a(Qo,
"asciiWrite");function No(r,e,t,n){return lt(Xn(e),r,t,n)}a(No,"base64Write");function qo(r,e,t,n){return lt(
Jo(e,r.length-t),r,t,n)}a(qo,"ucs2Write");h.prototype.write=a(function(e,t,n,i){if(t===void 0)i="utf\
...
return No(this,e,t,n);case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return qo(this,e,t,n);default:
...
N");function jo(r,e,t){return e===0&&t===r.length?Ot.fromByteArray(r):Ot.fromByteArray(r.slice(e,t))}
a(jo,"base64Slice");function $n(r,e,t){t=Math.min(r.length,t);let n=[],i=e;for(;i<t;){let s=r[i],o=null,
...
n.push(o),i+=u}return Wo(n)}a($n,"utf8Slice");var Nn=4096;function Wo(r){let e=r.length;if(e<=Nn)return String.
fromCharCode.apply(String,r);let t="",n=0;for(;n<e;)t+=String.fromCharCode.apply(String,r.slice(n,n+=
Nn));return t}a(Wo,"decodeCodePointsArray");function Ho(r,e,t){let n="";t=Math.min(r.length,t);for(let i=e;i<
...
ge(a(function(e){e=e>>>0,Re(e,"offset");let t=this[e],n=this[e+7];(t===void 0||n===void 0)&&He(e,this.
...
0),this[t]=e>>>24,this[t+1]=e>>>16,this[t+2]=e>>>8,this[t+3]=e&255,t+4},"writeUInt32BE");function Vn(r,e,t,n,i){
Jn(e,n,i,r,t,7);let s=Number(e&BigInt(4294967295));r[t++]=s,s=s>>8,r[t++]=s,s=s>>8,r[t++]=s,s=s>>8,r[t++]=
s;let o=Number(e>>BigInt(32)&BigInt(4294967295));return r[t++]=o,o=o>>8,r[t++]=o,o=o>>8,r[t++]=o,o=o>>
8,r[t++]=o,t}a(Vn,"wrtBigUInt64LE");function Kn(r,e,t,n,i){Jn(e,n,i,r,t,7);let s=Number(e&BigInt(4294967295));
r[t+7]=s,s=s>>8,r[t+6]=s,s=s>>8,r[t+5]=s,s=s>>8,r[t+4]=s;let o=Number(e>>BigInt(32)&BigInt(4294967295));
return r[t+3]=o,o=o>>8,r[t+2]=o,o=o>>8,r[t+1]=o,o=o>>8,r[t]=o,t+8}a(Kn,"wrtBigUInt64BE");h.prototype.
writeBigUInt64LE=ge(a(function(e,t=0){return Vn(this,e,t,BigInt(0),BigInt("0xffffffffffffffff"))},"w\
riteBigUInt64LE"));h.prototype.writeBigUInt64BE=ge(a(function(e,t=0){return Kn(this,e,t,BigInt(0),BigInt(
...
t+4},"writeInt32BE");h.prototype.writeBigInt64LE=ge(a(function(e,t=0){return Vn(this,e,t,-BigInt("0x\
8000000000000000"),BigInt("0x7fffffffffffffff"))},"writeBigInt64LE"));h.prototype.writeBigInt64BE=ge(
a(function(e,t=0){return Kn(this,e,t,-BigInt("0x8000000000000000"),BigInt("0x7fffffffffffffff"))},"w\
riteBigInt64BE"));function zn(r,e,t,n,i,s){if(t+n>r.length)throw new RangeError("Index out of range");
if(t<0)throw new RangeError("Index out of range")}a(zn,"checkIEEE754");function Yn(r,e,t,n,i){return e=
+e,t=t>>>0,i||zn(r,e,t,4,34028234663852886e22,-34028234663852886e22),Pe.write(r,e,t,n,23,4),t+4}a(Yn,
"writeFloat");h.prototype.writeFloatLE=a(function(e,t,n){return Yn(this,e,t,!0,n)},"writeFloatLE");h.
prototype.writeFloatBE=a(function(e,t,n){return Yn(this,e,t,!1,n)},"writeFloatBE");function Zn(r,e,t,n,i){
...
0;s<n-t;++s)this[s+t]=o[s%u]}return this},"fill");var Te={};function Ht(r,e,t){var n;Te[r]=(n=class extends t{constructor(){
...
Re(e,"offset"),(r[e]===void 0||r[e+t]===void 0)&&He(e,r.length-(t+1))}a(Ko,"checkBounds");function Jn(r,e,t,n,i,s){
...
nd <= ${t}${o}`,new Te.ERR_OUT_OF_RANGE("value",u,r)}Ko(n,i,s)}a(Jn,"checkIntBI");function Re(r,e){if(typeof r!=
"number")throw new Te.ERR_INVALID_ARG_TYPE(e,"number",r)}a(Re,"validateNumber");function He(r,e,t){throw Math.
floor(r)!==r?(Re(r,t),new Te.ERR_OUT_OF_RANGE(t||"offset","an integer",r)):e<0?new Te.ERR_BUFFER_OUT_OF_BOUNDS:
new Te.ERR_OUT_OF_RANGE(t||"offset",`>= ${t?1:0} and <= ${e}`,r)}a(He,"boundsError");var zo=/[^+/0-9A-Za-z-_]/g;
function Yo(r){if(r=r.split("=")[0],r=r.trim().replace(zo,""),r.length<2)return"";for(;r.length%4!==
...
o),n=t>>8,i=t%256,s.push(i),s.push(n);return s}a(Jo,"utf16leToBytes");function Xn(r){return Ot.toByteArray(
Yo(r))}a(Xn,"base64ToBytes");function lt(r,e,t,n){let i;for(i=0;i<n&&!(i+t>=e.length||i>=r.length);++i)
...
r}a(Gt,"numberIsNaN");var Xo=function(){let r="0123456789abcdef",e=new Array(256);for(let t=0;t<16;++t){
let n=t*16;for(let i=0;i<16;++i)e[n+i]=r[t]+r[i]}return e}();function ge(r){return typeof BigInt>"u"?
ea:r}a(ge,"defineBigIntMethod");function ea(){throw new Error("BigInt not supported")}a(ea,"BufferBi\
...
allocUnsafe=="function"?globalThis.Buffer:ei().Buffer,m=globalThis.process??{};m.env??(m.env={});try{
m.nextTick(()=>{})}catch{let e=Promise.resolve();m.nextTick=e.then.bind(e)}});var we=T((Il,$t)=>{"use strict";p();var Le=typeof Reflect=="object"?Reflect:null,ti=Le&&typeof Le.apply==
"function"?Le.apply:a(function(e,t,n){return Function.prototype.apply.call(e,t,n)},"ReflectApply"),ft;
Le&&typeof Le.ownKeys=="function"?ft=Le.ownKeys:Object.getOwnPropertySymbols?ft=a(function(e){return Object.
...
"ProcessEmitWarning");var ni=Number.isNaN||a(function(e){return e!==e},"NumberIsNaN");function R(){R.
init.call(this)}a(R,"EventEmitter");$t.exports=R;$t.exports.once=sa;R.EventEmitter=R;R.prototype._events=
void 0;R.prototype._eventsCount=0;R.prototype._maxListeners=void 0;var ri=10;function ht(r){if(typeof r!=
"function")throw new TypeError('The "listener" argument must be of type Function. Received type '+typeof r)}
a(ht,"checkListener");Object.defineProperty(R,"defaultMaxListeners",{enumerable:!0,get:a(function(){
return ri},"get"),set:a(function(r){if(typeof r!="number"||r<0||ni(r))throw new RangeError('The valu\
e of "defaultMaxListeners" is out of range. It must be a non-negative number. Received '+r+".");ri=r},
...
R.prototype.setMaxListeners=a(function(e){if(typeof e!="number"||e<0||ni(e))throw new RangeError('Th\
e value of "n" is out of range. It must be a non-negative number. Received '+e+".");return this._maxListeners=
e,this},"setMaxListeners");function ii(r){return r._maxListeners===void 0?R.defaultMaxListeners:r._maxListeners}
a(ii,"_getMaxListeners");R.prototype.getMaxListeners=a(function(){return ii(this)},"getMaxListeners");
...
throw u.context=o,u}var c=s[e];if(c===void 0)return!1;if(typeof c=="function")ti(c,this,t);else for(var l=c.
length,f=ci(c,l),n=0;n<l;++n)ti(f[n],this,t);return!0},"emit");function si(r,e,t,n){var i,s,o;if(ht(
...
"function"?o=s[e]=n?[t,o]:[o,t]:n?o.unshift(t):o.push(t),i=ii(r),i>0&&o.length>i&&!o.warned){o.warned=
...
r,u.type=e,u.count=o.length,ta(u)}return r}a(si,"_addListener");R.prototype.addListener=a(function(e,t){
return si(this,e,t,!1)},"addListener");R.prototype.on=R.prototype.addListener;R.prototype.prependListener=
a(function(e,t){return si(this,e,t,!0)},"prependListener");function ra(){if(!this.fired)return this.
target.removeListener(this.type,this.wrapFn),this.fired=!0,arguments.length===0?this.listener.call(this.
target):this.listener.apply(this.target,arguments)}a(ra,"onceWrapper");function oi(r,e,t){var n={fired:!1,
wrapFn:void 0,target:r,type:e,listener:t},i=ra.bind(n);return i.listener=t,n.wrapFn=i,i}a(oi,"_onceW\
rap");R.prototype.once=a(function(e,t){return ht(t),this.on(e,oi(this,e,t)),this},"once");R.prototype.
prependOnceListener=a(function(e,t){return ht(t),this.prependListener(e,oi(this,e,t)),this},"prepend\
...
0;i--)this.removeListener(e,t[i]);return this},"removeAllListeners");function ai(r,e,t){var n=r._events;
if(n===void 0)return[];var i=n[e];return i===void 0?[]:typeof i=="function"?t?[i.listener||i]:[i]:t?
ia(i):ci(i,i.length)}a(ai,"_listeners");R.prototype.listeners=a(function(e){return ai(this,e,!0)},"l\
isteners");R.prototype.rawListeners=a(function(e){return ai(this,e,!1)},"rawListeners");R.listenerCount=
function(r,e){return typeof r.listenerCount=="function"?r.listenerCount(e):ui.call(r,e)};R.prototype.
listenerCount=ui;function ui(r){var e=this._events;if(e!==void 0){var t=e[r];if(typeof t=="function")
return 1;if(t!==void 0)return t.length}return 0}a(ui,"listenerCount");R.prototype.eventNames=a(function(){
return this._eventsCount>0?ft(this._events):[]},"eventNames");function ci(r,e){for(var t=new Array(e),
n=0;n<e;++n)t[n]=r[n];return t}a(ci,"arrayClone");function na(r,e){for(;e+1<r.length;e++)r[e]=r[e+1];
...
removeListener("error",i),t([].slice.call(arguments))}a(s,"resolver"),li(r,e,s,{once:!0}),e!=="error"&&
oa(r,i,{once:!0})})}a(sa,"once");function oa(r,e,t){typeof r.on=="function"&&li(r,"error",e,t)}a(oa,
"addErrorHandlerIfEventEmitter");function li(r,e,t,n){if(typeof r.on=="function")n.once?r.once(e,t):
...
ust be of type EventEmitter. Received type '+typeof r)}a(li,"eventTargetAgnosticAddListener")});var pi={};ee(pi,{Socket:()=>de,isIP:()=>aa});function aa(r){return 0}var hi,fi,x,de,Ge=z(()=>{"use s\
trict";p();hi=xe(we(),1);a(aa,"isIP");fi=/^[^.]+\./,x=class x extends hi.EventEmitter{constructor(){
...
(t,n,i)=>{let s;return i?.jwtAuth?s=t.replace(fi,"apiauth."):s=t.replace(fi,"api."),"https://"+s+"/s\
...
password",subtls:void 0,rootCerts:"",pipelineTLS:!1,disableSNI:!1}),E(x,"opts",{});de=x});var di={};ee(di,{parse:()=>Vt});function Vt(r,e=!1){let{protocol:t}=new URL(r),n="http:"+r.substring(
...
pathname:l,search:f,query:_,hash:g}}var Kt=z(()=>{"use strict";p();a(Vt,"parse")});function Ve(r){let e=1779033703,t=3144134277,n=1013904242,i=2773480762,s=1359893119,o=2600822924,u=528734635,
...
for(let B=0;B<64;B++){let G=g(q,6)^g(q,11)^g(q,25),fe=q&ie^~q&se,_e=oe+G+fe+y[B]+A[B]|0,he=g(C,2)^g(
C,13)^g(C,22),Ce=C&S^C&H^S&H,ae=he+Ce|0;oe=se,se=ie,ie=q,q=le+_e|0,le=H,H=S,S=C,C=_e+ae|0}e=e+C|0,t=
...
return r===void 0?{add:P,digest:L}:(P(r),L())}var vi=z(()=>{"use strict";p();a(Ve,"sha256")});var U,Ke,Si=z(()=>{"use strict";p();U=class U{constructor(){E(this,"_dataLength",0);E(this,"_bufferL\
...
abcdef"),E(U,"hexOut",[]),E(U,"onePassHasher",new U);Ke=U});var Yt={};ee(Yt,{createHash:()=>Sa,createHmac:()=>xa,randomBytes:()=>va});function va(r){return crypto.
getRandomValues(d.alloc(r))}function Sa(r){if(r==="sha256")return{update:a(function(e){return{digest:a(
function(){return d.from(Ve(e))},"digest")}},"update")};if(r==="md5")return{update:a(function(e){return{
digest:a(function(){return typeof e=="string"?Ke.hashStr(e):Ke.hashByteArray(e)},"digest")}},"update")};
throw new Error(`Hash type '${r}' not supported`)}function xa(r,e){if(r!=="sha256")throw new Error(`\
...
64);o.set(i,0),o.set(t,64);let u=new Uint8Array(96);return u.set(s,0),u.set(Ve(o),64),d.from(Ve(u))},
"digest")}},"update")}}var Zt=z(()=>{"use strict";p();vi();Si();a(va,"randomBytes");a(Sa,"createHash");
a(xa,"createHmac")});var Xt=T(xi=>{"use strict";p();xi.parse=function(r,e){return new Jt(r,e).parse()};var mt=class mt{constructor(e,t){
...
not balanced");return this.entries}};a(mt,"ArrayParser");var Jt=mt;function Ea(r){return r}a(Ea,"ide\
ntity")});var er=T((Yl,Ei)=>{p();var Aa=Xt();Ei.exports={create:a(function(r,e){return{parse:a(function(){return Aa.
parse(r,e)},"parse")}},"create")}});var Ci=T((Xl,_i)=>{"use strict";p();var _a=/(\d{1,})-(\d{2})-(\d{2}) (\d{2}):(\d{2}):(\d{2})(\.\d{1,})?.*?( BC)?$/,
Ca=/^(\d{1,})-(\d{2})-(\d{2})( BC)?$/,Ia=/([Z+-])(\d{2})?:?(\d{2})?:?(\d{2})?/,Ta=/^-?infinity$/;_i.
exports=a(function(e){if(Ta.test(e))return Number(e.replace("i","I"));var t=_a.exec(e);if(!t)return Pa(
...
new Date(i,s,o,u,c,l,f),tr(i)&&y.setFullYear(i)),y},"parseDate");function Pa(r){var e=Ca.exec(r);if(e){
var t=parseInt(e[1],10),n=!!e[4];n&&(t=Ai(t));var i=parseInt(e[2],10)-1,s=e[3],o=new Date(t,i,s);return tr(
t)&&o.setFullYear(t),o}}a(Pa,"getDate");function Ra(r){if(r.endsWith("+00"))return 0;var e=Ia.exec(r.
...
1)}a(Ai,"bcYearToNegativeYear");function tr(r){return r>=0&&r<100}a(tr,"is0To99")});var Ti=T((rf,Ii)=>{p();Ii.exports=La;var Ba=Object.prototype.hasOwnProperty;function La(r){for(var e=1;e<
arguments.length;e++){var t=arguments[e];for(var n in t)Ba.call(t,n)&&(r[n]=t[n])}return r}a(La,"ext\
end")});var Bi=T((of,Ri)=>{"use strict";p();var Fa=Ti();Ri.exports=Fe;function Fe(r){if(!(this instanceof Fe))
...
/0+$/,"")),i+ka[n]}};var rr="([+-]?\\d+)",Oa=rr+"\\s+years?",Qa=rr+"\\s+mons?",Na=rr+"\\s+days?",qa="\
([+-])?([\\d]*):(\\d\\d):(\\d\\d)\\.?(\\d{1,6})?",ja=new RegExp([Oa,Qa,Na,qa].map(function(r){return"\
...
!o)||(t&&~Wa.indexOf(i)&&(o*=-1),n[i]=o),n},{})}a(Ga,"parse")});var Fi=T((cf,Li)=>{"use strict";p();Li.exports=a(function(e){if(/^\\x/.test(e))return new d(e.substr(
...
parseBytea")});var Ni=T((hf,Qi)=>{p();var ze=Xt(),Ye=er(),gt=Ci(),ki=Bi(),Ui=Fi();function wt(r){return a(function(t){
return t===null?t:r(t)},"nullAllowed")}a(wt,"allowNull");function Di(r){return r===null?r:r==="TRUE"||
r==="t"||r==="true"||r==="y"||r==="yes"||r==="on"||r==="1"}a(Di,"parseBool");function $a(r){return r?
ze.parse(r,Di):null}a($a,"parseBoolArray");function Va(r){return parseInt(r,10)}a(Va,"parseBaseTenIn\
t");function nr(r){return r?ze.parse(r,wt(Va)):null}a(nr,"parseIntegerArray");function Ka(r){return r?
ze.parse(r,wt(function(e){return Oi(e).trim()})):null}a(Ka,"parseBigIntegerArray");var za=a(function(r){
...
function(t){return t!==null&&(t=gt(t)),t});return e.parse()},"parseDateArray"),Ya=a(function(r){if(!r)
return null;var e=Ye.create(r,function(t){return t!==null&&(t=ki(t)),t});return e.parse()},"parseInt\
ervalArray"),Za=a(function(r){return r?ze.parse(r,wt(Ui)):null},"parseByteAArray"),or=a(function(r){
return parseInt(r,10)},"parseInteger"),Oi=a(function(r){var e=String(r);return/^\d+$/.test(e)?e:r},"\
parseBigInteger"),Mi=a(function(r){return r?ze.parse(r,wt(JSON.parse)):null},"parseJsonArray"),ar=a(
...
r(23,or),r(26,or),r(700,parseFloat),r(701,parseFloat),r(16,Di),r(1082,gt),r(1114,gt),r(1184,gt),r(600,
ar),r(651,re),r(718,Ja),r(1e3,$a),r(1001,Za),r(1005,nr),r(1007,nr),r(1028,nr),r(1016,Ka),r(1017,za),
r(1021,ir),r(1022,ir),r(1231,ir),r(1014,re),r(1015,re),r(1008,re),r(1009,re),r(1040,re),r(1041,re),r(
1115,sr),r(1182,sr),r(1185,sr),r(1186,ki),r(1187,Ya),r(17,Ui),r(114,JSON.parse.bind(JSON)),r(3802,JSON.
parse.bind(JSON)),r(199,Mi),r(3807,Mi),r(3907,re),r(2951,re),r(791,re),r(1183,re),r(1270,re)},"init");
Qi.exports={init:Xa}});var ji=T((yf,qi)=>{"use strict";p();var Z=1e6;function eu(r){var e=r.readInt32BE(0),t=r.readUInt32BE(
...
""+o%Z,n+u+i}a(eu,"readInt8");qi.exports=eu});var Vi=T((wf,$i)=>{p();var tu=ji(),F=a(function(r,e,t,n,i){t=t||0,n=n||!1,i=i||function(A,_,N){return A*
...
r(701,iu),r(16,au),r(1114,Hi.bind(null,!1)),r(1184,Hi.bind(null,!0)),r(1e3,Ze),r(1007,Ze),r(1016,Ze),
r(1008,Ze),r(1009,Ze),r(25,ou)},"init");$i.exports={init:uu}});var zi=T((Sf,Ki)=>{p();Ki.exports={BOOL:16,BYTEA:17,CHAR:18,INT8:20,INT2:21,INT4:23,REGPROC:24,TEXT:25,
...
REGROLE:4096}});var et=T(Xe=>{p();var cu=Ni(),lu=Vi(),fu=er(),hu=zi();Xe.getTypeParser=pu;Xe.setTypeParser=du;Xe.arrayParser=
fu;Xe.builtins=hu;var Je={text:{},binary:{}};function Yi(r){return String(r)}a(Yi,"noParse");function pu(r,e){
return e=e||"text",Je[e]&&Je[e][r]||Yi}a(pu,"getTypeParser");function du(r,e,t){typeof e=="function"&&
...
keepalives:1,keepalives_idle:0};var Me=et(),yu=Me.getTypeParser(20,"text"),mu=Me.getTypeParser(1016,
"text");ur.exports.__defineSetter__("parseInt8",function(r){Me.setTypeParser(20,"text",r?Me.getTypeParser(
23,"text"):yu),Me.setTypeParser(1016,"text",r?Me.getTypeParser(1007,"text"):mu)})});var rt=T((Tf,Ji)=>{"use strict";p();var gu=(Zt(),D(Yt)),wu=tt();function bu(r){var e=r.replace(/\\/g,
"\\\\").replace(/"/g,'\\"');return'"'+e+'"'}a(bu,"escapeElement");function Zi(r){for(var e="{",t=0;t<
r.length;t++)t>0&&(e=e+","),r[t]===null||typeof r[t]>"u"?e=e+"NULL":Array.isArray(r[t])?e=e+Zi(r[t]):
r[t]instanceof d?e+="\\\\x"+r[t].toString("hex"):e+=bu(bt(r[t]));return e=e+"}",e}a(Zi,"arrayString");
var bt=a(function(r,e){if(r==null)return null;if(r instanceof d)return r;if(ArrayBuffer.isView(r)){var t=d.
from(r.buffer,r.byteOffset,r.byteLength);return t.length===r.byteLength?t:t.slice(r.byteOffset,r.byteOffset+
r.byteLength)}return r instanceof Date?wu.parseInputDatesAsUTC?xu(r):Su(r):Array.isArray(r)?Zi(r):typeof r==
"object"?vu(r,e):r.toString()},"prepareValue");function vu(r,e){if(r&&typeof r.toPostgres=="function"){
if(e=e||[],e.indexOf(r)!==-1)throw new Error('circular reference detected while preparing "'+r+'" fo\
r query');return e.push(r),bt(r.toPostgres(bt),e)}return JSON.stringify(r)}a(vu,"prepareObject");function W(r,e){
for(r=""+r;r.length<e;)r="0"+r;return r}a(W,"pad");function Su(r){var e=-r.getTimezoneOffset(),t=r.getFullYear(),
...
-1):i+="+",i+=W(Math.floor(e/60),2)+":"+W(e%60,2),n&&(i+=" BC"),i}a(Su,"dateToString");function xu(r){
...
r.getUTCMilliseconds(),3);return n+="+00:00",t&&(n+=" BC"),n}a(xu,"dateToStringUTC");function Eu(r,e,t){
return r=typeof r=="string"?{text:r}:r,e&&(typeof e=="function"?r.callback=e:r.values=e),t&&(r.callback=
t),r}a(Eu,"normalizeQueryConfig");var cr=a(function(r){return gu.createHash("md5").update(r,"utf-8").
digest("hex")},"md5"),Au=a(function(r,e,t){var n=cr(e+r),i=cr(d.concat([d.from(n),t]));return"md5"+i},
"postgresMd5PasswordHash");Ji.exports={prepareValue:a(function(e){return bt(e)},"prepareValueWrapper"),
normalizeQueryConfig:Eu,postgresMd5PasswordHash:Au,md5:cr}});var xt=T((kf,es)=>{"use strict";p();var _u=et();function St(r){this._types=r||_u,this.text={},this.binary=
...
e||"text",this.getOverrides(e)[r]||this._types.getTypeParser(r,e)};es.exports=St});var nt={};ee(nt,{default:()=>Tu});var Tu,it=z(()=>{"use strict";p();Tu={}});var cs=T(($f,us)=>{"use strict";p();var hr=(Zt(),D(Yt));function Pu(r){if(r.indexOf("SCRAM-SHA-256")===
...
art with client nonce");var i=d.from(n.salt,"base64"),s=Uu(e,i,n.iteration),o=ke(s,"Client Key"),u=ku(
o),c="n=*,r="+r.clientNonce,l="r="+n.nonce+",s="+n.salt+",i="+n.iteration,f="c=biws,r="+n.nonce,y=c+
","+l+","+f,g=ke(u,y),A=as(o,g),_=A.toString("base64"),N=ke(s,"Server Key"),P=ke(N,y);r.message="SAS\
...
e<=126)}a(Lu,"isPrintableChars");function ss(r){return/^(?:[a-zA-Z0-9+/]{4})*(?:[a-zA-Z0-9+/]{2}==|[a-zA-Z0-9+/]{3}=)?$/.
...
Pairs");function Fu(r){let e=os(r),t=e.get("r");if(t){if(!Lu(t))throw new Error("SASL: SCRAM-SERVER-\
...
function Mu(r){let t=os(r).get("v");if(t){if(!ss(t))throw new Error("SASL: SCRAM-SERVER-FINAL-MESSAG\
E: server signature must be base64")}else throw new Error("SASL: SCRAM-SERVER-FINAL-MESSAGE: server \
signature is missing");return{serverSignature:t}}a(Mu,"parseServerFinalMessage");function as(r,e){if(!d.
...
a(as,"xorBuffers");function ku(r){return hr.createHash("sha256").update(r).digest()}a(ku,"sha256");function ke(r,e){
return hr.createHmac("sha256",r).update(e).digest()}a(ke,"hmacSha256");function Uu(r,e,t){for(var n=ke(
r,d.concat([e,d.from([0,0,0,1])])),i=n,s=0;s<t-1;s++)n=ke(r,n),i=as(i,n);return i}a(Uu,"Hi");us.exports=
{startSession:Pu,continueSession:Ru,finalizeSession:Bu}});var pr={};ee(pr,{join:()=>Du});function Du(...r){return r.join("/")}var dr=z(()=>{"use strict";p();a(
Du,"join")});var yr={};ee(yr,{stat:()=>Ou});function Ou(r,e){e(new Error("No filesystem"))}var mr=z(()=>{"use str\
ict";p();a(Ou,"stat")});var gr={};ee(gr,{default:()=>Qu});var Qu,wr=z(()=>{"use strict";p();Qu={}});var ls={};ee(ls,{StringDecoder:()=>br});var vr,br,fs=z(()=>{"use strict";p();vr=class vr{constructor(e){
E(this,"td");this.td=new TextDecoder(e)}write(e){return this.td.decode(e,{stream:!0})}end(e){return this.
td.decode(e)}};a(vr,"StringDecoder");br=vr});var ys=T((rh,ds)=>{"use strict";p();var{Transform:Nu}=(wr(),D(gr)),{StringDecoder:qu}=(fs(),D(ls)),ve=Symbol(
"last"),At=Symbol("decoder");function ju(r,e,t){let n;if(this.overflow){if(n=this[At].write(r).split(
this.matcher),n.length===1)return t();n.shift(),this.overflow=!1}else this[ve]+=this[At].write(r),n=
this[ve].split(this.matcher);this[ve]=n.pop();for(let i=0;i<n.length;i++)try{ps(this,this.mapper(n[i]))}catch(s){
return t(s)}if(this.overflow=this[ve].length>this.maxLength,this.overflow&&!this.skipOverflow){t(new Error(
"maximum buffer reached"));return}t()}a(ju,"transform");function Wu(r){if(this[ve]+=this[At].end(),this[ve])
try{ps(this,this.mapper(this[ve]))}catch(e){return r(e)}r()}a(Wu,"flush");function ps(r,e){e!==void 0&&
r.push(e)}a(ps,"push");function hs(r){return r}a(hs,"noop");function Hu(r,e,t){switch(r=r||/\r?\n/,e=
...
"object"&&(t=e,e=hs)}t=Object.assign({},t),t.autoDestroy=!0,t.transform=ju,t.flush=Wu,t.readableObjectMode=
!0;let n=new Nu(t);return n[ve]="",n[At]=new qu("utf8"),n.matcher=r,n.mapper=e,n.maxLength=t.maxLength,
n.skipOverflow=t.skipOverflow||!1,n.overflow=!1,n._destroy=function(i,s){this._writableState.errorEmitted=
!1,s(i)},n}a(Hu,"split");ds.exports=Hu});var ws=T((sh,me)=>{"use strict";p();var ms=(dr(),D(pr)),Gu=(wr(),D(gr)).Stream,$u=ys(),gs=(it(),D(nt)),
Vu=5432,_t=m.platform==="win32",st=m.stderr,Ku=56,zu=7,Yu=61440,Zu=32768;function Ju(r){return(r&Yu)==
Zu}a(Ju,"isRegFile");var Ue=["host","port","database","user","password"],Sr=Ue.length,Xu=Ue[Sr-1];function xr(){
var r=st instanceof Gu&&st.writable===!0;if(r){var e=Array.prototype.slice.call(arguments).concat(`
`);st.write(gs.format.apply(gs,e))}}a(xr,"warn");Object.defineProperty(me.exports,"isWin",{get:a(function(){
return _t},"get"),set:a(function(r){_t=r},"set")});me.exports.warnTo=function(r){var e=st;return st=
r,e};me.exports.getFileName=function(r){var e=r||m.env,t=e.PGPASSFILE||(_t?ms.join(e.APPDATA||"./","\
postgresql","pgpass.conf"):ms.join(e.HOME||"./",".pgpass"));return t};me.exports.usePgPass=function(r,e){
return Object.prototype.hasOwnProperty.call(m.env,"PGPASSWORD")?!1:_t?!0:(e=e||"<unkn>",Ju(r.mode)?r.
mode&(Ku|zu)?(xr('WARNING: password file "%s" has group or world access; permissions should be u=rw \
(0600) or less',e),!1):!0:(xr('WARNING: password file "%s" is not a plain file',e),!1))};var ec=me.exports.
...
e.destroy(),t(n)},"onEnd"),u=a(function(c){e.destroy(),xr("WARNING: error on reading file: %s",c),t(
...
length===Sr?o:null,o},rc=me.exports.isValidEntry=function(r){for(var e={0:function(o){return o.length>
...
0}},t=0;t<Ue.length;t+=1){var n=e[t],i=r[Ue[t]]||"",s=n(i);if(!s)return!1}return!0}});var vs=T((ch,Er)=>{"use strict";p();var uh=(dr(),D(pr)),bs=(mr(),D(yr)),Ct=ws();Er.exports=function(r,e){
var t=Ct.getFileName();bs.stat(t,function(n,i){if(n||!Ct.usePgPass(i,t))return e(void 0);var s=bs.createReadStream(
t);Ct.getPassword(r,s,e)})};Er.exports.warnTo=Ct.warnTo});var Ss={};ee(Ss,{default:()=>nc});var nc,xs=z(()=>{"use strict";p();nc={}});var As=T((hh,Es)=>{"use strict";p();var ic=(Kt(),D(di)),Ar=(mr(),D(yr));function _r(r){if(r.charAt(0)===
...
!1;break}}return t}a(_r,"parse");Es.exports=_r;_r.parse=_r});var It=T((yh,Is)=>{"use strict";p();var sc=(xs(),D(Ss)),Cs=tt(),_s=As().parse,$=a(function(r,e,t){return t===
void 0?t=m.env["PG"+r.toUpperCase()]:t===!1||(t=m.env[t]),e[r]||t||Cs[r]},"val"),oc=a(function(){switch(m.
...
var n=e[t];n!=null&&r.push(t+"="+De(n))},"add"),Ir=class Ir{constructor(e){e=typeof e=="string"?_s(e):
...
a(Ir,"ConnectionParameters");var Cr=Ir;Is.exports=Cr});var Rs=T((wh,Ps)=>{"use strict";p();var ac=et(),Ts=/^([A-Za-z]+)(?: (\d+))?(?: (\d+))?/,Pr=class Pr{constructor(e,t){
...
format||"text")}}};a(Pr,"Result");var Tr=Pr;Ps.exports=Tr});var Ms=T((Sh,Fs)=>{"use strict";p();var{EventEmitter:uc}=we(),Bs=Rs(),Ls=rt(),Br=class Br extends uc{constructor(e,t,n){
...
e.sendCopyFail("No source stream defined")}handleCopyData(e,t){}};a(Br,"Query");var Rr=Br;Fs.exports=
Rr});var an=T(I=>{"use strict";p();Object.defineProperty(I,"__esModule",{value:!0});I.NoticeMessage=I.DataRowMessage=
...
name=n}};a($r,"DatabaseError");var Lr=$r;I.DatabaseError=Lr;var Vr=class Vr{constructor(e,t){this.length=
e,this.chunk=t,this.name="copyData"}};a(Vr,"CopyDataMessage");var Fr=Vr;I.CopyDataMessage=Fr;var Kr=class Kr{constructor(e,t,n,i){
this.length=e,this.name=t,this.binary=n,this.columnTypes=new Array(i)}};a(Kr,"CopyResponse");var Mr=Kr;
I.CopyResponse=Mr;var zr=class zr{constructor(e,t,n,i,s,o,u){this.name=e,this.tableID=t,this.columnID=
n,this.dataTypeID=i,this.dataTypeSize=s,this.dataTypeModifier=o,this.format=u}};a(zr,"Field");var kr=zr;
I.Field=kr;var Yr=class Yr{constructor(e,t){this.length=e,this.fieldCount=t,this.name="rowDescriptio\
n",this.fields=new Array(this.fieldCount)}};a(Yr,"RowDescriptionMessage");var Ur=Yr;I.RowDescriptionMessage=
...
I.ParameterDescriptionMessage=Dr;var Jr=class Jr{constructor(e,t,n){this.length=e,this.parameterName=
t,this.parameterValue=n,this.name="parameterStatus"}};a(Jr,"ParameterStatusMessage");var Or=Jr;I.ParameterStatusMessage=
Or;var Xr=class Xr{constructor(e,t){this.length=e,this.salt=t,this.name="authenticationMD5Password"}};
a(Xr,"AuthenticationMD5Password");var Qr=Xr;I.AuthenticationMD5Password=Qr;var en=class en{constructor(e,t,n){
this.length=e,this.processID=t,this.secretKey=n,this.name="backendKeyData"}};a(en,"BackendKeyDataMes\
sage");var Nr=en;I.BackendKeyDataMessage=Nr;var tn=class tn{constructor(e,t,n,i){this.length=e,this.
processId=t,this.channel=n,this.payload=i,this.name="notification"}};a(tn,"NotificationResponseMessa\
ge");var qr=tn;I.NotificationResponseMessage=qr;var rn=class rn{constructor(e,t){this.length=e,this.
status=t,this.name="readyForQuery"}};a(rn,"ReadyForQueryMessage");var jr=rn;I.ReadyForQueryMessage=jr;
var nn=class nn{constructor(e,t){this.length=e,this.text=t,this.name="commandComplete"}};a(nn,"Comma\
ndCompleteMessage");var Wr=nn;I.CommandCompleteMessage=Wr;var sn=class sn{constructor(e,t){this.length=
e,this.fields=t,this.name="dataRow",this.fieldCount=t.length}};a(sn,"DataRowMessage");var Hr=sn;I.DataRowMessage=
Hr;var on=class on{constructor(e,t){this.length=e,this.message=t,this.name="notice"}};a(on,"NoticeMe\
ssage");var Gr=on;I.NoticeMessage=Gr});var ks=T(Tt=>{"use strict";p();Object.defineProperty(Tt,"__esModule",{value:!0});Tt.Writer=void 0;var cn=class cn{constructor(e=256){
...
headerPosition=0,this.buffer=d.allocUnsafe(this.size),t}};a(cn,"Writer");var un=cn;Tt.Writer=un});var Ds=T(Rt=>{"use strict";p();Object.defineProperty(Rt,"__esModule",{value:!0});Rt.serialize=void 0;
var ln=ks(),M=new ln.Writer,cc=a(r=>{M.addInt16(3).addInt16(0);for(let n of Object.keys(r))M.addCString(
n).addCString(r[n]);M.addCString("client_encoding").addCString("UTF8");var e=M.addCString("").flush(),
t=e.length+4;return new ln.Writer().addInt32(t).add(e).flush()},"startup"),lc=a(()=>{let r=d.allocUnsafe(
8);return r.writeInt32BE(8,0),r.writeInt32BE(80877103,4),r},"requestSsl"),fc=a(r=>M.addCString(r).flush(
112),"password"),hc=a(function(r,e){return M.addCString(r).addInt32(d.byteLength(e)).addString(e),M.
flush(112)},"sendSASLInitialResponseMessage"),pc=a(function(r){return M.addString(r).flush(112)},"se\
ndSCRAMClientFinalMessage"),dc=a(r=>M.addCString(r).flush(81),"query"),Us=[],yc=a(r=>{let e=r.name||
...
n),s=0;s<n;s++)i.addInt32(t[s]);return M.flush(80)},"parse"),Oe=new ln.Writer,mc=a(function(r,e){for(let t=0;t<
...
writeValues"),gc=a((r={})=>{let e=r.portal||"",t=r.statement||"",n=r.binary||!1,i=r.values||Us,s=i.length;
return M.addCString(e).addCString(t),M.addInt16(s),mc(i,r.valueMapper),M.addInt16(s),M.add(Oe.flush()),
M.addInt16(n?1:0),M.flush(66)},"bind"),wc=d.from([69,0,0,0,9,0,0,0,0,0]),bc=a(r=>{if(!r||!r.portal&&
!r.rows)return wc;let e=r.portal||"",t=r.rows||0,n=d.byteLength(e),i=4+n+1+4,s=d.allocUnsafe(1+i);return s[0]=
...
Sc=M.addCString("P").flush(68),xc=M.addCString("S").flush(68),Ec=a(r=>r.name?fn(68,`${r.type}${r.name||
""}`):r.type==="P"?Sc:xc,"describe"),Ac=a(r=>{let e=`${r.type}${r.name||""}`;return fn(67,e)},"close"),
_c=a(r=>M.add(r).flush(100),"copyData"),Cc=a(r=>fn(102,r),"copyFail"),Pt=a(r=>d.from([r,0,0,0,4]),"c\
...
cancel:vc};Rt.serialize=Bc});var Os=T(Bt=>{"use strict";p();Object.defineProperty(Bt,"__esModule",{value:!0});Bt.BufferReader=void 0;
var Lc=d.allocUnsafe(0),pn=class pn{constructor(e=0){this.offset=e,this.buffer=Lc,this.encoding="utf\
...
offset+e);return this.offset+=e,t}};a(pn,"BufferReader");var hn=pn;Bt.BufferReader=hn});var qs=T(Lt=>{"use strict";p();Object.defineProperty(Lt,"__esModule",{value:!0});Lt.Parser=void 0;var k=an(),
Fc=Os(),dn=1,Mc=4,Qs=dn+Mc,Ns=d.allocUnsafe(0),mn=class mn{constructor(e){if(this.buffer=Ns,this.bufferLength=
...
i+dn),u=dn+o;if(u+i<=n){let c=this.handlePacket(i+Qs,s,o,this.buffer);t(c),i+=u}else break}i===n?(this.
buffer=Ns,this.bufferLength=0,this.bufferOffset=0):(this.bufferLength=n-i,this.bufferOffset=i)}mergeBuffer(e){
...
s.L,c.routine=s.R,c}};a(mn,"Parser");var yn=mn;Lt.Parser=yn});var gn=T(Se=>{"use strict";p();Object.defineProperty(Se,"__esModule",{value:!0});Se.DatabaseError=Se.
serialize=Se.parse=void 0;var kc=an();Object.defineProperty(Se,"DatabaseError",{enumerable:!0,get:a(
function(){return kc.DatabaseError},"get")});var Uc=Ds();Object.defineProperty(Se,"serialize",{enumerable:!0,
get:a(function(){return Uc.serialize},"get")});var Dc=qs();function Oc(r,e){let t=new Dc.Parser;return r.
on("data",n=>t.parse(n,e)),new Promise(n=>r.on("end",()=>n()))}a(Oc,"parse");Se.parse=Oc});var js={};ee(js,{connect:()=>Qc});function Qc({socket:r,servername:e}){return r.startTls(e),r}var Ws=z(
()=>{"use strict";p();a(Qc,"connect")});var vn=T((Hh,$s)=>{"use strict";p();var Hs=(Ge(),D(pi)),Nc=we().EventEmitter,{parse:qc,serialize:Q}=gn(),
Gs=Q.flush(),jc=Q.sync(),Wc=Q.end(),bn=class bn extends Nc{constructor(e){super(),e=e||{},this.stream=
...
stream.writable&&this.stream.write(Gs)}sync(){this._ending=!0,this._send(Gs),this._send(jc)}ref(){this.
...
this._send(Q.copyDone())}sendCopyFail(e){this._send(Q.copyFail(e))}};a(bn,"Connection");var wn=bn;$s.
exports=wn});var zs=T((Kh,Ks)=>{"use strict";p();var Hc=we().EventEmitter,Vh=(it(),D(nt)),Gc=rt(),Sn=cs(),$c=vs(),
Vc=xt(),Kc=It(),Vs=Ms(),zc=tt(),Yc=vn(),xn=class xn extends Hc{constructor(e){super(),this.connectionParameters=
...
_Promise(t=>{this.connection.once("end",t)})}};a(xn,"Client");var Ft=xn;Ft.Query=Vs;Ks.exports=Ft});var Xs=T((Zh,Js)=>{"use strict";p();var Zc=we().EventEmitter,Ys=a(function(){},"NOOP"),Zs=a((r,e)=>{
let t=r.findIndex(e);return t===-1?void 0:r.splice(t,1)[0]},"removeWhere"),_n=class _n{constructor(e,t,n){
this.client=e,this.idleListener=t,this.timeoutId=n}};a(_n,"IdleItem");var En=_n,Cn=class Cn{constructor(e){
this.callback=e}};a(Cn,"PendingItem");var Qe=Cn;function Jc(){throw new Error("Release called on cli\
...
dleListener")}a(Xc,"makeIdleListener");var In=class In extends Zc{constructor(e,t){super(),this.options=
...
callback(o,void 0,Ys);else{if(this.log("new client connected"),this.options.maxLifetimeSeconds!==0){
let u=setTimeout(()=>{this.log("ending client due to expired lifetime"),this._expired.add(t),this._idle.
findIndex(l=>l.client===t)!==-1&&this._acquireClient(t,new Qe((l,f,y)=>y()),n,!1)},this.options.maxLifetimeSeconds*
...
verify?this.options.verify(e,s=>{if(s)return e.release(s),t.callback(s,void 0,Ys);t.callback(void 0,
...
e.unref(),this._idle.push(new En(e,t,s)),this._pulseQueue()}query(e,t,n){if(typeof e=="function"){let s=Mt(
this.Promise,e);return b(function(){return s.callback(new Error("Passing a function as the first par\
ameter to pool.query is not supported"))}),s.result}typeof t=="function"&&(n=t,t=void 0);let i=Mt(this.
...
ed end on pool more than once");return e?e(n):this.Promise.reject(n)}this.ending=!0;let t=Mt(this.Promise,
...
(this._expired.has(t)?1:0),0)}get totalCount(){return this._clients.length}};a(In,"Pool");var An=In;
Js.exports=An});var eo={};ee(eo,{default:()=>el});var el,to=z(()=>{"use strict";p();el={}});var ro=T((tp,tl)=>{tl.exports={name:"pg",version:"8.8.0",description:"PostgreSQL client - pure javas\
...
a178655"}});var so=T((rp,io)=>{"use strict";p();var no=we().EventEmitter,rl=(it(),D(nt)),Tn=rt(),Ne=io.exports=function(r,e,t){
no.call(this),r=Tn.normalizeQueryConfig(r,e,t),this.text=r.text,this.values=r.values,this.name=r.name,
this.callback=r.callback,this.state="new",this._arrayMode=r.rowMode==="array",this._emitRowEvents=!1,
this.on("newListener",function(n){n==="row"&&(this._emitRowEvents=!0)}.bind(this))};rl.inherits(Ne,no);
...
se conflicts and silent errors executing queries"));var n=(this.values||[]).map(Tn.prepareValue);if(r.
...
this.values)){let s=new Error("Query values must be an array");return t(s)}var i=this.values.map(Tn.
prepareValue);r.native.query(this.text,i,t)}else r.native.query(this.text,t)}});var co=T((op,uo)=>{"use strict";p();var il=(to(),D(eo)),sl=xt(),sp=ro(),oo=we().EventEmitter,ol=(it(),D(nt)),
al=It(),ao=so(),J=uo.exports=function(r){oo.call(this),r=r||{},this._Promise=r.Promise||w.Promise,this.
...
ao;ol.inherits(J,oo);J.prototype._errorAllQueries=function(r){let e=a(t=>{m.nextTick(()=>{t.native=this.
...
r,e,t)};J.prototype.getTypeParser=function(r,e){return this._types.getTypeParser(r,e)}});var Pn=T((cp,lo)=>{"use strict";p();lo.exports=co()});var ot=T((fp,at)=>{"use strict";p();var ul=zs(),cl=tt(),ll=vn(),fl=Xs(),{DatabaseError:hl}=gn(),pl=a(
r=>{var e;return e=class extends fl{constructor(n){super(n,r)}},a(e,"BoundPool"),e},"poolFactory"),Rn=a(
...
"u"?at.exports=new Rn(Pn()):(at.exports=new Rn(ul),Object.defineProperty(at.exports,"native",{configurable:!0,
enumerable:!1,get(){var r=null;try{r=new Rn(Pn())}catch(e){if(e.code!=="MODULE_NOT_FOUND")throw e}return Object.
defineProperty(at.exports,"native",{value:r}),r}}))});var ml={};ee(ml,{Client:()=>qe,DatabaseError:()=>je.DatabaseError,NeonDbError:()=>ye,Pool:()=>kt,SqlTemplate:()=>be,
_bundleExt:()=>yl,defaults:()=>je.defaults,encodeBuffersAsBytea:()=>lr,neon:()=>fr,neonConfig:()=>de,
types:()=>je.types});module.exports=D(ml);p();p();Ge();Kt();p();var ua=Object.defineProperty,ca=Object.defineProperties,la=Object.getOwnPropertyDescriptors,yi=Object.
getOwnPropertySymbols,fa=Object.prototype.hasOwnProperty,ha=Object.prototype.propertyIsEnumerable,mi=a(
(r,e,t)=>e in r?ua(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t,"__defNormalProp"),
pa=a((r,e)=>{for(var t in e||(e={}))fa.call(e,t)&&mi(r,t,e[t]);if(yi)for(var t of yi(e))ha.call(e,t)&&
mi(r,t,e[t]);return r},"__spreadValues"),da=a((r,e)=>ca(r,la(e)),"__spreadProps"),ya=1008e3,gi=new Uint8Array(
new Uint16Array([258]).buffer)[0]===2,ma=new TextDecoder,zt=new TextEncoder,pt=zt.encode("0123456789\
abcdef"),dt=zt.encode("0123456789ABCDEF"),ga=zt.encode("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqr\
stuvwxyz0123456789+/");var wi=ga.slice();wi[62]=45;wi[63]=95;var $e,yt;function wa(r,{alphabet:e,scratchArr:t}={}){if(!$e)if($e=
new Uint16Array(256),yt=new Uint16Array(256),gi)for(let _=0;_<256;_++)$e[_]=pt[_&15]<<8|pt[_>>>4],yt[_]=
...
r.buffer,r.byteOffset,s),c=new Uint32Array(o.buffer,o.byteOffset,i),l=e==="upper"?yt:$e,f=0,y=0,g;if(gi)
...
{},e),{scratchArr:o}))}return t}a(ba,"_toHexChunked");function bi(r,e={}){return e.alphabet!=="upper"&&
typeof r.toHex=="function"?r.toHex():ba(r,e)}a(bi,"toHex");p();var Xi=xe(rt());var vt=class vt{constructor(e,t){this.strings=e;this.values=t}compile(e={query:"",params:[]}){let{strings:t,
values:n}=this;for(let i=0,s=t.length;i<s;i++)if(e.query+=t[i],i<n.length){let o=n[i];if(o instanceof
vt)o.compile(e);else{let{params:u}=e,c=lr((0,Xi.prepareValue)(o));u.push(c),e.query+="$"+u.length}}return e}};
a(vt,"SqlTemplate");var be=vt;var is=xe(xt());function lr(r){return r instanceof d?"\\x"+bi(r):r}a(lr,"encodeBuffersAsBytea");var Et=class Et extends Error{constructor(t){
...
"function"&&Error.captureStackTrace(this,Et)}};a(Et,"NeonDbError");var ye=Et,ts="transaction() expec\
...
onstraint","file","line","routine"];function fr(r,{arrayMode:e,fullResults:t,fetchOptions:n,isolationLevel:i,
readOnly:s,deferrable:o,authToken:u}={}){if(!r)throw new Error("No database connection string was pr\
ovided to `neon()`. Perhaps an environment variable has not been set?");let c;try{c=Vt(r)}catch{throw new Error(
...
...`)");return rs(N,new be(P,L))}a(_,"templateFn"),_.query=(P,L,C)=>rs(N,{query:P,params:L??[]},C),_.
unsafe=P=>new be([P],[]),_.transaction=async(P,L)=>{if(typeof P=="function"&&(P=P(_)),!Array.isArray(
P))throw new Error(ts);P.forEach(H=>{if(H[Symbol.toStringTag]!=="NeonQueryPromise")throw new Error(ts)});
let C=P.map(H=>H.query),S=P.map(H=>H.opts??{});return N(C,S,L)};async function N(P,L,C){let{fetchEndpoint:S,
fetchFunction:H}=de,le=Array.isArray(P)?{queries:P.map(V=>V instanceof be?V.compile():V)}:P instanceof
be?P.compile():P,q=n??{},ie=e??!1,se=t??!1,oe=i,B=s,G=o;C!==void 0&&(C.fetchOptions!==void 0&&(q={...q,
...C.fetchOptions}),C.arrayMode!==void 0&&(ie=C.arrayMode),C.fullResults!==void 0&&(se=C.fullResults),
C.isolationLevel!==void 0&&(oe=C.isolationLevel),C.readOnly!==void 0&&(B=C.readOnly),C.deferrable!==
void 0&&(G=C.deferrable)),L!==void 0&&!Array.isArray(L)&&L.fetchOptions!==void 0&&(q={...q,...L.fetchOptions});
let fe=u;!Array.isArray(L)&&L?.authToken!==void 0&&(fe=L.authToken);let _e=typeof S=="function"?S(y,
g,{jwtAuth:fe!==void 0}):S,he={"Neon-Connection-String":r,"Neon-Raw-Text-Output":"true","Neon-Array-\
Mode":"true"},Ce=await Iu(fe);Ce&&(he.Authorization=`Bearer ${Ce}`),Array.isArray(P)&&(oe!==void 0&&
(he["Neon-Batch-Isolation-Level"]=oe),B!==void 0&&(he["Neon-Batch-Read-Only"]=String(B)),G!==void 0&&
(he["Neon-Batch-Deferrable"]=String(G)));let ae;try{ae=await(H??fetch)(_e,{method:"POST",body:JSON.stringify(
le),headers:he,...q})}catch(V){let j=new ye(`Error connecting to database: ${V}`);throw j.sourceError=
V,j}if(ae.ok){let V=await ae.json();if(Array.isArray(P)){let j=V.results;if(!Array.isArray(j))throw new ye(
"Neon internal error: unexpected result format");return j.map((X,K)=>{let We=L[K]??{},yo=We.arrayMode??
ie,mo=We.fullResults??se;return ns(X,{arrayMode:yo,fullResults:mo,types:We.types})})}else{let j=L??{},
X=j.arrayMode??ie,K=j.fullResults??se;return ns(V,{arrayMode:X,fullResults:K,types:j.types})}}else{let{
status:V}=ae;if(V===400){let j=await ae.json(),X=new ye(j.message);for(let K of Cu)X[K]=j[K]??void 0;
throw X}else{let j=await ae.text();throw new ye(`Server error (HTTP status ${V}): ${j}`)}}}return a(
N,"execute"),_}a(fr,"neon");function rs(r,e,t){return{[Symbol.toStringTag]:"NeonQueryPromise",query:e,
opts:t,then:a((n,i)=>r(e,t).then(n,i),"then"),catch:a(n=>r(e,t).catch(n),"catch"),finally:a(n=>r(e,t).
finally(n),"finally")}}a(rs,"createNeonQueryPromise");function ns(r,{arrayMode:e,fullResults:t,types:n}){
let i=new is.default(n),s=r.fields.map(c=>c.name),o=r.fields.map(c=>i.getTypeParser(c.dataTypeID)),u=e===
...
i,r):u}a(ns,"processQueryResult");async function Iu(r){if(typeof r=="string")return r;if(typeof r=="\
function")try{return await Promise.resolve(r())}catch(e){let t=new ye("Error getting auth token.");throw e instanceof
Error&&(t=new ye(`Error getting auth token: ${e.message}`)),t}}a(Iu,"getAuthToken");p();var ho=xe(ot());p();var fo=xe(ot());var Bn=class Bn extends fo.Client{constructor(t){super(t);this.config=t}get neonConfig(){return this.
...
"SASL: Invalid attribute pair entry");let K=X[0],We=X.substring(2);return[K,We]})),c=u.r,l=u.s,f=u.i;
...
length===i.clientNonce.length)throw new Error("SASL: SCRAM-SERVER-FIRST-MESSAGE: server nonce is too\
 short");let y=parseInt(f,10),g=d.from(l,"base64"),A=new TextEncoder,_=A.encode(s),N=await n.importKey(
"raw",_,{name:"HMAC",hash:{name:"SHA-256"}},!1,["sign"]),P=new Uint8Array(await n.sign("HMAC",N,d.concat(
[g,d.from([0,0,0,1])]))),L=P;for(var C=0;C<y-1;C++)P=new Uint8Array(await n.sign("HMAC",N,P)),L=d.from(
L.map((X,K)=>L[K]^P[K]));let S=L,H=await n.importKey("raw",S,{name:"HMAC",hash:{name:"SHA-256"}},!1,
...
"HMAC",G,A.encode(B))),_e=d.from(le.map((X,K)=>le[K]^fe[K])),he=_e.toString("base64");let Ce=await n.
importKey("raw",S,{name:"HMAC",hash:{name:"SHA-256"}},!1,["sign"]),ae=await n.sign("HMAC",Ce,A.encode(
"Server Key")),V=await n.importKey("raw",ae,{name:"HMAC",hash:{name:"SHA-256"}},!1,["sign"]);var j=d.
from(await n.sign("HMAC",V,A.encode(B)));i.message="SASLResponse",i.serverSignature=j.toString("base\
64"),i.response=oe+",p="+he,this.connection.sendSCRAMClientFinalMessage(this.saslSession.response)}};
a(Bn,"NeonClient");var qe=Bn;Ge();var po=xe(It());function dl(r,e){if(e)return{callback:e,result:void 0};let t,n,i=a(function(o,u){o?t(o):n(u)},"cb"),
s=new r(function(o,u){n=o,t=u});return{callback:i,result:s}}a(dl,"promisify");var Ln=class Ln extends ho.Pool{constructor(){
...
t,n,i);typeof n=="function"&&(i=n,n=void 0);let s=dl(this.Promise,i);i=s.callback;try{let o=new po.default(
this.options),u=encodeURIComponent,c=encodeURI,l=`postgresql://${u(o.user)}:${u(o.password)}@${u(o.host)}\
/${c(o.database)}`,f=typeof t=="string"?t:t.text,y=n??t.values??[];fr(l,{fullResults:!0,arrayMode:t.
rowMode==="array"})(f,y,{types:t.types??this.options?.types}).then(A=>i(void 0,A)).catch(A=>i(A))}catch(o){
i(o)}return s.result}};a(Ln,"NeonPool");var kt=Ln;Ge();var je=xe(ot()),yl="js";
