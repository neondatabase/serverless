"use strict";var To=Object.create;var Pe=Object.defineProperty;var Io=Object.getOwnPropertyDescriptor;var Po=Object.getOwnPropertyNames;var Ro=Object.getPrototypeOf,Bo=Object.prototype.hasOwnProperty;var Lo=(r,e,t)=>e in r?Pe(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t;var a=(r,e)=>Pe(r,"name",{value:e,configurable:!0});var G=(r,e,t)=>()=>{if(t)throw t[0];try{return r&&(e=r(r=0)),e}catch(n){throw t=[n],n}};var I=(r,e)=>()=>{try{return e||r((e={exports:{}}).exports,e),e.exports}catch(t){throw e=0,t}},re=(r,e)=>{
...
enumerable});return r};var ve=(r,e,t)=>(t=r!=null?To(Ro(r)):{},Wn(e||!r||!r.__esModule?Pe(t,"default",{value:r,enumerable:!0}):
t,r)),O=r=>Wn(Pe({},"__esModule",{value:!0}),r);var v=(r,e,t)=>Lo(r,typeof e!="symbol"?e+"":e,t);var $n=I(ht=>{"use strict";p();ht.byteLength=Fo;ht.toByteArray=Uo;ht.fromByteArray=qo;var ce=[],ne=[],
ko=typeof Uint8Array<"u"?Uint8Array:Array,Nt="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz01\
...
function Fo(r){var e=Hn(r),t=e[0],n=e[1];return(t+n)*3/4-n}a(Fo,"byteLength");function Mo(r,e,t){return(e+
t)*3/4-t}a(Mo,"_byteLength");function Uo(r){var e,t=Hn(r),n=t[0],i=t[1],s=new ko(Mo(r,n,i)),o=0,u=i>
...
4|ne[r.charCodeAt(c+2)]>>2,s[o++]=e>>8&255,s[o++]=e&255),s}a(Uo,"toByteArray");function Do(r){return ce[r>>
18&63]+ce[r>>12&63]+ce[r>>6&63]+ce[r&63]}a(Do,"tripletToBase64");function Oo(r,e,t){for(var n,i=[],s=e;s<
...
i.push(ce[e>>10]+ce[e>>4&63]+ce[e<<2&63]+"=")),i.join("")}a(qo,"fromByteArray")});var Gn=I(Wt=>{p();Wt.read=function(r,e,t,n,i){var s,o,u=i*8-n-1,c=(1<<u)-1,l=c>>1,f=-7,y=t?i-1:0,w=t?
...
50;var pt=2147483647;ke.kMaxLength=pt;h.TYPED_ARRAY_SUPPORT=Qo();!h.TYPED_ARRAY_SUPPORT&&typeof console<
...
for option "size"')}a(Jn,"assertSize");function No(r,e,t){return Jn(r),r<=0?de(r):e!==void 0?typeof t==
"string"?de(r).fill(e,t):de(r).fill(e):de(r)}a(No,"alloc");h.alloc=function(r,e,t){return No(r,e,t)};
function Vt(r){return Jn(r),de(r<0?0:zt(r)|0)}a(Vt,"allocUnsafe");h.allocUnsafe=function(r){return Vt(
r)};h.allocUnsafeSlow=function(r){return Vt(r)};function Wo(r,e){if((typeof e!="string"||e==="")&&(e=
"utf8"),!h.isEncoding(e))throw new TypeError("Unknown encoding: "+e);let t=Xn(r,e)|0,n=de(t),i=n.write(
r,e);return i!==t&&(n=n.slice(0,i)),n}a(Wo,"fromString");function Ht(r){let e=r.length<0?0:zt(r.length)|
0,t=de(e);for(let n=0;n<e;n+=1)t[n]=r[n]&255;return t}a(Ht,"fromArrayLike");function jo(r){if(le(r,Uint8Array)){
let e=new Uint8Array(r);return $t(e.buffer,e.byteOffset,e.byteLength)}return Ht(r)}a(jo,"fromArrayVi\
...
a(Ho,"fromObject");function zt(r){if(r>=pt)throw new RangeError("Attempt to allocate Buffer larger t\
han maximum size: 0x"+pt.toString(16)+" bytes");return r|0}a(zt,"checked");function $o(r){return+r!=
...
if(i)return n?-1:Gt(r).length;e=(""+e).toLowerCase(),i=!0}}a(Xn,"byteLength");h.byteLength=Xn;function Go(r,e,t){
...
0;o<n;++o){let u=parseInt(e.substr(o*2,2),16);if(Yt(u))return o;r[t+o]=u}return o}a(Vo,"hexWrite");function zo(r,e,t,n){
return dt(Gt(e,r.length-t),r,t,n)}a(zo,"utf8Write");function Ko(r,e,t,n){return dt(aa(e),r,t,n)}a(Ko,
"asciiWrite");function Yo(r,e,t,n){return dt(ui(e),r,t,n)}a(Yo,"base64Write");function Zo(r,e,t,n){return dt(
...
N");function Jo(r,e,t){return e===0&&t===r.length?jt.fromByteArray(r):jt.fromByteArray(r.slice(e,t))}
...
n.push(o),i+=u}return Xo(n)}a(ti,"utf8Slice");var Kn=4096;function Xo(r){let e=r.length;if(e<=Kn)return String.
fromCharCode.apply(String,r);let t="",n=0;for(;n<e;)t+=String.fromCharCode.apply(String,r.slice(n,n+=
Kn));return t}a(Xo,"decodeCodePointsArray");function ea(r,e,t){let n="";t=Math.min(r.length,t);for(let i=e;i<
...
Le(e,"offset"),(r[e]===void 0||r[e+t]===void 0)&&ze(e,r.length-(t+1))}a(ia,"checkBounds");function ai(r,e,t,n,i,s){
...
nd <= ${t}${o}`,new Re.ERR_OUT_OF_RANGE("value",u,r)}ia(n,i,s)}a(ai,"checkIntBI");function Le(r,e){if(typeof r!=
...
new Re.ERR_OUT_OF_RANGE(t||"offset",`>= ${t?1:0} and <= ${e}`,r)}a(ze,"boundsError");var sa=/[^+/0-9A-Za-z-_]/g;
function oa(r){if(r=r.split("=")[0],r=r.trim().replace(sa,""),r.length<2)return"";for(;r.length%4!==
0;)r=r+"=";return r}a(oa,"base64clean");function Gt(r,e){e=e||1/0;let t,n=r.length,i=null,s=[];for(let o=0;o<
...
o),n=t>>8,i=t%256,s.push(i),s.push(n);return s}a(ua,"utf16leToBytes");function ui(r){return jt.toByteArray(
oa(r))}a(ui,"base64ToBytes");function dt(r,e,t,n){let i;for(i=0;i<n&&!(i+t>=e.length||i>=r.length);++i)
...
r}a(Yt,"numberIsNaN");var ca=(function(){let r="0123456789abcdef",e=new Array(256);for(let t=0;t<16;++t){
...
m.nextTick(()=>{})}catch{let e=Promise.resolve();m.nextTick=e.then.bind(e)}});var Se=I((Yl,Zt)=>{"use strict";p();var Fe=typeof Reflect=="object"?Reflect:null,li=Fe&&typeof Fe.apply==
...
init.call(this)}a(R,"EventEmitter");Zt.exports=R;Zt.exports.once=ya;R.EventEmitter=R;R.prototype._events=
...
r,u.type=e,u.count=o.length,fa(u)}return r}a(di,"_addListener");R.prototype.addListener=a(function(e,t){
...
da(i):wi(i,i.length)}a(mi,"_listeners");R.prototype.listeners=a(function(e){return mi(this,e,!0)},"l\
...
ust be of type EventEmitter. Received type '+typeof r)}a(bi,"eventTargetAgnosticAddListener")});var Si={};re(Si,{Socket:()=>oe,isIP:()=>ga});function ga(r){return 0}var xi,vi,E,oe,Me=G(()=>{"use s\
trict";p();xi=ve(Se(),1);a(ga,"isIP");vi=/^[^.]+\./,E=class E extends xi.EventEmitter{constructor(){
...
disableWarningInBrowsers:!1}),v(E,"opts",{});oe=E});var Ei={};re(Ei,{parse:()=>Jt});function Jt(r,e=!1){let{protocol:t}=new URL(r),n="http:"+r.substring(
...
pathname:l,search:f,query:_,hash:w}}var Xt=G(()=>{"use strict";p();a(Jt,"parse")});var nr=I(Pi=>{"use strict";p();Pi.parse=function(r,e){return new rr(r,e).parse()};var xt=class xt{constructor(e,t){
...
not balanced");return this.entries}};a(xt,"ArrayParser");var rr=xt;function Ra(r){return r}a(Ra,"ide\
ntity")});var ir=I((gf,Ri)=>{p();var Ba=nr();Ri.exports={create:a(function(r,e){return{parse:a(function(){return Ba.
parse(r,e)},"parse")}},"create")}});var ki=I((vf,Li)=>{"use strict";p();var La=/(\d{1,})-(\d{2})-(\d{2}) (\d{2}):(\d{2}):(\d{2})(\.\d{1,})?.*?( BC)?$/,
...
new Date(i,s,o,u,c,l,f),sr(i)&&y.setFullYear(i)),y},"parseDate");function Ua(r){var e=ka.exec(r);if(e){
...
1)}a(Bi,"bcYearToNegativeYear");function sr(r){return r>=0&&r<100}a(sr,"is0To99")});var Mi=I((Ef,Fi)=>{p();Fi.exports=qa;var Oa=Object.prototype.hasOwnProperty;function qa(r){for(var e=1;e<
arguments.length;e++){var t=arguments[e];for(var n in t)Oa.call(t,n)&&(r[n]=t[n])}return r}a(qa,"ext\
end")});var Oi=I((Cf,Di)=>{"use strict";p();var Qa=Mi();Di.exports=Oe;function Oe(r){if(!(this instanceof Oe))
return new Oe(r);Qa(this,Ja(r))}a(Oe,"PostgresInterval");var Na=["seconds","minutes","hours","days",
"months","years"];Oe.prototype.toPostgres=function(){var r=Na.filter(this.hasOwnProperty,this);return this.
...
S"},ja=["years","months","days"],Ha=["hours","minutes","seconds"];Oe.prototype.toISOString=Oe.prototype.
...
!o)||(t&&~Ya.indexOf(i)&&(o*=-1),n[i]=o),n},{})}a(Ja,"parse")});var Ni=I((Pf,Qi)=>{"use strict";p();var qi=d.from||d;Qi.exports=a(function(e){if(/^\\x/.test(e))return qi(
...
y")},"parseBytea")});var zi=I((Lf,Vi)=>{p();var Ze=nr(),Je=ir(),St=ki(),ji=Oi(),Hi=Ni();function Et(r){return a(function(t){
...
t");function ar(r){return r?Ze.parse(r,Et(eu)):null}a(ar,"parseIntegerArray");function tu(r){return r?
Ze.parse(r,Et(function(e){return Gi(e).trim()})):null}a(tu,"parseBigIntegerArray");var ru=a(function(r){
...
function(t){return t!==null&&(t=St(t)),t});return e.parse()},"parseDateArray"),nu=a(function(r){if(!r)
return null;var e=Je.create(r,function(t){return t!==null&&(t=ji(t)),t});return e.parse()},"parseInt\
ervalArray"),iu=a(function(r){return r?Ze.parse(r,Et(Hi)):null},"parseByteAArray"),lr=a(function(r){
return parseInt(r,10)},"parseInteger"),Gi=a(function(r){var e=String(r);return/^\d+$/.test(e)?e:r},"\
parseBigInteger"),Wi=a(function(r){return r?Ze.parse(r,Et(JSON.parse)):null},"parseJsonArray"),fr=a(
...
r(23,lr),r(26,lr),r(700,parseFloat),r(701,parseFloat),r(16,$i),r(1082,St),r(1114,St),r(1184,St),r(600,
fr),r(651,ie),r(718,su),r(1e3,Xa),r(1001,iu),r(1005,ar),r(1007,ar),r(1028,ar),r(1016,tu),r(1017,ru),
r(1021,ur),r(1022,ur),r(1231,ur),r(1014,ie),r(1015,ie),r(1008,ie),r(1009,ie),r(1040,ie),r(1041,ie),r(
1115,cr),r(1182,cr),r(1185,cr),r(1186,ji),r(1187,nu),r(17,Hi),r(114,JSON.parse.bind(JSON)),r(3802,JSON.
parse.bind(JSON)),r(199,Wi),r(3807,Wi),r(3907,ie),r(2951,ie),r(791,ie),r(1183,ie),r(1270,ie)},"init");
Vi.exports={init:ou}});var Yi=I((Mf,Ki)=>{"use strict";p();var z=1e6;function au(r){var e=r.readInt32BE(0),t=r.readUInt32BE(
...
""+o%z,n+u+i}a(au,"readInt8");Ki.exports=au});var ts=I((Of,es)=>{p();var uu=Yi(),k=a(function(r,e,t,n,i){t=t||0,n=n||!1,i=i||function(A,_,D){return A*
...
r(1008,Xe),r(1009,Xe),r(25,pu)},"init");es.exports={init:yu}});var ns=I((Nf,rs)=>{p();rs.exports={BOOL:16,BYTEA:17,CHAR:18,INT8:20,INT2:21,INT4:23,REGPROC:24,TEXT:25,
...
REGROLE:4096}});var rt=I(tt=>{p();var mu=zi(),gu=ts(),wu=ir(),bu=ns();tt.getTypeParser=vu;tt.setTypeParser=xu;tt.arrayParser=
...
et.binary[r]=e})});var _t=I((Gf,ss)=>{"use strict";p();var Su=rt();function At(r){this._types=r||Su,this.text={},this.binary=
...
e||"text",this.getOverrides(e)[r]||this._types.getTypeParser(r,e)};ss.exports=At});function nt(r){let e=1779033703,t=3144134277,n=1013904242,i=2773480762,s=1359893119,o=2600822924,u=528734635,
...
24|_[j+1]<<16|_[j+2]<<8|_[j+3];for(let B=16;B<64;B++){let j=w(A[B-15],7)^w(A[B-15],18)^A[B-15]>>>3,he=w(
A[B-2],17)^w(A[B-2],19)^A[B-2]>>>10;A[B]=A[B-16]+j+A[B-7]+he|0}let T=e,g=t,Z=n,W=i,X=s,ee=o,ae=u,ue=c;
for(let B=0;B<64;B++){let j=w(X,6)^w(X,11)^w(X,25),he=X&ee^~X&ae,ge=ue+j+he+y[B]+A[B]|0,Ve=w(T,2)^w(
T,13)^w(T,22),pe=T&g^T&Z^g&Z,Ie=Ve+pe|0;ue=ae,ae=ee,ee=X,X=W+ge|0,W=Z,Z=g,g=T,T=ge+Ie|0}e=e+T|0,t=t+
...
return r===void 0?{add:Y,digest:P}:(Y(r),P())}var os=G(()=>{"use strict";p();a(nt,"sha256")});var U,it,as=G(()=>{"use strict";p();U=class U{constructor(){v(this,"_dataLength",0);v(this,"_bufferL\
...
abcdef"),v(U,"hexOut",[]),v(U,"onePassHasher",new U);it=U});var hr={};re(hr,{createHash:()=>Au,createHmac:()=>_u,randomBytes:()=>Eu});function Eu(r){return crypto.
...
a(_u,"createHmac")});var st=I((sh,dr)=>{"use strict";p();dr.exports={host:"localhost",user:m.platform==="win32"?m.env.USERNAME:
...
keepalives:1,keepalives_idle:0};var qe=rt(),Cu=qe.getTypeParser(20,"text"),Tu=qe.getTypeParser(1016,
"text");dr.exports.__defineSetter__("parseInt8",function(r){qe.setTypeParser(20,"text",r?qe.getTypeParser(
23,"text"):Cu),qe.setTypeParser(1016,"text",r?qe.getTypeParser(1007,"text"):Tu)})});var ot=I((ah,cs)=>{"use strict";p();var Iu=(pr(),O(hr)),Pu=st();function Ru(r){var e=r.replace(/\\/g,
...
r[t]instanceof d?e+="\\\\x"+r[t].toString("hex"):e+=Ru(Ct(r[t]));return e=e+"}",e}a(us,"arrayString");
...
r query');return e.push(r),Ct(r.toPostgres(Ct),e)}return JSON.stringify(r)}a(Bu,"prepareObject");function N(r,e){
...
"postgresMd5PasswordHash");cs.exports={prepareValue:a(function(e){return Ct(e)},"prepareValueWrapper"),
normalizeQueryConfig:Fu,postgresMd5PasswordHash:Mu,md5:yr}});var at={};re(at,{default:()=>qu});var qu,ut=G(()=>{"use strict";p();qu={}});var bs=I((vh,ws)=>{"use strict";p();var wr=(pr(),O(hr));function Qu(r){if(r.indexOf("SCRAM-SHA-256")===
...
","+l+","+f,w=Qe(u,y),A=gs(o,w),_=A.toString("base64"),D=Qe(s,"Server Key"),Y=Qe(D,y);r.message="SAS\
...
function $u(r){let t=ms(r).get("v");if(t){if(!ys(t))throw new Error("SASL: SCRAM-SERVER-FINAL-MESSAG\
E: server signature must be base64")}else throw new Error("SASL: SCRAM-SERVER-FINAL-MESSAGE: server \
signature is missing");return{serverSignature:t}}a($u,"parseServerFinalMessage");function gs(r,e){if(!d.
...
a(gs,"xorBuffers");function Gu(r){return wr.createHash("sha256").update(r).digest()}a(Gu,"sha256");function Qe(r,e){
...
ict";p();a(Ku,"stat")});var Er={};re(Er,{default:()=>Yu});var Yu,Ar=G(()=>{"use strict";p();Yu={}});var vs={};re(vs,{StringDecoder:()=>_r});var Cr,_r,xs=G(()=>{"use strict";p();Cr=class Cr{constructor(e){
v(this,"td");this.td=new TextDecoder(e)}write(e){return this.td.decode(e,{stream:!0})}end(e){return this.
td.decode(e)}};a(Cr,"StringDecoder");_r=Cr});var _s=I((Rh,As)=>{"use strict";p();var{Transform:Zu}=(Ar(),O(Er)),{StringDecoder:Ju}=(xs(),O(vs)),Ae=Symbol(
...
this[Ae].split(this.matcher);this[Ae]=n.pop();for(let i=0;i<n.length;i++)try{Es(this,this.mapper(n[i]))}catch(s){
...
try{Es(this,this.mapper(this[Ae]))}catch(e){return r(e)}r()}a(ec,"flush");function Es(r,e){e!==void 0&&
...
!1,s(i)},n}a(tc,"split");As.exports=tc});var Is=I((kh,me)=>{"use strict";p();var Cs=(vr(),O(br)),rc=(Ar(),O(Er)).Stream,nc=_s(),Ts=(ut(),O(at)),
ic=5432,Pt=m.platform==="win32",ct=m.stderr,sc=56,oc=7,ac=61440,uc=32768;function cc(r){return(r&ac)==
...
`);ct.write(Ts.format.apply(Ts,e))}}a(Ir,"warn");Object.defineProperty(me.exports,"isWin",{get:a(function(){
return Pt},"get"),set:a(function(r){Pt=r},"set")});me.exports.warnTo=function(r){var e=ct;return ct=
r,e};me.exports.getFileName=function(r){var e=r||m.env,t=e.PGPASSFILE||(Pt?Cs.join(e.APPDATA||"./","\
postgresql","pgpass.conf"):Cs.join(e.HOME||"./",".pgpass"));return t};me.exports.usePgPass=function(r,e){
return Object.prototype.hasOwnProperty.call(m.env,"PGPASSWORD")?!1:Pt?!0:(e=e||"<unkn>",cc(r.mode)?r.
...
0}},t=0;t<Ne.length;t+=1){var n=e[t],i=r[Ne[t]]||"",s=n(i);if(!s)return!1}return!0}});var Rs=I((Dh,Pr)=>{"use strict";p();var Uh=(vr(),O(br)),Ps=(Sr(),O(xr)),Rt=Is();Pr.exports=function(r,e){
var t=Rt.getFileName();Ps.stat(t,function(n,i){if(n||!Rt.usePgPass(i,t))return e(void 0);var s=Ps.createReadStream(
t);Rt.getPassword(r,s,e)})};Pr.exports.warnTo=Rt.warnTo});var Bs={};re(Bs,{default:()=>dc});var dc,Ls=G(()=>{"use strict";p();dc={}});var Lr=I((Qh,ks)=>{"use strict";p();var yc=(Xt(),O(Ei)),Rr=(Sr(),O(xr));function Br(r){if(r.charAt(0)===
...
!1;break}}return t}a(Br,"parse");ks.exports=Br;Br.parse=Br});var Bt=I((jh,Us)=>{"use strict";p();var mc=(Ls(),O(Bs)),Ms=st(),Fs=Lr().parse,H=a(function(r,e,t){return t===
...
no-verify":return{rejectUnauthorized:!1}}return Ms.ssl},"readSSLConfigFromEnvironment"),We=a(function(r){
return"'"+(""+r).replace(/\\/g,"\\\\").replace(/'/g,"\\'")+"'"},"quoteParamValue"),se=a(function(r,e,t){
var n=e[t];n!=null&&r.push(t+"="+We(n))},"add"),Fr=class Fr{constructor(e){e=typeof e=="string"?Fs(e):
...
a(Fr,"ConnectionParameters");var kr=Fr;Us.exports=kr});var qs=I((Gh,Os)=>{"use strict";p();var wc=rt(),Ds=/^([A-Za-z]+)(?: (\d+))?(?: (\d+))?/,Ur=class Ur{constructor(e,t){
...
format||"text")}}};a(Ur,"Result");var Mr=Ur;Os.exports=Mr});var js=I((Kh,Ws)=>{"use strict";p();var{EventEmitter:bc}=Se(),Qs=qs(),Ns=ot(),Or=class Or extends bc{constructor(e,t,n){
...
ssage");var Jr=pn;C.NoticeMessage=Jr});var Hs=I(Lt=>{"use strict";p();Object.defineProperty(Lt,"__esModule",{value:!0});Lt.Writer=void 0;var mn=class mn{constructor(e=256){
...
a(mn,"Writer");var yn=mn;Lt.Writer=yn});var Gs=I(Ft=>{"use strict";p();Object.defineProperty(Ft,"__esModule",{value:!0});Ft.serialize=void 0;
var gn=Hs(),L=new gn.Writer,vc=a(r=>{L.addInt16(3).addInt16(0);for(let n of Object.keys(r))L.addCString(
...
FinalMessage"),_c=a(r=>L.addCString(r).flush(81),"query"),$s=[],Cc=a(r=>{let e=r.name||"";e.length>63&&
...
Wc});var Vs=I(Mt=>{"use strict";p();Object.defineProperty(Mt,"__esModule",{value:!0});Mt.BufferReader=void 0;
...
offset+=e,t}};a(vn,"BufferReader");var bn=vn;Mt.BufferReader=bn});var Zs=I(Ut=>{"use strict";p();Object.defineProperty(Ut,"__esModule",{value:!0});Ut.Parser=void 0;var F=dn(),
jc=Vs(),Sn=1,Hc=4,zs=Sn+Hc,J=-1,xn=d.allocUnsafe(0),An=class An{constructor(e){if(this.buffer=xn,this.
...
readUInt32BE(i+Sn),u=Sn+o;if(u+i<=n){let c=this.handlePacket(i+zs,s,o,this.buffer);t(c),i+=u}else break}
...
o=Yc(s);break;case 82:o=nl(s,n);break;case 83:o=tl(s);break;case 75:o=rl(s);break;case 69:o=Ks(s,"er\
ror");break;case 78:o=Ks(s,"notice");break;case 84:o=Zc(s);break;case 116:o=Xc(s);break;case 71:o=zc(
...
Data"),zc=a(r=>Ys(r,"copyInResponse"),"parseCopyInMessage"),Kc=a(r=>Ys(r,"copyOutResponse"),"parseCo\
...
function(){return il.DatabaseError},"get")});var sl=Gs();Object.defineProperty(Te,"serialize",{enumerable:!0,
get:a(function(){return sl.serialize},"get")});var ol=Zs();function al(r,e){let t=new ol.Parser;return r.
on("data",n=>t.parse(n,e)),new Promise(n=>r.on("end",()=>n()))}a(al,"parse")});var Js={};re(Js,{connect:()=>ul});function ul({socket:r,servername:e}){return r.startTls(e),r}var Xs=G(
()=>{"use strict";p();a(ul,"connect")});var In=I((wp,ro)=>{"use strict";p();var eo=(Me(),O(Si)),cl=Se().EventEmitter,{parse:ll,serialize:Q}=_n(),
to=Q.flush(),fl=Q.sync(),hl=Q.end(),Tn=class Tn extends cl{constructor(e){super(),e=e||{},this.stream=
...
stream.writable&&this.stream.write(to)}sync(){this._ending=!0,this._send(to),this._send(fl)}ref(){this.
...
this._send(Q.copyDone())}sendCopyFail(e){this._send(Q.copyFail(e))}};a(Tn,"Connection");var Cn=Tn;ro.
exports=Cn});var so=I((Sp,io)=>{"use strict";p();var pl=Se().EventEmitter,xp=(ut(),O(at)),dl=ot(),Pn=bs(),yl=Rs(),
ml=_t(),gl=Bt(),no=js(),wl=st(),bl=In(),Rn=class Rn extends pl{constructor(e){super(),this.connectionParameters=
...
_Promise(t=>{this.connection.once("end",t)})}};a(Rn,"Client");var Dt=Rn;Dt.Query=no;io.exports=Dt});var uo=I((_p,ao)=>{"use strict";p();var vl=Se().EventEmitter,Bn=a(function(){},"NOOP"),oo=a((r,e)=>{
...
ao.exports=kn});var co={};re(co,{default:()=>El});var El,lo=G(()=>{"use strict";p();El={}});var fo=I((Pp,Al)=>{Al.exports={name:"pg",version:"8.8.0",description:"PostgreSQL client - pure javas\
...
a178655"}});var yo=I((Rp,po)=>{"use strict";p();var ho=Se().EventEmitter,_l=(ut(),O(at)),Dn=ot(),$e=po.exports=function(r,e,t){
...
this.on("newListener",function(n){n==="row"&&(this._emitRowEvents=!0)}.bind(this))};_l.inherits($e,ho);
...
prepareValue);r.native.query(this.text,i,t)}else r.native.query(this.text,t)}});var bo=I((Fp,wo)=>{"use strict";p();var Tl=(lo(),O(co)),Il=_t(),kp=fo(),mo=Se().EventEmitter,Pl=(ut(),O(at)),
Rl=Bt(),go=yo(),K=wo.exports=function(r){mo.call(this),r=r||{},this._Promise=r.Promise||b.Promise,this.
...
go;Pl.inherits(K,mo);K.prototype._errorAllQueries=function(r){let e=a(t=>{m.nextTick(()=>{t.native=this.
...
r,e,t)};K.prototype.getTypeParser=function(r,e){return this._types.getTypeParser(r,e)}});var On=I((Dp,vo)=>{"use strict";p();vo.exports=bo()});var lt=I((qp,ft)=>{"use strict";p();var Bl=so(),Ll=st(),kl=In(),Fl=uo(),{DatabaseError:Ml}=_n(),Ul=a(
...
_pools=[],this.Connection=kl,this.types=rt(),this.DatabaseError=Ml},"PG");typeof m.env.NODE_PG_FORCE_NATIVE<
...
defineProperty(ft.exports,"native",{value:r}),r}}))});var ql={};re(ql,{Client:()=>Ge,DatabaseError:()=>fe.DatabaseError,NeonDbError:()=>ye,NeonQueryPromise:()=>Ee,
Pool:()=>qt,SqlTemplate:()=>Ue,UnsafeRawSql:()=>De,_bundleExt:()=>Ol,defaults:()=>fe.defaults,escapeIdentifier:()=>fe.escapeIdentifier,
escapeLiteral:()=>fe.escapeLiteral,neon:()=>mr,neonConfig:()=>oe,parseConnectionString:()=>Ao.parse,
types:()=>fe.types,warnIfBrowser:()=>Ye});module.exports=O(ql);p();p();Me();Xt();p();var wa=Object.defineProperty,ba=Object.defineProperties,va=Object.getOwnPropertyDescriptors,Ai=Object.
...
Ea=a((r,e)=>{for(var t in e||(e={}))xa.call(e,t)&&_i(r,t,e[t]);if(Ai)for(var t of Ai(e))Sa.call(e,t)&&
_i(r,t,e[t]);return r},"__spreadValues"),Aa=a((r,e)=>ba(r,va(e)),"__spreadProps"),_a=1008e3,Ci=new Uint8Array(
new Uint16Array([258]).buffer)[0]===2,Ca=new TextDecoder,er=new TextEncoder,gt=er.encode("0123456789\
abcdef"),wt=er.encode("0123456789ABCDEF"),Ta=er.encode("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqr\
stuvwxyz0123456789+/");var Ti=Ta.slice();Ti[62]=45;Ti[63]=95;var Ke,bt;function Ia(r,{alphabet:e,scratchArr:t}={}){if(!Ke)if(Ke=
...
r.buffer,r.byteOffset,s),c=new Uint32Array(o.buffer,o.byteOffset,i),l=e==="upper"?bt:Ke,f=0,y=0,w;if(Ci)
...
{},e),{scratchArr:o}))}return t}a(Pa,"_toHexChunked");function Ii(r,e={}){return e.alphabet!=="upper"&&
typeof r.toHex=="function"?r.toHex():Pa(r,e)}a(Ii,"toHex");p();var vt=class vt{constructor(e,t){v(this,"strings",e);v(this,"values",t)}toParameterizedQuery(e={query:"",
...
d||ArrayBuffer.isView(o))&&(e.query+="::bytea")}}return e}};a(vt,"SqlTemplate");var Ue=vt,tr=class tr{constructor(e){
v(this,"sql",e)}};a(tr,"UnsafeRawSql");var De=tr;p();function Ye(){typeof window<"u"&&typeof document<"u"&&typeof console<"u"&&typeof console.warn=="func\
tion"&&console.warn(`          
        ************************************************************
        *                                                          *
        ...
        *  parameter.                                              *
        *                                                          *
        ************************************************************`)}a(Ye,"warnIfBrowser");Me();var ps=ve(_t()),ds=ve(ot());var Tt=class Tt extends Error{constructor(t){super(t);v(this,"name","NeonDbError");v(this,"severity");
...
Tt,"NeonDbError");var ye=Tt,ls="transaction() expects an array of queries, or a function returning a\
...
return r instanceof d?"\\x"+Ii(r):r}a(Du,"encodeBuffersAsBytea");function fs(r){let{query:e,params:t}=r instanceof
Ue?r.toParameterizedQuery():r;return{query:e,params:t.map(n=>Du((0,ds.prepareValue)(n)))}}a(fs,"prep\
...
P.forEach(W=>{if(!(W instanceof Ee))throw new Error(ls)});let g=P.map(W=>W.queryData),Z=P.map(W=>W.opts??
{});return Y(g,Z,T)};async function Y(P,T,g){let{fetchEndpoint:Z,fetchFunction:W}=oe,X=Array.isArray(
P)?{queries:P.map(te=>fs(te))}:fs(P),ee=n??{},ae=e??!1,ue=t??!1,B=i,j=s,he=o;g!==void 0&&(g.fetchOptions!==
...
"function"?Z(w,A,{jwtAuth:ge!==void 0}):Z,pe={"Neon-Connection-String":r,"Neon-Raw-Text-Output":"tru\
...
lt format");return M.map(($,be)=>{let Qt=T[be]??{},_o=Qt.arrayMode??ae,Co=Qt.fullResults??ue;return hs(
$,{arrayMode:_o,fullResults:Co,types:Qt.types})})}else{let M=T??{},$=M.arrayMode??ae,be=M.fullResults??
ue;return hs(te,{arrayMode:$,fullResults:be,types:M.types})}}else{let{status:te}=we;if(te===400){let M=await we.
json(),$=new ye(M.message);for(let be of Uu)$[be]=M[be]??void 0;throw $}else{let M=await we.text();throw new ye(
`Server error (HTTP status ${te}): ${M}`)}}}return a(Y,"execute"),D}a(mr,"neon");var gr=class gr{constructor(e,t,n){
...
execute(this.queryData,this.opts).finally(e)}};a(gr,"NeonQueryPromise");var Ee=gr;function hs(r,{arrayMode:e,
...
o,r._types=i,r):u}a(hs,"processQueryResult");async function Ou(r){if(typeof r=="string")return r;if(typeof r==
"function")try{return await Promise.resolve(r())}catch(e){let t=new ye("Error getting auth token.");
throw e instanceof Error&&(t=new ye(`Error getting auth token: ${e.message}`)),t}}a(Ou,"getAuthToken");p();var So=ve(lt());p();var xo=ve(lt());var Qn=class Qn extends xo.Client{constructor(t){super(t);v(this,"config",t)}get neonConfig(){return this.
...
W),ee="n=*,r="+i.clientNonce,ae="r="+c+",s="+l+",i="+y,ue="c=biws,r="+c,B=ee+","+ae+","+ue,j=await n.
...
"NeonClient");var Ge=Qn;Me();var Eo=ve(Bt());function Dl(r,e){if(e)return{callback:e,result:void 0};let t,n,i=a(function(o,u){o?t(o):n(u)},"cb"),
s=new r(function(o,u){n=o,t=u});return{callback:i,result:s}}a(Dl,"promisify");var Nn=class Nn extends So.Pool{constructor(){
super(...arguments);v(this,"Client",Ge);v(this,"hasFetchUnsupportedListeners",!1);v(this,"addListene\
...
t,n,i);typeof n=="function"&&(i=n,n=void 0);let s=Dl(this.Promise,i);i=s.callback;try{let o=new Eo.default(
...
A))}catch(o){i(o)}return s.result}};a(Nn,"NeonPool");var qt=Nn;Me();var fe=ve(lt()),Ao=ve(Lr()),Ol="js";
