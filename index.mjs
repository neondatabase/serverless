var mo=Object.create;var Ce=Object.defineProperty;var go=Object.getOwnPropertyDescriptor;var wo=Object.getOwnPropertyNames;var bo=Object.getPrototypeOf,vo=Object.prototype.hasOwnProperty;var So=(r,e,t)=>e in r?Ce(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t;var a=(r,e)=>Ce(r,"name",{value:e,configurable:!0});var K=(r,e)=>()=>(r&&(e=r(r=0)),e);var T=(r,e)=>()=>(e||r((e={exports:{}}).exports,e),e.exports),ne=(r,e)=>{for(var t in e)Ce(r,t,{get:e[t],
enumerable:!0})},Bn=(r,e,t,n)=>{if(e&&typeof e=="object"||typeof e=="function")for(let i of wo(e))!vo.
call(r,i)&&i!==t&&Ce(r,i,{get:()=>e[i],enumerable:!(n=go(e,i))||n.enumerable});return r};var Se=(r,e,t)=>(t=r!=null?mo(bo(r)):{},Bn(e||!r||!r.__esModule?Ce(t,"default",{value:r,enumerable:!0}):
t,r)),D=r=>Bn(Ce({},"__esModule",{value:!0}),r);var E=(r,e,t)=>So(r,typeof e!="symbol"?e+"":e,t);var Mn=T(at=>{"use strict";p();at.byteLength=Eo;at.toByteArray=_o;at.fromByteArray=To;var ue=[],ee=[],
xo=typeof Uint8Array<"u"?Uint8Array:Array,Mt="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz01\
...
function Eo(r){var e=Fn(r),t=e[0],n=e[1];return(t+n)*3/4-n}a(Eo,"byteLength");function Ao(r,e,t){return(e+
t)*3/4-t}a(Ao,"_byteLength");function _o(r){var e,t=Fn(r),n=t[0],i=t[1],s=new xo(Ao(r,n,i)),o=0,u=i>
...
4|ee[r.charCodeAt(c+2)]>>2,s[o++]=e>>8&255,s[o++]=e&255),s}a(_o,"toByteArray");function Co(r){return ue[r>>
...
i.push(ue[e>>10]+ue[e>>4&63]+ue[e<<2&63]+"=")),i.join("")}a(To,"fromByteArray")});var kn=T(kt=>{p();kt.read=function(r,e,t,n,i){var s,o,u=i*8-n-1,c=(1<<u)-1,l=c>>1,f=-7,d=t?i-1:0,g=t?
...
_,u/=256,i-=8);for(o=o<<i|u,l+=i;l>0;r[t+A]=o&255,A+=_,o/=256,l-=8);r[t+A-_]|=N*128}});var Jn=T(Re=>{"use strict";p();var Ut=Mn(),Te=kn(),Un=typeof Symbol=="function"&&typeof Symbol.for==
"function"?Symbol.for("nodejs.util.inspect.custom"):null;Re.Buffer=h;Re.SlowBuffer=Mo;Re.INSPECT_MAX_BYTES=
50;var ut=2147483647;Re.kMaxLength=ut;h.TYPED_ARRAY_SUPPORT=Po();!h.TYPED_ARRAY_SUPPORT&&typeof console<
...
a(h,"Buffer");h.poolSize=8192;function Nn(r,e,t){if(typeof r=="string")return Bo(r,e);if(ArrayBuffer.
...
for option "size"')}a(qn,"assertSize");function Ro(r,e,t){return qn(r),r<=0?pe(r):e!==void 0?typeof t==
...
r)};h.allocUnsafeSlow=function(r){return Nt(r)};function Bo(r,e){if((typeof e!="string"||e==="")&&(e=
"utf8"),!h.isEncoding(e))throw new TypeError("Unknown encoding: "+e);let t=jn(r,e)|0,n=pe(t),i=n.write(
r,e);return i!==t&&(n=n.slice(0,i)),n}a(Bo,"fromString");function Dt(r){let e=r.length<0?0:qt(r.length)|
0,t=pe(e);for(let n=0;n<e;n+=1)t[n]=r[n]&255;return t}a(Dt,"fromArrayLike");function Lo(r){if(ce(r,Uint8Array)){
let e=new Uint8Array(r);return Ot(e.buffer,e.byteOffset,e.byteLength)}return Dt(r)}a(Lo,"fromArrayVi\
...
r,e,t),Object.setPrototypeOf(n,h.prototype),n}a(Ot,"fromArrayBuffer");function Fo(r){if(h.isBuffer(r)){
...
a(Fo,"fromObject");function qt(r){if(r>=ut)throw new RangeError("Attempt to allocate Buffer larger t\
han maximum size: 0x"+ut.toString(16)+" bytes");return r|0}a(qt,"checked");function Mo(r){return+r!=
...
if(i)return n?-1:Qt(r).length;e=(""+e).toLowerCase(),i=!0}}a(jn,"byteLength");h.byteLength=jn;function ko(r,e,t){
...
tf8":case"utf-8":return Hn(this,e,t);case"ascii":return Wo(this,e,t);case"latin1":case"binary":return Ho(
...
h.prototype.lastIndexOf=a(function(e,t,n){return Wn(this,e,t,n,!1)},"lastIndexOf");function Uo(r,e,t,n){
t=Number(t)||0;let i=r.length-t;n?(n=Number(n),n>i&&(n=i)):n=i;let s=e.length;n>s/2&&(n=s/2);let o;for(o=
0;o<n;++o){let u=parseInt(e.substr(o*2,2),16);if(Wt(u))return o;r[t+o]=u}return o}a(Uo,"hexWrite");function Do(r,e,t,n){
return ct(Qt(e,r.length-t),r,t,n)}a(Do,"utf8Write");function Oo(r,e,t,n){return ct(Yo(e),r,t,n)}a(Oo,
"asciiWrite");function Qo(r,e,t,n){return ct(Zn(e),r,t,n)}a(Qo,"base64Write");function No(r,e,t,n){return ct(
...
N");function qo(r,e,t){return e===0&&t===r.length?Ut.fromByteArray(r):Ut.fromByteArray(r.slice(e,t))}
a(qo,"base64Slice");function Hn(r,e,t){t=Math.min(r.length,t);let n=[],i=e;for(;i<t;){let s=r[i],o=null,
...
n.push(o),i+=u}return jo(n)}a(Hn,"utf8Slice");var On=4096;function jo(r){let e=r.length;if(e<=On)return String.
fromCharCode.apply(String,r);let t="",n=0;for(;n<e;)t+=String.fromCharCode.apply(String,r.slice(n,n+=
On));return t}a(jo,"decodeCodePointsArray");function Wo(r,e,t){let n="";t=Math.min(r.length,t);for(let i=e;i<
...
_${r.slice(t-3,t)}${e}`;return`${r.slice(0,t)}${e}`}a(Qn,"addNumericalSeparator");function Vo(r,e,t){
Pe(e,"offset"),(r[e]===void 0||r[e+t]===void 0)&&qe(e,r.length-(t+1))}a(Vo,"checkBounds");function Yn(r,e,t,n,i,s){
...
nd <= ${t}${o}`,new Ie.ERR_OUT_OF_RANGE("value",u,r)}Vo(n,i,s)}a(Yn,"checkIntBI");function Pe(r,e){if(typeof r!=
...
new Ie.ERR_OUT_OF_RANGE(t||"offset",`>= ${t?1:0} and <= ${e}`,r)}a(qe,"boundsError");var Ko=/[^+/0-9A-Za-z-_]/g;
...
o),n=t>>8,i=t%256,s.push(i),s.push(n);return s}a(Zo,"utf16leToBytes");function Zn(r){return Ut.toByteArray(
zo(r))}a(Zn,"base64ToBytes");function ct(r,e,t,n){let i;for(i=0;i<n&&!(i+t>=e.length||i>=r.length);++i)
...
r}a(Wt,"numberIsNaN");var Jo=function(){let r="0123456789abcdef",e=new Array(256);for(let t=0;t<16;++t){
let n=t*16;for(let i=0;i<16;++i)e[n+i]=r[t]+r[i]}return e}();function ye(r){return typeof BigInt>"u"?
Xo:r}a(ye,"defineBigIntMethod");function Xo(){throw new Error("BigInt not supported")}a(Xo,"BufferBi\
...
m.nextTick(()=>{})}catch{let e=Promise.resolve();m.nextTick=e.then.bind(e)}});var me=T((_l,Ht)=>{"use strict";p();var Be=typeof Reflect=="object"?Reflect:null,Xn=Be&&typeof Be.apply==
...
init.call(this)}a(R,"EventEmitter");Ht.exports=R;Ht.exports.once=ia;R.EventEmitter=R;R.prototype._events=
...
r,u.type=e,u.count=o.length,ea(u)}return r}a(ni,"_addListener");R.prototype.addListener=a(function(e,t){
return ni(this,e,t,!1)},"addListener");R.prototype.on=R.prototype.addListener;R.prototype.prependListener=
a(function(e,t){return ni(this,e,t,!0)},"prependListener");function ta(){if(!this.fired)return this.
target.removeListener(this.type,this.wrapFn),this.fired=!0,arguments.length===0?this.listener.call(this.
target):this.listener.apply(this.target,arguments)}a(ta,"onceWrapper");function ii(r,e,t){var n={fired:!1,
wrapFn:void 0,target:r,type:e,listener:t},i=ta.bind(n);return i.listener=t,n.wrapFn=i,i}a(ii,"_onceW\
...
na(i):ai(i,i.length)}a(si,"_listeners");R.prototype.listeners=a(function(e){return si(this,e,!0)},"l\
...
sa(r,i,{once:!0})})}a(ia,"once");function sa(r,e,t){typeof r.on=="function"&&ui(r,"error",e,t)}a(sa,
...
ust be of type EventEmitter. Received type '+typeof r)}a(ui,"eventTargetAgnosticAddListener")});var fi={};ne(fi,{Socket:()=>ge,isIP:()=>oa});function oa(r){return 0}var li,ci,x,ge,je=K(()=>{"use s\
trict";p();li=Se(me(),1);a(oa,"isIP");ci=/^[^.]+\./,x=class x extends li.EventEmitter{constructor(){
...
pathname:l,search:f,query:_,hash:g}}var $t=K(()=>{"use strict";p();a(Gt,"parse")});function He(r){let e=1779033703,t=3144134277,n=1013904242,i=2773480762,s=1359893119,o=2600822924,u=528734635,
...
return r===void 0?{add:P,digest:L}:(P(r),L())}var wi=K(()=>{"use strict";p();a(He,"sha256")});var U,Ge,bi=K(()=>{"use strict";p();U=class U{constructor(){E(this,"_dataLength",0);E(this,"_bufferL\
...
abcdef"),E(U,"hexOut",[]),E(U,"onePassHasher",new U);Ge=U});var Kt={};ne(Kt,{createHash:()=>va,createHmac:()=>Sa,randomBytes:()=>ba});function ba(r){return crypto.
...
"digest")}},"update")}}var zt=K(()=>{"use strict";p();wi();bi();a(ba,"randomBytes");a(va,"createHash");
a(Sa,"createHmac")});var Zt=T(vi=>{"use strict";p();vi.parse=function(r,e){return new Yt(r,e).parse()};var yt=class yt{constructor(e,t){
...
not balanced");return this.entries}};a(yt,"ArrayParser");var Yt=yt;function xa(r){return r}a(xa,"ide\
ntity")});var Jt=T((Kl,Si)=>{p();var Ea=Zt();Si.exports={create:a(function(r,e){return{parse:a(function(){return Ea.
parse(r,e)},"parse")}},"create")}});var Ai=T((Zl,Ei)=>{"use strict";p();var Aa=/(\d{1,})-(\d{2})-(\d{2}) (\d{2}):(\d{2}):(\d{2})(\.\d{1,})?.*?( BC)?$/,
_a=/^(\d{1,})-(\d{2})-(\d{2})( BC)?$/,Ca=/([Z+-])(\d{2})?:?(\d{2})?:?(\d{2})?/,Ia=/^-?infinity$/;Ei.
...
(d=new Date(Date.UTC(i,s,o,u,c,l,f)),Xt(i)&&d.setUTCFullYear(i),g!==0&&d.setTime(d.getTime()-g)):(d=
new Date(i,s,o,u,c,l,f),Xt(i)&&d.setFullYear(i)),d},"parseDate");function Ta(r){var e=_a.exec(r);if(e){
...
e[3]||0,10)*60+parseInt(e[4]||0,10);return i*n*1e3}}a(Pa,"timeZoneOffset");function xi(r){return-(r-
1)}a(xi,"bcYearToNegativeYear");function Xt(r){return r>=0&&r<100}a(Xt,"is0To99")});var Ci=T((ef,_i)=>{p();_i.exports=Ba;var Ra=Object.prototype.hasOwnProperty;function Ba(r){for(var e=1;e<
arguments.length;e++){var t=arguments[e];for(var n in t)Ra.call(t,n)&&(r[n]=t[n])}return r}a(Ba,"ext\
end")});var Pi=T((nf,Ti)=>{"use strict";p();var La=Ci();Ti.exports=Le;function Le(r){if(!(this instanceof Le))
...
/0+$/,"")),i+Ma[n]}};var er="([+-]?\\d+)",Da=er+"\\s+years?",Oa=er+"\\s+mons?",Qa=er+"\\s+days?",Na="\
...
keys(Ii).reduce(function(n,i){var s=Ii[i],o=e[s];return!o||(o=i==="milliseconds"?Wa(o):parseInt(o,10),
!o)||(t&&~ja.indexOf(i)&&(o*=-1),n[i]=o),n},{})}a(Ha,"parse")});var Bi=T((af,Ri)=>{"use strict";p();Ri.exports=a(function(e){if(/^\\x/.test(e))return new y(e.substr(
...
parseBytea")});var Oi=T((lf,Di)=>{p();var $e=Zt(),Ve=Jt(),mt=Ai(),Fi=Pi(),Mi=Bi();function gt(r){return a(function(t){
return t===null?t:r(t)},"nullAllowed")}a(gt,"allowNull");function ki(r){return r===null?r:r==="TRUE"||
r==="t"||r==="true"||r==="y"||r==="yes"||r==="on"||r==="1"}a(ki,"parseBool");function Ga(r){return r?
$e.parse(r,ki):null}a(Ga,"parseBoolArray");function $a(r){return parseInt(r,10)}a($a,"parseBaseTenIn\
t");function tr(r){return r?$e.parse(r,gt($a)):null}a(tr,"parseIntegerArray");function Va(r){return r?
$e.parse(r,gt(function(e){return Ui(e).trim()})):null}a(Va,"parseBigIntegerArray");var Ka=a(function(r){
...
function(t){return t!==null&&(t=mt(t)),t});return e.parse()},"parseDateArray"),za=a(function(r){if(!r)
return null;var e=Ve.create(r,function(t){return t!==null&&(t=Fi(t)),t});return e.parse()},"parseInt\
ervalArray"),Ya=a(function(r){return r?$e.parse(r,gt(Mi)):null},"parseByteAArray"),ir=a(function(r){
...
r[i])}var s=sr(e);return s.radius=parseFloat(t),s},"parseCircle"),Ja=a(function(r){r(20,Ui),r(21,ir),
r(23,ir),r(26,ir),r(700,parseFloat),r(701,parseFloat),r(16,ki),r(1082,mt),r(1114,mt),r(1184,mt),r(600,
sr),r(651,te),r(718,Za),r(1e3,Ga),r(1001,Ya),r(1005,tr),r(1007,tr),r(1028,tr),r(1016,Va),r(1017,Ka),
r(1021,rr),r(1022,rr),r(1231,rr),r(1014,te),r(1015,te),r(1008,te),r(1009,te),r(1040,te),r(1041,te),r(
1115,nr),r(1182,nr),r(1185,nr),r(1186,Fi),r(1187,za),r(17,Mi),r(114,JSON.parse.bind(JSON)),r(3802,JSON.
parse.bind(JSON)),r(199,Li),r(3807,Li),r(3907,te),r(2951,te),r(791,te),r(1183,te),r(1270,te)},"init");
Di.exports={init:Ja}});var Ni=T((pf,Qi)=>{"use strict";p();var Y=1e6;function Xa(r){var e=r.readInt32BE(0),t=r.readUInt32BE(
...
""+o%Y,n+u+i}a(Xa,"readInt8");Qi.exports=Xa});var Gi=T((mf,Hi)=>{p();var eu=Ni(),F=a(function(r,e,t,n,i){t=t||0,n=n||!1,i=i||function(A,_,N){return A*
...
r[d]),8);var g=(e+t)%8;return g>0&&(l=i(l,o(r[f])>>8-g,g)),l},"parseBits"),Wi=a(function(r,e,t){var n=Math.
...
r,31,1,!0)+1):F(r,31,1)},"parseInt32"),ru=a(function(r){return Wi(r,23,8)},"parseFloat32"),nu=a(function(r){
return Wi(r,52,11)},"parseFloat64"),iu=a(function(r){var e=F(r,16,32);if(e==49152)return NaN;for(var t=Math.
...
null:F(r,8)>0},"parseBool"),au=a(function(r){r(20,eu),r(21,tu),r(23,qi),r(26,qi),r(1700,iu),r(700,ru),
r(701,nu),r(16,ou),r(1114,ji.bind(null,!1)),r(1184,ji.bind(null,!0)),r(1e3,Ke),r(1007,Ke),r(1016,Ke),
r(1008,Ke),r(1009,Ke),r(25,su)},"init");Hi.exports={init:au}});var Vi=T((bf,$i)=>{p();$i.exports={BOOL:16,BYTEA:17,CHAR:18,INT8:20,INT2:21,INT4:23,REGPROC:24,TEXT:25,
...
REGROLE:4096}});var Ze=T(Ye=>{p();var uu=Oi(),cu=Gi(),lu=Jt(),fu=Vi();Ye.getTypeParser=hu;Ye.setTypeParser=pu;Ye.arrayParser=
lu;Ye.builtins=fu;var ze={text:{},binary:{}};function Ki(r){return String(r)}a(Ki,"noParse");function hu(r,e){
return e=e||"text",ze[e]&&ze[e][r]||Ki}a(hu,"getTypeParser");function pu(r,e,t){typeof e=="function"&&
(t=e,e="text"),ze[e][r]=t}a(pu,"setTypeParser");uu.init(function(r,e){ze.text[r]=e});cu.init(function(r,e){
ze.binary[r]=e})});var Je=T((Af,or)=>{"use strict";p();or.exports={host:"localhost",user:m.platform==="win32"?m.env.USERNAME:
...
keepalives:1,keepalives_idle:0};var Fe=Ze(),du=Fe.getTypeParser(20,"text"),yu=Fe.getTypeParser(1016,
"text");or.exports.__defineSetter__("parseInt8",function(r){Fe.setTypeParser(20,"text",r?Fe.getTypeParser(
23,"text"):du),Fe.setTypeParser(1016,"text",r?Fe.getTypeParser(1007,"text"):yu)})});var Xe=T((Cf,Yi)=>{"use strict";p();var mu=(zt(),D(Kt)),gu=Je();function wu(r){var e=r.replace(/\\/g,
"\\\\").replace(/"/g,'\\"');return'"'+e+'"'}a(wu,"escapeElement");function zi(r){for(var e="{",t=0;t<
r.length;t++)t>0&&(e=e+","),r[t]===null||typeof r[t]>"u"?e=e+"NULL":Array.isArray(r[t])?e=e+zi(r[t]):
r[t]instanceof y?e+="\\\\x"+r[t].toString("hex"):e+=wu(wt(r[t]));return e=e+"}",e}a(zi,"arrayString");
...
r.byteLength)}return r instanceof Date?gu.parseInputDatesAsUTC?Su(r):vu(r):Array.isArray(r)?zi(r):typeof r==
...
r query');return e.push(r),wt(r.toPostgres(wt),e)}return JSON.stringify(r)}a(bu,"prepareObject");function W(r,e){
...
t),r}a(xu,"normalizeQueryConfig");var ar=a(function(r){return mu.createHash("md5").update(r,"utf-8").
digest("hex")},"md5"),Eu=a(function(r,e,t){var n=ar(e+r),i=ar(y.concat([y.from(n),t]));return"md5"+i},
"postgresMd5PasswordHash");Yi.exports={prepareValue:a(function(e){return wt(e)},"prepareValueWrapper"),
normalizeQueryConfig:xu,postgresMd5PasswordHash:Eu,md5:ar}});var vt=T((Pf,Zi)=>{"use strict";p();var Au=Ze();function bt(r){this._types=r||Au,this.text={},this.binary=
...
e||"text",this.getOverrides(e)[r]||this._types.getTypeParser(r,e)};Zi.exports=bt});var tt={};ne(tt,{default:()=>Tu});var Tu,rt=K(()=>{"use strict";p();Tu={}});var us=T((Qf,as)=>{"use strict";p();var ur=(zt(),D(Kt));function Pu(r){if(r.indexOf("SCRAM-SHA-256")===
...
","+l+","+f,g=Me(u,d),A=os(o,g),_=A.toString("base64"),N=Me(s,"Server Key"),P=Me(N,d);r.message="SAS\
...
a(os,"xorBuffers");function ku(r){return ur.createHash("sha256").update(r).digest()}a(ku,"sha256");function Me(r,e){
return ur.createHmac("sha256",r).update(e).digest()}a(Me,"hmacSha256");function Uu(r,e,t){for(var n=Me(
r,y.concat([e,y.from([0,0,0,1])])),i=n,s=0;s<t-1;s++)n=Me(r,n),i=os(i,n);return i}a(Uu,"Hi");as.exports=
{startSession:Pu,continueSession:Ru,finalizeSession:Bu}});var cr={};ne(cr,{join:()=>Du});function Du(...r){return r.join("/")}var lr=K(()=>{"use strict";p();a(
Du,"join")});var fr={};ne(fr,{stat:()=>Ou});function Ou(r,e){e(new Error("No filesystem"))}var hr=K(()=>{"use str\
ict";p();a(Ou,"stat")});var pr={};ne(pr,{default:()=>Qu});var Qu,dr=K(()=>{"use strict";p();Qu={}});var cs={};ne(cs,{StringDecoder:()=>yr});var mr,yr,ls=K(()=>{"use strict";p();mr=class mr{constructor(e){
E(this,"td");this.td=new TextDecoder(e)}write(e){return this.td.decode(e,{stream:!0})}end(e){return this.
td.decode(e)}};a(mr,"StringDecoder");yr=mr});var ds=T((zf,ps)=>{"use strict";p();var{Transform:Nu}=(dr(),D(pr)),{StringDecoder:qu}=(ls(),D(cs)),be=Symbol(
...
!1,s(i)},n}a(Hu,"split");ps.exports=Hu});var gs=T((Jf,de)=>{"use strict";p();var ys=(lr(),D(cr)),Gu=(dr(),D(pr)).Stream,$u=ds(),ms=(rt(),D(tt)),
...
`);nt.write(ms.format.apply(ms,e))}}a(wr,"warn");Object.defineProperty(de.exports,"isWin",{get:a(function(){
return At},"get"),set:a(function(r){At=r},"set")});de.exports.warnTo=function(r){var e=nt;return nt=
r,e};de.exports.getFileName=function(r){var e=r||m.env,t=e.PGPASSFILE||(At?ys.join(e.APPDATA||"./","\
postgresql","pgpass.conf"):ys.join(e.HOME||"./",".pgpass"));return t};de.exports.usePgPass=function(r,e){
...
replace(/\\([:\\])/g,"$1")),o[ke[f]]=A},"addToObj"),l=0;l<r.length-1;l+=1){if(e=r.charAt(l+1),t=r.charAt(
...
0}},t=0;t<ke.length;t+=1){var n=e[t],i=r[ke[t]]||"",s=n(i);if(!s)return!1}return!0}});var bs=T((rh,br)=>{"use strict";p();var th=(lr(),D(cr)),ws=(hr(),D(fr)),_t=gs();br.exports=function(r,e){
var t=_t.getFileName();ws.stat(t,function(n,i){if(n||!_t.usePgPass(i,t))return e(void 0);var s=ws.createReadStream(
t);_t.getPassword(r,s,e)})};br.exports.warnTo=_t.warnTo});var vs={};ne(vs,{default:()=>nc});var nc,Ss=K(()=>{"use strict";p();nc={}});var Es=T((sh,xs)=>{"use strict";p();var ic=($t(),D(hi)),vr=(hr(),D(fr));function Sr(r){if(r.charAt(0)===
...
!1;break}}return t}a(Sr,"parse");xs.exports=Sr;Sr.parse=Sr});var Ct=T((uh,Cs)=>{"use strict";p();var sc=(Ss(),D(vs)),_s=Je(),As=Es().parse,$=a(function(r,e,t){return t===
...
no-verify":return{rejectUnauthorized:!1}}return _s.ssl},"readSSLConfigFromEnvironment"),Ue=a(function(r){
return"'"+(""+r).replace(/\\/g,"\\\\").replace(/'/g,"\\'")+"'"},"quoteParamValue"),re=a(function(r,e,t){
var n=e[t];n!=null&&r.push(t+"="+Ue(n))},"add"),Er=class Er{constructor(e){e=typeof e=="string"?As(e):
...
a(Er,"ConnectionParameters");var xr=Er;Cs.exports=xr});var Ps=T((fh,Ts)=>{"use strict";p();var ac=Ze(),Is=/^([A-Za-z]+)(?: (\d+))?(?: (\d+))?/,_r=class _r{constructor(e,t){
...
format||"text")}}};a(_r,"Result");var Ar=_r;Ts.exports=Ar});var Fs=T((dh,Ls)=>{"use strict";p();var{EventEmitter:uc}=me(),Rs=Ps(),Bs=Xe(),Ir=class Ir extends uc{constructor(e,t,n){
...
e.sendCopyFail("No source stream defined")}handleCopyData(e,t){}};a(Ir,"Query");var Cr=Ir;Ls.exports=
...
ssage");var qr=tn;I.NoticeMessage=qr});var Ms=T(It=>{"use strict";p();Object.defineProperty(It,"__esModule",{value:!0});It.Writer=void 0;var sn=class sn{constructor(e=256){
...
headerPosition=0,this.buffer=y.allocUnsafe(this.size),t}};a(sn,"Writer");var nn=sn;It.Writer=nn});var Us=T(Pt=>{"use strict";p();Object.defineProperty(Pt,"__esModule",{value:!0});Pt.serialize=void 0;
var on=Ms(),M=new on.Writer,cc=a(r=>{M.addInt16(3).addInt16(0);for(let n of Object.keys(r))M.addCString(
...
n),s=0;s<n;s++)i.addInt32(t[s]);return M.flush(80)},"parse"),De=new on.Writer,mc=a(function(r,e){for(let t=0;t<
...
return M.addCString(e).addCString(t),M.addInt16(s),mc(i,r.valueMapper),M.addInt16(s),M.add(De.flush()),
...
_c=a(r=>M.add(r).flush(100),"copyData"),Cc=a(r=>an(102,r),"copyFail"),Tt=a(r=>y.from([r,0,0,0,4]),"c\
...
cancel:vc};Pt.serialize=Bc});var Ds=T(Rt=>{"use strict";p();Object.defineProperty(Rt,"__esModule",{value:!0});Rt.BufferReader=void 0;
...
offset+e);return this.offset+=e,t}};a(cn,"BufferReader");var un=cn;Rt.BufferReader=un});var Ns=T(Bt=>{"use strict";p();Object.defineProperty(Bt,"__esModule",{value:!0});Bt.Parser=void 0;var k=rn(),
Fc=Ds(),ln=1,Mc=4,Os=ln+Mc,Qs=y.allocUnsafe(0),hn=class hn{constructor(e){if(this.buffer=Qs,this.bufferLength=
...
i+ln),u=ln+o;if(u+i<=n){let c=this.handlePacket(i+Os,s,o,this.buffer);t(c),i+=u}else break}i===n?(this.
...
on("data",n=>t.parse(n,e)),new Promise(n=>r.on("end",()=>n()))}a(Oc,"parse");ve.parse=Oc});var qs={};ne(qs,{connect:()=>Qc});function Qc({socket:r,servername:e}){return r.startTls(e),r}var js=K(
()=>{"use strict";p();a(Qc,"connect")});var mn=T((Dh,Gs)=>{"use strict";p();var Ws=(je(),D(fi)),Nc=me().EventEmitter,{parse:qc,serialize:Q}=pn(),
Hs=Q.flush(),jc=Q.sync(),Wc=Q.end(),yn=class yn extends Nc{constructor(e){super(),e=e||{},this.stream=
...
this._send(Q.copyDone())}sendCopyFail(e){this._send(Q.copyFail(e))}};a(yn,"Connection");var dn=yn;Gs.
exports=dn});var Ks=T((qh,Vs)=>{"use strict";p();var Hc=me().EventEmitter,Nh=(rt(),D(tt)),Gc=Xe(),gn=us(),$c=bs(),
Vc=vt(),Kc=Ct(),$s=Fs(),zc=Je(),Yc=mn(),wn=class wn extends Hc{constructor(e){super(),this.connectionParameters=
...
_Promise(t=>{this.connection.once("end",t)})}};a(wn,"Client");var Lt=wn;Lt.Query=$s;Vs.exports=Lt});var Js=T((Hh,Zs)=>{"use strict";p();var Zc=me().EventEmitter,zs=a(function(){},"NOOP"),Ys=a((r,e)=>{
...
clearTimeout(o),t.callback(u,c,l)},"queueCallback"),s=new Oe(i),o=setTimeout(()=>{Ys(this._pendingQueue,
...
callback(o,void 0,zs);else{if(this.log("new client connected"),this.options.maxLifetimeSeconds!==0){
let u=setTimeout(()=>{this.log("ending client due to expired lifetime"),this._expired.add(t),this._idle.
findIndex(l=>l.client===t)!==-1&&this._acquireClient(t,new Oe((l,f,d)=>d()),n,!1)},this.options.maxLifetimeSeconds*
...
verify?this.options.verify(e,s=>{if(s)return e.release(s),t.callback(s,void 0,zs);t.callback(void 0,
...
Zs.exports=vn});var Xs={};ne(Xs,{default:()=>el});var el,eo=K(()=>{"use strict";p();el={}});var to=T((Kh,tl)=>{tl.exports={name:"pg",version:"8.8.0",description:"PostgreSQL client - pure javas\
...
a178655"}});var io=T((zh,no)=>{"use strict";p();var ro=me().EventEmitter,rl=(rt(),D(tt)),An=Xe(),Qe=no.exports=function(r,e,t){
ro.call(this),r=An.normalizeQueryConfig(r,e,t),this.text=r.text,this.values=r.values,this.name=r.name,
this.callback=r.callback,this.state="new",this._arrayMode=r.rowMode==="array",this._emitRowEvents=!1,
this.on("newListener",function(n){n==="row"&&(this._emitRowEvents=!0)}.bind(this))};rl.inherits(Qe,ro);
...
prepareValue);r.native.query(this.text,i,t)}else r.native.query(this.text,t)}});var uo=T((Xh,ao)=>{"use strict";p();var il=(eo(),D(Xs)),sl=vt(),Jh=to(),so=me().EventEmitter,ol=(rt(),D(tt)),
al=Ct(),oo=io(),Z=ao.exports=function(r){so.call(this),r=r||{},this._Promise=r.Promise||w.Promise,this.
...
r,e,t)};Z.prototype.getTypeParser=function(r,e){return this._types.getTypeParser(r,e)}});var _n=T((rp,co)=>{"use strict";p();co.exports=uo()});var it=T((ip,st)=>{"use strict";p();var ul=Ks(),cl=Je(),ll=mn(),fl=Js(),{DatabaseError:hl}=pn(),pl=a(
...
defineProperty(st.exports,"native",{value:r}),r}}))});p();p();je();$t();p();var aa=Object.defineProperty,ua=Object.defineProperties,ca=Object.getOwnPropertyDescriptors,pi=Object.
getOwnPropertySymbols,la=Object.prototype.hasOwnProperty,fa=Object.prototype.propertyIsEnumerable,di=a(
(r,e,t)=>e in r?aa(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t,"__defNormalProp"),
ha=a((r,e)=>{for(var t in e||(e={}))la.call(e,t)&&di(r,t,e[t]);if(pi)for(var t of pi(e))fa.call(e,t)&&
di(r,t,e[t]);return r},"__spreadValues"),pa=a((r,e)=>ua(r,ca(e)),"__spreadProps"),da=1008e3,yi=new Uint8Array(
new Uint16Array([258]).buffer)[0]===2,ya=new TextDecoder,Vt=new TextEncoder,ht=Vt.encode("0123456789\
abcdef"),pt=Vt.encode("0123456789ABCDEF"),ma=Vt.encode("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqr\
stuvwxyz0123456789+/");var mi=ma.slice();mi[62]=45;mi[63]=95;var We,dt;function ga(r,{alphabet:e,scratchArr:t}={}){if(!We)if(We=
new Uint16Array(256),dt=new Uint16Array(256),yi)for(let _=0;_<256;_++)We[_]=ht[_&15]<<8|ht[_>>>4],dt[_]=
pt[_&15]<<8|pt[_>>>4];else for(let _=0;_<256;_++)We[_]=ht[_&15]|ht[_>>>4]<<8,dt[_]=pt[_&15]|pt[_>>>4]<<
8;r.byteOffset%4!==0&&(r=new Uint8Array(r));let n=r.length,i=n>>>1,s=n>>>2,o=t||new Uint16Array(n),u=new Uint32Array(
r.buffer,r.byteOffset,s),c=new Uint32Array(o.buffer,o.byteOffset,i),l=e==="upper"?dt:We,f=0,d=0,g;if(yi)
...
{},e),{scratchArr:o}))}return t}a(wa,"_toHexChunked");function gi(r,e={}){return e.alphabet!=="upper"&&
typeof r.toHex=="function"?r.toHex():wa(r,e)}a(gi,"toHex");var ts=Se(Xe()),rs=Se(vt());function _u(r){return r instanceof y?"\\x"+gi(r):r}a(_u,"encodeBuffersAsBytea");var St=class St extends Error{constructor(t){
...
onstraint","file","line","routine"],xt=class xt{constructor(e,t){this.strings=e;this.values=t}compile(e={
query:"",params:[]}){let{strings:t,values:n}=this;for(let i=0,s=t.length;i<s;i++)if(e.query+=t[i],i<
n.length){let o=n[i];if(o instanceof xt)o.compile(e);else{let{params:u}=e,c=_u((0,ts.prepareValue)(o));
u.push(c),e.query+="$"+u.length}}return e}};a(xt,"SqlTemplate");var et=xt;function ns(r,{arrayMode:e,
...
n set?");let c;try{c=Gt(r)}catch{throw new Error("Database connection string provided to `neon()` is\
...
tagged-template function: sql`...`, not sql(`...`)");return Xi(N,new et(P,L))}a(_,"templateFn"),_.query=
(P,L,C)=>Xi(N,new et([P],L??[]),C),_.unsafe=P=>new et([P],[]),_.transaction=async(P,L)=>{if(typeof P==
"function"&&(P=P(_)),!Array.isArray(P))throw new Error(Ji);P.forEach(H=>{if(H[Symbol.toStringTag]!==
"NeonQueryPromise")throw new Error(Ji)});let C=P.map(H=>H.sqlTemplate),S=P.map(H=>H.opts??{});return N(
C,S,L)};async function N(P,L,C){let{fetchEndpoint:S,fetchFunction:H}=ge,le=Array.isArray(P)?{queries:P.
...
body:JSON.stringify(le),headers:he,...q})}catch(J){let j=new we(`Error connecting to database: ${J}`);
throw j.sourceError=J,j}if(ae.ok){let J=await ae.json();if(Array.isArray(P)){let j=J.results;if(!Array.
isArray(j))throw new we("Neon internal error: unexpected result format");return j.map((X,V)=>{let Ne=L[V]??
{},po=Ne.arrayMode??ie,yo=Ne.fullResults??se;return es(X,{arrayMode:po,fullResults:yo,types:Ne.types})})}else{
let j=L??{},X=j.arrayMode??ie,V=j.fullResults??se;return es(J,{arrayMode:X,fullResults:V,types:j.types})}}else{
let{status:J}=ae;if(J===400){let j=await ae.json(),X=new we(j.message);for(let V of Cu)X[V]=j[V]??void 0;
throw X}else{let j=await ae.text();throw new we(`Server error (HTTP status ${J}): ${j}`)}}}return a(
N,"execute"),_}a(ns,"neon");function Xi(r,e,t){return{[Symbol.toStringTag]:"NeonQueryPromise",sqlTemplate:e,
opts:t,then:a((n,i)=>r(e,t).then(n,i),"then"),catch:a(n=>r(e,t).catch(n),"catch"),finally:a(n=>r(e,t).
finally(n),"finally")}}a(Xi,"createNeonQueryPromise");function es(r,{arrayMode:e,fullResults:t,types:n}){
let i=new rs.default(n),s=r.fields.map(c=>c.name),o=r.fields.map(c=>i.getTypeParser(c.dataTypeID)),u=e===
...
i,r):u}a(es,"processQueryResult");async function Iu(r){if(typeof r=="string")return r;if(typeof r=="\
function")try{return await Promise.resolve(r())}catch(e){let t=new we("Error getting auth token.");throw e instanceof
Error&&(t=new we(`Error getting auth token: ${e.message}`)),t}}a(Iu,"getAuthToken");p();var fo=Se(it());p();var lo=Se(it());var In=class In extends lo.Client{constructor(t){super(t);this.config=t}get neonConfig(){return this.
...
a(In,"NeonClient");var ot=In;je();var ho=Se(Ct());function dl(r,e){if(e)return{callback:e,result:void 0};let t,n,i=a(function(o,u){o?t(o):n(u)},"cb"),
s=new r(function(o,u){n=o,t=u});return{callback:i,result:s}}a(dl,"promisify");var Pn=class Pn extends fo.Pool{constructor(){
...
/${c(o.database)}`,f=typeof t=="string"?t:t.text,d=n??t.values??[];ns(l,{fullResults:!0,arrayMode:t.
rowMode==="array"})(f,d,{types:t.types??this.options?.types}).then(A=>i(void 0,A)).catch(A=>i(A))}catch(o){
i(o)}return s.result}};a(Pn,"NeonPool");var Tn=Pn;je();var Rn=Se(it()),gp="mjs";var export_DatabaseError=Rn.DatabaseError;var export_defaults=Rn.defaults;var export_types=Rn.types;
export{ot as Client,export_DatabaseError as DatabaseError,we as NeonDbError,Tn as Pool,et as SqlTemplate,
gp as _bundleExt,export_defaults as defaults,ns as neon,ge as neonConfig,export_types as types};
