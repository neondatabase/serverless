...
var Ao=Object.create;var Ce=Object.defineProperty;var _o=Object.getOwnPropertyDescriptor;var Co=Object.getOwnPropertyNames;var To=Object.getPrototypeOf,Io=Object.prototype.hasOwnProperty;var Po=(r,e,t)=>e in r?Ce(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t;var a=(r,e)=>Ce(r,"name",{value:e,configurable:!0});var G=(r,e,t)=>()=>{if(t)throw t[0];try{return r&&(e=r(r=0)),e}catch(n){throw t=[n],n}};var T=(r,e)=>()=>{try{return e||r((e={exports:{}}).exports,e),e.exports}catch(t){throw e=0,t}},ne=(r,e)=>{
for(var t in e)Ce(r,t,{get:e[t],enumerable:!0})},Dn=(r,e,t,n)=>{if(e&&typeof e=="object"||typeof e==
"function")for(let i of Co(e))!Io.call(r,i)&&i!==t&&Ce(r,i,{get:()=>e[i],enumerable:!(n=_o(e,i))||n.
enumerable});return r};var me=(r,e,t)=>(t=r!=null?Ao(To(r)):{},Dn(e||!r||!r.__esModule?Ce(t,"default",{value:r,enumerable:!0}):
t,r)),D=r=>Dn(Ce({},"__esModule",{value:!0}),r);var S=(r,e,t)=>Po(r,typeof e!="symbol"?e+"":e,t);var Qn=T(ct=>{"use strict";p();ct.byteLength=Bo;ct.toByteArray=ko;ct.fromByteArray=Uo;var ue=[],J=[],
Ro=typeof Uint8Array<"u"?Uint8Array:Array,Ot="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz01\
23456789+/";for(Ee=0,On=Ot.length;Ee<On;++Ee)ue[Ee]=Ot[Ee],J[Ot.charCodeAt(Ee)]=Ee;var Ee,On;J[45]=62;
J[95]=63;function qn(r){var e=r.length;if(e%4>0)throw new Error("Invalid string. Length must be a mu\
ltiple of 4");var t=r.indexOf("=");t===-1&&(t=e);var n=t===e?0:4-t%4;return[t,n]}a(qn,"getLens");function Bo(r){
var e=qn(r),t=e[0],n=e[1];return(t+n)*3/4-n}a(Bo,"byteLength");function Lo(r,e,t){return(e+t)*3/4-t}
a(Lo,"_byteLength");function ko(r){var e,t=qn(r),n=t[0],i=t[1],s=new Ro(Lo(r,n,i)),o=0,u=i>0?n-4:n,c;
for(c=0;c<u;c+=4)e=J[r.charCodeAt(c)]<<18|J[r.charCodeAt(c+1)]<<12|J[r.charCodeAt(c+2)]<<6|J[r.charCodeAt(
c+3)],s[o++]=e>>16&255,s[o++]=e>>8&255,s[o++]=e&255;return i===2&&(e=J[r.charCodeAt(c)]<<2|J[r.charCodeAt(
c+1)]>>4,s[o++]=e&255),i===1&&(e=J[r.charCodeAt(c)]<<10|J[r.charCodeAt(c+1)]<<4|J[r.charCodeAt(c+2)]>>
2,s[o++]=e>>8&255,s[o++]=e&255),s}a(ko,"toByteArray");function Fo(r){return ue[r>>18&63]+ue[r>>12&63]+
ue[r>>6&63]+ue[r&63]}a(Fo,"tripletToBase64");function Mo(r,e,t){for(var n,i=[],s=e;s<t;s+=3)n=(r[s]<<
16&16711680)+(r[s+1]<<8&65280)+(r[s+2]&255),i.push(Fo(n));return i.join("")}a(Mo,"encodeChunk");function Uo(r){
for(var e,t=r.length,n=t%3,i=[],s=16383,o=0,u=t-n;o<u;o+=s)i.push(Mo(r,o,o+s>u?u:o+s));return n===1?
(e=r[t-1],i.push(ue[e>>2]+ue[e<<4&63]+"==")):n===2&&(e=(r[t-2]<<8)+r[t-1],i.push(ue[e>>10]+ue[e>>4&63]+
ue[e<<2&63]+"=")),i.join("")}a(Uo,"fromByteArray")});var Nn=T(qt=>{p();qt.read=function(r,e,t,n,i){var s,o,u=i*8-n-1,c=(1<<u)-1,l=c>>1,f=-7,y=t?i-1:0,g=t?
...
v,u/=256,i-=8);for(o=o<<i|u,l+=i;l>0;r[t+w]=o&255,w+=v,o/=256,l-=8);r[t+w-v]|=M*128}});var ii=T(Re=>{"use strict";p();var Qt=Qn(),Ie=Nn(),Wn=typeof Symbol=="function"&&typeof Symbol.for==
"function"?Symbol.for("nodejs.util.inspect.custom"):null;Re.Buffer=h;Re.SlowBuffer=Wo;Re.INSPECT_MAX_BYTES=
50;var lt=2147483647;Re.kMaxLength=lt;h.TYPED_ARRAY_SUPPORT=Do();!h.TYPED_ARRAY_SUPPORT&&typeof console<
...
this))return this.byteOffset},"get")});function fe(r){if(r>lt)throw new RangeError('The value "'+r+'\
...
'The "string" argument must be of type string. Received type number');return Ht(r)}return Gn(r,e,t)}
a(h,"Buffer");h.poolSize=8192;function Gn(r,e,t){if(typeof r=="string")return qo(r,e);if(ArrayBuffer.
...
SharedArrayBuffer)))return Wt(r,e,t);if(typeof r=="number")throw new TypeError('The "value" argument\
...
for option "size"')}a(Vn,"assertSize");function Oo(r,e,t){return Vn(r),r<=0?fe(r):e!==void 0?typeof t==
"string"?fe(r).fill(e,t):fe(r).fill(e):fe(r)}a(Oo,"alloc");h.alloc=function(r,e,t){return Oo(r,e,t)};
function Ht(r){return Vn(r),fe(r<0?0:$t(r)|0)}a(Ht,"allocUnsafe");h.allocUnsafe=function(r){return Ht(
r)};h.allocUnsafeSlow=function(r){return Ht(r)};function qo(r,e){if((typeof e!="string"||e==="")&&(e=
"utf8"),!h.isEncoding(e))throw new TypeError("Unknown encoding: "+e);let t=zn(r,e)|0,n=fe(t),i=n.write(
r,e);return i!==t&&(n=n.slice(0,i)),n}a(qo,"fromString");function Nt(r){let e=r.length<0?0:$t(r.length)|
0,t=fe(e);for(let n=0;n<e;n+=1)t[n]=r[n]&255;return t}a(Nt,"fromArrayLike");function Qo(r){if(ce(r,Uint8Array)){
let e=new Uint8Array(r);return Wt(e.buffer,e.byteOffset,e.byteLength)}return Nt(r)}a(Qo,"fromArrayVi\
ew");function Wt(r,e,t){if(e<0||r.byteLength<e)throw new RangeError('"offset" is outside of buffer b\
...
r,e,t),Object.setPrototypeOf(n,h.prototype),n}a(Wt,"fromArrayBuffer");function No(r){if(h.isBuffer(r)){
let e=$t(r.length)|0,t=fe(e);return t.length===0||r.copy(t,0,0,e),t}if(r.length!==void 0)return typeof r.
length!="number"||Vt(r.length)?fe(0):Nt(r);if(r.type==="Buffer"&&Array.isArray(r.data))return Nt(r.data)}
a(No,"fromObject");function $t(r){if(r>=lt)throw new RangeError("Attempt to allocate Buffer larger t\
han maximum size: 0x"+lt.toString(16)+" bytes");return r|0}a($t,"checked");function Wo(r){return+r!=
...
if(i)return n?-1:jt(r).length;e=(""+e).toLowerCase(),i=!0}}a(zn,"byteLength");h.byteLength=zn;function jo(r,e,t){
...
tf8":case"utf-8":return Yn(this,e,t);case"ascii":return Zo(this,e,t);case"latin1":case"binary":return Jo(
this,e,t);case"base64":return Ko(this,e,t);case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return ea(
...
h.prototype.lastIndexOf=a(function(e,t,n){return Kn(this,e,t,n,!1)},"lastIndexOf");function Ho(r,e,t,n){
t=Number(t)||0;let i=r.length-t;n?(n=Number(n),n>i&&(n=i)):n=i;let s=e.length;n>s/2&&(n=s/2);let o;for(o=
0;o<n;++o){let u=parseInt(e.substr(o*2,2),16);if(Vt(u))return o;r[t+o]=u}return o}a(Ho,"hexWrite");function $o(r,e,t,n){
return ft(jt(e,r.length-t),r,t,n)}a($o,"utf8Write");function Go(r,e,t,n){return ft(ia(e),r,t,n)}a(Go,
"asciiWrite");function Vo(r,e,t,n){return ft(ni(e),r,t,n)}a(Vo,"base64Write");function zo(r,e,t,n){return ft(
sa(e,r.length-t),r,t,n)}a(zo,"ucs2Write");h.prototype.write=a(function(e,t,n,i){if(t===void 0)i="utf\
...
utf-8":return $o(this,e,t,n);case"ascii":case"latin1":case"binary":return Go(this,e,t,n);case"base64":
return Vo(this,e,t,n);case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return zo(this,e,t,n);default:
...
N");function Ko(r,e,t){return e===0&&t===r.length?Qt.fromByteArray(r):Qt.fromByteArray(r.slice(e,t))}
a(Ko,"base64Slice");function Yn(r,e,t){t=Math.min(r.length,t);let n=[],i=e;for(;i<t;){let s=r[i],o=null,
...
n.push(o),i+=u}return Yo(n)}a(Yn,"utf8Slice");var Hn=4096;function Yo(r){let e=r.length;if(e<=Hn)return String.
fromCharCode.apply(String,r);let t="",n=0;for(;n<e;)t+=String.fromCharCode.apply(String,r.slice(n,n+=
Hn));return t}a(Yo,"decodeCodePointsArray");function Zo(r,e,t){let n="";t=Math.min(r.length,t);for(let i=e;i<
...
let t=this[e],n=this[e+7];(t===void 0||n===void 0)&&Ne(e,this.length-8);let i=t+this[++e]*2**8+this[++e]*
...
let t=this[e],n=this[e+7];(t===void 0||n===void 0)&&Ne(e,this.length-8);let i=t*2**24+this[++e]*2**16+
...
Ne(e,this.length-8);let i=this[e+4]+this[e+5]*2**8+this[e+6]*2**16+(n<<24);return(BigInt(i)<<BigInt(
32))+BigInt(t+this[++e]*2**8+this[++e]*2**16+this[++e]*2**24)},"readBigInt64LE"));h.prototype.readBigInt64BE=
ge(a(function(e){e=e>>>0,Pe(e,"offset");let t=this[e],n=this[e+7];(t===void 0||n===void 0)&&Ne(e,this.
...
return e=e>>>0,t||O(e,4,this.length),Ie.read(this,e,!0,23,4)},"readFloatLE");h.prototype.readFloatBE=
a(function(e,t){return e=e>>>0,t||O(e,4,this.length),Ie.read(this,e,!1,23,4)},"readFloatBE");h.prototype.
readDoubleLE=a(function(e,t){return e=e>>>0,t||O(e,8,this.length),Ie.read(this,e,!0,52,8)},"readDoub\
leLE");h.prototype.readDoubleBE=a(function(e,t){return e=e>>>0,t||O(e,8,this.length),Ie.read(this,e,
...
writeBigUInt64LE=ge(a(function(e,t=0){return Zn(this,e,t,BigInt(0),BigInt("0xffffffffffffffff"))},"w\
riteBigUInt64LE"));h.prototype.writeBigUInt64BE=ge(a(function(e,t=0){return Jn(this,e,t,BigInt(0),BigInt(
...
t+4},"writeInt32BE");h.prototype.writeBigInt64LE=ge(a(function(e,t=0){return Zn(this,e,t,-BigInt("0x\
...
+e,t=t>>>0,i||Xn(r,e,t,4,34028234663852886e22,-34028234663852886e22),Ie.write(r,e,t,n,23,4),t+4}a(ei,
...
return e=+e,t=t>>>0,i||Xn(r,e,t,8,17976931348623157e292,-17976931348623157e292),Ie.write(r,e,t,n,52,
...
0;s<n-t;++s)this[s+t]=o[s%u]}return this},"fill");var Te={};function Gt(r,e,t){var n;Te[r]=(n=class extends t{constructor(){
...
_${r.slice(t-3,t)}${e}`;return`${r.slice(0,t)}${e}`}a($n,"addNumericalSeparator");function ta(r,e,t){
Pe(e,"offset"),(r[e]===void 0||r[e+t]===void 0)&&Ne(e,r.length-(t+1))}a(ta,"checkBounds");function ri(r,e,t,n,i,s){
...
nd <= ${t}${o}`,new Te.ERR_OUT_OF_RANGE("value",u,r)}ta(n,i,s)}a(ri,"checkIntBI");function Pe(r,e){if(typeof r!=
"number")throw new Te.ERR_INVALID_ARG_TYPE(e,"number",r)}a(Pe,"validateNumber");function Ne(r,e,t){throw Math.
floor(r)!==r?(Pe(r,t),new Te.ERR_OUT_OF_RANGE(t||"offset","an integer",r)):e<0?new Te.ERR_BUFFER_OUT_OF_BOUNDS:
new Te.ERR_OUT_OF_RANGE(t||"offset",`>= ${t?1:0} and <= ${e}`,r)}a(Ne,"boundsError");var ra=/[^+/0-9A-Za-z-_]/g;
function na(r){if(r=r.split("=")[0],r=r.trim().replace(ra,""),r.length<2)return"";for(;r.length%4!==
0;)r=r+"=";return r}a(na,"base64clean");function jt(r,e){e=e||1/0;let t,n=r.length,i=null,s=[];for(let o=0;o<
...
o),n=t>>8,i=t%256,s.push(i),s.push(n);return s}a(sa,"utf16leToBytes");function ni(r){return Qt.toByteArray(
na(r))}a(ni,"base64ToBytes");function ft(r,e,t,n){let i;for(i=0;i<n&&!(i+t>=e.length||i>=r.length);++i)
...
r}a(Vt,"numberIsNaN");var oa=(function(){let r="0123456789abcdef",e=new Array(256);for(let t=0;t<16;++t){
let n=t*16;for(let i=0;i<16;++i)e[n+i]=r[t]+r[i]}return e})();function ge(r){return typeof BigInt>"u"?
aa:r}a(ge,"defineBigIntMethod");function aa(){throw new Error("BigInt not supported")}a(aa,"BufferBi\
...
m.nextTick(()=>{})}catch{let e=Promise.resolve();m.nextTick=e.then.bind(e)}});var be=T((lf,Zt)=>{"use strict";p();var Be=typeof Reflect=="object"?Reflect:null,hi=Be&&typeof Be.apply==
"function"?Be.apply:a(function(e,t,n){return Function.prototype.apply.call(e,t,n)},"ReflectApply"),wt;
Be&&typeof Be.ownKeys=="function"?wt=Be.ownKeys:Object.getOwnPropertySymbols?wt=a(function(e){return Object.
getOwnPropertyNames(e).concat(Object.getOwnPropertySymbols(e))},"ReflectOwnKeys"):wt=a(function(e){return Object.
getOwnPropertyNames(e)},"ReflectOwnKeys");function va(r){console&&console.warn&&console.warn(r)}a(va,
"ProcessEmitWarning");var di=Number.isNaN||a(function(e){return e!==e},"NumberIsNaN");function R(){R.
init.call(this)}a(R,"EventEmitter");Zt.exports=R;Zt.exports.once=Aa;R.EventEmitter=R;R.prototype._events=
void 0;R.prototype._eventsCount=0;R.prototype._maxListeners=void 0;var pi=10;function bt(r){if(typeof r!=
"function")throw new TypeError('The "listener" argument must be of type Function. Received type '+typeof r)}
a(bt,"checkListener");Object.defineProperty(R,"defaultMaxListeners",{enumerable:!0,get:a(function(){
return pi},"get"),set:a(function(r){if(typeof r!="number"||r<0||di(r))throw new RangeError('The valu\
e of "defaultMaxListeners" is out of range. It must be a non-negative number. Received '+r+".");pi=r},
...
R.prototype.setMaxListeners=a(function(e){if(typeof e!="number"||e<0||di(e))throw new RangeError('Th\
e value of "n" is out of range. It must be a non-negative number. Received '+e+".");return this._maxListeners=
e,this},"setMaxListeners");function yi(r){return r._maxListeners===void 0?R.defaultMaxListeners:r._maxListeners}
a(yi,"_getMaxListeners");R.prototype.getMaxListeners=a(function(){return yi(this)},"getMaxListeners");
...
throw u.context=o,u}var c=s[e];if(c===void 0)return!1;if(typeof c=="function")hi(c,this,t);else for(var l=c.
length,f=vi(c,l),n=0;n<l;++n)hi(f[n],this,t);return!0},"emit");function mi(r,e,t,n){var i,s,o;if(bt(
...
r,u.type=e,u.count=o.length,va(u)}return r}a(mi,"_addListener");R.prototype.addListener=a(function(e,t){
return mi(this,e,t,!1)},"addListener");R.prototype.on=R.prototype.addListener;R.prototype.prependListener=
a(function(e,t){return mi(this,e,t,!0)},"prependListener");function xa(){if(!this.fired)return this.
target.removeListener(this.type,this.wrapFn),this.fired=!0,arguments.length===0?this.listener.call(this.
target):this.listener.apply(this.target,arguments)}a(xa,"onceWrapper");function gi(r,e,t){var n={fired:!1,
wrapFn:void 0,target:r,type:e,listener:t},i=xa.bind(n);return i.listener=t,n.wrapFn=i,i}a(gi,"_onceW\
rap");R.prototype.once=a(function(e,t){return bt(t),this.on(e,gi(this,e,t)),this},"once");R.prototype.
prependOnceListener=a(function(e,t){return bt(t),this.prependListener(e,gi(this,e,t)),this},"prepend\
...
listener,s=o;break}if(s<0)return this;s===0?n.shift():Sa(n,s),n.length===1&&(i[e]=n[0]),i.removeListener!==
...
0;i--)this.removeListener(e,t[i]);return this},"removeAllListeners");function wi(r,e,t){var n=r._events;
if(n===void 0)return[];var i=n[e];return i===void 0?[]:typeof i=="function"?t?[i.listener||i]:[i]:t?
Ea(i):vi(i,i.length)}a(wi,"_listeners");R.prototype.listeners=a(function(e){return wi(this,e,!0)},"l\
isteners");R.prototype.rawListeners=a(function(e){return wi(this,e,!1)},"rawListeners");R.listenerCount=
function(r,e){return typeof r.listenerCount=="function"?r.listenerCount(e):bi.call(r,e)};R.prototype.
listenerCount=bi;function bi(r){var e=this._events;if(e!==void 0){var t=e[r];if(typeof t=="function")
return 1;if(t!==void 0)return t.length}return 0}a(bi,"listenerCount");R.prototype.eventNames=a(function(){
return this._eventsCount>0?wt(this._events):[]},"eventNames");function vi(r,e){for(var t=new Array(e),
n=0;n<e;++n)t[n]=r[n];return t}a(vi,"arrayClone");function Sa(r,e){for(;e+1<r.length;e++)r[e]=r[e+1];
r.pop()}a(Sa,"spliceOne");function Ea(r){for(var e=new Array(r.length),t=0;t<e.length;++t)e[t]=r[t].
listener||r[t];return e}a(Ea,"unwrapListeners");function Aa(r,e){return new Promise(function(t,n){function i(o){
r.removeListener(e,s),n(o)}a(i,"errorListener");function s(){typeof r.removeListener=="function"&&r.
removeListener("error",i),t([].slice.call(arguments))}a(s,"resolver"),xi(r,e,s,{once:!0}),e!=="error"&&
_a(r,i,{once:!0})})}a(Aa,"once");function _a(r,e,t){typeof r.on=="function"&&xi(r,"error",e,t)}a(_a,
"addErrorHandlerIfEventEmitter");function xi(r,e,t,n){if(typeof r.on=="function")n.once?r.once(e,t):
...
ust be of type EventEmitter. Received type '+typeof r)}a(xi,"eventTargetAgnosticAddListener")});var Ai={};ne(Ai,{Socket:()=>pe,isIP:()=>Ca});function Ca(r){return 0}var Ei,Si,A,pe,$e=G(()=>{"use s\
trict";p();Ei=me(be(),1);a(Ca,"isIP");Si=/^[^.]+\./,A=class A extends Ei.EventEmitter{constructor(){
...
poolQueryViaFetch:!1,fetchEndpoint:a((t,n,i)=>{let s;return i?.jwtAuth?s=t.replace(Si,"apiauth."):s=
t.replace(Si,"api."),"https://"+s+"/sql"},"fetchEndpoint"),fetchConnectionCache:!0,fetchFunction:void 0,
...
disableWarningInBrowsers:!1}),S(A,"opts",{});pe=A});var Xt=T(_i=>{"use strict";p();_i.parse=function(r,e){return new Jt(r,e).parse()};var vt=class vt{constructor(e,t){
...
not balanced");return this.entries}};a(vt,"ArrayParser");var Jt=vt;function Ta(r){return r}a(Ta,"ide\
ntity")});var er=T((wf,Ci)=>{p();var Ia=Xt();Ci.exports={create:a(function(r,e){return{parse:a(function(){return Ia.
parse(r,e)},"parse")}},"create")}});var Pi=T((xf,Ii)=>{"use strict";p();var Pa=/(\d{1,})-(\d{2})-(\d{2}) (\d{2}):(\d{2}):(\d{2})(\.\d{1,})?.*?( BC)?$/,
Ra=/^(\d{1,})-(\d{2})-(\d{2})( BC)?$/,Ba=/([Z+-])(\d{2})?:?(\d{2})?:?(\d{2})?/,La=/^-?infinity$/;Ii.
exports=a(function(e){if(La.test(e))return Number(e.replace("i","I"));var t=Pa.exec(e);if(!t)return ka(
e)||null;var n=!!t[8],i=parseInt(t[1],10);n&&(i=Ti(i));var s=parseInt(t[2],10)-1,o=t[3],u=parseInt(t[4],
10),c=parseInt(t[5],10),l=parseInt(t[6],10),f=t[7];f=f?1e3*parseFloat(f):0;var y,g=Fa(e);return g!=null?
(y=new Date(Date.UTC(i,s,o,u,c,l,f)),tr(i)&&y.setUTCFullYear(i),g!==0&&y.setTime(y.getTime()-g)):(y=
new Date(i,s,o,u,c,l,f),tr(i)&&y.setFullYear(i)),y},"parseDate");function ka(r){var e=Ra.exec(r);if(e){
var t=parseInt(e[1],10),n=!!e[4];n&&(t=Ti(t));var i=parseInt(e[2],10)-1,s=e[3],o=new Date(t,i,s);return tr(
t)&&o.setFullYear(t),o}}a(ka,"getDate");function Fa(r){if(r.endsWith("+00"))return 0;var e=Ba.exec(r.
split(" ")[1]);if(e){var t=e[1];if(t==="Z")return 0;var n=t==="-"?-1:1,i=parseInt(e[2],10)*3600+parseInt(
e[3]||0,10)*60+parseInt(e[4]||0,10);return i*n*1e3}}a(Fa,"timeZoneOffset");function Ti(r){return-(r-
1)}a(Ti,"bcYearToNegativeYear");function tr(r){return r>=0&&r<100}a(tr,"is0To99")});var Bi=T((Af,Ri)=>{p();Ri.exports=Ua;var Ma=Object.prototype.hasOwnProperty;function Ua(r){for(var e=1;e<
arguments.length;e++){var t=arguments[e];for(var n in t)Ma.call(t,n)&&(r[n]=t[n])}return r}a(Ua,"ext\
end")});var Fi=T((Tf,ki)=>{"use strict";p();var Da=Bi();ki.exports=Le;function Le(r){if(!(this instanceof Le))
return new Le(r);Da(this,Ka(r))}a(Le,"PostgresInterval");var Oa=["seconds","minutes","hours","days",
"months","years"];Le.prototype.toPostgres=function(){var r=Oa.filter(this.hasOwnProperty,this);return this.
...
S"},Qa=["years","months","days"],Na=["hours","minutes","seconds"];Le.prototype.toISOString=Le.prototype.
...
/0+$/,"")),i+qa[n]}};var rr="([+-]?\\d+)",Wa=rr+"\\s+years?",ja=rr+"\\s+mons?",Ha=rr+"\\s+days?",$a="\
([+-])?([\\d]*):(\\d\\d):(\\d\\d)\\.?(\\d{1,6})?",Ga=new RegExp([Wa,ja,Ha,$a].map(function(r){return"\
("+r+")?"}).join("\\s*")),Li={years:2,months:4,days:6,hours:9,minutes:10,seconds:11,milliseconds:12},
Va=["hours","minutes","seconds","milliseconds"];function za(r){var e=r+"000000".slice(r.length);return parseInt(
e,10)/1e3}a(za,"parseMilliseconds");function Ka(r){if(!r)return{};var e=Ga.exec(r),t=e[8]==="-";return Object.
keys(Li).reduce(function(n,i){var s=Li[i],o=e[s];return!o||(o=i==="milliseconds"?za(o):parseInt(o,10),
!o)||(t&&~Va.indexOf(i)&&(o*=-1),n[i]=o),n},{})}a(Ka,"parse")});var Di=T((Rf,Ui)=>{"use strict";p();var Mi=d.from||d;Ui.exports=a(function(e){if(/^\\x/.test(e))return Mi(
...
e[n+i]==="\\";)i++;for(var s=0;s<Math.floor(i/2);++s)t+="\\";n+=Math.floor(i/2)*2}return Mi(t,"binar\
y")},"parseBytea")});var Hi=T((kf,ji)=>{p();var Ge=Xt(),Ve=er(),xt=Pi(),qi=Fi(),Qi=Di();function St(r){return a(function(t){
return t===null?t:r(t)},"nullAllowed")}a(St,"allowNull");function Ni(r){return r===null?r:r==="TRUE"||
r==="t"||r==="true"||r==="y"||r==="yes"||r==="on"||r==="1"}a(Ni,"parseBool");function Ya(r){return r?
Ge.parse(r,Ni):null}a(Ya,"parseBoolArray");function Za(r){return parseInt(r,10)}a(Za,"parseBaseTenIn\
t");function nr(r){return r?Ge.parse(r,St(Za)):null}a(nr,"parseIntegerArray");function Ja(r){return r?
Ge.parse(r,St(function(e){return Wi(e).trim()})):null}a(Ja,"parseBigIntegerArray");var Xa=a(function(r){
if(!r)return null;var e=Ve.create(r,function(t){return t!==null&&(t=ar(t)),t});return e.parse()},"pa\
rsePointArray"),ir=a(function(r){if(!r)return null;var e=Ve.create(r,function(t){return t!==null&&(t=
parseFloat(t)),t});return e.parse()},"parseFloatArray"),X=a(function(r){if(!r)return null;var e=Ve.create(
r);return e.parse()},"parseStringArray"),sr=a(function(r){if(!r)return null;var e=Ve.create(r,function(t){
return t!==null&&(t=xt(t)),t});return e.parse()},"parseDateArray"),eu=a(function(r){if(!r)return null;
var e=Ve.create(r,function(t){return t!==null&&(t=qi(t)),t});return e.parse()},"parseIntervalArray"),
tu=a(function(r){return r?Ge.parse(r,St(Qi)):null},"parseByteAArray"),or=a(function(r){return parseInt(
r,10)},"parseInteger"),Wi=a(function(r){var e=String(r);return/^\d+$/.test(e)?e:r},"parseBigInteger"),
Oi=a(function(r){return r?Ge.parse(r,St(JSON.parse)):null},"parseJsonArray"),ar=a(function(r){return r[0]!==
"("?null:(r=r.substring(1,r.length-1).split(","),{x:parseFloat(r[0]),y:parseFloat(r[1])})},"parsePoi\
nt"),ru=a(function(r){if(r[0]!=="<"&&r[1]!=="(")return null;for(var e="(",t="",n=!1,i=2;i<r.length-1;i++){
if(n||(e+=r[i]),r[i]===")"){n=!0;continue}else if(!n)continue;r[i]!==","&&(t+=r[i])}var s=ar(e);return s.
radius=parseFloat(t),s},"parseCircle"),nu=a(function(r){r(20,Wi),r(21,or),r(23,or),r(26,or),r(700,parseFloat),
r(701,parseFloat),r(16,Ni),r(1082,xt),r(1114,xt),r(1184,xt),r(600,ar),r(651,X),r(718,ru),r(1e3,Ya),r(
1001,tu),r(1005,nr),r(1007,nr),r(1028,nr),r(1016,Ja),r(1017,Xa),r(1021,ir),r(1022,ir),r(1231,ir),r(1014,
X),r(1015,X),r(1008,X),r(1009,X),r(1040,X),r(1041,X),r(1115,sr),r(1182,sr),r(1185,sr),r(1186,qi),r(1187,
eu),r(17,Qi),r(114,JSON.parse.bind(JSON)),r(3802,JSON.parse.bind(JSON)),r(199,Oi),r(3807,Oi),r(3907,
X),r(2951,X),r(791,X),r(1183,X),r(1270,X)},"init");ji.exports={init:nu}});var Gi=T((Uf,$i)=>{"use strict";p();var z=1e6;function iu(r){var e=r.readInt32BE(0),t=r.readUInt32BE(
...
""+o%z,n+u+i}a(iu,"readInt8");$i.exports=iu});var Zi=T((qf,Yi)=>{p();var su=Gi(),L=a(function(r,e,t,n,i){t=t||0,n=n||!1,i=i||function(w,v,M){return w*
...
r[y]),8);var g=(e+t)%8;return g>0&&(l=i(l,o(r[f])>>8-g,g)),l},"parseBits"),Ki=a(function(r,e,t){var n=Math.
...
return L(r,1)==1?-1*(L(r,15,1,!0)+1):L(r,15,1)},"parseInt16"),Vi=a(function(r){return L(r,1)==1?-1*(L(
r,31,1,!0)+1):L(r,31,1)},"parseInt32"),au=a(function(r){return Ki(r,23,8)},"parseFloat32"),uu=a(function(r){
return Ki(r,52,11)},"parseFloat64"),cu=a(function(r){var e=L(r,16,32);if(e==49152)return NaN;for(var t=Math.
...
null:L(r,8)>0},"parseBool"),hu=a(function(r){r(20,su),r(21,ou),r(23,Vi),r(26,Vi),r(1700,cu),r(700,au),
r(701,uu),r(16,fu),r(1114,zi.bind(null,!1)),r(1184,zi.bind(null,!0)),r(1e3,ze),r(1007,ze),r(1016,ze),
r(1008,ze),r(1009,ze),r(25,lu)},"init");Yi.exports={init:hu}});var Xi=T((Wf,Ji)=>{p();Ji.exports={BOOL:16,BYTEA:17,CHAR:18,INT8:20,INT2:21,INT4:23,REGPROC:24,TEXT:25,
...
REGROLE:4096}});var Ze=T(Ye=>{p();var pu=Hi(),du=Zi(),yu=er(),mu=Xi();Ye.getTypeParser=gu;Ye.setTypeParser=wu;Ye.arrayParser=
yu;Ye.builtins=mu;var Ke={text:{},binary:{}};function es(r){return String(r)}a(es,"noParse");function gu(r,e){
return e=e||"text",Ke[e]&&Ke[e][r]||es}a(gu,"getTypeParser");function wu(r,e,t){typeof e=="function"&&
(t=e,e="text"),Ke[e][r]=t}a(wu,"setTypeParser");pu.init(function(r,e){Ke.text[r]=e});du.init(function(r,e){
Ke.binary[r]=e})});var At=T((Vf,ts)=>{"use strict";p();var bu=Ze();function Et(r){this._types=r||bu,this.text={},this.binary=
...
e||"text",this.getOverrides(e)[r]||this._types.getTypeParser(r,e)};ts.exports=Et});function Je(r){let e=1779033703,t=3144134277,n=1013904242,i=2773480762,s=1359893119,o=2600822924,u=528734635,
...
w[P-2],17)^g(w[P-2],19)^w[P-2]>>>10;w[P]=w[P-16]+$+w[P-7]+Z|0}let I=e,_=t,te=n,re=i,H=s,ie=o,se=u,ye=c;
for(let P=0;P<64;P++){let $=g(H,6)^g(H,11)^g(H,25),Z=H&ie^~H&se,W=ye+$+Z+y[P]+w[P]|0,U=g(I,2)^g(I,13)^
g(I,22),oe=I&_^I&te^_&te,ae=U+oe|0;ye=se,se=ie,ie=H,H=re+W|0,re=te,te=_,_=I,I=W+ae|0}e=e+I|0,t=t+_|0,
n=n+te|0,i=i+re|0,s=s+H|0,o=o+ie|0,u=u+se|0,c=c+ye|0,f=0},"process"),Q=a(I=>{typeof I=="string"&&(I=
new TextEncoder().encode(I));for(let _=0;_<I.length;_++)v[f++]=I[_],f===64&&M();l+=I.length},"add"),
le=a(()=>{if(v[f++]=128,f==64&&M(),f+8>64){for(;f<64;)v[f++]=0;M()}for(;f<58;)v[f++]=0;let I=l*8;v[f++]=
...
return r===void 0?{add:Q,digest:le}:(Q(r),le())}var rs=G(()=>{"use strict";p();a(Je,"sha256")});var F,Xe,ns=G(()=>{"use strict";p();F=class F{constructor(){S(this,"_dataLength",0);S(this,"_bufferL\
...
abcdef"),S(F,"hexOut",[]),S(F,"onePassHasher",new F);Xe=F});var ur={};ne(ur,{createHash:()=>xu,createHmac:()=>Su,randomBytes:()=>vu});function vu(r){return crypto.
getRandomValues(d.alloc(r))}function xu(r){if(r==="sha256")return{update:a(function(e){return{digest:a(
function(){return d.from(Je(e))},"digest")}},"update")};if(r==="md5")return{update:a(function(e){return{
digest:a(function(){return typeof e=="string"?Xe.hashStr(e):Xe.hashByteArray(e)},"digest")}},"update")};
...
64);o.set(i,0),o.set(t,64);let u=new Uint8Array(96);return u.set(s,0),u.set(Je(o),64),d.from(Je(u))},
"digest")}},"update")}}var cr=G(()=>{"use strict";p();rs();ns();a(vu,"randomBytes");a(xu,"createHash");
a(Su,"createHmac")});var et=T((oh,lr)=>{"use strict";p();lr.exports={host:"localhost",user:m.platform==="win32"?m.env.USERNAME:
...
keepalives:1,keepalives_idle:0};var ke=Ze(),Eu=ke.getTypeParser(20,"text"),Au=ke.getTypeParser(1016,
"text");lr.exports.__defineSetter__("parseInt8",function(r){ke.setTypeParser(20,"text",r?ke.getTypeParser(
23,"text"):Eu),ke.setTypeParser(1016,"text",r?ke.getTypeParser(1007,"text"):Au)})});var tt=T((uh,ss)=>{"use strict";p();var _u=(cr(),D(ur)),Cu=et();function Tu(r){var e=r.replace(/\\/g,
"\\\\").replace(/"/g,'\\"');return'"'+e+'"'}a(Tu,"escapeElement");function is(r){for(var e="{",t=0;t<
r.length;t++)t>0&&(e=e+","),r[t]===null||typeof r[t]>"u"?e=e+"NULL":Array.isArray(r[t])?e=e+is(r[t]):
r[t]instanceof d?e+="\\\\x"+r[t].toString("hex"):e+=Tu(_t(r[t]));return e=e+"}",e}a(is,"arrayString");
...
r.byteLength)}return r instanceof Date?Cu.parseInputDatesAsUTC?Ru(r):Pu(r):Array.isArray(r)?is(r):typeof r==
...
r query');return e.push(r),_t(r.toPostgres(_t),e)}return JSON.stringify(r)}a(Iu,"prepareObject");function N(r,e){
...
t),r}a(Bu,"normalizeQueryConfig");var fr=a(function(r){return _u.createHash("md5").update(r,"utf-8").
digest("hex")},"md5"),Lu=a(function(r,e,t){var n=fr(e+r),i=fr(d.concat([d.from(n),t]));return"md5"+i},
"postgresMd5PasswordHash");ss.exports={prepareValue:a(function(e){return _t(e)},"prepareValueWrapper"),
normalizeQueryConfig:Bu,postgresMd5PasswordHash:Lu,md5:fr}});var rt={};ne(rt,{default:()=>Mu});var Mu,nt=G(()=>{"use strict";p();Mu={}});var ms=T((Sh,ys)=>{"use strict";p();var hr=(cr(),D(ur));function Uu(r){if(r.indexOf("SCRAM-SHA-256")===
...
art with client nonce");var i=d.from(n.salt,"base64"),s=ju(e,i,n.iteration),o=Fe(s,"Client Key"),u=Wu(
o),c="n=*,r="+r.clientNonce,l="r="+n.nonce+",s="+n.salt+",i="+n.iteration,f="c=biws,r="+n.nonce,y=c+
","+l+","+f,g=Fe(u,y),w=ds(o,g),v=w.toString("base64"),M=Fe(s,"Server Key"),Q=Fe(M,y);r.message="SAS\
LResponse",r.serverSignature=Q.toString("base64"),r.response=f+",p="+v}a(Du,"continueSession");function Ou(r,e){
if(r.message!=="SASLResponse")throw new Error("SASL: Last message was not SASLResponse");if(typeof e!=
"string")throw new Error("SASL: SCRAM-SERVER-FINAL-MESSAGE: serverData must be a string");let{serverSignature:t}=Nu(
e);if(t!==r.serverSignature)throw new Error("SASL: SCRAM-SERVER-FINAL-MESSAGE: server signature does\
 not match")}a(Ou,"finalizeSession");function qu(r){if(typeof r!="string")throw new TypeError("SASL:\
...
Pairs");function Qu(r){let e=ps(r),t=e.get("r");if(t){if(!qu(t))throw new Error("SASL: SCRAM-SERVER-\
...
function Nu(r){let t=ps(r).get("v");if(t){if(!hs(t))throw new Error("SASL: SCRAM-SERVER-FINAL-MESSAG\
E: server signature must be base64")}else throw new Error("SASL: SCRAM-SERVER-FINAL-MESSAGE: server \
signature is missing");return{serverSignature:t}}a(Nu,"parseServerFinalMessage");function ds(r,e){if(!d.
...
a(ds,"xorBuffers");function Wu(r){return hr.createHash("sha256").update(r).digest()}a(Wu,"sha256");function Fe(r,e){
return hr.createHmac("sha256",r).update(e).digest()}a(Fe,"hmacSha256");function ju(r,e,t){for(var n=Fe(
r,d.concat([e,d.from([0,0,0,1])])),i=n,s=0;s<t-1;s++)n=Fe(r,n),i=ds(i,n);return i}a(ju,"Hi");ys.exports=
{startSession:Uu,continueSession:Du,finalizeSession:Ou}});var pr={};ne(pr,{join:()=>Hu});function Hu(...r){return r.join("/")}var dr=G(()=>{"use strict";p();a(
Hu,"join")});var yr={};ne(yr,{stat:()=>$u});function $u(r,e){e(new Error("No filesystem"))}var mr=G(()=>{"use str\
ict";p();a($u,"stat")});var gr={};ne(gr,{default:()=>Gu});var Gu,wr=G(()=>{"use strict";p();Gu={}});var gs={};ne(gs,{StringDecoder:()=>br});var vr,br,ws=G(()=>{"use strict";p();vr=class vr{constructor(e){
S(this,"td");this.td=new TextDecoder(e)}write(e){return this.td.decode(e,{stream:!0})}end(e){return this.
td.decode(e)}};a(vr,"StringDecoder");br=vr});var Ss=T((Lh,xs)=>{"use strict";p();var{Transform:Vu}=(wr(),D(gr)),{StringDecoder:zu}=(ws(),D(gs)),ve=Symbol(
"last"),Ct=Symbol("decoder");function Ku(r,e,t){let n;if(this.overflow){if(n=this[Ct].write(r).split(
this.matcher),n.length===1)return t();n.shift(),this.overflow=!1}else this[ve]+=this[Ct].write(r),n=
this[ve].split(this.matcher);this[ve]=n.pop();for(let i=0;i<n.length;i++)try{vs(this,this.mapper(n[i]))}catch(s){
return t(s)}if(this.overflow=this[ve].length>this.maxLength,this.overflow&&!this.skipOverflow){t(new Error(
"maximum buffer reached"));return}t()}a(Ku,"transform");function Yu(r){if(this[ve]+=this[Ct].end(),this[ve])
try{vs(this,this.mapper(this[ve]))}catch(e){return r(e)}r()}a(Yu,"flush");function vs(r,e){e!==void 0&&
r.push(e)}a(vs,"push");function bs(r){return r}a(bs,"noop");function Zu(r,e,t){switch(r=r||/\r?\n/,e=
...
"object"&&(t=e,e=bs)}t=Object.assign({},t),t.autoDestroy=!0,t.transform=Ku,t.flush=Yu,t.readableObjectMode=
!0;let n=new Vu(t);return n[ve]="",n[Ct]=new zu("utf8"),n.matcher=r,n.mapper=e,n.maxLength=t.maxLength,
n.skipOverflow=t.skipOverflow||!1,n.overflow=!1,n._destroy=function(i,s){this._writableState.errorEmitted=
!1,s(i)},n}a(Zu,"split");xs.exports=Zu});var _s=T((Mh,de)=>{"use strict";p();var Es=(dr(),D(pr)),Ju=(wr(),D(gr)).Stream,Xu=Ss(),As=(nt(),D(rt)),
ec=5432,Tt=m.platform==="win32",it=m.stderr,tc=56,rc=7,nc=61440,ic=32768;function sc(r){return(r&nc)==
ic}a(sc,"isRegFile");var Me=["host","port","database","user","password"],xr=Me.length,oc=Me[xr-1];function Sr(){
var r=it instanceof Ju&&it.writable===!0;if(r){var e=Array.prototype.slice.call(arguments).concat(`
`);it.write(As.format.apply(As,e))}}a(Sr,"warn");Object.defineProperty(de.exports,"isWin",{get:a(function(){
return Tt},"get"),set:a(function(r){Tt=r},"set")});de.exports.warnTo=function(r){var e=it;return it=
r,e};de.exports.getFileName=function(r){var e=r||m.env,t=e.PGPASSFILE||(Tt?Es.join(e.APPDATA||"./","\
postgresql","pgpass.conf"):Es.join(e.HOME||"./",".pgpass"));return t};de.exports.usePgPass=function(r,e){
return Object.prototype.hasOwnProperty.call(m.env,"PGPASSWORD")?!1:Tt?!0:(e=e||"<unkn>",sc(r.mode)?r.
mode&(tc|rc)?(Sr('WARNING: password file "%s" has group or world access; permissions should be u=rw \
(0600) or less',e),!1):!0:(Sr('WARNING: password file "%s" is not a plain file',e),!1))};var ac=de.exports.
match=function(r,e){return Me.slice(0,-1).reduce(function(t,n,i){return i==1&&Number(r[n]||ec)===Number(
e[n])?t&&!0:t&&(e[n]==="*"||e[n]===r[n])},!0)};de.exports.getPassword=function(r,e,t){var n,i=e.pipe(
Xu());function s(c){var l=uc(c);l&&cc(l)&&ac(r,l)&&(n=l[oc],i.end())}a(s,"onLine");var o=a(function(){
...
replace(/\\([:\\])/g,"$1")),o[Me[f]]=w},"addToObj"),l=0;l<r.length-1;l+=1){if(e=r.charAt(l+1),t=r.charAt(
l),u=n==xr-1,u){c(n,i);break}l>=0&&e==":"&&t!=="\\"&&(c(n,i,l+1),i=l+2,n+=1)}return o=Object.keys(o).
length===xr?o:null,o},cc=de.exports.isValidEntry=function(r){for(var e={0:function(o){return o.length>
...
0}},t=0;t<Me.length;t+=1){var n=e[t],i=r[Me[t]]||"",s=n(i);if(!s)return!1}return!0}});var Ts=T((qh,Er)=>{"use strict";p();var Oh=(dr(),D(pr)),Cs=(mr(),D(yr)),It=_s();Er.exports=function(r,e){
var t=It.getFileName();Cs.stat(t,function(n,i){if(n||!It.usePgPass(i,t))return e(void 0);var s=Cs.createReadStream(
t);It.getPassword(r,s,e)})};Er.exports.warnTo=It.warnTo});var Is={};ne(Is,{default:()=>lc});var lc,Ps=G(()=>{"use strict";p();lc={}});var Rs={};ne(Rs,{parse:()=>fc});function fc(r,e=!1){let{protocol:t}=new URL(r),n="http:"+r.substring(
...
pathname:l,search:f,query:v,hash:g}}var Bs=G(()=>{"use strict";p();a(fc,"parse")});var Cr=T((Hh,Ls)=>{"use strict";p();var hc=(Bs(),D(Rs)),Ar=(mr(),D(yr));function _r(r){if(r.charAt(0)===
...
!1;break}}return t}a(_r,"parse");Ls.exports=_r;_r.parse=_r});var Pt=T((Vh,Ms)=>{"use strict";p();var pc=(Ps(),D(Is)),Fs=et(),ks=Cr().parse,j=a(function(r,e,t){return t===
void 0?t=m.env["PG"+r.toUpperCase()]:t===!1||(t=m.env[t]),e[r]||t||Fs[r]},"val"),dc=a(function(){switch(m.
env.PGSSLMODE){case"disable":return!1;case"prefer":case"require":case"verify-ca":case"verify-full":return!0;case"\
no-verify":return{rejectUnauthorized:!1}}return Fs.ssl},"readSSLConfigFromEnvironment"),Ue=a(function(r){
return"'"+(""+r).replace(/\\/g,"\\\\").replace(/'/g,"\\'")+"'"},"quoteParamValue"),ee=a(function(r,e,t){
var n=e[t];n!=null&&r.push(t+"="+Ue(n))},"add"),Ir=class Ir{constructor(e){e=typeof e=="string"?ks(e):
...
var t=[];ee(t,this,"user"),ee(t,this,"password"),ee(t,this,"port"),ee(t,this,"application_name"),ee(
t,this,"fallback_application_name"),ee(t,this,"connect_timeout"),ee(t,this,"options");var n=typeof this.
ssl=="object"?this.ssl:this.ssl?{sslmode:this.ssl}:{};if(ee(t,n,"sslmode"),ee(t,n,"sslca"),ee(t,n,"s\
slkey"),ee(t,n,"sslcert"),ee(t,n,"sslrootcert"),this.database&&t.push("dbname="+Ue(this.database)),this.
...
pc.lookup(this.host,function(i,s){return i?e(i,null):(t.push("hostaddr="+Ue(s)),e(null,t.join(" ")))})}};
a(Ir,"ConnectionParameters");var Tr=Ir;Ms.exports=Tr});var Os=T((Yh,Ds)=>{"use strict";p();var yc=Ze(),Us=/^([A-Za-z]+)(?: (\d+))?(?: (\d+))?/,Rr=class Rr{constructor(e,t){
...
format||"text")}}};a(Rr,"Result");var Pr=Rr;Ds.exports=Pr});var Ws=T((Xh,Ns)=>{"use strict";p();var{EventEmitter:mc}=be(),qs=Os(),Qs=tt(),Lr=class Lr extends mc{constructor(e,t,n){
...
e.sendCopyFail("No source stream defined")}handleCopyData(e,t){}};a(Lr,"Query");var Br=Lr;Ns.exports=
Br});var un=T(C=>{"use strict";p();Object.defineProperty(C,"__esModule",{value:!0});C.NoticeMessage=C.DataRowMessage=
...
name=n}};a(Vr,"DatabaseError");var kr=Vr;C.DatabaseError=kr;var zr=class zr{constructor(e,t){this.length=
e,this.chunk=t,this.name="copyData"}};a(zr,"CopyDataMessage");var Fr=zr;C.CopyDataMessage=Fr;var Kr=class Kr{constructor(e,t,n,i){
this.length=e,this.name=t,this.binary=n,this.columnTypes=new Array(i)}};a(Kr,"CopyResponse");var Mr=Kr;
C.CopyResponse=Mr;var Yr=class Yr{constructor(e,t,n,i,s,o,u){this.name=e,this.tableID=t,this.columnID=
n,this.dataTypeID=i,this.dataTypeSize=s,this.dataTypeModifier=o,this.format=u}};a(Yr,"Field");var Ur=Yr;
C.Field=Ur;var Zr=class Zr{constructor(e,t){this.length=e,this.fieldCount=t,this.name="rowDescriptio\
n",this.fields=new Array(this.fieldCount)}};a(Zr,"RowDescriptionMessage");var Dr=Zr;C.RowDescriptionMessage=
...
C.ParameterDescriptionMessage=Or;var Xr=class Xr{constructor(e,t,n){this.length=e,this.parameterName=
t,this.parameterValue=n,this.name="parameterStatus"}};a(Xr,"ParameterStatusMessage");var qr=Xr;C.ParameterStatusMessage=
qr;var en=class en{constructor(e,t){this.length=e,this.salt=t,this.name="authenticationMD5Password"}};
a(en,"AuthenticationMD5Password");var Qr=en;C.AuthenticationMD5Password=Qr;var tn=class tn{constructor(e,t,n){
this.length=e,this.processID=t,this.secretKey=n,this.name="backendKeyData"}};a(tn,"BackendKeyDataMes\
sage");var Nr=tn;C.BackendKeyDataMessage=Nr;var rn=class rn{constructor(e,t,n,i){this.length=e,this.
processId=t,this.channel=n,this.payload=i,this.name="notification"}};a(rn,"NotificationResponseMessa\
ge");var Wr=rn;C.NotificationResponseMessage=Wr;var nn=class nn{constructor(e,t){this.length=e,this.
status=t,this.name="readyForQuery"}};a(nn,"ReadyForQueryMessage");var jr=nn;C.ReadyForQueryMessage=jr;
var sn=class sn{constructor(e,t){this.length=e,this.text=t,this.name="commandComplete"}};a(sn,"Comma\
ndCompleteMessage");var Hr=sn;C.CommandCompleteMessage=Hr;var on=class on{constructor(e,t){this.length=
e,this.fields=t,this.name="dataRow",this.fieldCount=t.length}};a(on,"DataRowMessage");var $r=on;C.DataRowMessage=
$r;var an=class an{constructor(e,t){this.length=e,this.message=t,this.name="notice"}};a(an,"NoticeMe\
ssage");var Gr=an;C.NoticeMessage=Gr});var js=T(Rt=>{"use strict";p();Object.defineProperty(Rt,"__esModule",{value:!0});Rt.Writer=void 0;var ln=class ln{constructor(e=256){
...
a(ln,"Writer");var cn=ln;Rt.Writer=cn});var $s=T(Lt=>{"use strict";p();Object.defineProperty(Lt,"__esModule",{value:!0});Lt.serialize=void 0;
var fn=js(),B=new fn.Writer,gc=a(r=>{B.addInt16(3).addInt16(0);for(let n of Object.keys(r))B.addCString(
n).addCString(r[n]);B.addCString("client_encoding").addCString("UTF8");let e=B.addCString("").flush(),
t=e.length+4;return new fn.Writer().addInt32(t).add(e).flush()},"startup"),wc=a(()=>{let r=d.allocUnsafe(
8);return r.writeInt32BE(8,0),r.writeInt32BE(80877103,4),r},"requestSsl"),bc=a(r=>B.addCString(r).flush(
112),"password"),vc=a(function(r,e){return B.addCString(r).addInt32PrefixedString(e),B.flush(112)},"\
sendSASLInitialResponseMessage"),xc=a(function(r){return B.addString(r).flush(112)},"sendSCRAMClient\
FinalMessage"),Sc=a(r=>B.addCString(r).flush(81),"query"),Hs=[],Ec=a(r=>{let e=r.name||"";e.length>63&&
...
n;s++)i.addInt32(t[s]);return B.flush(80)},"parse"),De=new fn.Writer,Ac=a(function(r,e){for(let t=0;t<
r.length;t++){let n=e?e(r[t],t):r[t];n==null?(B.addInt16(0),De.addInt32(-1)):n instanceof d?(B.addInt16(
1),De.addInt32(n.length),De.add(n)):(B.addInt16(0),De.addInt32PrefixedString(n))}},"writeValues"),_c=a(
(r={})=>{let e=r.portal||"",t=r.statement||"",n=r.binary||!1,i=r.values||Hs,s=i.length;B.addCString(
e).addCString(t),B.addInt16(s);try{Ac(i,r.valueMapper)}catch(o){throw B.clear(),De.clear(),o}return B.
addInt16(s),B.add(De.flush()),B.addInt16(1),B.addInt16(n?1:0),B.flush(66)},"bind"),Cc=d.from([69,0,0,
0,9,0,0,0,0,0]),Tc=a(r=>{if(!r||!r.portal&&!r.rows)return Cc;let e=r.portal||"",t=r.rows||0,n=d.byteLength(
e),i=4+n+1+4,s=d.allocUnsafe(1+i);return s[0]=69,s.writeInt32BE(i,1),s.write(e,5,"utf-8"),s[n+5]=0,s.
writeUInt32BE(t,s.length-4),s},"execute"),Ic=a((r,e)=>{let t=d.allocUnsafe(16);return t.writeInt32BE(
16,0),t.writeInt16BE(1234,4),t.writeInt16BE(5678,6),t.writeInt32BE(r,8),t.writeInt32BE(e,12),t},"can\
cel"),hn=a((r,e)=>{let n=4+d.byteLength(e)+1,i=d.allocUnsafe(1+n);return i[0]=r,i.writeInt32BE(n,1),
i.write(e,5,"utf-8"),i[n]=0,i},"cstringMessage"),Pc=B.addCString("P").flush(68),Rc=B.addCString("S").
flush(68),Bc=a(r=>r.name?hn(68,`${r.type}${r.name||""}`):r.type==="P"?Pc:Rc,"describe"),Lc=a(r=>{let e=`${r.
type}${r.name||""}`;return hn(67,e)},"close"),kc=a(r=>B.add(r).flush(100),"copyData"),Fc=a(r=>hn(102,
r),"copyFail"),Bt=a(r=>d.from([r,0,0,0,4]),"codeOnlyBuffer"),Mc=Bt(72),Uc=Bt(83),Dc=Bt(88),Oc=Bt(99),
qc={startup:gc,password:bc,requestSsl:wc,sendSASLInitialResponseMessage:vc,sendSCRAMClientFinalMessage:xc,
query:Sc,parse:Ec,bind:_c,execute:Tc,describe:Bc,close:Lc,flush:a(()=>Mc,"flush"),sync:a(()=>Uc,"syn\
c"),end:a(()=>Dc,"end"),copyData:kc,copyDone:a(()=>Oc,"copyDone"),copyFail:Fc,cancel:Ic};Lt.serialize=
qc});var Gs=T(kt=>{"use strict";p();Object.defineProperty(kt,"__esModule",{value:!0});kt.BufferReader=void 0;
var dn=class dn{constructor(e=0){this.offset=e,this.buffer=d.allocUnsafe(0),this.encoding="utf-8"}setBuffer(e,t){
...
offset+=e,t}};a(dn,"BufferReader");var pn=dn;kt.BufferReader=pn});var Ys=T(Ft=>{"use strict";p();Object.defineProperty(Ft,"__esModule",{value:!0});Ft.Parser=void 0;var k=un(),
Qc=Gs(),mn=1,Nc=4,Vs=mn+Nc,Y=-1,yn=d.allocUnsafe(0),wn=class wn{constructor(e){if(this.buffer=yn,this.
bufferLength=0,this.bufferOffset=0,this.reader=new Qc.BufferReader,e?.mode==="binary")throw new Error(
...
readUInt32BE(i+mn),u=mn+o;if(u+i<=n){let c=this.handlePacket(i+Vs,s,o,this.buffer);t(c),i+=u}else break}
i===n?(this.buffer=yn,this.bufferLength=0,this.bufferOffset=0):(this.bufferLength=n-i,this.bufferOffset=
...
break;case 73:o=k.emptyQuery;break;case 68:o=Zc(s);break;case 67:o=jc(s);break;case 90:o=Wc(s);break;case 65:
o=Vc(s);break;case 82:o=el(s,n);break;case 83:o=Jc(s);break;case 75:o=Xc(s);break;case 69:o=zs(s,"er\
ror");break;case 78:o=zs(s,"notice");break;case 84:o=zc(s);break;case 116:o=Yc(s);break;case 71:o=$c(
s);break;case 72:o=Gc(s);break;case 100:o=Hc(s,n);break;default:return new k.DatabaseError("received\
 invalid response: "+t.toString(16),n,"error")}return s.setBuffer(0,yn),o.length=n,o}};a(wn,"Parser");
var gn=wn;Ft.Parser=gn;var Wc=a(r=>{let e=r.string(1);return new k.ReadyForQueryMessage(Y,e)},"parse\
ReadyForQueryMessage"),jc=a(r=>{let e=r.cstring();return new k.CommandCompleteMessage(Y,e)},"parseCo\
mmandCompleteMessage"),Hc=a((r,e)=>{let t=r.bytes(e-4);return new k.CopyDataMessage(Y,t)},"parseCopy\
Data"),$c=a(r=>Ks(r,"copyInResponse"),"parseCopyInMessage"),Gc=a(r=>Ks(r,"copyOutResponse"),"parseCo\
pyOutMessage"),Ks=a((r,e)=>{let t=r.byte()!==0,n=r.int16(),i=new k.CopyResponse(Y,e,t,n);for(let s=0;s<
n;s++)i.columnTypes[s]=r.int16();return i},"parseCopyMessage"),Vc=a(r=>{let e=r.int32(),t=r.cstring(),
n=r.cstring();return new k.NotificationResponseMessage(Y,e,t,n)},"parseNotificationMessage"),zc=a(r=>{
let e=r.int16(),t=new k.RowDescriptionMessage(Y,e);for(let n=0;n<e;n++)t.fields[n]=Kc(r);return t},"\
parseRowDescriptionMessage"),Kc=a(r=>{let e=r.cstring(),t=r.uint32(),n=r.int16(),i=r.uint32(),s=r.int16(),
o=r.int32(),u=r.int16()===0?"text":"binary";return new k.Field(e,t,n,i,s,o,u)},"parseField"),Yc=a(r=>{
let e=r.int16(),t=new k.ParameterDescriptionMessage(Y,e);for(let n=0;n<e;n++)t.dataTypeIDs[n]=r.uint32();
return t},"parseParameterDescriptionMessage"),Zc=a(r=>{let e=r.int16(),t=new Array(e);for(let n=0;n<
e;n++){let i=r.int32();t[n]=i===-1?null:r.string(i)}return new k.DataRowMessage(Y,t)},"parseDataRowM\
essage"),Jc=a(r=>{let e=r.cstring(),t=r.cstring();return new k.ParameterStatusMessage(Y,e,t)},"parse\
ParameterStatusMessage"),Xc=a(r=>{let e=r.int32(),t=r.int32();return new k.BackendKeyDataMessage(Y,e,
t)},"parseBackendKeyData"),el=a((r,e)=>{let t=r.int32(),n={name:"authenticationOk",length:e};switch(t){case 0:
...
t.n,s.file=t.F,s.line=t.L,s.routine=t.R,s},"parseErrorMessage")});var bn=T(_e=>{"use strict";p();Object.defineProperty(_e,"__esModule",{value:!0});_e.DatabaseError=_e.
serialize=void 0;_e.parse=il;var tl=un();Object.defineProperty(_e,"DatabaseError",{enumerable:!0,get:a(
function(){return tl.DatabaseError},"get")});var rl=$s();Object.defineProperty(_e,"serialize",{enumerable:!0,
get:a(function(){return rl.serialize},"get")});var nl=Ys();function il(r,e){let t=new nl.Parser;return r.
on("data",n=>t.parse(n,e)),new Promise(n=>r.on("end",()=>n()))}a(il,"parse")});var Zs={};ne(Zs,{connect:()=>sl});function sl({socket:r,servername:e}){return r.startTls(e),r}var Js=G(
()=>{"use strict";p();a(sl,"connect")});var Sn=T((Sp,to)=>{"use strict";p();var Xs=($e(),D(Ai)),ol=be().EventEmitter,{parse:al,serialize:q}=bn(),
eo=q.flush(),ul=q.sync(),cl=q.end(),xn=class xn extends ol{constructor(e){super(),e=e||{},this.stream=
...
var u=(Js(),D(Zs));let c={socket:n.stream};n.ssl!==!0&&(Object.assign(c,n.ssl),"key"in n.ssl&&(c.key=
...
"end",()=>{this.emit("end")}),al(e,t=>{var n=t.name==="error"?"errorMessage":t.name;this._emitMessage&&
...
stream.writable&&this.stream.write(eo)}sync(){this._ending=!0,this._send(eo),this._send(ul)}ref(){this.
stream.ref()}unref(){this.stream.unref()}end(){if(this._ending=!0,!this._connecting||!this.stream.writable){
this.stream.end();return}return this.stream.write(cl,()=>{this.stream.end()})}close(e){this._send(q.
close(e))}describe(e){this._send(q.describe(e))}sendCopyFromChunk(e){this._send(q.copyData(e))}endCopyFrom(){
this._send(q.copyDone())}sendCopyFail(e){this._send(q.copyFail(e))}};a(xn,"Connection");var vn=xn;to.
exports=vn});var io=T((Cp,no)=>{"use strict";p();var ll=be().EventEmitter,_p=(nt(),D(rt)),fl=tt(),En=ms(),hl=Ts(),
pl=At(),dl=Pt(),ro=Ws(),yl=et(),ml=Sn(),An=class An extends ll{constructor(e){super(),this.connectionParameters=
new dl(e),this.user=this.connectionParameters.user,this.database=this.connectionParameters.database,
...
this._types=new pl(t.types),this._ending=!1,this._connecting=!1,this._connected=!1,this._connectionError=
!1,this._queryable=!0,this.connection=t.connection||new ml({stream:t.stream,ssl:this.connectionParameters.
ssl,keepAlive:t.keepAlive||!1,keepAliveInitialDelayMillis:t.keepAliveInitialDelayMillis||0,encoding:this.
connectionParameters.client_encoding||"utf8"}),this.queryQueue=[],this.binary=t.binary||yl.binary,this.
...
password=this.password=null;e()}).catch(n=>{t.emit("error",n)}):this.password!==null?e():hl(this.connectionParameters,
n=>{n!==void 0&&(this.connectionParameters.password=this.password=n),e()})}_handleAuthCleartextPassword(e){
this._checkPgPass(()=>{this.connection.password(this.password)})}_handleAuthMD5Password(e){this._checkPgPass(
()=>{let t=fl.postgresMd5PasswordHash(this.user,this.password,e.salt);this.connection.password(t)})}_handleAuthSASL(e){
this._checkPgPass(()=>{this.saslSession=En.startSession(e.mechanisms),this.connection.sendSASLInitialResponseMessage(
this.saslSession.mechanism,this.saslSession.response)})}_handleAuthSASLContinue(e){En.continueSession(
this.saslSession,this.password,e.data),this.connection.sendSCRAMClientFinalMessage(this.saslSession.
response)}_handleAuthSASLFinal(e){En.finalizeSession(this.saslSession,e.data),this.saslSession=null}_handleBackendKeyData(e){
...
_Promise(t=>{this.connection.once("end",t)})}};a(An,"Client");var Mt=An;Mt.Query=ro;no.exports=Mt});var ao=T((Pp,oo)=>{"use strict";p();var gl=be().EventEmitter,_n=a(function(){},"NOOP"),so=a((r,e)=>{
let t=r.findIndex(e);return t===-1?void 0:r.splice(t,1)[0]},"removeWhere"),In=class In{constructor(e,t,n){
this.client=e,this.idleListener=t,this.timeoutId=n}};a(In,"IdleItem");var Cn=In,Pn=class Pn{constructor(e){
this.callback=e}};a(Pn,"PendingItem");var Oe=Pn;function wl(){throw new Error("Release called on cli\
ent which has already been released to the pool.")}a(wl,"throwOnDoubleRelease");function Ut(r,e){if(e)
...
function bl(r,e){return a(function t(n){n.client=e,e.removeListener("error",t),e.on("error",()=>{r.log(
"additional client error after disconnection due to error",n)}),r._remove(e),r.emit("error",n,e)},"i\
dleListener")}a(bl,"makeIdleListener");var Rn=class Rn extends gl{constructor(e,t){super(),this.options=
...
this.log=this.options.log||function(){},this.Client=this.options.Client||t||st().Client,this.Promise=
...
_pulseQueue()),!this.options.connectionTimeoutMillis)return this._pendingQueue.push(new Oe(t.callback)),
n;let i=a((u,c,l)=>{clearTimeout(o),t.callback(u,c,l)},"queueCallback"),s=new Oe(i),o=setTimeout(()=>{
...
push(s),n}return this.newClient(new Oe(t.callback)),n}newClient(e){let t=new this.Client(this.options);
this._clients.push(t);let n=bl(this,t);this.log("checking client timeout");let i,s=!1;this.options.connectionTimeoutMillis&&
...
-1&&this._acquireClient(e,new Oe((o,u,c)=>c()),n,!1)},this.options.maxLifetimeSeconds*1e3);i.unref(),
...
t.callback(void 0,e,e.release)}_releaseOnce(e,t){let n=!1;return i=>{n&&wl(),n=!0,this._release(e,t,
...
e.unref(),this._idle.push(new Cn(e,t,s)),this._pulseQueue()}query(e,t,n){if(typeof e=="function"){let s=Ut(
...
(this._expired.has(t)?1:0),0)}get totalCount(){return this._clients.length}};a(Rn,"Pool");var Tn=Rn;
oo.exports=Tn});var uo={};ne(uo,{default:()=>vl});var vl,co=G(()=>{"use strict";p();vl={}});var lo=T((kp,xl)=>{xl.exports={name:"pg",version:"8.8.0",description:"PostgreSQL client - pure javas\
...
a178655"}});var po=T((Fp,ho)=>{"use strict";p();var fo=be().EventEmitter,Sl=(nt(),D(rt)),Bn=tt(),qe=ho.exports=function(r,e,t){
fo.call(this),r=Bn.normalizeQueryConfig(r,e,t),this.text=r.text,this.values=r.values,this.name=r.name,
this.callback=r.callback,this.state="new",this._arrayMode=r.rowMode==="array",this._emitRowEvents=!1,
this.on("newListener",function(n){n==="row"&&(this._emitRowEvents=!0)}.bind(this))};Sl.inherits(qe,fo);
var El={sqlState:"code",statementPosition:"position",messagePrimary:"message",context:"where",schemaName:"\
...
pq.resultErrorFields();if(e)for(var t in e){var n=El[t]||t;r[n]=e[t]}this.callback?this.callback(r):
...
prepareValue);r.native.query(this.text,i,t)}else r.native.query(this.text,t)}});var wo=T((Op,go)=>{"use strict";p();var Al=(co(),D(uo)),_l=At(),Dp=lo(),yo=be().EventEmitter,Cl=(nt(),D(rt)),
Tl=Pt(),mo=po(),K=go.exports=function(r){yo.call(this),r=r||{},this._Promise=r.Promise||b.Promise,this.
_types=new _l(r.types),this.native=new Al({types:this._types}),this._queryQueue=[],this._ending=!1,this.
_connecting=!1,this._connected=!1,this._queryable=!0;var e=this.connectionParameters=new Tl(r);this.
...
mo;Cl.inherits(K,yo);K.prototype._errorAllQueries=function(r){let e=a(t=>{m.nextTick(()=>{t.native=this.
...
r,e,t)};K.prototype.getTypeParser=function(r,e){return this._types.getTypeParser(r,e)}});var Ln=T((Np,bo)=>{"use strict";p();bo.exports=wo()});var st=T((jp,ot)=>{"use strict";p();var Il=io(),Pl=et(),Rl=Sn(),Bl=ao(),{DatabaseError:Ll}=bn(),kl=a(
r=>{var e;return e=class extends Bl{constructor(n){super(n,r)}},a(e,"BoundPool"),e},"poolFactory"),kn=a(
function(r){this.defaults=Pl,this.Client=r,this.Query=this.Client.Query,this.Pool=kl(this.Client),this.
_pools=[],this.Connection=Rl,this.types=Ze(),this.DatabaseError=Ll},"PG");typeof m.env.NODE_PG_FORCE_NATIVE<
"u"?ot.exports=new kn(Ln()):(ot.exports=new kn(Il),Object.defineProperty(ot.exports,"native",{configurable:!0,
enumerable:!1,get(){var r=null;try{r=new kn(Ln())}catch(e){if(e.code!=="MODULE_NOT_FOUND")throw e}return Object.
defineProperty(ot.exports,"native",{value:r}),r}}))});p();p();p();var ua=Object.defineProperty,ca=Object.defineProperties,la=Object.getOwnPropertyDescriptors,si=Object.
getOwnPropertySymbols,fa=Object.prototype.hasOwnProperty,ha=Object.prototype.propertyIsEnumerable,oi=a(
(r,e,t)=>e in r?ua(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t,"__defNormalProp"),
pa=a((r,e)=>{for(var t in e||(e={}))fa.call(e,t)&&oi(r,t,e[t]);if(si)for(var t of si(e))ha.call(e,t)&&
oi(r,t,e[t]);return r},"__spreadValues"),da=a((r,e)=>ca(r,la(e)),"__spreadProps"),ya=1008e3,ai=new Uint8Array(
new Uint16Array([258]).buffer)[0]===2,ma=new TextDecoder,zt=new TextEncoder,ht=zt.encode("0123456789\
abcdef"),pt=zt.encode("0123456789ABCDEF"),ga=zt.encode("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqr\
stuvwxyz0123456789+/");var ui=ga.slice();ui[62]=45;ui[63]=95;var We,dt;function wa(r,{alphabet:e,scratchArr:t}={}){if(!We)if(We=
new Uint16Array(256),dt=new Uint16Array(256),ai)for(let v=0;v<256;v++)We[v]=ht[v&15]<<8|ht[v>>>4],dt[v]=
pt[v&15]<<8|pt[v>>>4];else for(let v=0;v<256;v++)We[v]=ht[v&15]|ht[v>>>4]<<8,dt[v]=pt[v&15]|pt[v>>>4]<<
8;r.byteOffset%4!==0&&(r=new Uint8Array(r));let n=r.length,i=n>>>1,s=n>>>2,o=t||new Uint16Array(n),u=new Uint32Array(
r.buffer,r.byteOffset,s),c=new Uint32Array(o.buffer,o.byteOffset,i),l=e==="upper"?dt:We,f=0,y=0,g;if(ai)
...
return ma.decode(o.subarray(0,n))}a(wa,"_toHex");function ba(r,e={}){let t="",n=r.length,i=ya>>>1,s=Math.
ceil(n/i),o=new Uint16Array(s>1?i:n);for(let u=0;u<s;u++){let c=u*i,l=c+i;t+=wa(r.subarray(c,l),da(pa(
{},e),{scratchArr:o}))}return t}a(ba,"_toHexChunked");function ci(r,e={}){return e.alphabet!=="upper"&&
typeof r.toHex=="function"?r.toHex():ba(r,e)}a(ci,"toHex");p();p();var Kt=class Kt{constructor(e,t,n){S(this,"execute",e);S(this,"queryData",t);S(this,"opts",n)}then(e,t){
return this.execute(this.queryData,this.opts).then(e,t)}catch(e){return this.execute(this.queryData,
this.opts).catch(e)}finally(e){return this.execute(this.queryData,this.opts).finally(e)}};a(Kt,"Neon\
QueryPromise");var we=Kt;var yt=class yt{constructor(e,t){S(this,"strings",e);S(this,"values",t)}toParameterizedQuery(e={query:"",
params:[]}){let{strings:t,values:n}=this;for(let i=0,s=t.length;i<s;i++)if(e.query+=t[i],i<n.length){
let o=n[i];if(o instanceof He)e.query+=o.sql;else if(o instanceof we)if(o.queryData instanceof yt)o.
...
d||ArrayBuffer.isView(o))&&(e.query+="::bytea")}}return e}};a(yt,"SqlTemplate");var je=yt,Yt=class Yt{constructor(e){
S(this,"sql",e)}};a(Yt,"UnsafeRawSql");var He=Yt;p();function mt(){typeof window<"u"&&typeof document<"u"&&typeof console<"u"&&typeof console.warn=="func\
tion"&&console.warn(`          
        ************************************************************
        *                                                          *
        ...
        *  parameter.                                              *
        *                                                          *
        ************************************************************`)}a(mt,"warnIfBrowser");function li(r,e){
...
tion=value");return n}a(li,"URLFromPgConnectionString");function rf(r){return"postgresql:"+r.href.slice(
r.protocol.length)}a(rf,"pgConnectionStringFromURL");p();var gt=class gt extends Error{constructor(t){super(t);S(this,"name","NeonDbError");S(this,"severity");
...
gt,"NeonDbError");var he=gt,fi=["severity","code","detail","hint","position","internalPosition","int\
ernalQuery","where","schema","table","column","dataType","constraint","file","line","routine"];$e();var cs=me(At()),ls=me(tt());var os="transaction() expects an array of queries, or a function returning an array of queries";function ku(r){
return r instanceof d?"\\x"+ci(r):r}a(ku,"encodeBuffersAsBytea");function as(r){let{query:e,params:t}=r instanceof
je?r.toParameterizedQuery():r;return{query:e,params:t.map(n=>ku((0,ls.prepareValue)(n)))}}a(as,"prep\
areQuery");function fs(r,{arrayMode:e,fullResults:t,fetchOptions:n,isolationLevel:i,readOnly:s,deferrable:o,
authToken:u,disableWarningInBrowsers:c}={}){if(!r)throw new Error("No database connection string was\
 provided to `neon()`. Perhaps an environment variable has not been set?");let l=li(r,!0);function f(g,...w){
...
LECT $1", [value], options).');return new we(y,new je(g,w))}a(f,"templateFn"),f.query=(g,w,v)=>new we(
y,{query:g,params:w??[]},v),f.unsafe=g=>new He(g),f.transaction=async(g,w)=>{if(typeof g=="function"&&
(g=g(f)),!Array.isArray(g))throw new Error(os);g.forEach(Q=>{if(!(Q instanceof we))throw new Error(os)});
let v=g.map(Q=>Q.queryData),M=g.map(Q=>Q.opts??{});return y(v,M,w)};async function y(g,w,v){let{fetchEndpoint:M,
fetchFunction:Q}=pe,le=Array.isArray(g)?{queries:g.map(W=>as(W))}:as(g),I=n??{},_=e??!1,te=t??!1,re=i,
H=s,ie=o;v!==void 0&&(v.fetchOptions!==void 0&&(I={...I,...v.fetchOptions}),v.arrayMode!==void 0&&(_=
v.arrayMode),v.fullResults!==void 0&&(te=v.fullResults),v.isolationLevel!==void 0&&(re=v.isolationLevel),
...
void 0&&(se=w.authToken);let ye=typeof M=="function"?M(l.hostname,l.port,{jwtAuth:se!==void 0}):M,P={
"Neon-Connection-String":r,"Neon-Raw-Text-Output":"true","Neon-Array-Mode":"true"},$=await Fu(se);$&&
(P.Authorization=`Bearer ${$}`),Array.isArray(g)&&(re!==void 0&&(P["Neon-Batch-Isolation-Level"]=re),
H!==void 0&&(P["Neon-Batch-Read-Only"]=String(H)),ie!==void 0&&(P["Neon-Batch-Deferrable"]=String(ie))),
c||pe.disableWarningInBrowsers||mt();let Z;try{Z=await(Q??fetch)(ye,{method:"POST",body:JSON.stringify(
le),headers:P,...I})}catch(W){let U=new he(`Error connecting to database: ${W}`);throw U.sourceError=
W,U}if(Z.ok){let W=await Z.json();if(Array.isArray(g)){let U=W.results;if(!Array.isArray(U))throw new he(
"Neon internal error: unexpected result format");return U.map((oe,ae)=>{let Qe=w[ae]??{},Dt=Qe.arrayMode??
_,xe=Qe.fullResults??te;return us(oe,{arrayMode:Dt,fullResults:xe,types:Qe.types})})}else{let U=w??{},
oe=U.arrayMode??_,ae=U.fullResults??te;return us(W,{arrayMode:oe,fullResults:ae,types:U.types})}}else{
let{status:W}=Z;if(W===400){let U=await Z.json(),oe=new he(U.message);for(let ae of fi)oe[ae]=U[ae]??
void 0;throw oe}else{let U=await Z.text();throw new he(`Server error (HTTP status ${W}): ${U}`)}}}return a(
y,"execute"),f}a(fs,"neon");function us(r,{arrayMode:e,fullResults:t,types:n}){let i=new cs.default(
...
o[f](l)])));return t?(r.viaNeonFetch=!0,r.rowAsArray=e,r.rows=u,r._parsers=o,r._types=i,r):u}a(us,"p\
rocessQueryResult");async function Fu(r){if(typeof r=="string")return r;if(typeof r=="function")try{
return await Promise.resolve(r())}catch(e){let t=new he("Error getting auth token.");throw e instanceof
Error&&(t=new he(`Error getting auth token: ${e.message}`)),t}}a(Fu,"getAuthToken");p();var xo=me(st());p();var vo=me(st());var Fn=class Fn extends vo.Client{constructor(t){super(t);S(this,"config",t)}get neonConfig(){return this.
...
mt(),this._handleAuthCleartextPassword(),this._handleReadyForQuery()})}return o}async _handleAuthSASLContinue(t){
...
"SASL: protocol error");let u=Object.fromEntries(o.split(",").map(xe=>{if(!/^.=/.test(xe))throw new Error(
"SASL: Invalid attribute pair entry");let Se=xe[0],Eo=xe.substring(2);return[Se,Eo]})),c=u.r,l=u.s,f=u.
...
[g,d.from([0,0,0,1])]))),le=Q;for(var I=0;I<y-1;I++)Q=new Uint8Array(await n.sign("HMAC",M,Q)),le=d.
from(le.map((xe,Se)=>le[Se]^Q[Se]));let _=le,te=await n.importKey("raw",_,{name:"HMAC",hash:{name:"S\
HA-256"}},!1,["sign"]),re=new Uint8Array(await n.sign("HMAC",te,w.encode("Client Key"))),H=await n.digest(
"SHA-256",re),ie="n=*,r="+i.clientNonce,se="r="+c+",s="+l+",i="+y,ye="c=biws,r="+c,P=ie+","+se+","+ye,
$=await n.importKey("raw",H,{name:"HMAC",hash:{name:"SHA-256"}},!1,["sign"]);var Z=new Uint8Array(await n.
sign("HMAC",$,w.encode(P))),W=d.from(re.map((xe,Se)=>re[Se]^Z[Se])),U=W.toString("base64");let oe=await n.
importKey("raw",_,{name:"HMAC",hash:{name:"SHA-256"}},!1,["sign"]),ae=await n.sign("HMAC",oe,w.encode(
"Server Key")),Qe=await n.importKey("raw",ae,{name:"HMAC",hash:{name:"SHA-256"}},!1,["sign"]);var Dt=d.
from(await n.sign("HMAC",Qe,w.encode(P)));i.message="SASLResponse",i.serverSignature=Dt.toString("ba\
se64"),i.response=ye+",p="+U,this.connection.sendSCRAMClientFinalMessage(this.saslSession.response)}};
a(Fn,"NeonClient");var at=Fn;$e();var So=me(Pt());function Fl(r,e){if(e)return{callback:e,result:void 0};let t,n,i=a(function(o,u){o?t(o):n(u)},"cb"),
s=new r(function(o,u){n=o,t=u});return{callback:i,result:s}}a(Fl,"promisify");var Un=class Un extends xo.Pool{constructor(){
super(...arguments);S(this,"Client",at);S(this,"hasFetchUnsupportedListeners",!1);S(this,"addListene\
r",this.on)}on(t,n){return t!=="error"&&(this.hasFetchUnsupportedListeners=!0),super.on(t,n)}query(t,n,i){
if(!pe.poolQueryViaFetch||this.hasFetchUnsupportedListeners||typeof t=="function")return super.query(
t,n,i);typeof n=="function"&&(i=n,n=void 0);let s=Fl(this.Promise,i);i=s.callback;try{let o=new So.default(
this.options),u=encodeURIComponent,c=encodeURI,l=`postgresql://${u(o.user)}:${u(o.password)}@${u(o.host)}\
/${c(o.database)}`,f=typeof t=="string"?t:t.text,y=n??t.values??[];fs(l,{fullResults:!0,arrayMode:t.
rowMode==="array"}).query(f,y,{types:t.types??this.options?.types}).then(w=>i(void 0,w)).catch(w=>i(
w))}catch(o){i(o)}return s.result}};a(Un,"NeonPool");var Mn=Un;$e();var ut=me(st()),Ml=me(Cr()),nd="mjs";var export_DatabaseError=ut.DatabaseError;var export_defaults=ut.defaults;var export_escapeIdentifier=ut.escapeIdentifier;
var export_escapeLiteral=ut.escapeLiteral;var export_parseConnectionString=Ml.parse;var export_types=ut.types;
export{at as Client,export_DatabaseError as DatabaseError,Mn as Pool,je as SqlTemplate,li as URLFromPgConnectionString,
He as UnsafeRawSql,nd as _bundleExt,export_defaults as defaults,export_escapeIdentifier as escapeIdentifier,
export_escapeLiteral as escapeLiteral,fs as neon,pe as neonConfig,export_parseConnectionString as parseConnectionString,
rf as pgConnectionStringFromURL,export_types as types,mt as warnIfBrowser};
