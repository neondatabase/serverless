...
var _o=Object.create;var Ie=Object.defineProperty;var Io=Object.getOwnPropertyDescriptor;var To=Object.getOwnPropertyNames;var Po=Object.getPrototypeOf,Ro=Object.prototype.hasOwnProperty;var Bo=(r,e,t)=>e in r?Ie(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t;var a=(r,e)=>Ie(r,"name",{value:e,configurable:!0});var V=(r,e)=>()=>(r&&(e=r(r=0)),e);var T=(r,e)=>()=>(e||r((e={exports:{}}).exports,e),e.exports),ne=(r,e)=>{for(var t in e)Ie(r,t,{get:e[t],
enumerable:!0})},Nn=(r,e,t,n)=>{if(e&&typeof e=="object"||typeof e=="function")for(let i of To(e))!Ro.
call(r,i)&&i!==t&&Ie(r,i,{get:()=>e[i],enumerable:!(n=Io(e,i))||n.enumerable});return r};var me=(r,e,t)=>(t=r!=null?_o(Po(r)):{},Nn(e||!r||!r.__esModule?Ie(t,"default",{value:r,enumerable:!0}):
t,r)),O=r=>Nn(Ie({},"__esModule",{value:!0}),r);var E=(r,e,t)=>Bo(r,typeof e!="symbol"?e+"":e,t);var Hn=T(ht=>{"use strict";p();ht.byteLength=Fo;ht.toByteArray=Mo;ht.fromByteArray=Oo;var se=[],X=[],
Lo=typeof Uint8Array<"u"?Uint8Array:Array,Nt="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz01\
23456789+/";for(Ee=0,Wn=Nt.length;Ee<Wn;++Ee)se[Ee]=Nt[Ee],X[Nt.charCodeAt(Ee)]=Ee;var Ee,Wn;X[45]=62;
X[95]=63;function jn(r){var e=r.length;if(e%4>0)throw new Error("Invalid string. Length must be a mu\
ltiple of 4");var t=r.indexOf("=");t===-1&&(t=e);var n=t===e?0:4-t%4;return[t,n]}a(jn,"getLens");function Fo(r){
var e=jn(r),t=e[0],n=e[1];return(t+n)*3/4-n}a(Fo,"byteLength");function ko(r,e,t){return(e+t)*3/4-t}
a(ko,"_byteLength");function Mo(r){var e,t=jn(r),n=t[0],i=t[1],s=new Lo(ko(r,n,i)),o=0,u=i>0?n-4:n,c;
...
2,s[o++]=e>>8&255,s[o++]=e&255),s}a(Mo,"toByteArray");function Uo(r){return se[r>>18&63]+se[r>>12&63]+
se[r>>6&63]+se[r&63]}a(Uo,"tripletToBase64");function Do(r,e,t){for(var n,i=[],s=e;s<t;s+=3)n=(r[s]<<
16&16711680)+(r[s+1]<<8&65280)+(r[s+2]&255),i.push(Uo(n));return i.join("")}a(Do,"encodeChunk");function Oo(r){
for(var e,t=r.length,n=t%3,i=[],s=16383,o=0,u=t-n;o<u;o+=s)i.push(Do(r,o,o+s>u?u:o+s));return n===1?
(e=r[t-1],i.push(se[e>>2]+se[e<<4&63]+"==")):n===2&&(e=(r[t-2]<<8)+r[t-1],i.push(se[e>>10]+se[e>>4&63]+
se[e<<2&63]+"=")),i.join("")}a(Oo,"fromByteArray")});var Gn=T(Wt=>{p();Wt.read=function(r,e,t,n,i){var s,o,u=i*8-n-1,c=(1<<u)-1,l=c>>1,f=-7,y=t?i-1:0,w=t?
...
f=(1<<l)-1,y=f>>1,w=i===23?Math.pow(2,-24)-Math.pow(2,-77):0,A=n?0:s-1,_=n?1:-1,j=e<0||e===0&&1/e<0?
...
_,u/=256,i-=8);for(o=o<<i|u,l+=i;l>0;r[t+A]=o&255,A+=_,o/=256,l-=8);r[t+A-_]|=j*128}});var ui=T(Be=>{"use strict";p();var jt=Hn(),Pe=Gn(),$n=typeof Symbol=="function"&&typeof Symbol.for==
"function"?Symbol.for("nodejs.util.inspect.custom"):null;Be.Buffer=h;Be.SlowBuffer=Ho;Be.INSPECT_MAX_BYTES=
50;var pt=2147483647;Be.kMaxLength=pt;h.TYPED_ARRAY_SUPPORT=qo();!h.TYPED_ARRAY_SUPPORT&&typeof console<
...
a(h,"Buffer");h.poolSize=8192;function Yn(r,e,t){if(typeof r=="string")return No(r,e);if(ArrayBuffer.
isView(r))return Wo(r);if(r==null)throw new TypeError("The first argument must be one of type string\
, Buffer, ArrayBuffer, Array, or Array-like Object. Received type "+typeof r);if(oe(r,ArrayBuffer)||
r&&oe(r.buffer,ArrayBuffer)||typeof SharedArrayBuffer<"u"&&(oe(r,SharedArrayBuffer)||r&&oe(r.buffer,
...
for option "size"')}a(Zn,"assertSize");function Qo(r,e,t){return Zn(r),r<=0?le(r):e!==void 0?typeof t==
"string"?le(r).fill(e,t):le(r).fill(e):le(r)}a(Qo,"alloc");h.alloc=function(r,e,t){return Qo(r,e,t)};
function Vt(r){return Zn(r),le(r<0?0:Kt(r)|0)}a(Vt,"allocUnsafe");h.allocUnsafe=function(r){return Vt(
r)};h.allocUnsafeSlow=function(r){return Vt(r)};function No(r,e){if((typeof e!="string"||e==="")&&(e=
"utf8"),!h.isEncoding(e))throw new TypeError("Unknown encoding: "+e);let t=Jn(r,e)|0,n=le(t),i=n.write(
r,e);return i!==t&&(n=n.slice(0,i)),n}a(No,"fromString");function Ht(r){let e=r.length<0?0:Kt(r.length)|
0,t=le(e);for(let n=0;n<e;n+=1)t[n]=r[n]&255;return t}a(Ht,"fromArrayLike");function Wo(r){if(oe(r,Uint8Array)){
let e=new Uint8Array(r);return Gt(e.buffer,e.byteOffset,e.byteLength)}return Ht(r)}a(Wo,"fromArrayVi\
...
r,e,t),Object.setPrototypeOf(n,h.prototype),n}a(Gt,"fromArrayBuffer");function jo(r){if(h.isBuffer(r)){
let e=Kt(r.length)|0,t=le(e);return t.length===0||r.copy(t,0,0,e),t}if(r.length!==void 0)return typeof r.
length!="number"||Yt(r.length)?le(0):Ht(r);if(r.type==="Buffer"&&Array.isArray(r.data))return Ht(r.data)}
a(jo,"fromObject");function Kt(r){if(r>=pt)throw new RangeError("Attempt to allocate Buffer larger t\
han maximum size: 0x"+pt.toString(16)+" bytes");return r|0}a(Kt,"checked");function Ho(r){return+r!=
r&&(r=0),h.alloc(+r)}a(Ho,"SlowBuffer");h.isBuffer=a(function(e){return e!=null&&e._isBuffer===!0&&e!==
h.prototype},"isBuffer");h.compare=a(function(e,t){if(oe(e,Uint8Array)&&(e=h.from(e,e.offset,e.byteLength)),
oe(t,Uint8Array)&&(t=h.from(t,t.offset,t.byteLength)),!h.isBuffer(e)||!h.isBuffer(t))throw new TypeError(
...
if(oe(o,Uint8Array))s+o.length>i.length?(h.isBuffer(o)||(o=h.from(o)),o.copy(i,s)):Uint8Array.prototype.
...
if(ArrayBuffer.isView(r)||oe(r,ArrayBuffer))return r.byteLength;if(typeof r!="string")throw new TypeError(
...
tf8":case"utf-8":return ei(this,e,t);case"ascii":return Xo(this,e,t);case"latin1":case"binary":return ea(
...
if(oe(e,Uint8Array)&&(e=h.from(e,e.offset,e.byteLength)),!h.isBuffer(e))throw new TypeError('The "ta\
...
0;o<n;++o){let u=parseInt(e.substr(o*2,2),16);if(Yt(u))return o;r[t+o]=u}return o}a($o,"hexWrite");function Vo(r,e,t,n){
return dt($t(e,r.length-t),r,t,n)}a(Vo,"utf8Write");function Ko(r,e,t,n){return dt(oa(e),r,t,n)}a(Ko,
"asciiWrite");function zo(r,e,t,n){return dt(ai(e),r,t,n)}a(zo,"base64Write");function Yo(r,e,t,n){return dt(
...
utf-8":return Vo(this,e,t,n);case"ascii":case"latin1":case"binary":return Ko(this,e,t,n);case"base64":
return zo(this,e,t,n);case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return Yo(this,e,t,n);default:
...
a(Zo,"base64Slice");function ei(r,e,t){t=Math.min(r.length,t);let n=[],i=e;for(;i<t;){let s=r[i],o=null,
...
n.push(o),i+=u}return Jo(n)}a(ei,"utf8Slice");var Kn=4096;function Jo(r){let e=r.length;if(e<=Kn)return String.
fromCharCode.apply(String,r);let t="",n=0;for(;n<e;)t+=String.fromCharCode.apply(String,r.slice(n,n+=
Kn));return t}a(Jo,"decodeCodePointsArray");function Xo(r,e,t){let n="";t=Math.min(r.length,t);for(let i=e;i<
...
ge(a(function(e){e=e>>>0,Re(e,"offset");let t=this[e],n=this[e+7];(t===void 0||n===void 0)&&je(e,this.
...
writeBigUInt64LE=ge(a(function(e,t=0){return ti(this,e,t,BigInt(0),BigInt("0xffffffffffffffff"))},"w\
riteBigUInt64LE"));h.prototype.writeBigUInt64BE=ge(a(function(e,t=0){return ri(this,e,t,BigInt(0),BigInt(
...
t+4},"writeInt32BE");h.prototype.writeBigInt64LE=ge(a(function(e,t=0){return ti(this,e,t,-BigInt("0x\
...
+e,t=t>>>0,i||ni(r,e,t,4,34028234663852886e22,-34028234663852886e22),Pe.write(r,e,t,n,23,4),t+4}a(ii,
...
return e=+e,t=t>>>0,i||ni(r,e,t,8,17976931348623157e292,-17976931348623157e292),Pe.write(r,e,t,n,52,
...
_${r.slice(t-3,t)}${e}`;return`${r.slice(0,t)}${e}`}a(zn,"addNumericalSeparator");function na(r,e,t){
Re(e,"offset"),(r[e]===void 0||r[e+t]===void 0)&&je(e,r.length-(t+1))}a(na,"checkBounds");function oi(r,e,t,n,i,s){
...
nd <= ${t}${o}`,new Te.ERR_OUT_OF_RANGE("value",u,r)}na(n,i,s)}a(oi,"checkIntBI");function Re(r,e){if(typeof r!=
...
new Te.ERR_OUT_OF_RANGE(t||"offset",`>= ${t?1:0} and <= ${e}`,r)}a(je,"boundsError");var ia=/[^+/0-9A-Za-z-_]/g;
function sa(r){if(r=r.split("=")[0],r=r.trim().replace(ia,""),r.length<2)return"";for(;r.length%4!==
0;)r=r+"=";return r}a(sa,"base64clean");function $t(r,e){e=e||1/0;let t,n=r.length,i=null,s=[];for(let o=0;o<
...
o),n=t>>8,i=t%256,s.push(i),s.push(n);return s}a(aa,"utf16leToBytes");function ai(r){return jt.toByteArray(
sa(r))}a(ai,"base64ToBytes");function dt(r,e,t,n){let i;for(i=0;i<n&&!(i+t>=e.length||i>=r.length);++i)
e[i+t]=r[i];return i}a(dt,"blitBuffer");function oe(r,e){return r instanceof e||r!=null&&r.constructor!=
null&&r.constructor.name!=null&&r.constructor.name===e.name}a(oe,"isInstance");function Yt(r){return r!==
r}a(Yt,"numberIsNaN");var ua=function(){let r="0123456789abcdef",e=new Array(256);for(let t=0;t<16;++t){
let n=t*16;for(let i=0;i<16;++i)e[n+i]=r[t]+r[i]}return e}();function ge(r){return typeof BigInt>"u"?
ca:r}a(ge,"defineBigIntMethod");function ca(){throw new Error("BigInt not supported")}a(ca,"BufferBi\
gIntNotDefined")});var b,v,x,d,m,p=V(()=>{"use strict";b=globalThis,v=globalThis.setImmediate??(r=>setTimeout(r,0)),x=globalThis.
...
m.nextTick(()=>{})}catch{let e=Promise.resolve();m.nextTick=e.then.bind(e)}});var we=T((Ul,Zt)=>{"use strict";p();var Le=typeof Reflect=="object"?Reflect:null,ci=Le&&typeof Le.apply==
"function"?Le.apply:a(function(e,t,n){return Function.prototype.apply.call(e,t,n)},"ReflectApply"),yt;
Le&&typeof Le.ownKeys=="function"?yt=Le.ownKeys:Object.getOwnPropertySymbols?yt=a(function(e){return Object.
getOwnPropertyNames(e).concat(Object.getOwnPropertySymbols(e))},"ReflectOwnKeys"):yt=a(function(e){return Object.
getOwnPropertyNames(e)},"ReflectOwnKeys");function la(r){console&&console.warn&&console.warn(r)}a(la,
"ProcessEmitWarning");var fi=Number.isNaN||a(function(e){return e!==e},"NumberIsNaN");function P(){P.
init.call(this)}a(P,"EventEmitter");Zt.exports=P;Zt.exports.once=da;P.EventEmitter=P;P.prototype._events=
void 0;P.prototype._eventsCount=0;P.prototype._maxListeners=void 0;var li=10;function mt(r){if(typeof r!=
"function")throw new TypeError('The "listener" argument must be of type Function. Received type '+typeof r)}
a(mt,"checkListener");Object.defineProperty(P,"defaultMaxListeners",{enumerable:!0,get:a(function(){
...
P.prototype.setMaxListeners=a(function(e){if(typeof e!="number"||e<0||fi(e))throw new RangeError('Th\
e value of "n" is out of range. It must be a non-negative number. Received '+e+".");return this._maxListeners=
e,this},"setMaxListeners");function hi(r){return r._maxListeners===void 0?P.defaultMaxListeners:r._maxListeners}
a(hi,"_getMaxListeners");P.prototype.getMaxListeners=a(function(){return hi(this)},"getMaxListeners");
...
length,f=gi(c,l),n=0;n<l;++n)ci(f[n],this,t);return!0},"emit");function pi(r,e,t,n){var i,s,o;if(mt(
...
r,u.type=e,u.count=o.length,la(u)}return r}a(pi,"_addListener");P.prototype.addListener=a(function(e,t){
return pi(this,e,t,!1)},"addListener");P.prototype.on=P.prototype.addListener;P.prototype.prependListener=
a(function(e,t){return pi(this,e,t,!0)},"prependListener");function fa(){if(!this.fired)return this.
target.removeListener(this.type,this.wrapFn),this.fired=!0,arguments.length===0?this.listener.call(this.
target):this.listener.apply(this.target,arguments)}a(fa,"onceWrapper");function di(r,e,t){var n={fired:!1,
wrapFn:void 0,target:r,type:e,listener:t},i=fa.bind(n);return i.listener=t,n.wrapFn=i,i}a(di,"_onceW\
rap");P.prototype.once=a(function(e,t){return mt(t),this.on(e,di(this,e,t)),this},"once");P.prototype.
prependOnceListener=a(function(e,t){return mt(t),this.prependListener(e,di(this,e,t)),this},"prepend\
OnceListener");P.prototype.removeListener=a(function(e,t){var n,i,s,o,u;if(mt(t),i=this._events,i===
...
listener,s=o;break}if(s<0)return this;s===0?n.shift():ha(n,s),n.length===1&&(i[e]=n[0]),i.removeListener!==
...
pa(i):gi(i,i.length)}a(yi,"_listeners");P.prototype.listeners=a(function(e){return yi(this,e,!0)},"l\
isteners");P.prototype.rawListeners=a(function(e){return yi(this,e,!1)},"rawListeners");P.listenerCount=
function(r,e){return typeof r.listenerCount=="function"?r.listenerCount(e):mi.call(r,e)};P.prototype.
listenerCount=mi;function mi(r){var e=this._events;if(e!==void 0){var t=e[r];if(typeof t=="function")
return 1;if(t!==void 0)return t.length}return 0}a(mi,"listenerCount");P.prototype.eventNames=a(function(){
return this._eventsCount>0?yt(this._events):[]},"eventNames");function gi(r,e){for(var t=new Array(e),
n=0;n<e;++n)t[n]=r[n];return t}a(gi,"arrayClone");function ha(r,e){for(;e+1<r.length;e++)r[e]=r[e+1];
r.pop()}a(ha,"spliceOne");function pa(r){for(var e=new Array(r.length),t=0;t<e.length;++t)e[t]=r[t].
listener||r[t];return e}a(pa,"unwrapListeners");function da(r,e){return new Promise(function(t,n){function i(o){
...
ya(r,i,{once:!0})})}a(da,"once");function ya(r,e,t){typeof r.on=="function"&&wi(r,"error",e,t)}a(ya,
...
ust be of type EventEmitter. Received type '+typeof r)}a(wi,"eventTargetAgnosticAddListener")});var xi={};ne(xi,{Socket:()=>ae,isIP:()=>ma});function ma(r){return 0}var vi,bi,S,ae,Fe=V(()=>{"use s\
trict";p();vi=me(we(),1);a(ma,"isIP");bi=/^[^.]+\./,S=class S extends vi.EventEmitter{constructor(){
...
disableWarningInBrowsers:!1}),E(S,"opts",{});ae=S});var Ei={};ne(Ei,{parse:()=>Xt,setDefaultQueryParam:()=>Jt});function Si(r){let{protocol:e}=new URL(r),
t="http:"+r.substring(e.length);return{protocol:e,parsedUrl:new URL(t)}}function Jt(r,e,t){let{protocol:n,
parsedUrl:i}=Si(r);return i.searchParams.has(e)||i.searchParams.set(e,t),n+i.toString().substring(i.
protocol.length)}function Xt(r,e=!1){let{protocol:t,parsedUrl:n}=Si(r),{username:i,password:s,host:o,
hostname:u,port:c,pathname:l,search:f,searchParams:y,hash:w}=n;s=decodeURIComponent(s),i=decodeURIComponent(
i),l=decodeURIComponent(l);let A=i+":"+s,_=e?Object.fromEntries(y.entries()):f;return{href:r,protocol:t,
auth:A,username:i,password:s,host:o,hostname:u,port:c,pathname:l,search:f,query:_,hash:w}}var er=V(()=>{
"use strict";p();a(Si,"parseUrl");a(Jt,"setDefaultQueryParam");a(Xt,"parse")});var ir=T(Pi=>{"use strict";p();Pi.parse=function(r,e){return new nr(r,e).parse()};var St=class St{constructor(e,t){
...
not balanced");return this.entries}};a(St,"ArrayParser");var nr=St;function Pa(r){return r}a(Pa,"ide\
ntity")});var sr=T((sf,Ri)=>{p();var Ra=ir();Ri.exports={create:a(function(r,e){return{parse:a(function(){return Ra.
parse(r,e)},"parse")}},"create")}});var Fi=T((uf,Li)=>{"use strict";p();var Ba=/(\d{1,})-(\d{2})-(\d{2}) (\d{2}):(\d{2}):(\d{2})(\.\d{1,})?.*?( BC)?$/,
La=/^(\d{1,})-(\d{2})-(\d{2})( BC)?$/,Fa=/([Z+-])(\d{2})?:?(\d{2})?:?(\d{2})?/,ka=/^-?infinity$/;Li.
exports=a(function(e){if(ka.test(e))return Number(e.replace("i","I"));var t=Ba.exec(e);if(!t)return Ma(
e)||null;var n=!!t[8],i=parseInt(t[1],10);n&&(i=Bi(i));var s=parseInt(t[2],10)-1,o=t[3],u=parseInt(t[4],
10),c=parseInt(t[5],10),l=parseInt(t[6],10),f=t[7];f=f?1e3*parseFloat(f):0;var y,w=Ua(e);return w!=null?
(y=new Date(Date.UTC(i,s,o,u,c,l,f)),or(i)&&y.setUTCFullYear(i),w!==0&&y.setTime(y.getTime()-w)):(y=
new Date(i,s,o,u,c,l,f),or(i)&&y.setFullYear(i)),y},"parseDate");function Ma(r){var e=La.exec(r);if(e){
var t=parseInt(e[1],10),n=!!e[4];n&&(t=Bi(t));var i=parseInt(e[2],10)-1,s=e[3],o=new Date(t,i,s);return or(
t)&&o.setFullYear(t),o}}a(Ma,"getDate");function Ua(r){if(r.endsWith("+00"))return 0;var e=Fa.exec(r.
split(" ")[1]);if(e){var t=e[1];if(t==="Z")return 0;var n=t==="-"?-1:1,i=parseInt(e[2],10)*3600+parseInt(
e[3]||0,10)*60+parseInt(e[4]||0,10);return i*n*1e3}}a(Ua,"timeZoneOffset");function Bi(r){return-(r-
1)}a(Bi,"bcYearToNegativeYear");function or(r){return r>=0&&r<100}a(or,"is0To99")});var Mi=T((ff,ki)=>{p();ki.exports=Oa;var Da=Object.prototype.hasOwnProperty;function Oa(r){for(var e=1;e<
arguments.length;e++){var t=arguments[e];for(var n in t)Da.call(t,n)&&(r[n]=t[n])}return r}a(Oa,"ext\
end")});var Oi=T((df,Di)=>{"use strict";p();var qa=Mi();Di.exports=ke;function ke(r){if(!(this instanceof ke))
return new ke(r);qa(this,Za(r))}a(ke,"PostgresInterval");var Qa=["seconds","minutes","hours","days",
"months","years"];ke.prototype.toPostgres=function(){var r=Qa.filter(this.hasOwnProperty,this);return this.
...
S"},Wa=["years","months","days"],ja=["hours","minutes","seconds"];ke.prototype.toISOString=ke.prototype.
...
/0+$/,"")),i+Na[n]}};var ar="([+-]?\\d+)",Ha=ar+"\\s+years?",Ga=ar+"\\s+mons?",$a=ar+"\\s+days?",Va="\
([+-])?([\\d]*):(\\d\\d):(\\d\\d)\\.?(\\d{1,6})?",Ka=new RegExp([Ha,Ga,$a,Va].map(function(r){return"\
("+r+")?"}).join("\\s*")),Ui={years:2,months:4,days:6,hours:9,minutes:10,seconds:11,milliseconds:12},
za=["hours","minutes","seconds","milliseconds"];function Ya(r){var e=r+"000000".slice(r.length);return parseInt(
e,10)/1e3}a(Ya,"parseMilliseconds");function Za(r){if(!r)return{};var e=Ka.exec(r),t=e[8]==="-";return Object.
keys(Ui).reduce(function(n,i){var s=Ui[i],o=e[s];return!o||(o=i==="milliseconds"?Ya(o):parseInt(o,10),
!o)||(t&&~za.indexOf(i)&&(o*=-1),n[i]=o),n},{})}a(Za,"parse")});var Qi=T((gf,qi)=>{"use strict";p();qi.exports=a(function(e){if(/^\\x/.test(e))return new d(e.substr(
...
parseBytea")});var Vi=T((vf,$i)=>{p();var Ke=ir(),ze=sr(),Et=Fi(),Wi=Oi(),ji=Qi();function At(r){return a(function(t){
return t===null?t:r(t)},"nullAllowed")}a(At,"allowNull");function Hi(r){return r===null?r:r==="TRUE"||
r==="t"||r==="true"||r==="y"||r==="yes"||r==="on"||r==="1"}a(Hi,"parseBool");function Ja(r){return r?
Ke.parse(r,Hi):null}a(Ja,"parseBoolArray");function Xa(r){return parseInt(r,10)}a(Xa,"parseBaseTenIn\
t");function ur(r){return r?Ke.parse(r,At(Xa)):null}a(ur,"parseIntegerArray");function eu(r){return r?
Ke.parse(r,At(function(e){return Gi(e).trim()})):null}a(eu,"parseBigIntegerArray");var tu=a(function(r){
if(!r)return null;var e=ze.create(r,function(t){return t!==null&&(t=hr(t)),t});return e.parse()},"pa\
rsePointArray"),cr=a(function(r){if(!r)return null;var e=ze.create(r,function(t){return t!==null&&(t=
parseFloat(t)),t});return e.parse()},"parseFloatArray"),ee=a(function(r){if(!r)return null;var e=ze.
create(r);return e.parse()},"parseStringArray"),lr=a(function(r){if(!r)return null;var e=ze.create(r,
function(t){return t!==null&&(t=Et(t)),t});return e.parse()},"parseDateArray"),ru=a(function(r){if(!r)
return null;var e=ze.create(r,function(t){return t!==null&&(t=Wi(t)),t});return e.parse()},"parseInt\
ervalArray"),nu=a(function(r){return r?Ke.parse(r,At(ji)):null},"parseByteAArray"),fr=a(function(r){
return parseInt(r,10)},"parseInteger"),Gi=a(function(r){var e=String(r);return/^\d+$/.test(e)?e:r},"\
parseBigInteger"),Ni=a(function(r){return r?Ke.parse(r,At(JSON.parse)):null},"parseJsonArray"),hr=a(
...
r[i])}var s=hr(e);return s.radius=parseFloat(t),s},"parseCircle"),su=a(function(r){r(20,Gi),r(21,fr),
r(23,fr),r(26,fr),r(700,parseFloat),r(701,parseFloat),r(16,Hi),r(1082,Et),r(1114,Et),r(1184,Et),r(600,
hr),r(651,ee),r(718,iu),r(1e3,Ja),r(1001,nu),r(1005,ur),r(1007,ur),r(1028,ur),r(1016,eu),r(1017,tu),
r(1021,cr),r(1022,cr),r(1231,cr),r(1014,ee),r(1015,ee),r(1008,ee),r(1009,ee),r(1040,ee),r(1041,ee),r(
1115,lr),r(1182,lr),r(1185,lr),r(1186,Wi),r(1187,ru),r(17,ji),r(114,JSON.parse.bind(JSON)),r(3802,JSON.
parse.bind(JSON)),r(199,Ni),r(3807,Ni),r(3907,ee),r(2951,ee),r(791,ee),r(1183,ee),r(1270,ee)},"init");
$i.exports={init:su}});var zi=T((Ef,Ki)=>{"use strict";p();var z=1e6;function ou(r){var e=r.readInt32BE(0),t=r.readUInt32BE(
...
""+o%z,n+u+i}a(ou,"readInt8");Ki.exports=ou});var es=T((_f,Xi)=>{p();var au=zi(),L=a(function(r,e,t,n,i){t=t||0,n=n||!1,i=i||function(A,_,j){return A*
Math.pow(2,j)+_};var s=t>>3,o=a(function(A){return n?~A&255:A},"inv"),u=255,c=8-t%8;e<c&&(u=255<<8-e&
255,c=e),t&&(u=u>>t%8);var l=0;t%8+e>=8&&(l=i(0,o(r[s])&u,c));for(var f=e+t>>3,y=s+1;y<f;y++)l=i(l,o(
r[y]),8);var w=(e+t)%8;return w>0&&(l=i(l,o(r[f])>>8-w,w)),l},"parseBits"),Ji=a(function(r,e,t){var n=Math.
...
return L(r,1)==1?-1*(L(r,15,1,!0)+1):L(r,15,1)},"parseInt16"),Yi=a(function(r){return L(r,1)==1?-1*(L(
r,31,1,!0)+1):L(r,31,1)},"parseInt32"),cu=a(function(r){return Ji(r,23,8)},"parseFloat32"),lu=a(function(r){
return Ji(r,52,11)},"parseFloat64"),fu=a(function(r){var e=L(r,16,32);if(e==49152)return NaN;for(var t=Math.
...
null:L(r,8)>0},"parseBool"),du=a(function(r){r(20,au),r(21,uu),r(23,Yi),r(26,Yi),r(1700,fu),r(700,cu),
r(701,lu),r(16,pu),r(1114,Zi.bind(null,!1)),r(1184,Zi.bind(null,!0)),r(1e3,Ye),r(1007,Ye),r(1016,Ye),
r(1008,Ye),r(1009,Ye),r(25,hu)},"init");Xi.exports={init:du}});var rs=T((Pf,ts)=>{p();ts.exports={BOOL:16,BYTEA:17,CHAR:18,INT8:20,INT2:21,INT4:23,REGPROC:24,TEXT:25,
...
REGROLE:4096}});var Xe=T(Je=>{p();var yu=Vi(),mu=es(),gu=sr(),wu=rs();Je.getTypeParser=bu;Je.setTypeParser=vu;Je.arrayParser=
gu;Je.builtins=wu;var Ze={text:{},binary:{}};function ns(r){return String(r)}a(ns,"noParse");function bu(r,e){
return e=e||"text",Ze[e]&&Ze[e][r]||ns}a(bu,"getTypeParser");function vu(r,e,t){typeof e=="function"&&
(t=e,e="text"),Ze[e][r]=t}a(vu,"setTypeParser");yu.init(function(r,e){Ze.text[r]=e});mu.init(function(r,e){
Ze.binary[r]=e})});var _t=T((kf,is)=>{"use strict";p();var xu=Xe();function Ct(r){this._types=r||xu,this.text={},this.binary=
...
e||"text",this.getOverrides(e)[r]||this._types.getTypeParser(r,e)};is.exports=Ct});function et(r){let e=1779033703,t=3144134277,n=1013904242,i=2773480762,s=1359893119,o=2600822924,u=528734635,
...
2024104815,2227730452,2361852424,2428436474,2756734187,3204031479,3329325298],w=a((C,g)=>C>>>g|C<<32-
g,"rrot"),A=new Uint32Array(64),_=new Uint8Array(64),j=a(()=>{for(let R=0,G=0;R<16;R++,G+=4)A[R]=_[G]<<
24|_[G+1]<<16|_[G+2]<<8|_[G+3];for(let R=16;R<64;R++){let G=w(A[R-15],7)^w(A[R-15],18)^A[R-15]>>>3,ue=w(
A[R-2],17)^w(A[R-2],19)^A[R-2]>>>10;A[R]=A[R-16]+G+A[R-7]+ue|0}let C=e,g=t,B=n,Z=i,D=s,he=o,J=u,ie=c;
for(let R=0;R<64;R++){let G=w(D,6)^w(D,11)^w(D,25),ue=D&he^~D&J,pe=ie+G+ue+y[R]+A[R]|0,Se=w(C,2)^w(C,
13)^w(C,22),We=C&g^C&B^g&B,ce=Se+We|0;ie=J,J=he,he=D,D=Z+pe|0,Z=B,B=g,g=C,C=pe+ce|0}e=e+C|0,t=t+g|0,
n=n+B|0,i=i+Z|0,s=s+D|0,o=o+he|0,u=u+J|0,c=c+ie|0,f=0},"process"),H=a(C=>{typeof C=="string"&&(C=new TextEncoder().
encode(C));for(let g=0;g<C.length;g++)_[f++]=C[g],f===64&&j();l+=C.length},"add"),re=a(()=>{if(_[f++]=
128,f==64&&j(),f+8>64){for(;f<64;)_[f++]=0;j()}for(;f<58;)_[f++]=0;let C=l*8;_[f++]=C/1099511627776&
255,_[f++]=C/4294967296&255,_[f++]=C>>>24,_[f++]=C>>>16&255,_[f++]=C>>>8&255,_[f++]=C&255,j();let g=new Uint8Array(
...
c>>>24,g[29]=c>>>16&255,g[30]=c>>>8&255,g[31]=c&255,g},"digest");return r===void 0?{add:H,digest:re}:
(H(r),re())}var ss=V(()=>{"use strict";p();a(et,"sha256")});var U,tt,os=V(()=>{"use strict";p();U=class U{constructor(){E(this,"_dataLength",0);E(this,"_bufferL\
...
abcdef"),E(U,"hexOut",[]),E(U,"onePassHasher",new U);tt=U});var pr={};ne(pr,{createHash:()=>Eu,createHmac:()=>Au,randomBytes:()=>Su});function Su(r){return crypto.
...
"digest")}},"update")}}var dr=V(()=>{"use strict";p();ss();os();a(Su,"randomBytes");a(Eu,"createHash");
a(Au,"createHmac")});var rt=T((Vf,yr)=>{"use strict";p();yr.exports={host:"localhost",user:m.platform==="win32"?m.env.USERNAME:
...
keepalives:1,keepalives_idle:0};var Me=Xe(),Cu=Me.getTypeParser(20,"text"),_u=Me.getTypeParser(1016,
"text");yr.exports.__defineSetter__("parseInt8",function(r){Me.setTypeParser(20,"text",r?Me.getTypeParser(
23,"text"):Cu),Me.setTypeParser(1016,"text",r?Me.getTypeParser(1007,"text"):_u)})});var nt=T((zf,us)=>{"use strict";p();var Iu=(dr(),O(pr)),Tu=rt();function Pu(r){var e=r.replace(/\\/g,
"\\\\").replace(/"/g,'\\"');return'"'+e+'"'}a(Pu,"escapeElement");function as(r){for(var e="{",t=0;t<
r.length;t++)t>0&&(e=e+","),r[t]===null||typeof r[t]>"u"?e=e+"NULL":Array.isArray(r[t])?e=e+as(r[t]):
r[t]instanceof d?e+="\\\\x"+r[t].toString("hex"):e+=Pu(It(r[t]));return e=e+"}",e}a(as,"arrayString");
...
r.byteLength)}return r instanceof Date?Tu.parseInputDatesAsUTC?Lu(r):Bu(r):Array.isArray(r)?as(r):typeof r==
...
r query');return e.push(r),It(r.toPostgres(It),e)}return JSON.stringify(r)}a(Ru,"prepareObject");function W(r,e){
...
-1):i+="+",i+=W(Math.floor(e/60),2)+":"+W(e%60,2),n&&(i+=" BC"),i}a(Bu,"dateToString");function Lu(r){
...
r.getUTCMilliseconds(),3);return n+="+00:00",t&&(n+=" BC"),n}a(Lu,"dateToStringUTC");function Fu(r,e,t){
return r=typeof r=="string"?{text:r}:r,e&&(typeof e=="function"?r.callback=e:r.values=e),t&&(r.callback=
t),r}a(Fu,"normalizeQueryConfig");var mr=a(function(r){return Iu.createHash("md5").update(r,"utf-8").
digest("hex")},"md5"),ku=a(function(r,e,t){var n=mr(e+r),i=mr(d.concat([d.from(n),t]));return"md5"+i},
"postgresMd5PasswordHash");us.exports={prepareValue:a(function(e){return It(e)},"prepareValueWrapper"),
normalizeQueryConfig:Fu,postgresMd5PasswordHash:ku,md5:mr}});var it={};ne(it,{default:()=>Ou});var Ou,st=V(()=>{"use strict";p();Ou={}});var bs=T((ch,ws)=>{"use strict";p();var wr=(dr(),O(pr));function qu(r){if(r.indexOf("SCRAM-SHA-256")===
...
art with client nonce");var i=d.from(n.salt,"base64"),s=$u(e,i,n.iteration),o=Ue(s,"Client Key"),u=Gu(
o),c="n=*,r="+r.clientNonce,l="r="+n.nonce+",s="+n.salt+",i="+n.iteration,f="c=biws,r="+n.nonce,y=c+
","+l+","+f,w=Ue(u,y),A=gs(o,w),_=A.toString("base64"),j=Ue(s,"Server Key"),H=Ue(j,y);r.message="SAS\
LResponse",r.serverSignature=H.toString("base64"),r.response=f+",p="+_}a(Qu,"continueSession");function Nu(r,e){
...
e<=126)}a(Wu,"isPrintableChars");function ys(r){return/^(?:[a-zA-Z0-9+/]{4})*(?:[a-zA-Z0-9+/]{2}==|[a-zA-Z0-9+/]{3}=)?$/.
test(r)}a(ys,"isBase64");function ms(r){if(typeof r!="string")throw new TypeError("SASL: attribute p\
airs text must be a string");return new Map(r.split(",").map(e=>{if(!/^.=/.test(e))throw new Error("\
SASL: Invalid attribute pair entry");let t=e[0],n=e.substring(2);return[t,n]}))}a(ms,"parseAttribute\
Pairs");function ju(r){let e=ms(r),t=e.get("r");if(t){if(!Wu(t))throw new Error("SASL: SCRAM-SERVER-\
FIRST-MESSAGE: nonce must only contain printable characters")}else throw new Error("SASL: SCRAM-SERV\
ER-FIRST-MESSAGE: nonce missing");let n=e.get("s");if(n){if(!ys(n))throw new Error("SASL: SCRAM-SERV\
...
function Hu(r){let t=ms(r).get("v");if(t){if(!ys(t))throw new Error("SASL: SCRAM-SERVER-FINAL-MESSAG\
E: server signature must be base64")}else throw new Error("SASL: SCRAM-SERVER-FINAL-MESSAGE: server \
signature is missing");return{serverSignature:t}}a(Hu,"parseServerFinalMessage");function gs(r,e){if(!d.
...
a(gs,"xorBuffers");function Gu(r){return wr.createHash("sha256").update(r).digest()}a(Gu,"sha256");function Ue(r,e){
return wr.createHmac("sha256",r).update(e).digest()}a(Ue,"hmacSha256");function $u(r,e,t){for(var n=Ue(
r,d.concat([e,d.from([0,0,0,1])])),i=n,s=0;s<t-1;s++)n=Ue(r,n),i=gs(i,n);return i}a($u,"Hi");ws.exports=
{startSession:qu,continueSession:Qu,finalizeSession:Nu}});var br={};ne(br,{join:()=>Vu});function Vu(...r){return r.join("/")}var vr=V(()=>{"use strict";p();a(
Vu,"join")});var xr={};ne(xr,{stat:()=>Ku});function Ku(r,e){e(new Error("No filesystem"))}var Sr=V(()=>{"use str\
ict";p();a(Ku,"stat")});var Er={};ne(Er,{default:()=>zu});var zu,Ar=V(()=>{"use strict";p();zu={}});var vs={};ne(vs,{StringDecoder:()=>Cr});var _r,Cr,xs=V(()=>{"use strict";p();_r=class _r{constructor(e){
E(this,"td");this.td=new TextDecoder(e)}write(e){return this.td.decode(e,{stream:!0})}end(e){return this.
td.decode(e)}};a(_r,"StringDecoder");Cr=_r});var Cs=T((bh,As)=>{"use strict";p();var{Transform:Yu}=(Ar(),O(Er)),{StringDecoder:Zu}=(xs(),O(vs)),ve=Symbol(
...
this[ve].split(this.matcher);this[ve]=n.pop();for(let i=0;i<n.length;i++)try{Es(this,this.mapper(n[i]))}catch(s){
...
try{Es(this,this.mapper(this[ve]))}catch(e){return r(e)}r()}a(Xu,"flush");function Es(r,e){e!==void 0&&
r.push(e)}a(Es,"push");function Ss(r){return r}a(Ss,"noop");function ec(r,e,t){switch(r=r||/\r?\n/,e=
e||Ss,t=t||{},arguments.length){case 1:typeof r=="function"?(e=r,r=/\r?\n/):typeof r=="object"&&!(r instanceof
RegExp)&&!r[Symbol.split]&&(t=r,r=/\r?\n/);break;case 2:typeof r=="function"?(t=e,e=r,r=/\r?\n/):typeof e==
"object"&&(t=e,e=Ss)}t=Object.assign({},t),t.autoDestroy=!0,t.transform=Ju,t.flush=Xu,t.readableObjectMode=
...
!1,s(i)},n}a(ec,"split");As.exports=ec});var Ts=T((Sh,fe)=>{"use strict";p();var _s=(vr(),O(br)),tc=(Ar(),O(Er)).Stream,rc=Cs(),Is=(st(),O(it)),
nc=5432,Rt=m.platform==="win32",ot=m.stderr,ic=56,sc=7,oc=61440,ac=32768;function uc(r){return(r&oc)==
ac}a(uc,"isRegFile");var De=["host","port","database","user","password"],Ir=De.length,cc=De[Ir-1];function Tr(){
var r=ot instanceof tc&&ot.writable===!0;if(r){var e=Array.prototype.slice.call(arguments).concat(`
`);ot.write(Is.format.apply(Is,e))}}a(Tr,"warn");Object.defineProperty(fe.exports,"isWin",{get:a(function(){
return Rt},"get"),set:a(function(r){Rt=r},"set")});fe.exports.warnTo=function(r){var e=ot;return ot=
r,e};fe.exports.getFileName=function(r){var e=r||m.env,t=e.PGPASSFILE||(Rt?_s.join(e.APPDATA||"./","\
postgresql","pgpass.conf"):_s.join(e.HOME||"./",".pgpass"));return t};fe.exports.usePgPass=function(r,e){
return Object.prototype.hasOwnProperty.call(m.env,"PGPASSWORD")?!1:Rt?!0:(e=e||"<unkn>",uc(r.mode)?r.
...
match=function(r,e){return De.slice(0,-1).reduce(function(t,n,i){return i==1&&Number(r[n]||nc)===Number(
...
0}},t=0;t<De.length;t+=1){var n=e[t],i=r[De[t]]||"",s=n(i);if(!s)return!1}return!0}});var Rs=T((_h,Pr)=>{"use strict";p();var Ch=(vr(),O(br)),Ps=(Sr(),O(xr)),Bt=Ts();Pr.exports=function(r,e){
var t=Bt.getFileName();Ps.stat(t,function(n,i){if(n||!Bt.usePgPass(i,t))return e(void 0);var s=Ps.createReadStream(
t);Bt.getPassword(r,s,e)})};Pr.exports.warnTo=Bt.warnTo});var Bs={};ne(Bs,{default:()=>pc});var pc,Ls=V(()=>{"use strict";p();pc={}});var Lr=T((Ph,Fs)=>{"use strict";p();var dc=(er(),O(Ei)),Rr=(Sr(),O(xr));function Br(r){if(r.charAt(0)===
...
!1;break}}return t}a(Br,"parse");Fs.exports=Br;Br.parse=Br});var Lt=T((Lh,Us)=>{"use strict";p();var yc=(Ls(),O(Bs)),Ms=rt(),ks=Lr().parse,$=a(function(r,e,t){return t===
void 0?t=m.env["PG"+r.toUpperCase()]:t===!1||(t=m.env[t]),e[r]||t||Ms[r]},"val"),mc=a(function(){switch(m.
env.PGSSLMODE){case"disable":return!1;case"prefer":case"require":case"verify-ca":case"verify-full":return!0;case"\
no-verify":return{rejectUnauthorized:!1}}return Ms.ssl},"readSSLConfigFromEnvironment"),Oe=a(function(r){
return"'"+(""+r).replace(/\\/g,"\\\\").replace(/'/g,"\\'")+"'"},"quoteParamValue"),te=a(function(r,e,t){
var n=e[t];n!=null&&r.push(t+"="+Oe(n))},"add"),kr=class kr{constructor(e){e=typeof e=="string"?ks(e):
e||{},e.connectionString&&(e=Object.assign({},e,ks(e.connectionString))),this.user=$("user",e),this.
...
slkey"),te(t,n,"sslcert"),te(t,n,"sslrootcert"),this.database&&t.push("dbname="+Oe(this.database)),this.
...
yc.lookup(this.host,function(i,s){return i?e(i,null):(t.push("hostaddr="+Oe(s)),e(null,t.join(" ")))})}};
a(kr,"ConnectionParameters");var Fr=kr;Us.exports=Fr});var qs=T((Mh,Os)=>{"use strict";p();var gc=Xe(),Ds=/^([A-Za-z]+)(?: (\d+))?(?: (\d+))?/,Ur=class Ur{constructor(e,t){
...
format||"text")}}};a(Ur,"Result");var Mr=Ur;Os.exports=Mr});var js=T((Oh,Ws)=>{"use strict";p();var{EventEmitter:wc}=we(),Qs=qs(),Ns=nt(),Or=class Or extends wc{constructor(e,t,n){
super(),e=Ns.normalizeQueryConfig(e,t,n),this.text=e.text,this.values=e.values,this.rows=e.rows,this.
...
portal,statement:this.name,values:this.values,binary:this.binary,valueMapper:Ns.prepareValue})}catch(t){
this.handleError(t,e);return}e.describe({type:"P",name:this.portal||""}),this._getRows(e,this.rows)}handleCopyInResponse(e){
e.sendCopyFail("No source stream defined")}handleCopyData(e,t){}};a(Or,"Query");var Dr=Or;Ws.exports=
Dr});var dn=T(I=>{"use strict";p();Object.defineProperty(I,"__esModule",{value:!0});I.NoticeMessage=I.DataRowMessage=
...
name=n}};a(Xr,"DatabaseError");var qr=Xr;I.DatabaseError=qr;var en=class en{constructor(e,t){this.length=
e,this.chunk=t,this.name="copyData"}};a(en,"CopyDataMessage");var Qr=en;I.CopyDataMessage=Qr;var tn=class tn{constructor(e,t,n,i){
this.length=e,this.name=t,this.binary=n,this.columnTypes=new Array(i)}};a(tn,"CopyResponse");var Nr=tn;
I.CopyResponse=Nr;var rn=class rn{constructor(e,t,n,i,s,o,u){this.name=e,this.tableID=t,this.columnID=
n,this.dataTypeID=i,this.dataTypeSize=s,this.dataTypeModifier=o,this.format=u}};a(rn,"Field");var Wr=rn;
I.Field=Wr;var nn=class nn{constructor(e,t){this.length=e,this.fieldCount=t,this.name="rowDescriptio\
n",this.fields=new Array(this.fieldCount)}};a(nn,"RowDescriptionMessage");var jr=nn;I.RowDescriptionMessage=
...
I.ParameterDescriptionMessage=Hr;var on=class on{constructor(e,t,n){this.length=e,this.parameterName=
t,this.parameterValue=n,this.name="parameterStatus"}};a(on,"ParameterStatusMessage");var Gr=on;I.ParameterStatusMessage=
Gr;var an=class an{constructor(e,t){this.length=e,this.salt=t,this.name="authenticationMD5Password"}};
a(an,"AuthenticationMD5Password");var $r=an;I.AuthenticationMD5Password=$r;var un=class un{constructor(e,t,n){
this.length=e,this.processID=t,this.secretKey=n,this.name="backendKeyData"}};a(un,"BackendKeyDataMes\
sage");var Vr=un;I.BackendKeyDataMessage=Vr;var cn=class cn{constructor(e,t,n,i){this.length=e,this.
processId=t,this.channel=n,this.payload=i,this.name="notification"}};a(cn,"NotificationResponseMessa\
ge");var Kr=cn;I.NotificationResponseMessage=Kr;var ln=class ln{constructor(e,t){this.length=e,this.
status=t,this.name="readyForQuery"}};a(ln,"ReadyForQueryMessage");var zr=ln;I.ReadyForQueryMessage=zr;
var fn=class fn{constructor(e,t){this.length=e,this.text=t,this.name="commandComplete"}};a(fn,"Comma\
ndCompleteMessage");var Yr=fn;I.CommandCompleteMessage=Yr;var hn=class hn{constructor(e,t){this.length=
e,this.fields=t,this.name="dataRow",this.fieldCount=t.length}};a(hn,"DataRowMessage");var Zr=hn;I.DataRowMessage=
Zr;var pn=class pn{constructor(e,t){this.length=e,this.message=t,this.name="notice"}};a(pn,"NoticeMe\
ssage");var Jr=pn;I.NoticeMessage=Jr});var Hs=T(Ft=>{"use strict";p();Object.defineProperty(Ft,"__esModule",{value:!0});Ft.Writer=void 0;var mn=class mn{constructor(e=256){
...
headerPosition=0,this.buffer=d.allocUnsafe(this.size),t}};a(mn,"Writer");var yn=mn;Ft.Writer=yn});var $s=T(Mt=>{"use strict";p();Object.defineProperty(Mt,"__esModule",{value:!0});Mt.serialize=void 0;
var gn=Hs(),F=new gn.Writer,bc=a(r=>{F.addInt16(3).addInt16(0);for(let n of Object.keys(r))F.addCString(
...
8);return r.writeInt32BE(8,0),r.writeInt32BE(80877103,4),r},"requestSsl"),xc=a(r=>F.addCString(r).flush(
112),"password"),Sc=a(function(r,e){return F.addCString(r).addInt32(d.byteLength(e)).addString(e),F.
flush(112)},"sendSASLInitialResponseMessage"),Ec=a(function(r){return F.addString(r).flush(112)},"se\
ndSCRAMClientFinalMessage"),Ac=a(r=>F.addCString(r).flush(81),"query"),Gs=[],Cc=a(r=>{let e=r.name||
...
xecuting queries"));let t=r.types||Gs,n=t.length,i=F.addCString(e).addCString(r.text).addInt16(n);for(let s=0;s<
n;s++)i.addInt32(t[s]);return F.flush(80)},"parse"),qe=new gn.Writer,_c=a(function(r,e){for(let t=0;t<
...
writeValues"),Ic=a((r={})=>{let e=r.portal||"",t=r.statement||"",n=r.binary||!1,i=r.values||Gs,s=i.length;
return F.addCString(e).addCString(t),F.addInt16(s),_c(i,r.valueMapper),F.addInt16(s),F.add(qe.flush()),
F.addInt16(n?1:0),F.flush(66)},"bind"),Tc=d.from([69,0,0,0,9,0,0,0,0,0]),Pc=a(r=>{if(!r||!r.portal&&
!r.rows)return Tc;let e=r.portal||"",t=r.rows||0,n=d.byteLength(e),i=4+n+1+4,s=d.allocUnsafe(1+i);return s[0]=
69,s.writeInt32BE(i,1),s.write(e,5,"utf-8"),s[n+5]=0,s.writeUInt32BE(t,s.length-4),s},"execute"),Rc=a(
...
Bc=F.addCString("P").flush(68),Lc=F.addCString("S").flush(68),Fc=a(r=>r.name?wn(68,`${r.type}${r.name||
""}`):r.type==="P"?Bc:Lc,"describe"),kc=a(r=>{let e=`${r.type}${r.name||""}`;return wn(67,e)},"close"),
Mc=a(r=>F.add(r).flush(100),"copyData"),Uc=a(r=>wn(102,r),"copyFail"),kt=a(r=>d.from([r,0,0,0,4]),"c\
...
cancel:Rc};Mt.serialize=Nc});var Vs=T(Ut=>{"use strict";p();Object.defineProperty(Ut,"__esModule",{value:!0});Ut.BufferReader=void 0;
var Wc=d.allocUnsafe(0),vn=class vn{constructor(e=0){this.offset=e,this.buffer=Wc,this.encoding="utf\
...
offset+=e,t}};a(vn,"BufferReader");var bn=vn;Ut.BufferReader=bn});var Ys=T(Dt=>{"use strict";p();Object.defineProperty(Dt,"__esModule",{value:!0});Dt.Parser=void 0;var k=dn(),
jc=Vs(),xn=1,Hc=4,Ks=xn+Hc,zs=d.allocUnsafe(0),En=class En{constructor(e){if(this.buffer=zs,this.bufferLength=
...
this.bufferLength,i=this.bufferOffset;for(;i+Ks<=n;){let s=this.buffer[i],o=this.buffer.readUInt32BE(
i+xn),u=xn+o;if(u+i<=n){let c=this.handlePacket(i+Ks,s,o,this.buffer);t(c),i+=u}else break}i===n?(this.
...
a(En,"Parser");var Sn=En;Dt.Parser=Sn});var An=T(xe=>{"use strict";p();Object.defineProperty(xe,"__esModule",{value:!0});xe.DatabaseError=xe.
serialize=xe.parse=void 0;var Gc=dn();Object.defineProperty(xe,"DatabaseError",{enumerable:!0,get:a(
function(){return Gc.DatabaseError},"get")});var $c=$s();Object.defineProperty(xe,"serialize",{enumerable:!0,
get:a(function(){return $c.serialize},"get")});var Vc=Ys();function Kc(r,e){let t=new Vc.Parser;return r.
on("data",n=>t.parse(n,e)),new Promise(n=>r.on("end",()=>n()))}a(Kc,"parse");xe.parse=Kc});var Zs={};ne(Zs,{connect:()=>zc});function zc({socket:r,servername:e}){return r.startTls(e),r}var Js=V(
()=>{"use strict";p();a(zc,"connect")});var In=T((ap,to)=>{"use strict";p();var Xs=(Fe(),O(xi)),Yc=we().EventEmitter,{parse:Zc,serialize:Q}=An(),
eo=Q.flush(),Jc=Q.sync(),Xc=Q.end(),_n=class _n extends Yc{constructor(e){super(),e=e||{},this.stream=
...
var u=(Js(),O(Zs));let c={socket:n.stream};n.ssl!==!0&&(Object.assign(c,n.ssl),"key"in n.ssl&&(c.key=
...
stream.writable&&this.stream.write(eo)}sync(){this._ending=!0,this._send(eo),this._send(Jc)}ref(){this.
...
this._send(Q.copyDone())}sendCopyFail(e){this._send(Q.copyFail(e))}};a(_n,"Connection");var Cn=_n;to.
exports=Cn});var io=T((fp,no)=>{"use strict";p();var el=we().EventEmitter,lp=(st(),O(it)),tl=nt(),Tn=bs(),rl=Rs(),
nl=_t(),il=Lt(),ro=js(),sl=rt(),ol=In(),Pn=class Pn extends el{constructor(e){super(),this.connectionParameters=
...
_Promise(t=>{this.connection.once("end",t)})}};a(Pn,"Client");var Ot=Pn;Ot.Query=ro;no.exports=Ot});var uo=T((dp,ao)=>{"use strict";p();var al=we().EventEmitter,so=a(function(){},"NOOP"),oo=a((r,e)=>{
...
this.callback=e}};a(Fn,"PendingItem");var Qe=Fn;function ul(){throw new Error("Release called on cli\
...
dleListener")}a(cl,"makeIdleListener");var kn=class kn extends al{constructor(e,t){super(),this.options=
...
if(!this._isFull())return this.newClient(e);throw new Error("unexpected condition")}_remove(e){let t=oo(
...
clearTimeout(o),t.callback(u,c,l)},"queueCallback"),s=new Qe(i),o=setTimeout(()=>{oo(this._pendingQueue,
...
_pulseQueue(),e.timedOut||e.callback(o,void 0,so);else{if(this.log("new client connected"),this.options.
...
release(s),t.callback(s,void 0,so);t.callback(void 0,e,e.release)}):t.callback(void 0,e,e.release)}_releaseOnce(e,t){
...
e,t,s)),this._pulseQueue()}query(e,t,n){if(typeof e=="function"){let s=qt(this.Promise,e);return v(function(){
...
return this._clients.length}};a(kn,"Pool");var Bn=kn;ao.exports=Bn});var co={};ne(co,{default:()=>ll});var ll,lo=V(()=>{"use strict";p();ll={}});var fo=T((wp,fl)=>{fl.exports={name:"pg",version:"8.8.0",description:"PostgreSQL client - pure javas\
...
a178655"}});var yo=T((bp,po)=>{"use strict";p();var ho=we().EventEmitter,hl=(st(),O(it)),Mn=nt(),Ne=po.exports=function(r,e,t){
ho.call(this),r=Mn.normalizeQueryConfig(r,e,t),this.text=r.text,this.values=r.values,this.name=r.name,
this.callback=r.callback,this.state="new",this._arrayMode=r.rowMode==="array",this._emitRowEvents=!1,
this.on("newListener",function(n){n==="row"&&(this._emitRowEvents=!0)}.bind(this))};hl.inherits(Ne,ho);
...
prepareValue);r.native.query(this.text,i,t)}else r.native.query(this.text,t)}});var bo=T((Ep,wo)=>{"use strict";p();var dl=(lo(),O(co)),yl=_t(),Sp=fo(),mo=we().EventEmitter,ml=(st(),O(it)),
gl=Lt(),go=yo(),Y=wo.exports=function(r){mo.call(this),r=r||{},this._Promise=r.Promise||b.Promise,this.
_types=new yl(r.types),this.native=new dl({types:this._types}),this._queryQueue=[],this._ending=!1,this.
_connecting=!1,this._connected=!1,this._queryable=!0;var e=this.connectionParameters=new gl(r);this.
...
go;ml.inherits(Y,mo);Y.prototype._errorAllQueries=function(r){let e=a(t=>{m.nextTick(()=>{t.native=this.
...
e);else if(s=this.connectionParameters.query_timeout,n=new go(r,e,t),!n.callback){let c,l;i=new this.
...
m.nextTick(()=>{e.emit("end"),r&&r()})}),t};Y.prototype._hasActiveQuery=function(){return this._activeQuery&&
...
r,e,t)};Y.prototype.getTypeParser=function(r,e){return this._types.getTypeParser(r,e)}});var Un=T((_p,vo)=>{"use strict";p();vo.exports=bo()});var at=T((Tp,ut)=>{"use strict";p();var wl=io(),bl=rt(),vl=In(),xl=uo(),{DatabaseError:Sl}=An(),El=a(
r=>{var e;return e=class extends xl{constructor(n){super(n,r)}},a(e,"BoundPool"),e},"poolFactory"),Dn=a(
function(r){this.defaults=bl,this.Client=r,this.Query=this.Client.Query,this.Pool=El(this.Client),this.
_pools=[],this.Connection=vl,this.types=Xe(),this.DatabaseError=Sl},"PG");typeof m.env.NODE_PG_FORCE_NATIVE<
"u"?ut.exports=new Dn(Un()):(ut.exports=new Dn(wl),Object.defineProperty(ut.exports,"native",{configurable:!0,
enumerable:!1,get(){var r=null;try{r=new Dn(Un())}catch(e){if(e.code!=="MODULE_NOT_FOUND")throw e}return Object.
defineProperty(ut.exports,"native",{value:r}),r}}))});p();p();Fe();er();p();var ga=Object.defineProperty,wa=Object.defineProperties,ba=Object.getOwnPropertyDescriptors,Ai=Object.
getOwnPropertySymbols,va=Object.prototype.hasOwnProperty,xa=Object.prototype.propertyIsEnumerable,Ci=a(
(r,e,t)=>e in r?ga(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t,"__defNormalProp"),
Sa=a((r,e)=>{for(var t in e||(e={}))va.call(e,t)&&Ci(r,t,e[t]);if(Ai)for(var t of Ai(e))xa.call(e,t)&&
Ci(r,t,e[t]);return r},"__spreadValues"),Ea=a((r,e)=>wa(r,ba(e)),"__spreadProps"),Aa=1008e3,_i=new Uint8Array(
new Uint16Array([258]).buffer)[0]===2,Ca=new TextDecoder,tr=new TextEncoder,gt=tr.encode("0123456789\
abcdef"),wt=tr.encode("0123456789ABCDEF"),_a=tr.encode("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqr\
stuvwxyz0123456789+/");var Ii=_a.slice();Ii[62]=45;Ii[63]=95;var He,bt;function Ia(r,{alphabet:e,scratchArr:t}={}){if(!He)if(He=
new Uint16Array(256),bt=new Uint16Array(256),_i)for(let _=0;_<256;_++)He[_]=gt[_&15]<<8|gt[_>>>4],bt[_]=
wt[_&15]<<8|wt[_>>>4];else for(let _=0;_<256;_++)He[_]=gt[_&15]|gt[_>>>4]<<8,bt[_]=wt[_&15]|wt[_>>>4]<<
8;r.byteOffset%4!==0&&(r=new Uint8Array(r));let n=r.length,i=n>>>1,s=n>>>2,o=t||new Uint16Array(n),u=new Uint32Array(
r.buffer,r.byteOffset,s),c=new Uint32Array(o.buffer,o.byteOffset,i),l=e==="upper"?bt:He,f=0,y=0,w;if(_i)
...
return Ca.decode(o.subarray(0,n))}a(Ia,"_toHex");function Ta(r,e={}){let t="",n=r.length,i=Aa>>>1,s=Math.
ceil(n/i),o=new Uint16Array(s>1?i:n);for(let u=0;u<s;u++){let c=u*i,l=c+i;t+=Ia(r.subarray(c,l),Ea(Sa(
{},e),{scratchArr:o}))}return t}a(Ta,"_toHexChunked");function Ti(r,e={}){return e.alphabet!=="upper"&&
typeof r.toHex=="function"?r.toHex():Ta(r,e)}a(Ti,"toHex");p();var vt=class vt{constructor(e,t){this.strings=e;this.values=t}toParameterizedQuery(e={query:"",params:[]}){
let{strings:t,values:n}=this;for(let i=0,s=t.length;i<s;i++)if(e.query+=t[i],i<n.length){let o=n[i];
if(o instanceof $e)e.query+=o.sql;else if(o instanceof Ce)if(o.queryData instanceof vt)o.queryData.toParameterizedQuery(
...
(e.query+="::bytea")}}return e}};a(vt,"SqlTemplate");var Ge=vt,rr=class rr{constructor(e){this.sql=e}};
a(rr,"UnsafeRawSql");var $e=rr;p();function xt(){typeof window<"u"&&typeof document<"u"&&typeof console<"u"&&typeof console.warn=="func\
tion"&&console.warn(`          
        ************************************************************
        *                                                          *
        ...
        *  parameter.                                              *
        *                                                          *
        ************************************************************`)}a(xt,"warnIfBrowser");p();var Ve="pkg:npm/%40neondatabase/serverless@1.1.0";Fe();var hs=me(_t()),ps=me(nt());var Tt=class Tt extends Error{constructor(t){super(t);E(this,"name","NeonDbError");E(this,"severity");
...
Tt,"NeonDbError");var be=Tt,cs="transaction() expects an array of queries, or a function returning a\
n array of queries",Mu=["severity","code","detail","hint","position","internalPosition","internalQue\
ry","where","schema","table","column","dataType","constraint","file","line","routine"];function Uu(r){
return r instanceof d?"\\x"+Ti(r):r}a(Uu,"encodeBuffersAsBytea");function ls(r){let{query:e,params:t}=r instanceof
Ge?r.toParameterizedQuery():r;return{query:e,params:t.map(n=>Uu((0,ps.prepareValue)(n)))}}a(ls,"prep\
areQuery");function ds(r,{arrayMode:e,fullResults:t,fetchOptions:n,isolationLevel:i,readOnly:s,deferrable:o,
...
let{protocol:f,username:y,hostname:w,port:A,pathname:_}=l;if(f!=="postgres:"&&f!=="postgresql:"||!y||
!w||!_)throw new Error("Database connection string format for `neon()` should be: postgresql://user:\
password@host.tld/dbname?option=value");let j=Jt(r,"application_name",Ve);function H(C,...g){if(!(Array.
isArray(C)&&Array.isArray(C.raw)&&Array.isArray(g)))throw new Error('This function can now be called\
...
value], options).');return new Ce(re,new Ge(C,g))}a(H,"templateFn"),H.query=(C,g,B)=>new Ce(re,{query:C,
params:g??[]},B),H.unsafe=C=>new $e(C),H.transaction=async(C,g)=>{if(typeof C=="function"&&(C=C(H)),
!Array.isArray(C))throw new Error(cs);C.forEach(D=>{if(!(D instanceof Ce))throw new Error(cs)});let B=C.
map(D=>D.queryData),Z=C.map(D=>D.opts??{});return re(B,Z,g)};async function re(C,g,B){let{fetchEndpoint:Z,
fetchFunction:D}=ae,he=Array.isArray(C)?{queries:C.map(N=>ls(N))}:ls(C),J=n??{},ie=e??!1,R=t??!1,G=i,
ue=s,pe=o;B!==void 0&&(B.fetchOptions!==void 0&&(J={...J,...B.fetchOptions}),B.arrayMode!==void 0&&(ie=
B.arrayMode),B.fullResults!==void 0&&(R=B.fullResults),B.isolationLevel!==void 0&&(G=B.isolationLevel),
B.readOnly!==void 0&&(ue=B.readOnly),B.deferrable!==void 0&&(pe=B.deferrable)),g!==void 0&&!Array.isArray(
g)&&g.fetchOptions!==void 0&&(J={...J,...g.fetchOptions});let Se=u;!Array.isArray(g)&&g?.authToken!==
void 0&&(Se=g.authToken);let We=typeof Z=="function"?Z(w,A,{jwtAuth:Se!==void 0}):Z,ce={"Neon-Connec\
tion-String":j,"Neon-Raw-Text-Output":"true","Neon-Array-Mode":"true"},ft=await Du(Se);ft&&(ce.Authorization=
`Bearer ${ft}`),Array.isArray(C)&&(G!==void 0&&(ce["Neon-Batch-Isolation-Level"]=G),ue!==void 0&&(ce["\
Neon-Batch-Read-Only"]=String(ue)),pe!==void 0&&(ce["Neon-Batch-Deferrable"]=String(pe))),c||ae.disableWarningInBrowsers||
xt();let de;try{de=await(D??fetch)(We,{method:"POST",body:JSON.stringify(he),headers:ce,...J})}catch(N){
let M=new be(`Error connecting to database: ${N}`);throw M.sourceError=N,M}if(de.ok){let N=await de.
json();if(Array.isArray(C)){let M=N.results;if(!Array.isArray(M))throw new be("Neon internal error: \
unexpected result format");return M.map((ye,_e)=>{let Qt=g[_e]??{},Ao=Qt.arrayMode??ie,Co=Qt.fullResults??
R;return fs(ye,{arrayMode:Ao,fullResults:Co,types:Qt.types})})}else{let M=g??{},ye=M.arrayMode??ie,_e=M.
fullResults??R;return fs(N,{arrayMode:ye,fullResults:_e,types:M.types})}}else{let{status:N}=de;if(N===
400){let M=await de.json(),ye=new be(M.message);for(let _e of Mu)ye[_e]=M[_e]??void 0;throw ye}else{
let M=await de.text();throw new be(`Server error (HTTP status ${N}): ${M}`)}}}return a(re,"execute"),
H}a(ds,"neon");var gr=class gr{constructor(e,t,n){this.execute=e;this.queryData=t;this.opts=n}then(e,t){
return this.execute(this.queryData,this.opts).then(e,t)}catch(e){return this.execute(this.queryData,
this.opts).catch(e)}finally(e){return this.execute(this.queryData,this.opts).finally(e)}};a(gr,"Neon\
QueryPromise");var Ce=gr;function fs(r,{arrayMode:e,fullResults:t,types:n}){let i=new hs.default(n),
s=r.fields.map(c=>c.name),o=r.fields.map(c=>i.getTypeParser(c.dataTypeID)),u=e===!0?r.rows.map(c=>c.
map((l,f)=>l===null?null:o[f](l))):r.rows.map(c=>Object.fromEntries(c.map((l,f)=>[s[f],l===null?null:
o[f](l)])));return t?(r.viaNeonFetch=!0,r.rowAsArray=e,r.rows=u,r._parsers=o,r._types=i,r):u}a(fs,"p\
rocessQueryResult");async function Du(r){if(typeof r=="string")return r;if(typeof r=="function")try{
return await Promise.resolve(r())}catch(e){let t=new be("Error getting auth token.");throw e instanceof
Error&&(t=new be(`Error getting auth token: ${e.message}`)),t}}a(Du,"getAuthToken");p();var So=me(at());p();var xo=me(at());var On=class On extends xo.Client{constructor(t){super(typeof t=="string"?{connectionString:t,fallback_application_name:Ve}:
{fallback_application_name:Ve,...t});this.config=t}get neonConfig(){return this.connection.stream}connect(t){
...
onnect":"connect";l.on(f,()=>{this.neonConfig.disableWarningInBrowsers||xt(),this._handleAuthCleartextPassword(),
...
let u=Object.fromEntries(o.split(",").map(N=>{if(!/^.=/.test(N))throw new Error("SASL: Invalid attri\
bute pair entry");let M=N[0],ye=N.substring(2);return[M,ye]})),c=u.r,l=u.s,f=u.i;if(!c||!/^[!-+--~]+$/.
...
server nonce is too short");let y=parseInt(f,10),w=d.from(l,"base64"),A=new TextEncoder,_=A.encode(s),
j=await n.importKey("raw",_,{name:"HMAC",hash:{name:"SHA-256"}},!1,["sign"]),H=new Uint8Array(await n.
sign("HMAC",j,d.concat([w,d.from([0,0,0,1])]))),re=H;for(var C=0;C<y-1;C++)H=new Uint8Array(await n.
sign("HMAC",j,H)),re=d.from(re.map((N,M)=>re[M]^H[M]));let g=re,B=await n.importKey("raw",g,{name:"H\
MAC",hash:{name:"SHA-256"}},!1,["sign"]),Z=new Uint8Array(await n.sign("HMAC",B,A.encode("Client Key"))),
D=await n.digest("SHA-256",Z),he="n=*,r="+i.clientNonce,J="r="+c+",s="+l+",i="+y,ie="c=biws,r="+c,R=he+
","+J+","+ie,G=await n.importKey("raw",D,{name:"HMAC",hash:{name:"SHA-256"}},!1,["sign"]);var ue=new Uint8Array(
await n.sign("HMAC",G,A.encode(R))),pe=d.from(Z.map((N,M)=>Z[M]^ue[M])),Se=pe.toString("base64");let We=await n.
importKey("raw",g,{name:"HMAC",hash:{name:"SHA-256"}},!1,["sign"]),ce=await n.sign("HMAC",We,A.encode(
"Server Key")),ft=await n.importKey("raw",ce,{name:"HMAC",hash:{name:"SHA-256"}},!1,["sign"]);var de=d.
from(await n.sign("HMAC",ft,A.encode(R)));i.message="SASLResponse",i.serverSignature=de.toString("ba\
se64"),i.response=ie+",p="+Se,this.connection.sendSCRAMClientFinalMessage(this.saslSession.response)}};
a(On,"NeonClient");var ct=On;Fe();var Eo=me(Lt());function Al(r,e){if(e)return{callback:e,result:void 0};let t,n,i=a(function(o,u){o?t(o):n(u)},"cb"),
s=new r(function(o,u){n=o,t=u});return{callback:i,result:s}}a(Al,"promisify");var Qn=class Qn extends So.Pool{constructor(){
super(...arguments);E(this,"Client",ct);E(this,"hasFetchUnsupportedListeners",!1);E(this,"addListene\
...
t,n,i);typeof n=="function"&&(i=n,n=void 0);let s=Al(this.Promise,i);i=s.callback;try{let o=new Eo.default(
this.options),u=encodeURIComponent,c=encodeURI,l=`postgresql://${u(o.user)}:${u(o.password)}@${u(o.host)}\
/${c(o.database)}`,f=typeof t=="string"?t:t.text,y=n??t.values??[];ds(l,{fullResults:!0,arrayMode:t.
rowMode==="array"}).query(f,y,{types:t.types??this.options?.types}).then(A=>i(void 0,A)).catch(A=>i(
A))}catch(o){i(o)}return s.result}};a(Qn,"NeonPool");var qn=Qn;Fe();var lt=me(at()),Cl=me(Lr()),jp="mjs";var export_DatabaseError=lt.DatabaseError;var export_defaults=lt.defaults;var export_escapeIdentifier=lt.escapeIdentifier;
var export_escapeLiteral=lt.escapeLiteral;var export_parseConnectionString=Cl.parse;var export_types=lt.types;
export{ct as Client,export_DatabaseError as DatabaseError,be as NeonDbError,Ce as NeonQueryPromise,qn as Pool,
Ge as SqlTemplate,$e as UnsafeRawSql,jp as _bundleExt,export_defaults as defaults,export_escapeIdentifier as escapeIdentifier,
export_escapeLiteral as escapeLiteral,ds as neon,ae as neonConfig,export_parseConnectionString as parseConnectionString,
export_types as types,xt as warnIfBrowser};
