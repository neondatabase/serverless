...
var Co=Object.create;var Be=Object.defineProperty;var _o=Object.getOwnPropertyDescriptor;var Io=Object.getOwnPropertyNames;var To=Object.getPrototypeOf,Po=Object.prototype.hasOwnProperty;var Bo=(r,e,t)=>e in r?Be(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t;var a=(r,e)=>Be(r,"name",{value:e,configurable:!0});var K=(r,e)=>()=>(r&&(e=r(r=0)),e);var I=(r,e)=>()=>(e||r((e={exports:{}}).exports,e),e.exports),se=(r,e)=>{for(var t in e)Be(r,t,{get:e[t],
enumerable:!0})},Qn=(r,e,t,n)=>{if(e&&typeof e=="object"||typeof e=="function")for(let i of Io(e))!Po.
call(r,i)&&i!==t&&Be(r,i,{get:()=>e[i],enumerable:!(n=_o(e,i))||n.enumerable});return r};var Ae=(r,e,t)=>(t=r!=null?Co(To(r)):{},Qn(e||!r||!r.__esModule?Be(t,"default",{value:r,enumerable:!0}):
t,r)),O=r=>Qn(Be({},"__esModule",{value:!0}),r);var A=(r,e,t)=>Bo(r,typeof e!="symbol"?e+"":e,t);var jn=I(ht=>{"use strict";p();ht.byteLength=Lo;ht.toByteArray=ko;ht.fromByteArray=Do;var oe=[],te=[],
Ro=typeof Uint8Array<"u"?Uint8Array:Array,Wt="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz01\
23456789+/";for(Ce=0,Nn=Wt.length;Ce<Nn;++Ce)oe[Ce]=Wt[Ce],te[Wt.charCodeAt(Ce)]=Ce;var Ce,Nn;te[45]=
62;te[95]=63;function Wn(r){var e=r.length;if(e%4>0)throw new Error("Invalid string. Length must be \
a multiple of 4");var t=r.indexOf("=");t===-1&&(t=e);var n=t===e?0:4-t%4;return[t,n]}a(Wn,"getLens");
function Lo(r){var e=Wn(r),t=e[0],n=e[1];return(t+n)*3/4-n}a(Lo,"byteLength");function Fo(r,e,t){return(e+
t)*3/4-t}a(Fo,"_byteLength");function ko(r){var e,t=Wn(r),n=t[0],i=t[1],s=new Ro(Fo(r,n,i)),o=0,u=i>
...
4|te[r.charCodeAt(c+2)]>>2,s[o++]=e>>8&255,s[o++]=e&255),s}a(ko,"toByteArray");function Mo(r){return oe[r>>
18&63]+oe[r>>12&63]+oe[r>>6&63]+oe[r&63]}a(Mo,"tripletToBase64");function Uo(r,e,t){for(var n,i=[],s=e;s<
...
i.push(oe[e>>10]+oe[e>>4&63]+oe[e<<2&63]+"=")),i.join("")}a(Do,"fromByteArray")});var Hn=I(jt=>{p();jt.read=function(r,e,t,n,i){var s,o,u=i*8-n-1,c=(1<<u)-1,l=c>>1,f=-7,y=t?i-1:0,w=t?
...
pow(2,n),s=s-l}return(S?-1:1)*o*Math.pow(2,s-n)};jt.write=function(r,e,t,n,i,s){var o,u,c,l=s*8-i-1,
...
C,u/=256,i-=8);for(o=o<<i|u,l+=i;l>0;r[t+S]=o&255,S+=C,o/=256,l-=8);r[t+S-C]|=N*128}});var ai=I(ke=>{"use strict";p();var Ht=jn(),Le=Hn(),$n=typeof Symbol=="function"&&typeof Symbol.for==
"function"?Symbol.for("nodejs.util.inspect.custom"):null;ke.Buffer=h;ke.SlowBuffer=jo;ke.INSPECT_MAX_BYTES=
50;var pt=2147483647;ke.kMaxLength=pt;h.TYPED_ARRAY_SUPPORT=Oo();!h.TYPED_ARRAY_SUPPORT&&typeof console<
...
this))return this.byteOffset},"get")});function le(r){if(r>pt)throw new RangeError('The value "'+r+'\
...
'The "string" argument must be of type string. Received type number');return zt(r)}return Kn(r,e,t)}
a(h,"Buffer");h.poolSize=8192;function Kn(r,e,t){if(typeof r=="string")return Qo(r,e);if(ArrayBuffer.
...
SharedArrayBuffer)))return Gt(r,e,t);if(typeof r=="number")throw new TypeError('The "value" argument\
...
for option "size"')}a(Yn,"assertSize");function qo(r,e,t){return Yn(r),r<=0?le(r):e!==void 0?typeof t==
"string"?le(r).fill(e,t):le(r).fill(e):le(r)}a(qo,"alloc");h.alloc=function(r,e,t){return qo(r,e,t)};
function zt(r){return Yn(r),le(r<0?0:Kt(r)|0)}a(zt,"allocUnsafe");h.allocUnsafe=function(r){return zt(
r)};h.allocUnsafeSlow=function(r){return zt(r)};function Qo(r,e){if((typeof e!="string"||e==="")&&(e=
"utf8"),!h.isEncoding(e))throw new TypeError("Unknown encoding: "+e);let t=Zn(r,e)|0,n=le(t),i=n.write(
r,e);return i!==t&&(n=n.slice(0,i)),n}a(Qo,"fromString");function $t(r){let e=r.length<0?0:Kt(r.length)|
0,t=le(e);for(let n=0;n<e;n+=1)t[n]=r[n]&255;return t}a($t,"fromArrayLike");function No(r){if(ae(r,Uint8Array)){
let e=new Uint8Array(r);return Gt(e.buffer,e.byteOffset,e.byteLength)}return $t(r)}a(No,"fromArrayVi\
ew");function Gt(r,e,t){if(e<0||r.byteLength<e)throw new RangeError('"offset" is outside of buffer b\
...
r,e,t),Object.setPrototypeOf(n,h.prototype),n}a(Gt,"fromArrayBuffer");function Wo(r){if(h.isBuffer(r)){
let e=Kt(r.length)|0,t=le(e);return t.length===0||r.copy(t,0,0,e),t}if(r.length!==void 0)return typeof r.
length!="number"||Zt(r.length)?le(0):$t(r);if(r.type==="Buffer"&&Array.isArray(r.data))return $t(r.data)}
a(Wo,"fromObject");function Kt(r){if(r>=pt)throw new RangeError("Attempt to allocate Buffer larger t\
han maximum size: 0x"+pt.toString(16)+" bytes");return r|0}a(Kt,"checked");function jo(r){return+r!=
...
ascii":case"latin1":case"binary":return t;case"utf8":case"utf-8":return Vt(r).length;case"ucs2":case"\
ucs-2":case"utf16le":case"utf-16le":return t*2;case"hex":return t>>>1;case"base64":return oi(r).length;default:
if(i)return n?-1:Vt(r).length;e=(""+e).toLowerCase(),i=!0}}a(Zn,"byteLength");h.byteLength=Zn;function Ho(r,e,t){
...
tf8":case"utf-8":return Xn(this,e,t);case"ascii":return Jo(this,e,t);case"latin1":case"binary":return Xo(
...
compare");function Jn(r,e,t,n,i){if(r.length===0)return-1;if(typeof t=="string"?(n=t,t=0):t>2147483647?
...
call(r,e,t):Gn(r,[e],t,n,i);throw new TypeError("val must be string, number or Buffer")}a(Jn,"bidire\
...
e,t,n)!==-1},"includes");h.prototype.indexOf=a(function(e,t,n){return Jn(this,e,t,n,!0)},"indexOf");
h.prototype.lastIndexOf=a(function(e,t,n){return Jn(this,e,t,n,!1)},"lastIndexOf");function $o(r,e,t,n){
...
return dt(Vt(e,r.length-t),r,t,n)}a(Go,"utf8Write");function Vo(r,e,t,n){return dt(sa(e),r,t,n)}a(Vo,
"asciiWrite");function zo(r,e,t,n){return dt(oi(e),r,t,n)}a(zo,"base64Write");function Ko(r,e,t,n){return dt(
...
N");function Yo(r,e,t){return e===0&&t===r.length?Ht.fromByteArray(r):Ht.fromByteArray(r.slice(e,t))}
a(Yo,"base64Slice");function Xn(r,e,t){t=Math.min(r.length,t);let n=[],i=e;for(;i<t;){let s=r[i],o=null,
...
n.push(o),i+=u}return Zo(n)}a(Xn,"utf8Slice");var Vn=4096;function Zo(r){let e=r.length;if(e<=Vn)return String.
fromCharCode.apply(String,r);let t="",n=0;for(;n<e;)t+=String.fromCharCode.apply(String,r.slice(n,n+=
Vn));return t}a(Zo,"decodeCodePointsArray");function Jo(r,e,t){let n="";t=Math.min(r.length,t);for(let i=e;i<
...
2]<<8|this[e+3])},"readUInt32BE");h.prototype.readBigUInt64LE=ye(a(function(e){e=e>>>0,Fe(e,"offset");
...
BigInt(32))},"readBigUInt64LE"));h.prototype.readBigUInt64BE=ye(a(function(e){e=e>>>0,Fe(e,"offset");
...
readBigInt64LE=ye(a(function(e){e=e>>>0,Fe(e,"offset");let t=this[e],n=this[e+7];(t===void 0||n===void 0)&&
...
ye(a(function(e){e=e>>>0,Fe(e,"offset");let t=this[e],n=this[e+7];(t===void 0||n===void 0)&&$e(e,this.
...
return e=e>>>0,t||q(e,4,this.length),Le.read(this,e,!0,23,4)},"readFloatLE");h.prototype.readFloatBE=
a(function(e,t){return e=e>>>0,t||q(e,4,this.length),Le.read(this,e,!1,23,4)},"readFloatBE");h.prototype.
readDoubleLE=a(function(e,t){return e=e>>>0,t||q(e,8,this.length),Le.read(this,e,!0,52,8)},"readDoub\
leLE");h.prototype.readDoubleBE=a(function(e,t){return e=e>>>0,t||q(e,8,this.length),Le.read(this,e,
...
writeBigUInt64LE=ye(a(function(e,t=0){return ei(this,e,t,BigInt(0),BigInt("0xffffffffffffffff"))},"w\
riteBigUInt64LE"));h.prototype.writeBigUInt64BE=ye(a(function(e,t=0){return ti(this,e,t,BigInt(0),BigInt(
...
t+4},"writeInt32BE");h.prototype.writeBigInt64LE=ye(a(function(e,t=0){return ei(this,e,t,-BigInt("0x\
...
0;s<n-t;++s)this[s+t]=o[s%u]}return this},"fill");var Re={};function Yt(r,e,t){var n;Re[r]=(n=class extends t{constructor(){
...
]: ${this.message}`}},a(n,"NodeError"),n)}a(Yt,"E");Yt("ERR_BUFFER_OUT_OF_BOUNDS",function(r){return r?
`${r} is outside of buffer bounds`:"Attempt to access memory outside buffer bounds"},RangeError);Yt(
"ERR_INVALID_ARG_TYPE",function(r,e){return`The "${r}" argument must be of type number. Received typ\
e ${typeof e}`},TypeError);Yt("ERR_OUT_OF_RANGE",function(r,e,t){let n=`The value of "${r}" is out o\
...
_${r.slice(t-3,t)}${e}`;return`${r.slice(0,t)}${e}`}a(zn,"addNumericalSeparator");function ra(r,e,t){
Fe(e,"offset"),(r[e]===void 0||r[e+t]===void 0)&&$e(e,r.length-(t+1))}a(ra,"checkBounds");function si(r,e,t,n,i,s){
...
nd <= ${t}${o}`,new Re.ERR_OUT_OF_RANGE("value",u,r)}ra(n,i,s)}a(si,"checkIntBI");function Fe(r,e){if(typeof r!=
"number")throw new Re.ERR_INVALID_ARG_TYPE(e,"number",r)}a(Fe,"validateNumber");function $e(r,e,t){throw Math.
floor(r)!==r?(Fe(r,t),new Re.ERR_OUT_OF_RANGE(t||"offset","an integer",r)):e<0?new Re.ERR_BUFFER_OUT_OF_BOUNDS:
new Re.ERR_OUT_OF_RANGE(t||"offset",`>= ${t?1:0} and <= ${e}`,r)}a($e,"boundsError");var na=/[^+/0-9A-Za-z-_]/g;
function ia(r){if(r=r.split("=")[0],r=r.trim().replace(na,""),r.length<2)return"";for(;r.length%4!==
0;)r=r+"=";return r}a(ia,"base64clean");function Vt(r,e){e=e||1/0;let t,n=r.length,i=null,s=[];for(let o=0;o<
...
240,t>>12&63|128,t>>6&63|128,t&63|128)}else throw new Error("Invalid code point")}return s}a(Vt,"utf\
...
o),n=t>>8,i=t%256,s.push(i),s.push(n);return s}a(oa,"utf16leToBytes");function oi(r){return Ht.toByteArray(
ia(r))}a(oi,"base64ToBytes");function dt(r,e,t,n){let i;for(i=0;i<n&&!(i+t>=e.length||i>=r.length);++i)
e[i+t]=r[i];return i}a(dt,"blitBuffer");function ae(r,e){return r instanceof e||r!=null&&r.constructor!=
null&&r.constructor.name!=null&&r.constructor.name===e.name}a(ae,"isInstance");function Zt(r){return r!==
...
ua:r}a(ye,"defineBigIntMethod");function ua(){throw new Error("BigInt not supported")}a(ua,"BufferBi\
...
m.nextTick(()=>{})}catch{let e=Promise.resolve();m.nextTick=e.then.bind(e)}});var me=I((Ml,Jt)=>{"use strict";p();var Me=typeof Reflect=="object"?Reflect:null,ui=Me&&typeof Me.apply==
"function"?Me.apply:a(function(e,t,n){return Function.prototype.apply.call(e,t,n)},"ReflectApply"),yt;
Me&&typeof Me.ownKeys=="function"?yt=Me.ownKeys:Object.getOwnPropertySymbols?yt=a(function(e){return Object.
...
init.call(this)}a(L,"EventEmitter");Jt.exports=L;Jt.exports.once=pa;L.EventEmitter=L;L.prototype._events=
...
r,u.type=e,u.count=o.length,ca(u)}return r}a(hi,"_addListener");L.prototype.addListener=a(function(e,t){
return hi(this,e,t,!1)},"addListener");L.prototype.on=L.prototype.addListener;L.prototype.prependListener=
a(function(e,t){return hi(this,e,t,!0)},"prependListener");function la(){if(!this.fired)return this.
target.removeListener(this.type,this.wrapFn),this.fired=!0,arguments.length===0?this.listener.call(this.
target):this.listener.apply(this.target,arguments)}a(la,"onceWrapper");function pi(r,e,t){var n={fired:!1,
wrapFn:void 0,target:r,type:e,listener:t},i=la.bind(n);return i.listener=t,n.wrapFn=i,i}a(pi,"_onceW\
rap");L.prototype.once=a(function(e,t){return mt(t),this.on(e,pi(this,e,t)),this},"once");L.prototype.
prependOnceListener=a(function(e,t){return mt(t),this.prependListener(e,pi(this,e,t)),this},"prepend\
...
0;i--)this.removeListener(e,t[i]);return this},"removeAllListeners");function di(r,e,t){var n=r._events;
if(n===void 0)return[];var i=n[e];return i===void 0?[]:typeof i=="function"?t?[i.listener||i]:[i]:t?
ha(i):mi(i,i.length)}a(di,"_listeners");L.prototype.listeners=a(function(e){return di(this,e,!0)},"l\
isteners");L.prototype.rawListeners=a(function(e){return di(this,e,!1)},"rawListeners");L.listenerCount=
...
n=0;n<e;++n)t[n]=r[n];return t}a(mi,"arrayClone");function fa(r,e){for(;e+1<r.length;e++)r[e]=r[e+1];
...
da(r,i,{once:!0})})}a(pa,"once");function da(r,e,t){typeof r.on=="function"&&wi(r,"error",e,t)}a(da,
...
ust be of type EventEmitter. Received type '+typeof r)}a(wi,"eventTargetAgnosticAddListener")});var vi={};se(vi,{Socket:()=>ue,isIP:()=>ya});function ya(r){return 0}var bi,gi,x,ue,Ue=K(()=>{"use s\
trict";p();bi=Ae(me(),1);a(ya,"isIP");gi=/^[^.]+\./,x=class x extends bi.EventEmitter{constructor(){
...
poolQueryViaFetch:!1,fetchEndpoint:a((t,n,i)=>{let s;return i?.override?s=t:i?.jwtAuth?s=t.replace(gi,
"apiauth."):s=t.replace(gi,"api."),"https://"+s+"/sql"},"fetchEndpoint"),fetchConnectionCache:!0,fetchFunction:void 0,
...
disableWarningInBrowsers:!1}),A(x,"opts",{});ue=x});var xi={};se(xi,{parse:()=>Xt});function Xt(r,e=!1){let{protocol:t}=new URL(r),n="http:"+r.substring(
...
var er=K(()=>{"use strict";p();a(Xt,"parse")});var ir=I(Ii=>{"use strict";p();Ii.parse=function(r,e){return new nr(r,e).parse()};var St=class St{constructor(e,t){
...
not balanced");return this.entries}};a(St,"ArrayParser");var nr=St;function Ta(r){return r}a(Ta,"ide\
ntity")});var sr=I((tf,Ti)=>{p();var Pa=ir();Ti.exports={create:a(function(r,e){return{parse:a(function(){return Pa.
parse(r,e)},"parse")}},"create")}});var Ri=I((sf,Bi)=>{"use strict";p();var Ba=/(\d{1,})-(\d{2})-(\d{2}) (\d{2}):(\d{2}):(\d{2})(\.\d{1,})?.*?( BC)?$/,
Ra=/^(\d{1,})-(\d{2})-(\d{2})( BC)?$/,La=/([Z+-])(\d{2})?:?(\d{2})?:?(\d{2})?/,Fa=/^-?infinity$/;Bi.
...
(y=new Date(Date.UTC(i,s,o,u,c,l,f)),or(i)&&y.setUTCFullYear(i),w!==0&&y.setTime(y.getTime()-w)):(y=
new Date(i,s,o,u,c,l,f),or(i)&&y.setFullYear(i)),y},"parseDate");function ka(r){var e=Ra.exec(r);if(e){
var t=parseInt(e[1],10),n=!!e[4];n&&(t=Pi(t));var i=parseInt(e[2],10)-1,s=e[3],o=new Date(t,i,s);return or(
...
e[3]||0,10)*60+parseInt(e[4]||0,10);return i*n*1e3}}a(Ma,"timeZoneOffset");function Pi(r){return-(r-
1)}a(Pi,"bcYearToNegativeYear");function or(r){return r>=0&&r<100}a(or,"is0To99")});var Fi=I((uf,Li)=>{p();Li.exports=Da;var Ua=Object.prototype.hasOwnProperty;function Da(r){for(var e=1;e<
arguments.length;e++){var t=arguments[e];for(var n in t)Ua.call(t,n)&&(r[n]=t[n])}return r}a(Da,"ext\
end")});var Ui=I((ff,Mi)=>{"use strict";p();var Oa=Fi();Mi.exports=De;function De(r){if(!(this instanceof De))
return new De(r);Oa(this,Ya(r))}a(De,"PostgresInterval");var qa=["seconds","minutes","hours","days",
"months","years"];De.prototype.toPostgres=function(){var r=qa.filter(this.hasOwnProperty,this);return this.
...
S"},Na=["years","months","days"],Wa=["hours","minutes","seconds"];De.prototype.toISOString=De.prototype.
...
/0+$/,"")),i+Qa[n]}};var ar="([+-]?\\d+)",ja=ar+"\\s+years?",Ha=ar+"\\s+mons?",$a=ar+"\\s+days?",Ga="\
...
keys(ki).reduce(function(n,i){var s=ki[i],o=e[s];return!o||(o=i==="milliseconds"?Ka(o):parseInt(o,10),
!o)||(t&&~za.indexOf(i)&&(o*=-1),n[i]=o),n},{})}a(Ya,"parse")});var Oi=I((df,Di)=>{"use strict";p();Di.exports=a(function(e){if(/^\\x/.test(e))return new d(e.substr(
...
parseBytea")});var $i=I((wf,Hi)=>{p();var Ke=ir(),Ye=sr(),Et=Ri(),Qi=Ui(),Ni=Oi();function At(r){return a(function(t){
return t===null?t:r(t)},"nullAllowed")}a(At,"allowNull");function Wi(r){return r===null?r:r==="TRUE"||
r==="t"||r==="true"||r==="y"||r==="yes"||r==="on"||r==="1"}a(Wi,"parseBool");function Za(r){return r?
Ke.parse(r,Wi):null}a(Za,"parseBoolArray");function Ja(r){return parseInt(r,10)}a(Ja,"parseBaseTenIn\
t");function ur(r){return r?Ke.parse(r,At(Ja)):null}a(ur,"parseIntegerArray");function Xa(r){return r?
Ke.parse(r,At(function(e){return ji(e).trim()})):null}a(Xa,"parseBigIntegerArray");var eu=a(function(r){
if(!r)return null;var e=Ye.create(r,function(t){return t!==null&&(t=hr(t)),t});return e.parse()},"pa\
rsePointArray"),cr=a(function(r){if(!r)return null;var e=Ye.create(r,function(t){return t!==null&&(t=
parseFloat(t)),t});return e.parse()},"parseFloatArray"),re=a(function(r){if(!r)return null;var e=Ye.
create(r);return e.parse()},"parseStringArray"),lr=a(function(r){if(!r)return null;var e=Ye.create(r,
...
ervalArray"),ru=a(function(r){return r?Ke.parse(r,At(Ni)):null},"parseByteAArray"),fr=a(function(r){
return parseInt(r,10)},"parseInteger"),ji=a(function(r){var e=String(r);return/^\d+$/.test(e)?e:r},"\
parseBigInteger"),qi=a(function(r){return r?Ke.parse(r,At(JSON.parse)):null},"parseJsonArray"),hr=a(
...
r[i])}var s=hr(e);return s.radius=parseFloat(t),s},"parseCircle"),iu=a(function(r){r(20,ji),r(21,fr),
r(23,fr),r(26,fr),r(700,parseFloat),r(701,parseFloat),r(16,Wi),r(1082,Et),r(1114,Et),r(1184,Et),r(600,
hr),r(651,re),r(718,nu),r(1e3,Za),r(1001,ru),r(1005,ur),r(1007,ur),r(1028,ur),r(1016,Xa),r(1017,eu),
r(1021,cr),r(1022,cr),r(1231,cr),r(1014,re),r(1015,re),r(1008,re),r(1009,re),r(1040,re),r(1041,re),r(
1115,lr),r(1182,lr),r(1185,lr),r(1186,Qi),r(1187,tu),r(17,Ni),r(114,JSON.parse.bind(JSON)),r(3802,JSON.
parse.bind(JSON)),r(199,qi),r(3807,qi),r(3907,re),r(2951,re),r(791,re),r(1183,re),r(1270,re)},"init");
Hi.exports={init:iu}});var Vi=I((vf,Gi)=>{"use strict";p();var Z=1e6;function su(r){var e=r.readInt32BE(0),t=r.readUInt32BE(
...
""+o%Z,n+u+i}a(su,"readInt8");Gi.exports=su});var Ji=I((Ef,Zi)=>{p();var ou=Vi(),k=a(function(r,e,t,n,i){t=t||0,n=n||!1,i=i||function(S,C,N){return S*
...
r[y]),8);var w=(e+t)%8;return w>0&&(l=i(l,o(r[f])>>8-w,w)),l},"parseBits"),Yi=a(function(r,e,t){var n=Math.
...
r,31,1,!0)+1):k(r,31,1)},"parseInt32"),uu=a(function(r){return Yi(r,23,8)},"parseFloat32"),cu=a(function(r){
return Yi(r,52,11)},"parseFloat64"),lu=a(function(r){var e=k(r,16,32);if(e==49152)return NaN;for(var t=Math.
pow(1e4,k(r,16,16)),n=0,i=[],s=k(r,16),o=0;o<s;o++)n+=k(r,16,64+16*o)*t,t/=1e4;var u=Math.pow(10,k(r,
16,48));return(e===0?1:-1)*Math.round(n*u)/u},"parseNumeric"),Ki=a(function(r,e){var t=k(e,1),n=k(e,
...
usec=s},i.getUTCMicroSeconds=function(){return this.usec},i},"parseDate"),Ze=a(function(r){for(var e=k(
...
null:k(r,8)>0},"parseBool"),pu=a(function(r){r(20,ou),r(21,au),r(23,zi),r(26,zi),r(1700,lu),r(700,uu),
r(701,cu),r(16,hu),r(1114,Ki.bind(null,!1)),r(1184,Ki.bind(null,!0)),r(1e3,Ze),r(1007,Ze),r(1016,Ze),
r(1008,Ze),r(1009,Ze),r(25,fu)},"init");Zi.exports={init:pu}});var es=I((_f,Xi)=>{p();Xi.exports={BOOL:16,BYTEA:17,CHAR:18,INT8:20,INT2:21,INT4:23,REGPROC:24,TEXT:25,
...
REGROLE:4096}});var et=I(Xe=>{p();var du=$i(),yu=Ji(),mu=sr(),wu=es();Xe.getTypeParser=gu;Xe.setTypeParser=bu;Xe.arrayParser=
mu;Xe.builtins=wu;var Je={text:{},binary:{}};function ts(r){return String(r)}a(ts,"noParse");function gu(r,e){
return e=e||"text",Je[e]&&Je[e][r]||ts}a(gu,"getTypeParser");function bu(r,e,t){typeof e=="function"&&
(t=e,e="text"),Je[e][r]=t}a(bu,"setTypeParser");du.init(function(r,e){Je.text[r]=e});yu.init(function(r,e){
Je.binary[r]=e})});var _t=I((Rf,rs)=>{"use strict";p();var vu=et();function Ct(r){this._types=r||vu,this.text={},this.binary=
...
e||"text",this.getOverrides(e)[r]||this._types.getTypeParser(r,e)};rs.exports=Ct});function tt(r){let e=1779033703,t=3144134277,n=1013904242,i=2773480762,s=1359893119,o=2600822924,u=528734635,
...
24|C[H+1]<<16|C[H+2]<<8|C[H+3];for(let R=16;R<64;R++){let H=w(S[R-15],7)^w(S[R-15],18)^S[R-15]>>>3,ce=w(
S[R-2],17)^w(S[R-2],19)^S[R-2]>>>10;S[R]=S[R-16]+H+S[R-7]+ce|0}let T=e,E=t,P=n,F=i,B=s,X=o,G=u,he=c;
for(let R=0;R<64;R++){let H=w(B,6)^w(B,11)^w(B,25),ce=B&X^~B&G,pe=he+H+ce+y[R]+S[R]|0,ve=w(T,2)^w(T,
13)^w(T,22),xe=T&E^T&P^E&P,Se=ve+xe|0;he=G,G=X,X=B,B=F+pe|0,F=P,P=E,E=T,T=pe+Se|0}e=e+T|0,t=t+E|0,n=
n+P|0,i=i+F|0,s=s+B|0,o=o+X|0,u=u+G|0,c=c+he|0,f=0},"process"),W=a(T=>{typeof T=="string"&&(T=new TextEncoder().
encode(T));for(let E=0;E<T.length;E++)C[f++]=T[E],f===64&&N();l+=T.length},"add"),ie=a(()=>{if(C[f++]=
...
c>>>24,E[29]=c>>>16&255,E[30]=c>>>8&255,E[31]=c&255,E},"digest");return r===void 0?{add:W,digest:ie}:
(W(r),ie())}var ns=K(()=>{"use strict";p();a(tt,"sha256")});var D,rt,is=K(()=>{"use strict";p();D=class D{constructor(){A(this,"_dataLength",0);A(this,"_bufferL\
...
abcdef"),A(D,"hexOut",[]),A(D,"onePassHasher",new D);rt=D});var pr={};se(pr,{createHash:()=>Su,createHmac:()=>Eu,randomBytes:()=>xu});function xu(r){return crypto.
...
"digest")}},"update")}}var dr=K(()=>{"use strict";p();ns();is();a(xu,"randomBytes");a(Su,"createHash");
a(Eu,"createHmac")});var nt=I((Hf,yr)=>{"use strict";p();yr.exports={host:"localhost",user:m.platform==="win32"?m.env.USERNAME:
...
keepalives:1,keepalives_idle:0};var Oe=et(),Au=Oe.getTypeParser(20,"text"),Cu=Oe.getTypeParser(1016,
"text");yr.exports.__defineSetter__("parseInt8",function(r){Oe.setTypeParser(20,"text",r?Oe.getTypeParser(
23,"text"):Au),Oe.setTypeParser(1016,"text",r?Oe.getTypeParser(1007,"text"):Cu)})});var it=I((Gf,os)=>{"use strict";p();var _u=(dr(),O(pr)),Iu=nt();function Tu(r){var e=r.replace(/\\/g,
"\\\\").replace(/"/g,'\\"');return'"'+e+'"'}a(Tu,"escapeElement");function ss(r){for(var e="{",t=0;t<
r.length;t++)t>0&&(e=e+","),r[t]===null||typeof r[t]>"u"?e=e+"NULL":Array.isArray(r[t])?e=e+ss(r[t]):
r[t]instanceof d?e+="\\\\x"+r[t].toString("hex"):e+=Tu(It(r[t]));return e=e+"}",e}a(ss,"arrayString");
...
r.byteLength)}return r instanceof Date?Iu.parseInputDatesAsUTC?Ru(r):Bu(r):Array.isArray(r)?ss(r):typeof r==
...
t),r}a(Lu,"normalizeQueryConfig");var mr=a(function(r){return _u.createHash("md5").update(r,"utf-8").
digest("hex")},"md5"),Fu=a(function(r,e,t){var n=mr(e+r),i=mr(d.concat([d.from(n),t]));return"md5"+i},
"postgresMd5PasswordHash");os.exports={prepareValue:a(function(e){return It(e)},"prepareValueWrapper"),
normalizeQueryConfig:Lu,postgresMd5PasswordHash:Fu,md5:mr}});var st={};se(st,{default:()=>Ou});var Ou,ot=K(()=>{"use strict";p();Ou={}});var ws=I((sh,ms)=>{"use strict";p();var gr=(dr(),O(pr));function qu(r){if(r.indexOf("SCRAM-SHA-256")===
...
art with client nonce");var i=d.from(n.salt,"base64"),s=Gu(e,i,n.iteration),o=qe(s,"Client Key"),u=$u(
o),c="n=*,r="+r.clientNonce,l="r="+n.nonce+",s="+n.salt+",i="+n.iteration,f="c=biws,r="+n.nonce,y=c+
","+l+","+f,w=qe(u,y),S=ys(o,w),C=S.toString("base64"),N=qe(s,"Server Key"),W=qe(N,y);r.message="SAS\
...
a(ys,"xorBuffers");function $u(r){return gr.createHash("sha256").update(r).digest()}a($u,"sha256");function qe(r,e){
return gr.createHmac("sha256",r).update(e).digest()}a(qe,"hmacSha256");function Gu(r,e,t){for(var n=qe(
r,d.concat([e,d.from([0,0,0,1])])),i=n,s=0;s<t-1;s++)n=qe(r,n),i=ys(i,n);return i}a(Gu,"Hi");ms.exports=
{startSession:qu,continueSession:Qu,finalizeSession:Nu}});var br={};se(br,{join:()=>Vu});function Vu(...r){return r.join("/")}var vr=K(()=>{"use strict";p();a(
Vu,"join")});var xr={};se(xr,{stat:()=>zu});function zu(r,e){e(new Error("No filesystem"))}var Sr=K(()=>{"use str\
ict";p();a(zu,"stat")});var Er={};se(Er,{default:()=>Ku});var Ku,Ar=K(()=>{"use strict";p();Ku={}});var gs={};se(gs,{StringDecoder:()=>Cr});var _r,Cr,bs=K(()=>{"use strict";p();_r=class _r{constructor(e){
A(this,"td");this.td=new TextDecoder(e)}write(e){return this.td.decode(e,{stream:!0})}end(e){return this.
td.decode(e)}};a(_r,"StringDecoder");Cr=_r});var Es=I((yh,Ss)=>{"use strict";p();var{Transform:Yu}=(Ar(),O(Er)),{StringDecoder:Zu}=(bs(),O(gs)),ge=Symbol(
"last"),Pt=Symbol("decoder");function Ju(r,e,t){let n;if(this.overflow){if(n=this[Pt].write(r).split(
this.matcher),n.length===1)return t();n.shift(),this.overflow=!1}else this[ge]+=this[Pt].write(r),n=
this[ge].split(this.matcher);this[ge]=n.pop();for(let i=0;i<n.length;i++)try{xs(this,this.mapper(n[i]))}catch(s){
return t(s)}if(this.overflow=this[ge].length>this.maxLength,this.overflow&&!this.skipOverflow){t(new Error(
"maximum buffer reached"));return}t()}a(Ju,"transform");function Xu(r){if(this[ge]+=this[Pt].end(),this[ge])
try{xs(this,this.mapper(this[ge]))}catch(e){return r(e)}r()}a(Xu,"flush");function xs(r,e){e!==void 0&&
...
!0;let n=new Yu(t);return n[ge]="",n[Pt]=new Zu("utf8"),n.matcher=r,n.mapper=e,n.maxLength=t.maxLength,
n.skipOverflow=t.skipOverflow||!1,n.overflow=!1,n._destroy=function(i,s){this._writableState.errorEmitted=
!1,s(i)},n}a(ec,"split");Ss.exports=ec});var _s=I((gh,fe)=>{"use strict";p();var As=(vr(),O(br)),tc=(Ar(),O(Er)).Stream,rc=Es(),Cs=(ot(),O(st)),
nc=5432,Bt=m.platform==="win32",at=m.stderr,ic=56,sc=7,oc=61440,ac=32768;function uc(r){return(r&oc)==
ac}a(uc,"isRegFile");var Qe=["host","port","database","user","password"],Ir=Qe.length,cc=Qe[Ir-1];function Tr(){
var r=at instanceof tc&&at.writable===!0;if(r){var e=Array.prototype.slice.call(arguments).concat(`
`);at.write(Cs.format.apply(Cs,e))}}a(Tr,"warn");Object.defineProperty(fe.exports,"isWin",{get:a(function(){
return Bt},"get"),set:a(function(r){Bt=r},"set")});fe.exports.warnTo=function(r){var e=at;return at=
r,e};fe.exports.getFileName=function(r){var e=r||m.env,t=e.PGPASSFILE||(Bt?As.join(e.APPDATA||"./","\
postgresql","pgpass.conf"):As.join(e.HOME||"./",".pgpass"));return t};fe.exports.usePgPass=function(r,e){
return Object.prototype.hasOwnProperty.call(m.env,"PGPASSWORD")?!1:Bt?!0:(e=e||"<unkn>",uc(r.mode)?r.
mode&(ic|sc)?(Tr('WARNING: password file "%s" has group or world access; permissions should be u=rw \
(0600) or less',e),!1):!0:(Tr('WARNING: password file "%s" is not a plain file',e),!1))};var lc=fe.exports.
match=function(r,e){return Qe.slice(0,-1).reduce(function(t,n,i){return i==1&&Number(r[n]||nc)===Number(
...
void 0)},"onErr");e.on("error",u),i.on("data",s).on("end",o).on("error",u)};var fc=fe.exports.parseLine=
...
replace(/\\([:\\])/g,"$1")),o[Qe[f]]=S},"addToObj"),l=0;l<r.length-1;l+=1){if(e=r.charAt(l+1),t=r.charAt(
l),u=n==Ir-1,u){c(n,i);break}l>=0&&e==":"&&t!=="\\"&&(c(n,i,l+1),i=l+2,n+=1)}return o=Object.keys(o).
length===Ir?o:null,o},hc=fe.exports.isValidEntry=function(r){for(var e={0:function(o){return o.length>
...
0}},t=0;t<Qe.length;t+=1){var n=e[t],i=r[Qe[t]]||"",s=n(i);if(!s)return!1}return!0}});var Ts=I((Sh,Pr)=>{"use strict";p();var xh=(vr(),O(br)),Is=(Sr(),O(xr)),Rt=_s();Pr.exports=function(r,e){
var t=Rt.getFileName();Is.stat(t,function(n,i){if(n||!Rt.usePgPass(i,t))return e(void 0);var s=Is.createReadStream(
t);Rt.getPassword(r,s,e)})};Pr.exports.warnTo=Rt.warnTo});var Ps={};se(Ps,{default:()=>pc});var pc,Bs=K(()=>{"use strict";p();pc={}});var Ls=I((Ch,Rs)=>{"use strict";p();var dc=(er(),O(xi)),Br=(Sr(),O(xr));function Rr(r){if(r.charAt(0)===
...
!1;break}}return t}a(Rr,"parse");Rs.exports=Rr;Rr.parse=Rr});var Lt=I((Th,Ms)=>{"use strict";p();var yc=(Bs(),O(Ps)),ks=nt(),Fs=Ls().parse,$=a(function(r,e,t){return t===
...
no-verify":return{rejectUnauthorized:!1}}return ks.ssl},"readSSLConfigFromEnvironment"),Ne=a(function(r){
return"'"+(""+r).replace(/\\/g,"\\\\").replace(/'/g,"\\'")+"'"},"quoteParamValue"),ne=a(function(r,e,t){
var n=e[t];n!=null&&r.push(t+"="+Ne(n))},"add"),Fr=class Fr{constructor(e){e=typeof e=="string"?Fs(e):
...
slkey"),ne(t,n,"sslcert"),ne(t,n,"sslrootcert"),this.database&&t.push("dbname="+Ne(this.database)),this.
...
yc.lookup(this.host,function(i,s){return i?e(i,null):(t.push("hostaddr="+Ne(s)),e(null,t.join(" ")))})}};
a(Fr,"ConnectionParameters");var Lr=Fr;Ms.exports=Lr});var Os=I((Rh,Ds)=>{"use strict";p();var wc=et(),Us=/^([A-Za-z]+)(?: (\d+))?(?: (\d+))?/,Mr=class Mr{constructor(e,t){
...
format||"text")}}};a(Mr,"Result");var kr=Mr;Ds.exports=kr});var Ws=I((kh,Ns)=>{"use strict";p();var{EventEmitter:gc}=me(),qs=Os(),Qs=it(),Dr=class Dr extends gc{constructor(e,t,n){
...
e.sendCopyFail("No source stream defined")}handleCopyData(e,t){}};a(Dr,"Query");var Ur=Dr;Ns.exports=
Ur});var pn=I(_=>{"use strict";p();Object.defineProperty(_,"__esModule",{value:!0});_.NoticeMessage=_.DataRowMessage=
...
name=n}};a(Jr,"DatabaseError");var Or=Jr;_.DatabaseError=Or;var Xr=class Xr{constructor(e,t){this.length=
...
status=t,this.name="readyForQuery"}};a(cn,"ReadyForQueryMessage");var zr=cn;_.ReadyForQueryMessage=zr;
var ln=class ln{constructor(e,t){this.length=e,this.text=t,this.name="commandComplete"}};a(ln,"Comma\
ndCompleteMessage");var Kr=ln;_.CommandCompleteMessage=Kr;var fn=class fn{constructor(e,t){this.length=
...
ssage");var Zr=hn;_.NoticeMessage=Zr});var js=I(Ft=>{"use strict";p();Object.defineProperty(Ft,"__esModule",{value:!0});Ft.Writer=void 0;var yn=class yn{constructor(e=256){
...
headerPosition=0,this.buffer=d.allocUnsafe(this.size),t}};a(yn,"Writer");var dn=yn;Ft.Writer=dn});var $s=I(Mt=>{"use strict";p();Object.defineProperty(Mt,"__esModule",{value:!0});Mt.serialize=void 0;
var mn=js(),M=new mn.Writer,bc=a(r=>{M.addInt16(3).addInt16(0);for(let n of Object.keys(r))M.addCString(
n).addCString(r[n]);M.addCString("client_encoding").addCString("UTF8");let e=M.addCString("").flush(),
t=e.length+4;return new mn.Writer().addInt32(t).add(e).flush()},"startup"),vc=a(()=>{let r=d.allocUnsafe(
...
n;s++)i.addInt32(t[s]);return M.flush(80)},"parse"),We=new mn.Writer,_c=a(function(r,e){for(let t=0;t<
r.length;t++){let n=e?e(r[t],t):r[t];n==null?(M.addInt16(0),We.addInt32(-1)):n instanceof d?(M.addInt16(
1),We.addInt32(n.length),We.add(n)):(M.addInt16(0),We.addInt32(d.byteLength(n)),We.addString(n))}},"\
writeValues"),Ic=a((r={})=>{let e=r.portal||"",t=r.statement||"",n=r.binary||!1,i=r.values||Hs,s=i.length;
return M.addCString(e).addCString(t),M.addInt16(s),_c(i,r.valueMapper),M.addInt16(s),M.add(We.flush()),
...
6),t.writeInt32BE(r,8),t.writeInt32BE(e,12),t},"cancel"),wn=a((r,e)=>{let n=4+d.byteLength(e)+1,i=d.
allocUnsafe(1+n);return i[0]=r,i.writeInt32BE(n,1),i.write(e,5,"utf-8"),i[n]=0,i},"cstringMessage"),
Rc=M.addCString("P").flush(68),Lc=M.addCString("S").flush(68),Fc=a(r=>r.name?wn(68,`${r.type}${r.name||
""}`):r.type==="P"?Rc:Lc,"describe"),kc=a(r=>{let e=`${r.type}${r.name||""}`;return wn(67,e)},"close"),
Mc=a(r=>M.add(r).flush(100),"copyData"),Uc=a(r=>wn(102,r),"copyFail"),kt=a(r=>d.from([r,0,0,0,4]),"c\
...
var Wc=d.allocUnsafe(0),bn=class bn{constructor(e=0){this.offset=e,this.buffer=Wc,this.encoding="utf\
...
offset+=e,t}};a(bn,"BufferReader");var gn=bn;Ut.BufferReader=gn});var Ks=I(Dt=>{"use strict";p();Object.defineProperty(Dt,"__esModule",{value:!0});Dt.Parser=void 0;var U=pn(),
jc=Gs(),vn=1,Hc=4,Vs=vn+Hc,zs=d.allocUnsafe(0),Sn=class Sn{constructor(e){if(this.buffer=zs,this.bufferLength=
...
i+vn),u=vn+o;if(u+i<=n){let c=this.handlePacket(i+Vs,s,o,this.buffer);t(c),i+=u}else break}i===n?(this.
...
a(Sn,"Parser");var xn=Sn;Dt.Parser=xn});var En=I(be=>{"use strict";p();Object.defineProperty(be,"__esModule",{value:!0});be.DatabaseError=be.
serialize=be.parse=void 0;var $c=pn();Object.defineProperty(be,"DatabaseError",{enumerable:!0,get:a(
function(){return $c.DatabaseError},"get")});var Gc=$s();Object.defineProperty(be,"serialize",{enumerable:!0,
get:a(function(){return Gc.serialize},"get")});var Vc=Ks();function zc(r,e){let t=new Vc.Parser;return r.
on("data",n=>t.parse(n,e)),new Promise(n=>r.on("end",()=>n()))}a(zc,"parse");be.parse=zc});var Ys={};se(Ys,{connect:()=>Kc});function Kc({socket:r,servername:e}){return r.startTls(e),r}var Zs=K(
()=>{"use strict";p();a(Kc,"connect")});var _n=I((np,eo)=>{"use strict";p();var Js=(Ue(),O(vi)),Yc=me().EventEmitter,{parse:Zc,serialize:Q}=En(),
Xs=Q.flush(),Jc=Q.sync(),Xc=Q.end(),Cn=class Cn extends Yc{constructor(e){super(),e=e||{},this.stream=
...
this._send(Q.copyDone())}sendCopyFail(e){this._send(Q.copyFail(e))}};a(Cn,"Connection");var An=Cn;eo.
exports=An});var no=I((ap,ro)=>{"use strict";p();var el=me().EventEmitter,op=(ot(),O(st)),tl=it(),In=ws(),rl=Ts(),
nl=_t(),il=Lt(),to=Ws(),sl=nt(),ol=_n(),Tn=class Tn extends el{constructor(e){super(),this.connectionParameters=
...
_Promise(t=>{this.connection.once("end",t)})}};a(Tn,"Client");var Ot=Tn;Ot.Query=to;ro.exports=Ot});var ao=I((lp,oo)=>{"use strict";p();var al=me().EventEmitter,io=a(function(){},"NOOP"),so=a((r,e)=>{
let t=r.findIndex(e);return t===-1?void 0:r.splice(t,1)[0]},"removeWhere"),Rn=class Rn{constructor(e,t,n){
this.client=e,this.idleListener=t,this.timeoutId=n}};a(Rn,"IdleItem");var Pn=Rn,Ln=class Ln{constructor(e){
this.callback=e}};a(Ln,"PendingItem");var je=Ln;function ul(){throw new Error("Release called on cli\
...
dleListener")}a(cl,"makeIdleListener");var Fn=class Fn extends al{constructor(e,t){super(),this.options=
...
clearTimeout(o),t.callback(u,c,l)},"queueCallback"),s=new je(i),o=setTimeout(()=>{so(this._pendingQueue,
...
this.options.allowExitOnIdle&&s.unref()),this.options.allowExitOnIdle&&e.unref(),this._idle.push(new Pn(
...
return this._clients.length}};a(Fn,"Pool");var Bn=Fn;oo.exports=Bn});var uo={};se(uo,{default:()=>ll});var ll,co=K(()=>{"use strict";p();ll={}});var lo=I((dp,fl)=>{fl.exports={name:"pg",version:"8.8.0",description:"PostgreSQL client - pure javas\
...
a178655"}});var po=I((yp,ho)=>{"use strict";p();var fo=me().EventEmitter,hl=(ot(),O(st)),kn=it(),He=ho.exports=function(r,e,t){
fo.call(this),r=kn.normalizeQueryConfig(r,e,t),this.text=r.text,this.values=r.values,this.name=r.name,
this.callback=r.callback,this.state="new",this._arrayMode=r.rowMode==="array",this._emitRowEvents=!1,
this.on("newListener",function(n){n==="row"&&(this._emitRowEvents=!0)}.bind(this))};hl.inherits(He,fo);
...
se conflicts and silent errors executing queries"));var n=(this.values||[]).map(kn.prepareValue);if(r.
...
this.values)){let s=new Error("Query values must be an array");return t(s)}var i=this.values.map(kn.
prepareValue);r.native.query(this.text,i,t)}else r.native.query(this.text,t)}});var go=I((bp,wo)=>{"use strict";p();var dl=(co(),O(uo)),yl=_t(),gp=lo(),yo=me().EventEmitter,ml=(ot(),O(st)),
...
r,e,t)};J.prototype.getTypeParser=function(r,e){return this._types.getTypeParser(r,e)}});var Mn=I((Sp,bo)=>{"use strict";p();bo.exports=go()});var ut=I((Ap,ct)=>{"use strict";p();var gl=no(),bl=nt(),vl=_n(),xl=ao(),{DatabaseError:Sl}=En(),El=a(
r=>{var e;return e=class extends xl{constructor(n){super(n,r)}},a(e,"BoundPool"),e},"poolFactory"),Un=a(
function(r){this.defaults=bl,this.Client=r,this.Query=this.Client.Query,this.Pool=El(this.Client),this.
_pools=[],this.Connection=vl,this.types=et(),this.DatabaseError=Sl},"PG");typeof m.env.NODE_PG_FORCE_NATIVE<
"u"?ct.exports=new Un(Mn()):(ct.exports=new Un(gl),Object.defineProperty(ct.exports,"native",{configurable:!0,
enumerable:!1,get(){var r=null;try{r=new Un(Mn())}catch(e){if(e.code!=="MODULE_NOT_FOUND")throw e}return Object.
defineProperty(ct.exports,"native",{value:r}),r}}))});p();p();Ue();er();p();var ma=Object.defineProperty,wa=Object.defineProperties,ga=Object.getOwnPropertyDescriptors,Si=Object.
getOwnPropertySymbols,ba=Object.prototype.hasOwnProperty,va=Object.prototype.propertyIsEnumerable,Ei=a(
(r,e,t)=>e in r?ma(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t,"__defNormalProp"),
xa=a((r,e)=>{for(var t in e||(e={}))ba.call(e,t)&&Ei(r,t,e[t]);if(Si)for(var t of Si(e))va.call(e,t)&&
Ei(r,t,e[t]);return r},"__spreadValues"),Sa=a((r,e)=>wa(r,ga(e)),"__spreadProps"),Ea=1008e3,Ai=new Uint8Array(
new Uint16Array([258]).buffer)[0]===2,Aa=new TextDecoder,tr=new TextEncoder,wt=tr.encode("0123456789\
abcdef"),gt=tr.encode("0123456789ABCDEF"),Ca=tr.encode("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqr\
stuvwxyz0123456789+/");var Ci=Ca.slice();Ci[62]=45;Ci[63]=95;var Ge,bt;function _a(r,{alphabet:e,scratchArr:t}={}){if(!Ge)if(Ge=
new Uint16Array(256),bt=new Uint16Array(256),Ai)for(let C=0;C<256;C++)Ge[C]=wt[C&15]<<8|wt[C>>>4],bt[C]=
gt[C&15]<<8|gt[C>>>4];else for(let C=0;C<256;C++)Ge[C]=wt[C&15]|wt[C>>>4]<<8,bt[C]=gt[C&15]|gt[C>>>4]<<
8;r.byteOffset%4!==0&&(r=new Uint8Array(r));let n=r.length,i=n>>>1,s=n>>>2,o=t||new Uint16Array(n),u=new Uint32Array(
r.buffer,r.byteOffset,s),c=new Uint32Array(o.buffer,o.byteOffset,i),l=e==="upper"?bt:Ge,f=0,y=0,w;if(Ai)
...
{},e),{scratchArr:o}))}return t}a(Ia,"_toHexChunked");function _i(r,e={}){return e.alphabet!=="upper"&&
typeof r.toHex=="function"?r.toHex():Ia(r,e)}a(_i,"toHex");p();var vt=class vt{constructor(e,t){this.strings=e;this.values=t}toParameterizedQuery(e={query:"",params:[]}){
let{strings:t,values:n}=this;for(let i=0,s=t.length;i<s;i++)if(e.query+=t[i],i<n.length){let o=n[i];
if(o instanceof ze)e.query+=o.sql;else if(o instanceof Ie)if(o.queryData instanceof vt)o.queryData.toParameterizedQuery(
...
(e.query+="::bytea")}}return e}};a(vt,"SqlTemplate");var Ve=vt,rr=class rr{constructor(e){this.sql=e}};
a(rr,"UnsafeRawSql");var ze=rr;p();function xt(){typeof window<"u"&&typeof document<"u"&&typeof console<"u"&&typeof console.warn=="func\
tion"&&console.warn(`          
        ************************************************************
        *                                                          *
        ...
        *  parameter.                                              *
        *                                                          *
        ************************************************************`)}a(xt,"warnIfBrowser");Ue();var ls=Ae(_t()),fs=Ae(it());var Tt=class Tt extends Error{constructor(t){super(t);A(this,"name","NeonDbError");A(this,"severity");
...
Tt,"NeonDbError");var we=Tt,as="transaction() expects an array of queries, or a function returning a\
...
return r instanceof d?"\\x"+_i(r):r}a(Mu,"encodeBuffersAsBytea");function us(r){let{query:e,params:t}=r instanceof
Ve?r.toParameterizedQuery():r;return{query:e,params:t.map(n=>Mu((0,fs.prepareValue)(n)))}}a(us,"prep\
areQuery");function hs(r,{arrayMode:e,fullResults:t,fetchOptions:n,isolationLevel:i,readOnly:s,deferrable:o,
...
f!=="postgresql:"||!y||!w||!C)throw new Error("Database connection string format for `neon()` should\
 be: postgresql://user:password@host.tld/dbname?option=value");let ie=!1;W&&!w.startsWith(W)&&(r=Du(
r,N,W),console.table({endpoint:W,connectionString:r}),ie=!0);function T(P,...F){if(!(Array.isArray(P)&&
...
ons).');return new Ie(E,new Ve(P,F))}a(T,"templateFn"),T.query=(P,F,B)=>new Ie(E,{query:P,params:F??
[]},B),T.unsafe=P=>new ze(P),T.transaction=async(P,F)=>{if(typeof P=="function"&&(P=P(T)),!Array.isArray(
P))throw new Error(as);P.forEach(G=>{if(!(G instanceof Ie))throw new Error(as)});let B=P.map(G=>G.queryData),
X=P.map(G=>G.opts??{});return E(B,X,F)};async function E(P,F,B){let{fetchEndpoint:X,fetchFunction:G}=ue,
he=Array.isArray(P)?{queries:P.map(ee=>us(ee))}:us(P),R=n??{},H=e??!1,ce=t??!1,pe=i,ve=s,xe=o;B!==void 0&&
(B.fetchOptions!==void 0&&(R={...R,...B.fetchOptions}),B.arrayMode!==void 0&&(H=B.arrayMode),B.fullResults!==
void 0&&(ce=B.fullResults),B.isolationLevel!==void 0&&(pe=B.isolationLevel),B.readOnly!==void 0&&(ve=
B.readOnly),B.deferrable!==void 0&&(xe=B.deferrable)),F!==void 0&&!Array.isArray(F)&&F.fetchOptions!==
void 0&&(R={...R,...F.fetchOptions});let Se=u;!Array.isArray(F)&&F?.authToken!==void 0&&(Se=F.authToken);
let Qt=typeof X=="function"?X(w,S,{jwtAuth:Se!==void 0,override:ie}):X,Ee={"Neon-Connection-String":r,
"Neon-Raw-Text-Output":"true","Neon-Array-Mode":"true"},de=await Uu(Se);de&&(Ee.Authorization=`Beare\
r ${de}`),Array.isArray(P)&&(pe!==void 0&&(Ee["Neon-Batch-Isolation-Level"]=pe),ve!==void 0&&(Ee["Ne\
on-Batch-Read-Only"]=String(ve)),xe!==void 0&&(Ee["Neon-Batch-Deferrable"]=String(xe))),c||ue.disableWarningInBrowsers||
xt();let V;try{V=await(G??fetch)(Qt,{method:"POST",body:JSON.stringify(he),headers:Ee,...R})}catch(ee){
let z=new we(`Error connecting to database: ${ee}`);throw z.sourceError=ee,z}if(V.ok){let ee=await V.
json();if(Array.isArray(P)){let z=ee.results;if(!Array.isArray(z))throw new we("Neon internal error:\
 unexpected result format");return z.map((Te,Pe)=>{let Nt=F[Pe]??{},Eo=Nt.arrayMode??H,Ao=Nt.fullResults??
ce;return cs(Te,{arrayMode:Eo,fullResults:Ao,types:Nt.types})})}else{let z=F??{},Te=z.arrayMode??H,Pe=z.
fullResults??ce;return cs(ee,{arrayMode:Te,fullResults:Pe,types:z.types})}}else{let{status:ee}=V;if(ee===
400){let z=await V.json(),Te=new we(z.message);for(let Pe of ku)Te[Pe]=z[Pe]??void 0;throw Te}else{let z=await V.
text();throw new we(`Server error (HTTP status ${ee}): ${z}`)}}}return a(E,"execute"),T}a(hs,"neon");
var wr=class wr{constructor(e,t,n){this.execute=e;this.queryData=t;this.opts=n}then(e,t){return this.
execute(this.queryData,this.opts).then(e,t)}catch(e){return this.execute(this.queryData,this.opts).catch(
e)}finally(e){return this.execute(this.queryData,this.opts).finally(e)}};a(wr,"NeonQueryPromise");var Ie=wr;
function cs(r,{arrayMode:e,fullResults:t,types:n}){let i=new ls.default(n),s=r.fields.map(c=>c.name),
...
!0,r.rowAsArray=e,r.rows=u,r._parsers=o,r._types=i,r):u}a(cs,"processQueryResult");async function Uu(r){
...
"rewriteConnectionString");p();var xo=Ae(ut());p();var vo=Ae(ut());var Dn=class Dn extends vo.Client{constructor(t){super(t);this.config=t}get neonConfig(){return this.
...
"SASL: protocol error");let u=Object.fromEntries(o.split(",").map(de=>{if(!/^.=/.test(de))throw new Error(
"SASL: Invalid attribute pair entry");let V=de[0],ee=de.substring(2);return[V,ee]})),c=u.r,l=u.s,f=u.
...
[w,d.from([0,0,0,1])]))),ie=W;for(var T=0;T<y-1;T++)W=new Uint8Array(await n.sign("HMAC",N,W)),ie=d.
from(ie.map((de,V)=>ie[V]^W[V]));let E=ie,P=await n.importKey("raw",E,{name:"HMAC",hash:{name:"SHA-2\
56"}},!1,["sign"]),F=new Uint8Array(await n.sign("HMAC",P,S.encode("Client Key"))),B=await n.digest(
"SHA-256",F),X="n=*,r="+i.clientNonce,G="r="+c+",s="+l+",i="+y,he="c=biws,r="+c,R=X+","+G+","+he,H=await n.
importKey("raw",B,{name:"HMAC",hash:{name:"SHA-256"}},!1,["sign"]);var ce=new Uint8Array(await n.sign(
"HMAC",H,S.encode(R))),pe=d.from(F.map((de,V)=>F[V]^ce[V])),ve=pe.toString("base64");let xe=await n.
importKey("raw",E,{name:"HMAC",hash:{name:"SHA-256"}},!1,["sign"]),Se=await n.sign("HMAC",xe,S.encode(
"Server Key")),Qt=await n.importKey("raw",Se,{name:"HMAC",hash:{name:"SHA-256"}},!1,["sign"]);var Ee=d.
from(await n.sign("HMAC",Qt,S.encode(R)));i.message="SASLResponse",i.serverSignature=Ee.toString("ba\
se64"),i.response=he+",p="+ve,this.connection.sendSCRAMClientFinalMessage(this.saslSession.response)}};
a(Dn,"NeonClient");var lt=Dn;Ue();var So=Ae(Lt());function Al(r,e){if(e)return{callback:e,result:void 0};let t,n,i=a(function(o,u){o?t(o):n(u)},"cb"),
s=new r(function(o,u){n=o,t=u});return{callback:i,result:s}}a(Al,"promisify");var qn=class qn extends xo.Pool{constructor(){
super(...arguments);A(this,"Client",lt);A(this,"hasFetchUnsupportedListeners",!1);A(this,"addListene\
...
/${c(o.database)}`,f=typeof t=="string"?t:t.text,y=n??t.values??[];hs(l,{fullResults:!0,arrayMode:t.
rowMode==="array"}).query(f,y,{types:t.types??this.options?.types}).then(S=>i(void 0,S)).catch(S=>i(
S))}catch(o){i(o)}return s.result}};a(qn,"NeonPool");var On=qn;Ue();var ft=Ae(ut()),Op="mjs";var export_DatabaseError=ft.DatabaseError;var export_defaults=ft.defaults;var export_escapeIdentifier=ft.escapeIdentifier;
var export_escapeLiteral=ft.escapeLiteral;var export_types=ft.types;export{lt as Client,export_DatabaseError as DatabaseError,
we as NeonDbError,Ie as NeonQueryPromise,On as Pool,Ve as SqlTemplate,ze as UnsafeRawSql,Op as _bundleExt,
export_defaults as defaults,export_escapeIdentifier as escapeIdentifier,export_escapeLiteral as escapeLiteral,
hs as neon,ue as neonConfig,export_types as types,xt as warnIfBrowser};
