...
_idle.findIndex(l=>l.client===t)!==-1&&this._acquireClient(t,new Oe((l,f,d)=>d()),n,!1)},this.options.
...
length}};a(En,"Pool");var vn=En;Zs.exports=vn});var Xs={};ne(Xs,{default:()=>el});var el,eo=K(()=>{"use strict";p();el={}});var to=T((Kh,tl)=>{tl.exports={name:"pg",version:"8.8.0",description:"PostgreSQL client - pure javas\
...
(P,L,C)=>Xi(N,new et([P],L),C),_.unsafe=P=>new et([P],[]),_.transaction=async(P,L)=>{if(typeof P=="f\
unction"&&(P=P(_)),!Array.isArray(P))throw new Error(Ji);P.forEach(H=>{if(H[Symbol.toStringTag]!=="N\
eonQueryPromise")throw new Error(Ji)});let C=P.map(H=>H.parameterizedQuery),S=P.map(H=>H.opts??{});return N(
