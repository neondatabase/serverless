...
call(r,i)&&i!==t&&Ie(r,i,{get:()=>e[i],enumerable:!(n=Ao(e,i))||n.enumerable});return r};var Se=(r,e,t)=>(t=r!=null?Eo(_o(r)):{},On(e||!r||!r.__esModule?Ie(t,"default",{value:r,enumerable:!0}):
t,r)),O=r=>On(Ie({},"__esModule",{value:!0}),r);var E=(r,e,t)=>To(r,typeof e!="symbol"?e+"":e,t);var Nn=T(ft=>{"use strict";p();ft.byteLength=Ro;ft.toByteArray=Lo;ft.fromByteArray=Mo;var ae=[],te=[],
...
function Ro(r){var e=Qn(r),t=e[0],n=e[1];return(t+n)*3/4-n}a(Ro,"byteLength");function Bo(r,e,t){return(e+
t)*3/4-t}a(Bo,"_byteLength");function Lo(r){var e,t=Qn(r),n=t[0],i=t[1],s=new Po(Bo(r,n,i)),o=0,u=i>
...
i.push(ae[e>>10]+ae[e>>4&63]+ae[e<<2&63]+"=")),i.join("")}a(Mo,"fromByteArray")});var Wn=T(Nt=>{p();Nt.read=function(r,e,t,n,i){var s,o,u=i*8-n-1,c=(1<<u)-1,l=c>>1,f=-7,y=t?i-1:0,g=t?
...
C,u/=256,i-=8);for(o=o<<i|u,l+=i;l>0;r[t+A]=o&255,A+=C,o/=256,l-=8);r[t+A-C]|=D*128}});var si=T(Be=>{"use strict";p();var Wt=Nn(),Pe=Wn(),jn=typeof Symbol=="function"&&typeof Symbol.for==
...
for option "size"')}a(Kn,"assertSize");function Do(r,e,t){return Kn(r),r<=0?he(r):e!==void 0?typeof t==
"string"?he(r).fill(e,t):he(r).fill(e):he(r)}a(Do,"alloc");h.alloc=function(r,e,t){return Do(r,e,t)};
function $t(r){return Kn(r),he(r<0?0:Vt(r)|0)}a($t,"allocUnsafe");h.allocUnsafe=function(r){return $t(
...
if(i)return n?-1:Gt(r).length;e=(""+e).toLowerCase(),i=!0}}a(zn,"byteLength");h.byteLength=zn;function Wo(r,e,t){
...
tf8":case"utf-8":return Zn(this,e,t);case"ascii":return Yo(this,e,t);case"latin1":case"binary":return Zo(
...
"asciiWrite");function $o(r,e,t,n){return pt(ii(e),r,t,n)}a($o,"base64Write");function Vo(r,e,t,n){return pt(
...
a(Ko,"base64Slice");function Zn(r,e,t){t=Math.min(r.length,t);let n=[],i=e;for(;i<t;){let s=r[i],o=null,
...
n.push(o),i+=u}return zo(n)}a(Zn,"utf8Slice");var Gn=4096;function zo(r){let e=r.length;if(e<=Gn)return String.
fromCharCode.apply(String,r);let t="",n=0;for(;n<e;)t+=String.fromCharCode.apply(String,r.slice(n,n+=
Gn));return t}a(zo,"decodeCodePointsArray");function Yo(r,e,t){let n="";t=Math.min(r.length,t);for(let i=e;i<
...
writeBigUInt64LE=we(a(function(e,t=0){return Jn(this,e,t,BigInt(0),BigInt("0xffffffffffffffff"))},"w\
riteBigUInt64LE"));h.prototype.writeBigUInt64BE=we(a(function(e,t=0){return Xn(this,e,t,BigInt(0),BigInt(
...
t+4},"writeInt32BE");h.prototype.writeBigInt64LE=we(a(function(e,t=0){return Jn(this,e,t,-BigInt("0x\
...
_${r.slice(t-3,t)}${e}`;return`${r.slice(0,t)}${e}`}a($n,"addNumericalSeparator");function ea(r,e,t){
Re(e,"offset"),(r[e]===void 0||r[e+t]===void 0)&&je(e,r.length-(t+1))}a(ea,"checkBounds");function ni(r,e,t,n,i,s){
...
nd <= ${t}${o}`,new Te.ERR_OUT_OF_RANGE("value",u,r)}ea(n,i,s)}a(ni,"checkIntBI");function Re(r,e){if(typeof r!=
...
ra(r))}a(ii,"base64ToBytes");function pt(r,e,t,n){let i;for(i=0;i<n&&!(i+t>=e.length||i>=r.length);++i)
...
m.nextTick(()=>{})}catch{let e=Promise.resolve();m.nextTick=e.then.bind(e)}});var ge=T((Ll,Yt)=>{"use strict";p();var Le=typeof Reflect=="object"?Reflect:null,oi=Le&&typeof Le.apply==
...
r,u.type=e,u.count=o.length,aa(u)}return r}a(li,"_addListener");R.prototype.addListener=a(function(e,t){
...
la(i):di(i,i.length)}a(hi,"_listeners");R.prototype.listeners=a(function(e){return hi(this,e,!0)},"l\
...
n=0;n<e;++n)t[n]=r[n];return t}a(di,"arrayClone");function ca(r,e){for(;e+1<r.length;e++)r[e]=r[e+1];
...
ust be of type EventEmitter. Received type '+typeof r)}a(yi,"eventTargetAgnosticAddListener")});var gi={};ie(gi,{Socket:()=>ce,isIP:()=>pa});function pa(r){return 0}var wi,mi,S,ce,Fe=$(()=>{"use s\
trict";p();wi=Se(ge(),1);a(pa,"isIP");mi=/^[^.]+\./,S=class S extends wi.EventEmitter{constructor(){
...
disableWarningInBrowsers:!1}),E(S,"opts",{});ce=S});var bi={};ie(bi,{parse:()=>Zt});function Zt(r,e=!1){let{protocol:t}=new URL(r),n="http:"+r.substring(
...
pathname:l,search:f,query:C,hash:g}}var Jt=$(()=>{"use strict";p();a(Zt,"parse")});var rr=T(Ci=>{"use strict";p();Ci.parse=function(r,e){return new tr(r,e).parse()};var xt=class xt{constructor(e,t){
...
ntity")});var nr=T((ef,_i)=>{p();var Ia=rr();_i.exports={create:a(function(r,e){return{parse:a(function(){return Ia.
parse(r,e)},"parse")}},"create")}});var Pi=T((nf,Ti)=>{"use strict";p();var Ta=/(\d{1,})-(\d{2})-(\d{2}) (\d{2}):(\d{2}):(\d{2})(\.\d{1,})?.*?( BC)?$/,
Pa=/^(\d{1,})-(\d{2})-(\d{2})( BC)?$/,Ra=/([Z+-])(\d{2})?:?(\d{2})?:?(\d{2})?/,Ba=/^-?infinity$/;Ti.
...
e[3]||0,10)*60+parseInt(e[4]||0,10);return i*n*1e3}}a(Fa,"timeZoneOffset");function Ii(r){return-(r-
1)}a(Ii,"bcYearToNegativeYear");function ir(r){return r>=0&&r<100}a(ir,"is0To99")});var Bi=T((af,Ri)=>{p();Ri.exports=Ma;var ka=Object.prototype.hasOwnProperty;function Ma(r){for(var e=1;e<
arguments.length;e++){var t=arguments[e];for(var n in t)ka.call(t,n)&&(r[n]=t[n])}return r}a(Ma,"ext\
end")});var ki=T((lf,Fi)=>{"use strict";p();var Ua=Bi();Fi.exports=ke;function ke(r){if(!(this instanceof ke))
...
keys(Li).reduce(function(n,i){var s=Li[i],o=e[s];return!o||(o=i==="milliseconds"?Va(o):parseInt(o,10),
!o)||(t&&~$a.indexOf(i)&&(o*=-1),n[i]=o),n},{})}a(Ka,"parse")});var Ui=T((pf,Mi)=>{"use strict";p();Mi.exports=a(function(e){if(/^\\x/.test(e))return new d(e.substr(
...
parseBytea")});var ji=T((mf,Wi)=>{p();var Ke=rr(),ze=nr(),St=Pi(),Oi=ki(),qi=Ui();function Et(r){return a(function(t){
...
Ke.parse(r,Qi):null}a(za,"parseBoolArray");function Ya(r){return parseInt(r,10)}a(Ya,"parseBaseTenIn\
t");function or(r){return r?Ke.parse(r,Et(Ya)):null}a(or,"parseIntegerArray");function Za(r){return r?
Ke.parse(r,Et(function(e){return Ni(e).trim()})):null}a(Za,"parseBigIntegerArray");var Ja=a(function(r){
...
parseBigInteger"),Di=a(function(r){return r?Ke.parse(r,Et(JSON.parse)):null},"parseJsonArray"),lr=a(
...
r[i])}var s=lr(e);return s.radius=parseFloat(t),s},"parseCircle"),ru=a(function(r){r(20,Ni),r(21,cr),
r(23,cr),r(26,cr),r(700,parseFloat),r(701,parseFloat),r(16,Qi),r(1082,St),r(1114,St),r(1184,St),r(600,
...
1115,ur),r(1182,ur),r(1185,ur),r(1186,Oi),r(1187,Xa),r(17,qi),r(114,JSON.parse.bind(JSON)),r(3802,JSON.
parse.bind(JSON)),r(199,Di),r(3807,Di),r(3907,re),r(2951,re),r(791,re),r(1183,re),r(1270,re)},"init");
Wi.exports={init:ru}});var Gi=T((bf,Hi)=>{"use strict";p();var K=1e6;function nu(r){var e=r.readInt32BE(0),t=r.readUInt32BE(
...
""+o%K,n+u+i}a(nu,"readInt8");Hi.exports=nu});var Yi=T((Sf,zi)=>{p();var iu=Gi(),L=a(function(r,e,t,n,i){t=t||0,n=n||!1,i=i||function(A,C,D){return A*
...
r,31,1,!0)+1):L(r,31,1)},"parseInt32"),ou=a(function(r){return Ki(r,23,8)},"parseFloat32"),au=a(function(r){
return Ki(r,52,11)},"parseFloat64"),uu=a(function(r){var e=L(r,16,32);if(e==49152)return NaN;for(var t=Math.
...
null:L(r,8)>0},"parseBool"),fu=a(function(r){r(20,iu),r(21,su),r(23,$i),r(26,$i),r(1700,uu),r(700,ou),
r(701,au),r(16,lu),r(1114,Vi.bind(null,!1)),r(1184,Vi.bind(null,!0)),r(1e3,Ye),r(1007,Ye),r(1016,Ye),
r(1008,Ye),r(1009,Ye),r(25,cu)},"init");zi.exports={init:fu}});var Ji=T((Cf,Zi)=>{p();Zi.exports={BOOL:16,BYTEA:17,CHAR:18,INT8:20,INT2:21,INT4:23,REGPROC:24,TEXT:25,
...
REGROLE:4096}});var Xe=T(Je=>{p();var hu=ji(),pu=Yi(),du=nr(),yu=Ji();Je.getTypeParser=mu;Je.setTypeParser=wu;Je.arrayParser=
du;Je.builtins=yu;var Ze={text:{},binary:{}};function Xi(r){return String(r)}a(Xi,"noParse");function mu(r,e){
return e=e||"text",Ze[e]&&Ze[e][r]||Xi}a(mu,"getTypeParser");function wu(r,e,t){typeof e=="function"&&
(t=e,e="text"),Ze[e][r]=t}a(wu,"setTypeParser");hu.init(function(r,e){Ze.text[r]=e});pu.init(function(r,e){
Ze.binary[r]=e})});var Ct=T((Rf,es)=>{"use strict";p();var gu=Xe();function At(r){this._types=r||gu,this.text={},this.binary=
...
e||"text",this.getOverrides(e)[r]||this._types.getTypeParser(r,e)};es.exports=At});function et(r){let e=1779033703,t=3144134277,n=1013904242,i=2773480762,s=1359893119,o=2600822924,u=528734635,
...
(Y(r),P())}var ts=$(()=>{"use strict";p();a(et,"sha256")});var U,tt,rs=$(()=>{"use strict";p();U=class U{constructor(){E(this,"_dataLength",0);E(this,"_bufferL\
...
"digest")}},"update")}}var hr=$(()=>{"use strict";p();ts();rs();a(bu,"randomBytes");a(vu,"createHash");
a(xu,"createHmac")});var rt=T((jf,pr)=>{"use strict";p();pr.exports={host:"localhost",user:m.platform==="win32"?m.env.USERNAME:
...
23,"text"):Su),Me.setTypeParser(1016,"text",r?Me.getTypeParser(1007,"text"):Eu)})});var nt=T((Gf,is)=>{"use strict";p();var Au=(hr(),O(fr)),Cu=rt();function _u(r){var e=r.replace(/\\/g,
...
r[t]instanceof d?e+="\\\\x"+r[t].toString("hex"):e+=_u(_t(r[t]));return e=e+"}",e}a(ns,"arrayString");
...
normalizeQueryConfig:Ru,postgresMd5PasswordHash:Bu,md5:dr}});var it={};ie(it,{default:()=>Mu});var Mu,st=$(()=>{"use strict";p();Mu={}});var ys=T((sh,ds)=>{"use strict";p();var mr=(hr(),O(fr));function Uu(r){if(r.indexOf("SCRAM-SHA-256")===
...
","+l+","+f,g=Ue(u,y),A=ps(o,g),C=A.toString("base64"),D=Ue(s,"Server Key"),Y=Ue(D,y);r.message="SAS\
...
a(ps,"xorBuffers");function Wu(r){return mr.createHash("sha256").update(r).digest()}a(Wu,"sha256");function Ue(r,e){
return mr.createHmac("sha256",r).update(e).digest()}a(Ue,"hmacSha256");function ju(r,e,t){for(var n=Ue(
r,d.concat([e,d.from([0,0,0,1])])),i=n,s=0;s<t-1;s++)n=Ue(r,n),i=ps(i,n);return i}a(ju,"Hi");ds.exports=
{startSession:Uu,continueSession:Du,finalizeSession:Ou}});var wr={};ie(wr,{join:()=>Hu});function Hu(...r){return r.join("/")}var gr=$(()=>{"use strict";p();a(
Hu,"join")});var br={};ie(br,{stat:()=>Gu});function Gu(r,e){e(new Error("No filesystem"))}var vr=$(()=>{"use str\
ict";p();a(Gu,"stat")});var xr={};ie(xr,{default:()=>$u});var $u,Sr=$(()=>{"use strict";p();$u={}});var ms={};ie(ms,{StringDecoder:()=>Er});var Ar,Er,ws=$(()=>{"use strict";p();Ar=class Ar{constructor(e){
E(this,"td");this.td=new TextDecoder(e)}write(e){return this.td.decode(e,{stream:!0})}end(e){return this.
td.decode(e)}};a(Ar,"StringDecoder");Er=Ar});var xs=T((yh,vs)=>{"use strict";p();var{Transform:Vu}=(Sr(),O(xr)),{StringDecoder:Ku}=(ws(),O(ms)),ve=Symbol(
"last"),Tt=Symbol("decoder");function zu(r,e,t){let n;if(this.overflow){if(n=this[Tt].write(r).split(
this.matcher),n.length===1)return t();n.shift(),this.overflow=!1}else this[ve]+=this[Tt].write(r),n=
this[ve].split(this.matcher);this[ve]=n.pop();for(let i=0;i<n.length;i++)try{bs(this,this.mapper(n[i]))}catch(s){
return t(s)}if(this.overflow=this[ve].length>this.maxLength,this.overflow&&!this.skipOverflow){t(new Error(
"maximum buffer reached"));return}t()}a(zu,"transform");function Yu(r){if(this[ve]+=this[Tt].end(),this[ve])
try{bs(this,this.mapper(this[ve]))}catch(e){return r(e)}r()}a(Yu,"flush");function bs(r,e){e!==void 0&&
...
!0;let n=new Vu(t);return n[ve]="",n[Tt]=new Ku("utf8"),n.matcher=r,n.mapper=e,n.maxLength=t.maxLength,
n.skipOverflow=t.skipOverflow||!1,n.overflow=!1,n._destroy=function(i,s){this._writableState.errorEmitted=
!1,s(i)},n}a(Zu,"split");vs.exports=Zu});var As=T((gh,pe)=>{"use strict";p();var Ss=(gr(),O(wr)),Ju=(Sr(),O(xr)).Stream,Xu=xs(),Es=(st(),O(it)),
...
`);ot.write(Es.format.apply(Es,e))}}a(_r,"warn");Object.defineProperty(pe.exports,"isWin",{get:a(function(){
return Pt},"get"),set:a(function(r){Pt=r},"set")});pe.exports.warnTo=function(r){var e=ot;return ot=
r,e};pe.exports.getFileName=function(r){var e=r||m.env,t=e.PGPASSFILE||(Pt?Ss.join(e.APPDATA||"./","\
postgresql","pgpass.conf"):Ss.join(e.HOME||"./",".pgpass"));return t};pe.exports.usePgPass=function(r,e){
...
0}},t=0;t<De.length;t+=1){var n=e[t],i=r[De[t]]||"",s=n(i);if(!s)return!1}return!0}});var _s=T((Sh,Ir)=>{"use strict";p();var xh=(gr(),O(wr)),Cs=(vr(),O(br)),Rt=As();Ir.exports=function(r,e){
var t=Rt.getFileName();Cs.stat(t,function(n,i){if(n||!Rt.usePgPass(i,t))return e(void 0);var s=Cs.createReadStream(
t);Rt.getPassword(r,s,e)})};Ir.exports.warnTo=Rt.warnTo});var Is={};ie(Is,{default:()=>lc});var lc,Ts=$(()=>{"use strict";p();lc={}});var Rs=T((Ch,Ps)=>{"use strict";p();var fc=(Jt(),O(bi)),Tr=(vr(),O(br));function Pr(r){if(r.charAt(0)===
...
!1;break}}return t}a(Pr,"parse");Ps.exports=Pr;Pr.parse=Pr});var Bt=T((Th,Fs)=>{"use strict";p();var hc=(Ts(),O(Is)),Ls=rt(),Bs=Rs().parse,H=a(function(r,e,t){return t===
...
a(Br,"ConnectionParameters");var Rr=Br;Fs.exports=Rr});var Us=T((Bh,Ms)=>{"use strict";p();var dc=Xe(),ks=/^([A-Za-z]+)(?: (\d+))?(?: (\d+))?/,Fr=class Fr{constructor(e,t){
...
format||"text")}}};a(Fr,"Result");var Lr=Fr;Ms.exports=Lr});var Qs=T((kh,qs)=>{"use strict";p();var{EventEmitter:yc}=ge(),Ds=Us(),Os=nt(),Mr=class Mr extends yc{constructor(e,t,n){
...
e.sendCopyFail("No source stream defined")}handleCopyData(e,t){}};a(Mr,"Query");var kr=Mr;qs.exports=
...
e,this.chunk=t,this.name="copyData"}};a(Zr,"CopyDataMessage");var Dr=Zr;_.CopyDataMessage=Dr;var Jr=class Jr{constructor(e,t,n,i){
this.length=e,this.name=t,this.binary=n,this.columnTypes=new Array(i)}};a(Jr,"CopyResponse");var Or=Jr;
_.CopyResponse=Or;var Xr=class Xr{constructor(e,t,n,i,s,o,u){this.name=e,this.tableID=t,this.columnID=
...
ge");var Gr=on;_.NotificationResponseMessage=Gr;var an=class an{constructor(e,t){this.length=e,this.
status=t,this.name="readyForQuery"}};a(an,"ReadyForQueryMessage");var $r=an;_.ReadyForQueryMessage=$r;
...
e,this.fields=t,this.name="dataRow",this.fieldCount=t.length}};a(cn,"DataRowMessage");var Kr=cn;_.DataRowMessage=
Kr;var ln=class ln{constructor(e,t){this.length=e,this.message=t,this.name="notice"}};a(ln,"NoticeMe\
ssage");var zr=ln;_.NoticeMessage=zr});var Ns=T(Lt=>{"use strict";p();Object.defineProperty(Lt,"__esModule",{value:!0});Lt.Writer=void 0;var pn=class pn{constructor(e=256){
...
headerPosition=0,this.buffer=d.allocUnsafe(this.size),t}};a(pn,"Writer");var hn=pn;Lt.Writer=hn});var js=T(kt=>{"use strict";p();Object.defineProperty(kt,"__esModule",{value:!0});kt.serialize=void 0;
var dn=Ns(),F=new dn.Writer,mc=a(r=>{F.addInt16(3).addInt16(0);for(let n of Object.keys(r))F.addCString(
n).addCString(r[n]);F.addCString("client_encoding").addCString("UTF8");let e=F.addCString("").flush(),
t=e.length+4;return new dn.Writer().addInt32(t).add(e).flush()},"startup"),wc=a(()=>{let r=d.allocUnsafe(
...
n;s++)i.addInt32(t[s]);return F.flush(80)},"parse"),qe=new dn.Writer,Ec=a(function(r,e){for(let t=0;t<
...
6),t.writeInt32BE(r,8),t.writeInt32BE(e,12),t},"cancel"),yn=a((r,e)=>{let n=4+d.byteLength(e)+1,i=d.
allocUnsafe(1+n);return i[0]=r,i.writeInt32BE(n,1),i.write(e,5,"utf-8"),i[n]=0,i},"cstringMessage"),
Tc=F.addCString("P").flush(68),Pc=F.addCString("S").flush(68),Rc=a(r=>r.name?yn(68,`${r.type}${r.name||
""}`):r.type==="P"?Tc:Pc,"describe"),Bc=a(r=>{let e=`${r.type}${r.name||""}`;return yn(67,e)},"close"),
Lc=a(r=>F.add(r).flush(100),"copyData"),Fc=a(r=>yn(102,r),"copyFail"),Ft=a(r=>d.from([r,0,0,0,4]),"c\
...
offset+=e,t}};a(wn,"BufferReader");var mn=wn;Mt.BufferReader=mn});var Vs=T(Ut=>{"use strict";p();Object.defineProperty(Ut,"__esModule",{value:!0});Ut.Parser=void 0;var k=fn(),
Qc=Hs(),gn=1,Nc=4,Gs=gn+Nc,$s=d.allocUnsafe(0),vn=class vn{constructor(e){if(this.buffer=$s,this.bufferLength=
...
i+gn),u=gn+o;if(u+i<=n){let c=this.handlePacket(i+Gs,s,o,this.buffer);t(c),i+=u}else break}i===n?(this.
...
a(vn,"Parser");var bn=vn;Ut.Parser=bn});var xn=T(xe=>{"use strict";p();Object.defineProperty(xe,"__esModule",{value:!0});xe.DatabaseError=xe.
serialize=xe.parse=void 0;var Wc=fn();Object.defineProperty(xe,"DatabaseError",{enumerable:!0,get:a(
...
on("data",n=>t.parse(n,e)),new Promise(n=>r.on("end",()=>n()))}a(Gc,"parse");xe.parse=Gc});var Ks={};ie(Ks,{connect:()=>$c});function $c({socket:r,servername:e}){return r.startTls(e),r}var zs=$(
()=>{"use strict";p();a($c,"connect")});var An=T((np,Js)=>{"use strict";p();var Ys=(Fe(),O(gi)),Vc=ge().EventEmitter,{parse:Kc,serialize:Q}=xn(),
Zs=Q.flush(),zc=Q.sync(),Yc=Q.end(),En=class En extends Vc{constructor(e){super(),e=e||{},this.stream=
...
this._send(Q.copyDone())}sendCopyFail(e){this._send(Q.copyFail(e))}};a(En,"Connection");var Sn=En;Js.
exports=Sn});var to=T((ap,eo)=>{"use strict";p();var Zc=ge().EventEmitter,op=(st(),O(it)),Jc=nt(),Cn=ys(),Xc=_s(),
el=Ct(),tl=Bt(),Xs=Qs(),rl=rt(),nl=An(),_n=class _n extends Zc{constructor(e){super(),this.connectionParameters=
...
_Promise(t=>{this.connection.once("end",t)})}};a(_n,"Client");var Dt=_n;Dt.Query=Xs;eo.exports=Dt});var so=T((lp,io)=>{"use strict";p();var il=ge().EventEmitter,ro=a(function(){},"NOOP"),no=a((r,e)=>{
let t=r.findIndex(e);return t===-1?void 0:r.splice(t,1)[0]},"removeWhere"),Pn=class Pn{constructor(e,t,n){
this.client=e,this.idleListener=t,this.timeoutId=n}};a(Pn,"IdleItem");var In=Pn,Rn=class Rn{constructor(e){
this.callback=e}};a(Rn,"PendingItem");var Qe=Rn;function sl(){throw new Error("Release called on cli\
...
return this._clients.length}};a(Bn,"Pool");var Tn=Bn;io.exports=Tn});var oo={};ie(oo,{default:()=>al});var al,ao=$(()=>{"use strict";p();al={}});var uo=T((dp,ul)=>{ul.exports={name:"pg",version:"8.8.0",description:"PostgreSQL client - pure javas\
...
a178655"}});var fo=T((yp,lo)=>{"use strict";p();var co=ge().EventEmitter,cl=(st(),O(it)),Ln=nt(),Ne=lo.exports=function(r,e,t){
co.call(this),r=Ln.normalizeQueryConfig(r,e,t),this.text=r.text,this.values=r.values,this.name=r.name,
...
prepareValue);r.native.query(this.text,i,t)}else r.native.query(this.text,t)}});var mo=T((bp,yo)=>{"use strict";p();var fl=(ao(),O(oo)),hl=Ct(),gp=uo(),ho=ge().EventEmitter,pl=(st(),O(it)),
...
r,e,t)};z.prototype.getTypeParser=function(r,e){return this._types.getTypeParser(r,e)}});var Fn=T((Sp,wo)=>{"use strict";p();wo.exports=mo()});var at=T((Ap,ut)=>{"use strict";p();var yl=to(),ml=rt(),wl=An(),gl=so(),{DatabaseError:bl}=xn(),vl=a(
r=>{var e;return e=class extends gl{constructor(n){super(n,r)}},a(e,"BoundPool"),e},"poolFactory"),kn=a(
function(r){this.defaults=ml,this.Client=r,this.Query=this.Client.Query,this.Pool=vl(this.Client),this.
_pools=[],this.Connection=wl,this.types=Xe(),this.DatabaseError=bl},"PG");typeof m.env.NODE_PG_FORCE_NATIVE<
"u"?ut.exports=new kn(Fn()):(ut.exports=new kn(yl),Object.defineProperty(ut.exports,"native",{configurable:!0,
enumerable:!1,get(){var r=null;try{r=new kn(Fn())}catch(e){if(e.code!=="MODULE_NOT_FOUND")throw e}return Object.
defineProperty(ut.exports,"native",{value:r}),r}}))});p();p();Fe();Jt();p();var da=Object.defineProperty,ya=Object.defineProperties,ma=Object.getOwnPropertyDescriptors,vi=Object.
getOwnPropertySymbols,wa=Object.prototype.hasOwnProperty,ga=Object.prototype.propertyIsEnumerable,xi=a(
(r,e,t)=>e in r?da(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t,"__defNormalProp"),
ba=a((r,e)=>{for(var t in e||(e={}))wa.call(e,t)&&xi(r,t,e[t]);if(vi)for(var t of vi(e))ga.call(e,t)&&
xi(r,t,e[t]);return r},"__spreadValues"),va=a((r,e)=>ya(r,ma(e)),"__spreadProps"),xa=1008e3,Si=new Uint8Array(
new Uint16Array([258]).buffer)[0]===2,Sa=new TextDecoder,Xt=new TextEncoder,mt=Xt.encode("0123456789\
abcdef"),wt=Xt.encode("0123456789ABCDEF"),Ea=Xt.encode("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqr\
stuvwxyz0123456789+/");var Ei=Ea.slice();Ei[62]=45;Ei[63]=95;var He,gt;function Aa(r,{alphabet:e,scratchArr:t}={}){if(!He)if(He=
new Uint16Array(256),gt=new Uint16Array(256),Si)for(let C=0;C<256;C++)He[C]=mt[C&15]<<8|mt[C>>>4],gt[C]=
...
r.buffer,r.byteOffset,s),c=new Uint32Array(o.buffer,o.byteOffset,i),l=e==="upper"?gt:He,f=0,y=0,g;if(Si)
...
typeof r.toHex=="function"?r.toHex():Ca(r,e)}a(Ai,"toHex");p();var bt=class bt{constructor(e,t){this.strings=e;this.values=t}toParameterizedQuery(e={query:"",params:[]}){
...
tion"&&console.warn(`          
        ...
        *  parameter.                                              *
        *                                                          *
        ************************************************************`)}a(vt,"warnIfBrowser");p();var Ve="pkg:npm/%40neondatabase/serverless@1.0.2";Fe();var us=Se(Ct()),cs=Se(nt());var It=class It extends Error{constructor(t){super(t);E(this,"name","NeonDbError");E(this,"severity");
...
It,"NeonDbError");var be=It,ss="transaction() expects an array of queries, or a function returning a\
...
return r instanceof d?"\\x"+Ai(r):r}a(Fu,"encodeBuffersAsBytea");function os(r){let{query:e,params:t}=r instanceof
Ge?r.toParameterizedQuery():r;return{query:e,params:t.map(n=>Fu((0,cs.prepareValue)(n)))}}a(os,"prep\
...
Y,new Ge(P,I))}a(D,"templateFn"),D.query=(P,I,w)=>new Ce(Y,{query:P,params:I??[]},w),D.unsafe=P=>new $e(
P),D.transaction=async(P,I)=>{if(typeof P=="function"&&(P=P(D)),!Array.isArray(P))throw new Error(ss);
P.forEach(W=>{if(!(W instanceof Ce))throw new Error(ss)});let w=P.map(W=>W.queryData),Z=P.map(W=>W.opts??
{});return Y(w,Z,I)};async function Y(P,I,w){let{fetchEndpoint:Z,fetchFunction:W}=ce,J=Array.isArray(
P)?{queries:P.map(ee=>os(ee))}:os(P),X=n??{},se=e??!1,oe=t??!1,B=i,j=s,le=o;w!==void 0&&(w.fetchOptions!==
...
let M=new be(`Error connecting to database: ${ee}`);throw M.sourceError=ee,M}if(ye.ok){let ee=await ye.
json();if(Array.isArray(P)){let M=ee.results;if(!Array.isArray(M))throw new be("Neon internal error:\
 unexpected result format");return M.map((G,me)=>{let qt=I[me]??{},xo=qt.arrayMode??se,So=qt.fullResults??
oe;return as(G,{arrayMode:xo,fullResults:So,types:qt.types})})}else{let M=I??{},G=M.arrayMode??se,me=M.
fullResults??oe;return as(ee,{arrayMode:G,fullResults:me,types:M.types})}}else{let{status:ee}=ye;if(ee===
400){let M=await ye.json(),G=new be(M.message);for(let me of Lu)G[me]=M[me]??void 0;throw G}else{let M=await ye.
text();throw new be(`Server error (HTTP status ${ee}): ${M}`)}}}return a(Y,"execute"),D}a(ls,"neon");
...
function as(r,{arrayMode:e,fullResults:t,types:n}){let i=new us.default(n),s=r.fields.map(c=>c.name),
...
!0,r.rowAsArray=e,r.rows=u,r._parsers=o,r._types=i,r):u}a(as,"processQueryResult");async function ku(r){
if(typeof r=="string")return r;if(typeof r=="function")try{return await Promise.resolve(r())}catch(e){
let t=new be("Error getting auth token.");throw e instanceof Error&&(t=new be(`Error getting auth to\
ken: ${e.message}`)),t}}a(ku,"getAuthToken");p();var bo=Se(at());p();var go=Se(at());var Mn=class Mn extends go.Client{constructor(t){super(typeof t=="string"?{connectionString:t,fallback_application_name:Ve}:
...
importKey("raw",w,{name:"HMAC",hash:{name:"SHA-256"}},!1,["sign"]),_e=await n.sign("HMAC",fe,A.encode(
...
a(Mn,"NeonClient");var ct=Mn;Fe();var vo=Se(Bt());function xl(r,e){if(e)return{callback:e,result:void 0};let t,n,i=a(function(o,u){o?t(o):n(u)},"cb"),
s=new r(function(o,u){n=o,t=u});return{callback:i,result:s}}a(xl,"promisify");var Dn=class Dn extends bo.Pool{constructor(){
...
/${c(o.database)}`,f=typeof t=="string"?t:t.text,y=n??t.values??[];ls(l,{fullResults:!0,arrayMode:t.
rowMode==="array"}).query(f,y,{types:t.types??this.options?.types}).then(A=>i(void 0,A)).catch(A=>i(
A))}catch(o){i(o)}return s.result}};a(Dn,"NeonPool");var Un=Dn;Fe();var lt=Se(at()),qp="mjs";var export_DatabaseError=lt.DatabaseError;var export_defaults=lt.defaults;var export_escapeIdentifier=lt.escapeIdentifier;
var export_escapeLiteral=lt.escapeLiteral;var export_types=lt.types;export{ct as Client,export_DatabaseError as DatabaseError,
be as NeonDbError,Ce as NeonQueryPromise,Un as Pool,Ge as SqlTemplate,$e as UnsafeRawSql,qp as _bundleExt,
export_defaults as defaults,export_escapeIdentifier as escapeIdentifier,export_escapeLiteral as escapeLiteral,
ls as neon,ce as neonConfig,export_types as types,vt as warnIfBrowser};
