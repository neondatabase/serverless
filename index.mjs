...
var Eo=Object.create;var Ie=Object.defineProperty;var Ao=Object.getOwnPropertyDescriptor;var Co=Object.getOwnPropertyNames;var _o=Object.getPrototypeOf,Io=Object.prototype.hasOwnProperty;var To=(r,e,t)=>e in r?Ie(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t;var a=(r,e)=>Ie(r,"name",{value:e,configurable:!0});var G=(r,e)=>()=>(r&&(e=r(r=0)),e);var T=(r,e)=>()=>(e||r((e={exports:{}}).exports,e),e.exports),ie=(r,e)=>{for(var t in e)Ie(r,t,{get:e[t],
enumerable:!0})},On=(r,e,t,n)=>{if(e&&typeof e=="object"||typeof e=="function")for(let i of Co(e))!Io.
call(r,i)&&i!==t&&Ie(r,i,{get:()=>e[i],enumerable:!(n=Ao(e,i))||n.enumerable});return r};var xe=(r,e,t)=>(t=r!=null?Eo(_o(r)):{},On(e||!r||!r.__esModule?Ie(t,"default",{value:r,enumerable:!0}):
t,r)),O=r=>On(Ie({},"__esModule",{value:!0}),r);var A=(r,e,t)=>To(r,typeof e!="symbol"?e+"":e,t);var Qn=T(ft=>{"use strict";d();ft.byteLength=Lo;ft.toByteArray=Ro;ft.fromByteArray=Mo;var oe=[],te=[],
Po=typeof Uint8Array<"u"?Uint8Array:Array,qt="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz01\
23456789+/";for(Ee=0,Nn=qt.length;Ee<Nn;++Ee)oe[Ee]=qt[Ee],te[qt.charCodeAt(Ee)]=Ee;var Ee,Nn;te[45]=
...
function Lo(r){var e=qn(r),t=e[0],n=e[1];return(t+n)*3/4-n}a(Lo,"byteLength");function Bo(r,e,t){return(e+
t)*3/4-t}a(Bo,"_byteLength");function Ro(r){var e,t=qn(r),n=t[0],i=t[1],s=new Po(Bo(r,n,i)),o=0,u=i>
...
4|te[r.charCodeAt(c+2)]>>2,s[o++]=e>>8&255,s[o++]=e&255),s}a(Ro,"toByteArray");function ko(r){return oe[r>>
...
i.push(oe[e>>10]+oe[e>>4&63]+oe[e<<2&63]+"=")),i.join("")}a(Mo,"fromByteArray")});var Wn=T(Qt=>{d();Qt.read=function(r,e,t,n,i){var s,o,u=i*8-n-1,c=(1<<u)-1,l=c>>1,f=-7,p=t?i-1:0,g=t?
...
pow(2,n),s=s-l}return(E?-1:1)*o*Math.pow(2,s-n)};Qt.write=function(r,e,t,n,i,s){var o,u,c,l=s*8-i-1,
...
C,u/=256,i-=8);for(o=o<<i|u,l+=i;l>0;r[t+E]=o&255,E+=C,o/=256,l-=8);r[t+E-C]|=D*128}});var si=T(Be=>{"use strict";d();var Wt=Qn(),Pe=Wn(),jn=typeof Symbol=="function"&&typeof Symbol.for==
"function"?Symbol.for("nodejs.util.inspect.custom"):null;Be.Buffer=h;Be.SlowBuffer=Qo;Be.INSPECT_MAX_BYTES=
50;var ht=2147483647;Be.kMaxLength=ht;h.TYPED_ARRAY_SUPPORT=Uo();!h.TYPED_ARRAY_SUPPORT&&typeof console<
...
this))return this.byteOffset},"get")});function ce(r){if(r>ht)throw new RangeError('The value "'+r+'\
" is invalid for option "size"');let e=new Uint8Array(r);return Object.setPrototypeOf(e,h.prototype),
e}a(ce,"createBuffer");function h(r,e,t){if(typeof r=="number"){if(typeof e=="string")throw new TypeError(
'The "string" argument must be of type string. Received type number');return Gt(r)}return Vn(r,e,t)}
a(h,"Buffer");h.poolSize=8192;function Vn(r,e,t){if(typeof r=="string")return Oo(r,e);if(ArrayBuffer.
...
for option "size"')}a(zn,"assertSize");function Do(r,e,t){return zn(r),r<=0?ce(r):e!==void 0?typeof t==
"string"?ce(r).fill(e,t):ce(r).fill(e):ce(r)}a(Do,"alloc");h.alloc=function(r,e,t){return Do(r,e,t)};
function Gt(r){return zn(r),ce(r<0?0:Vt(r)|0)}a(Gt,"allocUnsafe");h.allocUnsafe=function(r){return Gt(
r)};h.allocUnsafeSlow=function(r){return Gt(r)};function Oo(r,e){if((typeof e!="string"||e==="")&&(e=
"utf8"),!h.isEncoding(e))throw new TypeError("Unknown encoding: "+e);let t=Kn(r,e)|0,n=ce(t),i=n.write(
r,e);return i!==t&&(n=n.slice(0,i)),n}a(Oo,"fromString");function jt(r){let e=r.length<0?0:Vt(r.length)|
0,t=ce(e);for(let n=0;n<e;n+=1)t[n]=r[n]&255;return t}a(jt,"fromArrayLike");function No(r){if(ae(r,Uint8Array)){
let e=new Uint8Array(r);return Ht(e.buffer,e.byteOffset,e.byteLength)}return jt(r)}a(No,"fromArrayVi\
...
let e=Vt(r.length)|0,t=ce(e);return t.length===0||r.copy(t,0,0,e),t}if(r.length!==void 0)return typeof r.
length!="number"||Kt(r.length)?ce(0):jt(r);if(r.type==="Buffer"&&Array.isArray(r.data))return jt(r.data)}
...
if(i)return n?-1:$t(r).length;e=(""+e).toLowerCase(),i=!0}}a(Kn,"byteLength");h.byteLength=Kn;function Wo(r,e,t){
...
tf8":case"utf-8":return Xn(this,e,t);case"ascii":return Yo(this,e,t);case"latin1":case"binary":return Xo(
...
"swap64");h.prototype.toString=a(function(){let e=this.length;return e===0?"":arguments.length===0?Xn(
...
h.prototype.lastIndexOf=a(function(e,t,n){return Yn(this,e,t,n,!1)},"lastIndexOf");function jo(r,e,t,n){
t=Number(t)||0;let i=r.length-t;n?(n=Number(n),n>i&&(n=i)):n=i;let s=e.length;n>s/2&&(n=s/2);let o;for(o=
0;o<n;++o){let u=parseInt(e.substr(o*2,2),16);if(Kt(u))return o;r[t+o]=u}return o}a(jo,"hexWrite");function Ho(r,e,t,n){
return dt($t(e,r.length-t),r,t,n)}a(Ho,"utf8Write");function $o(r,e,t,n){return dt(na(e),r,t,n)}a($o,
"asciiWrite");function Go(r,e,t,n){return dt(ii(e),r,t,n)}a(Go,"base64Write");function Vo(r,e,t,n){return dt(
...
N");function zo(r,e,t){return e===0&&t===r.length?Wt.fromByteArray(r):Wt.fromByteArray(r.slice(e,t))}
a(zo,"base64Slice");function Xn(r,e,t){t=Math.min(r.length,t);let n=[],i=e;for(;i<t;){let s=r[i],o=null,
...
n.push(o),i+=u}return Ko(n)}a(Xn,"utf8Slice");var $n=4096;function Ko(r){let e=r.length;if(e<=$n)return String.
fromCharCode.apply(String,r);let t="",n=0;for(;n<e;)t+=String.fromCharCode.apply(String,r.slice(n,n+=
$n));return t}a(Ko,"decodeCodePointsArray");function Yo(r,e,t){let n="";t=Math.min(r.length,t);for(let i=e;i<
...
2]<<8|this[e+3])},"readUInt32BE");h.prototype.readBigUInt64LE=me(a(function(e){e=e>>>0,Le(e,"offset");
...
BigInt(32))},"readBigUInt64LE"));h.prototype.readBigUInt64BE=me(a(function(e){e=e>>>0,Le(e,"offset");
...
readBigInt64LE=me(a(function(e){e=e>>>0,Le(e,"offset");let t=this[e],n=this[e+7];(t===void 0||n===void 0)&&
...
me(a(function(e){e=e>>>0,Le(e,"offset");let t=this[e],n=this[e+7];(t===void 0||n===void 0)&&We(e,this.
...
return e=e>>>0,t||N(e,4,this.length),Pe.read(this,e,!0,23,4)},"readFloatLE");h.prototype.readFloatBE=
a(function(e,t){return e=e>>>0,t||N(e,4,this.length),Pe.read(this,e,!1,23,4)},"readFloatBE");h.prototype.
readDoubleLE=a(function(e,t){return e=e>>>0,t||N(e,8,this.length),Pe.read(this,e,!0,52,8)},"readDoub\
leLE");h.prototype.readDoubleBE=a(function(e,t){return e=e>>>0,t||N(e,8,this.length),Pe.read(this,e,
...
8,r[t++]=o,t}a(Zn,"wrtBigUInt64LE");function Jn(r,e,t,n,i){ni(e,n,i,r,t,7);let s=Number(e&BigInt(4294967295));
...
writeBigUInt64LE=me(a(function(e,t=0){return Zn(this,e,t,BigInt(0),BigInt("0xffffffffffffffff"))},"w\
riteBigUInt64LE"));h.prototype.writeBigUInt64BE=me(a(function(e,t=0){return Jn(this,e,t,BigInt(0),BigInt(
...
t+4},"writeInt32BE");h.prototype.writeBigInt64LE=me(a(function(e,t=0){return Zn(this,e,t,-BigInt("0x\
8000000000000000"),BigInt("0x7fffffffffffffff"))},"writeBigInt64LE"));h.prototype.writeBigInt64BE=me(
...
+e,t=t>>>0,i||ei(r,e,t,4,34028234663852886e22,-34028234663852886e22),Pe.write(r,e,t,n,23,4),t+4}a(ti,
...
return e=+e,t=t>>>0,i||ei(r,e,t,8,17976931348623157e292,-17976931348623157e292),Pe.write(r,e,t,n,52,
...
0;s<n-t;++s)this[s+t]=o[s%u]}return this},"fill");var Te={};function zt(r,e,t){var n;Te[r]=(n=class extends t{constructor(){
...
_${r.slice(t-3,t)}${e}`;return`${r.slice(0,t)}${e}`}a(Gn,"addNumericalSeparator");function ea(r,e,t){
Le(e,"offset"),(r[e]===void 0||r[e+t]===void 0)&&We(e,r.length-(t+1))}a(ea,"checkBounds");function ni(r,e,t,n,i,s){
...
nd <= ${t}${o}`,new Te.ERR_OUT_OF_RANGE("value",u,r)}ea(n,i,s)}a(ni,"checkIntBI");function Le(r,e){if(typeof r!=
"number")throw new Te.ERR_INVALID_ARG_TYPE(e,"number",r)}a(Le,"validateNumber");function We(r,e,t){throw Math.
floor(r)!==r?(Le(r,t),new Te.ERR_OUT_OF_RANGE(t||"offset","an integer",r)):e<0?new Te.ERR_BUFFER_OUT_OF_BOUNDS:
new Te.ERR_OUT_OF_RANGE(t||"offset",`>= ${t?1:0} and <= ${e}`,r)}a(We,"boundsError");var ta=/[^+/0-9A-Za-z-_]/g;
function ra(r){if(r=r.split("=")[0],r=r.trim().replace(ta,""),r.length<2)return"";for(;r.length%4!==
0;)r=r+"=";return r}a(ra,"base64clean");function $t(r,e){e=e||1/0;let t,n=r.length,i=null,s=[];for(let o=0;o<
...
o),n=t>>8,i=t%256,s.push(i),s.push(n);return s}a(ia,"utf16leToBytes");function ii(r){return Wt.toByteArray(
ra(r))}a(ii,"base64ToBytes");function dt(r,e,t,n){let i;for(i=0;i<n&&!(i+t>=e.length||i>=r.length);++i)
e[i+t]=r[i];return i}a(dt,"blitBuffer");function ae(r,e){return r instanceof e||r!=null&&r.constructor!=
null&&r.constructor.name!=null&&r.constructor.name===e.name}a(ae,"isInstance");function Kt(r){return r!==
r}a(Kt,"numberIsNaN");var sa=function(){let r="0123456789abcdef",e=new Array(256);for(let t=0;t<16;++t){
let n=t*16;for(let i=0;i<16;++i)e[n+i]=r[t]+r[i]}return e}();function me(r){return typeof BigInt>"u"?
oa:r}a(me,"defineBigIntMethod");function oa(){throw new Error("BigInt not supported")}a(oa,"BufferBi\
...
m.nextTick(()=>{})}catch{let e=Promise.resolve();m.nextTick=e.then.bind(e)}});var we=T((Rl,Yt)=>{"use strict";d();var Re=typeof Reflect=="object"?Reflect:null,oi=Re&&typeof Re.apply==
"function"?Re.apply:a(function(e,t,n){return Function.prototype.apply.call(e,t,n)},"ReflectApply"),pt;
Re&&typeof Re.ownKeys=="function"?pt=Re.ownKeys:Object.getOwnPropertySymbols?pt=a(function(e){return Object.
...
"ProcessEmitWarning");var ui=Number.isNaN||a(function(e){return e!==e},"NumberIsNaN");function L(){L.
init.call(this)}a(L,"EventEmitter");Yt.exports=L;Yt.exports.once=fa;L.EventEmitter=L;L.prototype._events=
void 0;L.prototype._eventsCount=0;L.prototype._maxListeners=void 0;var ai=10;function yt(r){if(typeof r!=
"function")throw new TypeError('The "listener" argument must be of type Function. Received type '+typeof r)}
a(yt,"checkListener");Object.defineProperty(L,"defaultMaxListeners",{enumerable:!0,get:a(function(){
...
L.prototype.setMaxListeners=a(function(e){if(typeof e!="number"||e<0||ui(e))throw new RangeError('Th\
e value of "n" is out of range. It must be a non-negative number. Received '+e+".");return this._maxListeners=
e,this},"setMaxListeners");function ci(r){return r._maxListeners===void 0?L.defaultMaxListeners:r._maxListeners}
a(ci,"_getMaxListeners");L.prototype.getMaxListeners=a(function(){return ci(this)},"getMaxListeners");
...
length,f=pi(c,l),n=0;n<l;++n)oi(f[n],this,t);return!0},"emit");function li(r,e,t,n){var i,s,o;if(yt(
...
r,u.type=e,u.count=o.length,aa(u)}return r}a(li,"_addListener");L.prototype.addListener=a(function(e,t){
return li(this,e,t,!1)},"addListener");L.prototype.on=L.prototype.addListener;L.prototype.prependListener=
a(function(e,t){return li(this,e,t,!0)},"prependListener");function ua(){if(!this.fired)return this.
target.removeListener(this.type,this.wrapFn),this.fired=!0,arguments.length===0?this.listener.call(this.
target):this.listener.apply(this.target,arguments)}a(ua,"onceWrapper");function fi(r,e,t){var n={fired:!1,
wrapFn:void 0,target:r,type:e,listener:t},i=ua.bind(n);return i.listener=t,n.wrapFn=i,i}a(fi,"_onceW\
rap");L.prototype.once=a(function(e,t){return yt(t),this.on(e,fi(this,e,t)),this},"once");L.prototype.
prependOnceListener=a(function(e,t){return yt(t),this.prependListener(e,fi(this,e,t)),this},"prepend\
OnceListener");L.prototype.removeListener=a(function(e,t){var n,i,s,o,u;if(yt(t),i=this._events,i===
...
la(i):pi(i,i.length)}a(hi,"_listeners");L.prototype.listeners=a(function(e){return hi(this,e,!0)},"l\
isteners");L.prototype.rawListeners=a(function(e){return hi(this,e,!1)},"rawListeners");L.listenerCount=
function(r,e){return typeof r.listenerCount=="function"?r.listenerCount(e):di.call(r,e)};L.prototype.
listenerCount=di;function di(r){var e=this._events;if(e!==void 0){var t=e[r];if(typeof t=="function")
return 1;if(t!==void 0)return t.length}return 0}a(di,"listenerCount");L.prototype.eventNames=a(function(){
return this._eventsCount>0?pt(this._events):[]},"eventNames");function pi(r,e){for(var t=new Array(e),
n=0;n<e;++n)t[n]=r[n];return t}a(pi,"arrayClone");function ca(r,e){for(;e+1<r.length;e++)r[e]=r[e+1];
...
ha(r,i,{once:!0})})}a(fa,"once");function ha(r,e,t){typeof r.on=="function"&&yi(r,"error",e,t)}a(ha,
...
ust be of type EventEmitter. Received type '+typeof r)}a(yi,"eventTargetAgnosticAddListener")});var gi={};ie(gi,{Socket:()=>le,isIP:()=>da});function da(r){return 0}var wi,mi,b,le,je=G(()=>{"use s\
trict";d();wi=xe(we(),1);a(da,"isIP");mi=/^[^.]+\./,b=class b extends wi.EventEmitter{constructor(){
...
0"?`:${n}`:"";return`${o}://${t}${u}/sql`}let s;return i?.jwtAuth?s=t.replace(mi,"apiauth."):s=t.replace(
mi,"api."),"https://"+s+"/sql"},"fetchEndpoint"),fetchConnectionCache:!0,fetchFunction:void 0,webSocketConstructor:void 0,
...
A(b,"opts",{});le=b});var bi={};ie(bi,{parse:()=>Xt});function Xt(r,e=!1){let{protocol:t}=new URL(r),n="http:"+r.substring(
...
pathname:l,search:f,query:C,hash:g}}var Zt=G(()=>{"use strict";d();a(Xt,"parse")});var rr=T(Ci=>{"use strict";d();Ci.parse=function(r,e){return new tr(r,e).parse()};var St=class St{constructor(e,t){
...
not balanced");return this.entries}};a(St,"ArrayParser");var tr=St;function _a(r){return r}a(_a,"ide\
ntity")});var nr=T((Zl,_i)=>{d();var Ia=rr();_i.exports={create:a(function(r,e){return{parse:a(function(){return Ia.
parse(r,e)},"parse")}},"create")}});var Pi=T((tf,Ti)=>{"use strict";d();var Ta=/(\d{1,})-(\d{2})-(\d{2}) (\d{2}):(\d{2}):(\d{2})(\.\d{1,})?.*?( BC)?$/,
Pa=/^(\d{1,})-(\d{2})-(\d{2})( BC)?$/,La=/([Z+-])(\d{2})?:?(\d{2})?:?(\d{2})?/,Ba=/^-?infinity$/;Ti.
...
(p=new Date(Date.UTC(i,s,o,u,c,l,f)),ir(i)&&p.setUTCFullYear(i),g!==0&&p.setTime(p.getTime()-g)):(p=
new Date(i,s,o,u,c,l,f),ir(i)&&p.setFullYear(i)),p},"parseDate");function Ra(r){var e=Pa.exec(r);if(e){
...
e[3]||0,10)*60+parseInt(e[4]||0,10);return i*n*1e3}}a(ka,"timeZoneOffset");function Ii(r){return-(r-
1)}a(Ii,"bcYearToNegativeYear");function ir(r){return r>=0&&r<100}a(ir,"is0To99")});var Bi=T((sf,Li)=>{d();Li.exports=Ma;var Fa=Object.prototype.hasOwnProperty;function Ma(r){for(var e=1;e<
arguments.length;e++){var t=arguments[e];for(var n in t)Fa.call(t,n)&&(r[n]=t[n])}return r}a(Ma,"ext\
end")});var Fi=T((uf,ki)=>{"use strict";d();var Ua=Bi();ki.exports=ke;function ke(r){if(!(this instanceof ke))
return new ke(r);Ua(this,za(r))}a(ke,"PostgresInterval");var Da=["seconds","minutes","hours","days",
"months","years"];ke.prototype.toPostgres=function(){var r=Da.filter(this.hasOwnProperty,this);return this.
...
S"},Na=["years","months","days"],qa=["hours","minutes","seconds"];ke.prototype.toISOString=ke.prototype.
...
/0+$/,"")),i+Oa[n]}};var sr="([+-]?\\d+)",Qa=sr+"\\s+years?",Wa=sr+"\\s+mons?",ja=sr+"\\s+days?",Ha="\
...
keys(Ri).reduce(function(n,i){var s=Ri[i],o=e[s];return!o||(o=i==="milliseconds"?Va(o):parseInt(o,10),
!o)||(t&&~Ga.indexOf(i)&&(o*=-1),n[i]=o),n},{})}a(za,"parse")});var Ui=T((ff,Mi)=>{"use strict";d();Mi.exports=a(function(e){if(/^\\x/.test(e))return new y(e.substr(
...
parseBytea")});var ji=T((pf,Wi)=>{d();var Ve=rr(),ze=nr(),xt=Pi(),Oi=Fi(),Ni=Ui();function Et(r){return a(function(t){
return t===null?t:r(t)},"nullAllowed")}a(Et,"allowNull");function qi(r){return r===null?r:r==="TRUE"||
r==="t"||r==="true"||r==="y"||r==="yes"||r==="on"||r==="1"}a(qi,"parseBool");function Ka(r){return r?
Ve.parse(r,qi):null}a(Ka,"parseBoolArray");function Ya(r){return parseInt(r,10)}a(Ya,"parseBaseTenIn\
t");function or(r){return r?Ve.parse(r,Et(Ya)):null}a(or,"parseIntegerArray");function Xa(r){return r?
Ve.parse(r,Et(function(e){return Qi(e).trim()})):null}a(Xa,"parseBigIntegerArray");var Za=a(function(r){
...
ervalArray"),eu=a(function(r){return r?Ve.parse(r,Et(Ni)):null},"parseByteAArray"),cr=a(function(r){
return parseInt(r,10)},"parseInteger"),Qi=a(function(r){var e=String(r);return/^\d+$/.test(e)?e:r},"\
parseBigInteger"),Di=a(function(r){return r?Ve.parse(r,Et(JSON.parse)):null},"parseJsonArray"),lr=a(
...
r[i])}var s=lr(e);return s.radius=parseFloat(t),s},"parseCircle"),ru=a(function(r){r(20,Qi),r(21,cr),
r(23,cr),r(26,cr),r(700,parseFloat),r(701,parseFloat),r(16,qi),r(1082,xt),r(1114,xt),r(1184,xt),r(600,
lr),r(651,re),r(718,tu),r(1e3,Ka),r(1001,eu),r(1005,or),r(1007,or),r(1028,or),r(1016,Xa),r(1017,Za),
r(1021,ar),r(1022,ar),r(1231,ar),r(1014,re),r(1015,re),r(1008,re),r(1009,re),r(1040,re),r(1041,re),r(
1115,ur),r(1182,ur),r(1185,ur),r(1186,Oi),r(1187,Ja),r(17,Ni),r(114,JSON.parse.bind(JSON)),r(3802,JSON.
parse.bind(JSON)),r(199,Di),r(3807,Di),r(3907,re),r(2951,re),r(791,re),r(1183,re),r(1270,re)},"init");
Wi.exports={init:ru}});var $i=T((wf,Hi)=>{"use strict";d();var z=1e6;function nu(r){var e=r.readInt32BE(0),t=r.readUInt32BE(
...
""+o%z,n+u+i}a(nu,"readInt8");Hi.exports=nu});var Yi=T((vf,Ki)=>{d();var iu=$i(),R=a(function(r,e,t,n,i){t=t||0,n=n||!1,i=i||function(E,C,D){return E*
...
r[p]),8);var g=(e+t)%8;return g>0&&(l=i(l,o(r[f])>>8-g,g)),l},"parseBits"),zi=a(function(r,e,t){var n=Math.
...
return R(r,1)==1?-1*(R(r,15,1,!0)+1):R(r,15,1)},"parseInt16"),Gi=a(function(r){return R(r,1)==1?-1*(R(
r,31,1,!0)+1):R(r,31,1)},"parseInt32"),ou=a(function(r){return zi(r,23,8)},"parseFloat32"),au=a(function(r){
return zi(r,52,11)},"parseFloat64"),uu=a(function(r){var e=R(r,16,32);if(e==49152)return NaN;for(var t=Math.
pow(1e4,R(r,16,16)),n=0,i=[],s=R(r,16),o=0;o<s;o++)n+=R(r,16,64+16*o)*t,t/=1e4;var u=Math.pow(10,R(r,
16,48));return(e===0?1:-1)*Math.round(n*u)/u},"parseNumeric"),Vi=a(function(r,e){var t=R(e,1),n=R(e,
...
usec=s},i.getUTCMicroSeconds=function(){return this.usec},i},"parseDate"),Ke=a(function(r){for(var e=R(
...
null:R(r,8)>0},"parseBool"),fu=a(function(r){r(20,iu),r(21,su),r(23,Gi),r(26,Gi),r(1700,uu),r(700,ou),
r(701,au),r(16,lu),r(1114,Vi.bind(null,!1)),r(1184,Vi.bind(null,!0)),r(1e3,Ke),r(1007,Ke),r(1016,Ke),
r(1008,Ke),r(1009,Ke),r(25,cu)},"init");Ki.exports={init:fu}});var Zi=T((Ef,Xi)=>{d();Xi.exports={BOOL:16,BYTEA:17,CHAR:18,INT8:20,INT2:21,INT4:23,REGPROC:24,TEXT:25,
...
REGROLE:4096}});var Ze=T(Xe=>{d();var hu=ji(),du=Yi(),pu=nr(),yu=Zi();Xe.getTypeParser=mu;Xe.setTypeParser=wu;Xe.arrayParser=
pu;Xe.builtins=yu;var Ye={text:{},binary:{}};function Ji(r){return String(r)}a(Ji,"noParse");function mu(r,e){
return e=e||"text",Ye[e]&&Ye[e][r]||Ji}a(mu,"getTypeParser");function wu(r,e,t){typeof e=="function"&&
(t=e,e="text"),Ye[e][r]=t}a(wu,"setTypeParser");hu.init(function(r,e){Ye.text[r]=e});du.init(function(r,e){
Ye.binary[r]=e})});var Ct=T((Tf,es)=>{"use strict";d();var gu=Ze();function At(r){this._types=r||gu,this.text={},this.binary=
...
e||"text",this.getOverrides(e)[r]||this._types.getTypeParser(r,e)};es.exports=At});function Je(r){let e=1779033703,t=3144134277,n=1013904242,i=2773480762,s=1359893119,o=2600822924,u=528734635,
...
24|C[H+1]<<16|C[H+2]<<8|C[H+3];for(let B=16;B<64;B++){let H=g(E[B-15],7)^g(E[B-15],18)^E[B-15]>>>3,ue=g(
E[B-2],17)^g(E[B-2],19)^E[B-2]>>>10;E[B]=E[B-16]+H+E[B-7]+ue|0}let I=e,w=t,X=n,j=i,Z=s,he=o,J=u,se=c;
for(let B=0;B<64;B++){let H=g(Z,6)^g(Z,11)^g(Z,25),ue=Z&he^~Z&J,de=se+H+ue+p[B]+E[B]|0,Se=g(I,2)^g(I,
13)^g(I,22),Qe=I&w^I&X^w&X,ee=Se+Qe|0;se=J,J=he,he=Z,Z=j+de|0,j=X,X=w,w=I,I=de+ee|0}e=e+I|0,t=t+w|0,
n=n+X|0,i=i+j|0,s=s+Z|0,o=o+he|0,u=u+J|0,c=c+se|0,f=0},"process"),Y=a(I=>{typeof I=="string"&&(I=new TextEncoder().
...
(Y(r),P())}var ts=G(()=>{"use strict";d();a(Je,"sha256")});var U,et,rs=G(()=>{"use strict";d();U=class U{constructor(){A(this,"_dataLength",0);A(this,"_bufferL\
...
abcdef"),A(U,"hexOut",[]),A(U,"onePassHasher",new U);et=U});var fr={};ie(fr,{createHash:()=>vu,createHmac:()=>Su,randomBytes:()=>bu});function bu(r){return crypto.
getRandomValues(y.alloc(r))}function vu(r){if(r==="sha256")return{update:a(function(e){return{digest:a(
function(){return y.from(Je(e))},"digest")}},"update")};if(r==="md5")return{update:a(function(e){return{
...
t));let n=e.length;if(n>64)e=Je(e);else if(n<64){let c=new Uint8Array(64);c.set(e),e=c}let i=new Uint8Array(
64),s=new Uint8Array(64);for(let c=0;c<64;c++)i[c]=54^e[c],s[c]=92^e[c];let o=new Uint8Array(t.length+
64);o.set(i,0),o.set(t,64);let u=new Uint8Array(96);return u.set(s,0),u.set(Je(o),64),y.from(Je(u))},
"digest")}},"update")}}var hr=G(()=>{"use strict";d();ts();rs();a(bu,"randomBytes");a(vu,"createHash");
a(Su,"createHmac")});var tt=T((Qf,dr)=>{"use strict";d();dr.exports={host:"localhost",user:m.platform==="win32"?m.env.USERNAME:
...
keepalives:1,keepalives_idle:0};var Fe=Ze(),xu=Fe.getTypeParser(20,"text"),Eu=Fe.getTypeParser(1016,
"text");dr.exports.__defineSetter__("parseInt8",function(r){Fe.setTypeParser(20,"text",r?Fe.getTypeParser(
23,"text"):xu),Fe.setTypeParser(1016,"text",r?Fe.getTypeParser(1007,"text"):Eu)})});var rt=T((jf,is)=>{"use strict";d();var Au=(hr(),O(fr)),Cu=tt();function _u(r){var e=r.replace(/\\/g,
"\\\\").replace(/"/g,'\\"');return'"'+e+'"'}a(_u,"escapeElement");function ns(r){for(var e="{",t=0;t<
r.length;t++)t>0&&(e=e+","),r[t]===null||typeof r[t]>"u"?e=e+"NULL":Array.isArray(r[t])?e=e+ns(r[t]):
r[t]instanceof y?e+="\\\\x"+r[t].toString("hex"):e+=_u(_t(r[t]));return e=e+"}",e}a(ns,"arrayString");
...
r.byteLength)}return r instanceof Date?Cu.parseInputDatesAsUTC?Pu(r):Tu(r):Array.isArray(r)?ns(r):typeof r==
...
t),r}a(Lu,"normalizeQueryConfig");var pr=a(function(r){return Au.createHash("md5").update(r,"utf-8").
digest("hex")},"md5"),Bu=a(function(r,e,t){var n=pr(e+r),i=pr(y.concat([y.from(n),t]));return"md5"+i},
"postgresMd5PasswordHash");is.exports={prepareValue:a(function(e){return _t(e)},"prepareValueWrapper"),
normalizeQueryConfig:Lu,postgresMd5PasswordHash:Bu,md5:pr}});var nt={};ie(nt,{default:()=>Mu});var Mu,it=G(()=>{"use strict";d();Mu={}});var ys=T((th,ps)=>{"use strict";d();var mr=(hr(),O(fr));function Uu(r){if(r.indexOf("SCRAM-SHA-256")===
...
art with client nonce");var i=y.from(n.salt,"base64"),s=ju(e,i,n.iteration),o=Me(s,"Client Key"),u=Wu(
o),c="n=*,r="+r.clientNonce,l="r="+n.nonce+",s="+n.salt+",i="+n.iteration,f="c=biws,r="+n.nonce,p=c+
","+l+","+f,g=Me(u,p),E=ds(o,g),C=E.toString("base64"),D=Me(s,"Server Key"),Y=Me(D,p);r.message="SAS\
...
a(ds,"xorBuffers");function Wu(r){return mr.createHash("sha256").update(r).digest()}a(Wu,"sha256");function Me(r,e){
return mr.createHmac("sha256",r).update(e).digest()}a(Me,"hmacSha256");function ju(r,e,t){for(var n=Me(
r,y.concat([e,y.from([0,0,0,1])])),i=n,s=0;s<t-1;s++)n=Me(r,n),i=ds(i,n);return i}a(ju,"Hi");ps.exports=
{startSession:Uu,continueSession:Du,finalizeSession:Ou}});var wr={};ie(wr,{join:()=>Hu});function Hu(...r){return r.join("/")}var gr=G(()=>{"use strict";d();a(
Hu,"join")});var br={};ie(br,{stat:()=>$u});function $u(r,e){e(new Error("No filesystem"))}var vr=G(()=>{"use str\
ict";d();a($u,"stat")});var Sr={};ie(Sr,{default:()=>Gu});var Gu,xr=G(()=>{"use strict";d();Gu={}});var ms={};ie(ms,{StringDecoder:()=>Er});var Ar,Er,ws=G(()=>{"use strict";d();Ar=class Ar{constructor(e){
A(this,"td");this.td=new TextDecoder(e)}write(e){return this.td.decode(e,{stream:!0})}end(e){return this.
td.decode(e)}};a(Ar,"StringDecoder");Er=Ar});var Ss=T((fh,vs)=>{"use strict";d();var{Transform:Vu}=(xr(),O(Sr)),{StringDecoder:zu}=(ws(),O(ms)),be=Symbol(
"last"),Tt=Symbol("decoder");function Ku(r,e,t){let n;if(this.overflow){if(n=this[Tt].write(r).split(
this.matcher),n.length===1)return t();n.shift(),this.overflow=!1}else this[be]+=this[Tt].write(r),n=
this[be].split(this.matcher);this[be]=n.pop();for(let i=0;i<n.length;i++)try{bs(this,this.mapper(n[i]))}catch(s){
return t(s)}if(this.overflow=this[be].length>this.maxLength,this.overflow&&!this.skipOverflow){t(new Error(
"maximum buffer reached"));return}t()}a(Ku,"transform");function Yu(r){if(this[be]+=this[Tt].end(),this[be])
try{bs(this,this.mapper(this[be]))}catch(e){return r(e)}r()}a(Yu,"flush");function bs(r,e){e!==void 0&&
...
!0;let n=new Vu(t);return n[be]="",n[Tt]=new zu("utf8"),n.matcher=r,n.mapper=e,n.maxLength=t.maxLength,
n.skipOverflow=t.skipOverflow||!1,n.overflow=!1,n._destroy=function(i,s){this._writableState.errorEmitted=
!1,s(i)},n}a(Xu,"split");vs.exports=Xu});var As=T((ph,fe)=>{"use strict";d();var xs=(gr(),O(wr)),Zu=(xr(),O(Sr)).Stream,Ju=Ss(),Es=(it(),O(nt)),
ec=5432,Pt=m.platform==="win32",st=m.stderr,tc=56,rc=7,nc=61440,ic=32768;function sc(r){return(r&nc)==
ic}a(sc,"isRegFile");var Ue=["host","port","database","user","password"],Cr=Ue.length,oc=Ue[Cr-1];function _r(){
var r=st instanceof Zu&&st.writable===!0;if(r){var e=Array.prototype.slice.call(arguments).concat(`
`);st.write(Es.format.apply(Es,e))}}a(_r,"warn");Object.defineProperty(fe.exports,"isWin",{get:a(function(){
return Pt},"get"),set:a(function(r){Pt=r},"set")});fe.exports.warnTo=function(r){var e=st;return st=
r,e};fe.exports.getFileName=function(r){var e=r||m.env,t=e.PGPASSFILE||(Pt?xs.join(e.APPDATA||"./","\
postgresql","pgpass.conf"):xs.join(e.HOME||"./",".pgpass"));return t};fe.exports.usePgPass=function(r,e){
return Object.prototype.hasOwnProperty.call(m.env,"PGPASSWORD")?!1:Pt?!0:(e=e||"<unkn>",sc(r.mode)?r.
mode&(tc|rc)?(_r('WARNING: password file "%s" has group or world access; permissions should be u=rw \
(0600) or less',e),!1):!0:(_r('WARNING: password file "%s" is not a plain file',e),!1))};var ac=fe.exports.
match=function(r,e){return Ue.slice(0,-1).reduce(function(t,n,i){return i==1&&Number(r[n]||ec)===Number(
...
void 0)},"onErr");e.on("error",u),i.on("data",s).on("end",o).on("error",u)};var uc=fe.exports.parseLine=
...
replace(/\\([:\\])/g,"$1")),o[Ue[f]]=E},"addToObj"),l=0;l<r.length-1;l+=1){if(e=r.charAt(l+1),t=r.charAt(
l),u=n==Cr-1,u){c(n,i);break}l>=0&&e==":"&&t!=="\\"&&(c(n,i,l+1),i=l+2,n+=1)}return o=Object.keys(o).
length===Cr?o:null,o},cc=fe.exports.isValidEntry=function(r){for(var e={0:function(o){return o.length>
...
0}},t=0;t<Ue.length;t+=1){var n=e[t],i=r[Ue[t]]||"",s=n(i);if(!s)return!1}return!0}});var _s=T((gh,Ir)=>{"use strict";d();var wh=(gr(),O(wr)),Cs=(vr(),O(br)),Lt=As();Ir.exports=function(r,e){
var t=Lt.getFileName();Cs.stat(t,function(n,i){if(n||!Lt.usePgPass(i,t))return e(void 0);var s=Cs.createReadStream(
t);Lt.getPassword(r,s,e)})};Ir.exports.warnTo=Lt.warnTo});var Is={};ie(Is,{default:()=>lc});var lc,Ts=G(()=>{"use strict";d();lc={}});var Ls=T((Sh,Ps)=>{"use strict";d();var fc=(Zt(),O(bi)),Tr=(vr(),O(br));function Pr(r){if(r.charAt(0)===
...
!1;break}}return t}a(Pr,"parse");Ps.exports=Pr;Pr.parse=Pr});var Bt=T((Ah,ks)=>{"use strict";d();var hc=(Ts(),O(Is)),Rs=tt(),Bs=Ls().parse,$=a(function(r,e,t){return t===
...
no-verify":return{rejectUnauthorized:!1}}return Rs.ssl},"readSSLConfigFromEnvironment"),De=a(function(r){
return"'"+(""+r).replace(/\\/g,"\\\\").replace(/'/g,"\\'")+"'"},"quoteParamValue"),ne=a(function(r,e,t){
var n=e[t];n!=null&&r.push(t+"="+De(n))},"add"),Br=class Br{constructor(e){e=typeof e=="string"?Bs(e):
...
hc.lookup(this.host,function(i,s){return i?e(i,null):(t.push("hostaddr="+De(s)),e(null,t.join(" ")))})}};
a(Br,"ConnectionParameters");var Lr=Br;ks.exports=Lr});var Us=T((Ih,Ms)=>{"use strict";d();var pc=Ze(),Fs=/^([A-Za-z]+)(?: (\d+))?(?: (\d+))?/,kr=class kr{constructor(e,t){
...
format||"text")}}};a(kr,"Result");var Rr=kr;Ms.exports=Rr});var qs=T((Lh,Ns)=>{"use strict";d();var{EventEmitter:yc}=we(),Ds=Us(),Os=rt(),Mr=class Mr extends yc{constructor(e,t,n){
...
Fr});var fn=T(_=>{"use strict";d();Object.defineProperty(_,"__esModule",{value:!0});_.NoticeMessage=_.DataRowMessage=
...
name=n}};a(Yr,"DatabaseError");var Ur=Yr;_.DatabaseError=Ur;var Xr=class Xr{constructor(e,t){this.length=
e,this.chunk=t,this.name="copyData"}};a(Xr,"CopyDataMessage");var Dr=Xr;_.CopyDataMessage=Dr;var Zr=class Zr{constructor(e,t,n,i){
...
n,this.dataTypeID=i,this.dataTypeSize=s,this.dataTypeModifier=o,this.format=u}};a(Jr,"Field");var Nr=Jr;
_.Field=Nr;var en=class en{constructor(e,t){this.length=e,this.fieldCount=t,this.name="rowDescriptio\
n",this.fields=new Array(this.fieldCount)}};a(en,"RowDescriptionMessage");var qr=en;_.RowDescriptionMessage=
qr;var tn=class tn{constructor(e,t){this.length=e,this.parameterCount=t,this.name="parameterDescript\
ion",this.dataTypeIDs=new Array(this.parameterCount)}};a(tn,"ParameterDescriptionMessage");var Qr=tn;
_.ParameterDescriptionMessage=Qr;var rn=class rn{constructor(e,t,n){this.length=e,this.parameterName=
t,this.parameterValue=n,this.name="parameterStatus"}};a(rn,"ParameterStatusMessage");var Wr=rn;_.ParameterStatusMessage=
Wr;var nn=class nn{constructor(e,t){this.length=e,this.salt=t,this.name="authenticationMD5Password"}};
a(nn,"AuthenticationMD5Password");var jr=nn;_.AuthenticationMD5Password=jr;var sn=class sn{constructor(e,t,n){
this.length=e,this.processID=t,this.secretKey=n,this.name="backendKeyData"}};a(sn,"BackendKeyDataMes\
sage");var Hr=sn;_.BackendKeyDataMessage=Hr;var on=class on{constructor(e,t,n,i){this.length=e,this.
processId=t,this.channel=n,this.payload=i,this.name="notification"}};a(on,"NotificationResponseMessa\
ge");var $r=on;_.NotificationResponseMessage=$r;var an=class an{constructor(e,t){this.length=e,this.
status=t,this.name="readyForQuery"}};a(an,"ReadyForQueryMessage");var Gr=an;_.ReadyForQueryMessage=Gr;
var un=class un{constructor(e,t){this.length=e,this.text=t,this.name="commandComplete"}};a(un,"Comma\
ndCompleteMessage");var Vr=un;_.CommandCompleteMessage=Vr;var cn=class cn{constructor(e,t){this.length=
e,this.fields=t,this.name="dataRow",this.fieldCount=t.length}};a(cn,"DataRowMessage");var zr=cn;_.DataRowMessage=
zr;var ln=class ln{constructor(e,t){this.length=e,this.message=t,this.name="notice"}};a(ln,"NoticeMe\
ssage");var Kr=ln;_.NoticeMessage=Kr});var Qs=T(Rt=>{"use strict";d();Object.defineProperty(Rt,"__esModule",{value:!0});Rt.Writer=void 0;var dn=class dn{constructor(e=256){
...
headerPosition=0,this.buffer=y.allocUnsafe(this.size),t}};a(dn,"Writer");var hn=dn;Rt.Writer=hn});var js=T(Ft=>{"use strict";d();Object.defineProperty(Ft,"__esModule",{value:!0});Ft.serialize=void 0;
var pn=Qs(),k=new pn.Writer,mc=a(r=>{k.addInt16(3).addInt16(0);for(let n of Object.keys(r))k.addCString(
n).addCString(r[n]);k.addCString("client_encoding").addCString("UTF8");let e=k.addCString("").flush(),
t=e.length+4;return new pn.Writer().addInt32(t).add(e).flush()},"startup"),wc=a(()=>{let r=y.allocUnsafe(
...
n;s++)i.addInt32(t[s]);return k.flush(80)},"parse"),Oe=new pn.Writer,Ec=a(function(r,e){for(let t=0;t<
r.length;t++){let n=e?e(r[t],t):r[t];n==null?(k.addInt16(0),Oe.addInt32(-1)):n instanceof y?(k.addInt16(
1),Oe.addInt32(n.length),Oe.add(n)):(k.addInt16(0),Oe.addInt32(y.byteLength(n)),Oe.addString(n))}},"\
writeValues"),Ac=a((r={})=>{let e=r.portal||"",t=r.statement||"",n=r.binary||!1,i=r.values||Ws,s=i.length;
return k.addCString(e).addCString(t),k.addInt16(s),Ec(i,r.valueMapper),k.addInt16(s),k.add(Oe.flush()),
...
6),t.writeInt32BE(r,8),t.writeInt32BE(e,12),t},"cancel"),yn=a((r,e)=>{let n=4+y.byteLength(e)+1,i=y.
allocUnsafe(1+n);return i[0]=r,i.writeInt32BE(n,1),i.write(e,5,"utf-8"),i[n]=0,i},"cstringMessage"),
Tc=k.addCString("P").flush(68),Pc=k.addCString("S").flush(68),Lc=a(r=>r.name?yn(68,`${r.type}${r.name||
""}`):r.type==="P"?Tc:Pc,"describe"),Bc=a(r=>{let e=`${r.type}${r.name||""}`;return yn(67,e)},"close"),
Rc=a(r=>k.add(r).flush(100),"copyData"),kc=a(r=>yn(102,r),"copyFail"),kt=a(r=>y.from([r,0,0,0,4]),"c\
...
var Nc=y.allocUnsafe(0),wn=class wn{constructor(e=0){this.offset=e,this.buffer=Nc,this.encoding="utf\
...
offset+=e,t}};a(wn,"BufferReader");var mn=wn;Mt.BufferReader=mn});var Vs=T(Ut=>{"use strict";d();Object.defineProperty(Ut,"__esModule",{value:!0});Ut.Parser=void 0;var F=fn(),
qc=Hs(),gn=1,Qc=4,$s=gn+Qc,Gs=y.allocUnsafe(0),vn=class vn{constructor(e){if(this.buffer=Gs,this.bufferLength=
...
i+gn),u=gn+o;if(u+i<=n){let c=this.handlePacket(i+$s,s,o,this.buffer);t(c),i+=u}else break}i===n?(this.
...
a(vn,"Parser");var bn=vn;Ut.Parser=bn});var Sn=T(ve=>{"use strict";d();Object.defineProperty(ve,"__esModule",{value:!0});ve.DatabaseError=ve.
serialize=ve.parse=void 0;var Wc=fn();Object.defineProperty(ve,"DatabaseError",{enumerable:!0,get:a(
function(){return Wc.DatabaseError},"get")});var jc=js();Object.defineProperty(ve,"serialize",{enumerable:!0,
get:a(function(){return jc.serialize},"get")});var Hc=Vs();function $c(r,e){let t=new Hc.Parser;return r.
on("data",n=>t.parse(n,e)),new Promise(n=>r.on("end",()=>n()))}a($c,"parse");ve.parse=$c});var zs={};ie(zs,{connect:()=>Gc});function Gc({socket:r,servername:e}){return r.startTls(e),r}var Ks=G(
()=>{"use strict";d();a(Gc,"connect")});var An=T((Jh,Zs)=>{"use strict";d();var Ys=(je(),O(gi)),Vc=we().EventEmitter,{parse:zc,serialize:q}=Sn(),
Xs=q.flush(),Kc=q.sync(),Yc=q.end(),En=class En extends Vc{constructor(e){super(),e=e||{},this.stream=
...
this._send(q.copyDone())}sendCopyFail(e){this._send(q.copyFail(e))}};a(En,"Connection");var xn=En;Zs.
exports=xn});var to=T((nd,eo)=>{"use strict";d();var Xc=we().EventEmitter,rd=(it(),O(nt)),Zc=rt(),Cn=ys(),Jc=_s(),
el=Ct(),tl=Bt(),Js=qs(),rl=tt(),nl=An(),_n=class _n extends Xc{constructor(e){super(),this.connectionParameters=
...
_Promise(t=>{this.connection.once("end",t)})}};a(_n,"Client");var Dt=_n;Dt.Query=Js;eo.exports=Dt});var so=T((od,io)=>{"use strict";d();var il=we().EventEmitter,ro=a(function(){},"NOOP"),no=a((r,e)=>{
let t=r.findIndex(e);return t===-1?void 0:r.splice(t,1)[0]},"removeWhere"),Pn=class Pn{constructor(e,t,n){
this.client=e,this.idleListener=t,this.timeoutId=n}};a(Pn,"IdleItem");var In=Pn,Ln=class Ln{constructor(e){
this.callback=e}};a(Ln,"PendingItem");var Ne=Ln;function sl(){throw new Error("Release called on cli\
...
dleListener")}a(ol,"makeIdleListener");var Bn=class Bn extends il{constructor(e,t){super(),this.options=
...
clearTimeout(o),t.callback(u,c,l)},"queueCallback"),s=new Ne(i),o=setTimeout(()=>{no(this._pendingQueue,
...
_expired.add(t),this._idle.findIndex(l=>l.client===t)!==-1&&this._acquireClient(t,new Ne((l,f,p)=>p()),
...
this.options.allowExitOnIdle&&s.unref()),this.options.allowExitOnIdle&&e.unref(),this._idle.push(new In(
...
return this._clients.length}};a(Bn,"Pool");var Tn=Bn;io.exports=Tn});var oo={};ie(oo,{default:()=>al});var al,ao=G(()=>{"use strict";d();al={}});var uo=T((ld,ul)=>{ul.exports={name:"pg",version:"8.8.0",description:"PostgreSQL client - pure javas\
...
a178655"}});var fo=T((fd,lo)=>{"use strict";d();var co=we().EventEmitter,cl=(it(),O(nt)),Rn=rt(),qe=lo.exports=function(r,e,t){
co.call(this),r=Rn.normalizeQueryConfig(r,e,t),this.text=r.text,this.values=r.values,this.name=r.name,
this.callback=r.callback,this.state="new",this._arrayMode=r.rowMode==="array",this._emitRowEvents=!1,
this.on("newListener",function(n){n==="row"&&(this._emitRowEvents=!0)}.bind(this))};cl.inherits(qe,co);
...
prepareValue);r.native.query(this.text,i,t)}else r.native.query(this.text,t)}});var mo=T((yd,yo)=>{"use strict";d();var fl=(ao(),O(oo)),hl=Ct(),pd=uo(),ho=we().EventEmitter,dl=(it(),O(nt)),
...
r,e,t)};K.prototype.getTypeParser=function(r,e){return this._types.getTypeParser(r,e)}});var kn=T((gd,wo)=>{"use strict";d();wo.exports=mo()});var ot=T((vd,at)=>{"use strict";d();var yl=to(),ml=tt(),wl=An(),gl=so(),{DatabaseError:bl}=Sn(),vl=a(
r=>{var e;return e=class extends gl{constructor(n){super(n,r)}},a(e,"BoundPool"),e},"poolFactory"),Fn=a(
function(r){this.defaults=ml,this.Client=r,this.Query=this.Client.Query,this.Pool=vl(this.Client),this.
_pools=[],this.Connection=wl,this.types=Ze(),this.DatabaseError=bl},"PG");typeof m.env.NODE_PG_FORCE_NATIVE<
"u"?at.exports=new Fn(kn()):(at.exports=new Fn(yl),Object.defineProperty(at.exports,"native",{configurable:!0,
enumerable:!1,get(){var r=null;try{r=new Fn(kn())}catch(e){if(e.code!=="MODULE_NOT_FOUND")throw e}return Object.
defineProperty(at.exports,"native",{value:r}),r}}))});d();d();je();Zt();d();var pa=Object.defineProperty,ya=Object.defineProperties,ma=Object.getOwnPropertyDescriptors,vi=Object.
getOwnPropertySymbols,wa=Object.prototype.hasOwnProperty,ga=Object.prototype.propertyIsEnumerable,Si=a(
(r,e,t)=>e in r?pa(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t,"__defNormalProp"),
ba=a((r,e)=>{for(var t in e||(e={}))wa.call(e,t)&&Si(r,t,e[t]);if(vi)for(var t of vi(e))ga.call(e,t)&&
Si(r,t,e[t]);return r},"__spreadValues"),va=a((r,e)=>ya(r,ma(e)),"__spreadProps"),Sa=1008e3,xi=new Uint8Array(
new Uint16Array([258]).buffer)[0]===2,xa=new TextDecoder,Jt=new TextEncoder,mt=Jt.encode("0123456789\
abcdef"),wt=Jt.encode("0123456789ABCDEF"),Ea=Jt.encode("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqr\
stuvwxyz0123456789+/");var Ei=Ea.slice();Ei[62]=45;Ei[63]=95;var He,gt;function Aa(r,{alphabet:e,scratchArr:t}={}){if(!He)if(He=
new Uint16Array(256),gt=new Uint16Array(256),xi)for(let C=0;C<256;C++)He[C]=mt[C&15]<<8|mt[C>>>4],gt[C]=
wt[C&15]<<8|wt[C>>>4];else for(let C=0;C<256;C++)He[C]=mt[C&15]|mt[C>>>4]<<8,gt[C]=wt[C&15]|wt[C>>>4]<<
8;r.byteOffset%4!==0&&(r=new Uint8Array(r));let n=r.length,i=n>>>1,s=n>>>2,o=t||new Uint16Array(n),u=new Uint32Array(
r.buffer,r.byteOffset,s),c=new Uint32Array(o.buffer,o.byteOffset,i),l=e==="upper"?gt:He,f=0,p=0,g;if(xi)
...
{},e),{scratchArr:o}))}return t}a(Ca,"_toHexChunked");function Ai(r,e={}){return e.alphabet!=="upper"&&
typeof r.toHex=="function"?r.toHex():Ca(r,e)}a(Ai,"toHex");d();var bt=class bt{constructor(e,t){this.strings=e;this.values=t}toParameterizedQuery(e={query:"",params:[]}){
let{strings:t,values:n}=this;for(let i=0,s=t.length;i<s;i++)if(e.query+=t[i],i<n.length){let o=n[i];
if(o instanceof Ge)e.query+=o.sql;else if(o instanceof Ce)if(o.queryData instanceof bt)o.queryData.toParameterizedQuery(
...
(e.query+="::bytea")}}return e}};a(bt,"SqlTemplate");var $e=bt,er=class er{constructor(e){this.sql=e}};
a(er,"UnsafeRawSql");var Ge=er;d();function vt(){typeof window<"u"&&typeof document<"u"&&typeof console<"u"&&typeof console.warn=="func\
tion"&&console.warn(`          
        ************************************************************
        *                                                          *
        ...
        *  parameter.                                              *
        *                                                          *
        ************************************************************`)}a(vt,"warnIfBrowser");var us=xe(Ct()),cs=xe(rt());var It=class It extends Error{constructor(t){super(t);A(this,"name","NeonDbError");A(this,"severity");
...
It,"NeonDbError");var ge=It,ss="transaction() expects an array of queries, or a function returning a\
...
return r instanceof y?"\\x"+Ai(r):r}a(ku,"encodeBuffersAsBytea");function os(r){let{query:e,params:t}=r instanceof
$e?r.toParameterizedQuery():r;return{query:e,params:t.map(n=>ku((0,cs.prepareValue)(n)))}}a(os,"prep\
areQuery");function ls(r,{arrayMode:e,fullResults:t,fetchOptions:n,isolationLevel:i,readOnly:s,deferrable:o,
authToken:u,disableWarningInBrowsers:c}={}){if(!r)throw new Error("No database connection string was\
 provided to `neon()`. Perhaps an environment variable has not been set?");let l;try{l=Xt(r)}catch{throw new Error(
...
P.forEach(j=>{if(!(j instanceof Ce))throw new Error(ss)});let w=P.map(j=>j.queryData),X=P.map(j=>j.opts??
{});return Y(w,X,I)};async function Y(P,I,w){let{fetchEndpoint:X,fetchFunction:j,isNeonLocal:Z}=le,he=Array.
isArray(P)?{queries:P.map(Q=>os(Q))}:os(P),J=n??{},se=e??!1,B=t??!1,H=i,ue=s,de=o;w!==void 0&&(w.fetchOptions!==
void 0&&(J={...J,...w.fetchOptions}),w.arrayMode!==void 0&&(se=w.arrayMode),w.fullResults!==void 0&&
(B=w.fullResults),w.isolationLevel!==void 0&&(H=w.isolationLevel),w.readOnly!==void 0&&(ue=w.readOnly),
w.deferrable!==void 0&&(de=w.deferrable)),I!==void 0&&!Array.isArray(I)&&I.fetchOptions!==void 0&&(J=
{...J,...I.fetchOptions});let Se=u;!Array.isArray(I)&&I?.authToken!==void 0&&(Se=I.authToken);let Qe=typeof X==
"function"?X(g,E,{jwtAuth:Se!==void 0}):X,ee={"Neon-Connection-String":r,"Neon-Raw-Text-Output":"tru\
e","Neon-Array-Mode":"true"};Z&&(ee["X-Neon-User"]=p,ee["X-Neon-Password"]=l.password||"",ee["X-Neon\
-Database"]=C.slice(1));let lt=await Fu(Se);lt&&(ee.Authorization=`Bearer ${lt}`),Array.isArray(P)&&
(H!==void 0&&(ee["Neon-Batch-Isolation-Level"]=H),ue!==void 0&&(ee["Neon-Batch-Read-Only"]=String(ue)),
de!==void 0&&(ee["Neon-Batch-Deferrable"]=String(de))),c||le.disableWarningInBrowsers||vt();let pe;try{
pe=await(j??fetch)(Qe,{method:"POST",body:JSON.stringify(he),headers:ee,...J})}catch(Q){let M=new ge(
`Error connecting to database: ${Q}`);throw M.sourceError=Q,M}if(pe.ok){let Q=await pe.json();if(Array.
isArray(P)){let M=Q.results;if(!Array.isArray(M))throw new ge("Neon internal error: unexpected resul\
t format");return M.map((ye,_e)=>{let Nt=I[_e]??{},So=Nt.arrayMode??se,xo=Nt.fullResults??B;return as(
ye,{arrayMode:So,fullResults:xo,types:Nt.types})})}else{let M=I??{},ye=M.arrayMode??se,_e=M.fullResults??
B;return as(Q,{arrayMode:ye,fullResults:_e,types:M.types})}}else{let{status:Q}=pe;if(Q===400){let M=await pe.
json(),ye=new ge(M.message);for(let _e of Ru)ye[_e]=M[_e]??void 0;throw ye}else{let M=await pe.text();
throw new ge(`Server error (HTTP status ${Q}): ${M}`)}}}return a(Y,"execute"),D}a(ls,"neon");var yr=class yr{constructor(e,t,n){
...
this.queryData,this.opts).finally(e)}};a(yr,"NeonQueryPromise");var Ce=yr;function as(r,{arrayMode:e,
...
"function")try{return await Promise.resolve(r())}catch(e){let t=new ge("Error getting auth token.");
throw e instanceof Error&&(t=new ge(`Error getting auth token: ${e.message}`)),t}}a(Fu,"getAuthToken");d();var bo=xe(ot());d();var go=xe(ot());var Mn=class Mn extends go.Client{constructor(t){super(t);this.config=t}get neonConfig(){return this.
...
neonConfig.disableWarningInBrowsers||vt(),this._handleAuthCleartextPassword(),this._handleReadyForQuery()})}
...
",").map(Q=>{if(!/^.=/.test(Q))throw new Error("SASL: Invalid attribute pair entry");let M=Q[0],ye=Q.
substring(2);return[M,ye]})),c=u.r,l=u.s,f=u.i;if(!c||!/^[!-+--~]+$/.test(c))throw new Error("SASL: \
...
digest("SHA-256",j),he="n=*,r="+i.clientNonce,J="r="+c+",s="+l+",i="+p,se="c=biws,r="+c,B=he+","+J+"\
,"+se,H=await n.importKey("raw",Z,{name:"HMAC",hash:{name:"SHA-256"}},!1,["sign"]);var ue=new Uint8Array(
await n.sign("HMAC",H,E.encode(B))),de=y.from(j.map((Q,M)=>j[M]^ue[M])),Se=de.toString("base64");let Qe=await n.
importKey("raw",w,{name:"HMAC",hash:{name:"SHA-256"}},!1,["sign"]),ee=await n.sign("HMAC",Qe,E.encode(
"Server Key")),lt=await n.importKey("raw",ee,{name:"HMAC",hash:{name:"SHA-256"}},!1,["sign"]);var pe=y.
from(await n.sign("HMAC",lt,E.encode(B)));i.message="SASLResponse",i.serverSignature=pe.toString("ba\
se64"),i.response=se+",p="+Se,this.connection.sendSCRAMClientFinalMessage(this.saslSession.response)}};
a(Mn,"NeonClient");var ut=Mn;je();var vo=xe(Bt());function Sl(r,e){if(e)return{callback:e,result:void 0};let t,n,i=a(function(o,u){o?t(o):n(u)},"cb"),
s=new r(function(o,u){n=o,t=u});return{callback:i,result:s}}a(Sl,"promisify");var Dn=class Dn extends bo.Pool{constructor(){
super(...arguments);A(this,"Client",ut);A(this,"hasFetchUnsupportedListeners",!1);A(this,"addListene\
...
/${c(o.database)}`,f=typeof t=="string"?t:t.text,p=n??t.values??[];ls(l,{fullResults:!0,arrayMode:t.
rowMode==="array"}).query(f,p,{types:t.types??this.options?.types}).then(E=>i(void 0,E)).catch(E=>i(
E))}catch(o){i(o)}return s.result}};a(Dn,"NeonPool");var Un=Dn;je();var ct=xe(ot()),Fd="mjs";var export_DatabaseError=ct.DatabaseError;var export_defaults=ct.defaults;var export_escapeIdentifier=ct.escapeIdentifier;
...
ge as NeonDbError,Ce as NeonQueryPromise,Un as Pool,$e as SqlTemplate,Ge as UnsafeRawSql,Fd as _bundleExt,
export_defaults as defaults,export_escapeIdentifier as escapeIdentifier,export_escapeLiteral as escapeLiteral,
ls as neon,le as neonConfig,as as processQueryResult,export_types as types,vt as warnIfBrowser};
