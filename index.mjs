...
var Io=Object.create;var Ie=Object.defineProperty;var Po=Object.getOwnPropertyDescriptor;var Ro=Object.getOwnPropertyNames;var Lo=Object.getPrototypeOf,Bo=Object.prototype.hasOwnProperty;var Fo=(r,e,t)=>e in r?Ie(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t;var a=(r,e)=>Ie(r,"name",{value:e,configurable:!0});var V=(r,e,t)=>()=>{if(t)throw t[0];try{return r&&(e=r(r=0)),e}catch(n){throw t=[n],n}};var T=(r,e)=>()=>{try{return e||r((e={exports:{}}).exports,e),e.exports}catch(t){throw e=0,t}},se=(r,e)=>{
for(var t in e)Ie(r,t,{get:e[t],enumerable:!0})},Dn=(r,e,t,n)=>{if(e&&typeof e=="object"||typeof e==
"function")for(let i of Ro(e))!Bo.call(r,i)&&i!==t&&Ie(r,i,{get:()=>e[i],enumerable:!(n=Po(e,i))||n.
enumerable});return r};var we=(r,e,t)=>(t=r!=null?Io(Lo(r)):{},Dn(e||!r||!r.__esModule?Ie(t,"default",{value:r,enumerable:!0}):
t,r)),U=r=>Dn(Ie({},"__esModule",{value:!0}),r);var E=(r,e,t)=>Fo(r,typeof e!="symbol"?e+"":e,t);var Nn=T(lt=>{"use strict";h();lt.byteLength=Mo;lt.toByteArray=Oo;lt.fromByteArray=Qo;var le=[],X=[],
...
ltiple of 4");var t=r.indexOf("=");t===-1&&(t=e);var n=t===e?0:4-t%4;return[t,n]}a(Qn,"getLens");function Mo(r){
var e=Qn(r),t=e[0],n=e[1];return(t+n)*3/4-n}a(Mo,"byteLength");function Uo(r,e,t){return(e+t)*3/4-t}
a(Uo,"_byteLength");function Oo(r){var e,t=Qn(r),n=t[0],i=t[1],s=new ko(Uo(r,n,i)),o=0,u=i>0?n-4:n,c;
...
2,s[o++]=e>>8&255,s[o++]=e&255),s}a(Oo,"toByteArray");function Do(r){return le[r>>18&63]+le[r>>12&63]+
le[r>>6&63]+le[r&63]}a(Do,"tripletToBase64");function qo(r,e,t){for(var n,i=[],s=e;s<t;s+=3)n=(r[s]<<
16&16711680)+(r[s+1]<<8&65280)+(r[s+2]&255),i.push(Do(n));return i.join("")}a(qo,"encodeChunk");function Qo(r){
...
le[e<<2&63]+"=")),i.join("")}a(Qo,"fromByteArray")});var Wn=T(Qt=>{h();Qt.read=function(r,e,t,n,i){var s,o,u=i*8-n-1,c=(1<<u)-1,l=c>>1,f=-7,y=t?i-1:0,g=t?
...
v,u/=256,i-=8);for(o=o<<i|u,l+=i;l>0;r[t+w]=o&255,w+=v,o/=256,l-=8);r[t+w-v]|=M*128}});var si=T(Be=>{"use strict";h();var Nt=Nn(),Re=Wn(),jn=typeof Symbol=="function"&&typeof Symbol.for==
"function"?Symbol.for("nodejs.util.inspect.custom"):null;Be.Buffer=p;Be.SlowBuffer=Go;Be.INSPECT_MAX_BYTES=
50;var ft=2147483647;Be.kMaxLength=ft;p.TYPED_ARRAY_SUPPORT=No();!p.TYPED_ARRAY_SUPPORT&&typeof console<
...
a(p,"Buffer");p.poolSize=8192;function Vn(r,e,t){if(typeof r=="string")return jo(r,e);if(ArrayBuffer.
...
ed type "+typeof r)}a(Vn,"from");p.from=function(r,e,t){return Vn(r,e,t)};Object.setPrototypeOf(p.prototype,
...
for option "size"')}a(zn,"assertSize");function Wo(r,e,t){return zn(r),r<=0?pe(r):e!==void 0?typeof t==
"string"?pe(r).fill(e,t):pe(r).fill(e):pe(r)}a(Wo,"alloc");p.alloc=function(r,e,t){return Wo(r,e,t)};
function $t(r){return zn(r),pe(r<0?0:Gt(r)|0)}a($t,"allocUnsafe");p.allocUnsafe=function(r){return $t(
r)};p.allocUnsafeSlow=function(r){return $t(r)};function jo(r,e){if((typeof e!="string"||e==="")&&(e=
"utf8"),!p.isEncoding(e))throw new TypeError("Unknown encoding: "+e);let t=Kn(r,e)|0,n=pe(t),i=n.write(
r,e);return i!==t&&(n=n.slice(0,i)),n}a(jo,"fromString");function Wt(r){let e=r.length<0?0:Gt(r.length)|
0,t=pe(e);for(let n=0;n<e;n+=1)t[n]=r[n]&255;return t}a(Wt,"fromArrayLike");function Ho(r){if(fe(r,Uint8Array)){
let e=new Uint8Array(r);return jt(e.buffer,e.byteOffset,e.byteLength)}return Wt(r)}a(Ho,"fromArrayVi\
...
r,e,t),Object.setPrototypeOf(n,p.prototype),n}a(jt,"fromArrayBuffer");function $o(r){if(p.isBuffer(r)){
...
a($o,"fromObject");function Gt(r){if(r>=ft)throw new RangeError("Attempt to allocate Buffer larger t\
han maximum size: 0x"+ft.toString(16)+" bytes");return r|0}a(Gt,"checked");function Go(r){return+r!=
r&&(r=0),p.alloc(+r)}a(Go,"SlowBuffer");p.isBuffer=a(function(e){return e!=null&&e._isBuffer===!0&&e!==
...
an Array of Buffers');s+=o.length}return i},"concat");function Kn(r,e){if(p.isBuffer(r))return r.length;
...
if(i)return n?-1:Ht(r).length;e=(""+e).toLowerCase(),i=!0}}a(Kn,"byteLength");p.byteLength=Kn;function Vo(r,e,t){
...
tf8":case"utf-8":return Zn(this,e,t);case"ascii":return ta(this,e,t);case"latin1":case"binary":return ra(
...
"swap64");p.prototype.toString=a(function(){let e=this.length;return e===0?"":arguments.length===0?Zn(
this,0,e):Vo.apply(this,arguments)},"toString");p.prototype.toLocaleString=p.prototype.toString;p.prototype.
...
er "+e+">"},"inspect");jn&&(p.prototype[jn]=p.prototype.inspect);p.prototype.compare=a(function(e,t,n,i,s){
...
e,n)),p.isBuffer(e))return e.length===0?-1:Hn(r,e,t,n,i);if(typeof e=="number")return e=e&255,typeof Uint8Array.
...
if(f)return l}return-1}a(Hn,"arrayIndexOf");p.prototype.includes=a(function(e,t,n){return this.indexOf(
e,t,n)!==-1},"includes");p.prototype.indexOf=a(function(e,t,n){return Yn(this,e,t,n,!0)},"indexOf");
p.prototype.lastIndexOf=a(function(e,t,n){return Yn(this,e,t,n,!1)},"lastIndexOf");function zo(r,e,t,n){
t=Number(t)||0;let i=r.length-t;n?(n=Number(n),n>i&&(n=i)):n=i;let s=e.length;n>s/2&&(n=s/2);let o;for(o=
0;o<n;++o){let u=parseInt(e.substr(o*2,2),16);if(zt(u))return o;r[t+o]=u}return o}a(zo,"hexWrite");function Ko(r,e,t,n){
return ht(Ht(e,r.length-t),r,t,n)}a(Ko,"utf8Write");function Yo(r,e,t,n){return ht(ua(e),r,t,n)}a(Yo,
"asciiWrite");function Zo(r,e,t,n){return ht(ii(e),r,t,n)}a(Zo,"base64Write");function Jo(r,e,t,n){return ht(
ca(e,r.length-t),r,t,n)}a(Jo,"ucs2Write");p.prototype.write=a(function(e,t,n,i){if(t===void 0)i="utf\
...
N");function Xo(r,e,t){return e===0&&t===r.length?Nt.fromByteArray(r):Nt.fromByteArray(r.slice(e,t))}
a(Xo,"base64Slice");function Zn(r,e,t){t=Math.min(r.length,t);let n=[],i=e;for(;i<t;){let s=r[i],o=null,
...
n.push(o),i+=u}return ea(n)}a(Zn,"utf8Slice");var $n=4096;function ea(r){let e=r.length;if(e<=$n)return String.
fromCharCode.apply(String,r);let t="",n=0;for(;n<e;)t+=String.fromCharCode.apply(String,r.slice(n,n+=
$n));return t}a(ea,"decodeCodePointsArray");function ta(r,e,t){let n="";t=Math.min(r.length,t);for(let i=e;i<
...
fromCharCode(n[s]+n[s+1]*256);return i}a(ia,"utf16leSlice");p.prototype.slice=a(function(e,t){let n=this.
...
!1,52,8)},"readDoubleBE");function z(r,e,t,n,i,s){if(!p.isBuffer(r))throw new TypeError('"buffer" ar\
gument must be a Buffer instance');if(e>i||e<s)throw new RangeError('"value" argument is out of boun\
ds');if(t+n>r.length)throw new RangeError("Index out of range")}a(z,"checkInt");p.prototype.writeUintLE=
p.prototype.writeUIntLE=a(function(e,t,n,i){if(e=+e,t=t>>>0,n=n>>>0,!i){let u=Math.pow(2,8*n)-1;z(this,
...
+e,t=t>>>0,n||z(this,e,t,1,255,0),this[t]=e&255,t+1},"writeUInt8");p.prototype.writeUint16LE=p.prototype.
...
+e,t=t>>>0,n||z(this,e,t,2,65535,0),this[t]=e>>>8,this[t+1]=e&255,t+2},"writeUInt16BE");p.prototype.
writeUint32LE=p.prototype.writeUInt32LE=a(function(e,t,n){return e=+e,t=t>>>0,n||z(this,e,t,4,4294967295,
0),this[t+3]=e>>>24,this[t+2]=e>>>16,this[t+1]=e>>>8,this[t]=e&255,t+4},"writeUInt32LE");p.prototype.
writeUint32BE=p.prototype.writeUInt32BE=a(function(e,t,n){return e=+e,t=t>>>0,n||z(this,e,t,4,4294967295,
...
return r[t+3]=o,o=o>>8,r[t+2]=o,o=o>>8,r[t+1]=o,o=o>>8,r[t]=o,t+8}a(Xn,"wrtBigUInt64BE");p.prototype.
writeBigUInt64LE=be(a(function(e,t=0){return Jn(this,e,t,BigInt(0),BigInt("0xffffffffffffffff"))},"w\
riteBigUInt64LE"));p.prototype.writeBigUInt64BE=be(a(function(e,t=0){return Xn(this,e,t,BigInt(0),BigInt(
...
n},"writeIntBE");p.prototype.writeInt8=a(function(e,t,n){return e=+e,t=t>>>0,n||z(this,e,t,1,127,-128),
e<0&&(e=255+e+1),this[t]=e&255,t+1},"writeInt8");p.prototype.writeInt16LE=a(function(e,t,n){return e=
+e,t=t>>>0,n||z(this,e,t,2,32767,-32768),this[t]=e&255,this[t+1]=e>>>8,t+2},"writeInt16LE");p.prototype.
writeInt16BE=a(function(e,t,n){return e=+e,t=t>>>0,n||z(this,e,t,2,32767,-32768),this[t]=e>>>8,this[t+
1]=e&255,t+2},"writeInt16BE");p.prototype.writeInt32LE=a(function(e,t,n){return e=+e,t=t>>>0,n||z(this,
e,t,4,2147483647,-2147483648),this[t]=e&255,this[t+1]=e>>>8,this[t+2]=e>>>16,this[t+3]=e>>>24,t+4},"\
writeInt32LE");p.prototype.writeInt32BE=a(function(e,t,n){return e=+e,t=t>>>0,n||z(this,e,t,4,2147483647,
-2147483648),e<0&&(e=4294967295+e+1),this[t]=e>>>24,this[t+1]=e>>>16,this[t+2]=e>>>8,this[t+3]=e&255,
t+4},"writeInt32BE");p.prototype.writeBigInt64LE=be(a(function(e,t=0){return Jn(this,e,t,-BigInt("0x\
...
"writeFloat");p.prototype.writeFloatLE=a(function(e,t,n){return ti(this,e,t,!0,n)},"writeFloatLE");p.
...
8),t+8}a(ri,"writeDouble");p.prototype.writeDoubleLE=a(function(e,t,n){return ri(this,e,t,!0,n)},"wr\
iteDoubleLE");p.prototype.writeDoubleBE=a(function(e,t,n){return ri(this,e,t,!1,n)},"writeDoubleBE");
...
_${r.slice(t-3,t)}${e}`;return`${r.slice(0,t)}${e}`}a(Gn,"addNumericalSeparator");function sa(r,e,t){
Le(e,"offset"),(r[e]===void 0||r[e+t]===void 0)&&We(e,r.length-(t+1))}a(sa,"checkBounds");function ni(r,e,t,n,i,s){
...
nd <= ${t}${o}`,new Pe.ERR_OUT_OF_RANGE("value",u,r)}sa(n,i,s)}a(ni,"checkIntBI");function Le(r,e){if(typeof r!=
...
new Pe.ERR_OUT_OF_RANGE(t||"offset",`>= ${t?1:0} and <= ${e}`,r)}a(We,"boundsError");var oa=/[^+/0-9A-Za-z-_]/g;
function aa(r){if(r=r.split("=")[0],r=r.trim().replace(oa,""),r.length<2)return"";for(;r.length%4!==
0;)r=r+"=";return r}a(aa,"base64clean");function Ht(r,e){e=e||1/0;let t,n=r.length,i=null,s=[];for(let o=0;o<
...
o),n=t>>8,i=t%256,s.push(i),s.push(n);return s}a(ca,"utf16leToBytes");function ii(r){return Nt.toByteArray(
aa(r))}a(ii,"base64ToBytes");function ht(r,e,t,n){let i;for(i=0;i<n&&!(i+t>=e.length||i>=r.length);++i)
...
r}a(zt,"numberIsNaN");var la=(function(){let r="0123456789abcdef",e=new Array(256);for(let t=0;t<16;++t){
let n=t*16;for(let i=0;i<16;++i)e[n+i]=r[t]+r[i]}return e})();function be(r){return typeof BigInt>"u"?
fa:r}a(be,"defineBigIntMethod");function fa(){throw new Error("BigInt not supported")}a(fa,"BufferBi\
gIntNotDefined")});var b,x,S,d,m,h=V(()=>{"use strict";b=globalThis,x=globalThis.setImmediate??(r=>setTimeout(r,0)),S=globalThis.
...
m.nextTick(()=>{})}catch{let e=Promise.resolve();m.nextTick=e.then.bind(e)}});var ve=T((Sf,Jt)=>{"use strict";h();var Fe=typeof Reflect=="object"?Reflect:null,yi=Fe&&typeof Fe.apply==
...
getOwnPropertyNames(e)},"ReflectOwnKeys");function Ta(r){console&&console.warn&&console.warn(r)}a(Ta,
"ProcessEmitWarning");var gi=Number.isNaN||a(function(e){return e!==e},"NumberIsNaN");function P(){P.
init.call(this)}a(P,"EventEmitter");Jt.exports=P;Jt.exports.once=La;P.EventEmitter=P;P.prototype._events=
void 0;P.prototype._eventsCount=0;P.prototype._maxListeners=void 0;var mi=10;function xt(r){if(typeof r!=
"function")throw new TypeError('The "listener" argument must be of type Function. Received type '+typeof r)}
a(xt,"checkListener");Object.defineProperty(P,"defaultMaxListeners",{enumerable:!0,get:a(function(){
return mi},"get"),set:a(function(r){if(typeof r!="number"||r<0||gi(r))throw new RangeError('The valu\
e of "defaultMaxListeners" is out of range. It must be a non-negative number. Received '+r+".");mi=r},
...
P.prototype.setMaxListeners=a(function(e){if(typeof e!="number"||e<0||gi(e))throw new RangeError('Th\
e value of "n" is out of range. It must be a non-negative number. Received '+e+".");return this._maxListeners=
e,this},"setMaxListeners");function wi(r){return r._maxListeners===void 0?P.defaultMaxListeners:r._maxListeners}
a(wi,"_getMaxListeners");P.prototype.getMaxListeners=a(function(){return wi(this)},"getMaxListeners");
...
length,f=Ei(c,l),n=0;n<l;++n)yi(f[n],this,t);return!0},"emit");function bi(r,e,t,n){var i,s,o;if(xt(
...
"function"?o=s[e]=n?[t,o]:[o,t]:n?o.unshift(t):o.push(t),i=wi(r),i>0&&o.length>i&&!o.warned){o.warned=
...
r,u.type=e,u.count=o.length,Ta(u)}return r}a(bi,"_addListener");P.prototype.addListener=a(function(e,t){
return bi(this,e,t,!1)},"addListener");P.prototype.on=P.prototype.addListener;P.prototype.prependListener=
a(function(e,t){return bi(this,e,t,!0)},"prependListener");function Ia(){if(!this.fired)return this.
target.removeListener(this.type,this.wrapFn),this.fired=!0,arguments.length===0?this.listener.call(this.
target):this.listener.apply(this.target,arguments)}a(Ia,"onceWrapper");function xi(r,e,t){var n={fired:!1,
wrapFn:void 0,target:r,type:e,listener:t},i=Ia.bind(n);return i.listener=t,n.wrapFn=i,i}a(xi,"_onceW\
rap");P.prototype.once=a(function(e,t){return xt(t),this.on(e,xi(this,e,t)),this},"once");P.prototype.
prependOnceListener=a(function(e,t){return xt(t),this.prependListener(e,xi(this,e,t)),this},"prepend\
...
Ra(i):Ei(i,i.length)}a(vi,"_listeners");P.prototype.listeners=a(function(e){return vi(this,e,!0)},"l\
isteners");P.prototype.rawListeners=a(function(e){return vi(this,e,!1)},"rawListeners");P.listenerCount=
function(r,e){return typeof r.listenerCount=="function"?r.listenerCount(e):Si.call(r,e)};P.prototype.
listenerCount=Si;function Si(r){var e=this._events;if(e!==void 0){var t=e[r];if(typeof t=="function")
return 1;if(t!==void 0)return t.length}return 0}a(Si,"listenerCount");P.prototype.eventNames=a(function(){
return this._eventsCount>0?bt(this._events):[]},"eventNames");function Ei(r,e){for(var t=new Array(e),
n=0;n<e;++n)t[n]=r[n];return t}a(Ei,"arrayClone");function Pa(r,e){for(;e+1<r.length;e++)r[e]=r[e+1];
r.pop()}a(Pa,"spliceOne");function Ra(r){for(var e=new Array(r.length),t=0;t<e.length;++t)e[t]=r[t].
listener||r[t];return e}a(Ra,"unwrapListeners");function La(r,e){return new Promise(function(t,n){function i(o){
r.removeListener(e,s),n(o)}a(i,"errorListener");function s(){typeof r.removeListener=="function"&&r.
removeListener("error",i),t([].slice.call(arguments))}a(s,"resolver"),Ai(r,e,s,{once:!0}),e!=="error"&&
Ba(r,i,{once:!0})})}a(La,"once");function Ba(r,e,t){typeof r.on=="function"&&Ai(r,"error",e,t)}a(Ba,
"addErrorHandlerIfEventEmitter");function Ai(r,e,t,n){if(typeof r.on=="function")n.once?r.once(e,t):
...
ust be of type EventEmitter. Received type '+typeof r)}a(Ai,"eventTargetAgnosticAddListener")});var Ti={};se(Ti,{Socket:()=>de,isIP:()=>Fa});function Fa(r){return 0}var _i,Ci,A,de,Ge=V(()=>{"use s\
trict";h();_i=we(ve(),1);a(Fa,"isIP");Ci=/^[^.]+\./,A=class A extends _i.EventEmitter{constructor(){
...
poolQueryViaFetch:!1,fetchEndpoint:a((t,n,i)=>{let s;return i?.jwtAuth?s=t.replace(Ci,"apiauth."):s=
t.replace(Ci,"api."),"https://"+s+"/sql"},"fetchEndpoint"),fetchConnectionCache:!0,fetchFunction:void 0,
...
disableWarningInBrowsers:!1}),E(A,"opts",{});de=A});var er=T(Ii=>{"use strict";h();Ii.parse=function(r,e){return new Xt(r,e).parse()};var vt=class vt{constructor(e,t){
this.source=e,this.transform=t||ka,this.position=0,this.entries=[],this.recorded=[],this.dimension=0}isEof(){
...
not balanced");return this.entries}};a(vt,"ArrayParser");var Xt=vt;function ka(r){return r}a(ka,"ide\
ntity")});var tr=T((Rf,Pi)=>{h();var Ma=er();Pi.exports={create:a(function(r,e){return{parse:a(function(){return Ma.
parse(r,e)},"parse")}},"create")}});var Bi=T((Ff,Li)=>{"use strict";h();var Ua=/(\d{1,})-(\d{2})-(\d{2}) (\d{2}):(\d{2}):(\d{2})(\.\d{1,})?.*?( BC)?$/,
Oa=/^(\d{1,})-(\d{2})-(\d{2})( BC)?$/,Da=/([Z+-])(\d{2})?:?(\d{2})?:?(\d{2})?/,qa=/^-?infinity$/;Li.
exports=a(function(e){if(qa.test(e))return Number(e.replace("i","I"));var t=Ua.exec(e);if(!t)return Qa(
e)||null;var n=!!t[8],i=parseInt(t[1],10);n&&(i=Ri(i));var s=parseInt(t[2],10)-1,o=t[3],u=parseInt(t[4],
10),c=parseInt(t[5],10),l=parseInt(t[6],10),f=t[7];f=f?1e3*parseFloat(f):0;var y,g=Na(e);return g!=null?
(y=new Date(Date.UTC(i,s,o,u,c,l,f)),rr(i)&&y.setUTCFullYear(i),g!==0&&y.setTime(y.getTime()-g)):(y=
new Date(i,s,o,u,c,l,f),rr(i)&&y.setFullYear(i)),y},"parseDate");function Qa(r){var e=Oa.exec(r);if(e){
var t=parseInt(e[1],10),n=!!e[4];n&&(t=Ri(t));var i=parseInt(e[2],10)-1,s=e[3],o=new Date(t,i,s);return rr(
t)&&o.setFullYear(t),o}}a(Qa,"getDate");function Na(r){if(r.endsWith("+00"))return 0;var e=Da.exec(r.
split(" ")[1]);if(e){var t=e[1];if(t==="Z")return 0;var n=t==="-"?-1:1,i=parseInt(e[2],10)*3600+parseInt(
e[3]||0,10)*60+parseInt(e[4]||0,10);return i*n*1e3}}a(Na,"timeZoneOffset");function Ri(r){return-(r-
1)}a(Ri,"bcYearToNegativeYear");function rr(r){return r>=0&&r<100}a(rr,"is0To99")});var ki=T((Uf,Fi)=>{h();Fi.exports=ja;var Wa=Object.prototype.hasOwnProperty;function ja(r){for(var e=1;e<
arguments.length;e++){var t=arguments[e];for(var n in t)Wa.call(t,n)&&(r[n]=t[n])}return r}a(ja,"ext\
end")});var Oi=T((qf,Ui)=>{"use strict";h();var Ha=ki();Ui.exports=ke;function ke(r){if(!(this instanceof ke))
return new ke(r);Ha(this,ru(r))}a(ke,"PostgresInterval");var $a=["seconds","minutes","hours","days",
"months","years"];ke.prototype.toPostgres=function(){var r=$a.filter(this.hasOwnProperty,this);return this.
...
"")),t+" "+e},this).join(" ")};var Ga={years:"Y",months:"M",days:"D",hours:"H",minutes:"M",seconds:"\
S"},Va=["years","months","days"],za=["hours","minutes","seconds"];ke.prototype.toISOString=ke.prototype.
toISO=function(){var r=Va.map(t,this).join(""),e=za.map(t,this).join("");return"P"+r+"T"+e;function t(n){
var i=this[n]||0;return n==="seconds"&&this.milliseconds&&(i=(i+this.milliseconds/1e3).toFixed(6).replace(
/0+$/,"")),i+Ga[n]}};var nr="([+-]?\\d+)",Ka=nr+"\\s+years?",Ya=nr+"\\s+mons?",Za=nr+"\\s+days?",Ja="\
([+-])?([\\d]*):(\\d\\d):(\\d\\d)\\.?(\\d{1,6})?",Xa=new RegExp([Ka,Ya,Za,Ja].map(function(r){return"\
("+r+")?"}).join("\\s*")),Mi={years:2,months:4,days:6,hours:9,minutes:10,seconds:11,milliseconds:12},
eu=["hours","minutes","seconds","milliseconds"];function tu(r){var e=r+"000000".slice(r.length);return parseInt(
e,10)/1e3}a(tu,"parseMilliseconds");function ru(r){if(!r)return{};var e=Xa.exec(r),t=e[8]==="-";return Object.
keys(Mi).reduce(function(n,i){var s=Mi[i],o=e[s];return!o||(o=i==="milliseconds"?tu(o):parseInt(o,10),
!o)||(t&&~eu.indexOf(i)&&(o*=-1),n[i]=o),n},{})}a(ru,"parse")});var Qi=T((Wf,qi)=>{"use strict";h();var Di=d.from||d;qi.exports=a(function(e){if(/^\\x/.test(e))return Di(
...
e[n+i]==="\\";)i++;for(var s=0;s<Math.floor(i/2);++s)t+="\\";n+=Math.floor(i/2)*2}return Di(t,"binar\
y")},"parseBytea")});var Vi=T(($f,Gi)=>{h();var Ve=er(),ze=tr(),St=Bi(),Wi=Oi(),ji=Qi();function Et(r){return a(function(t){
return t===null?t:r(t)},"nullAllowed")}a(Et,"allowNull");function Hi(r){return r===null?r:r==="TRUE"||
r==="t"||r==="true"||r==="y"||r==="yes"||r==="on"||r==="1"}a(Hi,"parseBool");function nu(r){return r?
Ve.parse(r,Hi):null}a(nu,"parseBoolArray");function iu(r){return parseInt(r,10)}a(iu,"parseBaseTenIn\
t");function ir(r){return r?Ve.parse(r,Et(iu)):null}a(ir,"parseIntegerArray");function su(r){return r?
Ve.parse(r,Et(function(e){return $i(e).trim()})):null}a(su,"parseBigIntegerArray");var ou=a(function(r){
...
function(t){return t!==null&&(t=St(t)),t});return e.parse()},"parseDateArray"),au=a(function(r){if(!r)
return null;var e=ze.create(r,function(t){return t!==null&&(t=Wi(t)),t});return e.parse()},"parseInt\
ervalArray"),uu=a(function(r){return r?Ve.parse(r,Et(ji)):null},"parseByteAArray"),ar=a(function(r){
return parseInt(r,10)},"parseInteger"),$i=a(function(r){var e=String(r);return/^\d+$/.test(e)?e:r},"\
parseBigInteger"),Ni=a(function(r){return r?Ve.parse(r,Et(JSON.parse)):null},"parseJsonArray"),ur=a(
function(r){return r[0]!=="("?null:(r=r.substring(1,r.length-1).split(","),{x:parseFloat(r[0]),y:parseFloat(
r[1])})},"parsePoint"),cu=a(function(r){if(r[0]!=="<"&&r[1]!=="(")return null;for(var e="(",t="",n=!1,
i=2;i<r.length-1;i++){if(n||(e+=r[i]),r[i]===")"){n=!0;continue}else if(!n)continue;r[i]!==","&&(t+=
r[i])}var s=ur(e);return s.radius=parseFloat(t),s},"parseCircle"),lu=a(function(r){r(20,$i),r(21,ar),
r(23,ar),r(26,ar),r(700,parseFloat),r(701,parseFloat),r(16,Hi),r(1082,St),r(1114,St),r(1184,St),r(600,
ur),r(651,ee),r(718,cu),r(1e3,nu),r(1001,uu),r(1005,ir),r(1007,ir),r(1028,ir),r(1016,su),r(1017,ou),
r(1021,sr),r(1022,sr),r(1231,sr),r(1014,ee),r(1015,ee),r(1008,ee),r(1009,ee),r(1040,ee),r(1041,ee),r(
1115,or),r(1182,or),r(1185,or),r(1186,Wi),r(1187,au),r(17,ji),r(114,JSON.parse.bind(JSON)),r(3802,JSON.
parse.bind(JSON)),r(199,Ni),r(3807,Ni),r(3907,ee),r(2951,ee),r(791,ee),r(1183,ee),r(1270,ee)},"init");
Gi.exports={init:lu}});var Ki=T((zf,zi)=>{"use strict";h();var K=1e6;function fu(r){var e=r.readInt32BE(0),t=r.readUInt32BE(
...
""+o%K,n+u+i}a(fu,"readInt8");zi.exports=fu});var es=T((Zf,Xi)=>{h();var hu=Ki(),B=a(function(r,e,t,n,i){t=t||0,n=n||!1,i=i||function(w,v,M){return w*
...
r[y]),8);var g=(e+t)%8;return g>0&&(l=i(l,o(r[f])>>8-g,g)),l},"parseBits"),Ji=a(function(r,e,t){var n=Math.
pow(2,t-1)-1,i=B(r,1),s=B(r,t,1);if(s===0)return 0;var o=1,u=a(function(l,f,y){l===0&&(l=1);for(var g=1;g<=
y;g++)o/=2,(f&1<<y-g)>0&&(l+=o);return l},"parsePrecisionBits"),c=B(r,e,t+1,!1,u);return s==Math.pow(
2,t+1)-1?c===0?i===0?1/0:-1/0:NaN:(i===0?1:-1)*Math.pow(2,s-n)*c},"parseFloatFromBits"),pu=a(function(r){
return B(r,1)==1?-1*(B(r,15,1,!0)+1):B(r,15,1)},"parseInt16"),Yi=a(function(r){return B(r,1)==1?-1*(B(
r,31,1,!0)+1):B(r,31,1)},"parseInt32"),du=a(function(r){return Ji(r,23,8)},"parseFloat32"),yu=a(function(r){
return Ji(r,52,11)},"parseFloat64"),mu=a(function(r){var e=B(r,16,32);if(e==49152)return NaN;for(var t=Math.
pow(1e4,B(r,16,16)),n=0,i=[],s=B(r,16),o=0;o<s;o++)n+=B(r,16,64+16*o)*t,t/=1e4;var u=Math.pow(10,B(r,
16,48));return(e===0?1:-1)*Math.round(n*u)/u},"parseNumeric"),Zi=a(function(r,e){var t=B(e,1),n=B(e,
...
var f=B(r,32,i);if(i+=32,f==4294967295)return null;var y;if(l==23||l==20)return y=B(r,f*8,i),i+=f*8,
...
"parseArray"),gu=a(function(r){return r.toString("utf8")},"parseText"),wu=a(function(r){return r===null?
null:B(r,8)>0},"parseBool"),bu=a(function(r){r(20,hu),r(21,pu),r(23,Yi),r(26,Yi),r(1700,mu),r(700,du),
r(701,yu),r(16,wu),r(1114,Zi.bind(null,!1)),r(1184,Zi.bind(null,!0)),r(1e3,Ke),r(1007,Ke),r(1016,Ke),
r(1008,Ke),r(1009,Ke),r(25,gu)},"init");Xi.exports={init:bu}});var rs=T((eh,ts)=>{h();ts.exports={BOOL:16,BYTEA:17,CHAR:18,INT8:20,INT2:21,INT4:23,REGPROC:24,TEXT:25,
...
REGROLE:4096}});var Je=T(Ze=>{h();var xu=Vi(),vu=es(),Su=tr(),Eu=rs();Ze.getTypeParser=Au;Ze.setTypeParser=Cu;Ze.arrayParser=
Su;Ze.builtins=Eu;var Ye={text:{},binary:{}};function ns(r){return String(r)}a(ns,"noParse");function Au(r,e){
return e=e||"text",Ye[e]&&Ye[e][r]||ns}a(Au,"getTypeParser");function Cu(r,e,t){typeof e=="function"&&
(t=e,e="text"),Ye[e][r]=t}a(Cu,"setTypeParser");xu.init(function(r,e){Ye.text[r]=e});vu.init(function(r,e){
Ye.binary[r]=e})});var Ct=T((sh,is)=>{"use strict";h();var _u=Je();function At(r){this._types=r||_u,this.text={},this.binary=
...
e||"text",this.getOverrides(e)[r]||this._types.getTypeParser(r,e)};is.exports=At});function Xe(r){let e=1779033703,t=3144134277,n=1013904242,i=2773480762,s=1359893119,o=2600822924,u=528734635,
...
for(let R=0;R<64;R++){let $=g(H,6)^g(H,11)^g(H,25),Ee=H&oe^~H&ae,ue=me+$+Ee+y[R]+w[R]|0,Te=g(I,2)^g(
...
est");return r===void 0?{add:q,digest:he}:(q(r),he())}var ss=V(()=>{"use strict";h();a(Xe,"sha256")});var k,et,os=V(()=>{"use strict";h();k=class k{constructor(){E(this,"_dataLength",0);E(this,"_bufferL\
...
abcdef"),E(k,"hexOut",[]),E(k,"onePassHasher",new k);et=k});var cr={};se(cr,{createHash:()=>Iu,createHmac:()=>Pu,randomBytes:()=>Tu});function Tu(r){return crypto.
getRandomValues(d.alloc(r))}function Iu(r){if(r==="sha256")return{update:a(function(e){return{digest:a(
...
throw new Error(`Hash type '${r}' not supported`)}function Pu(r,e){if(r!=="sha256")throw new Error(`\
...
"digest")}},"update")}}var lr=V(()=>{"use strict";h();ss();os();a(Tu,"randomBytes");a(Iu,"createHash");
a(Pu,"createHmac")});var tt=T((wh,fr)=>{"use strict";h();fr.exports={host:"localhost",user:m.platform==="win32"?m.env.USERNAME:
...
keepalives:1,keepalives_idle:0};var Me=Je(),Ru=Me.getTypeParser(20,"text"),Lu=Me.getTypeParser(1016,
"text");fr.exports.__defineSetter__("parseInt8",function(r){Me.setTypeParser(20,"text",r?Me.getTypeParser(
23,"text"):Ru),Me.setTypeParser(1016,"text",r?Me.getTypeParser(1007,"text"):Lu)})});var rt=T((xh,us)=>{"use strict";h();var Bu=(lr(),U(cr)),Fu=tt();function ku(r){var e=r.replace(/\\/g,
"\\\\").replace(/"/g,'\\"');return'"'+e+'"'}a(ku,"escapeElement");function as(r){for(var e="{",t=0;t<
r.length;t++)t>0&&(e=e+","),r[t]===null||typeof r[t]>"u"?e=e+"NULL":Array.isArray(r[t])?e=e+as(r[t]):
r[t]instanceof d?e+="\\\\x"+r[t].toString("hex"):e+=ku(_t(r[t]));return e=e+"}",e}a(as,"arrayString");
...
r.byteLength)}return r instanceof Date?Fu.parseInputDatesAsUTC?Ou(r):Uu(r):Array.isArray(r)?as(r):typeof r==
"object"?Mu(r,e):r.toString()},"prepareValue");function Mu(r,e){if(r&&typeof r.toPostgres=="function"){
if(e=e||[],e.indexOf(r)!==-1)throw new Error('circular reference detected while preparing "'+r+'" fo\
r query');return e.push(r),_t(r.toPostgres(_t),e)}return JSON.stringify(r)}a(Mu,"prepareObject");function W(r,e){
for(r=""+r;r.length<e;)r="0"+r;return r}a(W,"pad");function Uu(r){var e=-r.getTimezoneOffset(),t=r.getFullYear(),
...
-1):i+="+",i+=W(Math.floor(e/60),2)+":"+W(e%60,2),n&&(i+=" BC"),i}a(Uu,"dateToString");function Ou(r){
...
r.getUTCMilliseconds(),3);return n+="+00:00",t&&(n+=" BC"),n}a(Ou,"dateToStringUTC");function Du(r,e,t){
return r=typeof r=="string"?{text:r}:r,e&&(typeof e=="function"?r.callback=e:r.values=e),t&&(r.callback=
t),r}a(Du,"normalizeQueryConfig");var hr=a(function(r){return Bu.createHash("md5").update(r,"utf-8").
digest("hex")},"md5"),qu=a(function(r,e,t){var n=hr(e+r),i=hr(d.concat([d.from(n),t]));return"md5"+i},
"postgresMd5PasswordHash");us.exports={prepareValue:a(function(e){return _t(e)},"prepareValueWrapper"),
normalizeQueryConfig:Du,postgresMd5PasswordHash:qu,md5:hr}});var nt={};se(nt,{default:()=>Wu});var Wu,it=V(()=>{"use strict";h();Wu={}});var bs=T((kh,ws)=>{"use strict";h();var pr=(lr(),U(cr));function ju(r){if(r.indexOf("SCRAM-SHA-256")===
...
SASLInitialResponse"}}a(ju,"startSession");function Hu(r,e,t){if(r.message!=="SASLInitialResponse")throw new Error(
...
L: SCRAM-SERVER-FIRST-MESSAGE: serverData must be a string");let n=Vu(t);if(n.nonce.startsWith(r.clientNonce)){
...
art with client nonce");var i=d.from(n.salt,"base64"),s=Yu(e,i,n.iteration),o=Ue(s,"Client Key"),u=Ku(
o),c="n=*,r="+r.clientNonce,l="r="+n.nonce+",s="+n.salt+",i="+n.iteration,f="c=biws,r="+n.nonce,y=c+
","+l+","+f,g=Ue(u,y),w=gs(o,g),v=w.toString("base64"),M=Ue(s,"Server Key"),q=Ue(M,y);r.message="SAS\
LResponse",r.serverSignature=q.toString("base64"),r.response=f+",p="+v}a(Hu,"continueSession");function $u(r,e){
...
e);if(t!==r.serverSignature)throw new Error("SASL: SCRAM-SERVER-FINAL-MESSAGE: server signature does\
 not match")}a($u,"finalizeSession");function Gu(r){if(typeof r!="string")throw new TypeError("SASL:\
 text must be a string");return r.split("").map((e,t)=>r.charCodeAt(t)).every(e=>e>=33&&e<=43||e>=45&&
e<=126)}a(Gu,"isPrintableChars");function ys(r){return/^(?:[a-zA-Z0-9+/]{4})*(?:[a-zA-Z0-9+/]{2}==|[a-zA-Z0-9+/]{3}=)?$/.
...
Pairs");function Vu(r){let e=ms(r),t=e.get("r");if(t){if(!Gu(t))throw new Error("SASL: SCRAM-SERVER-\
...
tion missing");let s=parseInt(i,10);return{nonce:t,salt:n,iteration:s}}a(Vu,"parseServerFirstMessage");
function zu(r){let t=ms(r).get("v");if(t){if(!ys(t))throw new Error("SASL: SCRAM-SERVER-FINAL-MESSAG\
E: server signature must be base64")}else throw new Error("SASL: SCRAM-SERVER-FINAL-MESSAGE: server \
signature is missing");return{serverSignature:t}}a(zu,"parseServerFinalMessage");function gs(r,e){if(!d.
...
a(gs,"xorBuffers");function Ku(r){return pr.createHash("sha256").update(r).digest()}a(Ku,"sha256");function Ue(r,e){
return pr.createHmac("sha256",r).update(e).digest()}a(Ue,"hmacSha256");function Yu(r,e,t){for(var n=Ue(
r,d.concat([e,d.from([0,0,0,1])])),i=n,s=0;s<t-1;s++)n=Ue(r,n),i=gs(i,n);return i}a(Yu,"Hi");ws.exports=
{startSession:ju,continueSession:Hu,finalizeSession:$u}});var dr={};se(dr,{join:()=>Zu});function Zu(...r){return r.join("/")}var yr=V(()=>{"use strict";h();a(
Zu,"join")});var mr={};se(mr,{stat:()=>Ju});function Ju(r,e){e(new Error("No filesystem"))}var gr=V(()=>{"use str\
ict";h();a(Ju,"stat")});var wr={};se(wr,{default:()=>Xu});var Xu,br=V(()=>{"use strict";h();Xu={}});var xs={};se(xs,{StringDecoder:()=>xr});var vr,xr,vs=V(()=>{"use strict";h();vr=class vr{constructor(e){
E(this,"td");this.td=new TextDecoder(e)}write(e){return this.td.decode(e,{stream:!0})}end(e){return this.
td.decode(e)}};a(vr,"StringDecoder");xr=vr});var Cs=T((Hh,As)=>{"use strict";h();var{Transform:ec}=(br(),U(wr)),{StringDecoder:tc}=(vs(),U(xs)),Se=Symbol(
"last"),Tt=Symbol("decoder");function rc(r,e,t){let n;if(this.overflow){if(n=this[Tt].write(r).split(
this.matcher),n.length===1)return t();n.shift(),this.overflow=!1}else this[Se]+=this[Tt].write(r),n=
this[Se].split(this.matcher);this[Se]=n.pop();for(let i=0;i<n.length;i++)try{Es(this,this.mapper(n[i]))}catch(s){
return t(s)}if(this.overflow=this[Se].length>this.maxLength,this.overflow&&!this.skipOverflow){t(new Error(
"maximum buffer reached"));return}t()}a(rc,"transform");function nc(r){if(this[Se]+=this[Tt].end(),this[Se])
try{Es(this,this.mapper(this[Se]))}catch(e){return r(e)}r()}a(nc,"flush");function Es(r,e){e!==void 0&&
r.push(e)}a(Es,"push");function Ss(r){return r}a(Ss,"noop");function ic(r,e,t){switch(r=r||/\r?\n/,e=
...
"object"&&(t=e,e=Ss)}t=Object.assign({},t),t.autoDestroy=!0,t.transform=rc,t.flush=nc,t.readableObjectMode=
!0;let n=new ec(t);return n[Se]="",n[Tt]=new tc("utf8"),n.matcher=r,n.mapper=e,n.maxLength=t.maxLength,
n.skipOverflow=t.skipOverflow||!1,n.overflow=!1,n._destroy=function(i,s){this._writableState.errorEmitted=
!1,s(i)},n}a(ic,"split");As.exports=ic});var Is=T((Vh,ye)=>{"use strict";h();var _s=(yr(),U(dr)),sc=(br(),U(wr)).Stream,oc=Cs(),Ts=(it(),U(nt)),
ac=5432,It=m.platform==="win32",st=m.stderr,uc=56,cc=7,lc=61440,fc=32768;function hc(r){return(r&lc)==
fc}a(hc,"isRegFile");var Oe=["host","port","database","user","password"],Sr=Oe.length,pc=Oe[Sr-1];function Er(){
var r=st instanceof sc&&st.writable===!0;if(r){var e=Array.prototype.slice.call(arguments).concat(`
`);st.write(Ts.format.apply(Ts,e))}}a(Er,"warn");Object.defineProperty(ye.exports,"isWin",{get:a(function(){
return It},"get"),set:a(function(r){It=r},"set")});ye.exports.warnTo=function(r){var e=st;return st=
r,e};ye.exports.getFileName=function(r){var e=r||m.env,t=e.PGPASSFILE||(It?_s.join(e.APPDATA||"./","\
postgresql","pgpass.conf"):_s.join(e.HOME||"./",".pgpass"));return t};ye.exports.usePgPass=function(r,e){
return Object.prototype.hasOwnProperty.call(m.env,"PGPASSWORD")?!1:It?!0:(e=e||"<unkn>",hc(r.mode)?r.
mode&(uc|cc)?(Er('WARNING: password file "%s" has group or world access; permissions should be u=rw \
(0600) or less',e),!1):!0:(Er('WARNING: password file "%s" is not a plain file',e),!1))};var dc=ye.exports.
match=function(r,e){return Oe.slice(0,-1).reduce(function(t,n,i){return i==1&&Number(r[n]||ac)===Number(
e[n])?t&&!0:t&&(e[n]==="*"||e[n]===r[n])},!0)};ye.exports.getPassword=function(r,e,t){var n,i=e.pipe(
oc());function s(c){var l=yc(c);l&&mc(l)&&dc(r,l)&&(n=l[pc],i.end())}a(s,"onLine");var o=a(function(){
e.destroy(),t(n)},"onEnd"),u=a(function(c){e.destroy(),Er("WARNING: error on reading file: %s",c),t(
void 0)},"onErr");e.on("error",u),i.on("data",s).on("end",o).on("error",u)};var yc=ye.exports.parseLine=
...
length===Sr?o:null,o},mc=ye.exports.isValidEntry=function(r){for(var e={0:function(o){return o.length>
...
0}},t=0;t<Oe.length;t+=1){var n=e[t],i=r[Oe[t]]||"",s=n(i);if(!s)return!1}return!0}});var Rs=T((Zh,Ar)=>{"use strict";h();var Yh=(yr(),U(dr)),Ps=(gr(),U(mr)),Pt=Is();Ar.exports=function(r,e){
var t=Pt.getFileName();Ps.stat(t,function(n,i){if(n||!Pt.usePgPass(i,t))return e(void 0);var s=Ps.createReadStream(
t);Pt.getPassword(r,s,e)})};Ar.exports.warnTo=Pt.warnTo});var Ls={};se(Ls,{default:()=>gc});var gc,Bs=V(()=>{"use strict";h();gc={}});var Fs={};se(Fs,{parse:()=>wc});function wc(r,e=!1){let{protocol:t}=new URL(r),n="http:"+r.substring(
...
pathname:l,search:f,query:v,hash:g}}var ks=V(()=>{"use strict";h();a(wc,"parse")});var Tr=T((rp,Ms)=>{"use strict";h();var bc=(ks(),U(Fs)),Cr=(gr(),U(mr));function _r(r){if(r.charAt(0)===
"/"){var t=r.split(" ");return{host:t[0],database:t[1]}}var e=bc.parse(/ |%[^a-f0-9]|%[a-f0-9][^a-f0-9]/i.
...
!1;break}}return t}a(_r,"parse");Ms.exports=_r;_r.parse=_r});var Rt=T((sp,Ds)=>{"use strict";h();var xc=(Bs(),U(Ls)),Os=tt(),Us=Tr().parse,j=a(function(r,e,t){return t===
void 0?t=m.env["PG"+r.toUpperCase()]:t===!1||(t=m.env[t]),e[r]||t||Os[r]},"val"),vc=a(function(){switch(m.
env.PGSSLMODE){case"disable":return!1;case"prefer":case"require":case"verify-ca":case"verify-full":return!0;case"\
no-verify":return{rejectUnauthorized:!1}}return Os.ssl},"readSSLConfigFromEnvironment"),De=a(function(r){
return"'"+(""+r).replace(/\\/g,"\\\\").replace(/'/g,"\\'")+"'"},"quoteParamValue"),te=a(function(r,e,t){
var n=e[t];n!=null&&r.push(t+"="+De(n))},"add"),Pr=class Pr{constructor(e){e=typeof e=="string"?Us(e):
e||{},e.connectionString&&(e=Object.assign({},e,Us(e.connectionString))),this.user=j("user",e),this.
...
ssl>"u"?vc():e.ssl,typeof this.ssl=="string"&&this.ssl==="true"&&(this.ssl=!0),this.ssl==="no-verify"&&
...
xc.lookup(this.host,function(i,s){return i?e(i,null):(t.push("hostaddr="+De(s)),e(null,t.join(" ")))})}};
a(Pr,"ConnectionParameters");var Ir=Pr;Ds.exports=Ir});var Ns=T((up,Qs)=>{"use strict";h();var Sc=Je(),qs=/^([A-Za-z]+)(?: (\d+))?(?: (\d+))?/,Lr=class Lr{constructor(e,t){
...
_types.getTypeParser(n.dataTypeID,n.format||"text"):this._parsers[t]=Sc.getTypeParser(n.dataTypeID,n.
format||"text")}}};a(Lr,"Result");var Rr=Lr;Qs.exports=Rr});var $s=T((fp,Hs)=>{"use strict";h();var{EventEmitter:Ec}=ve(),Ws=Ns(),js=rt(),Fr=class Fr extends Ec{constructor(e,t,n){
super(),e=js.normalizeQueryConfig(e,t,n),this.text=e.text,this.values=e.values,this.rows=e.rows,this.
...
new Ws(this._rowMode,this.types),this._results=this._result,this.isPreparedStatement=!1,this._canceledDueToError=
...
_results=[this._result]),this._result=new Ws(this._rowMode,this.types),this._results.push(this._result))}handleRowDescription(e){
...
portal,statement:this.name,values:this.values,binary:this.binary,valueMapper:js.prepareValue})}catch(t){
this.handleError(t,e);return}e.describe({type:"P",name:this.portal||""}),this._getRows(e,this.rows)}handleCopyInResponse(e){
e.sendCopyFail("No source stream defined")}handleCopyData(e,t){}};a(Fr,"Query");var Br=Fr;Hs.exports=
Br});var cn=T(_=>{"use strict";h();Object.defineProperty(_,"__esModule",{value:!0});_.NoticeMessage=_.DataRowMessage=
...
ssage");var Vr=un;_.NoticeMessage=Vr});var Gs=T(Lt=>{"use strict";h();Object.defineProperty(Lt,"__esModule",{value:!0});Lt.Writer=void 0;var fn=class fn{constructor(e=256){
...
a(fn,"Writer");var ln=fn;Lt.Writer=ln});var zs=T(Ft=>{"use strict";h();Object.defineProperty(Ft,"__esModule",{value:!0});Ft.serialize=void 0;
var hn=Gs(),L=new hn.Writer,Ac=a(r=>{L.addInt16(3).addInt16(0);for(let n of Object.keys(r))L.addCString(
n).addCString(r[n]);L.addCString("client_encoding").addCString("UTF8");let e=L.addCString("").flush(),
t=e.length+4;return new hn.Writer().addInt32(t).add(e).flush()},"startup"),Cc=a(()=>{let r=d.allocUnsafe(
8);return r.writeInt32BE(8,0),r.writeInt32BE(80877103,4),r},"requestSsl"),_c=a(r=>L.addCString(r).flush(
112),"password"),Tc=a(function(r,e){return L.addCString(r).addInt32PrefixedString(e),L.flush(112)},"\
sendSASLInitialResponseMessage"),Ic=a(function(r){return L.addString(r).flush(112)},"sendSCRAMClient\
FinalMessage"),Pc=a(r=>L.addCString(r).flush(81),"query"),Vs=[],Rc=a(r=>{let e=r.name||"";e.length>63&&
...
eries"));let t=r.types||Vs,n=t.length,i=L.addCString(e).addCString(r.text).addInt16(n);for(let s=0;s<
n;s++)i.addInt32(t[s]);return L.flush(80)},"parse"),qe=new hn.Writer,Lc=a(function(r,e){for(let t=0;t<
r.length;t++){let n=e?e(r[t],t):r[t];n==null?(L.addInt16(0),qe.addInt32(-1)):n instanceof d?(L.addInt16(
1),qe.addInt32(n.length),qe.add(n)):(L.addInt16(0),qe.addInt32PrefixedString(n))}},"writeValues"),Bc=a(
(r={})=>{let e=r.portal||"",t=r.statement||"",n=r.binary||!1,i=r.values||Vs,s=i.length;L.addCString(
e).addCString(t),L.addInt16(s);try{Lc(i,r.valueMapper)}catch(o){throw L.clear(),qe.clear(),o}return L.
addInt16(s),L.add(qe.flush()),L.addInt16(1),L.addInt16(n?1:0),L.flush(66)},"bind"),Fc=d.from([69,0,0,
0,9,0,0,0,0,0]),kc=a(r=>{if(!r||!r.portal&&!r.rows)return Fc;let e=r.portal||"",t=r.rows||0,n=d.byteLength(
e),i=4+n+1+4,s=d.allocUnsafe(1+i);return s[0]=69,s.writeInt32BE(i,1),s.write(e,5,"utf-8"),s[n+5]=0,s.
writeUInt32BE(t,s.length-4),s},"execute"),Mc=a((r,e)=>{let t=d.allocUnsafe(16);return t.writeInt32BE(
...
i.write(e,5,"utf-8"),i[n]=0,i},"cstringMessage"),Uc=L.addCString("P").flush(68),Oc=L.addCString("S").
flush(68),Dc=a(r=>r.name?pn(68,`${r.type}${r.name||""}`):r.type==="P"?Uc:Oc,"describe"),qc=a(r=>{let e=`${r.
type}${r.name||""}`;return pn(67,e)},"close"),Qc=a(r=>L.add(r).flush(100),"copyData"),Nc=a(r=>pn(102,
r),"copyFail"),Bt=a(r=>d.from([r,0,0,0,4]),"codeOnlyBuffer"),Wc=Bt(72),jc=Bt(83),Hc=Bt(88),$c=Bt(99),
Gc={startup:Ac,password:_c,requestSsl:Cc,sendSASLInitialResponseMessage:Tc,sendSCRAMClientFinalMessage:Ic,
query:Pc,parse:Rc,bind:Bc,execute:kc,describe:Dc,close:qc,flush:a(()=>Wc,"flush"),sync:a(()=>jc,"syn\
c"),end:a(()=>Hc,"end"),copyData:Qc,copyDone:a(()=>$c,"copyDone"),copyFail:Nc,cancel:Mc};Ft.serialize=
Gc});var Ks=T(kt=>{"use strict";h();Object.defineProperty(kt,"__esModule",{value:!0});kt.BufferReader=void 0;
...
offset+=e,t}};a(yn,"BufferReader");var dn=yn;kt.BufferReader=dn});var Xs=T(Mt=>{"use strict";h();Object.defineProperty(Mt,"__esModule",{value:!0});Mt.Parser=void 0;var F=cn(),
Vc=Ks(),gn=1,zc=4,Ys=gn+zc,Z=-1,mn=d.allocUnsafe(0),bn=class bn{constructor(e){if(this.buffer=mn,this.
bufferLength=0,this.bufferOffset=0,this.reader=new Vc.BufferReader,e?.mode==="binary")throw new Error(
"Binary mode not supported yet");this.mode=e?.mode||"text"}parse(e,t){this.mergeBuffer(e);let n=this.
bufferOffset+this.bufferLength,i=this.bufferOffset;for(;i+Ys<=n;){let s=this.buffer[i],o=this.buffer.
readUInt32BE(i+gn),u=gn+o;if(u+i<=n){let c=this.handlePacket(i+Ys,s,o,this.buffer);t(c),i+=u}else break}
...
break;case 73:o=F.emptyQuery;break;case 68:o=il(s);break;case 67:o=Yc(s);break;case 90:o=Kc(s);break;case 65:
o=el(s);break;case 82:o=al(s,n);break;case 83:o=sl(s);break;case 75:o=ol(s);break;case 69:o=Zs(s,"er\
ror");break;case 78:o=Zs(s,"notice");break;case 84:o=tl(s);break;case 116:o=nl(s);break;case 71:o=Jc(
s);break;case 72:o=Xc(s);break;case 100:o=Zc(s,n);break;default:return new F.DatabaseError("received\
 invalid response: "+t.toString(16),n,"error")}return s.setBuffer(0,mn),o.length=n,o}};a(bn,"Parser");
var wn=bn;Mt.Parser=wn;var Kc=a(r=>{let e=r.string(1);return new F.ReadyForQueryMessage(Z,e)},"parse\
ReadyForQueryMessage"),Yc=a(r=>{let e=r.cstring();return new F.CommandCompleteMessage(Z,e)},"parseCo\
mmandCompleteMessage"),Zc=a((r,e)=>{let t=r.bytes(e-4);return new F.CopyDataMessage(Z,t)},"parseCopy\
Data"),Jc=a(r=>Js(r,"copyInResponse"),"parseCopyInMessage"),Xc=a(r=>Js(r,"copyOutResponse"),"parseCo\
pyOutMessage"),Js=a((r,e)=>{let t=r.byte()!==0,n=r.int16(),i=new F.CopyResponse(Z,e,t,n);for(let s=0;s<
n;s++)i.columnTypes[s]=r.int16();return i},"parseCopyMessage"),el=a(r=>{let e=r.int32(),t=r.cstring(),
n=r.cstring();return new F.NotificationResponseMessage(Z,e,t,n)},"parseNotificationMessage"),tl=a(r=>{
let e=r.int16(),t=new F.RowDescriptionMessage(Z,e);for(let n=0;n<e;n++)t.fields[n]=rl(r);return t},"\
parseRowDescriptionMessage"),rl=a(r=>{let e=r.cstring(),t=r.uint32(),n=r.int16(),i=r.uint32(),s=r.int16(),
o=r.int32(),u=r.int16()===0?"text":"binary";return new F.Field(e,t,n,i,s,o,u)},"parseField"),nl=a(r=>{
let e=r.int16(),t=new F.ParameterDescriptionMessage(Z,e);for(let n=0;n<e;n++)t.dataTypeIDs[n]=r.uint32();
return t},"parseParameterDescriptionMessage"),il=a(r=>{let e=r.int16(),t=new Array(e);for(let n=0;n<
e;n++){let i=r.int32();t[n]=i===-1?null:r.string(i)}return new F.DataRowMessage(Z,t)},"parseDataRowM\
essage"),sl=a(r=>{let e=r.cstring(),t=r.cstring();return new F.ParameterStatusMessage(Z,e,t)},"parse\
ParameterStatusMessage"),ol=a(r=>{let e=r.int32(),t=r.int32();return new F.BackendKeyDataMessage(Z,e,
t)},"parseBackendKeyData"),al=a((r,e)=>{let t=r.int32(),n={name:"authenticationOk",length:e};switch(t){case 0:
...
t.n,s.file=t.F,s.line=t.L,s.routine=t.R,s},"parseErrorMessage")});var xn=T(_e=>{"use strict";h();Object.defineProperty(_e,"__esModule",{value:!0});_e.DatabaseError=_e.
serialize=void 0;_e.parse=fl;var ul=cn();Object.defineProperty(_e,"DatabaseError",{enumerable:!0,get:a(
function(){return ul.DatabaseError},"get")});var cl=zs();Object.defineProperty(_e,"serialize",{enumerable:!0,
get:a(function(){return cl.serialize},"get")});var ll=Xs();function fl(r,e){let t=new ll.Parser;return r.
on("data",n=>t.parse(n,e)),new Promise(n=>r.on("end",()=>n()))}a(fl,"parse")});var eo={};se(eo,{connect:()=>hl});function hl({socket:r,servername:e}){return r.startTls(e),r}var to=V(
()=>{"use strict";h();a(hl,"connect")});var En=T((kp,io)=>{"use strict";h();var ro=(Ge(),U(Ti)),pl=ve().EventEmitter,{parse:dl,serialize:D}=xn(),
no=D.flush(),yl=D.sync(),ml=D.end(),Sn=class Sn extends pl{constructor(e){super(),e=e||{},this.stream=
e.stream||new ro.Socket,this._keepAlive=e.keepAlive,this._keepAliveInitialDelayMillis=e.keepAliveInitialDelayMillis,
...
var u=(to(),U(eo));let c={socket:n.stream};n.ssl!==!0&&(Object.assign(c,n.ssl),"key"in n.ssl&&(c.key=
n.ssl.key)),ro.isIP(t)===0&&(c.servername=t);try{n.stream=u.connect(c)}catch(l){return n.emit("error",
l)}n.attachListeners(n.stream),n.stream.on("error",i),n.emit("sslconnect")})}attachListeners(e){e.on(
"end",()=>{this.emit("end")}),dl(e,t=>{var n=t.name==="error"?"errorMessage":t.name;this._emitMessage&&
...
stream.writable&&this.stream.write(no)}sync(){this._ending=!0,this._send(no),this._send(yl)}ref(){this.
stream.ref()}unref(){this.stream.unref()}end(){if(this._ending=!0,!this._connecting||!this.stream.writable){
this.stream.end();return}return this.stream.write(ml,()=>{this.stream.end()})}close(e){this._send(D.
close(e))}describe(e){this._send(D.describe(e))}sendCopyFromChunk(e){this._send(D.copyData(e))}endCopyFrom(){
this._send(D.copyDone())}sendCopyFail(e){this._send(D.copyFail(e))}};a(Sn,"Connection");var vn=Sn;io.
exports=vn});var ao=T((Dp,oo)=>{"use strict";h();var gl=ve().EventEmitter,Op=(it(),U(nt)),wl=rt(),An=bs(),bl=Rs(),
xl=Ct(),vl=Rt(),so=$s(),Sl=tt(),El=En(),Cn=class Cn extends gl{constructor(e){super(),this.connectionParameters=
new vl(e),this.user=this.connectionParameters.user,this.database=this.connectionParameters.database,
...
this._types=new xl(t.types),this._ending=!1,this._connecting=!1,this._connected=!1,this._connectionError=
...
password=this.password=null;e()}).catch(n=>{t.emit("error",n)}):this.password!==null?e():bl(this.connectionParameters,
n=>{n!==void 0&&(this.connectionParameters.password=this.password=n),e()})}_handleAuthCleartextPassword(e){
this._checkPgPass(()=>{this.connection.password(this.password)})}_handleAuthMD5Password(e){this._checkPgPass(
()=>{let t=wl.postgresMd5PasswordHash(this.user,this.password,e.salt);this.connection.password(t)})}_handleAuthSASL(e){
...
connectionParameters.query_timeout,i=new so(e,t,n),i.callback||(s=new this._Promise((l,f)=>{i.callback=
...
_Promise(t=>{this.connection.once("end",t)})}};a(Cn,"Client");var Ut=Cn;Ut.Query=so;oo.exports=Ut});var lo=T((Np,co)=>{"use strict";h();var Al=ve().EventEmitter,_n=a(function(){},"NOOP"),uo=a((r,e)=>{
...
this.callback=e}};a(Rn,"PendingItem");var Qe=Rn;function Cl(){throw new Error("Release called on cli\
ent which has already been released to the pool.")}a(Cl,"throwOnDoubleRelease");function Ot(r,e){if(e)
...
function _l(r,e){return a(function t(n){n.client=e,e.removeListener("error",t),e.on("error",()=>{r.log(
"additional client error after disconnection due to error",n)}),r._remove(e),r.emit("error",n,e)},"i\
dleListener")}a(_l,"makeIdleListener");var Ln=class Ln extends Al{constructor(e,t){super(),this.options=
...
_isFull())return this.newClient(e);throw new Error("unexpected condition")}_remove(e,t){let n=uo(this.
...
uo(this._pendingQueue,u=>u.callback===i),s.timedOut=!0,t.callback(new Error("timeout exceeded when t\
...
this._clients.push(t);let n=_l(this,t);this.log("checking client timeout");let i,s=!1;this.options.connectionTimeoutMillis&&
...
t.callback(void 0,e,e.release)}_releaseOnce(e,t){let n=!1;return i=>{n&&Cl(),n=!0,this._release(e,t,
...
co.exports=In});var fo={};se(fo,{default:()=>Tl});var Tl,ho=V(()=>{"use strict";h();Tl={}});var po=T(($p,Il)=>{Il.exports={name:"pg",version:"8.8.0",description:"PostgreSQL client - pure javas\
...
a178655"}});var go=T((Gp,mo)=>{"use strict";h();var yo=ve().EventEmitter,Pl=(it(),U(nt)),Bn=rt(),Ne=mo.exports=function(r,e,t){
yo.call(this),r=Bn.normalizeQueryConfig(r,e,t),this.text=r.text,this.values=r.values,this.name=r.name,
this.callback=r.callback,this.state="new",this._arrayMode=r.rowMode==="array",this._emitRowEvents=!1,
this.on("newListener",function(n){n==="row"&&(this._emitRowEvents=!0)}.bind(this))};Pl.inherits(Ne,yo);
var Rl={sqlState:"code",statementPosition:"position",messagePrimary:"message",context:"where",schemaName:"\
...
pq.resultErrorFields();if(e)for(var t in e){var n=Rl[t]||t;r[n]=e[t]}this.callback?this.callback(r):
...
prepareValue);r.native.query(this.text,i,t)}else r.native.query(this.text,t)}});var vo=T((Yp,xo)=>{"use strict";h();var Ll=(ho(),U(fo)),Bl=Ct(),Kp=po(),wo=ve().EventEmitter,Fl=(it(),U(nt)),
kl=Rt(),bo=go(),Y=xo.exports=function(r){wo.call(this),r=r||{},this._Promise=r.Promise||b.Promise,this.
_types=new Bl(r.types),this.native=new Ll({types:this._types}),this._queryQueue=[],this._ending=!1,this.
_connecting=!1,this._connected=!1,this._queryable=!0;var e=this.connectionParameters=new kl(r);this.
...
bo;Fl.inherits(Y,wo);Y.prototype._errorAllQueries=function(r){let e=a(t=>{m.nextTick(()=>{t.native=this.
...
e);else if(s=this.connectionParameters.query_timeout,n=new bo(r,e,t),!n.callback){let c,l;i=new this.
...
r,e,t)};Y.prototype.getTypeParser=function(r,e){return this._types.getTypeParser(r,e)}});var Fn=T((Xp,So)=>{"use strict";h();So.exports=vo()});var ot=T((td,at)=>{"use strict";h();var Ml=ao(),Ul=tt(),Ol=En(),Dl=lo(),{DatabaseError:ql}=xn(),Ql=a(
r=>{var e;return e=class extends Dl{constructor(n){super(n,r)}},a(e,"BoundPool"),e},"poolFactory"),kn=a(
function(r){this.defaults=Ul,this.Client=r,this.Query=this.Client.Query,this.Pool=Ql(this.Client),this.
_pools=[],this.Connection=Ol,this.types=Je(),this.DatabaseError=ql},"PG");typeof m.env.NODE_PG_FORCE_NATIVE<
"u"?at.exports=new kn(Fn()):(at.exports=new kn(Ml),Object.defineProperty(at.exports,"native",{configurable:!0,
enumerable:!1,get(){var r=null;try{r=new kn(Fn())}catch(e){if(e.code!=="MODULE_NOT_FOUND")throw e}return Object.
defineProperty(at.exports,"native",{value:r}),r}}))});h();h();h();var ha=Object.defineProperty,pa=Object.defineProperties,da=Object.getOwnPropertyDescriptors,oi=Object.
getOwnPropertySymbols,ya=Object.prototype.hasOwnProperty,ma=Object.prototype.propertyIsEnumerable,ai=a(
(r,e,t)=>e in r?ha(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t,"__defNormalProp"),
ga=a((r,e)=>{for(var t in e||(e={}))ya.call(e,t)&&ai(r,t,e[t]);if(oi)for(var t of oi(e))ma.call(e,t)&&
ai(r,t,e[t]);return r},"__spreadValues"),wa=a((r,e)=>pa(r,da(e)),"__spreadProps"),ba=1008e3,ui=new Uint8Array(
new Uint16Array([258]).buffer)[0]===2,xa=new TextDecoder,Kt=new TextEncoder,pt=Kt.encode("0123456789\
abcdef"),dt=Kt.encode("0123456789ABCDEF"),va=Kt.encode("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqr\
stuvwxyz0123456789+/");var ci=va.slice();ci[62]=45;ci[63]=95;var je,yt;function Sa(r,{alphabet:e,scratchArr:t}={}){if(!je)if(je=
...
r.buffer,r.byteOffset,s),c=new Uint32Array(o.buffer,o.byteOffset,i),l=e==="upper"?yt:je,f=0,y=0,g;if(ui)
...
return xa.decode(o.subarray(0,n))}a(Sa,"_toHex");function Ea(r,e={}){let t="",n=r.length,i=ba>>>1,s=Math.
ceil(n/i),o=new Uint16Array(s>1?i:n),u=wa(ga({},e),{scratchArr:o});for(let c=0;c<s;c++){let l=c*i,f=l+
i;t+=Sa(r.subarray(l,f),u)}return t}a(Ea,"_toHexChunked");function li(r,e={}){return e.alphabet!=="u\
pper"&&typeof r.toHex=="function"?r.toHex():Ea(r,e)}a(li,"toHex");h();h();var Yt=class Yt{constructor(e,t,n){E(this,"execute",e);E(this,"queryData",t);E(this,"opts",n)}then(e,t){
...
QueryPromise");var xe=Yt;var mt=class mt{constructor(e,t){E(this,"strings",e);E(this,"values",t)}toParameterizedQuery(e={query:"",
...
E(this,"sql",e)}};a(Zt,"UnsafeRawSql");var $e=Zt;h();function gt(){typeof window<"u"&&typeof document<"u"&&typeof console<"u"&&typeof console.warn=="func\
tion"&&console.warn(`          
        ************************************************************
        *                                                          *
...
wt,"NeonDbError");var N=wt,fi=["severity","code","detail","hint","position","internalPosition","inte\
rnalQuery","where","schema","table","column","dataType","constraint","file","line","routine"];function hi(r,e){let t,n;try{t=new URL(r).protocol,n=new URL("http:"+r.slice(t.length))}catch{throw new N(
...
mPgConnectionString");function Aa(r){return"postgresql:"+r.href.slice(r.protocol.length)}a(Aa,"pgCon\
nectionStringFromURL");var Ca=["connectionString","user","username","password","host","hostname","po\
rt","database"],_a={database:"pathname",user:"username",host:"hostname"};function pi(...r){let e={};
...
st and hostname");let n=hi(r,!1);await Promise.all(Ca.map(async u=>{if(u==="connectionString")return;
...
" must be a string${f} or a function resolving to one`)}let l=_a[u]??u;n[l]=c}));let{searchParams:i}=n;
for(let u in t)i.has(u)||i.append(u,t[u]);let s=Aa(n),o=hi(s,!0);return{resolvedConnectionString:s,resolvedURL:o}}
a(di,"resolveConnectionParams");Ge();var hs=we(Ct()),ps=we(rt());var cs="transaction() expects an array of queries, or a function returning an array of queries";function Qu(r){
return r instanceof d?"\\x"+li(r):r}a(Qu,"encodeBuffersAsBytea");function ls(r){let{query:e,params:t}=r instanceof
He?r.toParameterizedQuery():r;return{query:e,params:t.map(n=>Qu((0,ps.prepareValue)(n)))}}a(ls,"prep\
areQuery");function ds(r,e={}){typeof r!="string"&&(e=r??{},r=void 0);let{arrayMode:t,fullResults:n,
...
LECT $1", [value], options).');return new xe(y,new He(g,w))}a(f,"templateFn"),f.query=(g,w,v)=>new xe(
y,{query:g,params:w??[]},v),f.unsafe=g=>new $e(g),f.transaction=async(g,w)=>{if(typeof g=="function"&&
(g=g(f)),!Array.isArray(g))throw new Error(cs);g.forEach(q=>{if(!(q instanceof xe))throw new Error(cs)});
let v=g.map(q=>q.queryData),M=g.map(q=>q.opts??{});return y(v,M,w)};async function y(g,w,v){let{fetchEndpoint:M,
fetchFunction:q}=de,he=Array.isArray(g)?{queries:g.map(G=>ls(G))}:ls(g),I=i??{},C=t??!1,re=n??!1,ne=s,
...
void 0&&(ae=w.authToken);let me=pi(e,v??{},Array.isArray(w)||!w?{}:w),{resolvedConnectionString:R,resolvedURL:$}=await di(
r,me),Ee=typeof M=="function"?M($.hostname,$.port,{jwtAuth:ae!==void 0}):M,ue={"Neon-Connection-Stri\
ng":R,"Neon-Raw-Text-Output":"true","Neon-Array-Mode":"true"},Te=await Nu(ae);Te&&(ue.Authorization=
`Bearer ${Te}`),Array.isArray(g)&&(ne!==void 0&&(ue["Neon-Batch-Isolation-Level"]=ne),H!==void 0&&(ue["\
Neon-Batch-Read-Only"]=String(H)),oe!==void 0&&(ue["Neon-Batch-Deferrable"]=String(oe))),l||de.disableWarningInBrowsers||
gt();let ce;try{ce=await(q??fetch)(Ee,{method:"POST",body:JSON.stringify(he),headers:ue,...I})}catch(G){
let Q=new N(`Error connecting to database: ${G}`);throw Q.sourceError=G,Q}if(ce.ok){let G=await ce.json();
if(Array.isArray(g)){let Q=G.results;if(!Array.isArray(Q))throw new N("Neon internal error: unexpect\
ed result format");return Q.map((ge,J)=>{let ie=w[J]??{},Dt=ie.arrayMode??C,To=ie.fullResults??re;return fs(
ge,{arrayMode:Dt,fullResults:To,types:ie.types})})}else{let Q=w??{},ge=Q.arrayMode??C,J=Q.fullResults??
re;return fs(G,{arrayMode:ge,fullResults:J,types:Q.types})}}else{let{status:G}=ce;if(G===400){let Q=await ce.
json(),ge=new N(Q.message);for(let J of fi)ge[J]=Q[J]??void 0;throw ge}else{let Q=await ce.text();throw new N(
`Server error (HTTP status ${G}): ${Q}`)}}}return a(y,"execute"),f}a(ds,"neon");function fs(r,{arrayMode:e,
fullResults:t,types:n}){let i=new hs.default(n),s=r.fields.map(c=>c.name),o=r.fields.map(c=>i.getTypeParser(
...
o,r._types=i,r):u}a(fs,"processQueryResult");async function Nu(r){if(typeof r=="string")return r;if(typeof r==
"function")try{return await Promise.resolve(r())}catch(e){let t=new N("Error getting auth token.");throw e instanceof
Error&&(t=new N(`Error getting auth token: ${e.message}`)),t}}a(Nu,"getAuthToken");h();var Ao=we(ot());h();var Eo=we(ot());var Mn=class Mn extends Eo.Client{constructor(t){super(t);E(this,"config",t)}get neonConfig(){return this.
...
bind(this)));let f=this.password,y=Promise.resolve(typeof f=="function"?f():f),g=this.ssl?"sslconnec\
t":"connect";l.on(g,()=>{this.neonConfig.disableWarningInBrowsers||gt(),y.then(w=>{this.password=w,this.
_handleAuthCleartextPassword(),this._handleReadyForQuery()})})}return o}async _handleAuthSASLContinue(t){
...
A-256"}},!1,["sign"]),ne=new Uint8Array(await n.sign("HMAC",re,w.encode("Client Key"))),H=await n.digest(
"SHA-256",ne),oe="n=*,r="+i.clientNonce,ae="r="+c+",s="+l+",i="+y,me="c=biws,r="+c,R=oe+","+ae+","+me,
$=await n.importKey("raw",H,{name:"HMAC",hash:{name:"SHA-256"}},!1,["sign"]);var Ee=new Uint8Array(await n.
sign("HMAC",$,w.encode(R))),ue=d.from(ne.map((J,ie)=>ne[ie]^Ee[ie])),Te=ue.toString("base64");let ce=await n.
importKey("raw",C,{name:"HMAC",hash:{name:"SHA-256"}},!1,["sign"]),G=await n.sign("HMAC",ce,w.encode(
"Server Key")),Q=await n.importKey("raw",G,{name:"HMAC",hash:{name:"SHA-256"}},!1,["sign"]);var ge=d.
...
a(Mn,"NeonClient");var ut=Mn;Ge();var Co=we(Rt());function Nl(r,e){if(e)return{callback:e,result:void 0};let t,n,i=a(function(o,u){o?t(o):n(u)},"cb"),
s=new r(function(o,u){n=o,t=u});return{callback:i,result:s}}a(Nl,"promisify");var On=class On extends Ao.Pool{constructor(){
...
t,n,i);typeof n=="function"&&(i=n,n=void 0);let s=Nl(this.Promise,i);i=s.callback;try{let o=new Co.default(
...
w))}catch(o){i(o)}return s.result}};a(On,"NeonPool");var Un=On;Ge();var ct=we(ot());h();var _o=we(Tr());function Wl(r){return Object.entries(r).reduce((t,[n,i])=>(i!=null&&(t[n]=i),t),Object.create(null))}
a(Wl,"toConnectionOptions");function jl(r){return Object.entries(r).reduce((t,[n,i])=>{if(n==="ssl"){
let s=i;typeof s=="boolean"&&(t[n]=s),typeof s=="object"&&(t[n]=Wl(s))}else if(i!=null)if(n==="port"){
if(i!==""){let s=parseInt(i,10);if(isNaN(s))throw new Error(`Invalid ${n}: ${i}`);t[n]=s}}else t[n]=
i;return t},Object.create(null))}a(jl,"toClientConfig");function Hl(r){return jl((0,_o.parse)(r))}a(
Hl,"parseIntoClientConfig");var wd="mjs";var export_DatabaseError=ct.DatabaseError;var export_defaults=ct.defaults;var export_escapeIdentifier=ct.escapeIdentifier;
...
N as NeonDbError,Un as Pool,He as SqlTemplate,$e as UnsafeRawSql,wd as _bundleExt,export_defaults as defaults,
fi as errorFields,export_escapeIdentifier as escapeIdentifier,export_escapeLiteral as escapeLiteral,
ds as neon,de as neonConfig,Hl as parseIntoClientConfig,export_types as types};
