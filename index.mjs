...
var Eo=Object.create;var Ie=Object.defineProperty;var Ao=Object.getOwnPropertyDescriptor;var Co=Object.getOwnPropertyNames;var _o=Object.getPrototypeOf,Io=Object.prototype.hasOwnProperty;var To=(r,e,t)=>e in r?Ie(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t;var a=(r,e)=>Ie(r,"name",{value:e,configurable:!0});var $=(r,e)=>()=>(r&&(e=r(r=0)),e);var T=(r,e)=>()=>(e||r((e={exports:{}}).exports,e),e.exports),ie=(r,e)=>{for(var t in e)Ie(r,t,{get:e[t],
enumerable:!0})},qn=(r,e,t,n)=>{if(e&&typeof e=="object"||typeof e=="function")for(let i of Co(e))!Io.
call(r,i)&&i!==t&&Ie(r,i,{get:()=>e[i],enumerable:!(n=Ao(e,i))||n.enumerable});return r};var ge=(r,e,t)=>(t=r!=null?Eo(_o(r)):{},qn(e||!r||!r.__esModule?Ie(t,"default",{value:r,enumerable:!0}):
t,r)),O=r=>qn(Ie({},"__esModule",{value:!0}),r);var E=(r,e,t)=>To(r,typeof e!="symbol"?e+"":e,t);var Wn=T(ft=>{"use strict";p();ft.byteLength=Ro;ft.toByteArray=Lo;ft.fromByteArray=Mo;var ae=[],te=[],
Po=typeof Uint8Array<"u"?Uint8Array:Array,Qt="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz01\
23456789+/";for(Ee=0,Qn=Qt.length;Ee<Qn;++Ee)ae[Ee]=Qt[Ee],te[Qt.charCodeAt(Ee)]=Ee;var Ee,Qn;te[45]=
62;te[95]=63;function Nn(r){var e=r.length;if(e%4>0)throw new Error("Invalid string. Length must be \
a multiple of 4");var t=r.indexOf("=");t===-1&&(t=e);var n=t===e?0:4-t%4;return[t,n]}a(Nn,"getLens");
function Ro(r){var e=Nn(r),t=e[0],n=e[1];return(t+n)*3/4-n}a(Ro,"byteLength");function Bo(r,e,t){return(e+
t)*3/4-t}a(Bo,"_byteLength");function Lo(r){var e,t=Nn(r),n=t[0],i=t[1],s=new Po(Bo(r,n,i)),o=0,u=i>
...
4|te[r.charCodeAt(c+2)]>>2,s[o++]=e>>8&255,s[o++]=e&255),s}a(Lo,"toByteArray");function Fo(r){return ae[r>>
18&63]+ae[r>>12&63]+ae[r>>6&63]+ae[r&63]}a(Fo,"tripletToBase64");function ko(r,e,t){for(var n,i=[],s=e;s<
t;s+=3)n=(r[s]<<16&16711680)+(r[s+1]<<8&65280)+(r[s+2]&255),i.push(Fo(n));return i.join("")}a(ko,"en\
codeChunk");function Mo(r){for(var e,t=r.length,n=t%3,i=[],s=16383,o=0,u=t-n;o<u;o+=s)i.push(ko(r,o,
o+s>u?u:o+s));return n===1?(e=r[t-1],i.push(ae[e>>2]+ae[e<<4&63]+"==")):n===2&&(e=(r[t-2]<<8)+r[t-1],
i.push(ae[e>>10]+ae[e>>4&63]+ae[e<<2&63]+"=")),i.join("")}a(Mo,"fromByteArray")});var jn=T(Nt=>{p();Nt.read=function(r,e,t,n,i){var s,o,u=i*8-n-1,c=(1<<u)-1,l=c>>1,f=-7,y=t?i-1:0,w=t?
...
C,u/=256,i-=8);for(o=o<<i|u,l+=i;l>0;r[t+A]=o&255,A+=C,o/=256,l-=8);r[t+A-C]|=D*128}});var oi=T(Be=>{"use strict";p();var Wt=Wn(),Pe=jn(),Hn=typeof Symbol=="function"&&typeof Symbol.for==
"function"?Symbol.for("nodejs.util.inspect.custom"):null;Be.Buffer=h;Be.SlowBuffer=No;Be.INSPECT_MAX_BYTES=
...
this))return this.byteOffset},"get")});function he(r){if(r>ht)throw new RangeError('The value "'+r+'\
...
'The "string" argument must be of type string. Received type number');return $t(r)}return Kn(r,e,t)}
...
for option "size"')}a(zn,"assertSize");function Do(r,e,t){return zn(r),r<=0?he(r):e!==void 0?typeof t==
"string"?he(r).fill(e,t):he(r).fill(e):he(r)}a(Do,"alloc");h.alloc=function(r,e,t){return Do(r,e,t)};
function $t(r){return zn(r),he(r<0?0:Vt(r)|0)}a($t,"allocUnsafe");h.allocUnsafe=function(r){return $t(
r)};h.allocUnsafeSlow=function(r){return $t(r)};function Oo(r,e){if((typeof e!="string"||e==="")&&(e=
"utf8"),!h.isEncoding(e))throw new TypeError("Unknown encoding: "+e);let t=Yn(r,e)|0,n=he(t),i=n.write(
r,e);return i!==t&&(n=n.slice(0,i)),n}a(Oo,"fromString");function jt(r){let e=r.length<0?0:Vt(r.length)|
0,t=he(e);for(let n=0;n<e;n+=1)t[n]=r[n]&255;return t}a(jt,"fromArrayLike");function qo(r){if(ue(r,Uint8Array)){
let e=new Uint8Array(r);return Ht(e.buffer,e.byteOffset,e.byteLength)}return jt(r)}a(qo,"fromArrayVi\
...
let e=Vt(r.length)|0,t=he(e);return t.length===0||r.copy(t,0,0,e),t}if(r.length!==void 0)return typeof r.
length!="number"||zt(r.length)?he(0):jt(r);if(r.type==="Buffer"&&Array.isArray(r.data))return jt(r.data)}
a(Qo,"fromObject");function Vt(r){if(r>=ht)throw new RangeError("Attempt to allocate Buffer larger t\
han maximum size: 0x"+ht.toString(16)+" bytes");return r|0}a(Vt,"checked");function No(r){return+r!=
r&&(r=0),h.alloc(+r)}a(No,"SlowBuffer");h.isBuffer=a(function(e){return e!=null&&e._isBuffer===!0&&e!==
...
if(i)return n?-1:Gt(r).length;e=(""+e).toLowerCase(),i=!0}}a(Yn,"byteLength");h.byteLength=Yn;function Wo(r,e,t){
let n=!1;if((e===void 0||e<0)&&(e=0),e>this.length||((t===void 0||t>this.length)&&(t=this.length),t<=
0)||(t>>>=0,e>>>=0,t<=e))return"";for(r||(r="utf8");;)switch(r){case"hex":return Jo(this,e,t);case"u\
tf8":case"utf-8":return Jn(this,e,t);case"ascii":return Yo(this,e,t);case"latin1":case"binary":return Zo(
this,e,t);case"base64":return Ko(this,e,t);case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return Xo(
...
0;o<n;++o){let u=parseInt(e.substr(o*2,2),16);if(zt(u))return o;r[t+o]=u}return o}a(jo,"hexWrite");function Ho(r,e,t,n){
return pt(Gt(e,r.length-t),r,t,n)}a(Ho,"utf8Write");function Go(r,e,t,n){return pt(na(e),r,t,n)}a(Go,
"asciiWrite");function $o(r,e,t,n){return pt(si(e),r,t,n)}a($o,"base64Write");function Vo(r,e,t,n){return pt(
...
utf-8":return Ho(this,e,t,n);case"ascii":case"latin1":case"binary":return Go(this,e,t,n);case"base64":
return $o(this,e,t,n);case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return Vo(this,e,t,n);default:
...
N");function Ko(r,e,t){return e===0&&t===r.length?Wt.fromByteArray(r):Wt.fromByteArray(r.slice(e,t))}
a(Ko,"base64Slice");function Jn(r,e,t){t=Math.min(r.length,t);let n=[],i=e;for(;i<t;){let s=r[i],o=null,
...
n.push(o),i+=u}return zo(n)}a(Jn,"utf8Slice");var $n=4096;function zo(r){let e=r.length;if(e<=$n)return String.
fromCharCode.apply(String,r);let t="",n=0;for(;n<e;)t+=String.fromCharCode.apply(String,r.slice(n,n+=
$n));return t}a(zo,"decodeCodePointsArray");function Yo(r,e,t){let n="";t=Math.min(r.length,t);for(let i=e;i<
t;++i)n+=String.fromCharCode(r[i]&127);return n}a(Yo,"asciiSlice");function Zo(r,e,t){let n="";t=Math.
min(r.length,t);for(let i=e;i<t;++i)n+=String.fromCharCode(r[i]);return n}a(Zo,"latin1Slice");function Jo(r,e,t){
let n=r.length;(!e||e<0)&&(e=0),(!t||t<0||t>n)&&(t=n);let i="";for(let s=e;s<t;++s)i+=sa[r[s]];return i}
a(Jo,"hexSlice");function Xo(r,e,t){let n=r.slice(e,t),i="";for(let s=0;s<n.length-1;s+=2)i+=String.
fromCharCode(n[s]+n[s+1]*256);return i}a(Xo,"utf16leSlice");h.prototype.slice=a(function(e,t){let n=this.
...
0;s<n-t;++s)this[s+t]=o[s%u]}return this},"fill");var Te={};function Kt(r,e,t){var n;Te[r]=(n=class extends t{constructor(){
...
_${r.slice(t-3,t)}${e}`;return`${r.slice(0,t)}${e}`}a(Vn,"addNumericalSeparator");function ea(r,e,t){
Re(e,"offset"),(r[e]===void 0||r[e+t]===void 0)&&je(e,r.length-(t+1))}a(ea,"checkBounds");function ii(r,e,t,n,i,s){
...
nd <= ${t}${o}`,new Te.ERR_OUT_OF_RANGE("value",u,r)}ea(n,i,s)}a(ii,"checkIntBI");function Re(r,e){if(typeof r!=
...
new Te.ERR_OUT_OF_RANGE(t||"offset",`>= ${t?1:0} and <= ${e}`,r)}a(je,"boundsError");var ta=/[^+/0-9A-Za-z-_]/g;
...
o),n=t>>8,i=t%256,s.push(i),s.push(n);return s}a(ia,"utf16leToBytes");function si(r){return Wt.toByteArray(
ra(r))}a(si,"base64ToBytes");function pt(r,e,t,n){let i;for(i=0;i<n&&!(i+t>=e.length||i>=r.length);++i)
e[i+t]=r[i];return i}a(pt,"blitBuffer");function ue(r,e){return r instanceof e||r!=null&&r.constructor!=
null&&r.constructor.name!=null&&r.constructor.name===e.name}a(ue,"isInstance");function zt(r){return r!==
r}a(zt,"numberIsNaN");var sa=function(){let r="0123456789abcdef",e=new Array(256);for(let t=0;t<16;++t){
let n=t*16;for(let i=0;i<16;++i)e[n+i]=r[t]+r[i]}return e}();function we(r){return typeof BigInt>"u"?
oa:r}a(we,"defineBigIntMethod");function oa(){throw new Error("BigInt not supported")}a(oa,"BufferBi\
...
m.nextTick(()=>{})}catch{let e=Promise.resolve();m.nextTick=e.then.bind(e)}});var be=T((Fl,Yt)=>{"use strict";p();var Le=typeof Reflect=="object"?Reflect:null,ai=Le&&typeof Le.apply==
"function"?Le.apply:a(function(e,t,n){return Function.prototype.apply.call(e,t,n)},"ReflectApply"),dt;
Le&&typeof Le.ownKeys=="function"?dt=Le.ownKeys:Object.getOwnPropertySymbols?dt=a(function(e){return Object.
...
"ProcessEmitWarning");var ci=Number.isNaN||a(function(e){return e!==e},"NumberIsNaN");function R(){R.
init.call(this)}a(R,"EventEmitter");Yt.exports=R;Yt.exports.once=fa;R.EventEmitter=R;R.prototype._events=
void 0;R.prototype._eventsCount=0;R.prototype._maxListeners=void 0;var ui=10;function yt(r){if(typeof r!=
"function")throw new TypeError('The "listener" argument must be of type Function. Received type '+typeof r)}
a(yt,"checkListener");Object.defineProperty(R,"defaultMaxListeners",{enumerable:!0,get:a(function(){
return ui},"get"),set:a(function(r){if(typeof r!="number"||r<0||ci(r))throw new RangeError('The valu\
e of "defaultMaxListeners" is out of range. It must be a non-negative number. Received '+r+".");ui=r},
...
R.prototype.setMaxListeners=a(function(e){if(typeof e!="number"||e<0||ci(e))throw new RangeError('Th\
e value of "n" is out of range. It must be a non-negative number. Received '+e+".");return this._maxListeners=
e,this},"setMaxListeners");function li(r){return r._maxListeners===void 0?R.defaultMaxListeners:r._maxListeners}
a(li,"_getMaxListeners");R.prototype.getMaxListeners=a(function(){return li(this)},"getMaxListeners");
...
throw u.context=o,u}var c=s[e];if(c===void 0)return!1;if(typeof c=="function")ai(c,this,t);else for(var l=c.
length,f=yi(c,l),n=0;n<l;++n)ai(f[n],this,t);return!0},"emit");function fi(r,e,t,n){var i,s,o;if(yt(
...
"function"?o=s[e]=n?[t,o]:[o,t]:n?o.unshift(t):o.push(t),i=li(r),i>0&&o.length>i&&!o.warned){o.warned=
...
r,u.type=e,u.count=o.length,aa(u)}return r}a(fi,"_addListener");R.prototype.addListener=a(function(e,t){
return fi(this,e,t,!1)},"addListener");R.prototype.on=R.prototype.addListener;R.prototype.prependListener=
a(function(e,t){return fi(this,e,t,!0)},"prependListener");function ua(){if(!this.fired)return this.
target.removeListener(this.type,this.wrapFn),this.fired=!0,arguments.length===0?this.listener.call(this.
target):this.listener.apply(this.target,arguments)}a(ua,"onceWrapper");function hi(r,e,t){var n={fired:!1,
wrapFn:void 0,target:r,type:e,listener:t},i=ua.bind(n);return i.listener=t,n.wrapFn=i,i}a(hi,"_onceW\
rap");R.prototype.once=a(function(e,t){return yt(t),this.on(e,hi(this,e,t)),this},"once");R.prototype.
prependOnceListener=a(function(e,t){return yt(t),this.prependListener(e,hi(this,e,t)),this},"prepend\
...
la(i):yi(i,i.length)}a(pi,"_listeners");R.prototype.listeners=a(function(e){return pi(this,e,!0)},"l\
isteners");R.prototype.rawListeners=a(function(e){return pi(this,e,!1)},"rawListeners");R.listenerCount=
function(r,e){return typeof r.listenerCount=="function"?r.listenerCount(e):di.call(r,e)};R.prototype.
listenerCount=di;function di(r){var e=this._events;if(e!==void 0){var t=e[r];if(typeof t=="function")
return 1;if(t!==void 0)return t.length}return 0}a(di,"listenerCount");R.prototype.eventNames=a(function(){
return this._eventsCount>0?dt(this._events):[]},"eventNames");function yi(r,e){for(var t=new Array(e),
n=0;n<e;++n)t[n]=r[n];return t}a(yi,"arrayClone");function ca(r,e){for(;e+1<r.length;e++)r[e]=r[e+1];
...
removeListener("error",i),t([].slice.call(arguments))}a(s,"resolver"),mi(r,e,s,{once:!0}),e!=="error"&&
ha(r,i,{once:!0})})}a(fa,"once");function ha(r,e,t){typeof r.on=="function"&&mi(r,"error",e,t)}a(ha,
"addErrorHandlerIfEventEmitter");function mi(r,e,t,n){if(typeof r.on=="function")n.once?r.once(e,t):
...
ust be of type EventEmitter. Received type '+typeof r)}a(mi,"eventTargetAgnosticAddListener")});var bi={};ie(bi,{Socket:()=>ce,isIP:()=>pa});function pa(r){return 0}var wi,gi,S,ce,Fe=$(()=>{"use s\
trict";p();wi=ge(be(),1);a(pa,"isIP");gi=/^[^.]+\./,S=class S extends wi.EventEmitter{constructor(){
...
poolQueryViaFetch:!1,fetchEndpoint:a((t,n,i)=>{let s;return i?.jwtAuth?s=t.replace(gi,"apiauth."):s=
t.replace(gi,"api."),"https://"+s+"/sql"},"fetchEndpoint"),fetchConnectionCache:!0,fetchFunction:void 0,
...
disableWarningInBrowsers:!1}),E(S,"opts",{});ce=S});var vi={};ie(vi,{parse:()=>Zt});function Zt(r,e=!1){let{protocol:t}=new URL(r),n="http:"+r.substring(
...
pathname:l,search:f,query:C,hash:w}}var Jt=$(()=>{"use strict";p();a(Zt,"parse")});var rr=T(_i=>{"use strict";p();_i.parse=function(r,e){return new tr(r,e).parse()};var xt=class xt{constructor(e,t){
...
not balanced");return this.entries}};a(xt,"ArrayParser");var tr=xt;function _a(r){return r}a(_a,"ide\
ntity")});var nr=T((tf,Ii)=>{p();var Ia=rr();Ii.exports={create:a(function(r,e){return{parse:a(function(){return Ia.
parse(r,e)},"parse")}},"create")}});var Ri=T((sf,Pi)=>{"use strict";p();var Ta=/(\d{1,})-(\d{2})-(\d{2}) (\d{2}):(\d{2}):(\d{2})(\.\d{1,})?.*?( BC)?$/,
Pa=/^(\d{1,})-(\d{2})-(\d{2})( BC)?$/,Ra=/([Z+-])(\d{2})?:?(\d{2})?:?(\d{2})?/,Ba=/^-?infinity$/;Pi.
exports=a(function(e){if(Ba.test(e))return Number(e.replace("i","I"));var t=Ta.exec(e);if(!t)return La(
e)||null;var n=!!t[8],i=parseInt(t[1],10);n&&(i=Ti(i));var s=parseInt(t[2],10)-1,o=t[3],u=parseInt(t[4],
10),c=parseInt(t[5],10),l=parseInt(t[6],10),f=t[7];f=f?1e3*parseFloat(f):0;var y,w=Fa(e);return w!=null?
(y=new Date(Date.UTC(i,s,o,u,c,l,f)),ir(i)&&y.setUTCFullYear(i),w!==0&&y.setTime(y.getTime()-w)):(y=
new Date(i,s,o,u,c,l,f),ir(i)&&y.setFullYear(i)),y},"parseDate");function La(r){var e=Pa.exec(r);if(e){
var t=parseInt(e[1],10),n=!!e[4];n&&(t=Ti(t));var i=parseInt(e[2],10)-1,s=e[3],o=new Date(t,i,s);return ir(
t)&&o.setFullYear(t),o}}a(La,"getDate");function Fa(r){if(r.endsWith("+00"))return 0;var e=Ra.exec(r.
...
1)}a(Ti,"bcYearToNegativeYear");function ir(r){return r>=0&&r<100}a(ir,"is0To99")});var Li=T((uf,Bi)=>{p();Bi.exports=Ma;var ka=Object.prototype.hasOwnProperty;function Ma(r){for(var e=1;e<
arguments.length;e++){var t=arguments[e];for(var n in t)ka.call(t,n)&&(r[n]=t[n])}return r}a(Ma,"ext\
end")});var Mi=T((ff,ki)=>{"use strict";p();var Ua=Li();ki.exports=ke;function ke(r){if(!(this instanceof ke))
return new ke(r);Ua(this,Ka(r))}a(ke,"PostgresInterval");var Da=["seconds","minutes","hours","days",
...
S"},qa=["years","months","days"],Qa=["hours","minutes","seconds"];ke.prototype.toISOString=ke.prototype.
toISO=function(){var r=qa.map(t,this).join(""),e=Qa.map(t,this).join("");return"P"+r+"T"+e;function t(n){
var i=this[n]||0;return n==="seconds"&&this.milliseconds&&(i=(i+this.milliseconds/1e3).toFixed(6).replace(
/0+$/,"")),i+Oa[n]}};var sr="([+-]?\\d+)",Na=sr+"\\s+years?",Wa=sr+"\\s+mons?",ja=sr+"\\s+days?",Ha="\
([+-])?([\\d]*):(\\d\\d):(\\d\\d)\\.?(\\d{1,6})?",Ga=new RegExp([Na,Wa,ja,Ha].map(function(r){return"\
("+r+")?"}).join("\\s*")),Fi={years:2,months:4,days:6,hours:9,minutes:10,seconds:11,milliseconds:12},
$a=["hours","minutes","seconds","milliseconds"];function Va(r){var e=r+"000000".slice(r.length);return parseInt(
e,10)/1e3}a(Va,"parseMilliseconds");function Ka(r){if(!r)return{};var e=Ga.exec(r),t=e[8]==="-";return Object.
keys(Fi).reduce(function(n,i){var s=Fi[i],o=e[s];return!o||(o=i==="milliseconds"?Va(o):parseInt(o,10),
!o)||(t&&~$a.indexOf(i)&&(o*=-1),n[i]=o),n},{})}a(Ka,"parse")});var Di=T((df,Ui)=>{"use strict";p();Ui.exports=a(function(e){if(/^\\x/.test(e))return new d(e.substr(
...
parseBytea")});var Hi=T((gf,ji)=>{p();var Ke=rr(),ze=nr(),St=Ri(),qi=Mi(),Qi=Di();function Et(r){return a(function(t){
return t===null?t:r(t)},"nullAllowed")}a(Et,"allowNull");function Ni(r){return r===null?r:r==="TRUE"||
r==="t"||r==="true"||r==="y"||r==="yes"||r==="on"||r==="1"}a(Ni,"parseBool");function za(r){return r?
Ke.parse(r,Ni):null}a(za,"parseBoolArray");function Ya(r){return parseInt(r,10)}a(Ya,"parseBaseTenIn\
t");function or(r){return r?Ke.parse(r,Et(Ya)):null}a(or,"parseIntegerArray");function Za(r){return r?
Ke.parse(r,Et(function(e){return Wi(e).trim()})):null}a(Za,"parseBigIntegerArray");var Ja=a(function(r){
...
function(t){return t!==null&&(t=St(t)),t});return e.parse()},"parseDateArray"),Xa=a(function(r){if(!r)
return null;var e=ze.create(r,function(t){return t!==null&&(t=qi(t)),t});return e.parse()},"parseInt\
ervalArray"),eu=a(function(r){return r?Ke.parse(r,Et(Qi)):null},"parseByteAArray"),cr=a(function(r){
return parseInt(r,10)},"parseInteger"),Wi=a(function(r){var e=String(r);return/^\d+$/.test(e)?e:r},"\
parseBigInteger"),Oi=a(function(r){return r?Ke.parse(r,Et(JSON.parse)):null},"parseJsonArray"),lr=a(
...
r[i])}var s=lr(e);return s.radius=parseFloat(t),s},"parseCircle"),ru=a(function(r){r(20,Wi),r(21,cr),
r(23,cr),r(26,cr),r(700,parseFloat),r(701,parseFloat),r(16,Ni),r(1082,St),r(1114,St),r(1184,St),r(600,
lr),r(651,re),r(718,tu),r(1e3,za),r(1001,eu),r(1005,or),r(1007,or),r(1028,or),r(1016,Za),r(1017,Ja),
r(1021,ar),r(1022,ar),r(1231,ar),r(1014,re),r(1015,re),r(1008,re),r(1009,re),r(1040,re),r(1041,re),r(
1115,ur),r(1182,ur),r(1185,ur),r(1186,qi),r(1187,Xa),r(17,Qi),r(114,JSON.parse.bind(JSON)),r(3802,JSON.
parse.bind(JSON)),r(199,Oi),r(3807,Oi),r(3907,re),r(2951,re),r(791,re),r(1183,re),r(1270,re)},"init");
ji.exports={init:ru}});var $i=T((vf,Gi)=>{"use strict";p();var K=1e6;function nu(r){var e=r.readInt32BE(0),t=r.readUInt32BE(
...
""+o%K,n+u+i}a(nu,"readInt8");Gi.exports=nu});var Zi=T((Ef,Yi)=>{p();var iu=$i(),L=a(function(r,e,t,n,i){t=t||0,n=n||!1,i=i||function(A,C,D){return A*
...
r,31,1,!0)+1):L(r,31,1)},"parseInt32"),ou=a(function(r){return zi(r,23,8)},"parseFloat32"),au=a(function(r){
return zi(r,52,11)},"parseFloat64"),uu=a(function(r){var e=L(r,16,32);if(e==49152)return NaN;for(var t=Math.
...
null:L(r,8)>0},"parseBool"),fu=a(function(r){r(20,iu),r(21,su),r(23,Vi),r(26,Vi),r(1700,uu),r(700,ou),
r(701,au),r(16,lu),r(1114,Ki.bind(null,!1)),r(1184,Ki.bind(null,!0)),r(1e3,Ye),r(1007,Ye),r(1016,Ye),
r(1008,Ye),r(1009,Ye),r(25,cu)},"init");Yi.exports={init:fu}});var Xi=T((_f,Ji)=>{p();Ji.exports={BOOL:16,BYTEA:17,CHAR:18,INT8:20,INT2:21,INT4:23,REGPROC:24,TEXT:25,
...
REGROLE:4096}});var Xe=T(Je=>{p();var hu=Hi(),pu=Zi(),du=nr(),yu=Xi();Je.getTypeParser=mu;Je.setTypeParser=gu;Je.arrayParser=
du;Je.builtins=yu;var Ze={text:{},binary:{}};function es(r){return String(r)}a(es,"noParse");function mu(r,e){
return e=e||"text",Ze[e]&&Ze[e][r]||es}a(mu,"getTypeParser");function gu(r,e,t){typeof e=="function"&&
(t=e,e="text"),Ze[e][r]=t}a(gu,"setTypeParser");hu.init(function(r,e){Ze.text[r]=e});pu.init(function(r,e){
Ze.binary[r]=e})});var Ct=T((Bf,ts)=>{"use strict";p();var wu=Xe();function At(r){this._types=r||wu,this.text={},this.binary=
...
e||"text",this.getOverrides(e)[r]||this._types.getTypeParser(r,e)};ts.exports=At});function et(r){let e=1779033703,t=3144134277,n=1013904242,i=2773480762,s=1359893119,o=2600822924,u=528734635,
...
24|C[j+1]<<16|C[j+2]<<8|C[j+3];for(let B=16;B<64;B++){let j=w(A[B-15],7)^w(A[B-15],18)^A[B-15]>>>3,le=w(
A[B-2],17)^w(A[B-2],19)^A[B-2]>>>10;A[B]=A[B-16]+j+A[B-7]+le|0}let I=e,g=t,Z=n,W=i,J=s,X=o,se=u,oe=c;
for(let B=0;B<64;B++){let j=w(J,6)^w(J,11)^w(J,25),le=J&X^~J&se,de=oe+j+le+y[B]+A[B]|0,We=w(I,2)^w(I,
13)^w(I,22),fe=I&g^I&Z^g&Z,_e=We+fe|0;oe=se,se=X,X=J,J=W+de|0,W=Z,Z=g,g=I,I=de+_e|0}e=e+I|0,t=t+g|0,
...
(Y(r),P())}var rs=$(()=>{"use strict";p();a(et,"sha256")});var U,tt,ns=$(()=>{"use strict";p();U=class U{constructor(){E(this,"_dataLength",0);E(this,"_bufferL\
...
abcdef"),E(U,"hexOut",[]),E(U,"onePassHasher",new U);tt=U});var fr={};ie(fr,{createHash:()=>vu,createHmac:()=>xu,randomBytes:()=>bu});function bu(r){return crypto.
getRandomValues(d.alloc(r))}function vu(r){if(r==="sha256")return{update:a(function(e){return{digest:a(
...
throw new Error(`Hash type '${r}' not supported`)}function xu(r,e){if(r!=="sha256")throw new Error(`\
...
"digest")}},"update")}}var hr=$(()=>{"use strict";p();rs();ns();a(bu,"randomBytes");a(vu,"createHash");
a(xu,"createHmac")});var rt=T((Hf,pr)=>{"use strict";p();pr.exports={host:"localhost",user:m.platform==="win32"?m.env.USERNAME:
...
keepalives:1,keepalives_idle:0};var Me=Xe(),Su=Me.getTypeParser(20,"text"),Eu=Me.getTypeParser(1016,
"text");pr.exports.__defineSetter__("parseInt8",function(r){Me.setTypeParser(20,"text",r?Me.getTypeParser(
23,"text"):Su),Me.setTypeParser(1016,"text",r?Me.getTypeParser(1007,"text"):Eu)})});var nt=T(($f,ss)=>{"use strict";p();var Au=(hr(),O(fr)),Cu=rt();function _u(r){var e=r.replace(/\\/g,
"\\\\").replace(/"/g,'\\"');return'"'+e+'"'}a(_u,"escapeElement");function is(r){for(var e="{",t=0;t<
r.length;t++)t>0&&(e=e+","),r[t]===null||typeof r[t]>"u"?e=e+"NULL":Array.isArray(r[t])?e=e+is(r[t]):
r[t]instanceof d?e+="\\\\x"+r[t].toString("hex"):e+=_u(_t(r[t]));return e=e+"}",e}a(is,"arrayString");
...
r.byteLength)}return r instanceof Date?Cu.parseInputDatesAsUTC?Pu(r):Tu(r):Array.isArray(r)?is(r):typeof r==
...
for(r=""+r;r.length<e;)r="0"+r;return r}a(N,"pad");function Tu(r){var e=-r.getTimezoneOffset(),t=r.getFullYear(),
...
-1):i+="+",i+=N(Math.floor(e/60),2)+":"+N(e%60,2),n&&(i+=" BC"),i}a(Tu,"dateToString");function Pu(r){
...
r.getUTCMilliseconds(),3);return n+="+00:00",t&&(n+=" BC"),n}a(Pu,"dateToStringUTC");function Ru(r,e,t){
return r=typeof r=="string"?{text:r}:r,e&&(typeof e=="function"?r.callback=e:r.values=e),t&&(r.callback=
t),r}a(Ru,"normalizeQueryConfig");var dr=a(function(r){return Au.createHash("md5").update(r,"utf-8").
...
normalizeQueryConfig:Ru,postgresMd5PasswordHash:Bu,md5:dr}});var it={};ie(it,{default:()=>Mu});var Mu,st=$(()=>{"use strict";p();Mu={}});var ms=T((oh,ys)=>{"use strict";p();var mr=(hr(),O(fr));function Uu(r){if(r.indexOf("SCRAM-SHA-256")===
...
art with client nonce");var i=d.from(n.salt,"base64"),s=ju(e,i,n.iteration),o=Ue(s,"Client Key"),u=Wu(
o),c="n=*,r="+r.clientNonce,l="r="+n.nonce+",s="+n.salt+",i="+n.iteration,f="c=biws,r="+n.nonce,y=c+
","+l+","+f,w=Ue(u,y),A=ds(o,w),C=A.toString("base64"),D=Ue(s,"Server Key"),Y=Ue(D,y);r.message="SAS\
...
a(ds,"xorBuffers");function Wu(r){return mr.createHash("sha256").update(r).digest()}a(Wu,"sha256");function Ue(r,e){
return mr.createHmac("sha256",r).update(e).digest()}a(Ue,"hmacSha256");function ju(r,e,t){for(var n=Ue(
r,d.concat([e,d.from([0,0,0,1])])),i=n,s=0;s<t-1;s++)n=Ue(r,n),i=ds(i,n);return i}a(ju,"Hi");ys.exports=
{startSession:Uu,continueSession:Du,finalizeSession:Ou}});var gr={};ie(gr,{join:()=>Hu});function Hu(...r){return r.join("/")}var wr=$(()=>{"use strict";p();a(
Hu,"join")});var br={};ie(br,{stat:()=>Gu});function Gu(r,e){e(new Error("No filesystem"))}var vr=$(()=>{"use str\
ict";p();a(Gu,"stat")});var xr={};ie(xr,{default:()=>$u});var $u,Sr=$(()=>{"use strict";p();$u={}});var gs={};ie(gs,{StringDecoder:()=>Er});var Ar,Er,ws=$(()=>{"use strict";p();Ar=class Ar{constructor(e){
E(this,"td");this.td=new TextDecoder(e)}write(e){return this.td.decode(e,{stream:!0})}end(e){return this.
td.decode(e)}};a(Ar,"StringDecoder");Er=Ar});var Ss=T((mh,xs)=>{"use strict";p();var{Transform:Vu}=(Sr(),O(xr)),{StringDecoder:Ku}=(ws(),O(gs)),xe=Symbol(
"last"),Tt=Symbol("decoder");function zu(r,e,t){let n;if(this.overflow){if(n=this[Tt].write(r).split(
this.matcher),n.length===1)return t();n.shift(),this.overflow=!1}else this[xe]+=this[Tt].write(r),n=
...
"maximum buffer reached"));return}t()}a(zu,"transform");function Yu(r){if(this[xe]+=this[Tt].end(),this[xe])
try{vs(this,this.mapper(this[xe]))}catch(e){return r(e)}r()}a(Yu,"flush");function vs(r,e){e!==void 0&&
...
"object"&&(t=e,e=bs)}t=Object.assign({},t),t.autoDestroy=!0,t.transform=zu,t.flush=Yu,t.readableObjectMode=
!0;let n=new Vu(t);return n[xe]="",n[Tt]=new Ku("utf8"),n.matcher=r,n.mapper=e,n.maxLength=t.maxLength,
n.skipOverflow=t.skipOverflow||!1,n.overflow=!1,n._destroy=function(i,s){this._writableState.errorEmitted=
!1,s(i)},n}a(Zu,"split");xs.exports=Zu});var Cs=T((bh,pe)=>{"use strict";p();var Es=(wr(),O(gr)),Ju=(Sr(),O(xr)).Stream,Xu=Ss(),As=(st(),O(it)),
ec=5432,Pt=m.platform==="win32",ot=m.stderr,tc=56,rc=7,nc=61440,ic=32768;function sc(r){return(r&nc)==
ic}a(sc,"isRegFile");var De=["host","port","database","user","password"],Cr=De.length,oc=De[Cr-1];function _r(){
var r=ot instanceof Ju&&ot.writable===!0;if(r){var e=Array.prototype.slice.call(arguments).concat(`
`);ot.write(As.format.apply(As,e))}}a(_r,"warn");Object.defineProperty(pe.exports,"isWin",{get:a(function(){
return Pt},"get"),set:a(function(r){Pt=r},"set")});pe.exports.warnTo=function(r){var e=ot;return ot=
r,e};pe.exports.getFileName=function(r){var e=r||m.env,t=e.PGPASSFILE||(Pt?Es.join(e.APPDATA||"./","\
postgresql","pgpass.conf"):Es.join(e.HOME||"./",".pgpass"));return t};pe.exports.usePgPass=function(r,e){
...
(0600) or less',e),!1):!0:(_r('WARNING: password file "%s" is not a plain file',e),!1))};var ac=pe.exports.
match=function(r,e){return De.slice(0,-1).reduce(function(t,n,i){return i==1&&Number(r[n]||ec)===Number(
...
void 0)},"onErr");e.on("error",u),i.on("data",s).on("end",o).on("error",u)};var uc=pe.exports.parseLine=
...
length===Cr?o:null,o},cc=pe.exports.isValidEntry=function(r){for(var e={0:function(o){return o.length>
...
0}},t=0;t<De.length;t+=1){var n=e[t],i=r[De[t]]||"",s=n(i);if(!s)return!1}return!0}});var Is=T((Eh,Ir)=>{"use strict";p();var Sh=(wr(),O(gr)),_s=(vr(),O(br)),Rt=Cs();Ir.exports=function(r,e){
var t=Rt.getFileName();_s.stat(t,function(n,i){if(n||!Rt.usePgPass(i,t))return e(void 0);var s=_s.createReadStream(
t);Rt.getPassword(r,s,e)})};Ir.exports.warnTo=Rt.warnTo});var Ts={};ie(Ts,{default:()=>lc});var lc,Ps=$(()=>{"use strict";p();lc={}});var Rr=T((_h,Rs)=>{"use strict";p();var fc=(Jt(),O(vi)),Tr=(vr(),O(br));function Pr(r){if(r.charAt(0)===
...
!1;break}}return t}a(Pr,"parse");Rs.exports=Pr;Pr.parse=Pr});var Bt=T((Ph,Fs)=>{"use strict";p();var hc=(Ps(),O(Ts)),Ls=rt(),Bs=Rr().parse,H=a(function(r,e,t){return t===
void 0?t=m.env["PG"+r.toUpperCase()]:t===!1||(t=m.env[t]),e[r]||t||Ls[r]},"val"),pc=a(function(){switch(m.
env.PGSSLMODE){case"disable":return!1;case"prefer":case"require":case"verify-ca":case"verify-full":return!0;case"\
no-verify":return{rejectUnauthorized:!1}}return Ls.ssl},"readSSLConfigFromEnvironment"),Oe=a(function(r){
return"'"+(""+r).replace(/\\/g,"\\\\").replace(/'/g,"\\'")+"'"},"quoteParamValue"),ne=a(function(r,e,t){
var n=e[t];n!=null&&r.push(t+"="+Oe(n))},"add"),Lr=class Lr{constructor(e){e=typeof e=="string"?Bs(e):
...
ssl>"u"?pc():e.ssl,typeof this.ssl=="string"&&this.ssl==="true"&&(this.ssl=!0),this.ssl==="no-verify"&&
...
hc.lookup(this.host,function(i,s){return i?e(i,null):(t.push("hostaddr="+Oe(s)),e(null,t.join(" ")))})}};
a(Lr,"ConnectionParameters");var Br=Lr;Fs.exports=Br});var Us=T((Lh,Ms)=>{"use strict";p();var dc=Xe(),ks=/^([A-Za-z]+)(?: (\d+))?(?: (\d+))?/,kr=class kr{constructor(e,t){
...
_types.getTypeParser(n.dataTypeID,n.format||"text"):this._parsers[t]=dc.getTypeParser(n.dataTypeID,n.
format||"text")}}};a(kr,"Result");var Fr=kr;Ms.exports=Fr});var Qs=T((Mh,qs)=>{"use strict";p();var{EventEmitter:yc}=be(),Ds=Us(),Os=nt(),Ur=class Ur extends yc{constructor(e,t,n){
...
e.sendCopyFail("No source stream defined")}handleCopyData(e,t){}};a(Ur,"Query");var Mr=Ur;qs.exports=
...
sage");var Gr=on;_.BackendKeyDataMessage=Gr;var an=class an{constructor(e,t,n,i){this.length=e,this.
processId=t,this.channel=n,this.payload=i,this.name="notification"}};a(an,"NotificationResponseMessa\
ge");var $r=an;_.NotificationResponseMessage=$r;var un=class un{constructor(e,t){this.length=e,this.
...
ndCompleteMessage");var Kr=cn;_.CommandCompleteMessage=Kr;var ln=class ln{constructor(e,t){this.length=
e,this.fields=t,this.name="dataRow",this.fieldCount=t.length}};a(ln,"DataRowMessage");var zr=ln;_.DataRowMessage=
zr;var fn=class fn{constructor(e,t){this.length=e,this.message=t,this.name="notice"}};a(fn,"NoticeMe\
ssage");var Yr=fn;_.NoticeMessage=Yr});var Ns=T(Lt=>{"use strict";p();Object.defineProperty(Lt,"__esModule",{value:!0});Lt.Writer=void 0;var dn=class dn{constructor(e=256){
...
headerPosition=0,this.buffer=d.allocUnsafe(this.size),t}};a(dn,"Writer");var pn=dn;Lt.Writer=pn});var js=T(kt=>{"use strict";p();Object.defineProperty(kt,"__esModule",{value:!0});kt.serialize=void 0;
var yn=Ns(),F=new yn.Writer,mc=a(r=>{F.addInt16(3).addInt16(0);for(let n of Object.keys(r))F.addCString(
n).addCString(r[n]);F.addCString("client_encoding").addCString("UTF8");let e=F.addCString("").flush(),
t=e.length+4;return new yn.Writer().addInt32(t).add(e).flush()},"startup"),gc=a(()=>{let r=d.allocUnsafe(
8);return r.writeInt32BE(8,0),r.writeInt32BE(80877103,4),r},"requestSsl"),wc=a(r=>F.addCString(r).flush(
112),"password"),bc=a(function(r,e){return F.addCString(r).addInt32(d.byteLength(e)).addString(e),F.
flush(112)},"sendSASLInitialResponseMessage"),vc=a(function(r){return F.addString(r).flush(112)},"se\
ndSCRAMClientFinalMessage"),xc=a(r=>F.addCString(r).flush(81),"query"),Ws=[],Sc=a(r=>{let e=r.name||
...
n;s++)i.addInt32(t[s]);return F.flush(80)},"parse"),qe=new yn.Writer,Ec=a(function(r,e){for(let t=0;t<
...
return F.addCString(e).addCString(t),F.addInt16(s),Ec(i,r.valueMapper),F.addInt16(s),F.add(qe.flush()),
F.addInt16(n?1:0),F.flush(66)},"bind"),Cc=d.from([69,0,0,0,9,0,0,0,0,0]),_c=a(r=>{if(!r||!r.portal&&
!r.rows)return Cc;let e=r.portal||"",t=r.rows||0,n=d.byteLength(e),i=4+n+1+4,s=d.allocUnsafe(1+i);return s[0]=
...
Tc=F.addCString("P").flush(68),Pc=F.addCString("S").flush(68),Rc=a(r=>r.name?mn(68,`${r.type}${r.name||
""}`):r.type==="P"?Tc:Pc,"describe"),Bc=a(r=>{let e=`${r.type}${r.name||""}`;return mn(67,e)},"close"),
Lc=a(r=>F.add(r).flush(100),"copyData"),Fc=a(r=>mn(102,r),"copyFail"),Ft=a(r=>d.from([r,0,0,0,4]),"c\
odeOnlyBuffer"),kc=Ft(72),Mc=Ft(83),Uc=Ft(88),Dc=Ft(99),Oc={startup:mc,password:wc,requestSsl:gc,sendSASLInitialResponseMessage:bc,
sendSCRAMClientFinalMessage:vc,query:xc,parse:Sc,bind:Ac,execute:_c,describe:Rc,close:Bc,flush:a(()=>kc,
"flush"),sync:a(()=>Mc,"sync"),end:a(()=>Uc,"end"),copyData:Lc,copyDone:a(()=>Dc,"copyDone"),copyFail:Fc,
cancel:Ic};kt.serialize=Oc});var Hs=T(Mt=>{"use strict";p();Object.defineProperty(Mt,"__esModule",{value:!0});Mt.BufferReader=void 0;
var qc=d.allocUnsafe(0),wn=class wn{constructor(e=0){this.offset=e,this.buffer=qc,this.encoding="utf\
...
offset+=e,t}};a(wn,"BufferReader");var gn=wn;Mt.BufferReader=gn});var Vs=T(Ut=>{"use strict";p();Object.defineProperty(Ut,"__esModule",{value:!0});Ut.Parser=void 0;var k=hn(),
Qc=Hs(),bn=1,Nc=4,Gs=bn+Nc,$s=d.allocUnsafe(0),xn=class xn{constructor(e){if(this.buffer=$s,this.bufferLength=
...
i+bn),u=bn+o;if(u+i<=n){let c=this.handlePacket(i+Gs,s,o,this.buffer);t(c),i+=u}else break}i===n?(this.
...
a(xn,"Parser");var vn=xn;Ut.Parser=vn});var Sn=T(Se=>{"use strict";p();Object.defineProperty(Se,"__esModule",{value:!0});Se.DatabaseError=Se.
serialize=Se.parse=void 0;var Wc=hn();Object.defineProperty(Se,"DatabaseError",{enumerable:!0,get:a(
function(){return Wc.DatabaseError},"get")});var jc=js();Object.defineProperty(Se,"serialize",{enumerable:!0,
get:a(function(){return jc.serialize},"get")});var Hc=Vs();function Gc(r,e){let t=new Hc.Parser;return r.
on("data",n=>t.parse(n,e)),new Promise(n=>r.on("end",()=>n()))}a(Gc,"parse");Se.parse=Gc});var Ks={};ie(Ks,{connect:()=>$c});function $c({socket:r,servername:e}){return r.startTls(e),r}var zs=$(
()=>{"use strict";p();a($c,"connect")});var Cn=T((ip,Js)=>{"use strict";p();var Ys=(Fe(),O(bi)),Vc=be().EventEmitter,{parse:Kc,serialize:Q}=Sn(),
Zs=Q.flush(),zc=Q.sync(),Yc=Q.end(),An=class An extends Vc{constructor(e){super(),e=e||{},this.stream=
...
"end",()=>{this.emit("end")}),Kc(e,t=>{var n=t.name==="error"?"errorMessage":t.name;this._emitMessage&&
...
stream.writable&&this.stream.write(Zs)}sync(){this._ending=!0,this._send(Zs),this._send(zc)}ref(){this.
...
this._send(Q.copyDone())}sendCopyFail(e){this._send(Q.copyFail(e))}};a(An,"Connection");var En=An;Js.
exports=En});var to=T((up,eo)=>{"use strict";p();var Zc=be().EventEmitter,ap=(st(),O(it)),Jc=nt(),_n=ms(),Xc=Is(),
el=Ct(),tl=Bt(),Xs=Qs(),rl=rt(),nl=Cn(),In=class In extends Zc{constructor(e){super(),this.connectionParameters=
...
()=>{let t=Jc.postgresMd5PasswordHash(this.user,this.password,e.salt);this.connection.password(t)})}_handleAuthSASL(e){
...
_Promise(t=>{this.connection.once("end",t)})}};a(In,"Client");var Dt=In;Dt.Query=Xs;eo.exports=Dt});var so=T((fp,io)=>{"use strict";p();var il=be().EventEmitter,ro=a(function(){},"NOOP"),no=a((r,e)=>{
...
this.callback=e}};a(Bn,"PendingItem");var Qe=Bn;function sl(){throw new Error("Release called on cli\
...
dleListener")}a(ol,"makeIdleListener");var Ln=class Ln extends il{constructor(e,t){super(),this.options=
...
clearTimeout(o),t.callback(u,c,l)},"queueCallback"),s=new Qe(i),o=setTimeout(()=>{no(this._pendingQueue,
...
return this._clients.length}};a(Ln,"Pool");var Pn=Ln;io.exports=Pn});var oo={};ie(oo,{default:()=>al});var al,ao=$(()=>{"use strict";p();al={}});var uo=T((yp,ul)=>{ul.exports={name:"pg",version:"8.8.0",description:"PostgreSQL client - pure javas\
...
a178655"}});var fo=T((mp,lo)=>{"use strict";p();var co=be().EventEmitter,cl=(st(),O(it)),Fn=nt(),Ne=lo.exports=function(r,e,t){
co.call(this),r=Fn.normalizeQueryConfig(r,e,t),this.text=r.text,this.values=r.values,this.name=r.name,
this.callback=r.callback,this.state="new",this._arrayMode=r.rowMode==="array",this._emitRowEvents=!1,
this.on("newListener",function(n){n==="row"&&(this._emitRowEvents=!0)}.bind(this))};cl.inherits(Ne,co);
...
prepareValue);r.native.query(this.text,i,t)}else r.native.query(this.text,t)}});var mo=T((vp,yo)=>{"use strict";p();var fl=(ao(),O(oo)),hl=Ct(),bp=uo(),ho=be().EventEmitter,pl=(st(),O(it)),
dl=Bt(),po=fo(),z=yo.exports=function(r){ho.call(this),r=r||{},this._Promise=r.Promise||b.Promise,this.
_types=new hl(r.types),this.native=new fl({types:this._types}),this._queryQueue=[],this._ending=!1,this.
_connecting=!1,this._connected=!1,this._queryable=!0;var e=this.connectionParameters=new dl(r);this.
...
po;pl.inherits(z,ho);z.prototype._errorAllQueries=function(r){let e=a(t=>{m.nextTick(()=>{t.native=this.
...
r,e,t)};z.prototype.getTypeParser=function(r,e){return this._types.getTypeParser(r,e)}});var kn=T((Ep,go)=>{"use strict";p();go.exports=mo()});var at=T((Cp,ut)=>{"use strict";p();var yl=to(),ml=rt(),gl=Cn(),wl=so(),{DatabaseError:bl}=Sn(),vl=a(
...
_pools=[],this.Connection=gl,this.types=Xe(),this.DatabaseError=bl},"PG");typeof m.env.NODE_PG_FORCE_NATIVE<
"u"?ut.exports=new Mn(kn()):(ut.exports=new Mn(yl),Object.defineProperty(ut.exports,"native",{configurable:!0,
enumerable:!1,get(){var r=null;try{r=new Mn(kn())}catch(e){if(e.code!=="MODULE_NOT_FOUND")throw e}return Object.
defineProperty(ut.exports,"native",{value:r}),r}}))});p();p();Fe();Jt();p();var da=Object.defineProperty,ya=Object.defineProperties,ma=Object.getOwnPropertyDescriptors,xi=Object.
getOwnPropertySymbols,ga=Object.prototype.hasOwnProperty,wa=Object.prototype.propertyIsEnumerable,Si=a(
(r,e,t)=>e in r?da(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t,"__defNormalProp"),
ba=a((r,e)=>{for(var t in e||(e={}))ga.call(e,t)&&Si(r,t,e[t]);if(xi)for(var t of xi(e))wa.call(e,t)&&
Si(r,t,e[t]);return r},"__spreadValues"),va=a((r,e)=>ya(r,ma(e)),"__spreadProps"),xa=1008e3,Ei=new Uint8Array(
new Uint16Array([258]).buffer)[0]===2,Sa=new TextDecoder,Xt=new TextEncoder,mt=Xt.encode("0123456789\
abcdef"),gt=Xt.encode("0123456789ABCDEF"),Ea=Xt.encode("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqr\
stuvwxyz0123456789+/");var Ai=Ea.slice();Ai[62]=45;Ai[63]=95;var He,wt;function Aa(r,{alphabet:e,scratchArr:t}={}){if(!He)if(He=
new Uint16Array(256),wt=new Uint16Array(256),Ei)for(let C=0;C<256;C++)He[C]=mt[C&15]<<8|mt[C>>>4],wt[C]=
gt[C&15]<<8|gt[C>>>4];else for(let C=0;C<256;C++)He[C]=mt[C&15]|mt[C>>>4]<<8,wt[C]=gt[C&15]|gt[C>>>4]<<
8;r.byteOffset%4!==0&&(r=new Uint8Array(r));let n=r.length,i=n>>>1,s=n>>>2,o=t||new Uint16Array(n),u=new Uint32Array(
r.buffer,r.byteOffset,s),c=new Uint32Array(o.buffer,o.byteOffset,i),l=e==="upper"?wt:He,f=0,y=0,w;if(Ei)
...
return Sa.decode(o.subarray(0,n))}a(Aa,"_toHex");function Ca(r,e={}){let t="",n=r.length,i=xa>>>1,s=Math.
ceil(n/i),o=new Uint16Array(s>1?i:n);for(let u=0;u<s;u++){let c=u*i,l=c+i;t+=Aa(r.subarray(c,l),va(ba(
{},e),{scratchArr:o}))}return t}a(Ca,"_toHexChunked");function Ci(r,e={}){return e.alphabet!=="upper"&&
typeof r.toHex=="function"?r.toHex():Ca(r,e)}a(Ci,"toHex");p();var bt=class bt{constructor(e,t){this.strings=e;this.values=t}toParameterizedQuery(e={query:"",params:[]}){
let{strings:t,values:n}=this;for(let i=0,s=t.length;i<s;i++)if(e.query+=t[i],i<n.length){let o=n[i];
if(o instanceof $e)e.query+=o.sql;else if(o instanceof Ce)if(o.queryData instanceof bt)o.queryData.toParameterizedQuery(
...
(e.query+="::bytea")}}return e}};a(bt,"SqlTemplate");var Ge=bt,er=class er{constructor(e){this.sql=e}};
a(er,"UnsafeRawSql");var $e=er;p();function vt(){typeof window<"u"&&typeof document<"u"&&typeof console<"u"&&typeof console.warn=="func\
tion"&&console.warn(`          
        ************************************************************
        *                                                          *
        ...
        *  parameter.                                              *
        *                                                          *
        ************************************************************`)}a(vt,"warnIfBrowser");p();var Ve="pkg:npm/%40neondatabase/serverless@1.1.0";Fe();var cs=ge(Ct()),ls=ge(nt());var It=class It extends Error{constructor(t){super(t);E(this,"name","NeonDbError");E(this,"severity");
...
It,"NeonDbError");var ve=It,os="transaction() expects an array of queries, or a function returning a\
n array of queries",Lu=["severity","code","detail","hint","position","internalPosition","internalQue\
ry","where","schema","table","column","dataType","constraint","file","line","routine"];function Fu(r){
return r instanceof d?"\\x"+Ci(r):r}a(Fu,"encodeBuffersAsBytea");function as(r){let{query:e,params:t}=r instanceof
Ge?r.toParameterizedQuery():r;return{query:e,params:t.map(n=>Fu((0,ls.prepareValue)(n)))}}a(as,"prep\
...
Y,new Ge(P,I))}a(D,"templateFn"),D.query=(P,I,g)=>new Ce(Y,{query:P,params:I??[]},g),D.unsafe=P=>new $e(
P),D.transaction=async(P,I)=>{if(typeof P=="function"&&(P=P(D)),!Array.isArray(P))throw new Error(os);
P.forEach(W=>{if(!(W instanceof Ce))throw new Error(os)});let g=P.map(W=>W.queryData),Z=P.map(W=>W.opts??
{});return Y(g,Z,I)};async function Y(P,I,g){let{fetchEndpoint:Z,fetchFunction:W}=ce,J=Array.isArray(
P)?{queries:P.map(ee=>as(ee))}:as(P),X=n??{},se=e??!1,oe=t??!1,B=i,j=s,le=o;g!==void 0&&(g.fetchOptions!==
void 0&&(X={...X,...g.fetchOptions}),g.arrayMode!==void 0&&(se=g.arrayMode),g.fullResults!==void 0&&
(oe=g.fullResults),g.isolationLevel!==void 0&&(B=g.isolationLevel),g.readOnly!==void 0&&(j=g.readOnly),
g.deferrable!==void 0&&(le=g.deferrable)),I!==void 0&&!Array.isArray(I)&&I.fetchOptions!==void 0&&(X=
{...X,...I.fetchOptions});let de=u;!Array.isArray(I)&&I?.authToken!==void 0&&(de=I.authToken);let We=typeof Z==
"function"?Z(w,A,{jwtAuth:de!==void 0}):Z,fe={"Neon-Connection-String":r,"Neon-Raw-Text-Output":"tru\
e","Neon-Array-Mode":"true","Neon-Client-Info":Ve},_e=await ku(de);_e&&(fe.Authorization=`Bearer ${_e}`),
Array.isArray(P)&&(B!==void 0&&(fe["Neon-Batch-Isolation-Level"]=B),j!==void 0&&(fe["Neon-Batch-Read\
-Only"]=String(j)),le!==void 0&&(fe["Neon-Batch-Deferrable"]=String(le))),c||ce.disableWarningInBrowsers||
vt();let ye;try{ye=await(W??fetch)(We,{method:"POST",body:JSON.stringify(J),headers:fe,...X})}catch(ee){
let M=new ve(`Error connecting to database: ${ee}`);throw M.sourceError=ee,M}if(ye.ok){let ee=await ye.
json();if(Array.isArray(P)){let M=ee.results;if(!Array.isArray(M))throw new ve("Neon internal error:\
 unexpected result format");return M.map((G,me)=>{let qt=I[me]??{},xo=qt.arrayMode??se,So=qt.fullResults??
oe;return us(G,{arrayMode:xo,fullResults:So,types:qt.types})})}else{let M=I??{},G=M.arrayMode??se,me=M.
fullResults??oe;return us(ee,{arrayMode:G,fullResults:me,types:M.types})}}else{let{status:ee}=ye;if(ee===
400){let M=await ye.json(),G=new ve(M.message);for(let me of Lu)G[me]=M[me]??void 0;throw G}else{let M=await ye.
text();throw new ve(`Server error (HTTP status ${ee}): ${M}`)}}}return a(Y,"execute"),D}a(fs,"neon");
var yr=class yr{constructor(e,t,n){this.execute=e;this.queryData=t;this.opts=n}then(e,t){return this.
execute(this.queryData,this.opts).then(e,t)}catch(e){return this.execute(this.queryData,this.opts).catch(
e)}finally(e){return this.execute(this.queryData,this.opts).finally(e)}};a(yr,"NeonQueryPromise");var Ce=yr;
function us(r,{arrayMode:e,fullResults:t,types:n}){let i=new cs.default(n),s=r.fields.map(c=>c.name),
...
!0,r.rowAsArray=e,r.rows=u,r._parsers=o,r._types=i,r):u}a(us,"processQueryResult");async function ku(r){
if(typeof r=="string")return r;if(typeof r=="function")try{return await Promise.resolve(r())}catch(e){
let t=new ve("Error getting auth token.");throw e instanceof Error&&(t=new ve(`Error getting auth to\
ken: ${e.message}`)),t}}a(ku,"getAuthToken");p();var bo=ge(at());p();var wo=ge(at());var Un=class Un extends wo.Client{constructor(t){super(typeof t=="string"?{connectionString:t,fallback_application_name:Ve}:
...
onnect":"connect";l.on(f,()=>{this.neonConfig.disableWarningInBrowsers||vt(),this._handleAuthCleartextPassword(),
...
bute pair entry");let G=M[0],me=M.substring(2);return[G,me]})),c=u.r,l=u.s,f=u.i;if(!c||!/^[!-+--~]+$/.
...
digest("SHA-256",W),X="n=*,r="+i.clientNonce,se="r="+c+",s="+l+",i="+y,oe="c=biws,r="+c,B=X+","+se+"\
,"+oe,j=await n.importKey("raw",J,{name:"HMAC",hash:{name:"SHA-256"}},!1,["sign"]);var le=new Uint8Array(
await n.sign("HMAC",j,A.encode(B))),de=d.from(W.map((M,G)=>W[G]^le[G])),We=de.toString("base64");let fe=await n.
importKey("raw",g,{name:"HMAC",hash:{name:"SHA-256"}},!1,["sign"]),_e=await n.sign("HMAC",fe,A.encode(
"Server Key")),ye=await n.importKey("raw",_e,{name:"HMAC",hash:{name:"SHA-256"}},!1,["sign"]);var ee=d.
from(await n.sign("HMAC",ye,A.encode(B)));i.message="SASLResponse",i.serverSignature=ee.toString("ba\
se64"),i.response=oe+",p="+We,this.connection.sendSCRAMClientFinalMessage(this.saslSession.response)}};
a(Un,"NeonClient");var ct=Un;Fe();var vo=ge(Bt());function xl(r,e){if(e)return{callback:e,result:void 0};let t,n,i=a(function(o,u){o?t(o):n(u)},"cb"),
s=new r(function(o,u){n=o,t=u});return{callback:i,result:s}}a(xl,"promisify");var On=class On extends bo.Pool{constructor(){
...
t,n,i);typeof n=="function"&&(i=n,n=void 0);let s=xl(this.Promise,i);i=s.callback;try{let o=new vo.default(
...
A))}catch(o){i(o)}return s.result}};a(On,"NeonPool");var Dn=On;Fe();var lt=ge(at()),Sl=ge(Rr()),Qp="mjs";var export_DatabaseError=lt.DatabaseError;var export_defaults=lt.defaults;var export_escapeIdentifier=lt.escapeIdentifier;
var export_escapeLiteral=lt.escapeLiteral;var export_parseConnectionString=Sl.parse;var export_types=lt.types;
export{ct as Client,export_DatabaseError as DatabaseError,ve as NeonDbError,Ce as NeonQueryPromise,Dn as Pool,
Ge as SqlTemplate,$e as UnsafeRawSql,Qp as _bundleExt,export_defaults as defaults,export_escapeIdentifier as escapeIdentifier,
export_escapeLiteral as escapeLiteral,fs as neon,ce as neonConfig,export_parseConnectionString as parseConnectionString,
export_types as types,vt as warnIfBrowser};
