var vo=Object.create;var Te=Object.defineProperty;var xo=Object.getOwnPropertyDescriptor;var So=Object.getOwnPropertyNames;var Eo=Object.getPrototypeOf,Ao=Object.prototype.hasOwnProperty;var _o=(r,e,t)=>e in r?Te(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t;var a=(r,e)=>Te(r,"name",{value:e,configurable:!0});var z=(r,e)=>()=>(r&&(e=r(r=0)),e);var I=(r,e)=>()=>(e||r((e={exports:{}}).exports,e),e.exports),ne=(r,e)=>{for(var t in e)Te(r,t,{get:e[t],
...
t,r)),D=r=>kn(Te({},"__esModule",{value:!0}),r);var E=(r,e,t)=>_o(r,typeof e!="symbol"?e+"":e,t);var On=I(ct=>{"use strict";p();ct.byteLength=To;ct.toByteArray=Po;ct.fromByteArray=Lo;var ue=[],ee=[],
Co=typeof Uint8Array<"u"?Uint8Array:Array,Ut="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz01\
...
t)*3/4-t}a(Io,"_byteLength");function Po(r){var e,t=Dn(r),n=t[0],i=t[1],s=new Co(Io(r,n,i)),o=0,u=i>
...
_,u/=256,i-=8);for(o=o<<i|u,l+=i;l>0;r[t+A]=o&255,A+=_,o/=256,l-=8);r[t+A-_]|=Q*128}});var ri=I(Be=>{"use strict";p();var Ot=On(),Pe=qn(),Qn=typeof Symbol=="function"&&typeof Symbol.for==
...
pathname:l,search:f,query:_,hash:g}}var zt=z(()=>{"use strict";p();a(Vt,"parse")});var Jt=I(Si=>{"use strict";p();Si.parse=function(r,e){return new Zt(r,e).parse()};var wt=class wt{constructor(e,t){
...
parse(r,e)},"parse")}},"create")}});var Ci=I((Kl,_i)=>{"use strict";p();var _a=/(\d{1,})-(\d{2})-(\d{2}) (\d{2}):(\d{2}):(\d{2})(\.\d{1,})?.*?( BC)?$/,
Ca=/^(\d{1,})-(\d{2})-(\d{2})( BC)?$/,Ta=/([Z+-])(\d{2})?:?(\d{2})?:?(\d{2})?/,Ia=/^-?infinity$/;_i.
...
new Date(i,s,o,u,c,l,f),er(i)&&y.setFullYear(i)),y},"parseDate");function Pa(r){var e=Ca.exec(r);if(e){
...
parseBytea")});var Qi=I((uf,qi)=>{p();var Ve=Jt(),ze=Xt(),bt=Ci(),ki=Bi(),Ui=Fi();function vt(r){return a(function(t){
...
""+o%Y,n+u+i}a(eu,"readInt8");Ni.exports=eu});var Vi=I((df,$i)=>{p();var tu=ji(),F=a(function(r,e,t,n,i){t=t||0,n=n||!1,i=i||function(A,_,Q){return A*
...
r.byteLength)}return r instanceof Date?Su.parseInputDatesAsUTC?Cu(r):_u(r):Array.isArray(r)?es(r):typeof r==
...
","+l+","+f,g=ke(u,y),A=ls(o,g),_=A.toString("base64"),Q=ke(s,"Server Key"),P=ke(Q,y);r.message="SAS\
...
"maximum buffer reached"));return}t()}a($u,"transform");function Vu(r){if(this[be]+=this[_t].end(),this[be])
...
!0;let n=new Hu(t);return n[be]="",n[_t]=new Gu("utf8"),n.matcher=r,n.mapper=e,n.maxLength=t.maxLength,
...
Zu=5432,Ct=m.platform==="win32",st=m.stderr,Ju=56,Xu=7,ec=61440,tc=32768;function rc(r){return(r&ec)==
...
return Ct},"get"),set:a(function(r){Ct=r},"set")});de.exports.warnTo=function(r){var e=st;return st=
r,e};de.exports.getFileName=function(r){var e=r||m.env,t=e.PGPASSFILE||(Ct?bs.join(e.APPDATA||"./","\
postgresql","pgpass.conf"):bs.join(e.HOME||"./",".pgpass"));return t};de.exports.usePgPass=function(r,e){
return Object.prototype.hasOwnProperty.call(m.env,"PGPASSWORD")?!1:Ct?!0:(e=e||"<unkn>",rc(r.mode)?r.
...
t);Tt.getPassword(r,s,e)})};Er.exports.warnTo=Tt.warnTo});var As={};ne(As,{default:()=>ac});var ac,_s=z(()=>{"use strict";p();ac={}});var Ts=I((dh,Cs)=>{"use strict";p();var uc=(zt(),D(mi)),Ar=(mr(),D(yr));function _r(r){if(r.charAt(0)===
...
!1;break}}return t}a(_r,"parse");Cs.exports=_r;_r.parse=_r});var It=I((gh,Rs)=>{"use strict";p();var cc=(_s(),D(As)),Ps=tt(),Is=Ts().parse,$=a(function(r,e,t){return t===
...
a(Tr,"ConnectionParameters");var Cr=Tr;Rs.exports=Cr});var Fs=I((vh,Ls)=>{"use strict";p();var fc=Je(),Bs=/^([A-Za-z]+)(?: (\d+))?(?: (\d+))?/,Pr=class Pr{constructor(e,t){
...
_c=M.addCString("P").flush(68),Cc=M.addCString("S").flush(68),Tc=a(r=>r.name?fn(68,`${r.type}${r.name||
""}`):r.type==="P"?_c:Cc,"describe"),Ic=a(r=>{let e=`${r.type}${r.name||""}`;return fn(67,e)},"close"),
...
this.callback=e}};a(Cn,"PendingItem");var qe=Cn;function rl(){throw new Error("Release called on cli\
...
new Uint16Array(256),mt=new Uint16Array(256),bi)for(let _=0;_<256;_++)He[_]=dt[_&15]<<8|dt[_>>>4],mt[_]=
yt[_&15]<<8|yt[_>>>4];else for(let _=0;_<256;_++)He[_]=dt[_&15]|dt[_>>>4]<<8,mt[_]=yt[_&15]|yt[_>>>4]<<
...
a(_,"templateFn"),_.query=(P,L,C)=>new Ae(Q,{query:P,params:L??[]},C),_.unsafe=P=>new $e(P),_.transaction=
async(P,L)=>{if(typeof P=="function"&&(P=P(_)),!Array.isArray(P))throw new Error(rs);P.forEach(H=>{if(!(H instanceof
Ae))throw new Error(rs)});let C=P.map(H=>H.queryData),x=P.map(H=>H.opts??{});return Q(C,x,L)};async function Q(P,L,C){
...
text();throw new we(`Server error (HTTP status ${J}): ${j}`)}}}return a(Q,"execute"),_}a(as,"neon");
...
A))}catch(o){i(o)}return s.result}};a(Fn,"NeonPool");var Ln=Fn;We();var Mn=xe(ot()),Cp="mjs";var export_DatabaseError=Mn.DatabaseError;var export_defaults=Mn.defaults;var export_types=Mn.types;
export{ut as Client,export_DatabaseError as DatabaseError,we as NeonDbError,Ae as NeonQueryPromise,Ln as Pool,
Ge as SqlTemplate,$e as UnsafeRawSql,Cp as _bundleExt,export_defaults as defaults,as as neon,ge as neonConfig,
